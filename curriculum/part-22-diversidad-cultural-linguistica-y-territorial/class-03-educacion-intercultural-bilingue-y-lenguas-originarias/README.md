...
**Decisión que habilita:** determinar qué modalidad de educación intercultural bilingüe corresponde a tu establecimiento y con qué condiciones<br>
...
flowchart TB
    ...
    C --> A1["Educación<br/>intercultural bilingüe"]
    C --> A2["Educador tradicional"]
    C --> A3["Revitalización<br/>lingüística"]
    C --> A4["Asignatura de lengua<br/>indígena"]
    A1 & A2 & A3 & A4 --> D{{"determinar qué modalidad<br/>de educación<br/>intercultural bilingüe<br/>corresponde a tu<br/>establecimiento y…"}}
    D --> E["Evidencia de aprendizaje<br/>una propuesta de<br/>implementación con<br/>modalidad, condiciones,<br/>personas y evaluación de<br/>pertinencia"]
