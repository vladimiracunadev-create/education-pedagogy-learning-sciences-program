# Clase 274 — Segregación escolar y efecto par

> **Parte 22 · Diversidad cultural, lingüística y territorial** — clase 10 de 12
...
**Decisión que habilita:** determinar qué parte del resultado de tu establecimiento es efecto de composición y qué parte es efecto de su enseñanza<br>
**Evidencia de aprendizaje:** un análisis de resultados que distingue composición de valor agregado, con sus límites declarados

## 🎯 Propósito

Interpretar resultados escolares considerando composición y efecto par, y reconocer el nivel de segregación del sistema chileno como contexto de toda decisión.
...
2. **Explicar** qué parte del resultado de una escuela se explica por quiénes son sus estudiantes.
3. **Decidir** —qué parte del resultado de tu establecimiento es efecto de composición y qué parte es efecto de su enseñanza— y sostener la decisión con un fundamento escrito.
4. **Producir** la evidencia de la clase —un análisis de resultados que distingue composición de valor agregado, con sus límites declarados— y contrastarla contra el criterio de logro.
...
|---|---|
| **Segregación escolar** | distribución desigual de los estudiantes entre establecimientos según nivel socioeconómico o académico |
| **Efecto par** | influencia de la composición del grupo sobre el aprendizaje individual, independiente de la enseñanza recibida |
| **Valor agregado** | estimación del aporte del establecimiento al aprendizaje, descontando las características de entrada |
| **Composición de matrícula** | perfil agregado de los estudiantes de un establecimiento, principal predictor de sus resultados brutos |
...
2. Clasificar la situación distinguiendo **Segregación escolar** de **Efecto par**.
3. Decidir con fundamento, usando **Valor agregado** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Composición de matrícula** a la vista.
...
| **Evidencia de logro** | qué muestra un análisis de resultados que distingue composición de valor agregado, con sus límites declarados frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
Los modelos de valor agregado son estadísticamente exigentes, sensibles a los supuestos y con márgenes de error amplios para establecimientos pequeños. Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Segregación escolar"]
    C --> A2["Efecto par"]
    C --> A3["Valor agregado"]
    C --> A4["Composición de<br/>matrícula"]
    A1 & A2 & A3 & A4 --> D{{"determinar qué parte del<br/>resultado de tu<br/>establecimiento es<br/>efecto de composición y<br/>qué parte…"}}
    D --> E["Evidencia de aprendizaje<br/>un análisis de<br/>resultados que distingue<br/>composición de valor<br/>agregado, con sus<br/>límites…"]
...
El sistema escolar chileno presenta uno de los niveles de segregación socioeconómica más altos entre los países comparables, y eso condiciona la lectura de cualquier resultado. Los rankings de establecimientos por puntaje bruto miden en buena medida composición de matrícula, no calidad de enseñanza. El efecto par existe y está documentado, aunque su magnitud es objeto de discusión metodológica seria porque es difícil separarlo de la selección.

### 2. Frontera conceptual: qué es y qué no es

Los cuatro conceptos de esta clase se confunden entre sí con facilidad, y esa confusión no es
inocua: produce decisiones que atacan el problema equivocado. **Segregación escolar** no es lo
mismo que **Efecto par** —influencia de la composición del grupo sobre el aprendizaje individual, independiente de la enseñanza recibida—, y tratarlos como sinónimos hace
que la intervención se dirija al lugar incorrecto. Del mismo modo, **Valor agregado** y
**Composición de matrícula** describen aspectos distintos de la misma situación: el primero
estimación del aporte del establecimiento al aprendizaje, descontando las características de entrada, mientras el segundo perfil agregado de los estudiantes de un establecimiento, principal predictor de sus resultados brutos.
...
- **Evidencia de logro.** Qué muestra un análisis de resultados que distingue composición de valor agregado, con sus límites declarados frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
Un análisis profesional distingue tres niveles: resultado bruto, resultado comparado con establecimientos de composición similar, y progreso del mismo grupo de estudiantes en el tiempo. Solo el tercero se acerca a informar sobre el aporte de la enseñanza. Para un equipo directivo, esa distinción cambia las decisiones: perseguir el puntaje bruto conduce a seleccionar estudiantes; perseguir el progreso conduce a mejorar la enseñanza.

### 5. Qué sostiene la evidencia y qué no

Los modelos de valor agregado son estadísticamente exigentes, sensibles a los supuestos y con márgenes de error amplios para establecimientos pequeños. Usarlos para juzgar a docentes individuales carece de respaldo suficiente. Y separar efecto par de selección es un problema no resuelto: buena parte de lo que se atribuye al efecto par puede reflejar decisiones de las familias.
...
te deja en condiciones de qué parte del resultado de tu establecimiento es efecto de composición y qué parte es efecto de su enseñanza, y esa decisión se sostiene solo si
...
|---|---|---|
| Bellei, C. (2013). *El estudio de la segregación socioeconómica y académica de la educación chilena*. | cuantifica el contexto en que operan todas las decisiones pedagógicas del sistema. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
| Angrist, J. & Pischke, J.-S. (2009). *Mostly Harmless Econometrics*. | por qué separar efecto causal de selección es difícil y qué se puede afirmar con cada diseño. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Segregación escolar** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Segregación escolar de Efecto par.** El trabajo aquí es separar lo observado de lo interpretado sobre **Efecto par**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Valor agregado como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Valor agregado**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.

**Paso 4 — Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con Composición de matrícula a la vista.** Con **Composición de matrícula** ya delimitado, la pregunta pasa a ser de consecuencia: qué cambia para los estudiantes, para el tiempo de clase y para la carga del equipo. **Evidencia de partida** entrega la lectura observable; el juicio profesional sigue siendo humano y debe quedar firmado por quien lo hace.
...
|---|---|---|---|
| Intervenir sobre **Segregación escolar** | Distribución desigual de los estudiantes entre establecimientos según nivel socioeconómico o académico | Cuando **Evidencia de partida** es observable y accionable dentro del plazo de la decisión. | Sobrerreaccionar a una señal parcial. |
| Intervenir sobre **Efecto par** | Influencia de la composición del grupo sobre el aprendizaje individual, independiente de la enseñanza recibida | Cuando la primera explicación no distingue mecanismo ni responsable. | Convertir el concepto en etiqueta y no en intervención. |
| Observar antes de decidir | Reducir la incertidumbre antes de comprometer tiempo y credibilidad | Cuando la decisión es reversible y la evidencia disponible no distingue causas. | Observar indefinidamente y no decidir nunca. |
| Derivar o escalar | Poner la decisión donde están la competencia y la responsabilidad | Cuando hay normativa, resguardo de datos, salud o vulneración de derechos en juego. | Delegar hacia arriba lo que sí correspondía decidir en el aula. |

**Frontera de aplicación.** Los modelos de valor agregado son estadísticamente exigentes, sensibles a los supuestos y con márgenes de error amplios para establecimientos pequeños. Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre segregación escolar y efecto par |
|---|---|
...
Un análisis de resultados que distingue composición de valor agregado, con sus límites declarados.

Guárdala en `evidence/P22-C274-segregacion-escolar-y-efecto-par/` con estos archivos:
...
Analiza los resultados de un establecimiento en los tres niveles. Escribe qué se puede y qué no se puede concluir sobre su enseñanza.
...
- [ ] el análisis distingue resultado bruto, comparación con pares y progreso del mismo grupo;
- [ ] los límites de la inferencia están declarados explícitamente;
...
- Comparar establecimientos por puntaje bruto y concluir sobre la calidad de su enseñanza.
- Usar estimaciones de valor agregado para evaluar el desempeño de un docente individual.
...
La segregación es el mecanismo por el cual el sistema concentra las dificultades en los mismos establecimientos. Ignorarlo lleva a exigir a esas escuelas resultados que dependen de condiciones que no controlan.
...
1. ¿Con qué establecimientos es legítimo compararte y por qué?
2. ¿Qué sabes del progreso de tus mismos estudiantes entre un año y otro?
3. ¿Qué decisión tomarías distinto si persiguieras progreso en vez de puntaje?
...
Se apoya en la clase 011 y prepara la 275. Se articula con las partes 15 y 16.
...
|---|---|---|
| [← 273 · Aula multigrado: varios niveles a la vez](../class-09-aula-multigrado-varios-niveles-a-la-vez/README.md) | [Parte 22](../README.md) · [Programa](../../../README.md) | [275 · Financiamiento, recursos y decisiones pedagógicas →](../class-11-financiamiento-recursos-y-decisiones-pedagogicas/README.md) |
