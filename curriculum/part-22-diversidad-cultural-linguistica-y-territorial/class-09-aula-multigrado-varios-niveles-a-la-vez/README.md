...
**Decisión que habilita:** determinar la estructura de tu clase multigrado: qué es común, qué se diferencia y quién trabaja con quién<br>
...
flowchart TB
    ...
    C --> A1["Aula multigrado"]
    C --> A2["Tarea común con<br/>niveles"]
    C --> A3["Tutoría entre pares"]
    C --> A4["Rotación de atención"]
    A1 & A2 & A3 & A4 --> D{{"determinar la estructura<br/>de tu clase multigrado:<br/>qué es común, qué se<br/>diferencia y quién…"}}
    D --> E["Evidencia de aprendizaje<br/>una planificación<br/>multigrado con tarea<br/>común, tres niveles de<br/>exigencia y organización<br/>de la…"]
