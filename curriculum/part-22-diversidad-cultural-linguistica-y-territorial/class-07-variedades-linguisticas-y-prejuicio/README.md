# Clase 271 — Variedades lingüísticas y prejuicio

> **Parte 22 · Diversidad cultural, lingüística y territorial** — clase 7 de 12
...
**Decisión que habilita:** determinar qué corriges como error y qué corresponde a una variedad legítima del castellano<br>
**Evidencia de aprendizaje:** un criterio de corrección lingüística explícito, aplicado a producciones reales de tus estudiantes

## 🎯 Propósito

Distinguir variedad lingüística de error, enseñar el registro formal sin desvalorizar la lengua del hogar y reconocer el efecto de la corrección sobre la identidad.
...
2. **Explicar** qué enseña una escuela cuando corrige cómo habla un estudiante.
3. **Decidir** —qué corriges como error y qué corresponde a una variedad legítima del castellano— y sostener la decisión con un fundamento escrito.
4. **Producir** la evidencia de la clase —un criterio de corrección lingüística explícito, aplicado a producciones reales de tus estudiantes— y contrastarla contra el criterio de logro.
...
|---|---|
| **Variedad lingüística** | forma de una lengua asociada a un territorio o grupo social, con sistema propio y plenamente gramatical |
| **Registro formal** | variedad usada en contextos institucionales y académicos, que la escuela debe enseñar explícitamente |
| **Prejuicio lingüístico** | valoración negativa de una variedad, presentada como juicio sobre corrección y no sobre origen social |
| **Repertorio ampliado** | objetivo de agregar registros sin sustituir la variedad de origen |
...
2. Clasificar la situación distinguiendo **Variedad lingüística** de **Registro formal**.
3. Decidir con fundamento, usando **Prejuicio lingüístico** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Repertorio ampliado** a la vista.
...
| **Evidencia de logro** | qué muestra un criterio de corrección lingüística explícito, aplicado a producciones reales de tus estudiantes frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
El equilibrio es delicado y no admite fórmula: Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Variedad lingüística"]
    C --> A2["Registro formal"]
    C --> A3["Prejuicio lingüístico"]
    C --> A4["Repertorio ampliado"]
    A1 & A2 & A3 & A4 --> D{{"determinar qué corriges<br/>como error y qué<br/>corresponde a una<br/>variedad legítima del<br/>castellano"}}
    D --> E["Evidencia de aprendizaje<br/>un criterio de<br/>corrección lingüística<br/>explícito, aplicado a<br/>producciones reales de<br/>tus…"]
...
La lingüística estableció hace décadas que las variedades de una lengua son sistemas completos y regulares, y que la jerarquía entre ellas es social y no gramatical. La escuela suele operar con el supuesto contrario: trata las formas propias de la variedad del estudiante como errores, y lo corrige en términos de corrección y no de contexto de uso. El efecto documentado no es solo lingüístico, sino de participación: los estudiantes corregidos por su forma de hablar hablan menos.

### 2. Frontera conceptual: qué es y qué no es

Los cuatro conceptos de esta clase se confunden entre sí con facilidad, y esa confusión no es
inocua: produce decisiones que atacan el problema equivocado. **Variedad lingüística** no es lo
mismo que **Registro formal** —variedad usada en contextos institucionales y académicos, que la escuela debe enseñar explícitamente—, y tratarlos como sinónimos hace
que la intervención se dirija al lugar incorrecto. Del mismo modo, **Prejuicio lingüístico** y
**Repertorio ampliado** describen aspectos distintos de la misma situación: el primero
valoración negativa de una variedad, presentada como juicio sobre corrección y no sobre origen social, mientras el segundo objetivo de agregar registros sin sustituir la variedad de origen.
...
- **Evidencia de logro.** Qué muestra un criterio de corrección lingüística explícito, aplicado a producciones reales de tus estudiantes frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
El criterio profesional distingue tres cosas: errores propiamente tales, formas de otra variedad y adecuación al registro exigido. La enseñanza del registro formal es obligación de la escuela —privar de él es negar acceso—, pero se enseña como ampliación del repertorio y no como sustitución. En la práctica, eso significa nombrar el contexto: aquí se escribe así, y esa forma que usas es correcta en otro contexto.

### 5. Qué sostiene la evidencia y qué no

El equilibrio es delicado y no admite fórmula: exigir siempre el registro formal excluye, y no exigirlo nunca priva del acceso a los contextos que lo requieren. La investigación sobre el efecto de distintas estrategias de corrección en el aprendizaje del registro formal es limitada, y buena parte del debate se sostiene en argumentos de derechos más que en evidencia de resultados.
...
te deja en condiciones de qué corriges como error y qué corresponde a una variedad legítima del castellano, y esa decisión se sostiene solo si
...
|---|---|---|
| Labov, W. (1972). *The Logic of Nonstandard English*. | el texto que estableció que las variedades no estándar son sistemas plenamente lógicos. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
| Delpit, L. (1988). *The Silenced Dialogue*. | argumenta por qué no enseñar los códigos de poder es también una forma de exclusión. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Variedad lingüística** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Variedad lingüística de Registro formal.** El trabajo aquí es separar lo observado de lo interpretado sobre **Registro formal**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Prejuicio lingüístico como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Prejuicio lingüístico**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.

**Paso 4 — Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con Repertorio ampliado a la vista.** Con **Repertorio ampliado** ya delimitado, la pregunta pasa a ser de consecuencia: qué cambia para los estudiantes, para el tiempo de clase y para la carga del equipo. **Evidencia de partida** entrega la lectura observable; el juicio profesional sigue siendo humano y debe quedar firmado por quien lo hace.
...
|---|---|---|---|
| Intervenir sobre **Variedad lingüística** | Forma de una lengua asociada a un territorio o grupo social, con sistema propio y plenamente gramatical | Cuando **Evidencia de partida** es observable y accionable dentro del plazo de la decisión. | Sobrerreaccionar a una señal parcial. |
| Intervenir sobre **Registro formal** | Variedad usada en contextos institucionales y académicos, que la escuela debe enseñar explícitamente | Cuando la primera explicación no distingue mecanismo ni responsable. | Convertir el concepto en etiqueta y no en intervención. |
| Observar antes de decidir | Reducir la incertidumbre antes de comprometer tiempo y credibilidad | Cuando la decisión es reversible y la evidencia disponible no distingue causas. | Observar indefinidamente y no decidir nunca. |
| Derivar o escalar | Poner la decisión donde están la competencia y la responsabilidad | Cuando hay normativa, resguardo de datos, salud o vulneración de derechos en juego. | Delegar hacia arriba lo que sí correspondía decidir en el aula. |

**Frontera de aplicación.** El equilibrio es delicado y no admite fórmula: Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre variedades lingüísticas y prejuicio |
|---|---|
...
Un criterio de corrección lingüística explícito, aplicado a producciones reales de tus estudiantes.

Guárdala en `evidence/P22-C271-variedades-linguisticas-y-prejuicio/` con estos archivos:
...
Revisa tus correcciones de una semana y clasifícalas en error, variedad y registro. Cambia tu forma de corregir la segunda categoría y observa la participación oral.
...
- [ ] el criterio distingue error, variedad y adecuación de registro con ejemplos propios;
- [ ] la corrección nombra el contexto de uso en vez de calificar la forma como incorrecta;
...
- Corregir públicamente la variedad del estudiante como si fuera un error de conocimiento.
- Renunciar a enseñar el registro formal y dejar al estudiante sin acceso a contextos que lo exigen.
...
El prejuicio lingüístico opera sobre estudiantes rurales, migrantes y de sectores populares, y se ejerce con la apariencia de una corrección técnica. Es una de las formas de discriminación escolar más difíciles de nombrar.
...
1. ¿Cuál de tus correcciones frecuentes es en realidad una variedad legítima?
2. ¿Qué estudiante de tu curso habla menos desde que lo corregiste?
3. ¿Dónde enseñas explícitamente el registro formal que exiges?
...
Se apoya en las clases 265 y 269, y se articula con la parte 18 y con la clase 272.
...
|---|---|---|
| [← 270 · Enseñanza de lenguas extranjeras](../class-06-ensenanza-de-lenguas-extranjeras/README.md) | [Parte 22](../README.md) · [Programa](../../../README.md) | [272 · Educación rural: territorio y pertinencia →](../class-08-educacion-rural-territorio-y-pertinencia/README.md) |
