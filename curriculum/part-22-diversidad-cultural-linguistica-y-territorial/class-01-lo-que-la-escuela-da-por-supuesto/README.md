# Clase 265 — Lo que la escuela da por supuesto

> **Parte 22 · Diversidad cultural, lingüística y territorial** — clase 1 de 12
...
**Decisión que habilita:** determinar qué supone tu material sobre la vida de tus estudiantes y qué cambia si ese supuesto no se cumple<br>
**Evidencia de aprendizaje:** una revisión de un material o instrumento con sus supuestos identificados y corregidos

## 🎯 Propósito

Hacer visibles los supuestos culturales de la enseñanza y corregir los que convierten la diferencia en déficit.
...
2. **Explicar** qué estudiante imagina tu material cuando lo escribes, y quién queda fuera de esa imagen.
3. **Decidir** —qué supone tu material sobre la vida de tus estudiantes y qué cambia si ese supuesto no se cumple— y sostener la decisión con un fundamento escrito.
4. **Producir** la evidencia de la clase —una revisión de un material o instrumento con sus supuestos identificados y corregidos— y contrastarla contra el criterio de logro.
...
|---|---|
| **Supuesto implícito** | condición que un material da por cumplida sin declararla: lengua del hogar, espacio de estudio, familiaridad con el ejemplo |
| **Capital cultural** | conjunto de referencias, códigos y disposiciones valoradas por la escuela y distribuidas de manera desigual |
| **Interpretación deficitaria** | lectura que atribuye a carencia del estudiante lo que es desajuste entre su experiencia y el supuesto escolar |
| **Fondos de conocimiento** | saberes acumulados en la familia y la comunidad, utilizables como recurso de enseñanza |
...
2. Clasificar la situación distinguiendo **Supuesto implícito** de **Capital cultural**.
3. Decidir con fundamento, usando **Interpretación deficitaria** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Fondos de conocimiento** a la vista.
...
| **Evidencia de logro** | qué muestra una revisión de un material o instrumento con sus supuestos identificados y corregidos frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
Explicitar supuestos no elimina la desigualdad de origen, que es estructural y excede al aula. Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Supuesto implícito"]
    C --> A2["Capital cultural"]
    C --> A3["Interpretación<br/>deficitaria"]
    C --> A4["Fondos de conocimiento"]
    A1 & A2 & A3 & A4 --> D{{"determinar qué supone tu<br/>material sobre la vida<br/>de tus estudiantes y qué<br/>cambia si ese supuesto…"}}
    D --> E["Evidencia de aprendizaje<br/>una revisión de un<br/>material o instrumento<br/>con sus supuestos<br/>identificados y<br/>corregidos"]
...
Todo material educativo imagina un destinatario. Ese destinatario habla la lengua de instrucción en casa, reconoce los ejemplos, dispone de un lugar para estudiar y tiene adultos que conocen cómo funciona el sistema escolar. Cuando el estudiante real no coincide, la diferencia se interpreta como carencia: no sabe, no se esfuerza, no tiene apoyo. La corrección profesional no es bajar la exigencia sino explicitar el supuesto y decidir si se sostiene, se enseña o se reemplaza.

### 2. Frontera conceptual: qué es y qué no es

Los cuatro conceptos de esta clase se confunden entre sí con facilidad, y esa confusión no es
inocua: produce decisiones que atacan el problema equivocado. **Supuesto implícito** no es lo
mismo que **Capital cultural** —conjunto de referencias, códigos y disposiciones valoradas por la escuela y distribuidas de manera desigual—, y tratarlos como sinónimos hace
que la intervención se dirija al lugar incorrecto. Del mismo modo, **Interpretación deficitaria** y
**Fondos de conocimiento** describen aspectos distintos de la misma situación: el primero
lectura que atribuye a carencia del estudiante lo que es desajuste entre su experiencia y el supuesto escolar, mientras el segundo saberes acumulados en la familia y la comunidad, utilizables como recurso de enseñanza.
...
- **Evidencia de logro.** Qué muestra una revisión de un material o instrumento con sus supuestos identificados y corregidos frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
La revisión de material se hace con preguntas concretas: qué conocimiento previo no escolar exige el ejemplo, qué referencia cultural asume, qué condiciones materiales requiere la tarea para la casa, qué variedad de la lengua trata como correcta. Cada supuesto detectado admite tres salidas: mantenerlo y enseñarlo explícitamente, reemplazarlo por uno más accesible, o declararlo como contenido de la clase. El enfoque de fondos de conocimiento agrega la vía más productiva: convertir el saber de la familia en material.

### 5. Qué sostiene la evidencia y qué no

Explicitar supuestos no elimina la desigualdad de origen, que es estructural y excede al aula. Existe además el riesgo opuesto: adaptar tanto el material al contexto inmediato que se priva al estudiante del acceso a los códigos que la sociedad efectivamente exige. La posición defendible es enseñar esos códigos explícitamente en vez de suponerlos o de renunciar a ellos.
...
te deja en condiciones de qué supone tu material sobre la vida de tus estudiantes y qué cambia si ese supuesto no se cumple, y esa decisión se sostiene solo si
...
|---|---|---|
| Moll, L. et al. (1992). *Funds of Knowledge for Teaching*. | convierte el saber familiar en recurso de enseñanza en vez de en obstáculo. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
| Bourdieu, P. & Passeron, J.-C. (1970). *La reproducción*. | explica el mecanismo por el cual la escuela premia un capital cultural que no distribuye. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Supuesto implícito** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Supuesto implícito de Capital cultural.** El trabajo aquí es separar lo observado de lo interpretado sobre **Capital cultural**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Interpretación deficitaria como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Interpretación deficitaria**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.

**Paso 4 — Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con Fondos de conocimiento a la vista.** Con **Fondos de conocimiento** ya delimitado, la pregunta pasa a ser de consecuencia: qué cambia para los estudiantes, para el tiempo de clase y para la carga del equipo. **Evidencia de partida** entrega la lectura observable; el juicio profesional sigue siendo humano y debe quedar firmado por quien lo hace.
...
|---|---|---|---|
| Intervenir sobre **Supuesto implícito** | Condición que un material da por cumplida sin declararla: lengua del hogar, espacio de estudio, familiaridad con el ejemplo | Cuando **Evidencia de partida** es observable y accionable dentro del plazo de la decisión. | Sobrerreaccionar a una señal parcial. |
| Intervenir sobre **Capital cultural** | Conjunto de referencias, códigos y disposiciones valoradas por la escuela y distribuidas de manera desigual | Cuando la primera explicación no distingue mecanismo ni responsable. | Convertir el concepto en etiqueta y no en intervención. |
| Observar antes de decidir | Reducir la incertidumbre antes de comprometer tiempo y credibilidad | Cuando la decisión es reversible y la evidencia disponible no distingue causas. | Observar indefinidamente y no decidir nunca. |
| Derivar o escalar | Poner la decisión donde están la competencia y la responsabilidad | Cuando hay normativa, resguardo de datos, salud o vulneración de derechos en juego. | Delegar hacia arriba lo que sí correspondía decidir en el aula. |

**Frontera de aplicación.** Explicitar supuestos no elimina la desigualdad de origen, que es estructural y excede al aula. Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre lo que la escuela da por supuesto |
|---|---|
...
Una revisión de un material o instrumento con sus supuestos identificados y corregidos.

Guárdala en `evidence/P22-C265-lo-que-la-escuela-da-por-supuesto/` con estos archivos:
...
Revisa una evaluación tuya buscando supuestos culturales y de contexto. Corrige tres y aplica la versión nueva comparando los resultados.
...
- [ ] la revisión identifica al menos tres supuestos concretos con su corrección declarada;
- [ ] la corrección mantiene la exigencia de aprendizaje y no la reduce;
...
- Interpretar el desajuste con el supuesto escolar como falta de capacidad o de interés.
- Renunciar a los códigos académicos en nombre de la pertinencia y dejar al estudiante sin acceso a ellos.
...
Esta clase es el fundamento de toda la parte: la mayoría de las decisiones que excluyen no son deliberadas, son supuestos no examinados que operan en el material, en el ejemplo y en la evaluación.
...
1. ¿Qué asume tu tarea para la casa sobre el espacio y los adultos disponibles?
2. ¿Qué ejemplo de tu material sería incomprensible para un estudiante llegado hace un año?
3. ¿Qué saber de las familias de tu curso podría ser material de clase?
...
Abre la parte 22 y ordena las clases siguientes. Se apoya en las clases 010 y 011 y en la 235.
...
|---|---|---|
| [← Parte 22](../README.md) | [Parte 22](../README.md) · [Programa](../../../README.md) | [266 · Educación intercultural: del folclor al diálogo de saberes →](../class-02-educacion-intercultural-del-folclor-al-dialogo-de-saberes/README.md) |
