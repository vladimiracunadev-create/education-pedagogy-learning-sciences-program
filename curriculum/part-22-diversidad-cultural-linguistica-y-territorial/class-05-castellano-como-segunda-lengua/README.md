# Clase 269 — Castellano como segunda lengua

> **Parte 22 · Diversidad cultural, lingüística y territorial** — clase 5 de 12
...
**Decisión que habilita:** determinar qué demanda lingüística tiene tu asignatura y cómo la enseñas explícitamente<br>
**Evidencia de aprendizaje:** una planificación con andamiaje lingüístico declarado por tipo de texto y de tarea

## 🎯 Propósito

Enseñar el castellano académico de forma deliberada mientras el estudiante aprende contenidos en esa misma lengua.
...
2. **Explicar** por qué un estudiante que conversa con fluidez puede seguir sin entender la clase.
3. **Decidir** —qué demanda lingüística tiene tu asignatura y cómo la enseñas explícitamente— y sostener la decisión con un fundamento escrito.
4. **Producir** la evidencia de la clase —una planificación con andamiaje lingüístico declarado por tipo de texto y de tarea— y contrastarla contra el criterio de logro.
...
|---|---|
| **Lengua conversacional** | dominio suficiente para la interacción cotidiana, que se adquiere en meses |
| **Lengua académica** | registro formal, descontextualizado y específico de cada disciplina, cuya adquisición toma varios años |
| **Andamiaje lingüístico** | apoyos explícitos —estructuras, conectores, modelos de texto— que permiten producir el registro exigido |
| **Doble carga** | situación de aprender un contenido nuevo en una lengua que también se está aprendiendo |
...
2. Clasificar la situación distinguiendo **Lengua conversacional** de **Lengua académica**.
3. Decidir con fundamento, usando **Andamiaje lingüístico** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Doble carga** a la vista.
...
| **Evidencia de logro** | qué muestra una planificación con andamiaje lingüístico declarado por tipo de texto y de tarea frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
Los plazos estimados de adquisición del registro académico varían mucho según edad de llegada, escolaridad previa y contexto, y usarlos como norma rígida produce expectativas equivocadas. Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Lengua conversacional"]
    C --> A2["Lengua académica"]
    C --> A3["Andamiaje lingüístico"]
    C --> A4["Doble carga"]
    A1 & A2 & A3 & A4 --> D{{"determinar qué demanda<br/>lingüística tiene tu<br/>asignatura y cómo la<br/>enseñas explícitamente"}}
    D --> E["Evidencia de aprendizaje<br/>una planificación con<br/>andamiaje lingüístico<br/>declarado por tipo de<br/>texto y de tarea"]
...
La distinción entre lengua conversacional y lengua académica explica uno de los errores más frecuentes del sistema: un estudiante que conversa con soltura en el recreo es considerado hablante competente, y su bajo rendimiento se atribuye a capacidad o a esfuerzo. La investigación disponible indica que el registro académico requiere varios años más que el conversacional, y que sin enseñanza explícita esa brecha puede persistir durante toda la escolaridad.

### 2. Frontera conceptual: qué es y qué no es

Los cuatro conceptos de esta clase se confunden entre sí con facilidad, y esa confusión no es
inocua: produce decisiones que atacan el problema equivocado. **Lengua conversacional** no es lo
mismo que **Lengua académica** —registro formal, descontextualizado y específico de cada disciplina, cuya adquisición toma varios años—, y tratarlos como sinónimos hace
que la intervención se dirija al lugar incorrecto. Del mismo modo, **Andamiaje lingüístico** y
**Doble carga** describen aspectos distintos de la misma situación: el primero
apoyos explícitos —estructuras, conectores, modelos de texto— que permiten producir el registro exigido, mientras el segundo situación de aprender un contenido nuevo en una lengua que también se está aprendiendo.
...
- **Evidencia de logro.** Qué muestra una planificación con andamiaje lingüístico declarado por tipo de texto y de tarea frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
Enseñar el registro académico es tarea de cada asignatura, no del profesor de lenguaje. Implica declarar qué tipo de texto exige la tarea, entregar modelos, enseñar los conectores y las estructuras propias del campo, y aceptar producciones donde el contenido esté correcto aunque la forma aún no lo esté. El vocabulario técnico se enseña de forma explícita, y las evaluaciones separan lo que miden: comprensión del contenido o dominio de la lengua.

### 5. Qué sostiene la evidencia y qué no

Los plazos estimados de adquisición del registro académico varían mucho según edad de llegada, escolaridad previa y contexto, y usarlos como norma rígida produce expectativas equivocadas. La investigación proviene mayoritariamente de contextos anglófonos con programas estructurados que en Chile rara vez existen. Y hay riesgo de sobreatribuir a la lengua dificultades que son de trayectoria escolar interrumpida.
...
te deja en condiciones de qué demanda lingüística tiene tu asignatura y cómo la enseñas explícitamente, y esa decisión se sostiene solo si
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Lengua conversacional** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Lengua conversacional de Lengua académica.** El trabajo aquí es separar lo observado de lo interpretado sobre **Lengua académica**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Andamiaje lingüístico como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Andamiaje lingüístico**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.

**Paso 4 — Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con Doble carga a la vista.** Con **Doble carga** ya delimitado, la pregunta pasa a ser de consecuencia: qué cambia para los estudiantes, para el tiempo de clase y para la carga del equipo. **Evidencia de partida** entrega la lectura observable; el juicio profesional sigue siendo humano y debe quedar firmado por quien lo hace.
...
|---|---|---|---|
| Intervenir sobre **Lengua conversacional** | Dominio suficiente para la interacción cotidiana, que se adquiere en meses | Cuando **Evidencia de partida** es observable y accionable dentro del plazo de la decisión. | Sobrerreaccionar a una señal parcial. |
| Intervenir sobre **Lengua académica** | Registro formal, descontextualizado y específico de cada disciplina, cuya adquisición toma varios años | Cuando la primera explicación no distingue mecanismo ni responsable. | Convertir el concepto en etiqueta y no en intervención. |
| Observar antes de decidir | Reducir la incertidumbre antes de comprometer tiempo y credibilidad | Cuando la decisión es reversible y la evidencia disponible no distingue causas. | Observar indefinidamente y no decidir nunca. |
| Derivar o escalar | Poner la decisión donde están la competencia y la responsabilidad | Cuando hay normativa, resguardo de datos, salud o vulneración de derechos en juego. | Delegar hacia arriba lo que sí correspondía decidir en el aula. |

**Frontera de aplicación.** Los plazos estimados de adquisición del registro académico varían mucho según edad de llegada, escolaridad previa y contexto, y usarlos como norma rígida produce expectativas equivocadas. Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre castellano como segunda lengua |
|---|---|
...
Una planificación con andamiaje lingüístico declarado por tipo de texto y de tarea.

Guárdala en `evidence/P22-C269-castellano-como-segunda-lengua/` con estos archivos:
...
Identifica la demanda lingüística de tu próxima evaluación. Diseña el andamiaje y compara el resultado del estudiante con la evaluación anterior.
...
- [ ] la planificación declara la demanda lingüística de cada tarea y su andamiaje;
- [ ] la evaluación separa el dominio del contenido del dominio de la lengua;
...
- Concluir que domina el castellano porque conversa con fluidez, y evaluar en consecuencia.
- Delegar la enseñanza del registro académico al docente de lenguaje y evaluarlo en todas las asignaturas.
...
1. ¿Qué tipo de texto exige tu evaluación y dónde lo enseñaste?
2. ¿Cuánto de la calificación de este estudiante refleja contenido y cuánto refleja lengua?
3. ¿Qué vocabulario técnico das por conocido en tu asignatura?
...
Continúa la clase 268 y se articula con la 249 y con la parte 18. Prepara la clase 270.
...
|---|---|---|
| [← 268 · Estudiantes migrantes: acogida, trayectoria y derechos](../class-04-estudiantes-migrantes-acogida-trayectoria-y-derechos/README.md) | [Parte 22](../README.md) · [Programa](../../../README.md) | [270 · Enseñanza de lenguas extranjeras →](../class-06-ensenanza-de-lenguas-extranjeras/README.md) |
