# Clase 276 — Proyecto integrador: plan de pertinencia cultural y territorial

> **Parte 22 · Diversidad cultural, lingüística y territorial** — clase 12 de 12
...
**Decisión que habilita:** determinar el plan de pertinencia del establecimiento y qué evidencia mostrará que cambió algo<br>
**Evidencia de aprendizaje:** un plan de pertinencia con acogida lingüística, adecuación territorial, uso de recursos y evidencia comprometida

## 🎯 Propósito

Integrar la parte en un plan de pertinencia cultural, lingüística y territorial con acciones, responsables y evidencia.
...
2. **Explicar** cómo se convierte el reconocimiento de la diversidad en decisiones que se pueden verificar.
3. **Decidir** —el plan de pertinencia del establecimiento y qué evidencia mostrará que cambió algo— y sostener la decisión con un fundamento escrito.
4. **Producir** la evidencia de la clase —un plan de pertinencia con acogida lingüística, adecuación territorial, uso de recursos y evidencia comprometida— y contrastarla contra el criterio de logro.
...
|---|---|
| **Plan de pertinencia** | documento que articula las decisiones sobre diversidad cultural, lingüística y territorial de un establecimiento |
| **Acción verificable** | decisión con responsable, plazo y evidencia comprometida, distinguible de una declaración de principios |
| **Consulta a la comunidad** | participación de familias y organizaciones en las decisiones que las involucran |
| **Indicador desagregado** | medida presentada por grupo, que revela lo que el promedio oculta |
...
2. Clasificar la situación distinguiendo **Plan de pertinencia** de **Acción verificable**.
3. Decidir con fundamento, usando **Consulta a la comunidad** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Indicador desagregado** a la vista.
...
| **Evidencia de logro** | qué muestra un plan de pertinencia con acogida lingüística, adecuación territorial, uso de recursos y evidencia comprometida frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
El plan no modifica las condiciones estructurales —segregación, financiamiento, distribución territorial de la oferta— que producen buena parte de las desigualdades que intenta atender. Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Plan de pertinencia"]
    C --> A2["Acción verificable"]
    C --> A3["Consulta a la<br/>comunidad"]
    C --> A4["Indicador desagregado"]
    A1 & A2 & A3 & A4 --> D{{"determinar el plan de<br/>pertinencia del<br/>establecimiento y qué<br/>evidencia mostrará que<br/>cambió algo"}}
    D --> E["Evidencia de aprendizaje<br/>un plan de pertinencia<br/>con acogida lingüística,<br/>adecuación territorial,<br/>uso de recursos y…"]
...
Los proyectos educativos institucionales declaran casi siempre respeto por la diversidad, y esa declaración rara vez se traduce en decisiones verificables. El plan de esta parte se propone lo contrario: convertir el reconocimiento en acciones concretas —acogida lingüística, adecuación de material, articulación con la comunidad, uso justificado de recursos— con responsables, plazos y evidencia. El criterio de calidad es simple: qué se hace distinto el lunes por efecto de este documento.

### 2. Frontera conceptual: qué es y qué no es

Los cuatro conceptos de esta clase se confunden entre sí con facilidad, y esa confusión no es
inocua: produce decisiones que atacan el problema equivocado. **Plan de pertinencia** no es lo
mismo que **Acción verificable** —decisión con responsable, plazo y evidencia comprometida, distinguible de una declaración de principios—, y tratarlos como sinónimos hace
que la intervención se dirija al lugar incorrecto. Del mismo modo, **Consulta a la comunidad** y
**Indicador desagregado** describen aspectos distintos de la misma situación: el primero
participación de familias y organizaciones en las decisiones que las involucran, mientras el segundo medida presentada por grupo, que revela lo que el promedio oculta.
...
- **Evidencia de logro.** Qué muestra un plan de pertinencia con acogida lingüística, adecuación territorial, uso de recursos y evidencia comprometida frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
El plan integra las once clases anteriores: revisión de supuestos del material, decisiones sobre interculturalidad y lengua, acogida de estudiantes migrantes, enseñanza del castellano académico, criterios de corrección lingüística, pertinencia territorial, planificación multigrado cuando corresponde, lectura correcta de resultados y uso fundamentado de recursos. Cada componente compromete una evidencia y una fecha. La consulta a la comunidad es parte del proceso, no un trámite posterior.

### 5. Qué sostiene la evidencia y qué no

El plan no modifica las condiciones estructurales —segregación, financiamiento, distribución territorial de la oferta— que producen buena parte de las desigualdades que intenta atender. Su alcance es el margen de decisión del establecimiento, que es real pero acotado. Declararlo evita presentar como solución lo que es una respuesta parcial.
...
te deja en condiciones de el plan de pertinencia del establecimiento y qué evidencia mostrará que cambió algo, y esa decisión se sostiene solo si
...
|---|---|---|
| Booth, T. & Ainscow, M. (2011). *Index for Inclusion*. | el instrumento que convierte principios de inclusión en indicadores revisables. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
| Ladson-Billings, G. (1995). *Toward a Theory of Culturally Relevant Pedagogy*. | los criterios que permiten juzgar si una propuesta es pertinente o solo bienintencionada. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Plan de pertinencia** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Plan de pertinencia de Acción verificable.** El trabajo aquí es separar lo observado de lo interpretado sobre **Acción verificable**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Consulta a la comunidad como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Consulta a la comunidad**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.

**Paso 4 — Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con Indicador desagregado a la vista.** Con **Indicador desagregado** ya delimitado, la pregunta pasa a ser de consecuencia: qué cambia para los estudiantes, para el tiempo de clase y para la carga del equipo. **Evidencia de partida** entrega la lectura observable; el juicio profesional sigue siendo humano y debe quedar firmado por quien lo hace.
...
|---|---|---|---|
| Intervenir sobre **Plan de pertinencia** | Documento que articula las decisiones sobre diversidad cultural, lingüística y territorial de un establecimiento | Cuando **Evidencia de partida** es observable y accionable dentro del plazo de la decisión. | Sobrerreaccionar a una señal parcial. |
| Intervenir sobre **Acción verificable** | Decisión con responsable, plazo y evidencia comprometida, distinguible de una declaración de principios | Cuando la primera explicación no distingue mecanismo ni responsable. | Convertir el concepto en etiqueta y no en intervención. |
| Observar antes de decidir | Reducir la incertidumbre antes de comprometer tiempo y credibilidad | Cuando la decisión es reversible y la evidencia disponible no distingue causas. | Observar indefinidamente y no decidir nunca. |
| Derivar o escalar | Poner la decisión donde están la competencia y la responsabilidad | Cuando hay normativa, resguardo de datos, salud o vulneración de derechos en juego. | Delegar hacia arriba lo que sí correspondía decidir en el aula. |

**Frontera de aplicación.** El plan no modifica las condiciones estructurales —segregación, financiamiento, distribución territorial de la oferta— que producen buena parte de las desigualdades que intenta atender. Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre proyecto integrador: plan de pertinencia cultural y territorial |
|---|---|
...
Un plan de pertinencia con acogida lingüística, adecuación territorial, uso de recursos y evidencia comprometida.

Guárdala en `evidence/P22-C276-proyecto-integrador/` con estos archivos:
...
Escribe el plan de pertinencia de un establecimiento con evidencia comprometida por acción. Consúltalo con al menos una familia de cada grupo involucrado.
...
- [ ] cada acción del plan tiene responsable, plazo y evidencia comprometida;
- [ ] los indicadores están desagregados por grupo y no solo en promedio;
...
- Redactar el plan sin consulta a las comunidades cuya realidad pretende atender.
- Comprometer acciones sin evidencia ni fecha, con lo que el plan no puede evaluarse.
...
1. ¿Qué se hace distinto el lunes por efecto de este plan?
2. ¿Qué comunidad fue consultada y qué cambió en el plan por esa consulta?
3. ¿Qué muestran tus indicadores cuando los desagregas por grupo?
...
Cierra la parte 22 integrando las clases 265 a 275, y se articula con las partes 08, 15 y 21.
...
|---|---|---|
| [← 275 · Financiamiento, recursos y decisiones pedagógicas](../class-11-financiamiento-recursos-y-decisiones-pedagogicas/README.md) | [Parte 22](../README.md) · [Programa](../../../README.md) | [Programa completo →](../../../README.md) |
