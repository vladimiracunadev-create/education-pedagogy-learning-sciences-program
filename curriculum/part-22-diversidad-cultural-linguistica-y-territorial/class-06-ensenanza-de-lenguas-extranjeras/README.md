# Clase 270 — Enseñanza de lenguas extranjeras

> **Parte 22 · Diversidad cultural, lingüística y territorial** — clase 6 de 12

**Estado de evidencia:** `CONSISTENTE` · **Etapa:** 🟤 Etapa F — Especialización y desafíos contemporáneos · **Población de referencia:** transversal, con foco en contextos interculturales, migrantes y rurales<br>
**Decisión que habilita:** determinar qué proporción de tu clase de lengua extranjera ocurre efectivamente en esa lengua y con qué propósito<br>
**Evidencia de aprendizaje:** un rediseño de clase con exposición comprensible, uso comunicativo y evaluación coherente

## 🎯 Propósito

Fundamentar decisiones de enseñanza de lenguas extranjeras en lo que se sabe sobre adquisición, exposición y uso comunicativo.
...
2. **Explicar** qué transfiere de la investigación sobre adquisición del lenguaje a la clase de inglés.
3. **Decidir** —qué proporción de tu clase de lengua extranjera ocurre efectivamente en esa lengua y con qué propósito— y sostener la decisión con un fundamento escrito.
4. **Producir** la evidencia de la clase —un rediseño de clase con exposición comprensible, uso comunicativo y evaluación coherente— y contrastarla contra el criterio de logro.
...
|---|---|
| **Insumo comprensible** | exposición a la lengua en un nivel ligeramente superior al actual, que permite inferir significado |
| **Uso comunicativo** | empleo de la lengua para transmitir contenido real, no para exhibir estructuras aprendidas |
| **Atención a la forma** | enseñanza explícita de estructuras dentro de un contexto de uso, y no como contenido aislado |
| **Tiempo de exposición** | cantidad acumulada de contacto con la lengua, principal limitante en contextos escolares |
...
2. Clasificar la situación distinguiendo **Insumo comprensible** de **Uso comunicativo**.
3. Decidir con fundamento, usando **Atención a la forma** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Tiempo de exposición** a la vista.
...
| **Evidencia de logro** | qué muestra un rediseño de clase con exposición comprensible, uso comunicativo y evaluación coherente frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
El debate sobre el peso de la instrucción explícita en adquisición sigue abierto y las posiciones extremas no se sostienen. Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Insumo comprensible"]
    C --> A2["Uso comunicativo"]
    C --> A3["Atención a la forma"]
    C --> A4["Tiempo de exposición"]
    A1 & A2 & A3 & A4 --> D{{"determinar qué<br/>proporción de tu clase<br/>de lengua extranjera<br/>ocurre efectivamente en<br/>esa lengua y…"}}
    D --> E["Evidencia de aprendizaje<br/>un rediseño de clase con<br/>exposición comprensible,<br/>uso comunicativo y<br/>evaluación coherente"]
...
La enseñanza escolar de lenguas extranjeras enfrenta una limitación estructural: el tiempo de exposición es muy inferior al que la adquisición requiere. Con dos o tres horas semanales, ninguna metodología produce dominio. Eso no invalida la enseñanza; obliga a decidir con realismo qué es alcanzable y a maximizar dos variables que sí dependen del docente: la cantidad de insumo comprensible y las oportunidades de uso comunicativo real dentro de la sala.

### 2. Frontera conceptual: qué es y qué no es

Los cuatro conceptos de esta clase se confunden entre sí con facilidad, y esa confusión no es
inocua: produce decisiones que atacan el problema equivocado. **Insumo comprensible** no es lo
mismo que **Uso comunicativo** —empleo de la lengua para transmitir contenido real, no para exhibir estructuras aprendidas—, y tratarlos como sinónimos hace
que la intervención se dirija al lugar incorrecto. Del mismo modo, **Atención a la forma** y
**Tiempo de exposición** describen aspectos distintos de la misma situación: el primero
enseñanza explícita de estructuras dentro de un contexto de uso, y no como contenido aislado, mientras el segundo cantidad acumulada de contacto con la lengua, principal limitante en contextos escolares.
...
- **Evidencia de logro.** Qué muestra un rediseño de clase con exposición comprensible, uso comunicativo y evaluación coherente frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
Las decisiones que más rinden son de proporción: cuánto de la clase ocurre en la lengua meta, cuánto insumo comprensible recibe el estudiante y cuántas oportunidades tiene de usarla para decir algo que le importe. La atención explícita a la forma tiene lugar, pero dentro del uso y no como contenido central. La evaluación debe medir capacidad comunicativa y no solo conocimiento metalingüístico, que es lo más fácil de examinar y lo menos indicativo.

### 5. Qué sostiene la evidencia y qué no

El debate sobre el peso de la instrucción explícita en adquisición sigue abierto y las posiciones extremas no se sostienen. Los resultados dependen fuertemente de la exposición fuera del aula, muy desigual según acceso a medios y a contextos de uso. Y las metas de los marcos de referencia europeos, usadas en muchos programas, suponen cargas horarias que la escuela chilena no tiene.
...
te deja en condiciones de qué proporción de tu clase de lengua extranjera ocurre efectivamente en esa lengua y con qué propósito, y esa decisión se sostiene solo si
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Insumo comprensible** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Insumo comprensible de Uso comunicativo.** El trabajo aquí es separar lo observado de lo interpretado sobre **Uso comunicativo**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Atención a la forma como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Atención a la forma**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.

**Paso 4 — Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con Tiempo de exposición a la vista.** Con **Tiempo de exposición** ya delimitado, la pregunta pasa a ser de consecuencia: qué cambia para los estudiantes, para el tiempo de clase y para la carga del equipo. **Evidencia de partida** entrega la lectura observable; el juicio profesional sigue siendo humano y debe quedar firmado por quien lo hace.
...
|---|---|---|---|
| Intervenir sobre **Insumo comprensible** | Exposición a la lengua en un nivel ligeramente superior al actual, que permite inferir significado | Cuando **Evidencia de partida** es observable y accionable dentro del plazo de la decisión. | Sobrerreaccionar a una señal parcial. |
| Intervenir sobre **Uso comunicativo** | Empleo de la lengua para transmitir contenido real, no para exhibir estructuras aprendidas | Cuando la primera explicación no distingue mecanismo ni responsable. | Convertir el concepto en etiqueta y no en intervención. |
| Observar antes de decidir | Reducir la incertidumbre antes de comprometer tiempo y credibilidad | Cuando la decisión es reversible y la evidencia disponible no distingue causas. | Observar indefinidamente y no decidir nunca. |
| Derivar o escalar | Poner la decisión donde están la competencia y la responsabilidad | Cuando hay normativa, resguardo de datos, salud o vulneración de derechos en juego. | Delegar hacia arriba lo que sí correspondía decidir en el aula. |

**Frontera de aplicación.** El debate sobre el peso de la instrucción explícita en adquisición sigue abierto y las posiciones extremas no se sostienen. Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre enseñanza de lenguas extranjeras |
|---|---|
...
Un rediseño de clase con exposición comprensible, uso comunicativo y evaluación coherente.

Guárdala en `evidence/P22-C270-ensenanza-de-lenguas-extranjeras/` con estos archivos:
...
Registra la proporción de tu clase que ocurre en la lengua meta. Rediséñala aumentando el insumo comprensible y compara la participación oral.
...
- [ ] el rediseño declara la proporción de clase en la lengua meta y su propósito;
- [ ] la evaluación mide uso comunicativo además de conocimiento de estructuras;
...
- Dictar la clase de lengua extranjera mayoritariamente en castellano y evaluar en la lengua meta.
- Evaluar conocimiento sobre la lengua en vez de capacidad de usarla.
...
La exposición extraescolar a la lengua extranjera está fuertemente asociada al nivel socioeconómico. Una clase que asume ese contacto previo convierte una ventaja de origen en mérito escolar.
...
1. ¿Qué porcentaje de tu última clase ocurrió realmente en la lengua meta?
2. ¿Cuántas veces usó cada estudiante la lengua para decir algo propio?
3. ¿Qué es alcanzable con las horas que efectivamente tienes?

## 📗 Fuentes y verificación

- Lightbown, P. & Spada, N. *How Languages Are Learned* (edición vigente). **Uso en esta clase:** la síntesis más clara de lo que la investigación sobre adquisición permite afirmar. Lectura selectiva: índice y capítulos pertinentes; registra edición y páginas consultadas. **Localizar:** [ISBN 9783464107362](https://openlibrary.org/isbn/9783464107362) · [ficha](../../../docs/REGISTRO_DE_FUENTES.md#lightbown-spada-how-languages-are-learned)
- Ellis, R. (2003). *Task-Based Language Learning and Teaching*. **Uso en esta clase:** el enfoque por tareas con sus condiciones de eficacia y sus críticas. Lectura selectiva: índice y capítulos pertinentes; registra edición y páginas consultadas. **Localizar:** [ISBN 9780194421591](https://openlibrary.org/isbn/9780194421591) · [ficha](../../../docs/REGISTRO_DE_FUENTES.md#ellis-2003-task-based-language-learning-and-teaching)
...
Se articula con la clase 269 y con la parte 10. Enlaza con la clase 271.
...
|---|---|---|
| [← 269 · Castellano como segunda lengua](../class-05-castellano-como-segunda-lengua/README.md) | [Parte 22](../README.md) · [Programa](../../../README.md) | [271 · Variedades lingüísticas y prejuicio →](../class-07-variedades-linguisticas-y-prejuicio/README.md) |
