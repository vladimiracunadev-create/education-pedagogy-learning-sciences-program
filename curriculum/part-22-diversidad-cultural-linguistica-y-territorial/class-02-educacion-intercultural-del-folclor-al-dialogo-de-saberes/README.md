# Clase 266 — Educación intercultural: del folclor al diálogo de saberes

> **Parte 22 · Diversidad cultural, lingüística y territorial** — clase 2 de 12
...
**Decisión que habilita:** determinar si tu propuesta intercultural toca el currículum o solo lo decora<br>
**Evidencia de aprendizaje:** una unidad que integra un saber cultural en el contenido disciplinar, con criterios de evaluación coherentes

## 🎯 Propósito

Diseñar enseñanza intercultural que ponga en diálogo sistemas de conocimiento, en vez de agregar contenido folclórico al currículum existente.
...
2. **Explicar** qué separa una educación intercultural de una semana temática con trajes típicos.
3. **Decidir** —si tu propuesta intercultural toca el currículum o solo lo decora— y sostener la decisión con un fundamento escrito.
4. **Producir** la evidencia de la clase —una unidad que integra un saber cultural en el contenido disciplinar, con criterios de evaluación coherentes— y contrastarla contra el criterio de logro.
...
|---|---|
| **Educación intercultural** | enfoque que reconoce y pone en relación distintos sistemas de conocimiento dentro del currículum |
| **Folclorización** | reducción de una cultura a sus manifestaciones visibles —comida, vestimenta, festividades— sin tocar el conocimiento |
| **Diálogo de saberes** | puesta en relación de sistemas de conocimiento distintos, con reconocimiento de la validez de ambos |
| **Pertinencia curricular** | grado en que el contenido enseñado se conecta con el territorio y la experiencia de los estudiantes |
...
2. Clasificar la situación distinguiendo **Educación intercultural** de **Folclorización**.
3. Decidir con fundamento, usando **Diálogo de saberes** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Pertinencia curricular** a la vista.
...
| **Evidencia de logro** | qué muestra una unidad que integra un saber cultural en el contenido disciplinar, con criterios de evaluación coherentes frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
El enfoque exige conocimiento que el docente habitualmente no tiene y que requiere trabajar con la comunidad, lo que consume tiempo del que no dispone. Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Educación<br/>intercultural"]
    C --> A2["Folclorización"]
    C --> A3["Diálogo de saberes"]
    C --> A4["Pertinencia curricular"]
    A1 & A2 & A3 & A4 --> D{{"determinar si tu<br/>propuesta intercultural<br/>toca el currículum o<br/>solo lo decora"}}
    D --> E["Evidencia de aprendizaje<br/>una unidad que integra<br/>un saber cultural en el<br/>contenido disciplinar,<br/>con criterios de…"]
...
La mayor parte de lo que las escuelas llaman educación intercultural ocurre en una semana del año y no toca el currículum. Esa forma tiene un efecto contradictorio: exhibe la cultura como objeto exótico y confirma que el conocimiento válido es el otro, el que se enseña el resto del año. La versión exigente del enfoque es distinta: implica preguntarse qué sistema de conocimiento sobre el territorio, la salud, la naturaleza o la historia queda fuera del programa, y ponerlo en diálogo con el que se enseña.

### 2. Frontera conceptual: qué es y qué no es

Los cuatro conceptos de esta clase se confunden entre sí con facilidad, y esa confusión no es
inocua: produce decisiones que atacan el problema equivocado. **Educación intercultural** no es lo
mismo que **Folclorización** —reducción de una cultura a sus manifestaciones visibles —comida, vestimenta, festividades— sin tocar el conocimiento—, y tratarlos como sinónimos hace
que la intervención se dirija al lugar incorrecto. Del mismo modo, **Diálogo de saberes** y
**Pertinencia curricular** describen aspectos distintos de la misma situación: el primero
puesta en relación de sistemas de conocimiento distintos, con reconocimiento de la validez de ambos, mientras el segundo grado en que el contenido enseñado se conecta con el territorio y la experiencia de los estudiantes.
...
- **Evidencia de logro.** Qué muestra una unidad que integra un saber cultural en el contenido disciplinar, con criterios de evaluación coherentes frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
Una unidad intercultural real se reconoce por dónde ocurre: en ciencias, en historia, en matemática, no en el acto. Se identifica un contenido del programa que admite otro sistema de conocimiento, se trabajan ambos con rigor, se explicitan sus diferencias de método y de criterio de validez, y se evalúa la comprensión de ambos. La participación de personas de la comunidad como fuente —no como espectáculo— es lo que distingue el diálogo del gesto.

### 5. Qué sostiene la evidencia y qué no

El enfoque exige conocimiento que el docente habitualmente no tiene y que requiere trabajar con la comunidad, lo que consume tiempo del que no dispone. Su evidencia de efectos sobre aprendizaje es limitada y descansa más en argumentos de derechos y de pertinencia. Y existe una tensión no resuelta: cuánto currículum común se puede modificar sin afectar el acceso de los estudiantes a los mismos aprendizajes que se exigen a todos.
...
te deja en condiciones de si tu propuesta intercultural toca el currículum o solo lo decora, y esa decisión se sostiene solo si
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Educación intercultural** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Educación intercultural de Folclorización.** El trabajo aquí es separar lo observado de lo interpretado sobre **Folclorización**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Diálogo de saberes como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Diálogo de saberes**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.

**Paso 4 — Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con Pertinencia curricular a la vista.** Con **Pertinencia curricular** ya delimitado, la pregunta pasa a ser de consecuencia: qué cambia para los estudiantes, para el tiempo de clase y para la carga del equipo. **Evidencia de partida** entrega la lectura observable; el juicio profesional sigue siendo humano y debe quedar firmado por quien lo hace.
...
|---|---|---|---|
| Intervenir sobre **Educación intercultural** | Enfoque que reconoce y pone en relación distintos sistemas de conocimiento dentro del currículum | Cuando **Evidencia de partida** es observable y accionable dentro del plazo de la decisión. | Sobrerreaccionar a una señal parcial. |
| Intervenir sobre **Folclorización** | Reducción de una cultura a sus manifestaciones visibles —comida, vestimenta, festividades— sin tocar el conocimiento | Cuando la primera explicación no distingue mecanismo ni responsable. | Convertir el concepto en etiqueta y no en intervención. |
| Observar antes de decidir | Reducir la incertidumbre antes de comprometer tiempo y credibilidad | Cuando la decisión es reversible y la evidencia disponible no distingue causas. | Observar indefinidamente y no decidir nunca. |
| Derivar o escalar | Poner la decisión donde están la competencia y la responsabilidad | Cuando hay normativa, resguardo de datos, salud o vulneración de derechos en juego. | Delegar hacia arriba lo que sí correspondía decidir en el aula. |

**Frontera de aplicación.** El enfoque exige conocimiento que el docente habitualmente no tiene y que requiere trabajar con la comunidad, lo que consume tiempo del que no dispone. Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre educación intercultural: del folclor al diálogo de saberes |
|---|---|
...
Una unidad que integra un saber cultural en el contenido disciplinar, con criterios de evaluación coherentes.

Guárdala en `evidence/P22-C266-educacion-intercultural-del-folclor-al-dialogo-de-saberes/` con estos archivos:
...
Elige un contenido de tu asignatura y diseña una unidad que ponga en diálogo dos sistemas de conocimiento. Evalúa la comprensión de ambos.
...
- [ ] la unidad integra el saber en el contenido disciplinar y no en una actividad paralela;
- [ ] la evaluación considera ambos sistemas de conocimiento con criterios explícitos;
...
- Concentrar la interculturalidad en una efeméride y llamar a eso enfoque intercultural.
- Invitar a personas de la comunidad como ilustración y no como fuente de conocimiento con estatus.
...
1. ¿En qué asignatura y en qué contenido concreto ocurre tu propuesta intercultural?
2. ¿Qué sistema de conocimiento sobre este tema queda fuera de tu programa?
3. ¿Quién de la comunidad participa y en qué rol exactamente?
...
Continúa la clase 265 y prepara la 267. Se articula con la parte 09 y con la clase 235.
...
|---|---|---|
| [← 265 · Lo que la escuela da por supuesto](../class-01-lo-que-la-escuela-da-por-supuesto/README.md) | [Parte 22](../README.md) · [Programa](../../../README.md) | [267 · Educación intercultural bilingüe y lenguas originarias →](../class-03-educacion-intercultural-bilingue-y-lenguas-originarias/README.md) |
