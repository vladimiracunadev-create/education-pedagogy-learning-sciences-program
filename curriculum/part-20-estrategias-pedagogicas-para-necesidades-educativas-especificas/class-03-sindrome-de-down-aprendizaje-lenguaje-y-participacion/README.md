# Clase 243 — Síndrome de Down: aprendizaje, lenguaje y participación

> **Parte 20 · Estrategias pedagógicas para necesidades educativas específicas** — clase 3 de 12
...
**Decisión que habilita:** determinar qué apoyos de presentación, ritmo y comunicación necesita este estudiante para acceder al currículum<br>
**Evidencia de aprendizaje:** una adecuación de unidad con apoyo visual, ritmo ajustado y evaluación coherente con el objetivo mantenido

## 🎯 Propósito

Enseñar a estudiantes con síndrome de Down aprovechando su perfil —fortaleza visual, memoria verbal a corto plazo más frágil— con expectativas altas y apoyos precisos.
...
2. **Explicar** qué perfil de aprendizaje específico tiene el síndrome de Down y cómo se enseña con él a favor.
3. **Decidir** —qué apoyos de presentación, ritmo y comunicación necesita este estudiante para acceder al currículum— y sostener la decisión con un fundamento escrito.
4. **Producir** la evidencia de la clase —una adecuación de unidad con apoyo visual, ritmo ajustado y evaluación coherente con el objetivo mantenido— y contrastarla contra el criterio de logro.
...
|---|---|
| **Perfil de aprendizaje** | patrón relativamente característico de fortalezas y dificultades asociado a una condición, con variación individual amplia |
| **Apoyo visual** | presentación de información en soporte visual permanente, que compensa la fragilidad de la memoria verbal a corto plazo |
| **Adecuación de acceso** | cambio en cómo se presenta o se responde una tarea, sin modificar el objetivo de aprendizaje |
| **Expectativa ajustada** | nivel de exigencia basado en el desempeño observado y no en la expectativa asociada al diagnóstico |
...
2. Clasificar la situación distinguiendo **Perfil de aprendizaje** de **Apoyo visual**.
3. Decidir con fundamento, usando **Adecuación de acceso** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Expectativa ajustada** a la vista.
...
| **Evidencia de logro** | qué muestra una adecuación de unidad con apoyo visual, ritmo ajustado y evaluación coherente con el objetivo mantenido frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
El perfil describe tendencias de grupo con variación individual muy amplia: Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Perfil de aprendizaje"]
    C --> A2["Apoyo visual"]
    C --> A3["Adecuación de acceso"]
    C --> A4["Expectativa ajustada"]
    A1 & A2 & A3 & A4 --> D{{"determinar qué apoyos de<br/>presentación, ritmo y<br/>comunicación necesita<br/>este estudiante para…"}}
    D --> E["Evidencia de aprendizaje<br/>una adecuación de unidad<br/>con apoyo visual, ritmo<br/>ajustado y evaluación<br/>coherente con el…"]
...
El síndrome de Down presenta un perfil relativamente consistente: fortaleza relativa en procesamiento visual y en aprendizaje social, y mayor fragilidad en memoria verbal a corto plazo, en articulación y en lenguaje expresivo. Ese perfil tiene consecuencias directas: una instrucción larga y oral se pierde, mientras que la misma instrucción con apoyo visual permanente se sostiene. La evidencia acumulada muestra además que muchos estudiantes alcanzan niveles de lectura funcional que las expectativas tradicionales daban por imposibles.

### 2. Frontera conceptual: qué es y qué no es

Los cuatro conceptos de esta clase se confunden entre sí con facilidad, y esa confusión no es
inocua: produce decisiones que atacan el problema equivocado. **Perfil de aprendizaje** no es lo
mismo que **Apoyo visual** —presentación de información en soporte visual permanente, que compensa la fragilidad de la memoria verbal a corto plazo—, y tratarlos como sinónimos hace
que la intervención se dirija al lugar incorrecto. Del mismo modo, **Adecuación de acceso** y
**Expectativa ajustada** describen aspectos distintos de la misma situación: el primero
cambio en cómo se presenta o se responde una tarea, sin modificar el objetivo de aprendizaje, mientras el segundo nivel de exigencia basado en el desempeño observado y no en la expectativa asociada al diagnóstico.
...
- **Evidencia de logro.** Qué muestra una adecuación de unidad con apoyo visual, ritmo ajustado y evaluación coherente con el objetivo mantenido frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
Las decisiones que más rinden son de presentación y de tiempo: apoyo visual permanente, instrucciones cortas con verificación, lectura enseñada de forma sistemática y temprana —el perfil visual la favorece—, más tiempo de respuesta y oportunidades de participación que no dependan solo del lenguaje oral. El lenguaje expresivo suele ir por detrás de la comprensión: interpretar la dificultad para responder como falta de comprensión es el error más frecuente y el más costoso.

### 5. Qué sostiene la evidencia y qué no

El perfil describe tendencias de grupo con variación individual muy amplia: hay estudiantes cuyo desempeño se aparta por completo de lo esperado en cualquier dominio. La investigación educativa específica es relativamente escasa y buena parte proviene de estudios pequeños. Y las condiciones asociadas —auditivas, visuales, cardíacas— varían mucho y cambian las prioridades del apoyo en cada caso.
...
te deja en condiciones de qué apoyos de presentación, ritmo y comunicación necesita este estudiante para acceder al currículum, y esa decisión se sostiene solo si
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Perfil de aprendizaje** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Perfil de aprendizaje de Apoyo visual.** El trabajo aquí es separar lo observado de lo interpretado sobre **Apoyo visual**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Adecuación de acceso como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Adecuación de acceso**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.

**Paso 4 — Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con Expectativa ajustada a la vista.** Con **Expectativa ajustada** ya delimitado, la pregunta pasa a ser de consecuencia: qué cambia para los estudiantes, para el tiempo de clase y para la carga del equipo. **Evidencia de partida** entrega la lectura observable; el juicio profesional sigue siendo humano y debe quedar firmado por quien lo hace.
...
|---|---|---|---|
| Intervenir sobre **Perfil de aprendizaje** | Patrón relativamente característico de fortalezas y dificultades asociado a una condición, con variación individual amplia | Cuando **Evidencia de partida** es observable y accionable dentro del plazo de la decisión. | Sobrerreaccionar a una señal parcial. |
| Intervenir sobre **Apoyo visual** | Presentación de información en soporte visual permanente, que compensa la fragilidad de la memoria verbal a corto plazo | Cuando la primera explicación no distingue mecanismo ni responsable. | Convertir el concepto en etiqueta y no en intervención. |
| Observar antes de decidir | Reducir la incertidumbre antes de comprometer tiempo y credibilidad | Cuando la decisión es reversible y la evidencia disponible no distingue causas. | Observar indefinidamente y no decidir nunca. |
| Derivar o escalar | Poner la decisión donde están la competencia y la responsabilidad | Cuando hay normativa, resguardo de datos, salud o vulneración de derechos en juego. | Delegar hacia arriba lo que sí correspondía decidir en el aula. |

**Frontera de aplicación.** El perfil describe tendencias de grupo con variación individual muy amplia: Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre síndrome de Down: aprendizaje, lenguaje y participación |
|---|---|
...
Una adecuación de unidad con apoyo visual, ritmo ajustado y evaluación coherente con el objetivo mantenido.

Guárdala en `evidence/P20-C243-sindrome-de-down-aprendizaje-lenguaje-y-participacion/` con estos archivos:
...
Adecua una unidad completa manteniendo el objetivo. Documenta con evidencia qué comprendió el estudiante por vías distintas de la respuesta oral.
...
- [ ] la adecuación mantiene el objetivo de aprendizaje y modifica solo la vía de acceso;
- [ ] el apoyo visual está presente de forma permanente y no solo en la instrucción inicial;
...
- Interpretar la dificultad de expresión oral como límite de comprensión y bajar el contenido.
- Postergar la enseñanza sistemática de la lectura por suponer que no es alcanzable.
...
La barrera más persistente no es cognitiva sino de expectativa: el techo que la escuela asume termina cumpliéndose. Documentar desempeño real y contrastarlo con la expectativa declarada del equipo es una intervención en sí misma.
...
1. ¿Qué evidencia tienes de lo que este estudiante comprende, independiente de lo que puede decir?
2. ¿Cuánta información entregas solo por vía oral en una clase típica?
3. ¿Qué expectativa tienes sobre su lectura y en qué la basas?
...
Aplica el método de la clase 241 y complementa la 106. Enlaza con la parte 18 sobre enseñanza sistemática de la lectura.
...
|---|---|---|
| [← 242 · TDAH: atención, autorregulación y organización](../class-02-tdah-atencion-autorregulacion-y-organizacion/README.md) | [Parte 20](../README.md) · [Programa](../../../README.md) | [244 · Autismo: estructura, anticipación y comunicación →](../class-04-autismo-estructura-anticipacion-y-comunicacion/README.md) |
