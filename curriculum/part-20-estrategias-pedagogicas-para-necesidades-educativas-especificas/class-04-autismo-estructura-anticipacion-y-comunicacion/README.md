# Clase 244 — Autismo: estructura, anticipación y comunicación

> **Parte 20 · Estrategias pedagógicas para necesidades educativas específicas** — clase 4 de 12
...
**Decisión que habilita:** determinar qué elementos de estructura, anticipación y regulación sensorial requiere este estudiante<br>
**Evidencia de aprendizaje:** un diseño de aula con rutina visible, anticipación de cambios y ajustes sensoriales declarados

## 🎯 Propósito

Diseñar un aula predecible y comunicativamente accesible para estudiantes autistas, ajustando el entorno sensorial y social antes de intervenir la conducta.
...
2. **Explicar** por qué la estructura y la anticipación importan más que cualquier técnica específica.
3. **Decidir** —qué elementos de estructura, anticipación y regulación sensorial requiere este estudiante— y sostener la decisión con un fundamento escrito.
4. **Producir** la evidencia de la clase —un diseño de aula con rutina visible, anticipación de cambios y ajustes sensoriales declarados— y contrastarla contra el criterio de logro.
...
|---|---|
| **Estructura y previsibilidad** | organización del tiempo y del espacio que permite anticipar lo que ocurrirá y reduce la demanda de adaptación |
| **Anticipación** | aviso planificado de cambios de actividad, de espacio o de persona, con tiempo suficiente para procesarlo |
| **Regulación sensorial** | ajuste de estímulos —ruido, luz, contacto— cuyo exceso o defecto desorganiza la conducta |
| **Comunicación aumentativa** | sistema complementario o alternativo al habla que permite expresar necesidades y participar |
...
2. Clasificar la situación distinguiendo **Estructura y previsibilidad** de **Anticipación**.
3. Decidir con fundamento, usando **Regulación sensorial** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Comunicación aumentativa** a la vista.
...
| **Evidencia de logro** | qué muestra un diseño de aula con rutina visible, anticipación de cambios y ajustes sensoriales declarados frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
La heterogeneidad del espectro hace que casi cualquier afirmación general tenga excepciones importantes. Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Estructura y<br/>previsibilidad"]
    C --> A2["Anticipación"]
    C --> A3["Regulación sensorial"]
    C --> A4["Comunicación<br/>aumentativa"]
    A1 & A2 & A3 & A4 --> D{{"determinar qué elementos<br/>de estructura,<br/>anticipación y<br/>regulación sensorial<br/>requiere este…"}}
    D --> E["Evidencia de aprendizaje<br/>un diseño de aula con<br/>rutina visible,<br/>anticipación de cambios<br/>y ajustes sensoriales<br/>declarados"]
...
El autismo es un espectro amplio y los apoyos que rinden dependen del perfil individual, pero hay un principio que atraviesa la mayoría de los casos: la previsibilidad reduce la carga. Un entorno donde el estudiante sabe qué viene, cuánto durará y qué se espera de él libera recursos que de otro modo se consumen en gestionar la incertidumbre. Buena parte de las conductas que la escuela interpreta como oposición son respuestas a cambios no anunciados o a sobrecarga sensorial.

### 2. Frontera conceptual: qué es y qué no es

Los cuatro conceptos de esta clase se confunden entre sí con facilidad, y esa confusión no es
inocua: produce decisiones que atacan el problema equivocado. **Estructura y previsibilidad** no es lo
mismo que **Anticipación** —aviso planificado de cambios de actividad, de espacio o de persona, con tiempo suficiente para procesarlo—, y tratarlos como sinónimos hace
que la intervención se dirija al lugar incorrecto. Del mismo modo, **Regulación sensorial** y
**Comunicación aumentativa** describen aspectos distintos de la misma situación: el primero
ajuste de estímulos —ruido, luz, contacto— cuyo exceso o defecto desorganiza la conducta, mientras el segundo sistema complementario o alternativo al habla que permite expresar necesidades y participar.
...
- **Evidencia de logro.** Qué muestra un diseño de aula con rutina visible, anticipación de cambios y ajustes sensoriales declarados frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
Las decisiones de base son cuatro: rutina visible con secuencia de la clase a la vista, anticipación explícita de cualquier cambio, ajustes sensoriales concretos —ubicación, control de ruido, espacio de regulación disponible— y una vía de comunicación garantizada, que puede requerir apoyos aumentativos. Sobre esa base se trabaja la participación social con apoyos explícitos: los intercambios que otros aprenden por observación aquí se enseñan de forma directa.

### 5. Qué sostiene la evidencia y qué no

La heterogeneidad del espectro hace que casi cualquier afirmación general tenga excepciones importantes. Varias intervenciones populares carecen de respaldo o tienen respaldo débil, y algunas plantean objeciones éticas serias desde las propias personas autistas, especialmente aquellas centradas en suprimir conductas que no dañan a nadie. La distinción entre enseñar habilidades útiles y exigir apariencia de normalidad es un debate abierto que el equipo debe sostener.
...
te deja en condiciones de qué elementos de estructura, anticipación y regulación sensorial requiere este estudiante, y esa decisión se sostiene solo si
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Estructura y previsibilidad** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Estructura y previsibilidad de Anticipación.** El trabajo aquí es separar lo observado de lo interpretado sobre **Anticipación**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Regulación sensorial como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Regulación sensorial**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.

**Paso 4 — Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con Comunicación aumentativa a la vista.** Con **Comunicación aumentativa** ya delimitado, la pregunta pasa a ser de consecuencia: qué cambia para los estudiantes, para el tiempo de clase y para la carga del equipo. **Evidencia de partida** entrega la lectura observable; el juicio profesional sigue siendo humano y debe quedar firmado por quien lo hace.
...
|---|---|---|---|
| Intervenir sobre **Estructura y previsibilidad** | Organización del tiempo y del espacio que permite anticipar lo que ocurrirá y reduce la demanda de adaptación | Cuando **Evidencia de partida** es observable y accionable dentro del plazo de la decisión. | Sobrerreaccionar a una señal parcial. |
| Intervenir sobre **Anticipación** | Aviso planificado de cambios de actividad, de espacio o de persona, con tiempo suficiente para procesarlo | Cuando la primera explicación no distingue mecanismo ni responsable. | Convertir el concepto en etiqueta y no en intervención. |
| Observar antes de decidir | Reducir la incertidumbre antes de comprometer tiempo y credibilidad | Cuando la decisión es reversible y la evidencia disponible no distingue causas. | Observar indefinidamente y no decidir nunca. |
| Derivar o escalar | Poner la decisión donde están la competencia y la responsabilidad | Cuando hay normativa, resguardo de datos, salud o vulneración de derechos en juego. | Delegar hacia arriba lo que sí correspondía decidir en el aula. |

**Frontera de aplicación.** La heterogeneidad del espectro hace que casi cualquier afirmación general tenga excepciones importantes. Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre autismo: estructura, anticipación y comunicación |
|---|---|
...
Un diseño de aula con rutina visible, anticipación de cambios y ajustes sensoriales declarados.

Guárdala en `evidence/P20-C244-autismo-estructura-anticipacion-y-comunicacion/` con estos archivos:
...
Registra durante una semana los cambios no anunciados en la jornada de un estudiante. Implementa un protocolo de anticipación y compara los episodios de desregulación.
...
- [ ] el diseño declara rutina visible, protocolo de anticipación y ajustes sensoriales concretos;
- [ ] existe una vía de comunicación garantizada, verificada en situaciones de estrés;
...
- Interpretar como desafío una reacción a un cambio no anunciado o a sobrecarga sensorial.
- Adoptar programas de moda sin verificar su evidencia ni su aceptación por la comunidad autista.
...
El criterio ético central es distinguir apoyos que amplían la participación de intervenciones que buscan que el estudiante parezca no autista. La comunidad autista adulta ha sido explícita en esa distinción y su voz es una fuente legítima para el equipo.
...
1. ¿Qué cambios ocurrieron hoy sin aviso en la jornada de este estudiante?
2. ¿Cómo comunica una necesidad cuando está desregulado y esa vía está disponible?
3. ¿Qué conducta estás intentando modificar y a quién perjudica realmente?
...
Profundiza la clase 102 y aplica el método de la 241. Enlaza con la clase 248 y con la parte 12.
...
|---|---|---|
| [← 243 · Síndrome de Down: aprendizaje, lenguaje y participación](../class-03-sindrome-de-down-aprendizaje-lenguaje-y-participacion/README.md) | [Parte 20](../README.md) · [Programa](../../../README.md) | [245 · Discapacidad intelectual y acceso al currículum →](../class-05-discapacidad-intelectual-y-acceso-al-curriculum/README.md) |
