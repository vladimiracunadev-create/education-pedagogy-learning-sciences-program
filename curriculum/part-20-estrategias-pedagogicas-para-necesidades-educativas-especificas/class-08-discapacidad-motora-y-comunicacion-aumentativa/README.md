# Clase 248 — Discapacidad motora y comunicación aumentativa

> **Parte 20 · Estrategias pedagógicas para necesidades educativas específicas** — clase 8 de 12

**Estado de evidencia:** `CONSISTENTE` · **Etapa:** 🟤 Etapa F — Especialización y desafíos contemporáneos · **Población de referencia:** transversal, con foco en aula común<br>
**Decisión que habilita:** determinar qué vía de comunicación y qué acceso físico están garantizados para este estudiante en cada actividad<br>
**Evidencia de aprendizaje:** un plan de acceso físico y comunicativo con responsable, verificación y plan de contingencia

## 🎯 Propósito

Asegurar acceso físico y comunicativo mediante ajustes de entorno, tecnología de apoyo y sistemas aumentativos, con la participación como criterio.
...
2. **Explicar** por qué garantizar una vía de comunicación es la decisión que precede a todas las demás.
3. **Decidir** —qué vía de comunicación y qué acceso físico están garantizados para este estudiante en cada actividad— y sostener la decisión con un fundamento escrito.
4. **Producir** la evidencia de la clase —un plan de acceso físico y comunicativo con responsable, verificación y plan de contingencia— y contrastarla contra el criterio de logro.
...
|---|---|
| **Comunicación aumentativa y alternativa** | conjunto de sistemas que complementan o sustituyen el habla para permitir la expresión |
| **Tecnología de apoyo** | dispositivo o recurso que permite ejecutar una tarea que de otro modo sería inaccesible |
| **Acceso físico** | condición del espacio, mobiliario y materiales que permite participar sin depender de terceros |
| **Presunción de competencia** | supuesto de trabajo según el cual el estudiante comprende hasta que se demuestre lo contrario |
...
2. Clasificar la situación distinguiendo **Comunicación aumentativa y alternativa** de **Tecnología de apoyo**.
3. Decidir con fundamento, usando **Acceso físico** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Presunción de competencia** a la vista.
...
| **Evidencia de logro** | qué muestra un plan de acceso físico y comunicativo con responsable, verificación y plan de contingencia frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
La implementación depende de recursos que muchos establecimientos no tienen y de formación específica que el sistema entrega de manera desigual. Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Comunicación<br/>aumentativa y<br/>alternativa"]
    C --> A2["Tecnología de apoyo"]
    C --> A3["Acceso físico"]
    C --> A4["Presunción de<br/>competencia"]
    A1 & A2 & A3 & A4 --> D{{"determinar qué vía de<br/>comunicación y qué<br/>acceso físico están<br/>garantizados para este<br/>estudiante…"}}
    D --> E["Evidencia de aprendizaje<br/>un plan de acceso físico<br/>y comunicativo con<br/>responsable,<br/>verificación y plan de<br/>contingencia"]
...
En discapacidad motora y en trastornos severos de la comunicación, la barrera más grave no es el movimiento sino la presunción de que quien no habla no comprende. La evidencia acumulada con sistemas aumentativos ha desmentido esa presunción en numerosos casos, a veces después de años de escolarización empobrecida. De ahí que la presunción de competencia sea el punto de partida profesional: se enseña contenido de nivel y se busca la vía por la que el estudiante pueda mostrar lo que sabe.

### 2. Frontera conceptual: qué es y qué no es

Los cuatro conceptos de esta clase se confunden entre sí con facilidad, y esa confusión no es
inocua: produce decisiones que atacan el problema equivocado. **Comunicación aumentativa y alternativa** no es lo
mismo que **Tecnología de apoyo** —dispositivo o recurso que permite ejecutar una tarea que de otro modo sería inaccesible—, y tratarlos como sinónimos hace
que la intervención se dirija al lugar incorrecto. Del mismo modo, **Acceso físico** y
**Presunción de competencia** describen aspectos distintos de la misma situación: el primero
condición del espacio, mobiliario y materiales que permite participar sin depender de terceros, mientras el segundo supuesto de trabajo según el cual el estudiante comprende hasta que se demuestre lo contrario.
...
- **Evidencia de logro.** Qué muestra un plan de acceso físico y comunicativo con responsable, verificación y plan de contingencia frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
El plan cubre tres capas. Acceso físico: mobiliario, desplazamiento, materiales manipulables y ubicación que permita participar. Acceso comunicativo: sistema aumentativo disponible siempre —no guardado— y conocido por todos los docentes, no solo por la educadora diferencial. Contingencia: qué ocurre si el dispositivo falla o el asistente no asiste. La verificación es simple y dura: ¿puede este estudiante hacer una pregunta espontánea en tu clase?

### 5. Qué sostiene la evidencia y qué no

La implementación depende de recursos que muchos establecimientos no tienen y de formación específica que el sistema entrega de manera desigual. Los sistemas aumentativos exigen entrenamiento sostenido de todo el entorno para funcionar, y su abandono es frecuente cuando esa condición no se cumple. Además, la investigación educativa específica es escasa y muy heterogénea en calidad.
...
te deja en condiciones de qué vía de comunicación y qué acceso físico están garantizados para este estudiante en cada actividad, y esa decisión se sostiene solo si
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Comunicación aumentativa y alternativa** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Comunicación aumentativa y alternativa de Tecnología de apoyo.** El trabajo aquí es separar lo observado de lo interpretado sobre **Tecnología de apoyo**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Acceso físico como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Acceso físico**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.

**Paso 4 — Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con Presunción de competencia a la vista.** Con **Presunción de competencia** ya delimitado, la pregunta pasa a ser de consecuencia: qué cambia para los estudiantes, para el tiempo de clase y para la carga del equipo. **Evidencia de partida** entrega la lectura observable; el juicio profesional sigue siendo humano y debe quedar firmado por quien lo hace.
...
|---|---|---|---|
| Intervenir sobre **Comunicación aumentativa y alternativa** | Conjunto de sistemas que complementan o sustituyen el habla para permitir la expresión | Cuando **Evidencia de partida** es observable y accionable dentro del plazo de la decisión. | Sobrerreaccionar a una señal parcial. |
| Intervenir sobre **Tecnología de apoyo** | Dispositivo o recurso que permite ejecutar una tarea que de otro modo sería inaccesible | Cuando la primera explicación no distingue mecanismo ni responsable. | Convertir el concepto en etiqueta y no en intervención. |
| Observar antes de decidir | Reducir la incertidumbre antes de comprometer tiempo y credibilidad | Cuando la decisión es reversible y la evidencia disponible no distingue causas. | Observar indefinidamente y no decidir nunca. |
| Derivar o escalar | Poner la decisión donde están la competencia y la responsabilidad | Cuando hay normativa, resguardo de datos, salud o vulneración de derechos en juego. | Delegar hacia arriba lo que sí correspondía decidir en el aula. |

**Frontera de aplicación.** La implementación depende de recursos que muchos establecimientos no tienen y de formación específica que el sistema entrega de manera desigual. Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre discapacidad motora y comunicación aumentativa |
|---|---|
...
Un plan de acceso físico y comunicativo con responsable, verificación y plan de contingencia.

Guárdala en `evidence/P20-C248-discapacidad-motora-y-comunicacion-aumentativa/` con estos archivos:
...
Verifica si un estudiante con comunicación aumentativa puede iniciar una interacción en tu clase. Ajusta lo que lo impide y vuelve a verificar en dos semanas.
...
- [ ] el sistema de comunicación está disponible en todas las clases y todos los docentes saben usarlo;
- [ ] el plan declara la contingencia ante falla del dispositivo o ausencia del asistente;
...
- Mantener el sistema de comunicación guardado y usarlo solo en las sesiones con la especialista.
- Asumir que la ausencia de habla indica ausencia de comprensión y reducir el contenido en consecuencia.
...
La presunción de competencia no es optimismo: es la única postura que no produce daño irreversible cuando se equivoca. Presumir incapacidad y errar cuesta la escolaridad completa de una persona.
...
1. ¿Puede este estudiante hacer una pregunta espontánea en tu clase, hoy?
2. ¿Cuántos docentes del curso saben usar su sistema de comunicación?
3. ¿Qué pasa mañana si el dispositivo no funciona?

## 📗 Fuentes y verificación

- Beukelman, D. & Mirenda, P. *Augmentative and Alternative Communication* (edición vigente). **Uso en esta clase:** el manual de referencia sobre sistemas aumentativos y sus condiciones de implementación. Lectura selectiva: índice y capítulos pertinentes; registra edición y páginas consultadas. **Localizar:** [ISBN 9781598571967](https://openlibrary.org/isbn/9781598571967) · [ficha](../../../docs/REGISTRO_DE_FUENTES.md#beukelman-mirenda-augmentative-and-alternative-communication)
- Organización Mundial de la Salud. *Clasificación Internacional del Funcionamiento (CIF)* (edición vigente). **Uso en esta clase:** el marco que sitúa la participación como resultado de la interacción con el entorno. Lectura selectiva: índice y capítulos pertinentes; registra edición y páginas consultadas. **Localizar:** [fuente oficial](https://www.who.int/standards/classifications/international-classification-of-functioning-disability-and-health) · [ficha](../../../docs/REGISTRO_DE_FUENTES.md#organizacion-mundial-de-la-salud-clasificacion-internacional-del-funcionamiento)
...
Continúa la clase 247 y aplica el método de la 241. Se articula con la parte 13 y con la clase 251.
...
|---|---|---|
| [← 247 · Discapacidad visual y auditiva: estrategias de acceso](../class-07-discapacidad-visual-y-auditiva-estrategias-de-acceso/README.md) | [Parte 20](../README.md) · [Programa](../../../README.md) | [249 · Trastornos del lenguaje y de la comunicación →](../class-09-trastornos-del-lenguaje-y-de-la-comunicacion/README.md) |
