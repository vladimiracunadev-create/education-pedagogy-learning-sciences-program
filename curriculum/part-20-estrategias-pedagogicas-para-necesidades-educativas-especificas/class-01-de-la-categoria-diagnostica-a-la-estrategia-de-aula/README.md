# Clase 241 — De la categoría diagnóstica a la estrategia de aula

> **Parte 20 · Estrategias pedagógicas para necesidades educativas específicas** — clase 1 de 12
...
**Decisión que habilita:** determinar qué barrera concreta enfrenta este estudiante en esta clase y qué apoyo la remueve<br>
**Evidencia de aprendizaje:** una ficha de barrera y apoyo con evidencia de observación, apoyo elegido y criterio de retirada

## 🎯 Propósito

Traducir un antecedente diagnóstico en barreras observables y elegir el apoyo mínimo suficiente para removerlas, sin deducir la estrategia de la etiqueta.
...
2. **Explicar** por qué dos estudiantes con el mismo diagnóstico pueden necesitar apoyos opuestos.
3. **Decidir** —qué barrera concreta enfrenta este estudiante en esta clase y qué apoyo la remueve— y sostener la decisión con un fundamento escrito.
4. **Producir** la evidencia de la clase —una ficha de barrera y apoyo con evidencia de observación, apoyo elegido y criterio de retirada— y contrastarla contra el criterio de logro.
...
|---|---|
| **Barrera observable** | obstáculo concreto y verificable que impide participar o aprender en una situación determinada |
| **Apoyo mínimo suficiente** | ayuda más pequeña que remueve la barrera; más apoyo del necesario genera dependencia |
| **Criterio de retirada** | condición declarada de antemano que indica cuándo el apoyo deja de ser necesario |
| **Sobregeneralización diagnóstica** | error de inferir necesidades a partir de la categoría en vez de la observación del caso |
...
2. Clasificar la situación distinguiendo **Barrera observable** de **Apoyo mínimo suficiente**.
3. Decidir con fundamento, usando **Criterio de retirada** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Sobregeneralización diagnóstica** a la vista.
...
| **Evidencia de logro** | qué muestra una ficha de barrera y apoyo con evidencia de observación, apoyo elegido y criterio de retirada frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
La observación tiene sus propios sesgos: Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Barrera observable"]
    C --> A2["Apoyo mínimo<br/>suficiente"]
    C --> A3["Criterio de retirada"]
    C --> A4["Sobregeneralización<br/>diagnóstica"]
    A1 & A2 & A3 & A4 --> D{{"determinar qué barrera<br/>concreta enfrenta este<br/>estudiante en esta clase<br/>y qué apoyo la remueve"}}
    D --> E["Evidencia de aprendizaje<br/>una ficha de barrera y<br/>apoyo con evidencia de<br/>observación, apoyo<br/>elegido y criterio de<br/>retirada"]
...
Un diagnóstico informa sobre probabilidades, no sobre una persona. Dos estudiantes con el mismo diagnóstico pueden diferir en lenguaje, en autorregulación, en conocimiento previo y en contexto familiar más de lo que se parecen. La categoría es útil para anticipar qué observar y qué apoyos considerar; es inútil como fuente directa de decisiones. La secuencia profesional invierte el orden habitual: se observa la situación concreta, se nombra la barrera, se elige el apoyo y recién entonces el diagnóstico ayuda a interpretar por qué esa barrera aparece.

### 2. Frontera conceptual: qué es y qué no es

Los cuatro conceptos de esta clase se confunden entre sí con facilidad, y esa confusión no es
inocua: produce decisiones que atacan el problema equivocado. **Barrera observable** no es lo
mismo que **Apoyo mínimo suficiente** —ayuda más pequeña que remueve la barrera; más apoyo del necesario genera dependencia—, y tratarlos como sinónimos hace
que la intervención se dirija al lugar incorrecto. Del mismo modo, **Criterio de retirada** y
**Sobregeneralización diagnóstica** describen aspectos distintos de la misma situación: el primero
condición declarada de antemano que indica cuándo el apoyo deja de ser necesario, mientras el segundo error de inferir necesidades a partir de la categoría en vez de la observación del caso.
...
- **Evidencia de logro.** Qué muestra una ficha de barrera y apoyo con evidencia de observación, apoyo elegido y criterio de retirada frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
La ficha de barrera y apoyo obliga a ese orden. Registra qué ocurre exactamente —en qué momento de la clase, con qué tarea, con qué consecuencia—, formula la barrera en términos verificables, elige el apoyo más pequeño que podría removerla y declara cómo se sabrá si funcionó y cuándo se retirará. Es un documento breve que cambia la conversación de equipo: se discute sobre observaciones, no sobre impresiones.

### 5. Qué sostiene la evidencia y qué no

La observación tiene sus propios sesgos: se observa más a quien molesta y menos a quien se retrae, y se interpreta según lo que ya se espera. La ficha reduce ese riesgo pero no lo elimina. Además, hay condiciones donde el conocimiento acumulado sobre el perfil sí orienta decisiones específicas y prescindir de él por principio sería un error opuesto y también costoso.
...
te deja en condiciones de qué barrera concreta enfrenta este estudiante en esta clase y qué apoyo la remueve, y esa decisión se sostiene solo si
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Barrera observable** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Barrera observable de Apoyo mínimo suficiente.** El trabajo aquí es separar lo observado de lo interpretado sobre **Apoyo mínimo suficiente**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Criterio de retirada como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Criterio de retirada**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.

**Paso 4 — Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con Sobregeneralización diagnóstica a la vista.** Con **Sobregeneralización diagnóstica** ya delimitado, la pregunta pasa a ser de consecuencia: qué cambia para los estudiantes, para el tiempo de clase y para la carga del equipo. **Evidencia de partida** entrega la lectura observable; el juicio profesional sigue siendo humano y debe quedar firmado por quien lo hace.
...
|---|---|---|---|
| Intervenir sobre **Barrera observable** | Obstáculo concreto y verificable que impide participar o aprender en una situación determinada | Cuando **Evidencia de partida** es observable y accionable dentro del plazo de la decisión. | Sobrerreaccionar a una señal parcial. |
| Intervenir sobre **Apoyo mínimo suficiente** | Ayuda más pequeña que remueve la barrera; más apoyo del necesario genera dependencia | Cuando la primera explicación no distingue mecanismo ni responsable. | Convertir el concepto en etiqueta y no en intervención. |
| Observar antes de decidir | Reducir la incertidumbre antes de comprometer tiempo y credibilidad | Cuando la decisión es reversible y la evidencia disponible no distingue causas. | Observar indefinidamente y no decidir nunca. |
| Derivar o escalar | Poner la decisión donde están la competencia y la responsabilidad | Cuando hay normativa, resguardo de datos, salud o vulneración de derechos en juego. | Delegar hacia arriba lo que sí correspondía decidir en el aula. |

**Frontera de aplicación.** La observación tiene sus propios sesgos: Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre de la categoría diagnóstica a la estrategia de aula |
|---|---|
...
Una ficha de barrera y apoyo con evidencia de observación, apoyo elegido y criterio de retirada.

Guárdala en `evidence/P20-C241-de-la-categoria-diagnostica-a-la-estrategia-de-aula/` con estos archivos:
...
Observa a un estudiante en dos clases distintas y completa la ficha de barrera y apoyo. Contrasta tu conclusión con la del educador diferencial y registra las diferencias.
...
- [ ] la barrera está formulada en términos observables, con evidencia de al menos dos observaciones;
- [ ] el apoyo declara su criterio de éxito y su condición de retirada;
...
- Elegir el apoyo por la etiqueta diagnóstica antes de haber observado una sola clase.
- Instalar apoyos permanentes sin criterio de retirada y producir dependencia evitable.
...
Esta clase es el fundamento operativo de toda la parte: el riesgo permanente de la educación especial es tratar categorías en vez de personas, y ese riesgo se materializa en decisiones que rebajan expectativas sin evidencia que las justifique.
...
Abre la parte 20 y ordena las once clases siguientes. Se apoya en las clases 098 y 099 y prepara la 251.
...
|---|---|---|
| [← Parte 20](../README.md) | [Parte 20](../README.md) · [Programa](../../../README.md) | [242 · TDAH: atención, autorregulación y organización →](../class-02-tdah-atencion-autorregulacion-y-organizacion/README.md) |
