...
**Estado de evidencia:** `ROBUSTA` · **Etapa:** 🟤 Etapa F — Especialización y desafíos contemporáneos · **Población de referencia:** transversal, con foco en aula común<br>
**Decisión que habilita:** determinar qué ajustes de entorno, tarea y retroalimentación necesita este estudiante para sostener la actividad<br>
...
flowchart TB
    ...
    C --> A1["Funciones ejecutivas"]
    C --> A2["Demora de la<br/>gratificación"]
    C --> A3["Fragmentación de la<br/>tarea"]
    C --> A4["Retroalimentación<br/>frecuente"]
    A1 & A2 & A3 & A4 --> D{{"determinar qué ajustes<br/>de entorno, tarea y<br/>retroalimentación<br/>necesita este estudiante<br/>para…"}}
    D --> E["Evidencia de aprendizaje<br/>un plan de aula con<br/>ajustes de entorno,<br/>formato de tarea y<br/>sistema de<br/>retroalimentación…"]
