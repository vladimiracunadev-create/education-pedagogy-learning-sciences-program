# Clase 249 — Trastornos del lenguaje y de la comunicación

> **Parte 20 · Estrategias pedagógicas para necesidades educativas específicas** — clase 9 de 12
...
**Decisión que habilita:** determinar qué demanda lingüística de tu clase está bloqueando el aprendizaje de este estudiante<br>
**Evidencia de aprendizaje:** una adecuación de la carga lingüística de una unidad, con evidencia del aprendizaje conservado

## 🎯 Propósito

Ajustar la enseñanza para estudiantes con trastornos del lenguaje, reduciendo la demanda lingüística de la tarea sin reducir su demanda cognitiva.
...
2. **Explicar** cómo se enseña a un estudiante cuyo problema es entender o producir el lenguaje mismo.
3. **Decidir** —qué demanda lingüística de tu clase está bloqueando el aprendizaje de este estudiante— y sostener la decisión con un fundamento escrito.
4. **Producir** la evidencia de la clase —una adecuación de la carga lingüística de una unidad, con evidencia del aprendizaje conservado— y contrastarla contra el criterio de logro.
...
|---|---|
| **Trastorno del desarrollo del lenguaje** | dificultad persistente en la adquisición y uso del lenguaje, no explicada por otra condición |
| **Demanda lingüística** | cantidad y complejidad del lenguaje que una tarea exige para poder ejecutarla |
| **Demanda cognitiva** | complejidad del pensamiento que la tarea requiere, independiente de su envoltura verbal |
| **Apoyo no verbal** | vía de acceso o de respuesta que no depende del lenguaje oral o escrito |
...
2. Clasificar la situación distinguiendo **Trastorno del desarrollo del lenguaje** de **Demanda lingüística**.
3. Decidir con fundamento, usando **Demanda cognitiva** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Apoyo no verbal** a la vista.
...
| **Evidencia de logro** | qué muestra una adecuación de la carga lingüística de una unidad, con evidencia del aprendizaje conservado frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
Los ajustes de aula complementan y no sustituyen la intervención fonoaudiológica, que requiere especialista. Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Trastorno del<br/>desarrollo del<br/>lenguaje"]
    C --> A2["Demanda lingüística"]
    C --> A3["Demanda cognitiva"]
    C --> A4["Apoyo no verbal"]
    A1 & A2 & A3 & A4 --> D{{"determinar qué demanda<br/>lingüística de tu clase<br/>está bloqueando el<br/>aprendizaje de este<br/>estudiante"}}
    D --> E["Evidencia de aprendizaje<br/>una adecuación de la<br/>carga lingüística de una<br/>unidad, con evidencia<br/>del aprendizaje<br/>conservado"]
...
Los trastornos del lenguaje son frecuentes y sistemáticamente subdetectados, en parte porque se confunden con timidez, con desinterés o con dificultades conductuales. Su efecto escolar es amplio: casi toda instrucción escolar es verbal, de modo que un estudiante con dificultad de comprensión del lenguaje enfrenta barreras en todas las asignaturas al mismo tiempo. La distinción operativa clave es entre demanda lingüística y demanda cognitiva: reducir la primera manteniendo la segunda es el objetivo del ajuste.

### 2. Frontera conceptual: qué es y qué no es

Los cuatro conceptos de esta clase se confunden entre sí con facilidad, y esa confusión no es
inocua: produce decisiones que atacan el problema equivocado. **Trastorno del desarrollo del lenguaje** no es lo
mismo que **Demanda lingüística** —cantidad y complejidad del lenguaje que una tarea exige para poder ejecutarla—, y tratarlos como sinónimos hace
que la intervención se dirija al lugar incorrecto. Del mismo modo, **Demanda cognitiva** y
**Apoyo no verbal** describen aspectos distintos de la misma situación: el primero
complejidad del pensamiento que la tarea requiere, independiente de su envoltura verbal, mientras el segundo vía de acceso o de respuesta que no depende del lenguaje oral o escrito.
...
- **Evidencia de logro.** Qué muestra una adecuación de la carga lingüística de una unidad, con evidencia del aprendizaje conservado frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
Las decisiones concretas son de formulación y de apoyo: instrucciones cortas y en el orden en que deben ejecutarse, una idea por oración, verificación de comprensión con demostración y no con «¿entendiste?», apoyo visual permanente, tiempo de procesamiento antes de exigir respuesta y vías de respuesta que no dependan solo del lenguaje oral. Enseñar explícitamente el vocabulario de la asignatura pertenece al mismo conjunto de decisiones.

### 5. Qué sostiene la evidencia y qué no

Los ajustes de aula complementan y no sustituyen la intervención fonoaudiológica, que requiere especialista. La distinción entre trastorno del lenguaje y menor exposición lingüística previa es difícil de establecer sin evaluación especializada, y es una fuente conocida de diagnóstico erróneo en estudiantes de contextos vulnerables y en quienes aprenden el castellano como segunda lengua.
...
te deja en condiciones de qué demanda lingüística de tu clase está bloqueando el aprendizaje de este estudiante, y esa decisión se sostiene solo si
...
|---|---|---|
| Bishop, D. et al. (2017). *Phase 2 of CATALISE*. | el consenso internacional sobre criterios y terminología del trastorno del desarrollo del lenguaje. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
| Cummins, J. (1979). *Cognitive/Academic Language Proficiency*. | distingue dominio conversacional de dominio académico, clave para no confundir L2 con trastorno. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Trastorno del desarrollo del lenguaje** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Trastorno del desarrollo del lenguaje de Demanda lingüística.** El trabajo aquí es separar lo observado de lo interpretado sobre **Demanda lingüística**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Demanda cognitiva como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Demanda cognitiva**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.

**Paso 4 — Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con Apoyo no verbal a la vista.** Con **Apoyo no verbal** ya delimitado, la pregunta pasa a ser de consecuencia: qué cambia para los estudiantes, para el tiempo de clase y para la carga del equipo. **Evidencia de partida** entrega la lectura observable; el juicio profesional sigue siendo humano y debe quedar firmado por quien lo hace.
...
|---|---|---|---|
| Intervenir sobre **Trastorno del desarrollo del lenguaje** | Dificultad persistente en la adquisición y uso del lenguaje, no explicada por otra condición | Cuando **Evidencia de partida** es observable y accionable dentro del plazo de la decisión. | Sobrerreaccionar a una señal parcial. |
| Intervenir sobre **Demanda lingüística** | Cantidad y complejidad del lenguaje que una tarea exige para poder ejecutarla | Cuando la primera explicación no distingue mecanismo ni responsable. | Convertir el concepto en etiqueta y no en intervención. |
| Observar antes de decidir | Reducir la incertidumbre antes de comprometer tiempo y credibilidad | Cuando la decisión es reversible y la evidencia disponible no distingue causas. | Observar indefinidamente y no decidir nunca. |
| Derivar o escalar | Poner la decisión donde están la competencia y la responsabilidad | Cuando hay normativa, resguardo de datos, salud o vulneración de derechos en juego. | Delegar hacia arriba lo que sí correspondía decidir en el aula. |

**Frontera de aplicación.** Los ajustes de aula complementan y no sustituyen la intervención fonoaudiológica, que requiere especialista. Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre trastornos del lenguaje y de la comunicación |
|---|---|
...
Una adecuación de la carga lingüística de una unidad, con evidencia del aprendizaje conservado.

Guárdala en `evidence/P20-C249-trastornos-del-lenguaje-y-de-la-comunicacion/` con estos archivos:
...
Graba cinco minutos de tus instrucciones y cuenta ideas por oración. Reescríbelas reduciendo demanda lingüística y verifica si cambia la ejecución del estudiante.
...
- [ ] la adecuación reduce demanda lingüística y conserva la demanda cognitiva declarada;
- [ ] existe evidencia de que el estudiante aprendió el contenido por una vía distinta de la verbal;
...
- Verificar comprensión preguntando si entendieron, cuando la dificultad es precisamente comprender la pregunta.
- Confundir menor exposición lingüística previa con trastorno y derivar sin considerar la trayectoria.
...
La confusión entre dificultad de lenguaje, segunda lengua y capacidad general es una de las principales fuentes de derivación errónea del sistema, y afecta desproporcionadamente a estudiantes migrantes y de contextos vulnerables.
...
1. ¿Cuántas ideas contiene la instrucción más larga que diste hoy?
2. ¿Cómo verificas comprensión sin preguntar si entendieron?
3. ¿Estás observando un trastorno o una trayectoria de menor exposición al lenguaje?
...
Se apoya en la clase 241 y se articula con la parte 18 y con la clase 269 de la parte 22.
...
|---|---|---|
| [← 248 · Discapacidad motora y comunicación aumentativa](../class-08-discapacidad-motora-y-comunicacion-aumentativa/README.md) | [Parte 20](../README.md) · [Programa](../../../README.md) | [250 · Altas capacidades: enriquecimiento y aceleración →](../class-10-altas-capacidades-enriquecimiento-y-aceleracion/README.md) |
