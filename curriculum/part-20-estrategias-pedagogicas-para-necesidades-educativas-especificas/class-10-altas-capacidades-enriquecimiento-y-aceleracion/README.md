# Clase 250 — Altas capacidades: enriquecimiento y aceleración

> **Parte 20 · Estrategias pedagógicas para necesidades educativas específicas** — clase 10 de 12
...
**Decisión que habilita:** determinar qué combinación de compactación, profundización y aceleración corresponde a este estudiante<br>
**Evidencia de aprendizaje:** un plan de respuesta con evidencia de dominio previo y la modalidad elegida justificada

## 🎯 Propósito

Diseñar respuestas de enriquecimiento, compactación y aceleración para estudiantes con altas capacidades, con criterios y no con improvisación.
...
2. **Explicar** por qué la respuesta habitual a un estudiante que ya sabe es darle más trabajo del mismo.
3. **Decidir** —qué combinación de compactación, profundización y aceleración corresponde a este estudiante— y sostener la decisión con un fundamento escrito.
4. **Producir** la evidencia de la clase —un plan de respuesta con evidencia de dominio previo y la modalidad elegida justificada— y contrastarla contra el criterio de logro.
...
|---|---|
| **Compactación curricular** | eliminación del contenido ya dominado, comprobada con evaluación previa, para liberar tiempo |
| **Enriquecimiento** | profundización o ampliación del contenido, en vez de aumento de la cantidad de ejercicios |
| **Aceleración** | avance a un nivel superior en una asignatura o en el curso completo, con evidencia de respaldo favorable |
| **Subrendimiento** | desempeño muy por debajo de la capacidad demostrada, frecuente y asociado a desenganche |
...
2. Clasificar la situación distinguiendo **Compactación curricular** de **Enriquecimiento**.
3. Decidir con fundamento, usando **Aceleración** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Subrendimiento** a la vista.
...
| **Evidencia de logro** | qué muestra un plan de respuesta con evidencia de dominio previo y la modalidad elegida justificada frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
La identificación arrastra sesgos socioeconómicos y de género bien documentados: Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Compactación<br/>curricular"]
    C --> A2["Enriquecimiento"]
    C --> A3["Aceleración"]
    C --> A4["Subrendimiento"]
    A1 & A2 & A3 & A4 --> D{{"determinar qué<br/>combinación de<br/>compactación,<br/>profundización y<br/>aceleración corresponde<br/>a este…"}}
    D --> E["Evidencia de aprendizaje<br/>un plan de respuesta con<br/>evidencia de dominio<br/>previo y la modalidad<br/>elegida justificada"]
...
Las altas capacidades son la necesidad educativa peor atendida del sistema, en parte porque se asume que estos estudiantes se las arreglan solos. La evidencia sobre aceleración es de las más consistentes del campo y contradice la intuición escolar dominante: en sus diversas formas produce beneficios académicos sin los efectos sociales negativos que se le atribuyen. La respuesta más común —más ejercicios del mismo tipo— es también la que más contribuye al desenganche.

### 2. Frontera conceptual: qué es y qué no es

Los cuatro conceptos de esta clase se confunden entre sí con facilidad, y esa confusión no es
inocua: produce decisiones que atacan el problema equivocado. **Compactación curricular** no es lo
mismo que **Enriquecimiento** —profundización o ampliación del contenido, en vez de aumento de la cantidad de ejercicios—, y tratarlos como sinónimos hace
que la intervención se dirija al lugar incorrecto. Del mismo modo, **Aceleración** y
**Subrendimiento** describen aspectos distintos de la misma situación: el primero
avance a un nivel superior en una asignatura o en el curso completo, con evidencia de respaldo favorable, mientras el segundo desempeño muy por debajo de la capacidad demostrada, frecuente y asociado a desenganche.
...
- **Evidencia de logro.** Qué muestra un plan de respuesta con evidencia de dominio previo y la modalidad elegida justificada frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
La secuencia profesional parte por comprobar el dominio: se evalúa antes de enseñar y se elimina lo ya dominado. El tiempo liberado se destina a profundización real —problemas más complejos, proyectos de investigación, contenido de nivel superior— y no a tareas adicionales del mismo nivel. La aceleración, total o por asignatura, se evalúa con criterios establecidos y considerando madurez y contexto, no como excepción heroica.

### 5. Qué sostiene la evidencia y qué no

La identificación arrastra sesgos socioeconómicos y de género bien documentados: los instrumentos y los mecanismos de derivación favorecen a estudiantes de familias que conocen el sistema. El talento es además específico de dominio y su expresión varía en el tiempo, de modo que las clasificaciones tempranas y permanentes son problemáticas. Y la evidencia sobre programas de enriquecimiento extraescolar es más débil que la de aceleración.
...
te deja en condiciones de qué combinación de compactación, profundización y aceleración corresponde a este estudiante, y esa decisión se sostiene solo si
...
|---|---|---|
| Assouline, S. et al. (2015). *A Nation Empowered*. | la síntesis de evidencia sobre aceleración que contradice la práctica escolar habitual. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
| Subotnik, R., Olszewski-Kubilius, P. & Worrell, F. (2011). *Rethinking Giftedness and Gifted Education*. | el talento como trayectoria específica de dominio y no como atributo fijo. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Compactación curricular** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Compactación curricular de Enriquecimiento.** El trabajo aquí es separar lo observado de lo interpretado sobre **Enriquecimiento**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Aceleración como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Aceleración**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.

**Paso 4 — Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con Subrendimiento a la vista.** Con **Subrendimiento** ya delimitado, la pregunta pasa a ser de consecuencia: qué cambia para los estudiantes, para el tiempo de clase y para la carga del equipo. **Evidencia de partida** entrega la lectura observable; el juicio profesional sigue siendo humano y debe quedar firmado por quien lo hace.
...
|---|---|---|---|
| Intervenir sobre **Compactación curricular** | Eliminación del contenido ya dominado, comprobada con evaluación previa, para liberar tiempo | Cuando **Evidencia de partida** es observable y accionable dentro del plazo de la decisión. | Sobrerreaccionar a una señal parcial. |
| Intervenir sobre **Enriquecimiento** | Profundización o ampliación del contenido, en vez de aumento de la cantidad de ejercicios | Cuando la primera explicación no distingue mecanismo ni responsable. | Convertir el concepto en etiqueta y no en intervención. |
| Observar antes de decidir | Reducir la incertidumbre antes de comprometer tiempo y credibilidad | Cuando la decisión es reversible y la evidencia disponible no distingue causas. | Observar indefinidamente y no decidir nunca. |
| Derivar o escalar | Poner la decisión donde están la competencia y la responsabilidad | Cuando hay normativa, resguardo de datos, salud o vulneración de derechos en juego. | Delegar hacia arriba lo que sí correspondía decidir en el aula. |

**Frontera de aplicación.** La identificación arrastra sesgos socioeconómicos y de género bien documentados: Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre altas capacidades: enriquecimiento y aceleración |
|---|---|
...
Un plan de respuesta con evidencia de dominio previo y la modalidad elegida justificada.

Guárdala en `evidence/P20-C250-altas-capacidades-enriquecimiento-y-aceleracion/` con estos archivos:
...
Aplica una evaluación previa a tu próxima unidad. Compacta el contenido dominado de un estudiante y diseña qué hará con el tiempo liberado.
...
- [ ] existe evidencia de dominio previo que justifica la compactación;
- [ ] la modalidad elegida está justificada con criterios y no por disponibilidad de material;
...
- Asignar más ejercicios del mismo nivel como respuesta al estudiante que ya terminó.
- Rechazar la aceleración por preocupación social sin examinar la evidencia disponible.
...
El subdiagnóstico se concentra en estudiantes de contextos vulnerables, en niñas y en quienes tienen doble excepcionalidad —altas capacidades junto a una dificultad específica—, cuyo perfil se cancela mutuamente en los instrumentos habituales.
...
1. ¿Qué proporción del contenido de la unidad ya domina este estudiante, comprobado?
2. ¿Qué haces con el tiempo que se libera si compactas?
3. ¿A quién no estás identificando en tu curso y por qué?
...
Profundiza la clase 107 y aplica el método de la 241. Enlaza con la parte 09 y con la clase 151.
...
|---|---|---|
| [← 249 · Trastornos del lenguaje y de la comunicación](../class-09-trastornos-del-lenguaje-y-de-la-comunicacion/README.md) | [Parte 20](../README.md) · [Programa](../../../README.md) | [251 · Acompañamiento diferenciado y codocencia →](../class-11-acompanamiento-diferenciado-y-codocencia/README.md) |
