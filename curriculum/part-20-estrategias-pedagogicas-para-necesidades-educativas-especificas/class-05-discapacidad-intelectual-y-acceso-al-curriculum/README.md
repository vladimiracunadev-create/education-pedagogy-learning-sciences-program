# Clase 245 — Discapacidad intelectual y acceso al currículum

> **Parte 20 · Estrategias pedagógicas para necesidades educativas específicas** — clase 5 de 12
...
**Decisión que habilita:** determinar qué objetivos se mantienen, cuáles se priorizan y cuáles se adecúan para este estudiante<br>
**Evidencia de aprendizaje:** una priorización curricular justificada con evidencia de aprendizaje y proyección funcional

## 🎯 Propósito

Diseñar acceso al currículum común para estudiantes con discapacidad intelectual, con adecuaciones que preserven el aprendizaje significativo y proyección de vida independiente.
...
2. **Explicar** cómo se sostiene el acceso al currículum sin convertir la adecuación en un currículum paralelo.
3. **Decidir** —qué objetivos se mantienen, cuáles se priorizan y cuáles se adecúan para este estudiante— y sostener la decisión con un fundamento escrito.
4. **Producir** la evidencia de la clase —una priorización curricular justificada con evidencia de aprendizaje y proyección funcional— y contrastarla contra el criterio de logro.
...
|---|---|
| **Priorización curricular** | selección fundamentada de objetivos esenciales cuando no es posible abordar todos con profundidad |
| **Adecuación significativa** | modificación del objetivo de aprendizaje, no solo del acceso; exige justificación y revisión periódica |
| **Habilidad funcional** | aprendizaje con uso directo en la vida cotidiana y en la autonomía futura del estudiante |
| **Sistema de apoyos** | conjunto de recursos y estrategias graduadas que sostienen el funcionamiento en contextos concretos |
...
2. Clasificar la situación distinguiendo **Priorización curricular** de **Adecuación significativa**.
3. Decidir con fundamento, usando **Habilidad funcional** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Sistema de apoyos** a la vista.
...
| **Evidencia de logro** | qué muestra una priorización curricular justificada con evidencia de aprendizaje y proyección funcional frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
La priorización siempre implica pérdida y no hay algoritmo que la resuelva. Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Priorización<br/>curricular"]
    C --> A2["Adecuación<br/>significativa"]
    C --> A3["Habilidad funcional"]
    C --> A4["Sistema de apoyos"]
    A1 & A2 & A3 & A4 --> D{{"determinar qué objetivos<br/>se mantienen, cuáles se<br/>priorizan y cuáles se<br/>adecúan para este…"}}
    D --> E["Evidencia de aprendizaje<br/>una priorización<br/>curricular justificada<br/>con evidencia de<br/>aprendizaje y proyección<br/>funcional"]
...
El campo se desplazó desde clasificar por nivel de déficit hacia describir el sistema de apoyos que la persona requiere para funcionar en contextos determinados. Ese giro tiene consecuencias escolares directas: la pregunta deja de ser cuánto puede aprender este estudiante y pasa a ser qué apoyos necesita para aprender esto. En la práctica escolar, la tensión permanente es entre currículum común con adecuaciones y aprendizajes funcionales, y resolverla exige decisiones explícitas, no una respuesta general.

### 2. Frontera conceptual: qué es y qué no es

Los cuatro conceptos de esta clase se confunden entre sí con facilidad, y esa confusión no es
inocua: produce decisiones que atacan el problema equivocado. **Priorización curricular** no es lo
mismo que **Adecuación significativa** —modificación del objetivo de aprendizaje, no solo del acceso; exige justificación y revisión periódica—, y tratarlos como sinónimos hace
que la intervención se dirija al lugar incorrecto. Del mismo modo, **Habilidad funcional** y
**Sistema de apoyos** describen aspectos distintos de la misma situación: el primero
aprendizaje con uso directo en la vida cotidiana y en la autonomía futura del estudiante, mientras el segundo conjunto de recursos y estrategias graduadas que sostienen el funcionamiento en contextos concretos.
...
- **Evidencia de logro.** Qué muestra una priorización curricular justificada con evidencia de aprendizaje y proyección funcional frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
La priorización se hace con criterio declarado: se mantienen los objetivos con mayor proyección funcional y mayor valor de participación social, y se adecúan aquellos cuya versión completa no es alcanzable en el tiempo disponible. Cada adecuación significativa se documenta con su justificación y se revisa al menos una vez al año, porque las decisiones tomadas en tercero básico tienden a arrastrarse sin revisión hasta cuarto medio.

### 5. Qué sostiene la evidencia y qué no

La priorización siempre implica pérdida y no hay algoritmo que la resuelva. Existe además evidencia de que las expectativas del equipo predicen el desempeño más de lo que el diagnóstico justifica, lo que convierte la adecuación temprana en una profecía. Y la investigación sobre resultados de largo plazo en inclusión escolar es más débil de lo que el consenso normativo sugiere.
...
te deja en condiciones de qué objetivos se mantienen, cuáles se priorizan y cuáles se adecúan para este estudiante, y esa decisión se sostiene solo si
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Priorización curricular** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Priorización curricular de Adecuación significativa.** El trabajo aquí es separar lo observado de lo interpretado sobre **Adecuación significativa**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Habilidad funcional como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Habilidad funcional**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.

**Paso 4 — Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con Sistema de apoyos a la vista.** Con **Sistema de apoyos** ya delimitado, la pregunta pasa a ser de consecuencia: qué cambia para los estudiantes, para el tiempo de clase y para la carga del equipo. **Evidencia de partida** entrega la lectura observable; el juicio profesional sigue siendo humano y debe quedar firmado por quien lo hace.
...
|---|---|---|---|
| Intervenir sobre **Priorización curricular** | Selección fundamentada de objetivos esenciales cuando no es posible abordar todos con profundidad | Cuando **Evidencia de partida** es observable y accionable dentro del plazo de la decisión. | Sobrerreaccionar a una señal parcial. |
| Intervenir sobre **Adecuación significativa** | Modificación del objetivo de aprendizaje, no solo del acceso; exige justificación y revisión periódica | Cuando la primera explicación no distingue mecanismo ni responsable. | Convertir el concepto en etiqueta y no en intervención. |
| Observar antes de decidir | Reducir la incertidumbre antes de comprometer tiempo y credibilidad | Cuando la decisión es reversible y la evidencia disponible no distingue causas. | Observar indefinidamente y no decidir nunca. |
| Derivar o escalar | Poner la decisión donde están la competencia y la responsabilidad | Cuando hay normativa, resguardo de datos, salud o vulneración de derechos en juego. | Delegar hacia arriba lo que sí correspondía decidir en el aula. |

**Frontera de aplicación.** La priorización siempre implica pérdida y no hay algoritmo que la resuelva. Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre discapacidad intelectual y acceso al currículum |
|---|---|
...
Una priorización curricular justificada con evidencia de aprendizaje y proyección funcional.

Guárdala en `evidence/P20-C245-discapacidad-intelectual-y-acceso-al-curriculum/` con estos archivos:
...
Revisa la adecuación vigente de un estudiante. Documenta qué se decidió, cuándo y con qué evidencia, y propone la actualización que corresponda.
...
- [ ] cada adecuación significativa tiene justificación escrita y fecha de revisión;
- [ ] la priorización declara el criterio funcional y de participación que la ordena;
...
- Adecuar significativamente en los primeros años y no volver a revisar esa decisión nunca.
- Sustituir el currículum por actividades ocupacionales sin objetivo de aprendizaje declarado.
...
La adecuación significativa es la decisión más irreversible que toma un equipo escolar: define lo que el estudiante no aprenderá. Tomarla sin justificación escrita ni revisión programada es una de las formas más silenciosas de exclusión.
...
Profundiza la clase 106 y se apoya en las clases 241 y 099. Enlaza con la parte 06 y la clase 251.
...
|---|---|---|
| [← 244 · Autismo: estructura, anticipación y comunicación](../class-04-autismo-estructura-anticipacion-y-comunicacion/README.md) | [Parte 20](../README.md) · [Programa](../../../README.md) | [246 · Dislexia, disgrafía y discalculia en el aula común →](../class-06-dislexia-disgrafia-y-discalculia-en-el-aula-comun/README.md) |
