# Clase 251 — Acompañamiento diferenciado y codocencia

> **Parte 20 · Estrategias pedagógicas para necesidades educativas específicas** — clase 11 de 12

**Estado de evidencia:** `PRACTICA-PROFESIONAL` · **Etapa:** 🟤 Etapa F — Especialización y desafíos contemporáneos · **Población de referencia:** transversal, con foco en aula común<br>
**Decisión que habilita:** determinar qué modelo de codocencia usa tu curso, con qué tiempo real de coordinación y con qué reparto de responsabilidad<br>
**Evidencia de aprendizaje:** un acuerdo de codocencia con roles por momento de la clase, horario de coordinación y responsable de registro

## 🎯 Propósito

Organizar la coordinación entre docente de aula y educador diferencial con roles, tiempos y registro, para que el apoyo ocurra dentro de la clase.
...
2. **Explicar** por qué el apoyo se cae por logística y no por falta de conocimiento.
3. **Decidir** —qué modelo de codocencia usa tu curso, con qué tiempo real de coordinación y con qué reparto de responsabilidad— y sostener la decisión con un fundamento escrito.
4. **Producir** la evidencia de la clase —un acuerdo de codocencia con roles por momento de la clase, horario de coordinación y responsable de registro— y contrastarla contra el criterio de logro.
...
|---|---|
| **Codocencia** | trabajo conjunto de dos profesionales en la misma aula con responsabilidad compartida sobre todo el curso |
| **Modelos de codocencia** | formas de repartir la clase: apoyo, estaciones, enseñanza paralela, alternativa o en equipo |
| **Tiempo de coordinación** | horario protegido para planificar juntos; sin él, la codocencia se degrada a asistencia |
| **Acompañamiento diferenciado** | apoyo ajustado a necesidades distintas dentro de la misma clase y no fuera de ella |
...
2. Clasificar la situación distinguiendo **Codocencia** de **Modelos de codocencia**.
3. Decidir con fundamento, usando **Tiempo de coordinación** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Acompañamiento diferenciado** a la vista.
...
| **Evidencia de logro** | qué muestra un acuerdo de codocencia con roles por momento de la clase, horario de coordinación y responsable de registro frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
El tiempo de coordinación depende de decisiones de dirección que exceden a los docentes involucrados. Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Codocencia"]
    C --> A2["Modelos de codocencia"]
    C --> A3["Tiempo de coordinación"]
    C --> A4["Acompañamiento<br/>diferenciado"]
    A1 & A2 & A3 & A4 --> D{{"determinar qué modelo de<br/>codocencia usa tu curso,<br/>con qué tiempo real de<br/>coordinación y con qué…"}}
    D --> E["Evidencia de aprendizaje<br/>un acuerdo de codocencia<br/>con roles por momento de<br/>la clase, horario de<br/>coordinación y…"]
...
La mayoría de los planes de apoyo bien diseñados fracasan por razones organizacionales: no hay horario común para planificar, los roles no están definidos, y el segundo profesional termina como ayudante que circula entre los mismos tres estudiantes. La investigación disponible sobre codocencia es moderada en calidad, pero converge en una condición: sin tiempo protegido de coordinación, ninguno de los modelos funciona, y el más frecuente en la práctica —uno enseña y otro apoya— es también el de menor rendimiento.

### 2. Frontera conceptual: qué es y qué no es

Los cuatro conceptos de esta clase se confunden entre sí con facilidad, y esa confusión no es
inocua: produce decisiones que atacan el problema equivocado. **Codocencia** no es lo
mismo que **Modelos de codocencia** —formas de repartir la clase: apoyo, estaciones, enseñanza paralela, alternativa o en equipo—, y tratarlos como sinónimos hace
que la intervención se dirija al lugar incorrecto. Del mismo modo, **Tiempo de coordinación** y
**Acompañamiento diferenciado** describen aspectos distintos de la misma situación: el primero
horario protegido para planificar juntos;, mientras el segundo apoyo ajustado a necesidades distintas dentro de la misma clase y no fuera de ella.
...
- **Evidencia de logro.** Qué muestra un acuerdo de codocencia con roles por momento de la clase, horario de coordinación y responsable de registro frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
El acuerdo escrito resuelve lo que las buenas intenciones no resuelven: qué modelo se usa en cada momento de la clase, quién conduce, quién observa y registra, cómo se reparte la evaluación y en qué horario concreto se planifica. Definir que ambos profesionales son responsables de todo el curso —y no uno de los treinta y otro de los tres— es el cambio que más modifica la práctica observada.

### 5. Qué sostiene la evidencia y qué no

El tiempo de coordinación depende de decisiones de dirección que exceden a los docentes involucrados. La evidencia sobre efectos de la codocencia en aprendizaje es limitada y heterogénea, con muchos estudios de diseño débil. Y el modelo exige compatibilidad profesional real: dos personas competentes pueden coordinar mal y la estructura sola no lo compensa.
...
te deja en condiciones de qué modelo de codocencia usa tu curso, con qué tiempo real de coordinación y con qué reparto de responsabilidad, y esa decisión se sostiene solo si
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Codocencia** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Codocencia de Modelos de codocencia.** El trabajo aquí es separar lo observado de lo interpretado sobre **Modelos de codocencia**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Tiempo de coordinación como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Tiempo de coordinación**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.

**Paso 4 — Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con Acompañamiento diferenciado a la vista.** Con **Acompañamiento diferenciado** ya delimitado, la pregunta pasa a ser de consecuencia: qué cambia para los estudiantes, para el tiempo de clase y para la carga del equipo. **Evidencia de partida** entrega la lectura observable; el juicio profesional sigue siendo humano y debe quedar firmado por quien lo hace.
...
|---|---|---|---|
| Intervenir sobre **Codocencia** | Trabajo conjunto de dos profesionales en la misma aula con responsabilidad compartida sobre todo el curso | Cuando **Evidencia de partida** es observable y accionable dentro del plazo de la decisión. | Sobrerreaccionar a una señal parcial. |
| Intervenir sobre **Modelos de codocencia** | Formas de repartir la clase: apoyo, estaciones, enseñanza paralela, alternativa o en equipo | Cuando la primera explicación no distingue mecanismo ni responsable. | Convertir el concepto en etiqueta y no en intervención. |
| Observar antes de decidir | Reducir la incertidumbre antes de comprometer tiempo y credibilidad | Cuando la decisión es reversible y la evidencia disponible no distingue causas. | Observar indefinidamente y no decidir nunca. |
| Derivar o escalar | Poner la decisión donde están la competencia y la responsabilidad | Cuando hay normativa, resguardo de datos, salud o vulneración de derechos en juego. | Delegar hacia arriba lo que sí correspondía decidir en el aula. |

**Frontera de aplicación.** El tiempo de coordinación depende de decisiones de dirección que exceden a los docentes involucrados. Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre acompañamiento diferenciado y codocencia |
|---|---|
...
Un acuerdo de codocencia con roles por momento de la clase, horario de coordinación y responsable de registro.

Guárdala en `evidence/P20-C251-acompanamiento-diferenciado-y-codocencia/` con estos archivos:
...
Escribe el acuerdo de codocencia de un curso con roles por momento. Aplícalo dos semanas y registra cuánto tiempo de coordinación ocurrió realmente.
...
- [ ] el acuerdo declara modelo, roles y responsable de registro por momento de la clase;
- [ ] existe horario de coordinación protegido, con día y hora concretos;
...
- Sostener la codocencia sin horario de planificación y esperar coordinación en los recreos.
- Asignar el segundo profesional a un grupo fijo de estudiantes, que es segregación dentro del aula.
...
El diseño de la coordinación decide si el apoyo incluye o segrega: el mismo profesional puede sostener la participación del estudiante en la clase o instalar un aula paralela dentro de la sala.
...
1. ¿Cuánto tiempo real de planificación conjunta tienen esta semana, en el horario?
2. ¿Quién es responsable de los estudiantes con apoyo cuando el otro profesional falta?
3. ¿Tu segundo profesional trabaja con todo el curso o solo con los mismos tres?
...
Integra las clases 242 a 250 y prepara el proyecto integrador. Se articula con la parte 08 y con la clase 186.
...
|---|---|---|
| [← 250 · Altas capacidades: enriquecimiento y aceleración](../class-10-altas-capacidades-enriquecimiento-y-aceleracion/README.md) | [Parte 20](../README.md) · [Programa](../../../README.md) | [252 · Proyecto integrador: plan de apoyo con estrategias verificables →](../class-12-proyecto-integrador/README.md) |
