# Clase 246 — Dislexia, disgrafía y discalculia en el aula común

> **Parte 20 · Estrategias pedagógicas para necesidades educativas específicas** — clase 6 de 12
...
**Decisión que habilita:** determinar qué apoyos de acceso permiten que este estudiante aprenda tu asignatura mientras trabaja su dificultad<br>
**Evidencia de aprendizaje:** un conjunto de apoyos de acceso por asignatura con su justificación y su efecto registrado

## 🎯 Propósito

Sostener el aprendizaje de la asignatura en estudiantes con dislexia, disgrafía o discalculia mediante apoyos de acceso, sin asumir el rol de especialista.
...
2. **Explicar** qué hace un docente de asignatura con una dificultad específica que no le corresponde tratar.
3. **Decidir** —qué apoyos de acceso permiten que este estudiante aprenda tu asignatura mientras trabaja su dificultad— y sostener la decisión con un fundamento escrito.
4. **Producir** la evidencia de la clase —un conjunto de apoyos de acceso por asignatura con su justificación y su efecto registrado— y contrastarla contra el criterio de logro.
...
|---|---|
| **Dificultad específica del aprendizaje** | dificultad persistente en un dominio —lectura, escritura o cálculo— no explicada por enseñanza insuficiente ni por capacidad general |
| **Apoyo de acceso** | ajuste que permite recibir o expresar el contenido sin modificar el objetivo evaluado |
| **Doble tarea** | situación en que el estudiante debe resolver el contenido y sortear su dificultad simultáneamente, con sobrecarga garantizada |
| **Evaluación no contaminada** | instrumento que mide el objetivo declarado y no la dificultad específica del estudiante |
...
2. Clasificar la situación distinguiendo **Dificultad específica del aprendizaje** de **Apoyo de acceso**.
3. Decidir con fundamento, usando **Doble tarea** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Evaluación no contaminada** a la vista.
...
| **Evidencia de logro** | qué muestra un conjunto de apoyos de acceso por asignatura con su justificación y su efecto registrado frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
Los apoyos de acceso permiten aprender el contenido y no remedian la dificultad, que requiere intervención específica y sostenida. Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Dificultad específica<br/>del aprendizaje"]
    C --> A2["Apoyo de acceso"]
    C --> A3["Doble tarea"]
    C --> A4["Evaluación no<br/>contaminada"]
    A1 & A2 & A3 & A4 --> D{{"determinar qué apoyos de<br/>acceso permiten que este<br/>estudiante aprenda tu<br/>asignatura mientras…"}}
    D --> E["Evidencia de aprendizaje<br/>un conjunto de apoyos de<br/>acceso por asignatura<br/>con su justificación y<br/>su efecto registrado"]
...
El docente de historia no trata la dislexia y el de matemática no trata la discalculia, pero ambos deciden todos los días si ese estudiante puede aprender su asignatura. Ahí está el punto: sin apoyos de acceso, la dificultad específica contamina toda la escolaridad y el estudiante termina con bajo rendimiento generalizado que nada tiene que ver con su capacidad. El principio ordenador es separar el objetivo de la vía: si la clase evalúa comprensión histórica, la ortografía no debe decidir la nota.

### 2. Frontera conceptual: qué es y qué no es

Los cuatro conceptos de esta clase se confunden entre sí con facilidad, y esa confusión no es
inocua: produce decisiones que atacan el problema equivocado. **Dificultad específica del aprendizaje** no es lo
mismo que **Apoyo de acceso** —ajuste que permite recibir o expresar el contenido sin modificar el objetivo evaluado—, y tratarlos como sinónimos hace
que la intervención se dirija al lugar incorrecto. Del mismo modo, **Doble tarea** y
**Evaluación no contaminada** describen aspectos distintos de la misma situación: el primero
situación en que el estudiante debe resolver el contenido y sortear su dificultad simultáneamente, con sobrecarga garantizada, mientras el segundo instrumento que mide el objetivo declarado y no la dificultad específica del estudiante.
...
- **Evidencia de logro.** Qué muestra un conjunto de apoyos de acceso por asignatura con su justificación y su efecto registrado frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
Los apoyos con mejor relación entre costo y efecto son conocidos: texto leído en voz alta o en audio, más tiempo, calculadora cuando el objetivo no es el cálculo, respuesta oral o por teclado, textos con formato accesible, y evaluación de la ortografía solo cuando ese sea el objetivo declarado. Cada apoyo se declara en el instrumento y se aplica siempre, no solo en la prueba: un apoyo que aparece únicamente en la evaluación no fue enseñado ni entrenado.

### 5. Qué sostiene la evidencia y qué no

Los apoyos de acceso permiten aprender el contenido y no remedian la dificultad, que requiere intervención específica y sostenida. Existe además un debate real sobre cuándo un apoyo deja de ser acceso y pasa a alterar lo evaluado —la lectura en voz alta en una prueba de comprensión lectora es el caso clásico— y ese límite exige juicio profesional caso a caso.
...
te deja en condiciones de qué apoyos de acceso permiten que este estudiante aprenda tu asignatura mientras trabaja su dificultad, y esa decisión se sostiene solo si
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Dificultad específica del aprendizaje** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Dificultad específica del aprendizaje de Apoyo de acceso.** El trabajo aquí es separar lo observado de lo interpretado sobre **Apoyo de acceso**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Doble tarea como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Doble tarea**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.

**Paso 4 — Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con Evaluación no contaminada a la vista.** Con **Evaluación no contaminada** ya delimitado, la pregunta pasa a ser de consecuencia: qué cambia para los estudiantes, para el tiempo de clase y para la carga del equipo. **Evidencia de partida** entrega la lectura observable; el juicio profesional sigue siendo humano y debe quedar firmado por quien lo hace.
...
|---|---|---|---|
| Intervenir sobre **Dificultad específica del aprendizaje** | Dificultad persistente en un dominio —lectura, escritura o cálculo— no explicada por enseñanza insuficiente ni por capacidad general | Cuando **Evidencia de partida** es observable y accionable dentro del plazo de la decisión. | Sobrerreaccionar a una señal parcial. |
| Intervenir sobre **Apoyo de acceso** | Ajuste que permite recibir o expresar el contenido sin modificar el objetivo evaluado | Cuando la primera explicación no distingue mecanismo ni responsable. | Convertir el concepto en etiqueta y no en intervención. |
| Observar antes de decidir | Reducir la incertidumbre antes de comprometer tiempo y credibilidad | Cuando la decisión es reversible y la evidencia disponible no distingue causas. | Observar indefinidamente y no decidir nunca. |
| Derivar o escalar | Poner la decisión donde están la competencia y la responsabilidad | Cuando hay normativa, resguardo de datos, salud o vulneración de derechos en juego. | Delegar hacia arriba lo que sí correspondía decidir en el aula. |

**Frontera de aplicación.** Los apoyos de acceso permiten aprender el contenido y no remedian la dificultad, que requiere intervención específica y sostenida. Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre dislexia, disgrafía y discalculia en el aula común |
|---|---|
...
Un conjunto de apoyos de acceso por asignatura con su justificación y su efecto registrado.

Guárdala en `evidence/P20-C246-dislexia-disgrafia-y-discalculia-en-el-aula-comun/` con estos archivos:
...
Revisa tu última evaluación e identifica qué habilidad no declarada estaba midiendo. Rediséñala con apoyos de acceso y compara los resultados del estudiante.
...
- [ ] cada apoyo declara qué objetivo protege y por qué no altera lo evaluado;
- [ ] los apoyos se usan durante la enseñanza y no solo en la evaluación;
...
- Aplicar el apoyo solo el día de la prueba, sin haberlo usado nunca durante las clases.
- Descontar puntaje por ortografía en una evaluación cuyo objetivo declarado era otro.
...
Sin apoyos de acceso, una dificultad acotada se convierte en fracaso escolar generalizado y termina leyéndose como falta de capacidad. Es uno de los mecanismos mejor documentados por los que la escuela produce trayectorias que no correspondían.
...
1. ¿Qué mide realmente tu evaluación en el caso de este estudiante?
2. ¿Cuántos de tus apoyos existen solo el día de la prueba?
3. ¿Dónde está el límite entre acceso y alteración del objetivo en tu asignatura?
...
Aplica lo trabajado en la parte 18 y en la clase 104. Se articula con la 241 y con la parte 11.
...
|---|---|---|
| [← 245 · Discapacidad intelectual y acceso al currículum](../class-05-discapacidad-intelectual-y-acceso-al-curriculum/README.md) | [Parte 20](../README.md) · [Programa](../../../README.md) | [247 · Discapacidad visual y auditiva: estrategias de acceso →](../class-07-discapacidad-visual-y-auditiva-estrategias-de-acceso/README.md) |
