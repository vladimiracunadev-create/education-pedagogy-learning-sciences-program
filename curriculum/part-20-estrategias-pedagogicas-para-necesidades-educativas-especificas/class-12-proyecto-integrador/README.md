# Clase 252 — Proyecto integrador: plan de apoyo con estrategias verificables

> **Parte 20 · Estrategias pedagógicas para necesidades educativas específicas** — clase 12 de 12
...
**Decisión que habilita:** determinar el plan de apoyo completo de un estudiante y cómo se verificará que se ejecutó<br>
**Evidencia de aprendizaje:** un plan de apoyo con barreras, estrategias, responsables, evidencia comprometida y fecha de revisión

## 🎯 Propósito

Integrar barreras, estrategias, responsables y evidencia en un plan de apoyo verificable, revisable y ejecutable por quien no lo escribió.
...
2. **Explicar** cómo se escribe un plan de apoyo que cambie algo en el aula y no solo en la carpeta.
3. **Decidir** —el plan de apoyo completo de un estudiante y cómo se verificará que se ejecutó— y sostener la decisión con un fundamento escrito.
4. **Producir** la evidencia de la clase —un plan de apoyo con barreras, estrategias, responsables, evidencia comprometida y fecha de revisión— y contrastarla contra el criterio de logro.
...
|---|---|
| **Plan de apoyo** | documento que traduce las necesidades de un estudiante en decisiones de aula con responsables y plazos |
| **Evidencia comprometida** | producto o registro concreto que permitirá saber si el apoyo se ejecutó y si sirvió |
| **Ejecutabilidad** | propiedad de un plan que puede aplicar un docente que no participó en su elaboración |
| **Revisión con datos** | instancia programada donde se decide mantener, ajustar o retirar cada apoyo según lo observado |
...
2. Clasificar la situación distinguiendo **Plan de apoyo** de **Evidencia comprometida**.
3. Decidir con fundamento, usando **Ejecutabilidad** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Revisión con datos** a la vista.
...
| **Evidencia de logro** | qué muestra un plan de apoyo con barreras, estrategias, responsables, evidencia comprometida y fecha de revisión frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
Un plan bien escrito no garantiza ejecución: Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Plan de apoyo"]
    C --> A2["Evidencia comprometida"]
    C --> A3["Ejecutabilidad"]
    C --> A4["Revisión con datos"]
    A1 & A2 & A3 & A4 --> D{{"determinar el plan de<br/>apoyo completo de un<br/>estudiante y cómo se<br/>verificará que se<br/>ejecutó"}}
    D --> E["Evidencia de aprendizaje<br/>un plan de apoyo con<br/>barreras, estrategias,<br/>responsables, evidencia<br/>comprometida y fecha de…"]
...
En el caso del programa, tres de catorce planes de apoyo cambian algo en el aula; el resto se completa, se firma y se archiva. Esa proporción es la norma del sistema y su causa es identificable: los planes describen al estudiante en detalle y prescriben la práctica en generalidades. Un plan que cambia algo se reconoce porque cualquier docente del curso puede leerlo el lunes y saber exactamente qué hace distinto en su clase.

### 2. Frontera conceptual: qué es y qué no es

Los cuatro conceptos de esta clase se confunden entre sí con facilidad, y esa confusión no es
inocua: produce decisiones que atacan el problema equivocado. **Plan de apoyo** no es lo
mismo que **Evidencia comprometida** —producto o registro concreto que permitirá saber si el apoyo se ejecutó y si sirvió—, y tratarlos como sinónimos hace
que la intervención se dirija al lugar incorrecto. Del mismo modo, **Ejecutabilidad** y
**Revisión con datos** describen aspectos distintos de la misma situación: el primero
propiedad de un plan que puede aplicar un docente que no participó en su elaboración, mientras el segundo instancia programada donde se decide mantener, ajustar o retirar cada apoyo según lo observado.
...
- **Evidencia de logro.** Qué muestra un plan de apoyo con barreras, estrategias, responsables, evidencia comprometida y fecha de revisión frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
El proyecto integra las once clases anteriores. Cada barrera se formula en términos observables, con la evidencia que la sustenta. Cada estrategia declara quién la ejecuta, en qué momento y con qué material. Cada apoyo compromete una evidencia y una fecha de revisión. Se agrega la prueba decisiva: entregar el plan a un docente del curso que no participó y verificar si puede ejecutarlo sin explicaciones adicionales.

### 5. Qué sostiene la evidencia y qué no

Un plan bien escrito no garantiza ejecución: depende de tiempo, de coordinación y de decisiones institucionales que lo exceden. Tampoco predice resultados, porque los apoyos que funcionan con un estudiante pueden no funcionar con otro de perfil similar. Y existe el riesgo de que el documento se vuelva un fin en sí mismo, consumiendo el tiempo que debía destinarse a la enseñanza.
...
te deja en condiciones de el plan de apoyo completo de un estudiante y cómo se verificará que se ejecutó, y esa decisión se sostiene solo si
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Plan de apoyo** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Plan de apoyo de Evidencia comprometida.** El trabajo aquí es separar lo observado de lo interpretado sobre **Evidencia comprometida**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Ejecutabilidad como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Ejecutabilidad**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.

**Paso 4 — Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con Revisión con datos a la vista.** Con **Revisión con datos** ya delimitado, la pregunta pasa a ser de consecuencia: qué cambia para los estudiantes, para el tiempo de clase y para la carga del equipo. **Evidencia de partida** entrega la lectura observable; el juicio profesional sigue siendo humano y debe quedar firmado por quien lo hace.
...
|---|---|---|---|
| Intervenir sobre **Plan de apoyo** | Documento que traduce las necesidades de un estudiante en decisiones de aula con responsables y plazos | Cuando **Evidencia de partida** es observable y accionable dentro del plazo de la decisión. | Sobrerreaccionar a una señal parcial. |
| Intervenir sobre **Evidencia comprometida** | Producto o registro concreto que permitirá saber si el apoyo se ejecutó y si sirvió | Cuando la primera explicación no distingue mecanismo ni responsable. | Convertir el concepto en etiqueta y no en intervención. |
| Observar antes de decidir | Reducir la incertidumbre antes de comprometer tiempo y credibilidad | Cuando la decisión es reversible y la evidencia disponible no distingue causas. | Observar indefinidamente y no decidir nunca. |
| Derivar o escalar | Poner la decisión donde están la competencia y la responsabilidad | Cuando hay normativa, resguardo de datos, salud o vulneración de derechos en juego. | Delegar hacia arriba lo que sí correspondía decidir en el aula. |

**Frontera de aplicación.** Un plan bien escrito no garantiza ejecución: Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre proyecto integrador: plan de apoyo con estrategias verificables |
|---|---|
...
Un plan de apoyo con barreras, estrategias, responsables, evidencia comprometida y fecha de revisión.

Guárdala en `evidence/P20-C252-proyecto-integrador/` con estos archivos:
...
Escribe el plan completo de un estudiante y entrégalo a un colega del curso. Pídele que ejecute una semana solo con el documento y registra qué le faltó.
...
- [ ] cada estrategia declara responsable, momento y material concreto;
- [ ] un docente que no participó puede ejecutar el plan leyéndolo una vez;
...
- Escribir el plan en términos generales que no permiten saber qué se hace distinto el lunes.
- Fijar revisión anual y descubrir en diciembre que un apoyo no se aplicó nunca.
...
Un plan que no se ejecuta produce un daño específico: deja constancia formal de que la necesidad fue atendida y cierra la posibilidad de reclamarla. La verificación de ejecución es, por eso, una garantía de derechos.
...
1. ¿Qué hace distinto mañana el profesor de matemática por efecto de este plan?
2. ¿Qué evidencia tendrás en un mes de que el apoyo se ejecutó?
3. ¿Quién convoca la revisión y en qué fecha exacta?
...
Cierra la parte 20 integrando las clases 241 a 251, y se articula con las partes 08, 11 y 12.
...
|---|---|---|
| [← 251 · Acompañamiento diferenciado y codocencia](../class-11-acompanamiento-diferenciado-y-codocencia/README.md) | [Parte 20](../README.md) · [Programa](../../../README.md) | [Programa completo →](../../../README.md) |
