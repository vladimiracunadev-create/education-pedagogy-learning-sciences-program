# Clase 298 — Escuela Nueva de Colombia y modelos de bajo costo

> **Parte 24 · Modelos educativos internacionales y evidencia comparada** — clase 10 de 12
...
**Decisión que habilita:** determinar qué elemento de estos modelos resuelve un problema real de tu contexto<br>
**Evidencia de aprendizaje:** una ficha de modelo regional con mecanismo, evidencia y decisión de adopción fundamentada

## 🎯 Propósito

Analizar modelos de bajo costo desarrollados en la región, con foco en Escuela Nueva, y evaluar su pertinencia para contextos comparables.
...
2. **Explicar** qué modelo latinoamericano se exportó a decenas de países desde una escuela rural.
3. **Decidir** —qué elemento de estos modelos resuelve un problema real de tu contexto— y sostener la decisión con un fundamento escrito.
4. **Producir** la evidencia de la clase —una ficha de modelo regional con mecanismo, evidencia y decisión de adopción fundamentada— y contrastarla contra el criterio de logro.
...
|---|---|
| **Modelo de bajo costo** | diseño pedagógico concebido para operar con recursos limitados, y no adaptado a ellos después |
| **Guía de aprendizaje** | material estructurado que permite al estudiante avanzar con autonomía y al docente atender por grupos |
| **Promoción flexible** | avance según dominio y no según calendario, adecuado a trayectorias interrumpidas |
| **Gobierno estudiantil** | estructura de participación que distribuye responsabilidades reales dentro de la escuela |
...
2. Clasificar la situación distinguiendo **Modelo de bajo costo** de **Guía de aprendizaje**.
3. Decidir con fundamento, usando **Promoción flexible** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Gobierno estudiantil** a la vista.
...
| **Evidencia de logro** | qué muestra una ficha de modelo regional con mecanismo, evidencia y decisión de adopción fundamentada frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
La evidencia favorable proviene en parte de evaluaciones vinculadas al propio modelo, y los resultados en adaptaciones urbanas son más desiguales. Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Modelo de bajo costo"]
    C --> A2["Guía de aprendizaje"]
    C --> A3["Promoción flexible"]
    C --> A4["Gobierno estudiantil"]
    A1 & A2 & A3 & A4 --> D{{"determinar qué elemento<br/>de estos modelos<br/>resuelve un problema<br/>real de tu contexto"}}
    D --> E["Evidencia de aprendizaje<br/>una ficha de modelo<br/>regional con mecanismo,<br/>evidencia y decisión de<br/>adopción fundamentada"]
...
Escuela Nueva se desarrolló en Colombia para escuelas rurales multigrado y se difundió a decenas de países, incluidas adaptaciones urbanas. Su interés para la región es doble: fue diseñado desde las restricciones y no adaptado a ellas después, y cuenta con evaluaciones que muestran resultados favorables en contextos rurales, con la cautela de que buena parte fueron realizadas por equipos vinculados al propio modelo.

### 2. Frontera conceptual: qué es y qué no es

Los cuatro conceptos de esta clase se confunden entre sí con facilidad, y esa confusión no es
inocua: produce decisiones que atacan el problema equivocado. **Modelo de bajo costo** no es lo
mismo que **Guía de aprendizaje** —material estructurado que permite al estudiante avanzar con autonomía y al docente atender por grupos—, y tratarlos como sinónimos hace
que la intervención se dirija al lugar incorrecto. Del mismo modo, **Promoción flexible** y
**Gobierno estudiantil** describen aspectos distintos de la misma situación: el primero
avance según dominio y no según calendario, adecuado a trayectorias interrumpidas, mientras el segundo estructura de participación que distribuye responsabilidades reales dentro de la escuela.
...
- **Evidencia de logro.** Qué muestra una ficha de modelo regional con mecanismo, evidencia y decisión de adopción fundamentada frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
Los componentes son concretos y separables: guías de aprendizaje que permiten autonomía del estudiante y atención por grupos del docente, promoción flexible según dominio, biblioteca de aula y estructuras de participación estudiantil. Cada uno resuelve un problema identificable: la imposibilidad de dictar clases paralelas en multigrado, las trayectorias interrumpidas, el acceso a material. La adopción por componente es viable y es como se ha difundido efectivamente.

### 5. Qué sostiene la evidencia y qué no

La evidencia favorable proviene en parte de evaluaciones vinculadas al propio modelo, y los resultados en adaptaciones urbanas son más desiguales. La implementación exige formación docente específica y provisión sostenida de material; sin ellas, las guías se convierten en cuadernillos de ejercicios. Y su desempeño depende críticamente de la calidad de las guías, que no es fácil de producir.
...
te deja en condiciones de qué elemento de estos modelos resuelve un problema real de tu contexto, y esa decisión se sostiene solo si
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Modelo de bajo costo** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Modelo de bajo costo de Guía de aprendizaje.** El trabajo aquí es separar lo observado de lo interpretado sobre **Guía de aprendizaje**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Promoción flexible como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Promoción flexible**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.

**Paso 4 — Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con Gobierno estudiantil a la vista.** Con **Gobierno estudiantil** ya delimitado, la pregunta pasa a ser de consecuencia: qué cambia para los estudiantes, para el tiempo de clase y para la carga del equipo. **Evidencia de partida** entrega la lectura observable; el juicio profesional sigue siendo humano y debe quedar firmado por quien lo hace.
...
|---|---|---|---|
| Intervenir sobre **Modelo de bajo costo** | Diseño pedagógico concebido para operar con recursos limitados, y no adaptado a ellos después | Cuando **Evidencia de partida** es observable y accionable dentro del plazo de la decisión. | Sobrerreaccionar a una señal parcial. |
| Intervenir sobre **Guía de aprendizaje** | Material estructurado que permite al estudiante avanzar con autonomía y al docente atender por grupos | Cuando la primera explicación no distingue mecanismo ni responsable. | Convertir el concepto en etiqueta y no en intervención. |
| Observar antes de decidir | Reducir la incertidumbre antes de comprometer tiempo y credibilidad | Cuando la decisión es reversible y la evidencia disponible no distingue causas. | Observar indefinidamente y no decidir nunca. |
| Derivar o escalar | Poner la decisión donde están la competencia y la responsabilidad | Cuando hay normativa, resguardo de datos, salud o vulneración de derechos en juego. | Delegar hacia arriba lo que sí correspondía decidir en el aula. |

**Frontera de aplicación.** La evidencia favorable proviene en parte de evaluaciones vinculadas al propio modelo, y los resultados en adaptaciones urbanas son más desiguales. Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre escuela Nueva de Colombia y modelos de bajo costo |
|---|---|
...
Una ficha de modelo regional con mecanismo, evidencia y decisión de adopción fundamentada.

Guárdala en `evidence/P24-C298-escuela-nueva-de-colombia-y-modelos-de-bajo-costo/` con estos archivos:
...
Elige un componente del modelo y evalúa su pertinencia para un establecimiento concreto. Escribe qué exigiría implementarlo con calidad.
...
- [ ] la ficha declara el mecanismo de cada componente y el problema que resuelve;
- [ ] la evaluación de evidencia considera quién produjo los estudios disponibles;
...
- Adoptar las guías sin la formación docente ni la reorganización del aula que las hace funcionar.
- Descartar modelos regionales por prestigio y buscar referencias solo en sistemas del norte.
...
Los modelos diseñados desde la restricción suelen ser más pertinentes para las escuelas con menos recursos que las propuestas concebidas en sistemas con condiciones que aquí no existen.
...
1. ¿Qué problema concreto de tu contexto resuelve cada componente?
2. ¿Quién produjo la evidencia favorable disponible sobre este modelo?
3. ¿Qué formación exige la guía para que no sea un cuadernillo más?
...
Se articula con las clases 272 y 273 y con la 234. Prepara la clase 299.
...
|---|---|---|
| [← 297 · Portugal y Polonia: reformas que movieron resultados](../class-09-portugal-y-polonia-reformas-que-movieron-resultados/README.md) | [Parte 24](../README.md) · [Programa](../../../README.md) | [299 · Chile en perspectiva comparada →](../class-11-chile-en-perspectiva-comparada/README.md) |
