# Clase 297 — Portugal y Polonia: reformas que movieron resultados

> **Parte 24 · Modelos educativos internacionales y evidencia comparada** — clase 9 de 12
...
**Decisión que habilita:** determinar qué de estas dos trayectorias es común y podría ser el mecanismo relevante<br>
**Evidencia de aprendizaje:** una comparación de dos reformas con elementos comunes, diferencias y conclusiones fundamentadas

## 🎯 Propósito

Comparar dos trayectorias de reforma diferentes y extraer qué elemento es común y qué depende del contexto de cada una.
...
2. **Explicar** qué enseñan dos países que mejoraron con reformas muy distintas entre sí.
3. **Decidir** —qué de estas dos trayectorias es común y podría ser el mecanismo relevante— y sostener la decisión con un fundamento escrito.
4. **Producir** la evidencia de la clase —una comparación de dos reformas con elementos comunes, diferencias y conclusiones fundamentadas— y contrastarla contra el criterio de logro.
...
|---|---|
| **Trayectoria de reforma** | secuencia de decisiones y su orden, que suele importar más que las decisiones aisladas |
| **Postergación de la selección** | retraso de la separación de estudiantes en vías distintas, asociado con mejores resultados de equidad |
| **Autonomía con rendición de cuentas** | combinación de margen de decisión escolar con mecanismos de responsabilidad por resultados |
| **Elemento común** | coincidencia entre casos distintos, que aumenta la plausibilidad de un mecanismo |
...
2. Clasificar la situación distinguiendo **Trayectoria de reforma** de **Postergación de la selección**.
3. Decidir con fundamento, usando **Autonomía con rendición de cuentas** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Elemento común** a la vista.
...
| **Evidencia de logro** | qué muestra una comparación de dos reformas con elementos comunes, diferencias y conclusiones fundamentadas frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
La comparación de dos casos no permite inferencia causal: Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Trayectoria de reforma"]
    C --> A2["Postergación de la<br/>selección"]
    C --> A3["Autonomía con<br/>rendición de cuentas"]
    C --> A4["Elemento común"]
    A1 & A2 & A3 & A4 --> D{{"determinar qué de estas<br/>dos trayectorias es<br/>común y podría ser el<br/>mecanismo relevante"}}
    D --> E["Evidencia de aprendizaje<br/>una comparación de dos<br/>reformas con elementos<br/>comunes, diferencias y<br/>conclusiones<br/>fundamentadas"]
...
Portugal y Polonia mejoraron sus resultados en mediciones internacionales durante períodos comparables, con reformas de contenido bastante distinto. Comparar casos que difieren es más informativo que estudiar uno solo: lo que aparece en ambos es candidato a mecanismo, y lo que aparece en uno solo es probablemente contextual. En estos dos casos, la postergación de la separación de estudiantes en vías distintas aparece en ambos, aunque implementada de maneras diferentes.

### 2. Frontera conceptual: qué es y qué no es

Los cuatro conceptos de esta clase se confunden entre sí con facilidad, y esa confusión no es
inocua: produce decisiones que atacan el problema equivocado. **Trayectoria de reforma** no es lo
mismo que **Postergación de la selección** —retraso de la separación de estudiantes en vías distintas, asociado con mejores resultados de equidad—, y tratarlos como sinónimos hace
que la intervención se dirija al lugar incorrecto. Del mismo modo, **Autonomía con rendición de cuentas** y
**Elemento común** describen aspectos distintos de la misma situación: el primero
combinación de margen de decisión escolar con mecanismos de responsabilidad por resultados, mientras el segundo coincidencia entre casos distintos, que aumenta la plausibilidad de un mecanismo.
...
- **Evidencia de logro.** Qué muestra una comparación de dos reformas con elementos comunes, diferencias y conclusiones fundamentadas frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
El ejercicio comparativo se hace en tabla: qué hizo cada sistema, en qué orden, en qué contexto y con qué resultado. Luego se marcan coincidencias y diferencias. Ese procedimiento simple protege de la conclusión precipitada: una política presente en un solo caso exitoso no tiene más respaldo que la coincidencia, mientras que una presente en varios casos distintos merece atención.

### 5. Qué sostiene la evidencia y qué no

La comparación de dos casos no permite inferencia causal: ambos pudieron mejorar por razones ajenas a sus reformas, incluidas condiciones económicas y cambios demográficos. La medición de mejora en pruebas internacionales es sensible a cambios de cobertura escolar. Y la evidencia sobre postergación de la selección, aunque consistente, proviene mayoritariamente de estudios observacionales.
...
te deja en condiciones de qué de estas dos trayectorias es común y podría ser el mecanismo relevante, y esa decisión se sostiene solo si
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Trayectoria de reforma** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Trayectoria de reforma de Postergación de la selección.** El trabajo aquí es separar lo observado de lo interpretado sobre **Postergación de la selección**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Autonomía con rendición de cuentas como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Autonomía con rendición de cuentas**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.

**Paso 4 — Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con Elemento común a la vista.** Con **Elemento común** ya delimitado, la pregunta pasa a ser de consecuencia: qué cambia para los estudiantes, para el tiempo de clase y para la carga del equipo. **Evidencia de partida** entrega la lectura observable; el juicio profesional sigue siendo humano y debe quedar firmado por quien lo hace.
...
|---|---|---|---|
| Intervenir sobre **Trayectoria de reforma** | Secuencia de decisiones y su orden, que suele importar más que las decisiones aisladas | Cuando **Evidencia de partida** es observable y accionable dentro del plazo de la decisión. | Sobrerreaccionar a una señal parcial. |
| Intervenir sobre **Postergación de la selección** | Retraso de la separación de estudiantes en vías distintas, asociado con mejores resultados de equidad | Cuando la primera explicación no distingue mecanismo ni responsable. | Convertir el concepto en etiqueta y no en intervención. |
| Observar antes de decidir | Reducir la incertidumbre antes de comprometer tiempo y credibilidad | Cuando la decisión es reversible y la evidencia disponible no distingue causas. | Observar indefinidamente y no decidir nunca. |
| Derivar o escalar | Poner la decisión donde están la competencia y la responsabilidad | Cuando hay normativa, resguardo de datos, salud o vulneración de derechos en juego. | Delegar hacia arriba lo que sí correspondía decidir en el aula. |

**Frontera de aplicación.** La comparación de dos casos no permite inferencia causal: Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre portugal y Polonia: reformas que movieron resultados |
|---|---|
...
Una comparación de dos reformas con elementos comunes, diferencias y conclusiones fundamentadas.

Guárdala en `evidence/P24-C297-portugal-y-polonia-reformas-que-movieron-resultados/` con estos archivos:
...
Construye la tabla comparativa de dos reformas. Marca elementos comunes y escribe qué conclusión permite y cuál no permite esa comparación.
...
- [ ] la comparación identifica elementos comunes y diferencias con evidencia de cada uno;
- [ ] las conclusiones declaran explícitamente su nivel de certeza;
...
- Concluir sobre causas a partir de dos casos, sin considerar los sistemas que aplicaron lo mismo sin mejorar.
- Comparar solo el contenido de las reformas y omitir el orden en que ocurrieron.
...
La postergación de la separación en vías distintas es una de las decisiones estructurales con efecto más consistente sobre la equidad, y es también una de las menos discutidas en el debate escolar cotidiano.
...
1. ¿Qué aparece en ambos casos y qué en solo uno?
2. ¿En qué orden ocurrieron las decisiones en cada sistema?
3. ¿Qué cambió en la cobertura escolar durante el período comparado?
...
Aplica el método de la clase 289 y se articula con la 290 y con la parte 16.
...
|---|---|---|
| [← 296 · Ontario: mejora sistémica sostenida](../class-08-ontario-mejora-sistemica-sostenida/README.md) | [Parte 24](../README.md) · [Programa](../../../README.md) | [298 · Escuela Nueva de Colombia y modelos de bajo costo →](../class-10-escuela-nueva-de-colombia-y-modelos-de-bajo-costo/README.md) |
