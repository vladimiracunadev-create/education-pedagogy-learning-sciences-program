# Clase 300 — Proyecto integrador: propuesta de adaptación fundamentada

> **Parte 24 · Modelos educativos internacionales y evidencia comparada** — clase 12 de 12

**Estado de evidencia:** `PRACTICA-PROFESIONAL` · **Etapa:** 🟤 Etapa F — Especialización y desafíos contemporáneos · **Población de referencia:** directivos, formadores, investigadores y docentes con mirada de sistema<br>
**Decisión que habilita:** determinar qué propones adoptar, con qué condiciones y qué descartas explícitamente<br>
**Evidencia de aprendizaje:** una propuesta de adaptación con mecanismo, condiciones locales, descartes justificados y plan de verificación

## 🎯 Propósito

Integrar la parte en una propuesta de adaptación fundamentada que declare qué se toma, qué se descarta y qué haría fracasar el traslado.
...
2. **Explicar** cómo se propone adoptar algo de otro sistema sin quedar en el ridículo ni en la parálisis.
3. **Decidir** —qué propones adoptar, con qué condiciones y qué descartas explícitamente— y sostener la decisión con un fundamento escrito.
4. **Producir** la evidencia de la clase —una propuesta de adaptación con mecanismo, condiciones locales, descartes justificados y plan de verificación— y contrastarla contra el criterio de logro.
...
2. Clasificar la situación distinguiendo **Propuesta de adaptación** de **Descarte justificado**.
3. Decidir con fundamento, usando **Condición de fracaso** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Prueba en pequeño** a la vista.
...
| **Evidencia de logro** | qué muestra una propuesta de adaptación con mecanismo, condiciones locales, descartes justificados y plan de verificación frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
Ninguna propuesta bien fundamentada garantiza el resultado, porque la transferencia de prácticas entre contextos tiene una incertidumbre irreducible. Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Propuesta de<br/>adaptación"]
    C --> A2["Descarte justificado"]
    C --> A3["Condición de fracaso"]
    C --> A4["Prueba en pequeño"]
    A1 & A2 & A3 & A4 --> D{{"determinar qué propones<br/>adoptar, con qué<br/>condiciones y qué<br/>descartas explícitamente"}}
    D --> E["Evidencia de aprendizaje<br/>una propuesta de<br/>adaptación con<br/>mecanismo, condiciones<br/>locales, descartes<br/>justificados y plan…"]
...
El cierre de la parte es también el cierre del programa: producir una propuesta que un equipo pueda discutir, aprobar o rechazar con fundamento. Las propuestas de adopción de modelos externos fracasan por dos razones opuestas: entusiasmo sin condiciones, que importa la fachada, y escepticismo sin análisis, que descarta todo por principio. Una propuesta seria hace explícito lo que toma, lo que deja y lo que podría salir mal.

### 2. Frontera conceptual: qué es y qué no es

Los cuatro conceptos de esta clase se confunden entre sí con facilidad, y esa confusión no es
inocua: produce decisiones que atacan el problema equivocado. **Propuesta de adaptación** no es lo
...
- **Evidencia de logro.** Qué muestra una propuesta de adaptación con mecanismo, condiciones locales, descartes justificados y plan de verificación frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
La propuesta integra las once clases anteriores: el mecanismo identificado con la ficha de análisis, la evidencia disponible con su nivel de certeza, las condiciones locales verificadas, los descartes con su razón, la condición de fracaso previsible y el plan de prueba en pequeño antes de escalar. Ese último punto es el que distingue una propuesta profesional: se compromete a probar antes de comprometer a toda la institución.

### 5. Qué sostiene la evidencia y qué no

Ninguna propuesta bien fundamentada garantiza el resultado, porque la transferencia de prácticas entre contextos tiene una incertidumbre irreducible. El documento tampoco asegura la implementación, que depende de condiciones organizacionales que lo exceden. Y existe el riesgo de que el análisis cuidadoso se use como excusa para no hacer nada, que es la otra forma de fallar.
...
te deja en condiciones de qué propones adoptar, con qué condiciones y qué descartas explícitamente, y esa decisión se sostiene solo si
...
|---|---|---|
| Bryk, A. et al. (2015). *Learning to Improve*. | el método de probar en ciclos cortos antes de escalar, aplicable a cualquier adopción. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
| Crehan, L. (2016). *Cleverlands*. | el ejercicio de separar mecanismo de contexto, que esta propuesta debe reproducir. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Propuesta de adaptación** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Propuesta de adaptación de Descarte justificado.** El trabajo aquí es separar lo observado de lo interpretado sobre **Descarte justificado**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Condición de fracaso como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Condición de fracaso**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.

**Paso 4 — Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con Prueba en pequeño a la vista.** Con **Prueba en pequeño** ya delimitado, la pregunta pasa a ser de consecuencia: qué cambia para los estudiantes, para el tiempo de clase y para la carga del equipo. **Evidencia de partida** entrega la lectura observable; el juicio profesional sigue siendo humano y debe quedar firmado por quien lo hace.
...
|---|---|---|---|
| Intervenir sobre **Propuesta de adaptación** | Documento que traduce un mecanismo externo a condiciones locales, con sus renuncias explícitas | Cuando **Evidencia de partida** es observable y accionable dentro del plazo de la decisión. | Sobrerreaccionar a una señal parcial. |
| Intervenir sobre **Descarte justificado** | Elemento del modelo original que no se adopta, con la razón declarada | Cuando la primera explicación no distingue mecanismo ni responsable. | Convertir el concepto en etiqueta y no en intervención. |
| Observar antes de decidir | Reducir la incertidumbre antes de comprometer tiempo y credibilidad | Cuando la decisión es reversible y la evidencia disponible no distingue causas. | Observar indefinidamente y no decidir nunca. |
| Derivar o escalar | Poner la decisión donde están la competencia y la responsabilidad | Cuando hay normativa, resguardo de datos, salud o vulneración de derechos en juego. | Delegar hacia arriba lo que sí correspondía decidir en el aula. |

**Frontera de aplicación.** Ninguna propuesta bien fundamentada garantiza el resultado, porque la transferencia de prácticas entre contextos tiene una incertidumbre irreducible. Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre proyecto integrador: propuesta de adaptación fundamentada |
|---|---|
...
Una propuesta de adaptación con mecanismo, condiciones locales, descartes justificados y plan de verificación.

Guárdala en `evidence/P24-C300-proyecto-integrador/` con estos archivos:
...
Escribe la propuesta completa con los seis elementos. Preséntala a un equipo directivo y registra la objeción más fuerte que recibas.
...
- [ ] la propuesta declara mecanismo, condiciones, descartes y condición de fracaso;
- [ ] incluye un plan de prueba en pequeño con indicador, plazo y responsable;
...
- Proponer la adopción sin declarar qué se descarta del modelo original y por qué.
- Usar la incertidumbre de la transferencia como argumento para no probar nada.
...
1. ¿Qué descartas del modelo original y por qué razón exacta?
2. ¿Qué circunstancia local haría fracasar esto, y es probable?
3. ¿Cómo pruebas en pequeño antes de comprometer al establecimiento completo?
...
Cierra la parte 24 y el programa completo, integrando las clases 289 a 299 con las partes 15, 16 y 17.
...
|---|---|---|
| [← 299 · Chile en perspectiva comparada](../class-11-chile-en-perspectiva-comparada/README.md) | [Parte 24](../README.md) · [Programa](../../../README.md) | [Programa completo →](../../../README.md) |
