...
**Decisión que habilita:** determinar cómo ajustar la relación pedagógica para que el contenido no compita con la necesidad de autonomía y pertenencia<br>
...
2. Clasificar la situación distinguiendo **Sensibilidad social** de **Búsqueda de autonomía**.
3. Decidir con fundamento, usando **Toma de riesgos** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Plasticidad adolescente** a la vista.
...
| **Evidencia de logro** | qué muestra el rediseño de una práctica de aula que reduzca la exposición al ridículo público y aumente la autonomía real frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
La divulgación sobre el «cerebro adolescente inmaduro» se usa con frecuencia para justificar tanto la sobreprotección como el castigo. Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Sensibilidad social"]
    C --> A2["Búsqueda de autonomía"]
    C --> A3["Toma de riesgos"]
    C --> A4["Plasticidad<br/>adolescente"]
    A1 & A2 & A3 & A4 --> D{{"determinar cómo ajustar<br/>la relación pedagógica<br/>para que el contenido no<br/>compita con la…"}}
    D --> E["Evidencia de aprendizaje<br/>el rediseño de una<br/>práctica de aula que<br/>reduzca la exposición al<br/>ridículo público y<br/>aumente la…"]
...
inocua: produce decisiones que atacan el problema equivocado. **Sensibilidad social** no es lo
mismo que **Búsqueda de autonomía** —necesidad creciente de decidir por sí mismo; se opone al control percibido como arbitrario—, y tratarlos como sinónimos hace
que la intervención se dirija al lugar incorrecto. Del mismo modo, **Toma de riesgos** y
**Plasticidad adolescente** describen aspectos distintos de la misma situación: el primero
conducta más frecuente en presencia de pares que en solitario;, mientras el segundo período de reorganización que hace al aprendizaje y a la intervención especialmente efectivos.
...
- **Evidencia de logro.** Qué muestra el rediseño de una práctica de aula que reduzca la exposición al ridículo público y aumente la autonomía real frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
te deja en condiciones de cómo ajustar la relación pedagógica para que el contenido no compita con la necesidad de autonomía y pertenencia, y esa decisión se sostiene solo si
...
|---|---|---|
| Steinberg, L. (2014). *Age of Opportunity*. | reinterpreta la adolescencia como período de oportunidad y plasticidad, con la evidencia que lo respalda. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
| Blakemore, S.-J. (2018). *Inventing Ourselves: The Secret Life of the Teenage Brain*. | síntesis rigurosa y prudente sobre desarrollo cerebral adolescente y conducta social. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Sensibilidad social** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Sensibilidad social de Búsqueda de autonomía.** El trabajo aquí es separar lo observado de lo interpretado sobre **Búsqueda de autonomía**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Toma de riesgos como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Toma de riesgos**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.

**Paso 4 — Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con Plasticidad adolescente a la vista.** Con **Plasticidad adolescente** ya delimitado, la pregunta pasa a ser de consecuencia: qué cambia para los estudiantes, para el tiempo de clase y para la carga del equipo. **Evidencia de partida** entrega la lectura observable; el juicio profesional sigue siendo humano y debe quedar firmado por quien lo hace.
...
|---|---|---|---|
| Intervenir sobre **Sensibilidad social** | Mayor reactividad a la evaluación de los pares y al estatus dentro del grupo | Cuando **Evidencia de partida** es observable y accionable dentro del plazo de la decisión. | Sobrerreaccionar a una señal parcial. |
| Intervenir sobre **Búsqueda de autonomía** | Necesidad creciente de decidir por sí mismo; se opone al control percibido como arbitrario | Cuando la primera explicación no distingue mecanismo ni responsable. | Convertir el concepto en etiqueta y no en intervención. |
| Observar antes de decidir | Reducir la incertidumbre antes de comprometer tiempo y credibilidad | Cuando la decisión es reversible y la evidencia disponible no distingue causas. | Observar indefinidamente y no decidir nunca. |
| Derivar o escalar | Poner la decisión donde están la competencia y la responsabilidad | Cuando hay normativa, resguardo de datos, salud o vulneración de derechos en juego. | Delegar hacia arriba lo que sí correspondía decidir en el aula. |

**Frontera de aplicación.** La divulgación sobre el «cerebro adolescente inmaduro» se usa con frecuencia para justificar tanto la sobreprotección como el castigo. Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre adolescencia |
|---|---|
...
Guárdala en `evidence/P02-C032-adolescencia/` con estos archivos:
