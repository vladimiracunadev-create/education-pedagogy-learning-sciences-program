...
**Decisión que habilita:** determinar qué demanda cognitiva es razonable para la edad de tu grupo y qué apoyo la hace accesible<br>
...
2. Clasificar la situación distinguiendo **Razonamiento concreto y abstracto** de **Descentración**.
3. Decidir con fundamento, usando **Teoría de la mente** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Desarrollo por dominio** a la vista.
...
| **Evidencia de logro** | qué muestra una misma tarea graduada para tres edades distintas, con la demanda cognitiva declarada en cada versión frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
Las etapas siguen siendo útiles como referencia gruesa y peligrosas como criterio de decisión individual. Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Razonamiento concreto<br/>y abstracto"]
    C --> A2["Descentración"]
    C --> A3["Teoría de la mente"]
    C --> A4["Desarrollo por dominio"]
    A1 & A2 & A3 & A4 --> D{{"determinar qué demanda<br/>cognitiva es razonable<br/>para la edad de tu grupo<br/>y qué apoyo la hace…"}}
    D --> E["Evidencia de aprendizaje<br/>una misma tarea graduada<br/>para tres edades<br/>distintas, con la<br/>demanda cognitiva<br/>declarada en cada…"]
...
inocua: produce decisiones que atacan el problema equivocado. **Razonamiento concreto y abstracto** no es lo
mismo que **Descentración** —capacidad de considerar un punto de vista distinto del propio—, y tratarlos como sinónimos hace
que la intervención se dirija al lugar incorrecto. Del mismo modo, **Teoría de la mente** y
**Desarrollo por dominio** describen aspectos distintos de la misma situación: el primero
comprensión de que otros tienen creencias, deseos e intenciones distintos de los propios, mientras el segundo avance desigual:.
...
- **Evidencia de logro.** Qué muestra una misma tarea graduada para tres edades distintas, con la demanda cognitiva declarada en cada versión frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
te deja en condiciones de qué demanda cognitiva es razonable para la edad de tu grupo y qué apoyo la hace accesible, y esa decisión se sostiene solo si
...
|---|---|---|
| Siegler, R. (1996). *Emerging Minds: The Process of Change in Children's Thinking*. | muestra el desarrollo como variabilidad y selección de estrategias, no como sucesión de etapas fijas. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
| Gopnik, A. (2016). *The Gardener and the Carpenter*. | síntesis accesible de la investigación reciente sobre cognición infantil y sus implicancias para adultos que enseñan. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Razonamiento concreto y abstracto** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Razonamiento concreto y abstracto de Descentración.** El trabajo aquí es separar lo observado de lo interpretado sobre **Descentración**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Teoría de la mente como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Teoría de la mente**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.

**Paso 4 — Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con Desarrollo por dominio a la vista.** Con **Desarrollo por dominio** ya delimitado, la pregunta pasa a ser de consecuencia: qué cambia para los estudiantes, para el tiempo de clase y para la carga del equipo. **Evidencia de partida** entrega la lectura observable; el juicio profesional sigue siendo humano y debe quedar firmado por quien lo hace.
...
|---|---|---|---|
| Intervenir sobre **Razonamiento concreto y abstracto** | Operar sobre objetos y situaciones presentes frente a operar sobre símbolos y posibilidades | Cuando **Evidencia de partida** es observable y accionable dentro del plazo de la decisión. | Sobrerreaccionar a una señal parcial. |
| Intervenir sobre **Descentración** | Capacidad de considerar un punto de vista distinto del propio | Cuando la primera explicación no distingue mecanismo ni responsable. | Convertir el concepto en etiqueta y no en intervención. |
| Observar antes de decidir | Reducir la incertidumbre antes de comprometer tiempo y credibilidad | Cuando la decisión es reversible y la evidencia disponible no distingue causas. | Observar indefinidamente y no decidir nunca. |
| Derivar o escalar | Poner la decisión donde están la competencia y la responsabilidad | Cuando hay normativa, resguardo de datos, salud o vulneración de derechos en juego. | Delegar hacia arriba lo que sí correspondía decidir en el aula. |

**Frontera de aplicación.** Las etapas siguen siendo útiles como referencia gruesa y peligrosas como criterio de decisión individual. Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre desarrollo cognitivo |
|---|---|
...
Guárdala en `evidence/P02-C028-desarrollo-cognitivo/` con estos archivos:
