...
**Decisión que habilita:** determinar qué ajustes de ritmo, formato y apoyo hacen accesible tu formación a participantes mayores<br>
...
2. Clasificar la situación distinguiendo **Inteligencia fluida** de **Inteligencia cristalizada**.
3. Decidir con fundamento, usando **Velocidad de procesamiento** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Aprendizaje permanente** a la vista.
...
| **Evidencia de logro** | qué muestra el ajuste fundamentado de una formación para un grupo de adultos mayores, con las decisiones documentadas frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
La variabilidad entre personas mayores es mayor que en cualquier otro grupo etario, de modo que los promedios describen poco. Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Inteligencia fluida"]
    C --> A2["Inteligencia<br/>cristalizada"]
    C --> A3["Velocidad de<br/>procesamiento"]
    C --> A4["Aprendizaje permanente"]
    A1 & A2 & A3 & A4 --> D{{"determinar qué ajustes<br/>de ritmo, formato y<br/>apoyo hacen accesible tu<br/>formación a<br/>participantes…"}}
    D --> E["Evidencia de aprendizaje<br/>el ajuste fundamentado<br/>de una formación para un<br/>grupo de adultos<br/>mayores, con las<br/>decisiones…"]
...
inocua: produce decisiones que atacan el problema equivocado. **Inteligencia fluida** no es lo
mismo que **Inteligencia cristalizada** —conocimiento y vocabulario acumulados; se mantiene o aumenta hasta edades avanzadas—, y tratarlos como sinónimos hace
que la intervención se dirija al lugar incorrecto. Del mismo modo, **Velocidad de procesamiento** y
**Aprendizaje permanente** describen aspectos distintos de la misma situación: el primero
rapidez de operación cognitiva;, mientras el segundo participación en formación a lo largo de toda la vida, con propósitos que cambian con la etapa.
...
- **Evidencia de logro.** Qué muestra el ajuste fundamentado de una formación para un grupo de adultos mayores, con las decisiones documentadas frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
te deja en condiciones de qué ajustes de ritmo, formato y apoyo hacen accesible tu formación a participantes mayores, y esa decisión se sostiene solo si
...
|---|---|---|
| Baltes, P. & Baltes, M. (1990). *Successful Aging: Perspectives from the Behavioral Sciences*. | modelo de selección, optimización y compensación; muy útil para diseñar formación. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
| Salthouse, T. (2010). *Major Issues in Cognitive Aging*. | distingue con rigor qué declina, qué se conserva y qué artefactos introducen los diseños transversales. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Inteligencia fluida** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Inteligencia fluida de Inteligencia cristalizada.** El trabajo aquí es separar lo observado de lo interpretado sobre **Inteligencia cristalizada**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Velocidad de procesamiento como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Velocidad de procesamiento**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.

**Paso 4 — Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con Aprendizaje permanente a la vista.** Con **Aprendizaje permanente** ya delimitado, la pregunta pasa a ser de consecuencia: qué cambia para los estudiantes, para el tiempo de clase y para la carga del equipo. **Evidencia de partida** entrega la lectura observable; el juicio profesional sigue siendo humano y debe quedar firmado por quien lo hace.
...
|---|---|---|---|
| Intervenir sobre **Inteligencia fluida** | Capacidad de razonar con material nuevo; declina gradualmente con la edad | Cuando **Evidencia de partida** es observable y accionable dentro del plazo de la decisión. | Sobrerreaccionar a una señal parcial. |
| Intervenir sobre **Inteligencia cristalizada** | Conocimiento y vocabulario acumulados; se mantiene o aumenta hasta edades avanzadas | Cuando la primera explicación no distingue mecanismo ni responsable. | Convertir el concepto en etiqueta y no en intervención. |
| Observar antes de decidir | Reducir la incertidumbre antes de comprometer tiempo y credibilidad | Cuando la decisión es reversible y la evidencia disponible no distingue causas. | Observar indefinidamente y no decidir nunca. |
| Derivar o escalar | Poner la decisión donde están la competencia y la responsabilidad | Cuando hay normativa, resguardo de datos, salud o vulneración de derechos en juego. | Delegar hacia arriba lo que sí correspondía decidir en el aula. |

**Frontera de aplicación.** La variabilidad entre personas mayores es mayor que en cualquier otro grupo etario, de modo que los promedios describen poco. Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre envejecimiento y aprendizaje permanente |
|---|---|
...
Guárdala en `evidence/P02-C034-envejecimiento-y-aprendizaje-permanente/` con estos archivos:
