...
**Decisión que habilita:** determinar qué intervención de este período evitará que un autoconcepto académico negativo se consolide<br>
...
2. Clasificar la situación distinguiendo **Autoconcepto académico** de **Comparación social**.
3. Decidir con fundamento, usando **Estatus entre pares** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Hábito de trabajo** a la vista.
...
| **Evidencia de logro** | qué muestra un plan de trabajo para un estudiante con autoconcepto académico deteriorado, con acciones y evidencia de seguimiento frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
La relación entre autoconcepto y rendimiento es recíproca y su dirección causal se discute; Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Autoconcepto académico"]
    C --> A2["Comparación social"]
    C --> A3["Estatus entre pares"]
    C --> A4["Hábito de trabajo"]
    A1 & A2 & A3 & A4 --> D{{"determinar qué<br/>intervención de este<br/>período evitará que un<br/>autoconcepto académico<br/>negativo se…"}}
    D --> E["Evidencia de aprendizaje<br/>un plan de trabajo para<br/>un estudiante con<br/>autoconcepto académico<br/>deteriorado, con<br/>acciones y…"]
...
inocua: produce decisiones que atacan el problema equivocado. **Autoconcepto académico** no es lo
mismo que **Comparación social** —proceso de evaluar la propia capacidad en referencia al desempeño de los pares—, y tratarlos como sinónimos hace
que la intervención se dirija al lugar incorrecto. Del mismo modo, **Estatus entre pares** y
**Hábito de trabajo** describen aspectos distintos de la misma situación: el primero
posición del estudiante en la estructura social del curso;, mientras el segundo conjunto de rutinas de estudio y organización que se consolidan en este período.
...
- **Evidencia de logro.** Qué muestra un plan de trabajo para un estudiante con autoconcepto académico deteriorado, con acciones y evidencia de seguimiento frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
te deja en condiciones de qué intervención de este período evitará que un autoconcepto académico negativo se consolide, y esa decisión se sostiene solo si
...
|---|---|---|
| Eccles, J. (1999). *The Development of Children Ages 6 to 14*. The Future of Children, 9(2). | síntesis del período con foco en escuela, motivación y autoconcepto. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
| Marsh, H. & Craven, R. (2006). *Reciprocal Effects of Self-Concept and Performance*. | documenta la relación recíproca y desmonta la idea de intervenir la autoestima por sí sola. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Autoconcepto académico** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Autoconcepto académico de Comparación social.** El trabajo aquí es separar lo observado de lo interpretado sobre **Comparación social**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Estatus entre pares como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Estatus entre pares**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.

**Paso 4 — Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con Hábito de trabajo a la vista.** Con **Hábito de trabajo** ya delimitado, la pregunta pasa a ser de consecuencia: qué cambia para los estudiantes, para el tiempo de clase y para la carga del equipo. **Evidencia de partida** entrega la lectura observable; el juicio profesional sigue siendo humano y debe quedar firmado por quien lo hace.
...
|---|---|---|---|
| Intervenir sobre **Autoconcepto académico** | Idea que el estudiante tiene sobre su propia capacidad en un dominio escolar | Cuando **Evidencia de partida** es observable y accionable dentro del plazo de la decisión. | Sobrerreaccionar a una señal parcial. |
| Intervenir sobre **Comparación social** | Proceso de evaluar la propia capacidad en referencia al desempeño de los pares | Cuando la primera explicación no distingue mecanismo ni responsable. | Convertir el concepto en etiqueta y no en intervención. |
| Observar antes de decidir | Reducir la incertidumbre antes de comprometer tiempo y credibilidad | Cuando la decisión es reversible y la evidencia disponible no distingue causas. | Observar indefinidamente y no decidir nunca. |
| Derivar o escalar | Poner la decisión donde están la competencia y la responsabilidad | Cuando hay normativa, resguardo de datos, salud o vulneración de derechos en juego. | Delegar hacia arriba lo que sí correspondía decidir en el aula. |

**Frontera de aplicación.** La relación entre autoconcepto y rendimiento es recíproca y su dirección causal se discute; Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre niñez media |
|---|---|
...
Guárdala en `evidence/P02-C031-ninez-media/` con estos archivos:
