...
**Decisión que habilita:** determinar qué condiciones del entorno educativo temprano vas a priorizar cuando no puedes intervenir en todas<br>
...
2. Clasificar la situación distinguiendo **Período sensible** de **Estrés tóxico**.
3. Decidir con fundamento, usando **Interacción contingente** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Plasticidad** a la vista.
...
| **Evidencia de logro** | qué muestra un análisis de un contexto de primera infancia real que identifique factores protectores y de riesgo, con acciones priorizadas frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
La divulgación exagera este campo con frecuencia. Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Período sensible"]
    C --> A2["Estrés tóxico"]
    C --> A3["Interacción<br/>contingente"]
    C --> A4["Plasticidad"]
    A1 & A2 & A3 & A4 --> D{{"determinar qué<br/>condiciones del entorno<br/>educativo temprano vas a<br/>priorizar cuando no<br/>puedes…"}}
    D --> E["Evidencia de aprendizaje<br/>un análisis de un<br/>contexto de primera<br/>infancia real que<br/>identifique factores<br/>protectores y de…"]
...
inocua: produce decisiones que atacan el problema equivocado. **Período sensible** no es lo
mismo que **Estrés tóxico** —activación intensa y prolongada del sistema de estrés sin apoyo adulto amortiguador—, y tratarlos como sinónimos hace
que la intervención se dirija al lugar incorrecto. Del mismo modo, **Interacción contingente** y
**Plasticidad** describen aspectos distintos de la misma situación: el primero
intercambio en que el adulto responde de forma ajustada y oportuna a la señal del niño, mientras el segundo capacidad del sistema nervioso de reorganizarse con la experiencia;.
...
- **Evidencia de logro.** Qué muestra un análisis de un contexto de primera infancia real que identifique factores protectores y de riesgo, con acciones priorizadas frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
te deja en condiciones de qué condiciones del entorno educativo temprano vas a priorizar cuando no puedes intervenir en todas, y esa decisión se sostiene solo si
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Período sensible** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Período sensible de Estrés tóxico.** El trabajo aquí es separar lo observado de lo interpretado sobre **Estrés tóxico**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Interacción contingente como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Interacción contingente**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.

**Paso 4 — Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con Plasticidad a la vista.** Con **Plasticidad** ya delimitado, la pregunta pasa a ser de consecuencia: qué cambia para los estudiantes, para el tiempo de clase y para la carga del equipo. **Evidencia de partida** entrega la lectura observable; el juicio profesional sigue siendo humano y debe quedar firmado por quien lo hace.
...
|---|---|---|---|
| Intervenir sobre **Período sensible** | Ventana en que un sistema es especialmente receptivo a cierta experiencia; no equivale a ventana que se cierra | Cuando **Evidencia de partida** es observable y accionable dentro del plazo de la decisión. | Sobrerreaccionar a una señal parcial. |
| Intervenir sobre **Estrés tóxico** | Activación intensa y prolongada del sistema de estrés sin apoyo adulto amortiguador | Cuando la primera explicación no distingue mecanismo ni responsable. | Convertir el concepto en etiqueta y no en intervención. |
| Observar antes de decidir | Reducir la incertidumbre antes de comprometer tiempo y credibilidad | Cuando la decisión es reversible y la evidencia disponible no distingue causas. | Observar indefinidamente y no decidir nunca. |
| Derivar o escalar | Poner la decisión donde están la competencia y la responsabilidad | Cuando hay normativa, resguardo de datos, salud o vulneración de derechos en juego. | Delegar hacia arriba lo que sí correspondía decidir en el aula. |

**Frontera de aplicación.** La divulgación exagera este campo con frecuencia. Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre desarrollo prenatal y primera infancia |
|---|---|
...
Guárdala en `evidence/P02-C025-desarrollo-prenatal-y-primera-infancia/` con estos archivos:
