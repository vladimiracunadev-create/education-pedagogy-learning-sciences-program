...
**Decisión que habilita:** determinar qué supuestos de la enseñanza escolar debes abandonar al trabajar con estudiantes adultos<br>
...
2. Clasificar la situación distinguiendo **Adultez emergente** de **Identidad ocupacional**.
3. Decidir con fundamento, usando **Aprendizaje instrumental** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Conflicto de roles** a la vista.
...
| **Evidencia de logro** | qué muestra una comparación explícita entre el diseño de una misma formación para adolescentes y para adultos, con las decisiones que cambian frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
La categoría «adulto» agrupa realidades muy distintas: Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Adultez emergente"]
    C --> A2["Identidad ocupacional"]
    C --> A3["Aprendizaje<br/>instrumental"]
    C --> A4["Conflicto de roles"]
    A1 & A2 & A3 & A4 --> D{{"determinar qué supuestos<br/>de la enseñanza escolar<br/>debes abandonar al<br/>trabajar con<br/>estudiantes…"}}
    D --> E["Evidencia de aprendizaje<br/>una comparación<br/>explícita entre el<br/>diseño de una misma<br/>formación para<br/>adolescentes y para…"]
...
inocua: produce decisiones que atacan el problema equivocado. **Adultez emergente** no es lo
mismo que **Identidad ocupacional** —construcción de sí mismo en relación con el trabajo; organiza la motivación adulta por aprender—, y tratarlos como sinónimos hace
que la intervención se dirija al lugar incorrecto. Del mismo modo, **Aprendizaje instrumental** y
**Conflicto de roles** describen aspectos distintos de la misma situación: el primero
orientado a resolver un problema concreto y evaluado por su utilidad inmediata, mientras el segundo competencia entre estudio, trabajo y responsabilidades familiares por el mismo tiempo.
...
- **Evidencia de logro.** Qué muestra una comparación explícita entre el diseño de una misma formación para adolescentes y para adultos, con las decisiones que cambian frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
te deja en condiciones de qué supuestos de la enseñanza escolar debes abandonar al trabajar con estudiantes adultos, y esa decisión se sostiene solo si
...
|---|---|---|
| Arnett, J. (2000). *Emerging Adulthood*. American Psychologist, 55(5). | define el período y sus rasgos; explica trayectorias educativas no lineales. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
| Merriam, S. & Bierema, L. (2013). *Adult Learning: Linking Theory and Practice*. | revisa críticamente el campo y separa lo respaldado de lo asumido. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Adultez emergente** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Adultez emergente de Identidad ocupacional.** El trabajo aquí es separar lo observado de lo interpretado sobre **Identidad ocupacional**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Aprendizaje instrumental como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Aprendizaje instrumental**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.

**Paso 4 — Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con Conflicto de roles a la vista.** Con **Conflicto de roles** ya delimitado, la pregunta pasa a ser de consecuencia: qué cambia para los estudiantes, para el tiempo de clase y para la carga del equipo. **Evidencia de partida** entrega la lectura observable; el juicio profesional sigue siendo humano y debe quedar firmado por quien lo hace.
...
|---|---|---|---|
| Intervenir sobre **Adultez emergente** | Período entre los 18 y los 25 años, con exploración de identidad y trayectorias no lineales | Cuando **Evidencia de partida** es observable y accionable dentro del plazo de la decisión. | Sobrerreaccionar a una señal parcial. |
| Intervenir sobre **Identidad ocupacional** | Construcción de sí mismo en relación con el trabajo; organiza la motivación adulta por aprender | Cuando la primera explicación no distingue mecanismo ni responsable. | Convertir el concepto en etiqueta y no en intervención. |
| Observar antes de decidir | Reducir la incertidumbre antes de comprometer tiempo y credibilidad | Cuando la decisión es reversible y la evidencia disponible no distingue causas. | Observar indefinidamente y no decidir nunca. |
| Derivar o escalar | Poner la decisión donde están la competencia y la responsabilidad | Cuando hay normativa, resguardo de datos, salud o vulneración de derechos en juego. | Delegar hacia arriba lo que sí correspondía decidir en el aula. |

**Frontera de aplicación.** La categoría «adulto» agrupa realidades muy distintas: Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre adultez emergente y adultez |
|---|---|
...
Guárdala en `evidence/P02-C033-adultez-emergente-y-adultez/` con estos archivos:
