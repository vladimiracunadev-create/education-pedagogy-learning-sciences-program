...
**Estado de evidencia:** `EN-DEBATE` · **Etapa:** 🟢 Etapa A — Fundamentos · **Población de referencia:** trayectoria completa: primera infancia a adultez mayor<br>
**Decisión que habilita:** determinar qué diferencia individual de tu grupo justifica realmente un ajuste de enseñanza<br>
...
2. Clasificar la situación distinguiendo **Variabilidad esperable** de **Conocimiento previo**.
3. Decidir con fundamento, usando **Neuromito** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Diferenciación** a la vista.
...
| **Evidencia de logro** | qué muestra un perfil de variabilidad de tu curso con las diferencias que exigen ajuste y las que no, con su justificación frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
Hay debate legítimo sobre cuánta diferenciación es sostenible: Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Variabilidad esperable"]
    C --> A2["Conocimiento previo"]
    C --> A3["Neuromito"]
    C --> A4["Diferenciación"]
    A1 & A2 & A3 & A4 --> D{{"determinar qué<br/>diferencia individual de<br/>tu grupo justifica<br/>realmente un ajuste de<br/>enseñanza"}}
    D --> E["Evidencia de aprendizaje<br/>un perfil de<br/>variabilidad de tu curso<br/>con las diferencias que<br/>exigen ajuste y las que<br/>no, con…"]
...
inocua: produce decisiones que atacan el problema equivocado. **Variabilidad esperable** no es lo
mismo que **Conocimiento previo** —la diferencia individual con mayor poder explicativo sobre el aprendizaje nuevo—, y tratarlos como sinónimos hace
que la intervención se dirija al lugar incorrecto. Del mismo modo, **Neuromito** y
**Diferenciación** describen aspectos distintos de la misma situación: el primero
creencia sobre el cerebro ampliamente difundida y refutada por la evidencia, mientras el segundo ajuste de la enseñanza a la variabilidad, sin modificar el objetivo de aprendizaje.
...
- **Evidencia de logro.** Qué muestra un perfil de variabilidad de tu curso con las diferencias que exigen ajuste y las que no, con su justificación frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
te deja en condiciones de qué diferencia individual de tu grupo justifica realmente un ajuste de enseñanza, y esa decisión se sostiene solo si
...
|---|---|---|
| Pashler, H. et al. (2008). *Learning Styles: Concepts and Evidence*. Psychological Science in the Public Interest, 9(3). | la revisión que muestra la ausencia de evidencia para la hipótesis de emparejamiento; lectura obligada. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
| Tomlinson, C. (2014). *The Differentiated Classroom*. | propuesta operativa de diferenciación; léela junto con la evidencia sobre su implementación real. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Variabilidad esperable** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Variabilidad esperable de Conocimiento previo.** El trabajo aquí es separar lo observado de lo interpretado sobre **Conocimiento previo**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Neuromito como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Neuromito**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.

**Paso 4 — Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con Diferenciación a la vista.** Con **Diferenciación** ya delimitado, la pregunta pasa a ser de consecuencia: qué cambia para los estudiantes, para el tiempo de clase y para la carga del equipo. **Evidencia de partida** entrega la lectura observable; el juicio profesional sigue siendo humano y debe quedar firmado por quien lo hace.
...
|---|---|---|---|
| Intervenir sobre **Variabilidad esperable** | Dispersión normal de desempeños dentro de cualquier grupo; es el punto de partida del diseño | Cuando **Evidencia de partida** es observable y accionable dentro del plazo de la decisión. | Sobrerreaccionar a una señal parcial. |
| Intervenir sobre **Conocimiento previo** | La diferencia individual con mayor poder explicativo sobre el aprendizaje nuevo | Cuando la primera explicación no distingue mecanismo ni responsable. | Convertir el concepto en etiqueta y no en intervención. |
| Observar antes de decidir | Reducir la incertidumbre antes de comprometer tiempo y credibilidad | Cuando la decisión es reversible y la evidencia disponible no distingue causas. | Observar indefinidamente y no decidir nunca. |
| Derivar o escalar | Poner la decisión donde están la competencia y la responsabilidad | Cuando hay normativa, resguardo de datos, salud o vulneración de derechos en juego. | Delegar hacia arriba lo que sí correspondía decidir en el aula. |

**Frontera de aplicación.** Hay debate legítimo sobre cuánta diferenciación es sostenible: Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre diferencias individuales |
|---|---|
...
Guárdala en `evidence/P02-C035-diferencias-individuales/` con estos archivos:
