...
**Decisión que habilita:** determinar cómo responder a una conducta de vínculo sin reforzar la inseguridad ni negar la necesidad<br>
...
2. Clasificar la situación distinguiendo **Apego** de **Base segura**.
3. Decidir con fundamento, usando **Patrón de apego** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Figura significativa alternativa** a la vista.
...
| **Evidencia de logro** | qué muestra un análisis de dos conductas de vínculo observadas y la respuesta educativa fundamentada para cada una frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
El apego describe una relación específica, no un rasgo permanente del niño ni una explicación de todo su comportamiento. Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Apego"]
    C --> A2["Base segura"]
    C --> A3["Patrón de apego"]
    C --> A4["Figura significativa<br/>alternativa"]
    A1 & A2 & A3 & A4 --> D{{"determinar cómo<br/>responder a una conducta<br/>de vínculo sin reforzar<br/>la inseguridad ni negar<br/>la…"}}
    D --> E["Evidencia de aprendizaje<br/>un análisis de dos<br/>conductas de vínculo<br/>observadas y la<br/>respuesta educativa<br/>fundamentada para…"]
...
inocua: produce decisiones que atacan el problema equivocado. **Apego** no es lo
mismo que **Base segura** —función del adulto que permite al niño explorar sabiendo que hay retorno disponible—, y tratarlos como sinónimos hace
que la intervención se dirija al lugar incorrecto. Del mismo modo, **Patrón de apego** y
**Figura significativa alternativa** describen aspectos distintos de la misma situación: el primero
forma característica de responder ante la separación y el reencuentro;, mientras el segundo adulto no cuidador principal que puede cumplir funciones de sostén y ampliar la seguridad.
...
- **Evidencia de logro.** Qué muestra un análisis de dos conductas de vínculo observadas y la respuesta educativa fundamentada para cada una frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
te deja en condiciones de cómo responder a una conducta de vínculo sin reforzar la inseguridad ni negar la necesidad, y esa decisión se sostiene solo si
...
|---|---|---|
| Bowlby, J. (1988). *A Secure Base*. | la formulación clínica de la base segura y su relación con la exploración; muy aplicable al aula. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
| Sroufe, A. et al. (2005). *The Development of the Person*. | estudio longitudinal de treinta años; documenta continuidad y cambio, y desmiente el determinismo. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Apego** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Apego de Base segura.** El trabajo aquí es separar lo observado de lo interpretado sobre **Base segura**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Patrón de apego como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Patrón de apego**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.

**Paso 4 — Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con Figura significativa alternativa a la vista.** Con **Figura significativa alternativa** ya delimitado, la pregunta pasa a ser de consecuencia: qué cambia para los estudiantes, para el tiempo de clase y para la carga del equipo. **Evidencia de partida** entrega la lectura observable; el juicio profesional sigue siendo humano y debe quedar firmado por quien lo hace.
...
|---|---|---|---|
| Intervenir sobre **Apego** | Vínculo afectivo con un cuidador que organiza la búsqueda de proximidad y seguridad | Cuando **Evidencia de partida** es observable y accionable dentro del plazo de la decisión. | Sobrerreaccionar a una señal parcial. |
| Intervenir sobre **Base segura** | Función del adulto que permite al niño explorar sabiendo que hay retorno disponible | Cuando la primera explicación no distingue mecanismo ni responsable. | Convertir el concepto en etiqueta y no en intervención. |
| Observar antes de decidir | Reducir la incertidumbre antes de comprometer tiempo y credibilidad | Cuando la decisión es reversible y la evidencia disponible no distingue causas. | Observar indefinidamente y no decidir nunca. |
| Derivar o escalar | Poner la decisión donde están la competencia y la responsabilidad | Cuando hay normativa, resguardo de datos, salud o vulneración de derechos en juego. | Delegar hacia arriba lo que sí correspondía decidir en el aula. |

**Frontera de aplicación.** El apego describe una relación específica, no un rasgo permanente del niño ni una explicación de todo su comportamiento. Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre apego y vínculos |
|---|---|
...
Guárdala en `evidence/P02-C030-apego-y-vinculos/` con estos archivos:
