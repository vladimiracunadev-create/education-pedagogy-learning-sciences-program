...
**Estado de evidencia:** `ROBUSTA` · **Etapa:** 🟢 Etapa A — Fundamentos · **Población de referencia:** trayectoria completa: primera infancia a adultez mayor<br>
**Decisión que habilita:** determinar cómo vas a aumentar deliberadamente la cantidad y la calidad del lenguaje dirigido a cada niño<br>
...
2. Clasificar la situación distinguiendo **Lenguaje dirigido al niño** de **Intercambio conversacional**.
3. Decidir con fundamento, usando **Vocabulario receptivo y expresivo** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Conciencia fonológica** a la vista.
...
| **Evidencia de logro** | qué muestra un plan de interacción verbal con estrategias específicas y un registro de su aplicación durante una semana frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
La magnitud de la brecha léxica temprana ha sido revisada y los datos originales muy citados fueron cuestionados metodológicamente; Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Lenguaje dirigido al<br/>niño"]
    C --> A2["Intercambio<br/>conversacional"]
    C --> A3["Vocabulario receptivo<br/>y expresivo"]
    C --> A4["Conciencia fonológica"]
    A1 & A2 & A3 & A4 --> D{{"determinar cómo vas a<br/>aumentar deliberadamente<br/>la cantidad y la calidad<br/>del lenguaje dirigido a…"}}
    D --> E["Evidencia de aprendizaje<br/>un plan de interacción<br/>verbal con estrategias<br/>específicas y un<br/>registro de su<br/>aplicación…"]
...
inocua: produce decisiones que atacan el problema equivocado. **Lenguaje dirigido al niño** no es lo
mismo que **Intercambio conversacional** —turno completo de ida y vuelta entre adulto y niño; unidad con mayor valor predictivo—, y tratarlos como sinónimos hace
que la intervención se dirija al lugar incorrecto. Del mismo modo, **Vocabulario receptivo y expresivo** y
**Conciencia fonológica** describen aspectos distintos de la misma situación: el primero
palabras que se comprenden y palabras que se producen;, mientras el segundo capacidad de identificar y manipular los sonidos del habla;.
...
- **Evidencia de logro.** Qué muestra un plan de interacción verbal con estrategias específicas y un registro de su aplicación durante una semana frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
te deja en condiciones de cómo vas a aumentar deliberadamente la cantidad y la calidad del lenguaje dirigido a cada niño, y esa decisión se sostiene solo si
...
|---|---|---|
| Romeo, R. et al. (2018). *Beyond the 30-Million-Word Gap: Children's Conversational Exposure*. Psychological Science, 29(5). | muestra que los turnos conversacionales, y no el número de palabras, explican la asociación con el desarrollo. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
| Snow, C., Burns, S. & Griffin, P. (eds.) (1998). *Preventing Reading Difficulties in Young Children*. | conecta lenguaje oral temprano con lectura posterior; base de la prevención de dificultades lectoras. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
...
**Situación.** Un estudiante de 7.º básico dejó de participar, baja sus resultados y responde con agresividad a las correcciones. En el consejo aparecen cuatro explicaciones distintas —familiar, cognitiva, conductual y motivacional— y ninguna con evidencia.

**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Lenguaje dirigido al niño** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Lenguaje dirigido al niño de Intercambio conversacional.** El trabajo aquí es separar lo observado de lo interpretado sobre **Intercambio conversacional**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Vocabulario receptivo y expresivo como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Vocabulario receptivo y expresivo**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.

**Paso 4 — Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con Conciencia fonológica a la vista.** Con **Conciencia fonológica** ya delimitado, la pregunta pasa a ser de consecuencia: qué cambia para los estudiantes, para el tiempo de clase y para la carga del equipo. **Evidencia de partida** entrega la lectura observable; el juicio profesional sigue siendo humano y debe quedar firmado por quien lo hace.
...
|---|---|---|---|
| Intervenir sobre **Lenguaje dirigido al niño** | Habla que un adulto ajusta y dirige específicamente al niño; predice desarrollo mejor que el habla ambiental | Cuando **Evidencia de partida** es observable y accionable dentro del plazo de la decisión. | Sobrerreaccionar a una señal parcial. |
| Intervenir sobre **Intercambio conversacional** | Turno completo de ida y vuelta entre adulto y niño; unidad con mayor valor predictivo | Cuando la primera explicación no distingue mecanismo ni responsable. | Convertir el concepto en etiqueta y no en intervención. |
| Observar antes de decidir | Reducir la incertidumbre antes de comprometer tiempo y credibilidad | Cuando la decisión es reversible y la evidencia disponible no distingue causas. | Observar indefinidamente y no decidir nunca. |
| Derivar o escalar | Poner la decisión donde están la competencia y la responsabilidad | Cuando hay normativa, resguardo de datos, salud o vulneración de derechos en juego. | Delegar hacia arriba lo que sí correspondía decidir en el aula. |

**Frontera de aplicación.** La magnitud de la brecha léxica temprana ha sido revisada y los datos originales muy citados fueron cuestionados metodológicamente; Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre desarrollo del lenguaje |
|---|---|
...
Guárdala en `evidence/P02-C027-desarrollo-del-lenguaje/` con estos archivos:
...
Esta evidencia alimenta el artefacto de la parte: **trayectoria de desarrollo documentada con registros fechados, interpretación y decisiones por tramo**.
...
Riesgo característico de esta parte: **Usar la edad como diagnóstico y esperar el mismo desempeño de todo un curso.** Antes de aplicar
