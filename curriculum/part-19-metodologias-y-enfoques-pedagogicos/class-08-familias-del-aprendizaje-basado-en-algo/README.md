# Clase 236 — Familias del aprendizaje basado en algo

> **Parte 19 · Metodologías y enfoques pedagógicos** — clase 8 de 12

**Estado de evidencia:** `CONSISTENTE` · **Etapa:** 🟤 Etapa F — Especialización y desafíos contemporáneos · **Población de referencia:** transversal, de parvularia a educación superior<br>
**Decisión que habilita:** determinar cuál de estas familias corresponde a tu objetivo y qué exige para funcionar<br>
**Evidencia de aprendizaje:** un diseño que declara la familia elegida, su estructura, su producto y su criterio de evaluación

## 🎯 Propósito

Distinguir las familias del aprendizaje basado en algo por su estructura y elegir la que corresponde al objetivo perseguido.
...
2. **Explicar** en qué se diferencian realmente el aprendizaje basado en proyectos, en problemas, en casos y en retos.
3. **Decidir** —cuál de estas familias corresponde a tu objetivo y qué exige para funcionar— y sostener la decisión con un fundamento escrito.
4. **Producir** la evidencia de la clase —un diseño que declara la familia elegida, su estructura, su producto y su criterio de evaluación— y contrastarla contra el criterio de logro.
...
|---|---|
| **Aprendizaje basado en proyectos** | trabajo extendido que culmina en un producto público, con contenido curricular incorporado en el proceso |
| **Aprendizaje basado en problemas** | formato que parte de un problema mal estructurado y usa la necesidad de resolverlo para generar el estudio del contenido |
| **Método de casos** | análisis de una situación real documentada, con decisión fundamentada y discusión colectiva |
| **Producto público** | entrega dirigida a una audiencia externa, que cambia el estándar de calidad que el grupo se impone |
...
2. Clasificar la situación distinguiendo **Aprendizaje basado en proyectos** de **Aprendizaje basado en problemas**.
3. Decidir con fundamento, usando **Método de casos** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Producto público** a la vista.
...
| **Evidencia de logro** | qué muestra un diseño que declara la familia elegida, su estructura, su producto y su criterio de evaluación frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
El costo de tiempo es alto y la cobertura de contenido baja, lo que obliga a elegir qué se enseña así y qué no. Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Aprendizaje basado en<br/>proyectos"]
    C --> A2["Aprendizaje basado en<br/>problemas"]
    C --> A3["Método de casos"]
    C --> A4["Producto público"]
    A1 & A2 & A3 & A4 --> D{{"determinar cuál de estas<br/>familias corresponde a<br/>tu objetivo y qué exige<br/>para funcionar"}}
    D --> E["Evidencia de aprendizaje<br/>un diseño que declara la<br/>familia elegida, su<br/>estructura, su producto<br/>y su criterio de<br/>evaluación"]
...
Estas familias se confunden con frecuencia y sus diferencias no son cosméticas. El proyecto se organiza en torno a un producto; el problema, en torno a una pregunta mal estructurada; el caso, en torno a una decisión ya tomada por alguien; el reto, en torno a una restricción. Cada estructura produce aprendizajes distintos y exige condiciones distintas. La evidencia agregada muestra efectos moderados y muy dependientes de la implementación: los diseños con enseñanza explícita incorporada rinden considerablemente mejor que los que confían en que el contenido se aprenderá por necesidad.

### 2. Frontera conceptual: qué es y qué no es

Los cuatro conceptos de esta clase se confunden entre sí con facilidad, y esa confusión no es
inocua: produce decisiones que atacan el problema equivocado. **Aprendizaje basado en proyectos** no es lo
mismo que **Aprendizaje basado en problemas** —formato que parte de un problema mal estructurado y usa la necesidad de resolverlo para generar el estudio del contenido—, y tratarlos como sinónimos hace
que la intervención se dirija al lugar incorrecto. Del mismo modo, **Método de casos** y
**Producto público** describen aspectos distintos de la misma situación: el primero
análisis de una situación real documentada, con decisión fundamentada y discusión colectiva, mientras el segundo entrega dirigida a una audiencia externa, que cambia el estándar de calidad que el grupo se impone.
...
- **Evidencia de logro.** Qué muestra un diseño que declara la familia elegida, su estructura, su producto y su criterio de evaluación frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
El diseño profesional decide primero el objetivo y después la familia. Si el objetivo es dominar contenido, conviene incorporar instrucción explícita dentro del proyecto en vez de esperar que emerja. Si el objetivo es juicio profesional, el caso rinde más y cuesta menos tiempo. La evaluación debe medir el aprendizaje individual y no solo el producto grupal, que es donde estos formatos fallan con más frecuencia: un producto excelente puede convivir con dos estudiantes que no aprendieron nada.

### 5. Qué sostiene la evidencia y qué no

El costo de tiempo es alto y la cobertura de contenido baja, lo que obliga a elegir qué se enseña así y qué no. La evidencia es heterogénea porque bajo la misma etiqueta conviven diseños incomparables. Y hay un problema persistente de evaluación: la calidad del producto correlaciona con el reparto de trabajo dentro del grupo más que con el aprendizaje de cada integrante.
...
te deja en condiciones de cuál de estas familias corresponde a tu objetivo y qué exige para funcionar, y esa decisión se sostiene solo si
...
|---|---|---|
| Barron, B. & Darling-Hammond, L. (2008). *Teaching for Meaningful Learning*. | revisión de los formatos basados en indagación con sus condiciones de eficacia. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
| Hmelo-Silver, C. (2004). *Problem-Based Learning: What and How Do Students Learn?* | distingue el mecanismo del aprendizaje basado en problemas de sus versiones difusas. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Aprendizaje basado en proyectos** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Aprendizaje basado en proyectos de Aprendizaje basado en problemas.** El trabajo aquí es separar lo observado de lo interpretado sobre **Aprendizaje basado en problemas**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Método de casos como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Método de casos**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.

**Paso 4 — Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con Producto público a la vista.** Con **Producto público** ya delimitado, la pregunta pasa a ser de consecuencia: qué cambia para los estudiantes, para el tiempo de clase y para la carga del equipo. **Evidencia de partida** entrega la lectura observable; el juicio profesional sigue siendo humano y debe quedar firmado por quien lo hace.
...
|---|---|---|---|
| Intervenir sobre **Aprendizaje basado en proyectos** | Trabajo extendido que culmina en un producto público, con contenido curricular incorporado en el proceso | Cuando **Evidencia de partida** es observable y accionable dentro del plazo de la decisión. | Sobrerreaccionar a una señal parcial. |
| Intervenir sobre **Aprendizaje basado en problemas** | Formato que parte de un problema mal estructurado y usa la necesidad de resolverlo para generar el estudio del contenido | Cuando la primera explicación no distingue mecanismo ni responsable. | Convertir el concepto en etiqueta y no en intervención. |
| Observar antes de decidir | Reducir la incertidumbre antes de comprometer tiempo y credibilidad | Cuando la decisión es reversible y la evidencia disponible no distingue causas. | Observar indefinidamente y no decidir nunca. |
| Derivar o escalar | Poner la decisión donde están la competencia y la responsabilidad | Cuando hay normativa, resguardo de datos, salud o vulneración de derechos en juego. | Delegar hacia arriba lo que sí correspondía decidir en el aula. |

**Frontera de aplicación.** El costo de tiempo es alto y la cobertura de contenido baja, lo que obliga a elegir qué se enseña así y qué no. Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre familias del aprendizaje basado en algo |
|---|---|
...
Un diseño que declara la familia elegida, su estructura, su producto y su criterio de evaluación.

Guárdala en `evidence/P19-C236-familias-del-aprendizaje-basado-en-algo/` con estos archivos:
...
Rediseña una unidad con una de estas familias, incorporando instrucción explícita y evaluación individual. Registra qué aprendió el estudiante que menos participó.
...
- [ ] el diseño declara la familia elegida y por qué corresponde al objetivo;
- [ ] existe evaluación del aprendizaje individual además del producto colectivo;
...
- Esperar que el contenido se aprenda solo por la necesidad de resolver el problema.
- Calificar el producto grupal como si midiera el aprendizaje de cada estudiante.
...
Estos formatos amplifican las diferencias de capital cultural y de organización personal si no se estructuran: quien tiene apoyo en casa y hábitos de planificación brilla, y quien no los tiene desaparece dentro del grupo. Roles declarados, hitos intermedios y evaluación individual son medidas de equidad.
...
1. ¿Tu objetivo es dominar contenido, ejercitar juicio o producir algo? Cada uno pide otra familia.
2. ¿Dónde está la enseñanza explícita dentro de tu proyecto?
3. ¿Cómo sabrás qué aprendió el estudiante que menos trabajó?
...
Aplica los criterios de las clases 229 y 231. Profundiza lo tratado en las clases 065 y 066.
...
|---|---|---|
| [← 235 · Pedagogía crítica y educación popular](../class-07-pedagogia-critica-y-educacion-popular/README.md) | [Parte 19](../README.md) · [Programa](../../../README.md) | [237 · Aprendizaje-servicio y vínculo comunitario →](../class-09-aprendizaje-servicio-y-vinculo-comunitario/README.md) |
