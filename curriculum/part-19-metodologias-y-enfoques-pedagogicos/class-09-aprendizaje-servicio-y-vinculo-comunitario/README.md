# Clase 237 — Aprendizaje-servicio y vínculo comunitario

> **Parte 19 · Metodologías y enfoques pedagógicos** — clase 9 de 12

**Estado de evidencia:** `EMERGENTE` · **Etapa:** 🟤 Etapa F — Especialización y desafíos contemporáneos · **Población de referencia:** transversal, de parvularia a educación superior<br>
**Decisión que habilita:** determinar si tu actividad comunitaria tiene aprendizaje declarado, servicio real y reciprocidad, o solo una de las tres<br>
**Evidencia de aprendizaje:** un diseño de aprendizaje-servicio con objetivo curricular, necesidad validada con la comunidad y evaluación de ambos lados

## 🎯 Propósito

Diseñar aprendizaje-servicio con objetivos curriculares verificables y reciprocidad real con la comunidad, evitando el asistencialismo escolar.
...
2. **Explicar** qué distingue un aprendizaje-servicio de una actividad solidaria con nombre pedagógico.
3. **Decidir** —si tu actividad comunitaria tiene aprendizaje declarado, servicio real y reciprocidad, o solo una de las tres— y sostener la decisión con un fundamento escrito.
4. **Producir** la evidencia de la clase —un diseño de aprendizaje-servicio con objetivo curricular, necesidad validada con la comunidad y evaluación de ambos lados— y contrastarla contra el criterio de logro.
...
|---|---|
| **Aprendizaje-servicio** | metodología que articula objetivos curriculares con una acción de servicio a una necesidad real de la comunidad |
| **Reciprocidad** | condición según la cual la comunidad participa en la definición de la necesidad y no solo recibe la intervención |
| **Reflexión estructurada** | instancia planificada donde el estudiante conecta la experiencia con el contenido disciplinar; sin ella el efecto se pierde |
| **Asistencialismo escolar** | actividad de ayuda sin aprendizaje declarado ni participación de la comunidad en la decisión |
...
2. Clasificar la situación distinguiendo **Aprendizaje-servicio** de **Reciprocidad**.
3. Decidir con fundamento, usando **Reflexión estructurada** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Asistencialismo escolar** a la vista.
...
| **Evidencia de logro** | qué muestra un diseño de aprendizaje-servicio con objetivo curricular, necesidad validada con la comunidad y evaluación de ambos lados frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
La base empírica es todavía limitada y heterogénea, con muchos estudios de diseño débil y autoinforme. Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Aprendizaje-servicio"]
    C --> A2["Reciprocidad"]
    C --> A3["Reflexión estructurada"]
    C --> A4["Asistencialismo<br/>escolar"]
    A1 & A2 & A3 & A4 --> D{{"determinar si tu<br/>actividad comunitaria<br/>tiene aprendizaje<br/>declarado, servicio real<br/>y…"}}
    D --> E["Evidencia de aprendizaje<br/>un diseño de<br/>aprendizaje-servicio con<br/>objetivo curricular,<br/>necesidad validada con<br/>la comunidad…"]
...
El aprendizaje-servicio se distingue del voluntariado escolar por una condición exigente: debe haber aprendizaje curricular verificable y servicio real, y ambos deben estar diseñados juntos. La evidencia disponible muestra efectos consistentes en compromiso cívico y motivación, y efectos más modestos y variables en aprendizaje académico, dependiendo enteramente de si hubo reflexión estructurada. Sin esa reflexión, la experiencia produce recuerdo emotivo y poco aprendizaje transferible.

### 2. Frontera conceptual: qué es y qué no es

Los cuatro conceptos de esta clase se confunden entre sí con facilidad, y esa confusión no es
inocua: produce decisiones que atacan el problema equivocado. **Aprendizaje-servicio** no es lo
mismo que **Reciprocidad** —condición según la cual la comunidad participa en la definición de la necesidad y no solo recibe la intervención—, y tratarlos como sinónimos hace
que la intervención se dirija al lugar incorrecto. Del mismo modo, **Reflexión estructurada** y
**Asistencialismo escolar** describen aspectos distintos de la misma situación: el primero
instancia planificada donde el estudiante conecta la experiencia con el contenido disciplinar;, mientras el segundo actividad de ayuda sin aprendizaje declarado ni participación de la comunidad en la decisión.
...
- **Evidencia de logro.** Qué muestra un diseño de aprendizaje-servicio con objetivo curricular, necesidad validada con la comunidad y evaluación de ambos lados frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
Un diseño sólido parte del objetivo curricular, no de la actividad disponible. Luego valida la necesidad con la comunidad —que participa en definirla, no solo en recibirla—, planifica la reflexión en tres momentos y evalúa por separado el aprendizaje del estudiante y el efecto del servicio. La reciprocidad es lo que separa esta metodología de la campaña de fin de año: la comunidad es socia, no beneficiaria pasiva de un ejercicio escolar.

### 5. Qué sostiene la evidencia y qué no

La base empírica es todavía limitada y heterogénea, con muchos estudios de diseño débil y autoinforme. Los efectos académicos son inconsistentes y dependen de la calidad de la reflexión. Hay además un riesgo ético serio: proyectos que instrumentalizan a una comunidad vulnerable como material didáctico y se retiran cuando termina el semestre, dejando expectativas abiertas.
...
te deja en condiciones de si tu actividad comunitaria tiene aprendizaje declarado, servicio real y reciprocidad, o solo una de las tres, y esa decisión se sostiene solo si
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Aprendizaje-servicio** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Aprendizaje-servicio de Reciprocidad.** El trabajo aquí es separar lo observado de lo interpretado sobre **Reciprocidad**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Reflexión estructurada como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Reflexión estructurada**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.

**Paso 4 — Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con Asistencialismo escolar a la vista.** Con **Asistencialismo escolar** ya delimitado, la pregunta pasa a ser de consecuencia: qué cambia para los estudiantes, para el tiempo de clase y para la carga del equipo. **Evidencia de partida** entrega la lectura observable; el juicio profesional sigue siendo humano y debe quedar firmado por quien lo hace.
...
|---|---|---|---|
| Intervenir sobre **Aprendizaje-servicio** | Metodología que articula objetivos curriculares con una acción de servicio a una necesidad real de la comunidad | Cuando **Evidencia de partida** es observable y accionable dentro del plazo de la decisión. | Sobrerreaccionar a una señal parcial. |
| Intervenir sobre **Reciprocidad** | Condición según la cual la comunidad participa en la definición de la necesidad y no solo recibe la intervención | Cuando la primera explicación no distingue mecanismo ni responsable. | Convertir el concepto en etiqueta y no en intervención. |
| Observar antes de decidir | Reducir la incertidumbre antes de comprometer tiempo y credibilidad | Cuando la decisión es reversible y la evidencia disponible no distingue causas. | Observar indefinidamente y no decidir nunca. |
| Derivar o escalar | Poner la decisión donde están la competencia y la responsabilidad | Cuando hay normativa, resguardo de datos, salud o vulneración de derechos en juego. | Delegar hacia arriba lo que sí correspondía decidir en el aula. |

**Frontera de aplicación.** La base empírica es todavía limitada y heterogénea, con muchos estudios de diseño débil y autoinforme. Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre aprendizaje-servicio y vínculo comunitario |
|---|---|
...
Un diseño de aprendizaje-servicio con objetivo curricular, necesidad validada con la comunidad y evaluación de ambos lados.

Guárdala en `evidence/P19-C237-aprendizaje-servicio-y-vinculo-comunitario/` con estos archivos:
...
Diseña un aprendizaje-servicio partiendo de un objetivo curricular. Valida la necesidad con la comunidad y planifica los tres momentos de reflexión antes de ejecutar.
...
- [ ] el diseño declara objetivo curricular verificable y necesidad validada con la comunidad;
- [ ] existen instancias de reflexión estructurada y evaluación de ambos lados de la relación;
...
- Diseñar la actividad primero y buscar después qué objetivo curricular podría cubrir.
- Definir la necesidad de la comunidad desde la escuela, sin consultar a quien la vive.
...
El riesgo específico es convertir a estudiantes o comunidades en objeto de la buena voluntad de otros. El criterio de reciprocidad —y la pregunta sobre quién define la necesidad— es lo que protege la dignidad de todos los involucrados, incluidos los estudiantes de la propia escuela.
...
1. ¿Qué objetivo curricular se evaluará, y cómo?
2. ¿Quién de la comunidad participó en definir la necesidad?
3. ¿Qué ocurre con el vínculo cuando termina el semestre?
...
Se apoya en las clases 235 y 236, y enlaza con la parte 22 y con la clase 010.
...
|---|---|---|
| [← 236 · Familias del aprendizaje basado en algo](../class-08-familias-del-aprendizaje-basado-en-algo/README.md) | [Parte 19](../README.md) · [Programa](../../../README.md) | [238 · Gamificación y juego serio →](../class-10-gamificacion-y-juego-serio/README.md) |
