# Clase 234 — Freinet, Escuela Nueva y pedagogías activas

> **Parte 19 · Metodologías y enfoques pedagógicos** — clase 6 de 12
...
**Decisión que habilita:** determinar qué dispositivo de las pedagogías activas resuelve un problema real de tu aula<br>
**Evidencia de aprendizaje:** la implementación de un dispositivo de pedagogía activa con su registro de funcionamiento durante un mes

## 🎯 Propósito

Recuperar de Freinet, la Escuela Nueva y las pedagogías activas los dispositivos concretos que siguen operando y su condición de funcionamiento.
...
2. **Explicar** qué aportaron las pedagogías activas cuando tuvieron que funcionar sin recursos.
3. **Decidir** —qué dispositivo de las pedagogías activas resuelve un problema real de tu aula— y sostener la decisión con un fundamento escrito.
4. **Producir** la evidencia de la clase —la implementación de un dispositivo de pedagogía activa con su registro de funcionamiento durante un mes— y contrastarla contra el criterio de logro.
...
|---|---|
| **Técnicas Freinet** | conjunto de dispositivos —texto libre, imprenta escolar, correspondencia, plan de trabajo— que organizan el aula en torno a producción real |
| **Escuela Nueva** | movimiento pedagógico que centra la enseñanza en la actividad del estudiante y en el vínculo con la vida |
| **Plan de trabajo** | instrumento que reparte la responsabilidad de la tarea entre estudiante y docente durante un período declarado |
| **Producción con destinatario** | trabajo escolar dirigido a un lector o usuario real, lo que cambia el nivel de exigencia asumido |
...
2. Clasificar la situación distinguiendo **Técnicas Freinet** de **Escuela Nueva**.
3. Decidir con fundamento, usando **Plan de trabajo** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Producción con destinatario** a la vista.
...
| **Evidencia de logro** | qué muestra la implementación de un dispositivo de pedagogía activa con su registro de funcionamiento durante un mes frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
La tradición no dispone de evidencia experimental que respalde sus resultados de aprendizaje, y buena parte de lo que se sabe proviene de relatos de práctica. Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Técnicas Freinet"]
    C --> A2["Escuela Nueva"]
    C --> A3["Plan de trabajo"]
    C --> A4["Producción con<br/>destinatario"]
    A1 & A2 & A3 & A4 --> D{{"determinar qué<br/>dispositivo de las<br/>pedagogías activas<br/>resuelve un problema<br/>real de tu aula"}}
    D --> E["Evidencia de aprendizaje<br/>la implementación de un<br/>dispositivo de pedagogía<br/>activa con su registro<br/>de funcionamiento…"]
...
Las pedagogías activas europeas de comienzos del siglo veinte se desarrollaron en escuelas rurales pobres y con un solo docente, lo que las hace inesperadamente pertinentes para contextos con pocos recursos. Freinet no proponía una filosofía abstracta sino dispositivos: la imprenta escolar, el texto libre, la correspondencia entre escuelas, el plan de trabajo individual. Su lógica común es que el trabajo escolar tenga destinatario real, porque eso cambia la exigencia que el estudiante se impone.

### 2. Frontera conceptual: qué es y qué no es

Los cuatro conceptos de esta clase se confunden entre sí con facilidad, y esa confusión no es
inocua: produce decisiones que atacan el problema equivocado. **Técnicas Freinet** no es lo
mismo que **Escuela Nueva** —movimiento pedagógico que centra la enseñanza en la actividad del estudiante y en el vínculo con la vida—, y tratarlos como sinónimos hace
que la intervención se dirija al lugar incorrecto. Del mismo modo, **Plan de trabajo** y
**Producción con destinatario** describen aspectos distintos de la misma situación: el primero
instrumento que reparte la responsabilidad de la tarea entre estudiante y docente durante un período declarado, mientras el segundo trabajo escolar dirigido a un lector o usuario real, lo que cambia el nivel de exigencia asumido.
...
- **Evidencia de logro.** Qué muestra la implementación de un dispositivo de pedagogía activa con su registro de funcionamiento durante un mes frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
Adoptar estas técnicas hoy funciona mejor por dispositivo que por sistema completo. El plan de trabajo individual resuelve la gestión de ritmos distintos en un aula heterogénea. La producción con destinatario real —un blog, una publicación, una carta a otra escuela— eleva la exigencia sin agregar presión evaluativa. La asamblea de curso ordena la convivencia cuando se ejecuta con reglas y no como conversación abierta. Cada uno tiene su condición: sin ella, el dispositivo se convierte en actividad decorativa.

### 5. Qué sostiene la evidencia y qué no

La tradición no dispone de evidencia experimental que respalde sus resultados de aprendizaje, y buena parte de lo que se sabe proviene de relatos de práctica. Sus dispositivos exigen tiempo docente que muchos contextos no tienen. Y el énfasis en el interés del estudiante, mal entendido, puede derivar en currículum errático: la evidencia sobre la necesidad de una progresión de contenidos es más fuerte que la que respalda dejarla al azar del interés.
...
te deja en condiciones de qué dispositivo de las pedagogías activas resuelve un problema real de tu aula, y esa decisión se sostiene solo si
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Técnicas Freinet** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Técnicas Freinet de Escuela Nueva.** El trabajo aquí es separar lo observado de lo interpretado sobre **Escuela Nueva**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Plan de trabajo como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Plan de trabajo**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.

**Paso 4 — Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con Producción con destinatario a la vista.** Con **Producción con destinatario** ya delimitado, la pregunta pasa a ser de consecuencia: qué cambia para los estudiantes, para el tiempo de clase y para la carga del equipo. **Evidencia de partida** entrega la lectura observable; el juicio profesional sigue siendo humano y debe quedar firmado por quien lo hace.
...
|---|---|---|---|
| Intervenir sobre **Técnicas Freinet** | Conjunto de dispositivos —texto libre, imprenta escolar, correspondencia, plan de trabajo— que organizan el aula en torno a producción real | Cuando **Evidencia de partida** es observable y accionable dentro del plazo de la decisión. | Sobrerreaccionar a una señal parcial. |
| Intervenir sobre **Escuela Nueva** | Movimiento pedagógico que centra la enseñanza en la actividad del estudiante y en el vínculo con la vida | Cuando la primera explicación no distingue mecanismo ni responsable. | Convertir el concepto en etiqueta y no en intervención. |
| Observar antes de decidir | Reducir la incertidumbre antes de comprometer tiempo y credibilidad | Cuando la decisión es reversible y la evidencia disponible no distingue causas. | Observar indefinidamente y no decidir nunca. |
| Derivar o escalar | Poner la decisión donde están la competencia y la responsabilidad | Cuando hay normativa, resguardo de datos, salud o vulneración de derechos en juego. | Delegar hacia arriba lo que sí correspondía decidir en el aula. |

**Frontera de aplicación.** La tradición no dispone de evidencia experimental que respalde sus resultados de aprendizaje, y buena parte de lo que se sabe proviene de relatos de práctica. Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre freinet, Escuela Nueva y pedagogías activas |
|---|---|
...
La implementación de un dispositivo de pedagogía activa con su registro de funcionamiento durante un mes.

Guárdala en `evidence/P19-C234-freinet-escuela-nueva-y-pedagogias-activas/` con estos archivos:
...
Implementa un dispositivo durante un mes con su condición declarada. Registra semanalmente su funcionamiento y decide con evidencia si lo mantienes.
...
- [ ] el dispositivo se implementa con su condición de funcionamiento declarada;
- [ ] existe registro de un mes que permite juzgar si resolvió el problema que motivó adoptarlo;
...
- Adoptar el dispositivo sin su condición: un plan de trabajo sin seguimiento es una lista de tareas.
- Confundir actividad del estudiante con aprendizaje y renunciar a la progresión del contenido.
...
Los dispositivos que individualizan el ritmo —plan de trabajo, tarea con destinatario— son especialmente útiles en aulas muy heterogéneas y en multigrado, donde la clase frontal única deja fuera a la mitad del grupo por arriba o por abajo.
...
1. ¿Qué problema real de tu aula resolvería este dispositivo, y cómo lo mides?
2. ¿Quién es el destinatario real de lo que producen tus estudiantes?
3. ¿Qué progresión de contenido queda protegida mientras el dispositivo opera?
...
Continúa la clase 233 y prepara la 235. Enlaza con la clase 246 sobre aula multigrado.
...
|---|---|---|
| [← 233 · Montessori, Waldorf y Reggio Emilia](../class-05-montessori-waldorf-y-reggio-emilia/README.md) | [Parte 19](../README.md) · [Programa](../../../README.md) | [235 · Pedagogía crítica y educación popular →](../class-07-pedagogia-critica-y-educacion-popular/README.md) |
