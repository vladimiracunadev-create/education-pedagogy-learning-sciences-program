# Clase 230 — Instrucción explícita y enseñanza directa

> **Parte 19 · Metodologías y enfoques pedagógicos** — clase 2 de 12

**Estado de evidencia:** `ROBUSTA` · **Etapa:** 🟤 Etapa F — Especialización y desafíos contemporáneos · **Población de referencia:** transversal, de parvularia a educación superior<br>
**Decisión que habilita:** determinar cuándo tu contenido exige instrucción explícita y qué parte de su estructura estás omitiendo<br>
**Evidencia de aprendizaje:** una clase diseñada con la estructura completa de la instrucción explícita y su registro de verificación

## 🎯 Propósito

Aplicar instrucción explícita con su estructura completa —modelamiento, práctica guiada, práctica independiente y verificación— y distinguirla de la clase expositiva.
...
2. **Explicar** por qué el método con más respaldo empírico es también el peor entendido.
3. **Decidir** —cuándo tu contenido exige instrucción explícita y qué parte de su estructura estás omitiendo— y sostener la decisión con un fundamento escrito.
4. **Producir** la evidencia de la clase —una clase diseñada con la estructura completa de la instrucción explícita y su registro de verificación— y contrastarla contra el criterio de logro.
...
|---|---|
| **Instrucción explícita** | enseñanza estructurada que presenta el contenido en pasos pequeños, con modelamiento, práctica guiada y verificación frecuente |
| **Modelamiento** | demostración del procedimiento por parte del docente, verbalizando las decisiones que normalmente quedan implícitas |
| **Práctica guiada** | ejecución del estudiante con apoyo y corrección inmediata antes de trabajar solo |
| **Verificación frecuente** | comprobación del entendimiento de todo el grupo durante la clase, no al final de la unidad |
...
2. Clasificar la situación distinguiendo **Instrucción explícita** de **Modelamiento**.
3. Decidir con fundamento, usando **Práctica guiada** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Verificación frecuente** a la vista.
...
| **Evidencia de logro** | qué muestra una clase diseñada con la estructura completa de la instrucción explícita y su registro de verificación frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
La instrucción explícita rinde más con contenido nuevo, con procedimientos bien definidos y con estudiantes de bajo conocimiento previo. Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Instrucción explícita"]
    C --> A2["Modelamiento"]
    C --> A3["Práctica guiada"]
    C --> A4["Verificación frecuente"]
    A1 & A2 & A3 & A4 --> D{{"determinar cuándo tu<br/>contenido exige<br/>instrucción explícita y<br/>qué parte de su<br/>estructura estás…"}}
    D --> E["Evidencia de aprendizaje<br/>una clase diseñada con<br/>la estructura completa<br/>de la instrucción<br/>explícita y su registro<br/>de…"]
...
La instrucción explícita acumula uno de los respaldos empíricos más consistentes de la investigación sobre enseñanza, y aun así arrastra una reputación de método pasivo y anticuado. La confusión viene de identificarla con la clase expositiva. No son lo mismo: la clase expositiva presenta contenido, mientras que la instrucción explícita alterna presentación breve, práctica con corrección inmediata y verificación constante del grupo completo. Es, en la práctica, uno de los formatos con más participación por minuto.

### 2. Frontera conceptual: qué es y qué no es

Los cuatro conceptos de esta clase se confunden entre sí con facilidad, y esa confusión no es
inocua: produce decisiones que atacan el problema equivocado. **Instrucción explícita** no es lo
mismo que **Modelamiento** —demostración del procedimiento por parte del docente, verbalizando las decisiones que normalmente quedan implícitas—, y tratarlos como sinónimos hace
que la intervención se dirija al lugar incorrecto. Del mismo modo, **Práctica guiada** y
**Verificación frecuente** describen aspectos distintos de la misma situación: el primero
ejecución del estudiante con apoyo y corrección inmediata antes de trabajar solo, mientras el segundo comprobación del entendimiento de todo el grupo durante la clase, no al final de la unidad.
...
- **Evidencia de logro.** Qué muestra una clase diseñada con la estructura completa de la instrucción explícita y su registro de verificación frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
La estructura completa importa porque el efecto viene del conjunto. Se presenta poco contenido a la vez, se modela el procedimiento pensando en voz alta, se practica con apoyo hasta que la mayoría acierta, se verifica el entendimiento de todos —no solo de quien levanta la mano— y recién entonces se suelta a práctica independiente. La omisión más frecuente es saltarse la práctica guiada: se explica y se manda a trabajar solo, con lo que la mitad del curso practica errores.

### 5. Qué sostiene la evidencia y qué no

La instrucción explícita rinde más con contenido nuevo, con procedimientos bien definidos y con estudiantes de bajo conocimiento previo. Con estudiantes avanzados o en tareas genuinamente abiertas, la misma estructura puede volverse redundante y sofocante. Además, su evidencia proviene mayoritariamente de habilidades bien estructuradas —lectura, matemática, procedimientos— y se traslada peor a objetivos como el juicio estético o la deliberación ética.
...
te deja en condiciones de cuándo tu contenido exige instrucción explícita y qué parte de su estructura estás omitiendo, y esa decisión se sostiene solo si
...
|---|---|---|
| Rosenshine, B. (2012). *Principles of Instruction*. | la síntesis operativa más usada: diez principios derivados de investigación convergente. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
| Kirschner, P., Sweller, J. & Clark, R. (2006). *Why Minimal Guidance During Instruction Does Not Work*. | fundamenta desde la carga cognitiva por qué la guía alta rinde con novatos. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Instrucción explícita** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Instrucción explícita de Modelamiento.** El trabajo aquí es separar lo observado de lo interpretado sobre **Modelamiento**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Práctica guiada como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Práctica guiada**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.

**Paso 4 — Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con Verificación frecuente a la vista.** Con **Verificación frecuente** ya delimitado, la pregunta pasa a ser de consecuencia: qué cambia para los estudiantes, para el tiempo de clase y para la carga del equipo. **Evidencia de partida** entrega la lectura observable; el juicio profesional sigue siendo humano y debe quedar firmado por quien lo hace.
...
|---|---|---|---|
| Intervenir sobre **Instrucción explícita** | Enseñanza estructurada que presenta el contenido en pasos pequeños, con modelamiento, práctica guiada y verificación frecuente | Cuando **Evidencia de partida** es observable y accionable dentro del plazo de la decisión. | Sobrerreaccionar a una señal parcial. |
| Intervenir sobre **Modelamiento** | Demostración del procedimiento por parte del docente, verbalizando las decisiones que normalmente quedan implícitas | Cuando la primera explicación no distingue mecanismo ni responsable. | Convertir el concepto en etiqueta y no en intervención. |
| Observar antes de decidir | Reducir la incertidumbre antes de comprometer tiempo y credibilidad | Cuando la decisión es reversible y la evidencia disponible no distingue causas. | Observar indefinidamente y no decidir nunca. |
| Derivar o escalar | Poner la decisión donde están la competencia y la responsabilidad | Cuando hay normativa, resguardo de datos, salud o vulneración de derechos en juego. | Delegar hacia arriba lo que sí correspondía decidir en el aula. |

**Frontera de aplicación.** La instrucción explícita rinde más con contenido nuevo, con procedimientos bien definidos y con estudiantes de bajo conocimiento previo. Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre instrucción explícita y enseñanza directa |
|---|---|
...
Una clase diseñada con la estructura completa de la instrucción explícita y su registro de verificación.

Guárdala en `evidence/P19-C230-instruccion-explicita-y-ensenanza-directa/` con estos archivos:
...
Diseña una clase con los cuatro componentes explícitos y registra qué proporción del curso acertó en la verificación antes de la práctica independiente.
...
- [ ] la clase incluye modelamiento, práctica guiada, verificación y práctica independiente;
- [ ] existe un registro de qué proporción del curso demostró entender antes de soltar la práctica;
...
- Confundirla con exponer: explicar treinta minutos y llamar a eso instrucción explícita.
- Verificar el entendimiento preguntando al curso en general y avanzar con la respuesta de tres estudiantes.
...
La verificación frecuente del grupo completo es lo que evita que la clase avance con quienes ya sabían. Para estudiantes con dificultades de atención o de lenguaje, los pasos pequeños y la corrección inmediata son la diferencia entre participar y quedar fuera desde el primer minuto.
...
1. ¿Cuál de los cuatro componentes omites con más frecuencia y por qué?
2. ¿Cómo sabes cuántos entendieron antes de mandar a trabajar solos?
3. ¿En qué contenido de tu asignatura este formato sería el equivocado?
...
Se apoya en la clase 229 y contrasta directamente con la 231. Profundiza lo tratado en las clases 122 y 128.
...
|---|---|---|
| [← 229 · Cómo se compara un enfoque pedagógico](../class-01-como-se-compara-un-enfoque-pedagogico/README.md) | [Parte 19](../README.md) · [Programa](../../../README.md) | [231 · Indagación y descubrimiento guiado →](../class-03-indagacion-y-descubrimiento-guiado/README.md) |
