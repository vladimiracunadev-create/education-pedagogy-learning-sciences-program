# Clase 240 — Proyecto integrador: decisión metodológica fundamentada

> **Parte 19 · Metodologías y enfoques pedagógicos** — clase 12 de 12
...
**Decisión que habilita:** determinar el enfoque que adoptarás, con qué condiciones y cómo sabrás si funcionó<br>
**Evidencia de aprendizaje:** una decisión metodológica escrita con criterios, condiciones, alternativa descartada y plan de verificación

## 🎯 Propósito

Integrar los criterios de la parte en una decisión metodológica fundamentada, con condiciones de implementación y plan de verificación explícitos.
...
2. **Explicar** cómo se defiende una decisión metodológica ante un equipo que ya decidió otra cosa.
3. **Decidir** —el enfoque que adoptarás, con qué condiciones y cómo sabrás si funcionó— y sostener la decisión con un fundamento escrito.
4. **Producir** la evidencia de la clase —una decisión metodológica escrita con criterios, condiciones, alternativa descartada y plan de verificación— y contrastarla contra el criterio de logro.
...
|---|---|
| **Decisión fundamentada** | elección que declara criterios, evidencia considerada, alternativa descartada y condición de revisión |
| **Alternativa descartada** | opción que se evaluó y no se eligió, con la razón explicitada; su ausencia delata una decisión no deliberada |
| **Plan de verificación** | conjunto de indicadores y plazos que permitirán concluir si la decisión funcionó |
| **Condición de revisión** | señal previamente declarada que obligaría a revisar o revertir la decisión |
...
2. Clasificar la situación distinguiendo **Decisión fundamentada** de **Alternativa descartada**.
3. Decidir con fundamento, usando **Plan de verificación** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Condición de revisión** a la vista.
...
| **Evidencia de logro** | qué muestra una decisión metodológica escrita con criterios, condiciones, alternativa descartada y plan de verificación frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
Una decisión bien fundamentada puede ser equivocada: Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Decisión fundamentada"]
    C --> A2["Alternativa descartada"]
    C --> A3["Plan de verificación"]
    C --> A4["Condición de revisión"]
    A1 & A2 & A3 & A4 --> D{{"determinar el enfoque<br/>que adoptarás, con qué<br/>condiciones y cómo<br/>sabrás si funcionó"}}
    D --> E["Evidencia de aprendizaje<br/>una decisión<br/>metodológica escrita con<br/>criterios, condiciones,<br/>alternativa descartada y<br/>plan de…"]
...
Las decisiones metodológicas en las escuelas rara vez se documentan, y por eso rara vez se evalúan. Se adopta un enfoque tras una jornada de capacitación, se implementa de manera desigual, y dos años después nadie puede decir si funcionó porque nunca se declaró qué sería funcionar. El proyecto de esta parte corrige exactamente eso: producir una decisión que un tercero pueda auditar sin haber estado en la conversación donde se tomó.

### 2. Frontera conceptual: qué es y qué no es

Los cuatro conceptos de esta clase se confunden entre sí con facilidad, y esa confusión no es
inocua: produce decisiones que atacan el problema equivocado. **Decisión fundamentada** no es lo
mismo que **Alternativa descartada** —opción que se evaluó y no se eligió, con la razón explicitada; su ausencia delata una decisión no deliberada—, y tratarlos como sinónimos hace
que la intervención se dirija al lugar incorrecto. Del mismo modo, **Plan de verificación** y
**Condición de revisión** describen aspectos distintos de la misma situación: el primero
conjunto de indicadores y plazos que permitirán concluir si la decisión funcionó, mientras el segundo señal previamente declarada que obligaría a revisar o revertir la decisión.
...
- **Evidencia de logro.** Qué muestra una decisión metodológica escrita con criterios, condiciones, alternativa descartada y plan de verificación frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
La decisión integra todo lo trabajado: los criterios de comparación de la clase 229, la evidencia examinada sobre cada enfoque, las condiciones de implementación que el contexto puede o no sostener, y la alternativa descartada con su razón. Se agrega lo que casi nunca aparece: qué señal obligaría a revisar la decisión y en qué fecha se revisará. Documentada así, la decisión resiste el cambio de equipo y permite aprender del error si lo hubo.

### 5. Qué sostiene la evidencia y qué no

Una decisión bien fundamentada puede ser equivocada: el fundamento reduce el riesgo pero no lo elimina, porque ningún estudio conoce el contexto donde se aplica. Además, el documento no garantiza la implementación: la brecha entre lo decidido y lo ejecutado es el factor que más explica los fracasos metodológicos, y depende de tiempo, formación y acompañamiento que exceden a quien escribe la decisión.
...
te deja en condiciones de el enfoque que adoptarás, con qué condiciones y cómo sabrás si funcionó, y esa decisión se sostiene solo si
...
|---|---|---|
| Biggs, J. & Tang, C. (2011). *Teaching for Quality Learning at University*. | el alineamiento como criterio de coherencia entre lo decidido y lo evaluado. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
| Bryk, A. et al. (2015). *Learning to Improve*. | método para probar un cambio en pequeño antes de comprometer a toda la institución. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Decisión fundamentada** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Decisión fundamentada de Alternativa descartada.** El trabajo aquí es separar lo observado de lo interpretado sobre **Alternativa descartada**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Plan de verificación como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Plan de verificación**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.

**Paso 4 — Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con Condición de revisión a la vista.** Con **Condición de revisión** ya delimitado, la pregunta pasa a ser de consecuencia: qué cambia para los estudiantes, para el tiempo de clase y para la carga del equipo. **Evidencia de partida** entrega la lectura observable; el juicio profesional sigue siendo humano y debe quedar firmado por quien lo hace.
...
|---|---|---|---|
| Intervenir sobre **Decisión fundamentada** | Elección que declara criterios, evidencia considerada, alternativa descartada y condición de revisión | Cuando **Evidencia de partida** es observable y accionable dentro del plazo de la decisión. | Sobrerreaccionar a una señal parcial. |
| Intervenir sobre **Alternativa descartada** | Opción que se evaluó y no se eligió, con la razón explicitada; su ausencia delata una decisión no deliberada | Cuando la primera explicación no distingue mecanismo ni responsable. | Convertir el concepto en etiqueta y no en intervención. |
| Observar antes de decidir | Reducir la incertidumbre antes de comprometer tiempo y credibilidad | Cuando la decisión es reversible y la evidencia disponible no distingue causas. | Observar indefinidamente y no decidir nunca. |
| Derivar o escalar | Poner la decisión donde están la competencia y la responsabilidad | Cuando hay normativa, resguardo de datos, salud o vulneración de derechos en juego. | Delegar hacia arriba lo que sí correspondía decidir en el aula. |

**Frontera de aplicación.** Una decisión bien fundamentada puede ser equivocada: Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre proyecto integrador: decisión metodológica fundamentada |
|---|---|
...
Una decisión metodológica escrita con criterios, condiciones, alternativa descartada y plan de verificación.

Guárdala en `evidence/P19-C240-proyecto-integrador/` con estos archivos:
...
Escribe la decisión metodológica de una unidad completa con los cinco elementos. Preséntala a tu equipo y registra la objeción más fuerte que recibiste.
...
- [ ] la decisión declara criterios, alternativa descartada y condición de revisión;
- [ ] el plan de verificación tiene indicador, plazo y responsable nombrados;
...
- Presentar la decisión sin alternativa descartada, con lo que la deliberación no puede evaluarse.
- Declarar un plan de verificación sin fecha ni responsable, que es no tener plan.
...
Una decisión metodológica siempre distribuye ventajas: hay estudiantes a los que el enfoque elegido favorece y otros a los que exige más. Declarar quiénes son los segundos y qué apoyo tendrán es parte de la decisión, no un anexo.
...
1. ¿Qué alternativa descartaste y por qué razón exacta?
2. ¿Qué señal te haría revertir esta decisión, y quién la estará mirando?
3. ¿Qué condición de implementación no tienes hoy asegurada?
...
Cierra la parte 19 integrando las clases 229 a 239, y se aplica en las partes 09, 10 y 15.
...
|---|---|---|
| [← 239 · Enfoque por competencias y su coherencia](../class-11-enfoque-por-competencias-y-su-coherencia/README.md) | [Parte 19](../README.md) · [Programa](../../../README.md) | [Programa completo →](../../../README.md) |
