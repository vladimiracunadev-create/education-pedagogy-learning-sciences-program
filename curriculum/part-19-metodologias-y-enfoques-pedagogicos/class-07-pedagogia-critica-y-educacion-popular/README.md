# Clase 235 — Pedagogía crítica y educación popular

> **Parte 19 · Metodologías y enfoques pedagógicos** — clase 7 de 12
...
**Decisión que habilita:** determinar qué contenido de tu asignatura cambia cuando se pregunta a quién sirve el conocimiento que enseñas<br>
**Evidencia de aprendizaje:** el rediseño de una unidad que incorpora una pregunta crítica sin renunciar al rigor disciplinar

## 🎯 Propósito

Comprender la pedagogía crítica en sus términos, aplicar lo que aporta al diseño de enseñanza y sostener con honestidad la discusión que genera.
...
2. **Explicar** qué exige una pedagogía que se define por su posición política y no por su técnica.
3. **Decidir** —qué contenido de tu asignatura cambia cuando se pregunta a quién sirve el conocimiento que enseñas— y sostener la decisión con un fundamento escrito.
4. **Producir** la evidencia de la clase —el rediseño de una unidad que incorpora una pregunta crítica sin renunciar al rigor disciplinar— y contrastarla contra el criterio de logro.
...
|---|---|
| **Educación bancaria** | modelo criticado por Freire en que el conocimiento se deposita en el estudiante, tratado como receptáculo |
| **Diálogo problematizador** | método que parte de una situación significativa para el grupo y la convierte en objeto de análisis |
| **Currículum oculto** | conjunto de valores, jerarquías y normas que la escuela transmite sin declararlas en ningún programa |
| **Concientización** | proceso de leer críticamente la propia situación social como condición para actuar sobre ella |
...
2. Clasificar la situación distinguiendo **Educación bancaria** de **Diálogo problematizador**.
3. Decidir con fundamento, usando **Currículum oculto** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Concientización** a la vista.
...
| **Evidencia de logro** | qué muestra el rediseño de una unidad que incorpora una pregunta crítica sin renunciar al rigor disciplinar frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
El debate es real y conviene sostenerlo sin caricatura. Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Educación bancaria"]
    C --> A2["Diálogo<br/>problematizador"]
    C --> A3["Currículum oculto"]
    C --> A4["Concientización"]
    A1 & A2 & A3 & A4 --> D{{"determinar qué contenido<br/>de tu asignatura cambia<br/>cuando se pregunta a<br/>quién sirve el…"}}
    D --> E["Evidencia de aprendizaje<br/>el rediseño de una<br/>unidad que incorpora una<br/>pregunta crítica sin<br/>renunciar al rigor<br/>disciplinar"]
...
La pedagogía crítica no compite con otras metodologías en el mismo plano: no propone principalmente una técnica sino una pregunta previa —para qué y para quién se enseña— que ninguna técnica responde. Su aporte más sólido y menos discutido es el concepto de currículum oculto: la constatación de que la escuela enseña jerarquías, expectativas y formas de hablar que nadie declara y que sin embargo se aprenden con enorme eficacia. Ese hallazgo es hoy patrimonio común del campo, mucho más allá de la tradición que lo originó.

### 2. Frontera conceptual: qué es y qué no es

Los cuatro conceptos de esta clase se confunden entre sí con facilidad, y esa confusión no es
inocua: produce decisiones que atacan el problema equivocado. **Educación bancaria** no es lo
mismo que **Diálogo problematizador** —método que parte de una situación significativa para el grupo y la convierte en objeto de análisis—, y tratarlos como sinónimos hace
que la intervención se dirija al lugar incorrecto. Del mismo modo, **Currículum oculto** y
**Concientización** describen aspectos distintos de la misma situación: el primero
conjunto de valores, jerarquías y normas que la escuela transmite sin declararlas en ningún programa, mientras el segundo proceso de leer críticamente la propia situación social como condición para actuar sobre ella.
...
- **Evidencia de logro.** Qué muestra el rediseño de una unidad que incorpora una pregunta crítica sin renunciar al rigor disciplinar frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
Aplicada al diseño, esta tradición obliga a explicitar tres cosas: qué versión del contenido se está enseñando y cuál queda fuera, qué supone la clase sobre la vida de los estudiantes, y qué relación entre docente y estudiante instala el formato elegido. Se traduce en decisiones concretas: qué fuentes se leen en historia, qué problemas se usan en matemática, quién habla y cuánto en la sala. No exige renunciar al rigor: exige declarar la selección que el rigor por sí solo no decide.

### 5. Qué sostiene la evidencia y qué no

El debate es real y conviene sostenerlo sin caricatura. Sus críticos señalan que la tradición aporta poco sobre cómo se aprende un contenido específico, que su evidencia empírica sobre resultados de aprendizaje es escasa, y que en manos poco cuidadosas puede desplazar la enseñanza disciplinar por el discurso. Sus defensores responden que la neutralidad pedagógica no existe y que omitir la pregunta es también una posición. Ambas advertencias son pertinentes y el programa las sostiene juntas.
...
te deja en condiciones de qué contenido de tu asignatura cambia cuando se pregunta a quién sirve el conocimiento que enseñas, y esa decisión se sostiene solo si
...
|---|---|---|
| Freire, P. (1970). *Pedagogía del oprimido*. | la formulación original de la crítica y del diálogo problematizador, con su lenguaje propio. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
| Biesta, G. (2010). *Good Education in an Age of Measurement*. | recupera la pregunta por la finalidad sin renunciar al rigor ni caer en el eslogan. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Educación bancaria** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Educación bancaria de Diálogo problematizador.** El trabajo aquí es separar lo observado de lo interpretado sobre **Diálogo problematizador**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Currículum oculto como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Currículum oculto**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.

**Paso 4 — Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con Concientización a la vista.** Con **Concientización** ya delimitado, la pregunta pasa a ser de consecuencia: qué cambia para los estudiantes, para el tiempo de clase y para la carga del equipo. **Evidencia de partida** entrega la lectura observable; el juicio profesional sigue siendo humano y debe quedar firmado por quien lo hace.
...
|---|---|---|---|
| Intervenir sobre **Educación bancaria** | Modelo criticado por Freire en que el conocimiento se deposita en el estudiante, tratado como receptáculo | Cuando **Evidencia de partida** es observable y accionable dentro del plazo de la decisión. | Sobrerreaccionar a una señal parcial. |
| Intervenir sobre **Diálogo problematizador** | Método que parte de una situación significativa para el grupo y la convierte en objeto de análisis | Cuando la primera explicación no distingue mecanismo ni responsable. | Convertir el concepto en etiqueta y no en intervención. |
| Observar antes de decidir | Reducir la incertidumbre antes de comprometer tiempo y credibilidad | Cuando la decisión es reversible y la evidencia disponible no distingue causas. | Observar indefinidamente y no decidir nunca. |
| Derivar o escalar | Poner la decisión donde están la competencia y la responsabilidad | Cuando hay normativa, resguardo de datos, salud o vulneración de derechos en juego. | Delegar hacia arriba lo que sí correspondía decidir en el aula. |

**Frontera de aplicación.** El debate es real y conviene sostenerlo sin caricatura. Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre pedagogía crítica y educación popular |
|---|---|
...
El rediseño de una unidad que incorpora una pregunta crítica sin renunciar al rigor disciplinar.

Guárdala en `evidence/P19-C235-pedagogia-critica-y-educacion-popular/` con estos archivos:
...
Rediseña una unidad explicitando qué contenidos quedaron fuera y por qué. Presenta la selección a un colega y registra en qué no estuvieron de acuerdo.
...
- [ ] el rediseño explicita qué queda dentro y qué queda fuera del contenido, y por qué;
- [ ] la exigencia disciplinar se mantiene y es verificable en la producción del estudiante;
...
- Sustituir el contenido disciplinar por discurso y dejar al estudiante sin las herramientas que reclama para sí.
- Declarar neutralidad y no examinar qué selección de contenidos y qué expectativas transmite la propia clase.
...
La atención al currículum oculto es directamente una herramienta de inclusión: hace visible que la escuela premia formas de hablar, de vestir y de participar que no todos los estudiantes traen de casa, y que esa diferencia se califica sin declararlo.
...
1. ¿Qué versión de tu disciplina estás enseñando y cuál queda fuera del programa?
2. ¿Qué supone tu clase sobre la vida de tus estudiantes fuera de la escuela?
3. ¿Quién habla en tu sala, cuánto, y qué enseña esa distribución?
...
Se apoya en las partes 00 y 09, y dialoga con la clase 232. Prepara la 237 y la parte 22.
...
|---|---|---|
| [← 234 · Freinet, Escuela Nueva y pedagogías activas](../class-06-freinet-escuela-nueva-y-pedagogias-activas/README.md) | [Parte 19](../README.md) · [Programa](../../../README.md) | [236 · Familias del aprendizaje basado en algo →](../class-08-familias-del-aprendizaje-basado-en-algo/README.md) |
