# Clase 231 — Indagación y descubrimiento guiado

> **Parte 19 · Metodologías y enfoques pedagógicos** — clase 3 de 12

**Estado de evidencia:** `EN-DEBATE` · **Etapa:** 🟤 Etapa F — Especialización y desafíos contemporáneos · **Población de referencia:** transversal, de parvularia a educación superior<br>
**Decisión que habilita:** determinar cuánta guía necesita tu actividad de indagación y en qué momento se retira<br>
**Evidencia de aprendizaje:** una secuencia de indagación con el nivel de guía declarado en cada fase y su criterio de retirada

## 🎯 Propósito

Diseñar indagación con la guía suficiente para que produzca aprendizaje, y reconocer cuándo la apertura se vuelve abandono.
...
2. **Explicar** qué separa el descubrimiento guiado, que funciona, del descubrimiento puro, que no.
3. **Decidir** —cuánta guía necesita tu actividad de indagación y en qué momento se retira— y sostener la decisión con un fundamento escrito.
4. **Producir** la evidencia de la clase —una secuencia de indagación con el nivel de guía declarado en cada fase y su criterio de retirada— y contrastarla contra el criterio de logro.
...
|---|---|
| **Indagación guiada** | investigación estudiantil con pregunta, procedimiento o marco provistos por el docente en grados variables |
| **Descubrimiento puro** | actividad en que el estudiante debe hallar el principio sin apoyo estructurado; su evidencia es consistentemente pobre |
| **Andamiaje** | apoyo temporal calibrado que permite ejecutar lo que aún no se puede hacer solo, y que se retira de forma planificada |
| **Carga cognitiva** | demanda de recursos mentales de una tarea; cuando excede la capacidad, no queda margen para aprender |
...
2. Clasificar la situación distinguiendo **Indagación guiada** de **Descubrimiento puro**.
3. Decidir con fundamento, usando **Andamiaje** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Carga cognitiva** a la vista.
...
| **Evidencia de logro** | qué muestra una secuencia de indagación con el nivel de guía declarado en cada fase y su criterio de retirada frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
El debate sigue abierto y buena parte depende de qué se mide: Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Indagación guiada"]
    C --> A2["Descubrimiento puro"]
    C --> A3["Andamiaje"]
    C --> A4["Carga cognitiva"]
    A1 & A2 & A3 & A4 --> D{{"determinar cuánta guía<br/>necesita tu actividad de<br/>indagación y en qué<br/>momento se retira"}}
    D --> E["Evidencia de aprendizaje<br/>una secuencia de<br/>indagación con el nivel<br/>de guía declarado en<br/>cada fase y su criterio<br/>de…"]
...
Este es el debate más largo y peor entendido del campo. La evidencia es bastante clara en un punto: pedir a estudiantes con poco conocimiento previo que descubran principios sin apoyo produce menos aprendizaje que enseñárselos, y produce además la ilusión de haber trabajado mucho. Pero eso no condena a la indagación: cuando la actividad entrega pregunta, procedimiento o marco de interpretación, y cuando el docente interviene en los momentos críticos, los resultados mejoran y aparecen aprendizajes que la exposición no genera.

### 2. Frontera conceptual: qué es y qué no es

Los cuatro conceptos de esta clase se confunden entre sí con facilidad, y esa confusión no es
inocua: produce decisiones que atacan el problema equivocado. **Indagación guiada** no es lo
mismo que **Descubrimiento puro** —actividad en que el estudiante debe hallar el principio sin apoyo estructurado; su evidencia es consistentemente pobre—, y tratarlos como sinónimos hace
que la intervención se dirija al lugar incorrecto. Del mismo modo, **Andamiaje** y
**Carga cognitiva** describen aspectos distintos de la misma situación: el primero
apoyo temporal calibrado que permite ejecutar lo que aún no se puede hacer solo, y que se retira de forma planificada, mientras el segundo demanda de recursos mentales de una tarea;.
...
- **Evidencia de logro.** Qué muestra una secuencia de indagación con el nivel de guía declarado en cada fase y su criterio de retirada frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
Diseñar indagación consiste en decidir qué se entrega y qué se deja abierto en cada fase, y en anticipar el momento donde el grupo se atascará. La guía puede estar en la pregunta, en el procedimiento, en los datos, en el criterio de evaluación o en la síntesis final. La regla práctica: mientras menos conocimiento previo, más elementos se entregan, y la apertura crece a medida que el conocimiento se consolida.

### 5. Qué sostiene la evidencia y qué no

El debate sigue abierto y buena parte depende de qué se mide: la indagación tiende a rendir peor en pruebas de conocimiento inmediato y mejor en transferencia y en actitud hacia la disciplina, aunque esta última evidencia es más débil. También hay un problema de definición: bajo el mismo nombre se agrupan actividades tan distintas que comparar estudios entre sí es problemático. Y el costo de tiempo es real: la indagación cubre menos contenido por hora.
...
te deja en condiciones de cuánta guía necesita tu actividad de indagación y en qué momento se retira, y esa decisión se sostiene solo si
...
|---|---|---|
| Mayer, R. (2004). *Should There Be a Three-Strikes Rule Against Pure Discovery Learning?* | distingue con precisión qué versión del descubrimiento fracasa y cuál no. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
| Kirschner, P., Sweller, J. & Clark, R. (2006). *Why Minimal Guidance During Instruction Does Not Work*. | la crítica que obliga a defender cualquier diseño abierto con argumentos. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Indagación guiada** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Indagación guiada de Descubrimiento puro.** El trabajo aquí es separar lo observado de lo interpretado sobre **Descubrimiento puro**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Andamiaje como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Andamiaje**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.

**Paso 4 — Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con Carga cognitiva a la vista.** Con **Carga cognitiva** ya delimitado, la pregunta pasa a ser de consecuencia: qué cambia para los estudiantes, para el tiempo de clase y para la carga del equipo. **Evidencia de partida** entrega la lectura observable; el juicio profesional sigue siendo humano y debe quedar firmado por quien lo hace.
...
|---|---|---|---|
| Intervenir sobre **Indagación guiada** | Investigación estudiantil con pregunta, procedimiento o marco provistos por el docente en grados variables | Cuando **Evidencia de partida** es observable y accionable dentro del plazo de la decisión. | Sobrerreaccionar a una señal parcial. |
| Intervenir sobre **Descubrimiento puro** | Actividad en que el estudiante debe hallar el principio sin apoyo estructurado; su evidencia es consistentemente pobre | Cuando la primera explicación no distingue mecanismo ni responsable. | Convertir el concepto en etiqueta y no en intervención. |
| Observar antes de decidir | Reducir la incertidumbre antes de comprometer tiempo y credibilidad | Cuando la decisión es reversible y la evidencia disponible no distingue causas. | Observar indefinidamente y no decidir nunca. |
| Derivar o escalar | Poner la decisión donde están la competencia y la responsabilidad | Cuando hay normativa, resguardo de datos, salud o vulneración de derechos en juego. | Delegar hacia arriba lo que sí correspondía decidir en el aula. |

**Frontera de aplicación.** El debate sigue abierto y buena parte depende de qué se mide: Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre indagación y descubrimiento guiado |
|---|---|
...
Una secuencia de indagación con el nivel de guía declarado en cada fase y su criterio de retirada.

Guárdala en `evidence/P19-C231-indagacion-y-descubrimiento-guiado/` con estos archivos:
...
Toma una actividad de indagación que ya usas y reescríbela declarando el nivel de guía por fase. Aplícala y registra dónde efectivamente se atascó el grupo.
...
- [ ] la secuencia declara qué elemento se entrega y cuál queda abierto en cada fase;
- [ ] existe un punto de intervención previsto para el atasco anticipado;
...
- Entregar una pregunta abierta a estudiantes sin la base conceptual para orientarse, y llamar a eso autonomía.
- Concluir del debate que la indagación no sirve, cuando lo que no sirve es el descubrimiento sin guía.
...
La indagación sin guía amplifica las diferencias de origen: quien llega con conocimiento y con hábitos de estudio se orienta, y quien no llega con eso se pierde y concluye que el problema es suyo. El andamiaje explícito es aquí una medida de equidad, no una concesión.
...
1. ¿Qué sabe realmente tu curso antes de esta indagación, y alcanza para orientarse?
2. ¿En qué punto vas a intervenir aunque el grupo no lo pida?
3. ¿Qué aprendizaje esperas que esta actividad produzca y que una explicación no produciría?

## 📗 Fuentes y verificación

- Mayer, R. (2004). *Should There Be a Three-Strikes Rule Against Pure Discovery Learning?* **Uso en esta clase:** distingue con precisión qué versión del descubrimiento fracasa y cuál no. Lectura selectiva: índice y capítulos pertinentes; registra edición y páginas consultadas.
- Kirschner, P., Sweller, J. & Clark, R. (2006). *Why Minimal Guidance During Instruction Does Not Work*. **Uso en esta clase:** la crítica que obliga a defender cualquier diseño abierto con argumentos. Lectura selectiva: índice y capítulos pertinentes; registra edición y páginas consultadas.
...
Contrasta con la clase 230 y prepara la 236. Enlaza con las clases 065 y 127.
...
|---|---|---|
| [← 230 · Instrucción explícita y enseñanza directa](../class-02-instruccion-explicita-y-ensenanza-directa/README.md) | [Parte 19](../README.md) · [Programa](../../../README.md) | [232 · Conductismo, cognitivismo y constructivismo →](../class-04-conductismo-cognitivismo-y-constructivismo/README.md) |
