...
**Decisión que habilita:** determinar si tu actividad necesita mecánicas de juego o si el problema real es de sentido de la tarea<br>
...
flowchart TB
    ...
    C --> A1["Gamificación"]
    C --> A2["Juego serio"]
    C --> A3["Desplazamiento de la<br/>motivación"]
    C --> A4["Mecánica alineada"]
    A1 & A2 & A3 & A4 --> D{{"determinar si tu<br/>actividad necesita<br/>mecánicas de juego o si<br/>el problema real es de<br/>sentido de…"}}
    D --> E["Evidencia de aprendizaje<br/>un diseño lúdico que<br/>declara qué mecánica<br/>usa, qué aprendizaje<br/>persigue y cómo evita<br/>el…"]
