# Clase 232 — Conductismo, cognitivismo y constructivismo

> **Parte 19 · Metodologías y enfoques pedagógicos** — clase 4 de 12
...
**Decisión que habilita:** determinar qué supuesto sobre el aprendizaje está detrás de la práctica que usas todos los días<br>
**Evidencia de aprendizaje:** un análisis de tres prácticas propias que identifica el supuesto teórico de cada una y sus consecuencias

## 🎯 Propósito

Traducir las grandes tradiciones teóricas en decisiones de diseño concretas, y reconocer cuál está operando detrás de una práctica habitual.
...
2. **Explicar** cómo tres teorías del aprendizaje se convierten en tres decisiones distintas el lunes en la sala.
3. **Decidir** —qué supuesto sobre el aprendizaje está detrás de la práctica que usas todos los días— y sostener la decisión con un fundamento escrito.
4. **Producir** la evidencia de la clase —un análisis de tres prácticas propias que identifica el supuesto teórico de cada una y sus consecuencias— y contrastarla contra el criterio de logro.
...
|---|---|
| **Conductismo** | tradición que explica el aprendizaje por asociación entre conducta y consecuencia; ordena la práctica, el refuerzo y el moldeamiento |
| **Cognitivismo** | tradición centrada en el procesamiento de información: atención, memoria de trabajo y organización del conocimiento |
| **Constructivismo** | tradición según la cual el conocimiento se construye sobre estructuras previas mediante actividad del sujeto |
| **Supuesto operante** | creencia sobre cómo se aprende que está detrás de una decisión pedagógica aunque nadie la enuncie |
...
2. Clasificar la situación distinguiendo **Conductismo** de **Cognitivismo**.
3. Decidir con fundamento, usando **Constructivismo** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Supuesto operante** a la vista.
...
| **Evidencia de logro** | qué muestra un análisis de tres prácticas propias que identifica el supuesto teórico de cada una y sus consecuencias frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
Las tres tradiciones son marcos interpretativos, no teorías con capacidad predictiva fina para el aula: Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Conductismo"]
    C --> A2["Cognitivismo"]
    C --> A3["Constructivismo"]
    C --> A4["Supuesto operante"]
    A1 & A2 & A3 & A4 --> D{{"determinar qué supuesto<br/>sobre el aprendizaje<br/>está detrás de la<br/>práctica que usas todos<br/>los días"}}
    D --> E["Evidencia de aprendizaje<br/>un análisis de tres<br/>prácticas propias que<br/>identifica el supuesto<br/>teórico de cada una y<br/>sus…"]
...
Las tres tradiciones se presentan a menudo como una sucesión donde cada una supera a la anterior. Es una lectura cómoda y falsa. Cada una identificó un fenómeno real y aporta decisiones que la práctica sigue usando: el conductismo explica por qué la práctica distribuida y la retroalimentación inmediata funcionan; el cognitivismo explica los límites de la memoria de trabajo y por qué se enseña en pasos; el constructivismo explica por qué el conocimiento previo determina lo que se entiende de una explicación nueva.

### 2. Frontera conceptual: qué es y qué no es

Los cuatro conceptos de esta clase se confunden entre sí con facilidad, y esa confusión no es
inocua: produce decisiones que atacan el problema equivocado. **Conductismo** no es lo
mismo que **Cognitivismo** —tradición centrada en el procesamiento de información: atención, memoria de trabajo y organización del conocimiento—, y tratarlos como sinónimos hace
que la intervención se dirija al lugar incorrecto. Del mismo modo, **Constructivismo** y
**Supuesto operante** describen aspectos distintos de la misma situación: el primero
tradición según la cual el conocimiento se construye sobre estructuras previas mediante actividad del sujeto, mientras el segundo creencia sobre cómo se aprende que está detrás de una decisión pedagógica aunque nadie la enuncie.
...
- **Evidencia de logro.** Qué muestra un análisis de tres prácticas propias que identifica el supuesto teórico de cada una y sus consecuencias frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
El ejercicio profesional consiste en identificar el supuesto detrás de lo que ya se hace. Corregir errores de inmediato es una decisión conductista; fraccionar el contenido y controlar la carga es cognitivista; partir de las ideas previas y provocar conflicto conceptual es constructivista. Un docente competente combina los tres registros según el objetivo, y el problema aparece cuando adopta una etiqueta como identidad y descarta decisiones útiles por venir del bando equivocado.

### 5. Qué sostiene la evidencia y qué no

Las tres tradiciones son marcos interpretativos, no teorías con capacidad predictiva fina para el aula: ninguna dice cuánto tiempo dedicar ni cómo agrupar. El constructivismo, en particular, es una teoría del conocimiento que fue traducida indebidamente a una prescripción metodológica: de que el estudiante construye su comprensión no se sigue que deba hacerlo sin enseñanza. Confundir teoría del aprendizaje con teoría de la enseñanza es el error más costoso del campo.
...
te deja en condiciones de qué supuesto sobre el aprendizaje está detrás de la práctica que usas todos los días, y esa decisión se sostiene solo si
...
|---|---|---|
| Mayer, R. (2004). *Should There Be a Three-Strikes Rule Against Pure Discovery Learning?* | muestra el salto indebido de teoría constructivista a prescripción metodológica. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
| Sweller, J., van Merriënboer, J. & Paas, F. (1998). *Cognitive Architecture and Instructional Design*. | el puente explícito entre arquitectura cognitiva y decisiones de diseño. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Conductismo** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Conductismo de Cognitivismo.** El trabajo aquí es separar lo observado de lo interpretado sobre **Cognitivismo**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Constructivismo como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Constructivismo**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.

**Paso 4 — Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con Supuesto operante a la vista.** Con **Supuesto operante** ya delimitado, la pregunta pasa a ser de consecuencia: qué cambia para los estudiantes, para el tiempo de clase y para la carga del equipo. **Evidencia de partida** entrega la lectura observable; el juicio profesional sigue siendo humano y debe quedar firmado por quien lo hace.
...
|---|---|---|---|
| Intervenir sobre **Conductismo** | Tradición que explica el aprendizaje por asociación entre conducta y consecuencia; ordena la práctica, el refuerzo y el moldeamiento | Cuando **Evidencia de partida** es observable y accionable dentro del plazo de la decisión. | Sobrerreaccionar a una señal parcial. |
| Intervenir sobre **Cognitivismo** | Tradición centrada en el procesamiento de información: atención, memoria de trabajo y organización del conocimiento | Cuando la primera explicación no distingue mecanismo ni responsable. | Convertir el concepto en etiqueta y no en intervención. |
| Observar antes de decidir | Reducir la incertidumbre antes de comprometer tiempo y credibilidad | Cuando la decisión es reversible y la evidencia disponible no distingue causas. | Observar indefinidamente y no decidir nunca. |
| Derivar o escalar | Poner la decisión donde están la competencia y la responsabilidad | Cuando hay normativa, resguardo de datos, salud o vulneración de derechos en juego. | Delegar hacia arriba lo que sí correspondía decidir en el aula. |

**Frontera de aplicación.** Las tres tradiciones son marcos interpretativos, no teorías con capacidad predictiva fina para el aula: Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre conductismo, cognitivismo y constructivismo |
|---|---|
...
Un análisis de tres prácticas propias que identifica el supuesto teórico de cada una y sus consecuencias.

Guárdala en `evidence/P19-C232-conductismo-cognitivismo-y-constructivismo/` con estos archivos:
...
Registra tres decisiones que tomaste esta semana en clase. Identifica el supuesto teórico de cada una y evalúa si ese supuesto se sostiene con tus estudiantes.
...
- [ ] el análisis identifica el supuesto operante de cada práctica con su consecuencia observable;
- [ ] se declara al menos un caso donde el supuesto propio produce una decisión discutible;
...
- Deducir un método de una teoría del aprendizaje como si la relación fuera lógica y directa.
- Descartar una práctica útil por asociarla a una tradición desprestigiada en el discurso profesional.
...
Los supuestos implícitos tienen consecuencias distributivas: quien cree que el aprendizaje ocurre por descubrimiento espontáneo tiende a atribuir el fracaso a la falta de curiosidad del estudiante, y no a la ausencia de enseñanza. Explicitar el supuesto es el primer paso para hacerse cargo.
...
1. ¿Qué supuesto sobre el aprendizaje hay detrás de tu forma de corregir?
2. ¿Qué práctica útil estás descartando por venir de una tradición que te resulta ajena?
3. ¿Dónde estás deduciendo un método de una teoría sin evidencia intermedia?
...
Da el fundamento teórico a las clases 230 y 231. Se apoya en la parte 01 y prepara la 233.
...
|---|---|---|
| [← 231 · Indagación y descubrimiento guiado](../class-03-indagacion-y-descubrimiento-guiado/README.md) | [Parte 19](../README.md) · [Programa](../../../README.md) | [233 · Montessori, Waldorf y Reggio Emilia →](../class-05-montessori-waldorf-y-reggio-emilia/README.md) |
