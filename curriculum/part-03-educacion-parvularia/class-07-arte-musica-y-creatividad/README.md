...
**Estado de evidencia:** `EMERGENTE` · **Etapa:** 🔵 Etapa B — Enseñanza por ciclo vital · **Población de referencia:** sala cuna, niveles medios y transición (0 a 6 años)<br>
**Decisión que habilita:** determinar si una actividad artística persigue la expresión del niño o la producción de un objeto para el adulto<br>
...
2. Clasificar la situación distinguiendo **Lenguaje expresivo** de **Proceso y producto**.
3. Decidir con fundamento, usando **Exploración sonora** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Decisión estética** a la vista.
...
| **Evidencia de logro** | qué muestra el rediseño de una actividad artística típica que devuelva al niño las decisiones estéticas y su justificación frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
La investigación sobre efectos del arte en otros aprendizajes es débil y con frecuencia sobreinterpretada: Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Lenguaje expresivo"]
    C --> A2["Proceso y producto"]
    C --> A3["Exploración sonora"]
    C --> A4["Decisión estética"]
    A1 & A2 & A3 & A4 --> D{{"determinar si una<br/>actividad artística<br/>persigue la expresión<br/>del niño o la producción<br/>de un…"}}
    D --> E["Evidencia de aprendizaje<br/>el rediseño de una<br/>actividad artística<br/>típica que devuelva al<br/>niño las decisiones<br/>estéticas y…"]
...
inocua: produce decisiones que atacan el problema equivocado. **Lenguaje expresivo** no es lo
mismo que **Proceso y producto** —distinción entre el valor de la experiencia creadora y el objeto resultante—, y tratarlos como sinónimos hace
que la intervención se dirija al lugar incorrecto. Del mismo modo, **Exploración sonora** y
**Decisión estética** describen aspectos distintos de la misma situación: el primero
investigación de sonido, ritmo y silencio como material propio de aprendizaje, mientras el segundo elección del niño sobre forma, color, material o secuencia;.
...
- **Evidencia de logro.** Qué muestra el rediseño de una actividad artística típica que devuelva al niño las decisiones estéticas y su justificación frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
te deja en condiciones de si una actividad artística persigue la expresión del niño o la producción de un objeto para el adulto, y esa decisión se sostiene solo si
...
|---|---|---|
| Eisner, E. (2002). *The Arts and the Creation of Mind*. | argumenta el valor cognitivo propio de las artes sin apelar a efectos de transferencia. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
| Winner, E., Goldstein, T. & Vincent-Lancrin, S. (2013). *Art for Art's Sake? Overview*. OCDE. | revisa la evidencia sobre transferencia del arte a otros aprendizajes y desmonta las promesas infundadas. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Lenguaje expresivo** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Lenguaje expresivo de Proceso y producto.** El trabajo aquí es separar lo observado de lo interpretado sobre **Proceso y producto**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Exploración sonora como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Exploración sonora**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.

**Paso 4 — Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con Decisión estética a la vista.** Con **Decisión estética** ya delimitado, la pregunta pasa a ser de consecuencia: qué cambia para los estudiantes, para el tiempo de clase y para la carga del equipo. **Evidencia de partida** entrega la lectura observable; el juicio profesional sigue siendo humano y debe quedar firmado por quien lo hace.
...
|---|---|---|---|
| Intervenir sobre **Lenguaje expresivo** | Modo de representar y comunicar experiencia mediante el arte, la música o el movimiento | Cuando **Evidencia de partida** es observable y accionable dentro del plazo de la decisión. | Sobrerreaccionar a una señal parcial. |
| Intervenir sobre **Proceso y producto** | Distinción entre el valor de la experiencia creadora y el objeto resultante | Cuando la primera explicación no distingue mecanismo ni responsable. | Convertir el concepto en etiqueta y no en intervención. |
| Observar antes de decidir | Reducir la incertidumbre antes de comprometer tiempo y credibilidad | Cuando la decisión es reversible y la evidencia disponible no distingue causas. | Observar indefinidamente y no decidir nunca. |
| Derivar o escalar | Poner la decisión donde están la competencia y la responsabilidad | Cuando hay normativa, resguardo de datos, salud o vulneración de derechos en juego. | Delegar hacia arriba lo que sí correspondía decidir en el aula. |

**Frontera de aplicación.** La investigación sobre efectos del arte en otros aprendizajes es débil y con frecuencia sobreinterpretada: Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre arte, música y creatividad |
|---|---|
...
Guárdala en `evidence/P03-C043-arte-musica-y-creatividad/` con estos archivos:
...
Riesgo característico de esta parte: **Escolarizar el nivel adelantando formatos de enseñanza propios de la básica.** Antes de aplicar
...
- Eisner, E. (2002). *The Arts and the Creation of Mind*. **Uso en esta clase:** argumenta el valor cognitivo propio de las artes sin apelar a efectos de transferencia. Lectura selectiva: índice y capítulos pertinentes; registra edición y páginas consultadas.
- Winner, E., Goldstein, T. & Vincent-Lancrin, S. (2013). *Art for Art's Sake? Overview*. OCDE. **Uso en esta clase:** revisa la evidencia sobre transferencia del arte a otros aprendizajes y desmonta las promesas infundadas. Lectura selectiva: índice y capítulos pertinentes; registra edición y páginas consultadas.
