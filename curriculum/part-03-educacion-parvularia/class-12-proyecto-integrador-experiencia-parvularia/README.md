...
**Decisión que habilita:** determinar el conjunto completo de decisiones de una experiencia y justificar cada una con los principios del nivel<br>
...
2. Clasificar la situación distinguiendo **Experiencia de aprendizaje** de **Coherencia interna**.
3. Decidir con fundamento, usando **Mediación planificada** como criterio y declarando la fuente.
...
| **Evidencia de logro** | qué muestra una experiencia parvularia completa —planificación, ambiente, mediación, documentación y análisis posterior— frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
Una experiencia bien diseñada no garantiza aprendizaje en todos los niños, y su evidencia es limitada: Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Experiencia de<br/>aprendizaje"]
    C --> A2["Coherencia interna"]
    C --> A3["Mediación planificada"]
    C --> A4["Análisis posterior"]
    A1 & A2 & A3 & A4 --> D{{"determinar el conjunto<br/>completo de decisiones<br/>de una experiencia y<br/>justificar cada una con<br/>los…"}}
    D --> E["Evidencia de aprendizaje<br/>una experiencia<br/>parvularia completa<br/>—planificación,<br/>ambiente, mediación,<br/>documentación y…"]
...
- **Evidencia de logro.** Qué muestra una experiencia parvularia completa —planificación, ambiente, mediación, documentación y análisis posterior— frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
te deja en condiciones de el conjunto completo de decisiones de una experiencia y justificar cada una con los principios del nivel, y esa decisión se sostiene solo si
...
|---|---|---|
| Mineduc (2018). *Bases Curriculares de la Educación Parvularia*. | referencia obligatoria para objetivos y coherencia curricular del nivel. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
| Rinaldi, C. (2006). *In Dialogue with Reggio Emilia*. | modelo de cómo documentar y analizar una experiencia para aprender de ella como equipo. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Experiencia de aprendizaje** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Experiencia de aprendizaje de Coherencia interna.** El trabajo aquí es separar lo observado de lo interpretado sobre **Coherencia interna**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Mediación planificada como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Mediación planificada**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.
...
**Frontera de aplicación.** Una experiencia bien diseñada no garantiza aprendizaje en todos los niños, y su evidencia es limitada: Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre proyecto integrador: experiencia parvularia |
|---|---|
...
Guárdala en `evidence/P03-C048-proyecto-integrador-experiencia-parvularia/` con estos archivos:
