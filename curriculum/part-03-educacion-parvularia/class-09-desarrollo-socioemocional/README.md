...
**Estado de evidencia:** `CONSISTENTE` · **Etapa:** 🔵 Etapa B — Enseñanza por ciclo vital · **Población de referencia:** sala cuna, niveles medios y transición (0 a 6 años)<br>
**Decisión que habilita:** determinar cómo intervenir en un conflicto entre niños de modo que ambos aprendan algo<br>
...
2. Clasificar la situación distinguiendo **Identificación emocional** de **Corregulación**.
3. Decidir con fundamento, usando **Mediación de conflictos** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Participación en el grupo** a la vista.
...
| **Evidencia de logro** | qué muestra un protocolo propio de mediación de conflictos entre niños pequeños, con el guion del adulto paso a paso frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
La corregulación exige disponibilidad adulta, y esa disponibilidad depende de la proporción adulto-niño: Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Identificación<br/>emocional"]
    C --> A2["Corregulación"]
    C --> A3["Mediación de<br/>conflictos"]
    C --> A4["Participación en el<br/>grupo"]
    A1 & A2 & A3 & A4 --> D{{"determinar cómo<br/>intervenir en un<br/>conflicto entre niños de<br/>modo que ambos aprendan<br/>algo"}}
    D --> E["Evidencia de aprendizaje<br/>un protocolo propio de<br/>mediación de conflictos<br/>entre niños pequeños,<br/>con el guion del adulto…"]
...
inocua: produce decisiones que atacan el problema equivocado. **Identificación emocional** no es lo
mismo que **Corregulación** —apoyo del adulto que presta calma y lenguaje mientras el niño no puede regularse solo—, y tratarlos como sinónimos hace
que la intervención se dirija al lugar incorrecto. Del mismo modo, **Mediación de conflictos** y
**Participación en el grupo** describen aspectos distintos de la misma situación: el primero
intervención que sostiene a ambos niños y convierte el conflicto en aprendizaje social, mientras el segundo habilidades para entrar en el juego, sostener el turno y reparar tras un desacuerdo.
...
- **Evidencia de logro.** Qué muestra un protocolo propio de mediación de conflictos entre niños pequeños, con el guion del adulto paso a paso frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
te deja en condiciones de cómo intervenir en un conflicto entre niños de modo que ambos aprendan algo, y esa decisión se sostiene solo si
...
|---|---|---|
| Denham, S. (1998). *Emotional Development in Young Children*. | describe la secuencia del desarrollo emocional y sus implicancias para la intervención adulta. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
| Gloeckler, L. & Cassell, J. (2012). *Teacher Practices with Toddlers during Social Problem Solving Opportunities*. | documenta qué hacen efectivamente los adultos ante conflictos y qué prácticas enseñan más. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Identificación emocional** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Identificación emocional de Corregulación.** El trabajo aquí es separar lo observado de lo interpretado sobre **Corregulación**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Mediación de conflictos como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Mediación de conflictos**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.

**Paso 4 — Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con Participación en el grupo a la vista.** Con **Participación en el grupo** ya delimitado, la pregunta pasa a ser de consecuencia: qué cambia para los estudiantes, para el tiempo de clase y para la carga del equipo. **Evidencia de partida** entrega la lectura observable; el juicio profesional sigue siendo humano y debe quedar firmado por quien lo hace.
...
|---|---|---|---|
| Intervenir sobre **Identificación emocional** | Capacidad de reconocer y nombrar la propia emoción y la de otro | Cuando **Evidencia de partida** es observable y accionable dentro del plazo de la decisión. | Sobrerreaccionar a una señal parcial. |
| Intervenir sobre **Corregulación** | Apoyo del adulto que presta calma y lenguaje mientras el niño no puede regularse solo | Cuando la primera explicación no distingue mecanismo ni responsable. | Convertir el concepto en etiqueta y no en intervención. |
| Observar antes de decidir | Reducir la incertidumbre antes de comprometer tiempo y credibilidad | Cuando la decisión es reversible y la evidencia disponible no distingue causas. | Observar indefinidamente y no decidir nunca. |
| Derivar o escalar | Poner la decisión donde están la competencia y la responsabilidad | Cuando hay normativa, resguardo de datos, salud o vulneración de derechos en juego. | Delegar hacia arriba lo que sí correspondía decidir en el aula. |

**Frontera de aplicación.** La corregulación exige disponibilidad adulta, y esa disponibilidad depende de la proporción adulto-niño: Fuera de esa frontera, la comparación
...
Guárdala en `evidence/P03-C045-desarrollo-socioemocional/` con estos archivos:
