...
**Estado de evidencia:** `PRACTICA-PROFESIONAL` · **Etapa:** 🔵 Etapa B — Enseñanza por ciclo vital · **Población de referencia:** sala cuna, niveles medios y transición (0 a 6 años)<br>
**Decisión que habilita:** determinar qué evidencia vas a recoger, con qué frecuencia y qué decisión tomarás con ella<br>
...
2. Clasificar la situación distinguiendo **Observación sistemática** de **Documentación pedagógica**.
3. Decidir con fundamento, usando **Registro anecdótico** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Interpretación en equipo** a la vista.
...
| **Evidencia de logro** | qué muestra un sistema de documentación pedagógica con instrumentos, periodicidad y un ejemplo completo de interpretación y decisión frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
La observación es vulnerable al sesgo: Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Observación<br/>sistemática"]
    C --> A2["Documentación<br/>pedagógica"]
    C --> A3["Registro anecdótico"]
    C --> A4["Interpretación en<br/>equipo"]
    A1 & A2 & A3 & A4 --> D{{"determinar qué evidencia<br/>vas a recoger, con qué<br/>frecuencia y qué<br/>decisión tomarás con<br/>ella"}}
    D --> E["Evidencia de aprendizaje<br/>un sistema de<br/>documentación pedagógica<br/>con instrumentos,<br/>periodicidad y un<br/>ejemplo completo de…"]
...
inocua: produce decisiones que atacan el problema equivocado. **Observación sistemática** no es lo
...
- **Evidencia de logro.** Qué muestra un sistema de documentación pedagógica con instrumentos, periodicidad y un ejemplo completo de interpretación y decisión frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
te deja en condiciones de qué evidencia vas a recoger, con qué frecuencia y qué decisión tomarás con ella, y esa decisión se sostiene solo si
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Observación sistemática** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Observación sistemática de Documentación pedagógica.** El trabajo aquí es separar lo observado de lo interpretado sobre **Documentación pedagógica**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Registro anecdótico como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Registro anecdótico**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.

**Paso 4 — Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con Interpretación en equipo a la vista.** Con **Interpretación en equipo** ya delimitado, la pregunta pasa a ser de consecuencia: qué cambia para los estudiantes, para el tiempo de clase y para la carga del equipo. **Evidencia de partida** entrega la lectura observable; el juicio profesional sigue siendo humano y debe quedar firmado por quien lo hace.
...
|---|---|---|---|
| Intervenir sobre **Observación sistemática** | Registro planificado de conductas específicas, con foco y criterio definidos de antemano | Cuando **Evidencia de partida** es observable y accionable dentro del plazo de la decisión. | Sobrerreaccionar a una señal parcial. |
| Intervenir sobre **Documentación pedagógica** | Conjunto de registros que hace visible el aprendizaje y permite interpretarlo en equipo | Cuando la primera explicación no distingue mecanismo ni responsable. | Convertir el concepto en etiqueta y no en intervención. |
| Observar antes de decidir | Reducir la incertidumbre antes de comprometer tiempo y credibilidad | Cuando la decisión es reversible y la evidencia disponible no distingue causas. | Observar indefinidamente y no decidir nunca. |
| Derivar o escalar | Poner la decisión donde están la competencia y la responsabilidad | Cuando hay normativa, resguardo de datos, salud o vulneración de derechos en juego. | Delegar hacia arriba lo que sí correspondía decidir en el aula. |

**Frontera de aplicación.** La observación es vulnerable al sesgo: Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre observación y documentación pedagógica |
|---|---|
...
Guárdala en `evidence/P03-C046-observacion-y-documentacion-pedagogica/` con estos archivos:
