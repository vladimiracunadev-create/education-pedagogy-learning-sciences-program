...
**Estado de evidencia:** `MARCO-NORMATIVO` · **Etapa:** 🔵 Etapa B — Enseñanza por ciclo vital · **Población de referencia:** sala cuna, niveles medios y transición (0 a 6 años)<br>
**Decisión que habilita:** determinar si una práctica propuesta para el nivel respeta sus principios o lo escolariza<br>
...
2. Clasificar la situación distinguiendo **Principio pedagógico** de **Bienestar integral**.
3. Decidir con fundamento, usando **Protagonismo del niño** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Intencionalidad pedagógica** a la vista.
...
| **Evidencia de logro** | qué muestra una evaluación de tres prácticas de un jardín contrastadas con los principios del nivel, con veredicto y fundamento frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
Los principios se declaran con facilidad y se aplican con dificultad. Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Principio pedagógico"]
    C --> A2["Bienestar integral"]
    C --> A3["Protagonismo del niño"]
    C --> A4["Intencionalidad<br/>pedagógica"]
    A1 & A2 & A3 & A4 --> D{{"determinar si una<br/>práctica propuesta para<br/>el nivel respeta sus<br/>principios o lo<br/>escolariza"}}
    D --> E["Evidencia de aprendizaje<br/>una evaluación de tres<br/>prácticas de un jardín<br/>contrastadas con los<br/>principios del nivel,<br/>con…"]
...
inocua: produce decisiones que atacan el problema equivocado. **Principio pedagógico** no es lo
mismo que **Bienestar integral** —condición de seguridad, salud y afecto sin la cual el aprendizaje del nivel no ocurre—, y tratarlos como sinónimos hace
que la intervención se dirija al lugar incorrecto. Del mismo modo, **Protagonismo del niño** y
**Intencionalidad pedagógica** describen aspectos distintos de la misma situación: el primero
reconocimiento del niño como sujeto activo que inicia, decide y construye su experiencia, mientras el segundo propósito de aprendizaje explícito detrás de una experiencia que puede parecer libre.
...
- **Evidencia de logro.** Qué muestra una evaluación de tres prácticas de un jardín contrastadas con los principios del nivel, con veredicto y fundamento frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
te deja en condiciones de si una práctica propuesta para el nivel respeta sus principios o lo escolariza, y esa decisión se sostiene solo si
...
|---|---|---|
| Mineduc (2018). *Bases Curriculares de la Educación Parvularia*. | marco vigente: principios, ámbitos, núcleos y objetivos de aprendizaje del nivel en Chile. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
| Copple, C. & Bredekamp, S. (eds.) (2009). *Developmentally Appropriate Practice*. NAEYC. | argumenta con evidencia por qué la escolarización temprana no mejora resultados y qué sí lo hace. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Principio pedagógico** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Principio pedagógico de Bienestar integral.** El trabajo aquí es separar lo observado de lo interpretado sobre **Bienestar integral**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Protagonismo del niño como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Protagonismo del niño**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.

**Paso 4 — Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con Intencionalidad pedagógica a la vista.** Con **Intencionalidad pedagógica** ya delimitado, la pregunta pasa a ser de consecuencia: qué cambia para los estudiantes, para el tiempo de clase y para la carga del equipo. **Evidencia de partida** entrega la lectura observable; el juicio profesional sigue siendo humano y debe quedar firmado por quien lo hace.
...
|---|---|---|---|
| Intervenir sobre **Principio pedagógico** | Criterio rector que orienta toda decisión del nivel y permite juzgar una práctica concreta | Cuando **Evidencia de partida** es observable y accionable dentro del plazo de la decisión. | Sobrerreaccionar a una señal parcial. |
| Intervenir sobre **Bienestar integral** | Condición de seguridad, salud y afecto sin la cual el aprendizaje del nivel no ocurre | Cuando la primera explicación no distingue mecanismo ni responsable. | Convertir el concepto en etiqueta y no en intervención. |
| Observar antes de decidir | Reducir la incertidumbre antes de comprometer tiempo y credibilidad | Cuando la decisión es reversible y la evidencia disponible no distingue causas. | Observar indefinidamente y no decidir nunca. |
| Derivar o escalar | Poner la decisión donde están la competencia y la responsabilidad | Cuando hay normativa, resguardo de datos, salud o vulneración de derechos en juego. | Delegar hacia arriba lo que sí correspondía decidir en el aula. |

**Frontera de aplicación.** Los principios se declaran con facilidad y se aplican con dificultad. Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre principios de educación parvularia |
|---|---|
...
Guárdala en `evidence/P03-C037-principios-de-educacion-parvularia/` con estos archivos:
