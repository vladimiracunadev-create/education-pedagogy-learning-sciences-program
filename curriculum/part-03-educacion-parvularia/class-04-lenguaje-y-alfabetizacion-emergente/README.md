...
**Estado de evidencia:** `ROBUSTA` · **Etapa:** 🔵 Etapa B — Enseñanza por ciclo vital · **Población de referencia:** sala cuna, niveles medios y transición (0 a 6 años)<br>
**Decisión que habilita:** determinar qué precursor de la lectura vas a trabajar de forma sistemática y con qué evidencia lo verificarás<br>
...
2. Clasificar la situación distinguiendo **Alfabetización emergente** de **Conciencia fonológica**.
3. Decidir con fundamento, usando **Conocimiento del alfabeto** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Funcionalidad del texto** a la vista.
...
| **Evidencia de logro** | qué muestra una secuencia de alfabetización emergente con actividades, progresión y evidencia de aprendizaje observable frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
Hay un límite claro: Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Alfabetización<br/>emergente"]
    C --> A2["Conciencia fonológica"]
    C --> A3["Conocimiento del<br/>alfabeto"]
    C --> A4["Funcionalidad del<br/>texto"]
    A1 & A2 & A3 & A4 --> D{{"determinar qué precursor<br/>de la lectura vas a<br/>trabajar de forma<br/>sistemática y con qué<br/>evidencia…"}}
    D --> E["Evidencia de aprendizaje<br/>una secuencia de<br/>alfabetización emergente<br/>con actividades,<br/>progresión y evidencia<br/>de…"]
...
inocua: produce decisiones que atacan el problema equivocado. **Alfabetización emergente** no es lo
mismo que **Conciencia fonológica** —capacidad de identificar y manipular unidades sonoras del habla; predice el aprendizaje lector—, y tratarlos como sinónimos hace
que la intervención se dirija al lugar incorrecto. Del mismo modo, **Conocimiento del alfabeto** y
**Funcionalidad del texto** describen aspectos distintos de la misma situación: el primero
identificación de letras y de sus sonidos;, mientras el segundo comprensión de para qué sirve lo escrito y cómo se usa en la vida cotidiana.
...
- **Evidencia de logro.** Qué muestra una secuencia de alfabetización emergente con actividades, progresión y evidencia de aprendizaje observable frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
te deja en condiciones de qué precursor de la lectura vas a trabajar de forma sistemática y con qué evidencia lo verificarás, y esa decisión se sostiene solo si
...
|---|---|---|
| National Early Literacy Panel (2008). *Developing Early Literacy*. | identifica y jerarquiza los predictores tempranos de la lectura con síntesis cuantitativa. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
| Castles, A., Rastle, K. & Nation, K. (2018). *Ending the Reading Wars*. | conecta los precursores con la enseñanza posterior y aclara qué está resuelto en el debate. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Alfabetización emergente** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Alfabetización emergente de Conciencia fonológica.** El trabajo aquí es separar lo observado de lo interpretado sobre **Conciencia fonológica**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Conocimiento del alfabeto como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Conocimiento del alfabeto**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.

**Paso 4 — Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con Funcionalidad del texto a la vista.** Con **Funcionalidad del texto** ya delimitado, la pregunta pasa a ser de consecuencia: qué cambia para los estudiantes, para el tiempo de clase y para la carga del equipo. **Evidencia de partida** entrega la lectura observable; el juicio profesional sigue siendo humano y debe quedar firmado por quien lo hace.
...
|---|---|---|---|
| Intervenir sobre **Alfabetización emergente** | Conjunto de conocimientos sobre el lenguaje escrito que se construyen antes de leer convencionalmente | Cuando **Evidencia de partida** es observable y accionable dentro del plazo de la decisión. | Sobrerreaccionar a una señal parcial. |
| Intervenir sobre **Conciencia fonológica** | Capacidad de identificar y manipular unidades sonoras del habla; predice el aprendizaje lector | Cuando la primera explicación no distingue mecanismo ni responsable. | Convertir el concepto en etiqueta y no en intervención. |
| Observar antes de decidir | Reducir la incertidumbre antes de comprometer tiempo y credibilidad | Cuando la decisión es reversible y la evidencia disponible no distingue causas. | Observar indefinidamente y no decidir nunca. |
| Derivar o escalar | Poner la decisión donde están la competencia y la responsabilidad | Cuando hay normativa, resguardo de datos, salud o vulneración de derechos en juego. | Delegar hacia arriba lo que sí correspondía decidir en el aula. |

**Frontera de aplicación.** Hay un límite claro: Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre lenguaje y alfabetización emergente |
|---|---|
...
Guárdala en `evidence/P03-C040-lenguaje-y-alfabetizacion-emergente/` con estos archivos:
