...
**Decisión que habilita:** determinar qué participación familiar vas a promover y cómo comprobarás que mejoró algo<br>
...
2. Clasificar la situación distinguiendo **Alianza educativa** de **Participación con foco en el aprendizaje**.
3. Decidir con fundamento, usando **Comunicación bidireccional** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Prácticas del hogar** a la vista.
...
| **Evidencia de logro** | qué muestra un plan de trabajo con familias con acciones, responsables, periodicidad e indicador de efecto frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
Las condiciones familiares limitan lo que es posible: Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Alianza educativa"]
    C --> A2["Participación con foco<br/>en el aprendizaje"]
    C --> A3["Comunicación<br/>bidireccional"]
    C --> A4["Prácticas del hogar"]
    A1 & A2 & A3 & A4 --> D{{"determinar qué<br/>participación familiar<br/>vas a promover y cómo<br/>comprobarás que mejoró<br/>algo"}}
    D --> E["Evidencia de aprendizaje<br/>un plan de trabajo con<br/>familias con acciones,<br/>responsables,<br/>periodicidad e indicador<br/>de efecto"]
...
inocua: produce decisiones que atacan el problema equivocado. **Alianza educativa** no es lo
mismo que **Participación con foco en el aprendizaje** —involucramiento centrado en lo que el niño aprende, no solo en tareas logísticas—, y tratarlos como sinónimos hace
que la intervención se dirija al lugar incorrecto. Del mismo modo, **Comunicación bidireccional** y
**Prácticas del hogar** describen aspectos distintos de la misma situación: el primero
intercambio en que la familia también aporta información que modifica la práctica, mientras el segundo rutinas familiares de lectura, conversación y juego que sostienen el aprendizaje.
...
- **Evidencia de logro.** Qué muestra un plan de trabajo con familias con acciones, responsables, periodicidad e indicador de efecto frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
te deja en condiciones de qué participación familiar vas a promover y cómo comprobarás que mejoró algo, y esa decisión se sostiene solo si
...
|---|---|---|
| Desforges, C. & Abouchaar, A. (2003). *The Impact of Parental Involvement, Parental Support and Family Education on Pupil Achievement*. | distingue con evidencia qué formas de participación se asocian con aprendizaje y cuáles no. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
| Epstein, J. (2011). *School, Family, and Community Partnerships*. | marco operativo de tipos de participación; útil para diseñar y auditar un plan. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Alianza educativa** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Alianza educativa de Participación con foco en el aprendizaje.** El trabajo aquí es separar lo observado de lo interpretado sobre **Participación con foco en el aprendizaje**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Comunicación bidireccional como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Comunicación bidireccional**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.

**Paso 4 — Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con Prácticas del hogar a la vista.** Con **Prácticas del hogar** ya delimitado, la pregunta pasa a ser de consecuencia: qué cambia para los estudiantes, para el tiempo de clase y para la carga del equipo. **Evidencia de partida** entrega la lectura observable; el juicio profesional sigue siendo humano y debe quedar firmado por quien lo hace.
...
|---|---|---|---|
| Intervenir sobre **Alianza educativa** | Relación de colaboración con propósitos compartidos entre el equipo y las familias | Cuando **Evidencia de partida** es observable y accionable dentro del plazo de la decisión. | Sobrerreaccionar a una señal parcial. |
| Intervenir sobre **Participación con foco en el aprendizaje** | Involucramiento centrado en lo que el niño aprende, no solo en tareas logísticas | Cuando la primera explicación no distingue mecanismo ni responsable. | Convertir el concepto en etiqueta y no en intervención. |
| Observar antes de decidir | Reducir la incertidumbre antes de comprometer tiempo y credibilidad | Cuando la decisión es reversible y la evidencia disponible no distingue causas. | Observar indefinidamente y no decidir nunca. |
| Derivar o escalar | Poner la decisión donde están la competencia y la responsabilidad | Cuando hay normativa, resguardo de datos, salud o vulneración de derechos en juego. | Delegar hacia arriba lo que sí correspondía decidir en el aula. |

**Frontera de aplicación.** Las condiciones familiares limitan lo que es posible: Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre familia y comunidad |
|---|---|
...
Guárdala en `evidence/P03-C047-familia-y-comunidad/` con estos archivos:
