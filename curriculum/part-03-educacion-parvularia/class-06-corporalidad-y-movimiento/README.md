...
**Decisión que habilita:** determinar qué objetivos corporales específicos vas a trabajar y cómo distinguirás avance de simple actividad física<br>
...
2. Clasificar la situación distinguiendo **Conciencia corporal** de **Coordinación**.
3. Decidir con fundamento, usando **Orientación espacial** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Regulación por el movimiento** a la vista.
...
| **Evidencia de logro** | qué muestra una planificación de experiencias corporales con objetivos, progresión y evidencia observable de logro frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
Conviene distinguir lo respaldado de lo prometido: Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Conciencia corporal"]
    C --> A2["Coordinación"]
    C --> A3["Orientación espacial"]
    C --> A4["Regulación por el<br/>movimiento"]
    A1 & A2 & A3 & A4 --> D{{"determinar qué objetivos<br/>corporales específicos<br/>vas a trabajar y cómo<br/>distinguirás avance de…"}}
    D --> E["Evidencia de aprendizaje<br/>una planificación de<br/>experiencias corporales<br/>con objetivos,<br/>progresión y evidencia<br/>observable…"]
...
inocua: produce decisiones que atacan el problema equivocado. **Conciencia corporal** no es lo
mismo que **Coordinación** —organización del movimiento en función de una intención; se desarrolla con práctica variada—, y tratarlos como sinónimos hace
que la intervención se dirija al lugar incorrecto. Del mismo modo, **Orientación espacial** y
**Regulación por el movimiento** describen aspectos distintos de la misma situación: el primero
comprensión de la posición y el desplazamiento propio y de los objetos en el espacio, mientras el segundo uso de la actividad física y de la calma corporal para modular el estado de activación.
...
- **Evidencia de logro.** Qué muestra una planificación de experiencias corporales con objetivos, progresión y evidencia observable de logro frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
te deja en condiciones de qué objetivos corporales específicos vas a trabajar y cómo distinguirás avance de simple actividad física, y esa decisión se sostiene solo si
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Conciencia corporal** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Conciencia corporal de Coordinación.** El trabajo aquí es separar lo observado de lo interpretado sobre **Coordinación**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Orientación espacial como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Orientación espacial**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.

**Paso 4 — Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con Regulación por el movimiento a la vista.** Con **Regulación por el movimiento** ya delimitado, la pregunta pasa a ser de consecuencia: qué cambia para los estudiantes, para el tiempo de clase y para la carga del equipo. **Evidencia de partida** entrega la lectura observable; el juicio profesional sigue siendo humano y debe quedar firmado por quien lo hace.
...
|---|---|---|---|
| Intervenir sobre **Conciencia corporal** | Reconocimiento del propio cuerpo, sus partes, sus límites y sus posibilidades de acción | Cuando **Evidencia de partida** es observable y accionable dentro del plazo de la decisión. | Sobrerreaccionar a una señal parcial. |
| Intervenir sobre **Coordinación** | Organización del movimiento en función de una intención; se desarrolla con práctica variada | Cuando la primera explicación no distingue mecanismo ni responsable. | Convertir el concepto en etiqueta y no en intervención. |
| Observar antes de decidir | Reducir la incertidumbre antes de comprometer tiempo y credibilidad | Cuando la decisión es reversible y la evidencia disponible no distingue causas. | Observar indefinidamente y no decidir nunca. |
| Derivar o escalar | Poner la decisión donde están la competencia y la responsabilidad | Cuando hay normativa, resguardo de datos, salud o vulneración de derechos en juego. | Delegar hacia arriba lo que sí correspondía decidir en el aula. |

**Frontera de aplicación.** Conviene distinguir lo respaldado de lo prometido: Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre corporalidad y movimiento |
|---|---|
...
Guárdala en `evidence/P03-C042-corporalidad-y-movimiento/` con estos archivos:
