...
**Decisión que habilita:** determinar qué modificación del ambiente hará posible el aprendizaje que hoy no aparece<br>
...
2. Clasificar la situación distinguiendo **Ambiente de aprendizaje** de **Zona o rincón**.
3. Decidir con fundamento, usando **Material abierto** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Ritmo de la jornada** a la vista.
...
| **Evidencia de logro** | qué muestra un rediseño de ambiente con la conducta esperada por cada zona y la evidencia observada antes y después frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
No hay una configuración óptima universal: Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Ambiente de<br/>aprendizaje"]
    C --> A2["Zona o rincón"]
    C --> A3["Material abierto"]
    C --> A4["Ritmo de la jornada"]
    A1 & A2 & A3 & A4 --> D{{"determinar qué<br/>modificación del<br/>ambiente hará posible el<br/>aprendizaje que hoy no<br/>aparece"}}
    D --> E["Evidencia de aprendizaje<br/>un rediseño de ambiente<br/>con la conducta esperada<br/>por cada zona y la<br/>evidencia observada<br/>antes y…"]
...
inocua: produce decisiones que atacan el problema equivocado. **Ambiente de aprendizaje** no es lo
mismo que **Zona o rincón** —sector organizado con intención pedagógica, materiales seleccionados y conducta esperada—, y tratarlos como sinónimos hace
que la intervención se dirija al lugar incorrecto. Del mismo modo, **Material abierto** y
**Ritmo de la jornada** describen aspectos distintos de la misma situación: el primero
recurso sin uso único que admite múltiples acciones y niveles de complejidad, mientras el segundo secuencia y duración de los momentos;.
...
- **Evidencia de logro.** Qué muestra un rediseño de ambiente con la conducta esperada por cada zona y la evidencia observada antes y después frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
te deja en condiciones de qué modificación del ambiente hará posible el aprendizaje que hoy no aparece, y esa decisión se sostiene solo si
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Ambiente de aprendizaje** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Ambiente de aprendizaje de Zona o rincón.** El trabajo aquí es separar lo observado de lo interpretado sobre **Zona o rincón**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Material abierto como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Material abierto**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.

**Paso 4 — Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con Ritmo de la jornada a la vista.** Con **Ritmo de la jornada** ya delimitado, la pregunta pasa a ser de consecuencia: qué cambia para los estudiantes, para el tiempo de clase y para la carga del equipo. **Evidencia de partida** entrega la lectura observable; el juicio profesional sigue siendo humano y debe quedar firmado por quien lo hace.
...
|---|---|---|---|
| Intervenir sobre **Ambiente de aprendizaje** | Conjunto de espacio, materiales, tiempo y organización que condiciona la actividad posible | Cuando **Evidencia de partida** es observable y accionable dentro del plazo de la decisión. | Sobrerreaccionar a una señal parcial. |
| Intervenir sobre **Zona o rincón** | Sector organizado con intención pedagógica, materiales seleccionados y conducta esperada | Cuando la primera explicación no distingue mecanismo ni responsable. | Convertir el concepto en etiqueta y no en intervención. |
| Observar antes de decidir | Reducir la incertidumbre antes de comprometer tiempo y credibilidad | Cuando la decisión es reversible y la evidencia disponible no distingue causas. | Observar indefinidamente y no decidir nunca. |
| Derivar o escalar | Poner la decisión donde están la competencia y la responsabilidad | Cuando hay normativa, resguardo de datos, salud o vulneración de derechos en juego. | Delegar hacia arriba lo que sí correspondía decidir en el aula. |

**Frontera de aplicación.** No hay una configuración óptima universal: Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre ambientes de aprendizaje |
|---|---|
...
Guárdala en `evidence/P03-C039-ambientes-de-aprendizaje/` con estos archivos:
