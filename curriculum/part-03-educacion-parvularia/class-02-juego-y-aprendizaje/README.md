...
**Decisión que habilita:** determinar qué grado de intervención adulta requiere un juego para sostener el aprendizaje sin apropiárselo<br>
...
2. Clasificar la situación distinguiendo **Juego libre** de **Juego guiado**.
3. Decidir con fundamento, usando **Juego simbólico** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Intervención sensible** a la vista.
...
| **Evidencia de logro** | qué muestra el diseño de tres situaciones de juego con distinto grado de guía adulta y el aprendizaje que cada una persigue frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
La investigación sobre juego tiene limitaciones conocidas: Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Juego libre"]
    C --> A2["Juego guiado"]
    C --> A3["Juego simbólico"]
    C --> A4["Intervención sensible"]
    A1 & A2 & A3 & A4 --> D{{"determinar qué grado de<br/>intervención adulta<br/>requiere un juego para<br/>sostener el aprendizaje<br/>sin…"}}
    D --> E["Evidencia de aprendizaje<br/>el diseño de tres<br/>situaciones de juego con<br/>distinto grado de guía<br/>adulta y el aprendizaje<br/>que…"]
...
inocua: produce decisiones que atacan el problema equivocado. **Juego libre** no es lo
mismo que **Juego guiado** —situación diseñada por el adulto que conserva la iniciativa del niño dentro de un propósito—, y tratarlos como sinónimos hace
que la intervención se dirija al lugar incorrecto. Del mismo modo, **Juego simbólico** y
**Intervención sensible** describen aspectos distintos de la misma situación: el primero
representación de roles y situaciones;, mientras el segundo participación del adulto que amplía el juego sin dirigirlo ni interrumpirlo.
...
- **Evidencia de logro.** Qué muestra el diseño de tres situaciones de juego con distinto grado de guía adulta y el aprendizaje que cada una persigue frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
te deja en condiciones de qué grado de intervención adulta requiere un juego para sostener el aprendizaje sin apropiárselo, y esa decisión se sostiene solo si
...
|---|---|---|
| Weisberg, D., Hirsh-Pasek, K. & Golinkoff, R. (2013). *Guided Play: Where Curricular Goals Meet a Playful Pedagogy*. | define el juego guiado y sintetiza la evidencia que lo distingue del juego libre y de la instrucción. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
| Vygotsky, L. (1978). *Mind in Society*, cap. sobre el juego. | explica por qué el juego simbólico opera como zona de desarrollo próximo del propio niño. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Juego libre** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Juego libre de Juego guiado.** El trabajo aquí es separar lo observado de lo interpretado sobre **Juego guiado**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Juego simbólico como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Juego simbólico**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.

**Paso 4 — Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con Intervención sensible a la vista.** Con **Intervención sensible** ya delimitado, la pregunta pasa a ser de consecuencia: qué cambia para los estudiantes, para el tiempo de clase y para la carga del equipo. **Evidencia de partida** entrega la lectura observable; el juicio profesional sigue siendo humano y debe quedar firmado por quien lo hace.
...
|---|---|---|---|
| Intervenir sobre **Juego libre** | Actividad elegida y dirigida por el niño, sin objetivo impuesto por el adulto | Cuando **Evidencia de partida** es observable y accionable dentro del plazo de la decisión. | Sobrerreaccionar a una señal parcial. |
| Intervenir sobre **Juego guiado** | Situación diseñada por el adulto que conserva la iniciativa del niño dentro de un propósito | Cuando la primera explicación no distingue mecanismo ni responsable. | Convertir el concepto en etiqueta y no en intervención. |
| Observar antes de decidir | Reducir la incertidumbre antes de comprometer tiempo y credibilidad | Cuando la decisión es reversible y la evidencia disponible no distingue causas. | Observar indefinidamente y no decidir nunca. |
| Derivar o escalar | Poner la decisión donde están la competencia y la responsabilidad | Cuando hay normativa, resguardo de datos, salud o vulneración de derechos en juego. | Delegar hacia arriba lo que sí correspondía decidir en el aula. |

**Frontera de aplicación.** La investigación sobre juego tiene limitaciones conocidas: Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre juego y aprendizaje |
|---|---|
...
Guárdala en `evidence/P03-C038-juego-y-aprendizaje/` con estos archivos:
