...
**Estado de evidencia:** `ROBUSTA` · **Etapa:** 🟢 Etapa A — Fundamentos · **Población de referencia:** transversal: los mecanismos son generales, su aplicación no<br>
**Decisión que habilita:** determinar cuándo y cómo se recuperará cada contenido a lo largo de tu asignatura<br>
...
2. Clasificar la situación distinguiendo **Práctica de recuperación** de **Práctica distribuida**.
3. Decidir con fundamento, usando **Dificultad deseable** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Ilusión de fluidez** a la vista.
...
| **Evidencia de logro** | qué muestra un calendario de recuperación y espaciado para una unidad completa, con instrumentos breves y sin calificación de por medio frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
La recuperación funciona mejor cuando el contenido fue comprendido inicialmente: Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Práctica de<br/>recuperación"]
    C --> A2["Práctica distribuida"]
    C --> A3["Dificultad deseable"]
    C --> A4["Ilusión de fluidez"]
    A1 & A2 & A3 & A4 --> D{{"determinar cuándo y cómo<br/>se recuperará cada<br/>contenido a lo largo de<br/>tu asignatura"}}
    D --> E["Evidencia de aprendizaje<br/>un calendario de<br/>recuperación y espaciado<br/>para una unidad<br/>completa, con<br/>instrumentos breves y…"]
...
inocua: produce decisiones que atacan el problema equivocado. **Práctica de recuperación** no es lo
mismo que **Práctica distribuida** —distribución del estudio en el tiempo en vez de concentrarlo; produce retención más duradera—, y tratarlos como sinónimos hace
que la intervención se dirija al lugar incorrecto. Del mismo modo, **Dificultad deseable** y
**Ilusión de fluidez** describen aspectos distintos de la misma situación: el primero
condición que hace el aprendizaje más lento y más duradero, mientras el segundo sensación de dominio que produce releer material familiar y que no se corresponde con retención real.
...
- **Evidencia de logro.** Qué muestra un calendario de recuperación y espaciado para una unidad completa, con instrumentos breves y sin calificación de por medio frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
te deja en condiciones de cuándo y cómo se recuperará cada contenido a lo largo de tu asignatura, y esa decisión se sostiene solo si
...
|---|---|---|
| Roediger, H. & Karpicke, J. (2006). *Test-Enhanced Learning*. Psychological Science, 17(3). | el experimento que instaló el efecto de recuperación y mostró la discrepancia entre sensación y retención. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
| Dunlosky, J. et al. (2013). *Improving Students' Learning With Effective Learning Techniques*. | clasifica diez técnicas por evidencia; práctica distribuida y de recuperación quedan en el nivel más alto. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Práctica de recuperación** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Práctica de recuperación de Práctica distribuida.** El trabajo aquí es separar lo observado de lo interpretado sobre **Práctica distribuida**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Dificultad deseable como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Dificultad deseable**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.

**Paso 4 — Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con Ilusión de fluidez a la vista.** Con **Ilusión de fluidez** ya delimitado, la pregunta pasa a ser de consecuencia: qué cambia para los estudiantes, para el tiempo de clase y para la carga del equipo. **Evidencia de partida** entrega la lectura observable; el juicio profesional sigue siendo humano y debe quedar firmado por quien lo hace.
...
|---|---|---|---|
| Intervenir sobre **Práctica de recuperación** | Acto de traer a la memoria lo aprendido sin tenerlo a la vista; fortalece la retención más que releer | Cuando **Evidencia de partida** es observable y accionable dentro del plazo de la decisión. | Sobrerreaccionar a una señal parcial. |
| Intervenir sobre **Práctica distribuida** | Distribución del estudio en el tiempo en vez de concentrarlo; produce retención más duradera | Cuando la primera explicación no distingue mecanismo ni responsable. | Convertir el concepto en etiqueta y no en intervención. |
| Observar antes de decidir | Reducir la incertidumbre antes de comprometer tiempo y credibilidad | Cuando la decisión es reversible y la evidencia disponible no distingue causas. | Observar indefinidamente y no decidir nunca. |
| Derivar o escalar | Poner la decisión donde están la competencia y la responsabilidad | Cuando hay normativa, resguardo de datos, salud o vulneración de derechos en juego. | Delegar hacia arriba lo que sí correspondía decidir en el aula. |

**Frontera de aplicación.** La recuperación funciona mejor cuando el contenido fue comprendido inicialmente: Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre práctica de recuperación y espaciado |
|---|---|
...
Guárdala en `evidence/P01-C020-practica-de-recuperacion-y-espaciado/` con estos archivos:
