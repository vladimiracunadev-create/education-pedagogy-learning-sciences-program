...
**Decisión que habilita:** determinar si el problema que enfrentas se resuelve modificando consecuencias o si exige intervenir en la comprensión<br>
...
2. Clasificar la situación distinguiendo **Reforzamiento** de **Castigo**.
3. Decidir con fundamento, usando **Programa de reforzamiento** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Análisis funcional** a la vista.
...
| **Evidencia de logro** | qué muestra un análisis funcional de una conducta real del aula, con antecedente, conducta, consecuencia y una intervención propuesta frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
El conductismo describe bien la conducta y mal la comprensión: Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Reforzamiento"]
    C --> A2["Castigo"]
    C --> A3["Programa de<br/>reforzamiento"]
    C --> A4["Análisis funcional"]
    A1 & A2 & A3 & A4 --> D{{"determinar si el<br/>problema que enfrentas<br/>se resuelve modificando<br/>consecuencias o si<br/>exige…"}}
    D --> E["Evidencia de aprendizaje<br/>un análisis funcional de<br/>una conducta real del<br/>aula, con antecedente,<br/>conducta, consecuencia<br/>y…"]
...
inocua: produce decisiones que atacan el problema equivocado. **Reforzamiento** no es lo
mismo que **Castigo** —consecuencia que disminuye la probabilidad de una conducta; con efectos secundarios documentados—, y tratarlos como sinónimos hace
que la intervención se dirija al lugar incorrecto. Del mismo modo, **Programa de reforzamiento** y
**Análisis funcional** describen aspectos distintos de la misma situación: el primero
regla que define cuándo se entrega la consecuencia;, mientras el segundo procedimiento que identifica antecedente, conducta y consecuencia para explicar por qué ocurre algo.
...
- **Evidencia de logro.** Qué muestra un análisis funcional de una conducta real del aula, con antecedente, conducta, consecuencia y una intervención propuesta frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
te deja en condiciones de si el problema que enfrentas se resuelve modificando consecuencias o si exige intervenir en la comprensión, y esa decisión se sostiene solo si
...
|---|---|---|
| Skinner, B. F. (1968). *The Technology of Teaching*. | la formulación original aplicada a la enseñanza; léelo por su precisión conceptual, no por su programa educativo completo. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
| Deci, E., Koestner, R. & Ryan, R. (1999). *A Meta-Analytic Review of Experiments Examining the Effects of Extrinsic Rewards on Intrinsic Motivation*. | documenta cuándo la recompensa externa deteriora la motivación interna; el matiz que evita el mal uso del reforzamiento. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Reforzamiento** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Reforzamiento de Castigo.** El trabajo aquí es separar lo observado de lo interpretado sobre **Castigo**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Programa de reforzamiento como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Programa de reforzamiento**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.

**Paso 4 — Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con Análisis funcional a la vista.** Con **Análisis funcional** ya delimitado, la pregunta pasa a ser de consecuencia: qué cambia para los estudiantes, para el tiempo de clase y para la carga del equipo. **Evidencia de partida** entrega la lectura observable; el juicio profesional sigue siendo humano y debe quedar firmado por quien lo hace.
...
|---|---|---|---|
| Intervenir sobre **Reforzamiento** | Consecuencia que aumenta la probabilidad de que una conducta se repita | Cuando **Evidencia de partida** es observable y accionable dentro del plazo de la decisión. | Sobrerreaccionar a una señal parcial. |
| Intervenir sobre **Castigo** | Consecuencia que disminuye la probabilidad de una conducta; con efectos secundarios documentados | Cuando la primera explicación no distingue mecanismo ni responsable. | Convertir el concepto en etiqueta y no en intervención. |
| Observar antes de decidir | Reducir la incertidumbre antes de comprometer tiempo y credibilidad | Cuando la decisión es reversible y la evidencia disponible no distingue causas. | Observar indefinidamente y no decidir nunca. |
| Derivar o escalar | Poner la decisión donde están la competencia y la responsabilidad | Cuando hay normativa, resguardo de datos, salud o vulneración de derechos en juego. | Delegar hacia arriba lo que sí correspondía decidir en el aula. |

**Frontera de aplicación.** El conductismo describe bien la conducta y mal la comprensión: Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre conductismo y aprendizaje observable |
|---|---|
...
Guárdala en `evidence/P01-C013-conductismo-y-aprendizaje-observable/` con estos archivos:
