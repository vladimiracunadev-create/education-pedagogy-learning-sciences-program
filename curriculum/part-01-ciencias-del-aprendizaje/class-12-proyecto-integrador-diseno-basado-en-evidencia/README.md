...
**Decisión que habilita:** determinar la secuencia completa de una unidad y justificar cada decisión con el mecanismo que la sostiene<br>
...
2. Clasificar la situación distinguiendo **Diseño basado en evidencia** de **Mecanismo**.
3. Decidir con fundamento, usando **Fidelidad de implementación** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Evaluación del diseño** a la vista.
...
| **Evidencia de logro** | qué muestra el diseño de una unidad con una tabla que asocie cada decisión didáctica a su mecanismo y a su fuente frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
Que una decisión esté respaldada por un mecanismo no garantiza que funcione en tu contexto: Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Diseño basado en<br/>evidencia"]
    C --> A2["Mecanismo"]
    C --> A3["Fidelidad de<br/>implementación"]
    C --> A4["Evaluación del diseño"]
    A1 & A2 & A3 & A4 --> D{{"determinar la secuencia<br/>completa de una unidad y<br/>justificar cada decisión<br/>con el mecanismo que…"}}
    D --> E["Evidencia de aprendizaje<br/>el diseño de una unidad<br/>con una tabla que asocie<br/>cada decisión didáctica<br/>a su mecanismo y a su…"]
...
inocua: produce decisiones que atacan el problema equivocado. **Diseño basado en evidencia** no es lo
mismo que **Mecanismo** —proceso cognitivo o social que explica por qué una intervención produce su efecto—, y tratarlos como sinónimos hace
que la intervención se dirija al lugar incorrecto. Del mismo modo, **Fidelidad de implementación** y
**Evaluación del diseño** describen aspectos distintos de la misma situación: el primero
grado en que lo diseñado se ejecuta como fue concebido;, mientras el segundo comprobación de si la unidad produjo el aprendizaje que declaraba perseguir.
...
- **Evidencia de logro.** Qué muestra el diseño de una unidad con una tabla que asocie cada decisión didáctica a su mecanismo y a su fuente frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
te deja en condiciones de la secuencia completa de una unidad y justificar cada decisión con el mecanismo que la sostiene, y esa decisión se sostiene solo si
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Diseño basado en evidencia** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Diseño basado en evidencia de Mecanismo.** El trabajo aquí es separar lo observado de lo interpretado sobre **Mecanismo**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.
...
|---|---|---|---|
| Intervenir sobre **Diseño basado en evidencia** | Proceso de decidir la enseñanza a partir de mecanismos documentados y de evidencia disponible | Cuando **Evidencia de partida** es observable y accionable dentro del plazo de la decisión. | Sobrerreaccionar a una señal parcial. |
| Intervenir sobre **Mecanismo** | Proceso cognitivo o social que explica por qué una intervención produce su efecto | Cuando la primera explicación no distingue mecanismo ni responsable. | Convertir el concepto en etiqueta y no en intervención. |
| Observar antes de decidir | Reducir la incertidumbre antes de comprometer tiempo y credibilidad | Cuando la decisión es reversible y la evidencia disponible no distingue causas. | Observar indefinidamente y no decidir nunca. |
| Derivar o escalar | Poner la decisión donde están la competencia y la responsabilidad | Cuando hay normativa, resguardo de datos, salud o vulneración de derechos en juego. | Delegar hacia arriba lo que sí correspondía decidir en el aula. |

**Frontera de aplicación.** Que una decisión esté respaldada por un mecanismo no garantiza que funcione en tu contexto: Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre proyecto integrador: diseño basado en evidencia |
|---|---|
...
Guárdala en `evidence/P01-C024-proyecto-integrador-diseno-basado-en-evidencia/` con estos archivos:
