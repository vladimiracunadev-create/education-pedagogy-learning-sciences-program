...
**Decisión que habilita:** determinar qué condición de la tarea vas a modificar para que esforzarse sea razonable para tus estudiantes<br>
...
2. Clasificar la situación distinguiendo **Autonomía** de **Competencia**.
3. Decidir con fundamento, usando **Valor de la tarea** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Atribución** a la vista.
...
| **Evidencia de logro** | qué muestra el rediseño de una tarea que aumente autonomía, competencia o valor percibido, con su fundamento explícito frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
Las intervenciones motivacionales breves que se popularizaron —mentalidad de crecimiento, propósito— muestran en replicaciones grandes efectos pequeños y concentrados en subgrupos específicos, sobre todo estudiantes de bajo rendimiento en contextos que sostienen el mensaje. Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Autonomía"]
    C --> A2["Competencia"]
    C --> A3["Valor de la tarea"]
    C --> A4["Atribución"]
    A1 & A2 & A3 & A4 --> D{{"determinar qué condición<br/>de la tarea vas a<br/>modificar para que<br/>esforzarse sea razonable<br/>para tus…"}}
    D --> E["Evidencia de aprendizaje<br/>el rediseño de una tarea<br/>que aumente autonomía,<br/>competencia o valor<br/>percibido, con su…"]
...
inocua: produce decisiones que atacan el problema equivocado. **Autonomía** no es lo
mismo que **Competencia** —expectativa razonable de poder lograr la tarea con el esfuerzo disponible—, y tratarlos como sinónimos hace
que la intervención se dirija al lugar incorrecto. Del mismo modo, **Valor de la tarea** y
**Atribución** describen aspectos distintos de la misma situación: el primero
utilidad, interés o importancia que el estudiante atribuye a lo que se le pide, mientras el segundo explicación que la persona se da sobre las causas de su éxito o fracaso.
...
- **Evidencia de logro.** Qué muestra el rediseño de una tarea que aumente autonomía, competencia o valor percibido, con su fundamento explícito frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
te deja en condiciones de qué condición de la tarea vas a modificar para que esforzarse sea razonable para tus estudiantes, y esa decisión se sostiene solo si
...
|---|---|---|
| Ryan, R. & Deci, E. (2000). *Self-Determination Theory and the Facilitation of Intrinsic Motivation*. American Psychologist, 55(1). | el marco de autonomía, competencia y vínculo, con su evidencia y sus condiciones. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
| Wigfield, A. & Eccles, J. (2000). *Expectancy–Value Theory of Achievement Motivation*. | explica la decisión de esforzarse como producto de expectativa y valor; muy operativo para rediseñar tareas. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Autonomía** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Autonomía de Competencia.** El trabajo aquí es separar lo observado de lo interpretado sobre **Competencia**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Valor de la tarea como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Valor de la tarea**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.

**Paso 4 — Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con Atribución a la vista.** Con **Atribución** ya delimitado, la pregunta pasa a ser de consecuencia: qué cambia para los estudiantes, para el tiempo de clase y para la carga del equipo. **Evidencia de partida** entrega la lectura observable; el juicio profesional sigue siendo humano y debe quedar firmado por quien lo hace.
...
|---|---|---|---|
| Intervenir sobre **Autonomía** | Percepción de que la propia acción es elegida y no impuesta; no significa ausencia de estructura | Cuando **Evidencia de partida** es observable y accionable dentro del plazo de la decisión. | Sobrerreaccionar a una señal parcial. |
| Intervenir sobre **Competencia** | Expectativa razonable de poder lograr la tarea con el esfuerzo disponible | Cuando la primera explicación no distingue mecanismo ni responsable. | Convertir el concepto en etiqueta y no en intervención. |
| Observar antes de decidir | Reducir la incertidumbre antes de comprometer tiempo y credibilidad | Cuando la decisión es reversible y la evidencia disponible no distingue causas. | Observar indefinidamente y no decidir nunca. |
| Derivar o escalar | Poner la decisión donde están la competencia y la responsabilidad | Cuando hay normativa, resguardo de datos, salud o vulneración de derechos en juego. | Delegar hacia arriba lo que sí correspondía decidir en el aula. |

**Frontera de aplicación.** Las intervenciones motivacionales breves que se popularizaron —mentalidad de crecimiento, propósito— muestran en replicaciones grandes efectos pequeños y concentrados en subgrupos específicos, sobre todo estudiantes de bajo rendimiento en contextos que sostienen el mensaje. Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre motivación y autodeterminación |
|---|---|
...
Guárdala en `evidence/P01-C022-motivacion-y-autodeterminacion/` con estos archivos:
