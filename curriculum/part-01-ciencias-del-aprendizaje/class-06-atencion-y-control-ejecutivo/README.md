...
**Decisión que habilita:** determinar qué elementos de tu clase están compitiendo por la atención y cuáles hay que eliminar<br>
...
2. Clasificar la situación distinguiendo **Atención selectiva** de **Control ejecutivo**.
3. Decidir con fundamento, usando **Costo de cambio de tarea** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Carga atencional externa** a la vista.
...
| **Evidencia de logro** | qué muestra una auditoría de atención de una clase real con las fuentes de competencia identificadas y su corrección frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
El control ejecutivo madura durante toda la infancia y la adolescencia y varía mucho entre personas de la misma edad; Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Atención selectiva"]
    C --> A2["Control ejecutivo"]
    C --> A3["Costo de cambio de<br/>tarea"]
    C --> A4["Carga atencional<br/>externa"]
    A1 & A2 & A3 & A4 --> D{{"determinar qué elementos<br/>de tu clase están<br/>compitiendo por la<br/>atención y cuáles hay<br/>que eliminar"}}
    D --> E["Evidencia de aprendizaje<br/>una auditoría de<br/>atención de una clase<br/>real con las fuentes de<br/>competencia<br/>identificadas y su…"]
...
inocua: produce decisiones que atacan el problema equivocado. **Atención selectiva** no es lo
mismo que **Control ejecutivo** —conjunto de funciones —inhibición, memoria de trabajo, flexibilidad— que regulan la conducta dirigida a metas—, y tratarlos como sinónimos hace
que la intervención se dirija al lugar incorrecto. Del mismo modo, **Costo de cambio de tarea** y
**Carga atencional externa** describen aspectos distintos de la misma situación: el primero
pérdida de rendimiento al alternar entre tareas;, mientras el segundo demanda impuesta por el entorno:.
...
- **Evidencia de logro.** Qué muestra una auditoría de atención de una clase real con las fuentes de competencia identificadas y su corrección frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
te deja en condiciones de qué elementos de tu clase están compitiendo por la atención y cuáles hay que eliminar, y esa decisión se sostiene solo si
...
|---|---|---|
| Diamond, A. (2013). *Executive Functions*. Annual Review of Psychology, 64. | la revisión de referencia sobre funciones ejecutivas, su desarrollo y qué intervenciones tienen evidencia. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
| Mayer, R. (2021). *Multimedia Learning*. | aporta los principios de redundancia y atención dividida, con experimentos que se replican en aula. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Atención selectiva** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Atención selectiva de Control ejecutivo.** El trabajo aquí es separar lo observado de lo interpretado sobre **Control ejecutivo**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Costo de cambio de tarea como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Costo de cambio de tarea**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.

**Paso 4 — Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con Carga atencional externa a la vista.** Con **Carga atencional externa** ya delimitado, la pregunta pasa a ser de consecuencia: qué cambia para los estudiantes, para el tiempo de clase y para la carga del equipo. **Evidencia de partida** entrega la lectura observable; el juicio profesional sigue siendo humano y debe quedar firmado por quien lo hace.
...
|---|---|---|---|
| Intervenir sobre **Atención selectiva** | Capacidad de priorizar un estímulo relevante e inhibir los demás | Cuando **Evidencia de partida** es observable y accionable dentro del plazo de la decisión. | Sobrerreaccionar a una señal parcial. |
| Intervenir sobre **Control ejecutivo** | Conjunto de funciones —inhibición, memoria de trabajo, flexibilidad— que regulan la conducta dirigida a metas | Cuando la primera explicación no distingue mecanismo ni responsable. | Convertir el concepto en etiqueta y no en intervención. |
| Observar antes de decidir | Reducir la incertidumbre antes de comprometer tiempo y credibilidad | Cuando la decisión es reversible y la evidencia disponible no distingue causas. | Observar indefinidamente y no decidir nunca. |
| Derivar o escalar | Poner la decisión donde están la competencia y la responsabilidad | Cuando hay normativa, resguardo de datos, salud o vulneración de derechos en juego. | Delegar hacia arriba lo que sí correspondía decidir en el aula. |

**Frontera de aplicación.** El control ejecutivo madura durante toda la infancia y la adolescencia y varía mucho entre personas de la misma edad; Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre atención y control ejecutivo |
|---|---|
...
Guárdala en `evidence/P01-C018-atencion-y-control-ejecutivo/` con estos archivos:
