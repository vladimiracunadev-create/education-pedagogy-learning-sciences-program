...
**Decisión que habilita:** determinar en qué punto del procesamiento se está perdiendo el aprendizaje de tu grupo<br>
...
2. Clasificar la situación distinguiendo **Procesamiento de información** de **Codificación**.
3. Decidir con fundamento, usando **Esquema** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Recuperación** a la vista.
...
| **Evidencia de logro** | qué muestra un diagnóstico de una clase propia que localice el cuello de botella —atención, codificación, almacenamiento o recuperación— con evidencia frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
El modelo es una metáfora útil, no una descripción neurológica literal. Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Procesamiento de<br/>información"]
    C --> A2["Codificación"]
    C --> A3["Esquema"]
    C --> A4["Recuperación"]
    A1 & A2 & A3 & A4 --> D{{"determinar en qué punto<br/>del procesamiento se<br/>está perdiendo el<br/>aprendizaje de tu grupo"}}
    D --> E["Evidencia de aprendizaje<br/>un diagnóstico de una<br/>clase propia que<br/>localice el cuello de<br/>botella —atención,<br/>codificación,…"]
...
inocua: produce decisiones que atacan el problema equivocado. **Procesamiento de información** no es lo
mismo que **Codificación** —proceso por el que la información se transforma en representación almacenable—, y tratarlos como sinónimos hace
que la intervención se dirija al lugar incorrecto. Del mismo modo, **Esquema** y
**Recuperación** describen aspectos distintos de la misma situación: el primero
estructura de conocimiento organizado que permite tratar muchos elementos como uno solo, mientras el segundo acceso a la información almacenada;.
...
- **Evidencia de logro.** Qué muestra un diagnóstico de una clase propia que localice el cuello de botella —atención, codificación, almacenamiento o recuperación— con evidencia frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
te deja en condiciones de en qué punto del procesamiento se está perdiendo el aprendizaje de tu grupo, y esa decisión se sostiene solo si
...
|---|---|---|
| Atkinson, R. & Shiffrin, R. (1968). *Human Memory: A Proposed System and Its Control Processes*. | el modelo estructural clásico; sigue siendo el andamio conceptual del que derivan las clases 017 a 020. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
| Willingham, D. (2009). *Why Don't Students Like School?* | traduce la arquitectura cognitiva a decisiones de aula con ejemplos concretos; excelente puente para equipos docentes. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Procesamiento de información** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Procesamiento de información de Codificación.** El trabajo aquí es separar lo observado de lo interpretado sobre **Codificación**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Esquema como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Esquema**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.

**Paso 4 — Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con Recuperación a la vista.** Con **Recuperación** ya delimitado, la pregunta pasa a ser de consecuencia: qué cambia para los estudiantes, para el tiempo de clase y para la carga del equipo. **Evidencia de partida** entrega la lectura observable; el juicio profesional sigue siendo humano y debe quedar firmado por quien lo hace.
...
|---|---|---|---|
| Intervenir sobre **Procesamiento de información** | Modelo que describe el aprendizaje como flujo entre registros de memoria con capacidad limitada | Cuando **Evidencia de partida** es observable y accionable dentro del plazo de la decisión. | Sobrerreaccionar a una señal parcial. |
| Intervenir sobre **Codificación** | Proceso por el que la información se transforma en representación almacenable | Cuando la primera explicación no distingue mecanismo ni responsable. | Convertir el concepto en etiqueta y no en intervención. |
| Observar antes de decidir | Reducir la incertidumbre antes de comprometer tiempo y credibilidad | Cuando la decisión es reversible y la evidencia disponible no distingue causas. | Observar indefinidamente y no decidir nunca. |
| Derivar o escalar | Poner la decisión donde están la competencia y la responsabilidad | Cuando hay normativa, resguardo de datos, salud o vulneración de derechos en juego. | Delegar hacia arriba lo que sí correspondía decidir en el aula. |

**Frontera de aplicación.** El modelo es una metáfora útil, no una descripción neurológica literal. Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre cognitivismo y procesamiento de información |
|---|---|
...
Guárdala en `evidence/P01-C014-cognitivismo-y-procesamiento-de-informacion/` con estos archivos:
