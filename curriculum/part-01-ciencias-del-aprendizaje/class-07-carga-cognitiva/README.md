...
**Decisión que habilita:** determinar qué dificultad de tu clase es inherente al contenido y cuál es un defecto de diseño<br>
...
2. Clasificar la situación distinguiendo **Carga intrínseca** de **Carga extrínseca**.
3. Decidir con fundamento, usando **Efecto de atención dividida** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Ejemplo trabajado** a la vista.
...
| **Evidencia de logro** | qué muestra un rediseño de material con al menos tres efectos de carga corregidos y su justificación frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
La teoría tiene un matiz decisivo: Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Carga intrínseca"]
    C --> A2["Carga extrínseca"]
    C --> A3["Efecto de atención<br/>dividida"]
    C --> A4["Ejemplo trabajado"]
    A1 & A2 & A3 & A4 --> D{{"determinar qué<br/>dificultad de tu clase<br/>es inherente al<br/>contenido y cuál es un<br/>defecto de diseño"}}
    D --> E["Evidencia de aprendizaje<br/>un rediseño de material<br/>con al menos tres<br/>efectos de carga<br/>corregidos y su<br/>justificación"]
...
inocua: produce decisiones que atacan el problema equivocado. **Carga intrínseca** no es lo
mismo que **Carga extrínseca** —demanda añadida por un diseño deficiente; es la que hay que eliminar—, y tratarlos como sinónimos hace
que la intervención se dirija al lugar incorrecto. Del mismo modo, **Efecto de atención dividida** y
**Ejemplo trabajado** describen aspectos distintos de la misma situación: el primero
pérdida por tener que integrar mentalmente fuentes que deberían estar integradas físicamente, mientras el segundo problema resuelto paso a paso que reduce la carga del novato frente a la resolución sin guía.
...
- **Evidencia de logro.** Qué muestra un rediseño de material con al menos tres efectos de carga corregidos y su justificación frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
te deja en condiciones de qué dificultad de tu clase es inherente al contenido y cuál es un defecto de diseño, y esa decisión se sostiene solo si
...
|---|---|---|
| Sweller, J., van Merriënboer, J. & Paas, F. (2019). *Cognitive Architecture and Instructional Design: 20 Years Later*. Educational Psychology Review, 31. | actualiza la teoría, sus efectos y sus condiciones límite, incluido el efecto de reversión por experticia. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
| Mayer, R. (2021). *Multimedia Learning*. | traduce los efectos de carga a reglas concretas de diseño de material visual y multimedia. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Carga intrínseca** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Carga intrínseca de Carga extrínseca.** El trabajo aquí es separar lo observado de lo interpretado sobre **Carga extrínseca**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Efecto de atención dividida como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Efecto de atención dividida**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.

**Paso 4 — Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con Ejemplo trabajado a la vista.** Con **Ejemplo trabajado** ya delimitado, la pregunta pasa a ser de consecuencia: qué cambia para los estudiantes, para el tiempo de clase y para la carga del equipo. **Evidencia de partida** entrega la lectura observable; el juicio profesional sigue siendo humano y debe quedar firmado por quien lo hace.
...
|---|---|---|---|
| Intervenir sobre **Carga intrínseca** | Demanda impuesta por la complejidad propia del contenido y por su número de elementos que interactúan | Cuando **Evidencia de partida** es observable y accionable dentro del plazo de la decisión. | Sobrerreaccionar a una señal parcial. |
| Intervenir sobre **Carga extrínseca** | Demanda añadida por un diseño deficiente; es la que hay que eliminar | Cuando la primera explicación no distingue mecanismo ni responsable. | Convertir el concepto en etiqueta y no en intervención. |
| Observar antes de decidir | Reducir la incertidumbre antes de comprometer tiempo y credibilidad | Cuando la decisión es reversible y la evidencia disponible no distingue causas. | Observar indefinidamente y no decidir nunca. |
| Derivar o escalar | Poner la decisión donde están la competencia y la responsabilidad | Cuando hay normativa, resguardo de datos, salud o vulneración de derechos en juego. | Delegar hacia arriba lo que sí correspondía decidir en el aula. |

**Frontera de aplicación.** La teoría tiene un matiz decisivo: Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre carga cognitiva |
|---|---|
...
Guárdala en `evidence/P01-C019-carga-cognitiva/` con estos archivos:
