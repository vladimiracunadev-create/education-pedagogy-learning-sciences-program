...
**Decisión que habilita:** determinar cuántos elementos nuevos puede sostener tu grupo en una sesión y qué hay que automatizar antes<br>
...
flowchart TB
    ...
    C --> A1["Memoria de trabajo"]
    C --> A2["Memoria de largo plazo"]
    C --> A3["Automatización"]
    C --> A4["Efecto de la<br/>experticia"]
    A1 & A2 & A3 & A4 --> D{{"determinar cuántos<br/>elementos nuevos puede<br/>sostener tu grupo en una<br/>sesión y qué hay que…"}}
    D --> E["Evidencia de aprendizaje<br/>el rediseño de una clase<br/>que reduzca los<br/>elementos simultáneos y<br/>declare qué se<br/>automatizó…"]
