...
**Estado de evidencia:** `CONSISTENTE` · **Etapa:** 🟢 Etapa A — Fundamentos · **Población de referencia:** transversal: los mecanismos son generales, su aplicación no<br>
**Decisión que habilita:** determinar qué concepción previa de tus estudiantes debes hacer explícita antes de enseñar el contenido nuevo<br>
...
2. Clasificar la situación distinguiendo **Construcción del conocimiento** de **Concepción alternativa**.
3. Decidir con fundamento, usando **Conflicto cognitivo** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Asimilación y acomodación** a la vista.
...
| **Evidencia de logro** | qué muestra un instrumento breve de detección de concepciones previas para un contenido concreto, con las respuestas erróneas esperadas frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
El constructivismo es una teoría del aprendizaje, no un método de enseñanza, y esa confusión ha producido daño real. Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Construcción del<br/>conocimiento"]
    C --> A2["Concepción alternativa"]
    C --> A3["Conflicto cognitivo"]
    C --> A4["Asimilación y<br/>acomodación"]
    A1 & A2 & A3 & A4 --> D{{"determinar qué<br/>concepción previa de tus<br/>estudiantes debes hacer<br/>explícita antes de<br/>enseñar el…"}}
    D --> E["Evidencia de aprendizaje<br/>un instrumento breve de<br/>detección de<br/>concepciones previas<br/>para un contenido<br/>concreto, con las…"]
...
inocua: produce decisiones que atacan el problema equivocado. **Construcción del conocimiento** no es lo
mismo que **Concepción alternativa** —idea previa coherente y estable que contradice el conocimiento disciplinar y resiste la enseñanza—, y tratarlos como sinónimos hace
que la intervención se dirija al lugar incorrecto. Del mismo modo, **Conflicto cognitivo** y
**Asimilación y acomodación** describen aspectos distintos de la misma situación: el primero
situación en que la evidencia contradice la concepción previa y fuerza su revisión, mientras el segundo incorporar lo nuevo a un esquema existente o modificar el esquema para que lo nuevo quepa.
...
- **Evidencia de logro.** Qué muestra un instrumento breve de detección de concepciones previas para un contenido concreto, con las respuestas erróneas esperadas frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
te deja en condiciones de qué concepción previa de tus estudiantes debes hacer explícita antes de enseñar el contenido nuevo, y esa decisión se sostiene solo si
...
|---|---|---|
| Piaget, J. (1970). *Psicología y epistemología*. | fuente del par asimilación-acomodación; útil para entender el mecanismo, con las reservas actuales sobre las etapas fijas. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
| Kirschner, P., Sweller, J. & Clark, R. (2006). *Why Minimal Guidance During Instruction Does Not Work*. Educational Psychologist, 41(2). | el contrapunto obligatorio: distingue la teoría del aprendizaje del método de enseñanza que se le atribuye. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Construcción del conocimiento** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Construcción del conocimiento de Concepción alternativa.** El trabajo aquí es separar lo observado de lo interpretado sobre **Concepción alternativa**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Conflicto cognitivo como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Conflicto cognitivo**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.

**Paso 4 — Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con Asimilación y acomodación a la vista.** Con **Asimilación y acomodación** ya delimitado, la pregunta pasa a ser de consecuencia: qué cambia para los estudiantes, para el tiempo de clase y para la carga del equipo. **Evidencia de partida** entrega la lectura observable; el juicio profesional sigue siendo humano y debe quedar firmado por quien lo hace.
...
|---|---|---|---|
| Intervenir sobre **Construcción del conocimiento** | Proceso por el que el sujeto integra información nueva reorganizando lo que ya sabe | Cuando **Evidencia de partida** es observable y accionable dentro del plazo de la decisión. | Sobrerreaccionar a una señal parcial. |
| Intervenir sobre **Concepción alternativa** | Idea previa coherente y estable que contradice el conocimiento disciplinar y resiste la enseñanza | Cuando la primera explicación no distingue mecanismo ni responsable. | Convertir el concepto en etiqueta y no en intervención. |
| Observar antes de decidir | Reducir la incertidumbre antes de comprometer tiempo y credibilidad | Cuando la decisión es reversible y la evidencia disponible no distingue causas. | Observar indefinidamente y no decidir nunca. |
| Derivar o escalar | Poner la decisión donde están la competencia y la responsabilidad | Cuando hay normativa, resguardo de datos, salud o vulneración de derechos en juego. | Delegar hacia arriba lo que sí correspondía decidir en el aula. |

**Frontera de aplicación.** El constructivismo es una teoría del aprendizaje, no un método de enseñanza, y esa confusión ha producido daño real. Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre constructivismo |
|---|---|
...
Guárdala en `evidence/P01-C015-constructivismo/` con estos archivos:
