...
**Estado de evidencia:** `EN-DEBATE` · **Etapa:** 🟢 Etapa A — Fundamentos · **Población de referencia:** transversal: los mecanismos son generales, su aplicación no<br>
**Decisión que habilita:** determinar a qué situaciones concretas debe transferir lo que enseñas, y practicar en esa variedad desde el comienzo<br>
...
2. Clasificar la situación distinguiendo **Transferencia cercana** de **Transferencia lejana**.
3. Decidir con fundamento, usando **Práctica variada** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Estructura profunda** a la vista.
...
| **Evidencia de logro** | qué muestra un conjunto de tareas de práctica variada que cubra las situaciones reales a las que debe transferir el aprendizaje frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
Aquí hay desacuerdo real. Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Transferencia cercana"]
    C --> A2["Transferencia lejana"]
    C --> A3["Práctica variada"]
    C --> A4["Estructura profunda"]
    A1 & A2 & A3 & A4 --> D{{"determinar a qué<br/>situaciones concretas<br/>debe transferir lo que<br/>enseñas, y practicar en<br/>esa…"}}
    D --> E["Evidencia de aprendizaje<br/>un conjunto de tareas de<br/>práctica variada que<br/>cubra las situaciones<br/>reales a las que debe…"]
...
inocua: produce decisiones que atacan el problema equivocado. **Transferencia cercana** no es lo
mismo que **Transferencia lejana** —aplicación a contextos, formatos o dominios distintos; es infrecuente y difícil de producir—, y tratarlos como sinónimos hace
que la intervención se dirija al lugar incorrecto. Del mismo modo, **Práctica variada** y
**Estructura profunda** describen aspectos distintos de la misma situación: el primero
entrenamiento con ejemplos que cambian en superficie manteniendo la estructura profunda, mientras el segundo relación subyacente que hace que dos problemas distintos se resuelvan igual.
...
- **Evidencia de logro.** Qué muestra un conjunto de tareas de práctica variada que cubra las situaciones reales a las que debe transferir el aprendizaje frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
te deja en condiciones de a qué situaciones concretas debe transferir lo que enseñas, y practicar en esa variedad desde el comienzo, y esa decisión se sostiene solo si
...
|---|---|---|
| Barnett, S. & Ceci, S. (2002). *When and Where Do We Apply What We Learn? A Taxonomy for Far Transfer*. Psychological Bulletin, 128(4). | ordena el debate con una taxonomía; útil para no discutir sobre transferencia sin decir cuál. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
| Gick, M. & Holyoak, K. (1983). *Schema Induction and Analogical Transfer*. | los experimentos clásicos que muestran cuán poco transfiere una solución si no se hace explícita la analogía. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Transferencia cercana** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Transferencia cercana de Transferencia lejana.** El trabajo aquí es separar lo observado de lo interpretado sobre **Transferencia lejana**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Práctica variada como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Práctica variada**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.

**Paso 4 — Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con Estructura profunda a la vista.** Con **Estructura profunda** ya delimitado, la pregunta pasa a ser de consecuencia: qué cambia para los estudiantes, para el tiempo de clase y para la carga del equipo. **Evidencia de partida** entrega la lectura observable; el juicio profesional sigue siendo humano y debe quedar firmado por quien lo hace.
...
|---|---|---|---|
| Intervenir sobre **Transferencia cercana** | Aplicación de lo aprendido a situaciones muy similares a las de la práctica | Cuando **Evidencia de partida** es observable y accionable dentro del plazo de la decisión. | Sobrerreaccionar a una señal parcial. |
| Intervenir sobre **Transferencia lejana** | Aplicación a contextos, formatos o dominios distintos; es infrecuente y difícil de producir | Cuando la primera explicación no distingue mecanismo ni responsable. | Convertir el concepto en etiqueta y no en intervención. |
| Observar antes de decidir | Reducir la incertidumbre antes de comprometer tiempo y credibilidad | Cuando la decisión es reversible y la evidencia disponible no distingue causas. | Observar indefinidamente y no decidir nunca. |
| Derivar o escalar | Poner la decisión donde están la competencia y la responsabilidad | Cuando hay normativa, resguardo de datos, salud o vulneración de derechos en juego. | Delegar hacia arriba lo que sí correspondía decidir en el aula. |

**Frontera de aplicación.** Aquí hay desacuerdo real. Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre transferencia y aprendizaje profundo |
|---|---|
...
Guárdala en `evidence/P01-C023-transferencia-y-aprendizaje-profundo/` con estos archivos:
