...
**Decisión que habilita:** determinar qué apoyo dar, cuánto y en qué momento retirarlo para que el estudiante quede autónomo<br>
...
2. Clasificar la situación distinguiendo **Zona de desarrollo próximo** de **Mediación**.
3. Decidir con fundamento, usando **Andamiaje** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Internalización** a la vista.
...
| **Evidencia de logro** | qué muestra el diseño de una secuencia con apoyo graduado, con el criterio explícito de retiro de cada apoyo frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
La zona de desarrollo próximo es un concepto potente y difícil de operacionalizar: Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Zona de desarrollo<br/>próximo"]
    C --> A2["Mediación"]
    C --> A3["Andamiaje"]
    C --> A4["Internalización"]
    A1 & A2 & A3 & A4 --> D{{"determinar qué apoyo<br/>dar, cuánto y en qué<br/>momento retirarlo para<br/>que el estudiante quede…"}}
    D --> E["Evidencia de aprendizaje<br/>el diseño de una<br/>secuencia con apoyo<br/>graduado, con el<br/>criterio explícito de<br/>retiro de cada apoyo"]
...
inocua: produce decisiones que atacan el problema equivocado. **Zona de desarrollo próximo** no es lo
mismo que **Mediación** —intervención de otra persona o de un instrumento cultural que hace posible un desempeño todavía no autónomo—, y tratarlos como sinónimos hace
que la intervención se dirija al lugar incorrecto. Del mismo modo, **Andamiaje** y
**Internalización** describen aspectos distintos de la misma situación: el primero
apoyo temporal, ajustado y retirado progresivamente a medida que aumenta el dominio, mientras el segundo proceso por el que una regulación externa se convierte en regulación propia del estudiante.
...
- **Evidencia de logro.** Qué muestra el diseño de una secuencia con apoyo graduado, con el criterio explícito de retiro de cada apoyo frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
te deja en condiciones de qué apoyo dar, cuánto y en qué momento retirarlo para que el estudiante quede autónomo, y esa decisión se sostiene solo si
...
|---|---|---|
| Vygotsky, L. (1978). *Mind in Society*. | fuente directa de la zona de desarrollo próximo y de la mediación; conviene leer el original antes que sus resúmenes. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
| Wood, D., Bruner, J. & Ross, G. (1976). *The Role of Tutoring in Problem Solving*. | el artículo que introduce el andamiaje con criterios observables de ajuste y retiro. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Zona de desarrollo próximo** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Zona de desarrollo próximo de Mediación.** El trabajo aquí es separar lo observado de lo interpretado sobre **Mediación**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.
...
|---|---|---|---|
| Intervenir sobre **Zona de desarrollo próximo** | Distancia entre lo que se logra de forma autónoma y lo que se logra con apoyo competente | Cuando **Evidencia de partida** es observable y accionable dentro del plazo de la decisión. | Sobrerreaccionar a una señal parcial. |
| Intervenir sobre **Mediación** | Intervención de otra persona o de un instrumento cultural que hace posible un desempeño todavía no autónomo | Cuando la primera explicación no distingue mecanismo ni responsable. | Convertir el concepto en etiqueta y no en intervención. |
| Observar antes de decidir | Reducir la incertidumbre antes de comprometer tiempo y credibilidad | Cuando la decisión es reversible y la evidencia disponible no distingue causas. | Observar indefinidamente y no decidir nunca. |
| Derivar o escalar | Poner la decisión donde están la competencia y la responsabilidad | Cuando hay normativa, resguardo de datos, salud o vulneración de derechos en juego. | Delegar hacia arriba lo que sí correspondía decidir en el aula. |

**Frontera de aplicación.** La zona de desarrollo próximo es un concepto potente y difícil de operacionalizar: Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre socioconstructivismo y aprendizaje mediado |
|---|---|
...
Guárdala en `evidence/P01-C016-socioconstructivismo-y-aprendizaje-mediado/` con estos archivos:
