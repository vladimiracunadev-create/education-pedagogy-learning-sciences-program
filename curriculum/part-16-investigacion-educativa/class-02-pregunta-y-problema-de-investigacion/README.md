...
**Decisión que habilita:** determinar la pregunta exacta que tu investigación responderá y qué decisión cambiaría según la respuesta<br>
...
2. Clasificar la situación distinguiendo **Pregunta investigable** de **Delimitación**.
3. Decidir con fundamento, usando **Relevancia** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Factibilidad** a la vista.
...
| **Evidencia de logro** | qué muestra una pregunta de investigación delimitada con su justificación, su alcance y las consecuencias de cada respuesta posible frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
No hay una fórmula para producir buenas preguntas: Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Pregunta investigable"]
    C --> A2["Delimitación"]
    C --> A3["Relevancia"]
    C --> A4["Factibilidad"]
    A1 & A2 & A3 & A4 --> D{{"determinar la pregunta<br/>exacta que tu<br/>investigación responderá<br/>y qué decisión cambiaría<br/>según la…"}}
    D --> E["Evidencia de aprendizaje<br/>una pregunta de<br/>investigación delimitada<br/>con su justificación, su<br/>alcance y las<br/>consecuencias…"]
...
inocua: produce decisiones que atacan el problema equivocado. **Pregunta investigable** no es lo
mismo que **Delimitación** —precisión sobre población, contexto, variables y período que la pregunta abarca—, y tratarlos como sinónimos hace
que la intervención se dirija al lugar incorrecto. Del mismo modo, **Relevancia** y
**Factibilidad** describen aspectos distintos de la misma situación: el primero
aporte de la respuesta al conocimiento disponible o a una decisión práctica, mientras el segundo posibilidad real de responder la pregunta con el acceso, el tiempo y los recursos disponibles.
...
- **Evidencia de logro.** Qué muestra una pregunta de investigación delimitada con su justificación, su alcance y las consecuencias de cada respuesta posible frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
te deja en condiciones de la pregunta exacta que tu investigación responderá y qué decisión cambiaría según la respuesta, y esa decisión se sostiene solo si
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Pregunta investigable** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Pregunta investigable de Delimitación.** El trabajo aquí es separar lo observado de lo interpretado sobre **Delimitación**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Relevancia como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Relevancia**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.

**Paso 4 — Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con Factibilidad a la vista.** Con **Factibilidad** ya delimitado, la pregunta pasa a ser de consecuencia: qué cambia para los estudiantes, para el tiempo de clase y para la carga del equipo. **Evidencia de partida** entrega la lectura observable; el juicio profesional sigue siendo humano y debe quedar firmado por quien lo hace.
...
|---|---|---|---|
| Intervenir sobre **Pregunta investigable** | Interrogante que puede responderse con evidencia empírica en un plazo y con recursos definidos | Cuando **Evidencia de partida** es observable y accionable dentro del plazo de la decisión. | Sobrerreaccionar a una señal parcial. |
| Intervenir sobre **Delimitación** | Precisión sobre población, contexto, variables y período que la pregunta abarca | Cuando la primera explicación no distingue mecanismo ni responsable. | Convertir el concepto en etiqueta y no en intervención. |
| Observar antes de decidir | Reducir la incertidumbre antes de comprometer tiempo y credibilidad | Cuando la decisión es reversible y la evidencia disponible no distingue causas. | Observar indefinidamente y no decidir nunca. |
| Derivar o escalar | Poner la decisión donde están la competencia y la responsabilidad | Cuando hay normativa, resguardo de datos, salud o vulneración de derechos en juego. | Delegar hacia arriba lo que sí correspondía decidir en el aula. |

**Frontera de aplicación.** No hay una fórmula para producir buenas preguntas: Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre pregunta y problema de investigación |
|---|---|
...
Guárdala en `evidence/P16-C194-pregunta-y-problema-de-investigacion/` con estos archivos:
