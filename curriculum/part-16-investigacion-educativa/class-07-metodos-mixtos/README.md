...
**Decisión que habilita:** determinar qué aporta la combinación de métodos que ninguno de los dos aportaría por separado<br>
...
2. Clasificar la situación distinguiendo **Diseño mixto** de **Secuencia**.
3. Decidir con fundamento, usando **Integración** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Yuxtaposición** a la vista.
...
| **Evidencia de logro** | qué muestra un diseño mixto con su justificación, su secuencia y el punto explícito de integración de los componentes frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
Los diseños mixtos exigen competencia en ambas tradiciones y consumen más recursos. Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A3["Integración"]
    C --> A4["Yuxtaposición"]
    A1 & A2 & A3 & A4 --> D{{"determinar qué aporta la<br/>combinación de métodos<br/>que ninguno de los dos<br/>aportaría por separado"}}
    D --> E["Evidencia de aprendizaje<br/>un diseño mixto con su<br/>justificación, su<br/>secuencia y el punto<br/>explícito de integración<br/>de los…"]
...
- **Evidencia de logro.** Qué muestra un diseño mixto con su justificación, su secuencia y el punto explícito de integración de los componentes frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
te deja en condiciones de qué aporta la combinación de métodos que ninguno de los dos aportaría por separado, y esa decisión se sostiene solo si
...
|---|---|---|
| Creswell, J. & Plano Clark, V. (2018). *Designing and Conducting Mixed Methods Research*. | tipología de diseños mixtos con sus puntos de integración. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
| Bryman, A. (2007). *Barriers to Integrating Quantitative and Qualitative Research*. | documenta por qué la integración falla en la práctica y cómo evitarlo. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Diseño mixto** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Diseño mixto de Secuencia.** El trabajo aquí es separar lo observado de lo interpretado sobre **Secuencia**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Integración como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Integración**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.

**Paso 4 — Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con Yuxtaposición a la vista.** Con **Yuxtaposición** ya delimitado, la pregunta pasa a ser de consecuencia: qué cambia para los estudiantes, para el tiempo de clase y para la carga del equipo. **Evidencia de partida** entrega la lectura observable; el juicio profesional sigue siendo humano y debe quedar firmado por quien lo hace.
...
**Frontera de aplicación.** Los diseños mixtos exigen competencia en ambas tradiciones y consumen más recursos. Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre métodos mixtos |
|---|---|
...
Guárdala en `evidence/P16-C199-metodos-mixtos/` con estos archivos:
