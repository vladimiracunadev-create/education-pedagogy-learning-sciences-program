...
**Estado de evidencia:** `EN-DEBATE` · **Etapa:** 🔴 Etapa E — Investigación avanzada y formación de formadores · **Población de referencia:** investigación aplicada, tesis de magíster e investigación institucional<br>
**Decisión que habilita:** determinar qué supuestos sobre el conocimiento sostienen tu pregunta y qué métodos son coherentes con ellos<br>
...
2. Clasificar la situación distinguiendo **Ontología** de **Epistemología**.
3. Decidir con fundamento, usando **Paradigma** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Coherencia metodológica** a la vista.
...
| **Evidencia de logro** | qué muestra la declaración epistemológica de una investigación propia, con sus supuestos y sus implicancias metodológicas frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
La discusión paradigmática se ha usado con frecuencia para descalificar métodos ajenos en vez de para orientar decisiones. Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A2["Epistemología"]
    C --> A3["Paradigma"]
    C --> A4["Coherencia<br/>metodológica"]
    A1 & A2 & A3 & A4 --> D{{"determinar qué supuestos<br/>sobre el conocimiento<br/>sostienen tu pregunta y<br/>qué métodos son…"}}
    D --> E["Evidencia de aprendizaje<br/>la declaración<br/>epistemológica de una<br/>investigación propia,<br/>con sus supuestos y sus<br/>implicancias…"]
...
inocua: produce decisiones que atacan el problema equivocado. **Ontología** no es lo
...
- **Evidencia de logro.** Qué muestra la declaración epistemológica de una investigación propia, con sus supuestos y sus implicancias metodológicas frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
te deja en condiciones de qué supuestos sobre el conocimiento sostienen tu pregunta y qué métodos son coherentes con ellos, y esa decisión se sostiene solo si
...
|---|---|---|
| Guba, E. & Lincoln, Y. (1994). *Competing Paradigms in Qualitative Research*. | exposición clásica de los paradigmas y de sus supuestos. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
| Creswell, J. & Creswell, J. D. (2018). *Research Design*. | conecta supuestos, preguntas y diseños con criterios prácticos de elección. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Ontología** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Ontología de Epistemología.** El trabajo aquí es separar lo observado de lo interpretado sobre **Epistemología**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Paradigma como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Paradigma**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.

**Paso 4 — Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con Coherencia metodológica a la vista.** Con **Coherencia metodológica** ya delimitado, la pregunta pasa a ser de consecuencia: qué cambia para los estudiantes, para el tiempo de clase y para la carga del equipo. **Evidencia de partida** entrega la lectura observable; el juicio profesional sigue siendo humano y debe quedar firmado por quien lo hace.
...
**Frontera de aplicación.** La discusión paradigmática se ha usado con frecuencia para descalificar métodos ajenos en vez de para orientar decisiones. Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre epistemología de la investigación |
|---|---|
...
Guárdala en `evidence/P16-C193-epistemologia-de-la-investigacion/` con estos archivos:
