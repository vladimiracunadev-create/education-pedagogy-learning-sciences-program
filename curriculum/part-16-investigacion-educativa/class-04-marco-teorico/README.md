...
**Decisión que habilita:** determinar qué teoría orientará tu diseño y qué observaciones esperarías si esa teoría es correcta<br>
...
2. Clasificar la situación distinguiendo **Marco teórico** de **Definición operacional**.
3. Decidir con fundamento, usando **Relación teórica** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Consecuencia observable** a la vista.
...
| **Evidencia de logro** | qué muestra un marco teórico con conceptos definidos, relaciones explícitas y predicciones observables derivadas frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
En investigación cualitativa exploratoria, un marco demasiado rígido puede cerrar la observación a lo previsto y perder lo emergente. Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Marco teórico"]
    C --> A2["Definición operacional"]
    C --> A3["Relación teórica"]
    C --> A4["Consecuencia<br/>observable"]
    A1 & A2 & A3 & A4 --> D{{"determinar qué teoría<br/>orientará tu diseño y<br/>qué observaciones<br/>esperarías si esa teoría<br/>es…"}}
    D --> E["Evidencia de aprendizaje<br/>un marco teórico con<br/>conceptos definidos,<br/>relaciones explícitas y<br/>predicciones<br/>observables…"]
...
- **Evidencia de logro.** Qué muestra un marco teórico con conceptos definidos, relaciones explícitas y predicciones observables derivadas frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
te deja en condiciones de qué teoría orientará tu diseño y qué observaciones esperarías si esa teoría es correcta, y esa decisión se sostiene solo si
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Marco teórico** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Marco teórico de Definición operacional.** El trabajo aquí es separar lo observado de lo interpretado sobre **Definición operacional**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Relación teórica como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Relación teórica**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.

**Paso 4 — Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con Consecuencia observable a la vista.** Con **Consecuencia observable** ya delimitado, la pregunta pasa a ser de consecuencia: qué cambia para los estudiantes, para el tiempo de clase y para la carga del equipo. **Evidencia de partida** entrega la lectura observable; el juicio profesional sigue siendo humano y debe quedar firmado por quien lo hace.
...
**Frontera de aplicación.** En investigación cualitativa exploratoria, un marco demasiado rígido puede cerrar la observación a lo previsto y perder lo emergente. Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre marco teórico |
|---|---|
...
Guárdala en `evidence/P16-C196-marco-teorico/` con estos archivos:
