...
**Decisión que habilita:** determinar el procedimiento de análisis y cómo documentarás el camino desde los datos hasta los temas<br>
...
2. Clasificar la situación distinguiendo **Código** de **Tema**.
3. Decidir con fundamento, usando **Trazabilidad** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Codificación inductiva y deductiva** a la vista.
...
| **Evidencia de logro** | qué muestra un análisis temático documentado con sistema de códigos, temas construidos y trazabilidad hasta los datos frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
El análisis temático es flexible y esa flexibilidad exige declarar decisiones: Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A2["Tema"]
    C --> A3["Trazabilidad"]
    C --> A4["Codificación inductiva<br/>y deductiva"]
    A1 & A2 & A3 & A4 --> D{{"determinar el<br/>procedimiento de<br/>análisis y cómo<br/>documentarás el camino<br/>desde los datos hasta<br/>los…"}}
    D --> E["Evidencia de aprendizaje<br/>un análisis temático<br/>documentado con sistema<br/>de códigos, temas<br/>construidos y<br/>trazabilidad hasta…"]
...
inocua: produce decisiones que atacan el problema equivocado. **Código** no es lo
mismo que **Tema** —patrón de significado construido a partir de códigos, que responde a la pregunta de investigación—, y tratarlos como sinónimos hace
que la intervención se dirija al lugar incorrecto. Del mismo modo, **Trazabilidad** y
**Codificación inductiva y deductiva** describen aspectos distintos de la misma situación: el primero
posibilidad de recorrer el camino desde una afirmación hasta los datos que la sostienen, mientras el segundo construcción de códigos desde los datos o desde un marco previo.
...
- **Evidencia de logro.** Qué muestra un análisis temático documentado con sistema de códigos, temas construidos y trazabilidad hasta los datos frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
te deja en condiciones de el procedimiento de análisis y cómo documentarás el camino desde los datos hasta los temas, y esa decisión se sostiene solo si
...
|---|---|---|
| Braun, V. & Clarke, V. (2006). *Using Thematic Analysis in Psychology*. | el procedimiento por fases más usado; léelo completo antes de declarar que lo aplicaste. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
| Miles, M., Huberman, A. & Saldaña (2014). *Qualitative Data Analysis*. | repertorio de estrategias de codificación y de despliegue de datos. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Código** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Código de Tema.** El trabajo aquí es separar lo observado de lo interpretado sobre **Tema**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.
...
|---|---|---|---|
| Intervenir sobre **Código** | Etiqueta que identifica un segmento de datos con significado relevante para la pregunta | Cuando **Evidencia de partida** es observable y accionable dentro del plazo de la decisión. | Sobrerreaccionar a una señal parcial. |
| Intervenir sobre **Tema** | Patrón de significado construido a partir de códigos, que responde a la pregunta de investigación | Cuando la primera explicación no distingue mecanismo ni responsable. | Convertir el concepto en etiqueta y no en intervención. |
| Observar antes de decidir | Reducir la incertidumbre antes de comprometer tiempo y credibilidad | Cuando la decisión es reversible y la evidencia disponible no distingue causas. | Observar indefinidamente y no decidir nunca. |
| Derivar o escalar | Poner la decisión donde están la competencia y la responsabilidad | Cuando hay normativa, resguardo de datos, salud o vulneración de derechos en juego. | Delegar hacia arriba lo que sí correspondía decidir en el aula. |

**Frontera de aplicación.** El análisis temático es flexible y esa flexibilidad exige declarar decisiones: Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre análisis temático |
|---|---|
...
Guárdala en `evidence/P16-C202-analisis-tematico/` con estos archivos:
