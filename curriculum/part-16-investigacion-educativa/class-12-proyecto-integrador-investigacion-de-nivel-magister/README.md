...
**Decisión que habilita:** determinar el conjunto completo de decisiones de tu investigación y qué podrás afirmar con ella<br>
...
2. Clasificar la situación distinguiendo **Coherencia interna** de **Alcance declarado**.
3. Decidir con fundamento, usando **Limitación** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Contribución** a la vista.
...
| **Evidencia de logro** | qué muestra un informe de investigación completo con pregunta, marco, diseño, análisis, resultados y limitaciones frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
Una investigación de magíster produce evidencia acotada: Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Coherencia interna"]
    C --> A2["Alcance declarado"]
    C --> A3["Limitación"]
    C --> A4["Contribución"]
    A1 & A2 & A3 & A4 --> D{{"determinar el conjunto<br/>completo de decisiones<br/>de tu investigación y<br/>qué podrás afirmar con<br/>ella"}}
    D --> E["Evidencia de aprendizaje<br/>un informe de<br/>investigación completo<br/>con pregunta, marco,<br/>diseño, análisis,<br/>resultados y…"]
...
inocua: produce decisiones que atacan el problema equivocado. **Coherencia interna** no es lo
mismo que **Alcance declarado** —afirmación explícita de a qué contexto y población se aplican los hallazgos—, y tratarlos como sinónimos hace
que la intervención se dirija al lugar incorrecto. Del mismo modo, **Limitación** y
**Contribución** describen aspectos distintos de la misma situación: el primero
restricción del estudio que condiciona sus conclusiones;, mientras el segundo aporte concreto al conocimiento o a la práctica que el estudio produce.
...
- **Evidencia de logro.** Qué muestra un informe de investigación completo con pregunta, marco, diseño, análisis, resultados y limitaciones frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
te deja en condiciones de el conjunto completo de decisiones de tu investigación y qué podrás afirmar con ella, y esa decisión se sostiene solo si
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Coherencia interna** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Coherencia interna de Alcance declarado.** El trabajo aquí es separar lo observado de lo interpretado sobre **Alcance declarado**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Limitación como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Limitación**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.

**Paso 4 — Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con Contribución a la vista.** Con **Contribución** ya delimitado, la pregunta pasa a ser de consecuencia: qué cambia para los estudiantes, para el tiempo de clase y para la carga del equipo. **Evidencia de partida** entrega la lectura observable; el juicio profesional sigue siendo humano y debe quedar firmado por quien lo hace.
...
**Frontera de aplicación.** Una investigación de magíster produce evidencia acotada: Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre proyecto integrador: investigación de nivel magíster |
|---|---|
...
Guárdala en `evidence/P16-C204-proyecto-integrador-investigacion-de-nivel-magister/` con estos archivos:
