...
**Estado de evidencia:** `PRACTICA-PROFESIONAL` · **Etapa:** 🔴 Etapa E — Investigación avanzada y formación de formadores · **Población de referencia:** investigación aplicada, tesis de magíster e investigación institucional<br>
**Decisión que habilita:** determinar qué se sabe con solidez sobre tu problema y dónde está el vacío que justifica tu investigación<br>
...
2. Clasificar la situación distinguiendo **Estrategia de búsqueda** de **Criterio de inclusión**.
3. Decidir con fundamento, usando **Evaluación crítica** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Vacío** a la vista.
...
| **Evidencia de logro** | qué muestra una revisión de literatura con estrategia de búsqueda documentada, criterios de selección y síntesis crítica frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
Toda revisión tiene sesgo de publicación: Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Estrategia de búsqueda"]
    C --> A2["Criterio de inclusión"]
    C --> A3["Evaluación crítica"]
    C --> A4["Vacío"]
    A1 & A2 & A3 & A4 --> D{{"determinar qué se sabe<br/>con solidez sobre tu<br/>problema y dónde está el<br/>vacío que justifica tu…"}}
    D --> E["Evidencia de aprendizaje<br/>una revisión de<br/>literatura con<br/>estrategia de búsqueda<br/>documentada, criterios<br/>de selección y…"]
...
inocua: produce decisiones que atacan el problema equivocado. **Estrategia de búsqueda** no es lo
mismo que **Criterio de inclusión** —regla explícita que define qué estudios entran en la revisión y cuáles no—, y tratarlos como sinónimos hace
que la intervención se dirija al lugar incorrecto. Del mismo modo, **Evaluación crítica** y
**Vacío** describen aspectos distintos de la misma situación: el primero
juicio sobre la calidad metodológica de cada estudio y sobre lo que permite afirmar, mientras el segundo aspecto del problema que la literatura no resuelve y que justifica una nueva investigación.
...
- **Evidencia de logro.** Qué muestra una revisión de literatura con estrategia de búsqueda documentada, criterios de selección y síntesis crítica frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
te deja en condiciones de qué se sabe con solidez sobre tu problema y dónde está el vacío que justifica tu investigación, y esa decisión se sostiene solo si
...
|---|---|---|
| Petticrew, M. & Roberts, H. (2006). *Systematic Reviews in the Social Sciences*. | metodología de revisión sistemática aplicable también a revisiones más acotadas. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
| Boote, D. & Beile, P. (2005). *Scholars Before Researchers*. | argumenta y operacionaliza qué hace buena a una revisión de literatura de tesis. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Estrategia de búsqueda** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Estrategia de búsqueda de Criterio de inclusión.** El trabajo aquí es separar lo observado de lo interpretado sobre **Criterio de inclusión**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Evaluación crítica como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Evaluación crítica**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.

**Paso 4 — Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con Vacío a la vista.** Con **Vacío** ya delimitado, la pregunta pasa a ser de consecuencia: qué cambia para los estudiantes, para el tiempo de clase y para la carga del equipo. **Evidencia de partida** entrega la lectura observable; el juicio profesional sigue siendo humano y debe quedar firmado por quien lo hace.
...
|---|---|---|---|
| Intervenir sobre **Estrategia de búsqueda** | Conjunto de fuentes, términos y filtros usados, documentado para ser reproducible | Cuando **Evidencia de partida** es observable y accionable dentro del plazo de la decisión. | Sobrerreaccionar a una señal parcial. |
| Intervenir sobre **Criterio de inclusión** | Regla explícita que define qué estudios entran en la revisión y cuáles no | Cuando la primera explicación no distingue mecanismo ni responsable. | Convertir el concepto en etiqueta y no en intervención. |
| Observar antes de decidir | Reducir la incertidumbre antes de comprometer tiempo y credibilidad | Cuando la decisión es reversible y la evidencia disponible no distingue causas. | Observar indefinidamente y no decidir nunca. |
| Derivar o escalar | Poner la decisión donde están la competencia y la responsabilidad | Cuando hay normativa, resguardo de datos, salud o vulneración de derechos en juego. | Delegar hacia arriba lo que sí correspondía decidir en el aula. |

**Frontera de aplicación.** Toda revisión tiene sesgo de publicación: Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre revisión de literatura |
|---|---|
...
Guárdala en `evidence/P16-C195-revision-de-literatura/` con estos archivos:
...
Riesgo característico de esta parte: **Elegir el método antes de tener la pregunta delimitada.** Antes de aplicar
