...
**Decisión que habilita:** determinar cómo la seguridad quedará incorporada al criterio de evaluación de cada desempeño y no como contenido aparte<br>
...
2. Clasificar la situación distinguiendo **Riesgo** de **Medida de control**.
3. Decidir con fundamento, usando **Cultura preventiva** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Responsabilidad institucional** a la vista.
...
| **Evidencia de logro** | qué muestra una matriz de riesgos de tu taller con medidas, responsables y su integración en los criterios de evaluación frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
La normativa de seguridad y salud en el trabajo cambia y varía por sector; Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Riesgo"]
    C --> A2["Medida de control"]
    C --> A3["Cultura preventiva"]
    C --> A4["Responsabilidad<br/>institucional"]
    A1 & A2 & A3 & A4 --> D{{"determinar cómo la<br/>seguridad quedará<br/>incorporada al criterio<br/>de evaluación de cada<br/>desempeño y…"}}
    D --> E["Evidencia de aprendizaje<br/>una matriz de riesgos de<br/>tu taller con medidas,<br/>responsables y su<br/>integración en los<br/>criterios…"]
...
inocua: produce decisiones que atacan el problema equivocado. **Riesgo** no es lo
...
- **Evidencia de logro.** Qué muestra una matriz de riesgos de tu taller con medidas, responsables y su integración en los criterios de evaluación frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
te deja en condiciones de cómo la seguridad quedará incorporada al criterio de evaluación de cada desempeño y no como contenido aparte, y esa decisión se sostiene solo si
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Riesgo** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Riesgo de Medida de control.** El trabajo aquí es separar lo observado de lo interpretado sobre **Medida de control**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Cultura preventiva como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Cultura preventiva**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.

**Paso 4 — Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con Responsabilidad institucional a la vista.** Con **Responsabilidad institucional** ya delimitado, la pregunta pasa a ser de consecuencia: qué cambia para los estudiantes, para el tiempo de clase y para la carga del equipo. **Evidencia de partida** entrega la lectura observable; el juicio profesional sigue siendo humano y debe quedar firmado por quien lo hace.
...
|---|---|---|---|
| Intervenir sobre **Riesgo** | Probabilidad de que ocurra un daño asociado a una tarea, equipo o condición | Cuando **Evidencia de partida** es observable y accionable dentro del plazo de la decisión. | Sobrerreaccionar a una señal parcial. |
| Intervenir sobre **Medida de control** | Acción que elimina, reduce o señaliza un riesgo, con jerarquía definida | Cuando la primera explicación no distingue mecanismo ni responsable. | Convertir el concepto en etiqueta y no en intervención. |
| Observar antes de decidir | Reducir la incertidumbre antes de comprometer tiempo y credibilidad | Cuando la decisión es reversible y la evidencia disponible no distingue causas. | Observar indefinidamente y no decidir nunca. |
| Derivar o escalar | Poner la decisión donde están la competencia y la responsabilidad | Cuando hay normativa, resguardo de datos, salud o vulneración de derechos en juego. | Delegar hacia arriba lo que sí correspondía decidir en el aula. |

**Frontera de aplicación.** La normativa de seguridad y salud en el trabajo cambia y varía por sector; Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre seguridad y cultura preventiva |
|---|---|
...
Guárdala en `evidence/P06-C076-seguridad-y-cultura-preventiva/` con estos archivos:
