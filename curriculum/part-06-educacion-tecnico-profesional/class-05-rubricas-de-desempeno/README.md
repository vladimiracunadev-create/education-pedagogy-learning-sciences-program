...
**Decisión que habilita:** determinar los descriptores de cada nivel de desempeño para que la evaluación no dependa del evaluador<br>
...
2. Clasificar la situación distinguiendo **Descriptor** de **Nivel de desempeño**.
3. Decidir con fundamento, usando **Acuerdo entre evaluadores** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Criterio crítico** a la vista.
...
| **Evidencia de logro** | qué muestra una rúbrica de desempeño calibrada con evidencia de acuerdo entre dos evaluadores sobre trabajos reales frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
Las rúbricas mejoran la consistencia pero no garantizan validez: Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Descriptor"]
    C --> A2["Nivel de desempeño"]
    C --> A3["Acuerdo entre<br/>evaluadores"]
    C --> A4["Criterio crítico"]
    A1 & A2 & A3 & A4 --> D{{"determinar los<br/>descriptores de cada<br/>nivel de desempeño para<br/>que la evaluación no<br/>dependa del…"}}
    D --> E["Evidencia de aprendizaje<br/>una rúbrica de desempeño<br/>calibrada con evidencia<br/>de acuerdo entre dos<br/>evaluadores sobre…"]
...
inocua: produce decisiones que atacan el problema equivocado. **Descriptor** no es lo
mismo que **Nivel de desempeño** —grado de calidad diferenciado por rasgos concretos y no por intensidad del adverbio—, y tratarlos como sinónimos hace
que la intervención se dirija al lugar incorrecto. Del mismo modo, **Acuerdo entre evaluadores** y
**Criterio crítico** describen aspectos distintos de la misma situación: el primero
grado en que dos personas asignan el mismo nivel al mismo desempeño, mientras el segundo aspecto cuyo incumplimiento invalida el desempeño completo, típicamente la seguridad.
...
- **Evidencia de logro.** Qué muestra una rúbrica de desempeño calibrada con evidencia de acuerdo entre dos evaluadores sobre trabajos reales frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
te deja en condiciones de los descriptores de cada nivel de desempeño para que la evaluación no dependa del evaluador, y esa decisión se sostiene solo si
...
|---|---|---|
| Jonsson, A. & Svingby, G. (2007). *The Use of Scoring Rubrics*. | evidencia sobre cuándo las rúbricas mejoran la consistencia y qué las hace fallar. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
| Sadler, D. R. (2009). *Indeterminacy in the Use of Preset Criteria for Assessment*. | advierte sobre los límites de los criterios prefijados en desempeños complejos. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Descriptor** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Descriptor de Nivel de desempeño.** El trabajo aquí es separar lo observado de lo interpretado sobre **Nivel de desempeño**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Acuerdo entre evaluadores como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Acuerdo entre evaluadores**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.

**Paso 4 — Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con Criterio crítico a la vista.** Con **Criterio crítico** ya delimitado, la pregunta pasa a ser de consecuencia: qué cambia para los estudiantes, para el tiempo de clase y para la carga del equipo. **Evidencia de partida** entrega la lectura observable; el juicio profesional sigue siendo humano y debe quedar firmado por quien lo hace.
...
|---|---|---|---|
| Intervenir sobre **Descriptor** | Descripción observable de lo que se hace en un nivel de desempeño determinado | Cuando **Evidencia de partida** es observable y accionable dentro del plazo de la decisión. | Sobrerreaccionar a una señal parcial. |
| Intervenir sobre **Nivel de desempeño** | Grado de calidad diferenciado por rasgos concretos y no por intensidad del adverbio | Cuando la primera explicación no distingue mecanismo ni responsable. | Convertir el concepto en etiqueta y no en intervención. |
| Observar antes de decidir | Reducir la incertidumbre antes de comprometer tiempo y credibilidad | Cuando la decisión es reversible y la evidencia disponible no distingue causas. | Observar indefinidamente y no decidir nunca. |
| Derivar o escalar | Poner la decisión donde están la competencia y la responsabilidad | Cuando hay normativa, resguardo de datos, salud o vulneración de derechos en juego. | Delegar hacia arriba lo que sí correspondía decidir en el aula. |

**Frontera de aplicación.** Las rúbricas mejoran la consistencia pero no garantizan validez: Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre rúbricas de desempeño |
|---|---|
...
Guárdala en `evidence/P06-C077-rubricas-de-desempeno/` con estos archivos:
