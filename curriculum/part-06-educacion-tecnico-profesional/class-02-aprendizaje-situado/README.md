...
**Estado de evidencia:** `CONSISTENTE` · **Etapa:** 🔵 Etapa B — Enseñanza por ciclo vital · **Población de referencia:** formación técnica de nivel medio y superior, y capacitación de oficio<br>
**Decisión que habilita:** determinar qué nivel de participación real puede asumir tu estudiante ahora y cuál será el siguiente<br>
...
2. Clasificar la situación distinguiendo **Comunidad de práctica** de **Participación periférica legítima**.
3. Decidir con fundamento, usando **Aprendizaje situado** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Progresión de responsabilidad** a la vista.
...
| **Evidencia de logro** | qué muestra una progresión de participación desde tareas periféricas hasta responsabilidad plena, con criterios de avance frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
El aprendizaje situado es un marco descriptivo potente y no un método con protocolo probado; Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Comunidad de práctica"]
    C --> A2["Participación<br/>periférica legítima"]
    C --> A3["Aprendizaje situado"]
    C --> A4["Progresión de<br/>responsabilidad"]
    A1 & A2 & A3 & A4 --> D{{"determinar qué nivel de<br/>participación real puede<br/>asumir tu estudiante<br/>ahora y cuál será el…"}}
    D --> E["Evidencia de aprendizaje<br/>una progresión de<br/>participación desde<br/>tareas periféricas hasta<br/>responsabilidad plena,<br/>con…"]
...
inocua: produce decisiones que atacan el problema equivocado. **Comunidad de práctica** no es lo
mismo que **Participación periférica legítima** —involucramiento real pero acotado del aprendiz en el trabajo de la comunidad—, y tratarlos como sinónimos hace
que la intervención se dirija al lugar incorrecto. Del mismo modo, **Aprendizaje situado** y
**Progresión de responsabilidad** describen aspectos distintos de la misma situación: el primero
adquisición de competencias en el contexto real donde se usan, mientras el segundo aumento gradual de la exigencia y de la autonomía en la tarea.
...
- **Evidencia de logro.** Qué muestra una progresión de participación desde tareas periféricas hasta responsabilidad plena, con criterios de avance frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
te deja en condiciones de qué nivel de participación real puede asumir tu estudiante ahora y cuál será el siguiente, y esa decisión se sostiene solo si
...
|---|---|---|
| Lave, J. & Wenger, E. (1991). *Situated Learning*. | el texto que define participación periférica legítima y explica cómo se aprende un oficio. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
| Billett, S. (2001). *Learning in the Workplace*. | traduce el enfoque a decisiones de diseño de formación en el puesto de trabajo. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
...
**Situación.** En la especialidad de administración, los estudiantes aprueban las pruebas escritas del módulo y fallan en la práctica profesional: no saben conciliar una cuenta ni explicar un error a un cliente. Dos empresas devolvieron practicantes.

**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Comunidad de práctica** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Comunidad de práctica de Participación periférica legítima.** El trabajo aquí es separar lo observado de lo interpretado sobre **Participación periférica legítima**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Aprendizaje situado como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Aprendizaje situado**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.

**Paso 4 — Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con Progresión de responsabilidad a la vista.** Con **Progresión de responsabilidad** ya delimitado, la pregunta pasa a ser de consecuencia: qué cambia para los estudiantes, para el tiempo de clase y para la carga del equipo. **Evidencia de partida** entrega la lectura observable; el juicio profesional sigue siendo humano y debe quedar firmado por quien lo hace.
...
|---|---|---|---|
| Intervenir sobre **Comunidad de práctica** | Grupo que comparte un oficio, sus estándares y sus formas de hacer las cosas | Cuando **Evidencia de partida** es observable y accionable dentro del plazo de la decisión. | Sobrerreaccionar a una señal parcial. |
| Intervenir sobre **Participación periférica legítima** | Involucramiento real pero acotado del aprendiz en el trabajo de la comunidad | Cuando la primera explicación no distingue mecanismo ni responsable. | Convertir el concepto en etiqueta y no en intervención. |
| Observar antes de decidir | Reducir la incertidumbre antes de comprometer tiempo y credibilidad | Cuando la decisión es reversible y la evidencia disponible no distingue causas. | Observar indefinidamente y no decidir nunca. |
| Derivar o escalar | Poner la decisión donde están la competencia y la responsabilidad | Cuando hay normativa, resguardo de datos, salud o vulneración de derechos en juego. | Delegar hacia arriba lo que sí correspondía decidir en el aula. |

**Frontera de aplicación.** El aprendizaje situado es un marco descriptivo potente y no un método con protocolo probado; Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre aprendizaje situado |
|---|---|
...
Guárdala en `evidence/P06-C074-aprendizaje-situado/` con estos archivos:
...
Esta evidencia alimenta el artefacto de la parte: **módulo técnico-profesional completo con competencias evaluables, seguridad integrada, rúbricas calibradas y portafolio de evidencias**.
...
Riesgo característico de esta parte: **Evaluar el oficio con pruebas escritas en vez de desempeños observables.** Antes de aplicar
