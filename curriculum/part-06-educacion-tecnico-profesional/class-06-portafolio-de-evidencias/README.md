...
**Estado de evidencia:** `PRACTICA-PROFESIONAL` · **Etapa:** 🔵 Etapa B — Enseñanza por ciclo vital · **Población de referencia:** formación técnica de nivel medio y superior, y capacitación de oficio<br>
**Decisión que habilita:** determinar qué evidencias son suficientes para afirmar que una competencia está lograda<br>
...
2. Clasificar la situación distinguiendo **Portafolio de evidencias** de **Trazabilidad**.
3. Decidir con fundamento, usando **Suficiencia** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Autenticidad** a la vista.
...
| **Evidencia de logro** | qué muestra la estructura de un portafolio con evidencias requeridas por competencia, criterios de suficiencia y sistema de verificación frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
Los portafolios son costosos de evaluar y su consistencia entre evaluadores es baja sin criterios explícitos y calibración. Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Portafolio de<br/>evidencias"]
    C --> A2["Trazabilidad"]
    C --> A3["Suficiencia"]
    C --> A4["Autenticidad"]
    A1 & A2 & A3 & A4 --> D{{"determinar qué<br/>evidencias son<br/>suficientes para afirmar<br/>que una competencia está<br/>lograda"}}
    D --> E["Evidencia de aprendizaje<br/>la estructura de un<br/>portafolio con<br/>evidencias requeridas<br/>por competencia,<br/>criterios de…"]
...
inocua: produce decisiones que atacan el problema equivocado. **Portafolio de evidencias** no es lo
mismo que **Trazabilidad** —posibilidad de vincular cada evidencia con la competencia, la fecha y las condiciones en que se produjo—, y tratarlos como sinónimos hace
que la intervención se dirija al lugar incorrecto. Del mismo modo, **Suficiencia** y
**Autenticidad** describen aspectos distintos de la misma situación: el primero
cantidad y variedad de evidencia necesaria para sostener la afirmación de logro, mientras el segundo garantía de que la evidencia fue producida por el estudiante en las condiciones declaradas.
...
- **Evidencia de logro.** Qué muestra la estructura de un portafolio con evidencias requeridas por competencia, criterios de suficiencia y sistema de verificación frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
te deja en condiciones de qué evidencias son suficientes para afirmar que una competencia está lograda, y esa decisión se sostiene solo si
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Portafolio de evidencias** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Portafolio de evidencias de Trazabilidad.** El trabajo aquí es separar lo observado de lo interpretado sobre **Trazabilidad**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Suficiencia como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Suficiencia**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.

**Paso 4 — Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con Autenticidad a la vista.** Con **Autenticidad** ya delimitado, la pregunta pasa a ser de consecuencia: qué cambia para los estudiantes, para el tiempo de clase y para la carga del equipo. **Evidencia de partida** entrega la lectura observable; el juicio profesional sigue siendo humano y debe quedar firmado por quien lo hace.
...
|---|---|---|---|
| Intervenir sobre **Portafolio de evidencias** | Conjunto organizado de productos y registros que documentan el logro de competencias | Cuando **Evidencia de partida** es observable y accionable dentro del plazo de la decisión. | Sobrerreaccionar a una señal parcial. |
| Intervenir sobre **Trazabilidad** | Posibilidad de vincular cada evidencia con la competencia, la fecha y las condiciones en que se produjo | Cuando la primera explicación no distingue mecanismo ni responsable. | Convertir el concepto en etiqueta y no en intervención. |
| Observar antes de decidir | Reducir la incertidumbre antes de comprometer tiempo y credibilidad | Cuando la decisión es reversible y la evidencia disponible no distingue causas. | Observar indefinidamente y no decidir nunca. |
| Derivar o escalar | Poner la decisión donde están la competencia y la responsabilidad | Cuando hay normativa, resguardo de datos, salud o vulneración de derechos en juego. | Delegar hacia arriba lo que sí correspondía decidir en el aula. |

**Frontera de aplicación.** Los portafolios son costosos de evaluar y su consistencia entre evaluadores es baja sin criterios explícitos y calibración. Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre portafolio de evidencias |
|---|---|
...
Guárdala en `evidence/P06-C078-portafolio-de-evidencias/` con estos archivos:
