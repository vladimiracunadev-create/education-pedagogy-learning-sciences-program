...
**Estado de evidencia:** `MARCO-NORMATIVO` · **Etapa:** 🔵 Etapa B — Enseñanza por ciclo vital · **Población de referencia:** formación técnica de nivel medio y superior, y capacitación de oficio<br>
**Decisión que habilita:** determinar qué objetivos de aprendizaje debe cumplir la práctica y cómo se supervisarán efectivamente<br>
...
2. Clasificar la situación distinguiendo **Práctica profesional** de **Plan de práctica**.
3. Decidir con fundamento, usando **Supervisión efectiva** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Resguardo del estudiante** a la vista.
...
| **Evidencia de logro** | qué muestra un plan de práctica profesional con objetivos, supervisión, instrumentos de evaluación y resguardos declarados frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
La normativa sobre práctica profesional —duración, requisitos, seguro, obligaciones del establecimiento— es específica y cambia; Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Práctica profesional"]
    C --> A2["Plan de práctica"]
    C --> A3["Supervisión efectiva"]
    C --> A4["Resguardo del<br/>estudiante"]
    A1 & A2 & A3 & A4 --> D{{"determinar qué objetivos<br/>de aprendizaje debe<br/>cumplir la práctica y<br/>cómo se supervisarán…"}}
    D --> E["Evidencia de aprendizaje<br/>un plan de práctica<br/>profesional con<br/>objetivos, supervisión,<br/>instrumentos de<br/>evaluación y…"]
...
inocua: produce decisiones que atacan el problema equivocado. **Práctica profesional** no es lo
mismo que **Plan de práctica** —documento que define objetivos, tareas, supervisión y evaluación del período—, y tratarlos como sinónimos hace
que la intervención se dirija al lugar incorrecto. Del mismo modo, **Supervisión efectiva** y
**Resguardo del estudiante** describen aspectos distintos de la misma situación: el primero
contacto real y periódico del docente supervisor con el estudiante y con la empresa, mientras el segundo condiciones de seguridad, horario, seguro escolar y protección frente a abusos.
...
- **Evidencia de logro.** Qué muestra un plan de práctica profesional con objetivos, supervisión, instrumentos de evaluación y resguardos declarados frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
te deja en condiciones de qué objetivos de aprendizaje debe cumplir la práctica y cómo se supervisarán efectivamente, y esa decisión se sostiene solo si
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Práctica profesional** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Práctica profesional de Plan de práctica.** El trabajo aquí es separar lo observado de lo interpretado sobre **Plan de práctica**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Supervisión efectiva como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Supervisión efectiva**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.

**Paso 4 — Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con Resguardo del estudiante a la vista.** Con **Resguardo del estudiante** ya delimitado, la pregunta pasa a ser de consecuencia: qué cambia para los estudiantes, para el tiempo de clase y para la carga del equipo. **Evidencia de partida** entrega la lectura observable; el juicio profesional sigue siendo humano y debe quedar firmado por quien lo hace.
...
|---|---|---|---|
| Intervenir sobre **Práctica profesional** | Período de desempeño en contexto laboral real como requisito formativo y de titulación | Cuando **Evidencia de partida** es observable y accionable dentro del plazo de la decisión. | Sobrerreaccionar a una señal parcial. |
| Intervenir sobre **Plan de práctica** | Documento que define objetivos, tareas, supervisión y evaluación del período | Cuando la primera explicación no distingue mecanismo ni responsable. | Convertir el concepto en etiqueta y no en intervención. |
| Observar antes de decidir | Reducir la incertidumbre antes de comprometer tiempo y credibilidad | Cuando la decisión es reversible y la evidencia disponible no distingue causas. | Observar indefinidamente y no decidir nunca. |
| Derivar o escalar | Poner la decisión donde están la competencia y la responsabilidad | Cuando hay normativa, resguardo de datos, salud o vulneración de derechos en juego. | Delegar hacia arriba lo que sí correspondía decidir en el aula. |

**Frontera de aplicación.** La normativa sobre práctica profesional —duración, requisitos, seguro, obligaciones del establecimiento— es específica y cambia; Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre práctica profesional |
|---|---|
...
Guárdala en `evidence/P06-C081-practica-profesional/` con estos archivos:
