...
**Decisión que habilita:** determinar qué acuerdos concretos sostienen una relación útil con una empresa y qué se ofrece a cambio<br>
...
2. Clasificar la situación distinguiendo **Vinculación con el medio** de **Beneficio mutuo**.
3. Decidir con fundamento, usando **Consejo asesor empresarial** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Actualización del perfil** a la vista.
...
| **Evidencia de logro** | qué muestra un convenio de vinculación con objetivos, compromisos de ambas partes, indicadores y mecanismo de revisión frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
El vínculo tiene tensiones reales: Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Vinculación con el<br/>medio"]
    C --> A2["Beneficio mutuo"]
    C --> A3["Consejo asesor<br/>empresarial"]
    C --> A4["Actualización del<br/>perfil"]
    A1 & A2 & A3 & A4 --> D{{"determinar qué acuerdos<br/>concretos sostienen una<br/>relación útil con una<br/>empresa y qué se ofrece<br/>a…"}}
    D --> E["Evidencia de aprendizaje<br/>un convenio de<br/>vinculación con<br/>objetivos, compromisos<br/>de ambas partes,<br/>indicadores y mecanismo…"]
...
- **Evidencia de logro.** Qué muestra un convenio de vinculación con objetivos, compromisos de ambas partes, indicadores y mecanismo de revisión frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
te deja en condiciones de qué acuerdos concretos sostienen una relación útil con una empresa y qué se ofrece a cambio, y esa decisión se sostiene solo si
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Vinculación con el medio** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Vinculación con el medio de Beneficio mutuo.** El trabajo aquí es separar lo observado de lo interpretado sobre **Beneficio mutuo**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Consejo asesor empresarial como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Consejo asesor empresarial**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.

**Paso 4 — Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con Actualización del perfil a la vista.** Con **Actualización del perfil** ya delimitado, la pregunta pasa a ser de consecuencia: qué cambia para los estudiantes, para el tiempo de clase y para la carga del equipo. **Evidencia de partida** entrega la lectura observable; el juicio profesional sigue siendo humano y debe quedar firmado por quien lo hace.
...
**Frontera de aplicación.** El vínculo tiene tensiones reales: Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre vínculo educación-empresa |
|---|---|
...
Guárdala en `evidence/P06-C080-vinculo-educacion-empresa/` con estos archivos:
