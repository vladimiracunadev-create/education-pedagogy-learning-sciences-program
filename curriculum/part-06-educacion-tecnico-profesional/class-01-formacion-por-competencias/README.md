...
**Decisión que habilita:** determinar el estándar de desempeño que hará observable la competencia que declaraste<br>
...
2. Clasificar la situación distinguiendo **Competencia** de **Estándar de desempeño**.
3. Decidir con fundamento, usando **Evidencia de competencia** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Condición de ejecución** a la vista.
...
| **Evidencia de logro** | qué muestra tres competencias reescritas con su estándar de desempeño, sus evidencias y sus condiciones de ejecución frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
El enfoque de competencias tiene críticas legítimas: Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Competencia"]
    C --> A2["Estándar de desempeño"]
    C --> A3["Evidencia de<br/>competencia"]
    C --> A4["Condición de ejecución"]
    A1 & A2 & A3 & A4 --> D{{"determinar el estándar<br/>de desempeño que hará<br/>observable la<br/>competencia que<br/>declaraste"}}
    D --> E["Evidencia de aprendizaje<br/>tres competencias<br/>reescritas con su<br/>estándar de desempeño,<br/>sus evidencias y sus<br/>condiciones de…"]
...
mismo que **Estándar de desempeño** —descripción del nivel exigido: qué hace, con qué calidad y en qué condiciones—, y tratarlos como sinónimos hace
que la intervención se dirija al lugar incorrecto. Del mismo modo, **Evidencia de competencia** y
**Condición de ejecución** describen aspectos distintos de la misma situación: el primero
producto, desempeño o registro que permite afirmar que la competencia se posee, mientras el segundo contexto, materiales, tiempo y restricciones en que se demuestra el desempeño.
...
- **Evidencia de logro.** Qué muestra tres competencias reescritas con su estándar de desempeño, sus evidencias y sus condiciones de ejecución frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
te deja en condiciones de el estándar de desempeño que hará observable la competencia que declaraste, y esa decisión se sostiene solo si
...
**Paso 2 — Clasificar la situación distinguiendo Competencia de Estándar de desempeño.** El trabajo aquí es separar lo observado de lo interpretado sobre **Estándar de desempeño**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Evidencia de competencia como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Evidencia de competencia**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.

**Paso 4 — Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con Condición de ejecución a la vista.** Con **Condición de ejecución** ya delimitado, la pregunta pasa a ser de consecuencia: qué cambia para los estudiantes, para el tiempo de clase y para la carga del equipo. **Evidencia de partida** entrega la lectura observable; el juicio profesional sigue siendo humano y debe quedar firmado por quien lo hace.
...
|---|---|---|---|
| Intervenir sobre **Competencia** | Capacidad de movilizar conocimientos, procedimientos y criterios en una situación real del oficio | Cuando **Evidencia de partida** es observable y accionable dentro del plazo de la decisión. | Sobrerreaccionar a una señal parcial. |
| Intervenir sobre **Estándar de desempeño** | Descripción del nivel exigido: qué hace, con qué calidad y en qué condiciones | Cuando la primera explicación no distingue mecanismo ni responsable. | Convertir el concepto en etiqueta y no en intervención. |
| Observar antes de decidir | Reducir la incertidumbre antes de comprometer tiempo y credibilidad | Cuando la decisión es reversible y la evidencia disponible no distingue causas. | Observar indefinidamente y no decidir nunca. |
| Derivar o escalar | Poner la decisión donde están la competencia y la responsabilidad | Cuando hay normativa, resguardo de datos, salud o vulneración de derechos en juego. | Delegar hacia arriba lo que sí correspondía decidir en el aula. |

**Frontera de aplicación.** El enfoque de competencias tiene críticas legítimas: Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre formación por competencias |
|---|---|
...
Guárdala en `evidence/P06-C073-formacion-por-competencias/` con estos archivos:
