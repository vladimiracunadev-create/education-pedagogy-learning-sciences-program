...
**Decisión que habilita:** determinar la estructura de tu sesión de taller para maximizar la práctica efectiva de cada estudiante<br>
...
2. Clasificar la situación distinguiendo **Demostración** de **Práctica con corrección**.
3. Decidir con fundamento, usando **Tiempo de práctica efectiva** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Rotación** a la vista.
...
| **Evidencia de logro** | qué muestra el diseño de una sesión de taller con secuencia, rotación, tiempos y verificación individual del desempeño frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
La demostración es necesaria y no suficiente: Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Demostración"]
    C --> A2["Práctica con<br/>corrección"]
    C --> A3["Tiempo de práctica<br/>efectiva"]
    C --> A4["Rotación"]
    A1 & A2 & A3 & A4 --> D{{"determinar la estructura<br/>de tu sesión de taller<br/>para maximizar la<br/>práctica efectiva de<br/>cada…"}}
    D --> E["Evidencia de aprendizaje<br/>el diseño de una sesión<br/>de taller con secuencia,<br/>rotación, tiempos y<br/>verificación individual…"]
...
- **Evidencia de logro.** Qué muestra el diseño de una sesión de taller con secuencia, rotación, tiempos y verificación individual del desempeño frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
te deja en condiciones de la estructura de tu sesión de taller para maximizar la práctica efectiva de cada estudiante, y esa decisión se sostiene solo si
...
|---|---|---|
| Rosenshine, B. (2012). *Principles of Instruction*. | la secuencia de demostración, práctica guiada e independiente aplicada a cualquier destreza. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
| Ericsson, K. A. & Pool, R. (2016). *Peak: Secrets from the New Science of Expertise*. | fundamenta la práctica deliberada con retroalimentación como mecanismo de dominio técnico. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Demostración** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Demostración de Práctica con corrección.** El trabajo aquí es separar lo observado de lo interpretado sobre **Práctica con corrección**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Tiempo de práctica efectiva como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Tiempo de práctica efectiva**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.
...
**Frontera de aplicación.** La demostración es necesaria y no suficiente: Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre talleres y laboratorios |
|---|---|
...
Guárdala en `evidence/P06-C075-talleres-y-laboratorios/` con estos archivos:
