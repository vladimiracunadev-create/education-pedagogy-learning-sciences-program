...
**Estado de evidencia:** `EN-DEBATE` · **Etapa:** 🔵 Etapa B — Enseñanza por ciclo vital · **Población de referencia:** 1.º a 8.º básico (6 a 13 años)<br>
**Decisión que habilita:** determinar qué competencia digital específica vas a enseñar y cómo la evaluarás con desempeño real<br>
...
2. Clasificar la situación distinguiendo **Alfabetización digital** de **Evaluación de información**.
3. Decidir con fundamento, usando **Lectura lateral** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Huella y privacidad** a la vista.
...
| **Evidencia de logro** | qué muestra una secuencia de alfabetización digital con una tarea de evaluación de información y sus criterios frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
El campo cambia rápido y la evidencia sobre intervenciones es limitada y de corto plazo. Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Alfabetización digital"]
    C --> A2["Evaluación de<br/>información"]
    C --> A3["Lectura lateral"]
    C --> A4["Huella y privacidad"]
    A1 & A2 & A3 & A4 --> D{{"determinar qué<br/>competencia digital<br/>específica vas a enseñar<br/>y cómo la evaluarás con<br/>desempeño…"}}
    D --> E["Evidencia de aprendizaje<br/>una secuencia de<br/>alfabetización digital<br/>con una tarea de<br/>evaluación de<br/>información y sus…"]
...
inocua: produce decisiones que atacan el problema equivocado. **Alfabetización digital** no es lo
mismo que **Evaluación de información** —juicio sobre la credibilidad de una fuente digital: quién la produce, con qué interés y con qué respaldo—, y tratarlos como sinónimos hace
que la intervención se dirija al lugar incorrecto. Del mismo modo, **Lectura lateral** y
**Huella y privacidad** describen aspectos distintos de la misma situación: el primero
estrategia de verificar una fuente saliendo de ella y consultando otras, en vez de analizarla internamente, mientras el segundo rastro de datos que deja el uso de servicios digitales y sus consecuencias.
...
- **Evidencia de logro.** Qué muestra una secuencia de alfabetización digital con una tarea de evaluación de información y sus criterios frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
te deja en condiciones de qué competencia digital específica vas a enseñar y cómo la evaluarás con desempeño real, y esa decisión se sostiene solo si
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Alfabetización digital** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Alfabetización digital de Evaluación de información.** El trabajo aquí es separar lo observado de lo interpretado sobre **Evaluación de información**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Lectura lateral como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Lectura lateral**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.

**Paso 4 — Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con Huella y privacidad a la vista.** Con **Huella y privacidad** ya delimitado, la pregunta pasa a ser de consecuencia: qué cambia para los estudiantes, para el tiempo de clase y para la carga del equipo. **Evidencia de partida** entrega la lectura observable; el juicio profesional sigue siendo humano y debe quedar firmado por quien lo hace.
...
|---|---|---|---|
| Intervenir sobre **Alfabetización digital** | Capacidad de buscar, evaluar, producir y comunicar información con medios digitales | Cuando **Evidencia de partida** es observable y accionable dentro del plazo de la decisión. | Sobrerreaccionar a una señal parcial. |
| Intervenir sobre **Evaluación de información** | Juicio sobre la credibilidad de una fuente digital: quién la produce, con qué interés y con qué respaldo | Cuando la primera explicación no distingue mecanismo ni responsable. | Convertir el concepto en etiqueta y no en intervención. |
| Observar antes de decidir | Reducir la incertidumbre antes de comprometer tiempo y credibilidad | Cuando la decisión es reversible y la evidencia disponible no distingue causas. | Observar indefinidamente y no decidir nunca. |
| Derivar o escalar | Poner la decisión donde están la competencia y la responsabilidad | Cuando hay normativa, resguardo de datos, salud o vulneración de derechos en juego. | Delegar hacia arriba lo que sí correspondía decidir en el aula. |

**Frontera de aplicación.** El campo cambia rápido y la evidencia sobre intervenciones es limitada y de corto plazo. Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre tecnología y alfabetización digital |
|---|---|
...
Guárdala en `evidence/P04-C056-tecnologia-y-alfabetizacion-digital/` con estos archivos:
