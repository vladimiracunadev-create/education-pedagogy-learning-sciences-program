...
**Decisión que habilita:** determinar qué concepción alternativa vas a confrontar y con qué evidencia experimentable<br>
...
2. Clasificar la situación distinguiendo **Indagación guiada** de **Concepción alternativa**.
3. Decidir con fundamento, usando **Modelo científico escolar** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Evidencia** a la vista.
...
| **Evidencia de logro** | qué muestra una secuencia de indagación con predicción, contraste, explicación explícita y confrontación de la concepción alternativa frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
La indagación con guía mínima muestra resultados pobres, especialmente en estudiantes con menos conocimiento previo. Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A3["Modelo científico<br/>escolar"]
    C --> A4["Evidencia"]
    A1 & A2 & A3 & A4 --> D{{"determinar qué<br/>concepción alternativa<br/>vas a confrontar y con<br/>qué evidencia<br/>experimentable"}}
    D --> E["Evidencia de aprendizaje<br/>una secuencia de<br/>indagación con<br/>predicción, contraste,<br/>explicación explícita y<br/>confrontación de…"]
...
- **Evidencia de logro.** Qué muestra una secuencia de indagación con predicción, contraste, explicación explícita y confrontación de la concepción alternativa frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
te deja en condiciones de qué concepción alternativa vas a confrontar y con qué evidencia experimentable, y esa decisión se sostiene solo si
...
|---|---|---|
| Furtak, E. et al. (2012). *Experimental and Quasi-Experimental Studies of Inquiry-Based Science Teaching*. Review of Educational Research, 82(3). | metaanálisis que muestra el papel decisivo del grado de guía en la indagación. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
| Driver, R. et al. (1994). *Making Sense of Secondary Science*. | catálogo de concepciones alternativas por tema; herramienta directa para planificar. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
...
|---|---|---|---|
| Intervenir sobre **Indagación guiada** | Investigación estructurada por el docente donde el estudiante predice, prueba y explica | Cuando **Evidencia de partida** es observable y accionable dentro del plazo de la decisión. | Sobrerreaccionar a una señal parcial. |
| Intervenir sobre **Concepción alternativa** | Idea previa sobre fenómenos naturales, coherente y resistente a la enseñanza | Cuando la primera explicación no distingue mecanismo ni responsable. | Convertir el concepto en etiqueta y no en intervención. |
| Observar antes de decidir | Reducir la incertidumbre antes de comprometer tiempo y credibilidad | Cuando la decisión es reversible y la evidencia disponible no distingue causas. | Observar indefinidamente y no decidir nunca. |
| Derivar o escalar | Poner la decisión donde están la competencia y la responsabilidad | Cuando hay normativa, resguardo de datos, salud o vulneración de derechos en juego. | Delegar hacia arriba lo que sí correspondía decidir en el aula. |

**Frontera de aplicación.** La indagación con guía mínima muestra resultados pobres, especialmente en estudiantes con menos conocimiento previo. Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre didáctica de las ciencias |
|---|---|
...
Guárdala en `evidence/P04-C052-didactica-de-las-ciencias/` con estos archivos:
