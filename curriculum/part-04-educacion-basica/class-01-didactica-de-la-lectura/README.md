...
**Decisión que habilita:** determinar la secuencia de enseñanza lectora de tu curso y qué se evalúa en cada componente<br>
...
flowchart TB
    ...
    C --> A1["Decodificación"]
    C --> A2["Fluidez lectora"]
    C --> A3["Vocabulario"]
    C --> A4["Comprensión lectora"]
    A1 & A2 & A3 & A4 --> D{{"determinar la secuencia<br/>de enseñanza lectora de<br/>tu curso y qué se evalúa<br/>en cada componente"}}
    D --> E["Evidencia de aprendizaje<br/>una secuencia de<br/>enseñanza lectora con<br/>progresión de<br/>correspondencias,<br/>práctica de fluidez y…"]
