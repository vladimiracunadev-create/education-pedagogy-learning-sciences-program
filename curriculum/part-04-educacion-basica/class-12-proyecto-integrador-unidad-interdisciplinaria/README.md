...
**Estado de evidencia:** `CONSISTENTE` · **Etapa:** 🔵 Etapa B — Enseñanza por ciclo vital · **Población de referencia:** 1.º a 8.º básico (6 a 13 años)<br>
**Decisión que habilita:** determinar qué objetivos disciplinares se sostienen en la integración y cuáles se pierden<br>
...
2. Clasificar la situación distinguiendo **Integración curricular** de **Objetivo disciplinar**.
3. Decidir con fundamento, usando **Producto integrador** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Coordinación docente** a la vista.
...
| **Evidencia de logro** | qué muestra una unidad interdisciplinaria con objetivos por asignatura, evaluación por objetivo y análisis de su ejecución frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
La evidencia sobre enfoques integrados es mixta y depende fuertemente de la calidad del diseño y del conocimiento previo de los estudiantes. Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Integración curricular"]
    C --> A2["Objetivo disciplinar"]
    C --> A3["Producto integrador"]
    C --> A4["Coordinación docente"]
    A1 & A2 & A3 & A4 --> D{{"determinar qué objetivos<br/>disciplinares se<br/>sostienen en la<br/>integración y cuáles se<br/>pierden"}}
    D --> E["Evidencia de aprendizaje<br/>una unidad<br/>interdisciplinaria con<br/>objetivos por<br/>asignatura, evaluación<br/>por objetivo y análisis…"]
...
inocua: produce decisiones que atacan el problema equivocado. **Integración curricular** no es lo
mismo que **Objetivo disciplinar** —aprendizaje propio de una asignatura que debe seguir siendo verificable dentro de la integración—, y tratarlos como sinónimos hace
que la intervención se dirija al lugar incorrecto. Del mismo modo, **Producto integrador** y
**Coordinación docente** describen aspectos distintos de la misma situación: el primero
tarea final que exige movilizar aprendizajes de más de una disciplina, mientras el segundo acuerdo explícito entre docentes sobre objetivos, tiempos y criterios de evaluación.
...
- **Evidencia de logro.** Qué muestra una unidad interdisciplinaria con objetivos por asignatura, evaluación por objetivo y análisis de su ejecución frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
te deja en condiciones de qué objetivos disciplinares se sostienen en la integración y cuáles se pierden, y esa decisión se sostiene solo si
...
|---|---|---|
| Beane, J. (1997). *Curriculum Integration*. | la formulación más consistente de la integración curricular y sus condiciones. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
| Wiggins, G. & McTighe, J. (2005). *Understanding by Design*. | aporta el criterio de evidencia aceptable, que es lo que impide que la integración diluya objetivos. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Integración curricular** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Integración curricular de Objetivo disciplinar.** El trabajo aquí es separar lo observado de lo interpretado sobre **Objetivo disciplinar**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Producto integrador como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Producto integrador**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.

**Paso 4 — Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con Coordinación docente a la vista.** Con **Coordinación docente** ya delimitado, la pregunta pasa a ser de consecuencia: qué cambia para los estudiantes, para el tiempo de clase y para la carga del equipo. **Evidencia de partida** entrega la lectura observable; el juicio profesional sigue siendo humano y debe quedar firmado por quien lo hace.
...
|---|---|---|---|
| Intervenir sobre **Integración curricular** | Organización de la enseñanza en torno a un problema o tema que convoca a varias asignaturas | Cuando **Evidencia de partida** es observable y accionable dentro del plazo de la decisión. | Sobrerreaccionar a una señal parcial. |
| Intervenir sobre **Objetivo disciplinar** | Aprendizaje propio de una asignatura que debe seguir siendo verificable dentro de la integración | Cuando la primera explicación no distingue mecanismo ni responsable. | Convertir el concepto en etiqueta y no en intervención. |
| Observar antes de decidir | Reducir la incertidumbre antes de comprometer tiempo y credibilidad | Cuando la decisión es reversible y la evidencia disponible no distingue causas. | Observar indefinidamente y no decidir nunca. |
| Derivar o escalar | Poner la decisión donde están la competencia y la responsabilidad | Cuando hay normativa, resguardo de datos, salud o vulneración de derechos en juego. | Delegar hacia arriba lo que sí correspondía decidir en el aula. |

**Frontera de aplicación.** La evidencia sobre enfoques integrados es mixta y depende fuertemente de la calidad del diseño y del conocimiento previo de los estudiantes. Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre proyecto integrador: unidad interdisciplinaria |
|---|---|
...
Guárdala en `evidence/P04-C060-proyecto-integrador-unidad-interdisciplinaria/` con estos archivos:
