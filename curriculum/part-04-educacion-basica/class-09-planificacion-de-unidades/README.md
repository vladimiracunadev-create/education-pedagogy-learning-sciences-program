...
**Decisión que habilita:** determinar la secuencia completa de una unidad y la evidencia que recogerás en cada tramo<br>
...
2. Clasificar la situación distinguiendo **Unidad didáctica** de **Alineamiento**.
3. Decidir con fundamento, usando **Tiempo real disponible** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Evidencia intermedia** a la vista.
...
| **Evidencia de logro** | qué muestra una unidad completa de cuatro a seis semanas con alineamiento verificable y calendario realista frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
Una planificación es una hipótesis, no un contrato: Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Unidad didáctica"]
    C --> A2["Alineamiento"]
    C --> A3["Tiempo real disponible"]
    C --> A4["Evidencia intermedia"]
    A1 & A2 & A3 & A4 --> D{{"determinar la secuencia<br/>completa de una unidad y<br/>la evidencia que<br/>recogerás en cada tramo"}}
    D --> E["Evidencia de aprendizaje<br/>una unidad completa de<br/>cuatro a seis semanas<br/>con alineamiento<br/>verificable y calendario<br/>realista"]
...
inocua: produce decisiones que atacan el problema equivocado. **Unidad didáctica** no es lo
mismo que **Alineamiento** —correspondencia entre lo que se declara, lo que se enseña y lo que se evalúa—, y tratarlos como sinónimos hace
que la intervención se dirija al lugar incorrecto. Del mismo modo, **Tiempo real disponible** y
**Evidencia intermedia** describen aspectos distintos de la misma situación: el primero
horas efectivas de clase descontando evaluaciones, actos, interrupciones y ausencias, mientras el segundo información sobre el aprendizaje recogida durante la unidad y no solo al final.
...
- **Evidencia de logro.** Qué muestra una unidad completa de cuatro a seis semanas con alineamiento verificable y calendario realista frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
te deja en condiciones de la secuencia completa de una unidad y la evidencia que recogerás en cada tramo, y esa decisión se sostiene solo si
...
|---|---|---|
| Wiggins, G. & McTighe, J. (2005). *Understanding by Design*. | el procedimiento de diseño inverso, aplicable directamente a la unidad escolar. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
| Mineduc. *Programas de Estudio* vigentes. | referencia obligatoria de objetivos y progresión; base sobre la que se planifica en Chile. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Unidad didáctica** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Unidad didáctica de Alineamiento.** El trabajo aquí es separar lo observado de lo interpretado sobre **Alineamiento**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Tiempo real disponible como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Tiempo real disponible**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.

**Paso 4 — Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con Evidencia intermedia a la vista.** Con **Evidencia intermedia** ya delimitado, la pregunta pasa a ser de consecuencia: qué cambia para los estudiantes, para el tiempo de clase y para la carga del equipo. **Evidencia de partida** entrega la lectura observable; el juicio profesional sigue siendo humano y debe quedar firmado por quien lo hace.
...
|---|---|---|---|
| Intervenir sobre **Unidad didáctica** | Secuencia de clases organizada en torno a un conjunto coherente de objetivos | Cuando **Evidencia de partida** es observable y accionable dentro del plazo de la decisión. | Sobrerreaccionar a una señal parcial. |
| Intervenir sobre **Alineamiento** | Correspondencia entre lo que se declara, lo que se enseña y lo que se evalúa | Cuando la primera explicación no distingue mecanismo ni responsable. | Convertir el concepto en etiqueta y no en intervención. |
| Observar antes de decidir | Reducir la incertidumbre antes de comprometer tiempo y credibilidad | Cuando la decisión es reversible y la evidencia disponible no distingue causas. | Observar indefinidamente y no decidir nunca. |
| Derivar o escalar | Poner la decisión donde están la competencia y la responsabilidad | Cuando hay normativa, resguardo de datos, salud o vulneración de derechos en juego. | Delegar hacia arriba lo que sí correspondía decidir en el aula. |

**Frontera de aplicación.** Una planificación es una hipótesis, no un contrato: Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre planificación de unidades |
|---|---|
...
Guárdala en `evidence/P04-C057-planificacion-de-unidades/` con estos archivos:
...
- Mineduc. *Programas de Estudio* vigentes. **Uso en esta clase:** referencia obligatoria de objetivos y progresión; base sobre la que se planifica en Chile. Lectura selectiva: índice y capítulos pertinentes; registra edición y páginas consultadas.
