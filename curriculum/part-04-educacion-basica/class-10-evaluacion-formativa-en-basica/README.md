...
**Decisión que habilita:** determinar qué técnica de recogida de evidencia usarás y qué harás con lo que muestre<br>
...
2. Clasificar la situación distinguiendo **Evaluación formativa** de **Técnica de verificación**.
3. Decidir con fundamento, usando **Ajuste** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Retroalimentación utilizable** a la vista.
...
| **Evidencia de logro** | qué muestra un registro de tres ciclos de evaluación formativa con la evidencia recogida y el ajuste que produjo frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
El tamaño de efecto de la evaluación formativa se ha citado con cifras infladas provenientes de síntesis heterogéneas. Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A2["Técnica de<br/>verificación"]
    C --> A3["Ajuste"]
    C --> A4["Retroalimentación<br/>utilizable"]
    A1 & A2 & A3 & A4 --> D{{"determinar qué técnica<br/>de recogida de evidencia<br/>usarás y qué harás con<br/>lo que muestre"}}
    D --> E["Evidencia de aprendizaje<br/>un registro de tres<br/>ciclos de evaluación<br/>formativa con la<br/>evidencia recogida y el<br/>ajuste que…"]
...
mismo que **Técnica de verificación** —procedimiento breve que revela el estado de comprensión de todo el curso, no de quien responde—, y tratarlos como sinónimos hace
que la intervención se dirija al lugar incorrecto. Del mismo modo, **Ajuste** y
**Retroalimentación utilizable** describen aspectos distintos de la misma situación: el primero
cambio concreto en la enseñanza derivado de la evidencia recogida, mientras el segundo comentario que el estudiante puede aplicar en un trabajo posterior.
...
- **Evidencia de logro.** Qué muestra un registro de tres ciclos de evaluación formativa con la evidencia recogida y el ajuste que produjo frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
te deja en condiciones de qué técnica de recogida de evidencia usarás y qué harás con lo que muestre, y esa decisión se sostiene solo si
...
|---|---|---|
| Wiliam, D. (2011). *Embedded Formative Assessment*. | convierte la evaluación formativa en técnicas concretas con condiciones de uso. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
| Black, P. & Wiliam, D. (1998). *Inside the Black Box*. | el texto que instaló la práctica; conviene leerlo junto con las revisiones críticas posteriores sobre magnitudes. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
...
**Paso 2 — Clasificar la situación distinguiendo Evaluación formativa de Técnica de verificación.** El trabajo aquí es separar lo observado de lo interpretado sobre **Técnica de verificación**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Ajuste como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Ajuste**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.

**Paso 4 — Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con Retroalimentación utilizable a la vista.** Con **Retroalimentación utilizable** ya delimitado, la pregunta pasa a ser de consecuencia: qué cambia para los estudiantes, para el tiempo de clase y para la carga del equipo. **Evidencia de partida** entrega la lectura observable; el juicio profesional sigue siendo humano y debe quedar firmado por quien lo hace.
...
|---|---|---|---|
| Intervenir sobre **Evaluación formativa** | Uso de evidencia sobre el aprendizaje para ajustar la enseñanza mientras aún se puede | Cuando **Evidencia de partida** es observable y accionable dentro del plazo de la decisión. | Sobrerreaccionar a una señal parcial. |
| Intervenir sobre **Técnica de verificación** | Procedimiento breve que revela el estado de comprensión de todo el curso, no de quien responde | Cuando la primera explicación no distingue mecanismo ni responsable. | Convertir el concepto en etiqueta y no en intervención. |
| Observar antes de decidir | Reducir la incertidumbre antes de comprometer tiempo y credibilidad | Cuando la decisión es reversible y la evidencia disponible no distingue causas. | Observar indefinidamente y no decidir nunca. |
| Derivar o escalar | Poner la decisión donde están la competencia y la responsabilidad | Cuando hay normativa, resguardo de datos, salud o vulneración de derechos en juego. | Delegar hacia arriba lo que sí correspondía decidir en el aula. |

**Frontera de aplicación.** El tamaño de efecto de la evaluación formativa se ha citado con cifras infladas provenientes de síntesis heterogéneas. Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre evaluación formativa en básica |
|---|---|
...
Guárdala en `evidence/P04-C058-evaluacion-formativa-en-basica/` con estos archivos:
