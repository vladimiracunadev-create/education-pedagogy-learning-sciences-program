...
**Decisión que habilita:** determinar qué estrategia de escritura vas a enseñar de forma explícita y cómo la modelarás<br>
...
2. Clasificar la situación distinguiendo **Proceso de escritura** de **Estrategia de escritura**.
3. Decidir con fundamento, usando **Transcripción** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Revisión** a la vista.
...
| **Evidencia de logro** | qué muestra una secuencia de escritura con estrategia enseñada, modelamiento, práctica guiada y criterios de revisión frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
Los efectos varían según el tipo de texto y la edad, y las estrategias enseñadas no transfieren automáticamente a otros géneros. Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Proceso de escritura"]
    C --> A2["Estrategia de<br/>escritura"]
    C --> A3["Transcripción"]
    C --> A4["Revisión"]
    A1 & A2 & A3 & A4 --> D{{"determinar qué<br/>estrategia de escritura<br/>vas a enseñar de forma<br/>explícita y cómo la<br/>modelarás"}}
    D --> E["Evidencia de aprendizaje<br/>una secuencia de<br/>escritura con estrategia<br/>enseñada, modelamiento,<br/>práctica guiada y<br/>criterios…"]
...
inocua: produce decisiones que atacan el problema equivocado. **Proceso de escritura** no es lo
mismo que **Estrategia de escritura** —procedimiento explícito que el estudiante puede aplicar de forma autónoma—, y tratarlos como sinónimos hace
que la intervención se dirija al lugar incorrecto. Del mismo modo, **Transcripción** y
**Revisión** describen aspectos distintos de la misma situación: el primero
costo de la caligrafía y la ortografía;, mientras el segundo modificación del texto con criterios;.
...
- **Evidencia de logro.** Qué muestra una secuencia de escritura con estrategia enseñada, modelamiento, práctica guiada y criterios de revisión frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
te deja en condiciones de qué estrategia de escritura vas a enseñar de forma explícita y cómo la modelarás, y esa decisión se sostiene solo si
...
|---|---|---|
| Graham, S. & Perin, D. (2007). *Writing Next*. | síntesis de intervenciones efectivas en escritura con tamaños de efecto declarados. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
| Graham, S. & Harris, K. *Self-Regulated Strategy Development*. | modelo de enseñanza explícita de estrategias con evidencia acumulada en distintas edades. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
...
|---|---|---|---|
| Intervenir sobre **Proceso de escritura** | Ciclo de planificar, redactar, revisar y editar; no es lineal y se enseña por partes | Cuando **Evidencia de partida** es observable y accionable dentro del plazo de la decisión. | Sobrerreaccionar a una señal parcial. |
| Intervenir sobre **Estrategia de escritura** | Procedimiento explícito que el estudiante puede aplicar de forma autónoma | Cuando la primera explicación no distingue mecanismo ni responsable. | Convertir el concepto en etiqueta y no en intervención. |
| Observar antes de decidir | Reducir la incertidumbre antes de comprometer tiempo y credibilidad | Cuando la decisión es reversible y la evidencia disponible no distingue causas. | Observar indefinidamente y no decidir nunca. |
| Derivar o escalar | Poner la decisión donde están la competencia y la responsabilidad | Cuando hay normativa, resguardo de datos, salud o vulneración de derechos en juego. | Delegar hacia arriba lo que sí correspondía decidir en el aula. |

**Frontera de aplicación.** Los efectos varían según el tipo de texto y la edad, y las estrategias enseñadas no transfieren automáticamente a otros géneros. Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre didáctica de la escritura |
|---|---|
...
Guárdala en `evidence/P04-C050-didactica-de-la-escritura/` con estos archivos:
...
- Graham, S. & Harris, K. *Self-Regulated Strategy Development*. **Uso en esta clase:** modelo de enseñanza explícita de estrategias con evidencia acumulada en distintas edades. Lectura selectiva: índice y capítulos pertinentes; registra edición y páginas consultadas.
