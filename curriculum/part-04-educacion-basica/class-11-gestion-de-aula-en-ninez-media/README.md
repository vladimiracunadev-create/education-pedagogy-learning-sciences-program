...
**Decisión que habilita:** determinar qué rutinas vas a enseñar explícitamente antes de que aparezca el primer problema<br>
...
2. Clasificar la situación distinguiendo **Rutina** de **Transición**.
3. Decidir con fundamento, usando **Percepción simultánea** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Prevención** a la vista.
...
| **Evidencia de logro** | qué muestra el sistema de rutinas de un curso con su plan de enseñanza, práctica y corrección durante las primeras semanas frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
Las rutinas ordenan pero no resuelven conflictos de fondo ni situaciones de vulneración, y un sistema rígido aplicado sin criterio puede volverse una fuente de conflicto. Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Rutina"]
    C --> A2["Transición"]
    C --> A3["Percepción simultánea"]
    C --> A4["Prevención"]
    A1 & A2 & A3 & A4 --> D{{"determinar qué rutinas<br/>vas a enseñar<br/>explícitamente antes de<br/>que aparezca el primer<br/>problema"}}
    D --> E["Evidencia de aprendizaje<br/>el sistema de rutinas de<br/>un curso con su plan de<br/>enseñanza, práctica y<br/>corrección durante las…"]
...
inocua: produce decisiones que atacan el problema equivocado. **Rutina** no es lo
mismo que **Transición** —cambio entre actividades; concentra la mayoría de los problemas de conducta—, y tratarlos como sinónimos hace
que la intervención se dirija al lugar incorrecto. Del mismo modo, **Percepción simultánea** y
**Prevención** describen aspectos distintos de la misma situación: el primero
capacidad del docente de saber qué ocurre en toda la sala mientras atiende a una parte, mientras el segundo conjunto de decisiones tomadas antes del problema y que reducen su probabilidad.
...
- **Evidencia de logro.** Qué muestra el sistema de rutinas de un curso con su plan de enseñanza, práctica y corrección durante las primeras semanas frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
te deja en condiciones de qué rutinas vas a enseñar explícitamente antes de que aparezca el primer problema, y esa decisión se sostiene solo si
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Rutina** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Rutina de Transición.** El trabajo aquí es separar lo observado de lo interpretado sobre **Transición**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Percepción simultánea como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Percepción simultánea**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.

**Paso 4 — Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con Prevención a la vista.** Con **Prevención** ya delimitado, la pregunta pasa a ser de consecuencia: qué cambia para los estudiantes, para el tiempo de clase y para la carga del equipo. **Evidencia de partida** entrega la lectura observable; el juicio profesional sigue siendo humano y debe quedar firmado por quien lo hace.
...
|---|---|---|---|
| Intervenir sobre **Rutina** | Procedimiento estable para una situación recurrente; se enseña, se practica y se corrige | Cuando **Evidencia de partida** es observable y accionable dentro del plazo de la decisión. | Sobrerreaccionar a una señal parcial. |
| Intervenir sobre **Transición** | Cambio entre actividades; concentra la mayoría de los problemas de conducta | Cuando la primera explicación no distingue mecanismo ni responsable. | Convertir el concepto en etiqueta y no en intervención. |
| Observar antes de decidir | Reducir la incertidumbre antes de comprometer tiempo y credibilidad | Cuando la decisión es reversible y la evidencia disponible no distingue causas. | Observar indefinidamente y no decidir nunca. |
| Derivar o escalar | Poner la decisión donde están la competencia y la responsabilidad | Cuando hay normativa, resguardo de datos, salud o vulneración de derechos en juego. | Delegar hacia arriba lo que sí correspondía decidir en el aula. |

**Frontera de aplicación.** Las rutinas ordenan pero no resuelven conflictos de fondo ni situaciones de vulneración, y un sistema rígido aplicado sin criterio puede volverse una fuente de conflicto. Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre gestión de aula en niñez media |
|---|---|
...
Guárdala en `evidence/P04-C059-gestion-de-aula-en-ninez-media/` con estos archivos:
