...
**Estado de evidencia:** `EMERGENTE` · **Etapa:** 🔵 Etapa B — Enseñanza por ciclo vital · **Población de referencia:** 1.º a 8.º básico (6 a 13 años)<br>
**Decisión que habilita:** determinar qué aprendizaje artístico específico persigue tu unidad y cómo lo evaluarás sin premiar solo la prolijidad<br>
...
2. Clasificar la situación distinguiendo **Lenguaje artístico** de **Apreciación**.
3. Decidir con fundamento, usando **Producción** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Criterio de evaluación artística** a la vista.
...
| **Evidencia de logro** | qué muestra una unidad de arte con objetivos propios, criterios de evaluación y evidencia de proceso además de producto frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
La evidencia sobre efectos del arte en el rendimiento en otras asignaturas es débil y las promesas de transferencia no se sostienen en revisiones sistemáticas. Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Lenguaje artístico"]
    C --> A2["Apreciación"]
    C --> A3["Producción"]
    C --> A4["Criterio de evaluación<br/>artística"]
    A1 & A2 & A3 & A4 --> D{{"determinar qué<br/>aprendizaje artístico<br/>específico persigue tu<br/>unidad y cómo lo<br/>evaluarás sin…"}}
    D --> E["Evidencia de aprendizaje<br/>una unidad de arte con<br/>objetivos propios,<br/>criterios de evaluación<br/>y evidencia de proceso<br/>además…"]
...
inocua: produce decisiones que atacan el problema equivocado. **Lenguaje artístico** no es lo
mismo que **Apreciación** —observación y análisis de obras con criterios; se enseña y se evalúa—, y tratarlos como sinónimos hace
que la intervención se dirija al lugar incorrecto. Del mismo modo, **Producción** y
**Criterio de evaluación artística** describen aspectos distintos de la misma situación: el primero
creación con decisiones propias del estudiante dentro de restricciones dadas, mientras el segundo referencia explícita que permite juzgar el trabajo sin reducirlo a limpieza o parecido.
...
- **Evidencia de logro.** Qué muestra una unidad de arte con objetivos propios, criterios de evaluación y evidencia de proceso además de producto frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
te deja en condiciones de qué aprendizaje artístico específico persigue tu unidad y cómo lo evaluarás sin premiar solo la prolijidad, y esa decisión se sostiene solo si
...
|---|---|---|
| Eisner, E. (2002). *The Arts and the Creation of Mind*. | fundamenta el contenido cognitivo propio de las artes y sus formas de evaluación. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
| Winner, E., Goldstein, T. & Vincent-Lancrin, S. (2013). *Art for Art's Sake?* OCDE. | revisa la evidencia sobre transferencia y ordena qué se puede afirmar. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Lenguaje artístico** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Lenguaje artístico de Apreciación.** El trabajo aquí es separar lo observado de lo interpretado sobre **Apreciación**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Producción como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Producción**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.

**Paso 4 — Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con Criterio de evaluación artística a la vista.** Con **Criterio de evaluación artística** ya delimitado, la pregunta pasa a ser de consecuencia: qué cambia para los estudiantes, para el tiempo de clase y para la carga del equipo. **Evidencia de partida** entrega la lectura observable; el juicio profesional sigue siendo humano y debe quedar firmado por quien lo hace.
...
**Frontera de aplicación.** La evidencia sobre efectos del arte en el rendimiento en otras asignaturas es débil y las promesas de transferencia no se sostienen en revisiones sistemáticas. Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre arte y creatividad |
|---|---|
...
Guárdala en `evidence/P04-C054-arte-y-creatividad/` con estos archivos:
