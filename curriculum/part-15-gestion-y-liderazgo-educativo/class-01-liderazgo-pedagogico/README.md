...
**Decisión que habilita:** determinar en qué prácticas de liderazgo vas a invertir tu tiempo, sabiendo que no alcanza para todas<br>
...
2. Clasificar la situación distinguiendo **Liderazgo pedagógico** de **Efecto indirecto**.
3. Decidir con fundamento, usando **Participación en el aprendizaje docente** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Foco** a la vista.
...
| **Evidencia de logro** | qué muestra un análisis del uso real de tu tiempo directivo con una redistribución hacia prácticas de mayor efecto frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
Los efectos del liderazgo son moderados y dependen del contexto: Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Liderazgo pedagógico"]
    C --> A2["Efecto indirecto"]
    C --> A3["Participación en el<br/>aprendizaje docente"]
    C --> A4["Foco"]
    A1 & A2 & A3 & A4 --> D{{"determinar en qué<br/>prácticas de liderazgo<br/>vas a invertir tu<br/>tiempo, sabiendo que no<br/>alcanza para…"}}
    D --> E["Evidencia de aprendizaje<br/>un análisis del uso real<br/>de tu tiempo directivo<br/>con una redistribución<br/>hacia prácticas de<br/>mayor…"]
...
inocua: produce decisiones que atacan el problema equivocado. **Liderazgo pedagógico** no es lo
mismo que **Efecto indirecto** —influencia del liderazgo sobre el aprendizaje a través de las condiciones y del trabajo docente—, y tratarlos como sinónimos hace
que la intervención se dirija al lugar incorrecto. Del mismo modo, **Participación en el aprendizaje docente** y
**Foco** describen aspectos distintos de la misma situación: el primero
práctica directiva de aprender junto al equipo, no solo de organizarlo, mientras el segundo capacidad de sostener pocas prioridades frente a la presión de lo urgente.
...
- **Evidencia de logro.** Qué muestra un análisis del uso real de tu tiempo directivo con una redistribución hacia prácticas de mayor efecto frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
te deja en condiciones de en qué prácticas de liderazgo vas a invertir tu tiempo, sabiendo que no alcanza para todas, y esa decisión se sostiene solo si
...
|---|---|---|
| Robinson, V. (2011). *Student-Centered Leadership*. | ordena por efecto las prácticas de liderazgo y sitúa arriba la participación en el aprendizaje docente. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
| Leithwood, K. et al. (2020). *Seven Strong Claims about Successful School Leadership Revisited*. | actualiza lo que se sabe con evidencia sobre liderazgo escolar. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Liderazgo pedagógico** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Liderazgo pedagógico de Efecto indirecto.** El trabajo aquí es separar lo observado de lo interpretado sobre **Efecto indirecto**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Participación en el aprendizaje docente como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Participación en el aprendizaje docente**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.

**Paso 4 — Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con Foco a la vista.** Con **Foco** ya delimitado, la pregunta pasa a ser de consecuencia: qué cambia para los estudiantes, para el tiempo de clase y para la carga del equipo. **Evidencia de partida** entrega la lectura observable; el juicio profesional sigue siendo humano y debe quedar firmado por quien lo hace.
...
|---|---|---|---|
| Intervenir sobre **Liderazgo pedagógico** | Conjunto de prácticas directivas centradas en la calidad de la enseñanza y del aprendizaje | Cuando **Evidencia de partida** es observable y accionable dentro del plazo de la decisión. | Sobrerreaccionar a una señal parcial. |
| Intervenir sobre **Efecto indirecto** | Influencia del liderazgo sobre el aprendizaje a través de las condiciones y del trabajo docente | Cuando la primera explicación no distingue mecanismo ni responsable. | Convertir el concepto en etiqueta y no en intervención. |
| Observar antes de decidir | Reducir la incertidumbre antes de comprometer tiempo y credibilidad | Cuando la decisión es reversible y la evidencia disponible no distingue causas. | Observar indefinidamente y no decidir nunca. |
| Derivar o escalar | Poner la decisión donde están la competencia y la responsabilidad | Cuando hay normativa, resguardo de datos, salud o vulneración de derechos en juego. | Delegar hacia arriba lo que sí correspondía decidir en el aula. |

**Frontera de aplicación.** Los efectos del liderazgo son moderados y dependen del contexto: Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre liderazgo pedagógico |
|---|---|
...
Guárdala en `evidence/P15-C181-liderazgo-pedagogico/` con estos archivos:
