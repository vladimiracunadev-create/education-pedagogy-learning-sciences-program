...
**Decisión que habilita:** determinar el foco, el instrumento y el uso de la información antes de entrar a la primera sala<br>
...
2. Clasificar la situación distinguiendo **Foco de observación** de **Instrumento**.
3. Decidir con fundamento, usando **Uso declarado** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Separación de propósitos** a la vista.
...
| **Evidencia de logro** | qué muestra un protocolo de observación con foco, instrumento, acuerdos de uso y procedimiento de retroalimentación frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
La confiabilidad de las observaciones de aula es limitada: Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Foco de observación"]
    C --> A2["Instrumento"]
    C --> A3["Uso declarado"]
    C --> A4["Separación de<br/>propósitos"]
    A1 & A2 & A3 & A4 --> D{{"determinar el foco, el<br/>instrumento y el uso de<br/>la información antes de<br/>entrar a la primera sala"}}
    D --> E["Evidencia de aprendizaje<br/>un protocolo de<br/>observación con foco,<br/>instrumento, acuerdos de<br/>uso y procedimiento de…"]
...
inocua: produce decisiones que atacan el problema equivocado. **Foco de observación** no es lo
mismo que **Instrumento** —pauta que define qué se registra y con qué criterios, para reducir el juicio arbitrario—, y tratarlos como sinónimos hace
que la intervención se dirija al lugar incorrecto. Del mismo modo, **Uso declarado** y
**Separación de propósitos** describen aspectos distintos de la misma situación: el primero
acuerdo explícito sobre para qué se usará la información y quién la verá, mientras el segundo distinción entre observación para desarrollo y observación para evaluación del desempeño.
...
- **Evidencia de logro.** Qué muestra un protocolo de observación con foco, instrumento, acuerdos de uso y procedimiento de retroalimentación frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
te deja en condiciones de el foco, el instrumento y el uso de la información antes de entrar a la primera sala, y esa decisión se sostiene solo si
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Foco de observación** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Foco de observación de Instrumento.** El trabajo aquí es separar lo observado de lo interpretado sobre **Instrumento**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.
...
|---|---|---|---|
| Intervenir sobre **Foco de observación** | Aspecto acotado de la práctica que se observará; observar todo equivale a no observar nada | Cuando **Evidencia de partida** es observable y accionable dentro del plazo de la decisión. | Sobrerreaccionar a una señal parcial. |
| Intervenir sobre **Instrumento** | Pauta que define qué se registra y con qué criterios, para reducir el juicio arbitrario | Cuando la primera explicación no distingue mecanismo ni responsable. | Convertir el concepto en etiqueta y no en intervención. |
| Observar antes de decidir | Reducir la incertidumbre antes de comprometer tiempo y credibilidad | Cuando la decisión es reversible y la evidencia disponible no distingue causas. | Observar indefinidamente y no decidir nunca. |
| Derivar o escalar | Poner la decisión donde están la competencia y la responsabilidad | Cuando hay normativa, resguardo de datos, salud o vulneración de derechos en juego. | Delegar hacia arriba lo que sí correspondía decidir en el aula. |

**Frontera de aplicación.** La confiabilidad de las observaciones de aula es limitada: Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre observación de clases |
|---|---|
...
Guárdala en `evidence/P15-C183-observacion-de-clases/` con estos archivos:
