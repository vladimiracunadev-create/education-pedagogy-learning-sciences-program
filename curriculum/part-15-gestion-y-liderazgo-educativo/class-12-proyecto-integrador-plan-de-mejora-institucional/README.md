...
**Decisión que habilita:** determinar el plan completo de mejora y cómo se verificará su efecto sin depender de percepciones<br>
...
2. Clasificar la situación distinguiendo **Plan de mejora** de **Capacidad de ejecución**.
3. Decidir con fundamento, usando **Indicador desagregado** como criterio y declarando la fuente.
...
| **Evidencia de logro** | qué muestra un plan de mejora institucional con diagnóstico, prioridades, ciclos, indicadores desagregados y seguimiento frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
Un plan bien diseñado no garantiza mejora: Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Plan de mejora"]
    C --> A2["Capacidad de ejecución"]
    C --> A3["Indicador desagregado"]
    C --> A4["Sostenibilidad"]
    A1 & A2 & A3 & A4 --> D{{"determinar el plan<br/>completo de mejora y<br/>cómo se verificará su<br/>efecto sin depender de…"}}
    D --> E["Evidencia de aprendizaje<br/>un plan de mejora<br/>institucional con<br/>diagnóstico,<br/>prioridades, ciclos,<br/>indicadores<br/>desagregados…"]
...
- **Evidencia de logro.** Qué muestra un plan de mejora institucional con diagnóstico, prioridades, ciclos, indicadores desagregados y seguimiento frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
te deja en condiciones de el plan completo de mejora y cómo se verificará su efecto sin depender de percepciones, y esa decisión se sostiene solo si
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Plan de mejora** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Plan de mejora de Capacidad de ejecución.** El trabajo aquí es separar lo observado de lo interpretado sobre **Capacidad de ejecución**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Indicador desagregado como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Indicador desagregado**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.
...
**Frontera de aplicación.** Un plan bien diseñado no garantiza mejora: Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre proyecto integrador: plan de mejora institucional |
|---|---|
...
Guárdala en `evidence/P15-C192-proyecto-integrador-plan-de-mejora-institucional/` con estos archivos:
