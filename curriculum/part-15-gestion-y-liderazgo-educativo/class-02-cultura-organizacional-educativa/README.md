...
**Decisión que habilita:** determinar qué supuesto cultural debe moverse antes de intentar el cambio que quieres introducir<br>
...
2. Clasificar la situación distinguiendo **Cultura organizacional** de **Norma informal**.
3. Decidir con fundamento, usando **Confianza relacional** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Resistencia** a la vista.
...
| **Evidencia de logro** | qué muestra un diagnóstico de cultura organizacional con evidencia y una estrategia de cambio ajustada a lo que permite frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
La cultura se describe mejor de lo que se manipula: Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Cultura organizacional"]
    C --> A2["Norma informal"]
    C --> A3["Confianza relacional"]
    C --> A4["Resistencia"]
    A1 & A2 & A3 & A4 --> D{{"determinar qué supuesto<br/>cultural debe moverse<br/>antes de intentar el<br/>cambio que quieres<br/>introducir"}}
    D --> E["Evidencia de aprendizaje<br/>un diagnóstico de<br/>cultura organizacional<br/>con evidencia y una<br/>estrategia de cambio<br/>ajustada a lo…"]
...
inocua: produce decisiones que atacan el problema equivocado. **Cultura organizacional** no es lo
mismo que **Norma informal** —regla no escrita que gobierna la conducta cotidiana con más fuerza que el reglamento—, y tratarlos como sinónimos hace
que la intervención se dirija al lugar incorrecto. Del mismo modo, **Confianza relacional** y
**Resistencia** describen aspectos distintos de la misma situación: el primero
calidad de las expectativas mutuas entre docentes, directivos, estudiantes y familias, mientras el segundo respuesta organizacional al cambio;.
...
- **Evidencia de logro.** Qué muestra un diagnóstico de cultura organizacional con evidencia y una estrategia de cambio ajustada a lo que permite frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
te deja en condiciones de qué supuesto cultural debe moverse antes de intentar el cambio que quieres introducir, y esa decisión se sostiene solo si
...
|---|---|---|
| Schein, E. (2010). *Organizational Culture and Leadership*. | modelo de niveles de cultura aplicable al diagnóstico institucional. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
| Bryk, A. & Schneider, B. (2002). *Trust in Schools*. | evidencia longitudinal sobre confianza relacional como condición de mejora. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Cultura organizacional** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Cultura organizacional de Norma informal.** El trabajo aquí es separar lo observado de lo interpretado sobre **Norma informal**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Confianza relacional como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Confianza relacional**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.

**Paso 4 — Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con Resistencia a la vista.** Con **Resistencia** ya delimitado, la pregunta pasa a ser de consecuencia: qué cambia para los estudiantes, para el tiempo de clase y para la carga del equipo. **Evidencia de partida** entrega la lectura observable; el juicio profesional sigue siendo humano y debe quedar firmado por quien lo hace.
...
|---|---|---|---|
| Intervenir sobre **Cultura organizacional** | Supuestos compartidos, mayormente implícitos, sobre cómo se hacen las cosas aquí | Cuando **Evidencia de partida** es observable y accionable dentro del plazo de la decisión. | Sobrerreaccionar a una señal parcial. |
| Intervenir sobre **Norma informal** | Regla no escrita que gobierna la conducta cotidiana con más fuerza que el reglamento | Cuando la primera explicación no distingue mecanismo ni responsable. | Convertir el concepto en etiqueta y no en intervención. |
| Observar antes de decidir | Reducir la incertidumbre antes de comprometer tiempo y credibilidad | Cuando la decisión es reversible y la evidencia disponible no distingue causas. | Observar indefinidamente y no decidir nunca. |
| Derivar o escalar | Poner la decisión donde están la competencia y la responsabilidad | Cuando hay normativa, resguardo de datos, salud o vulneración de derechos en juego. | Delegar hacia arriba lo que sí correspondía decidir en el aula. |

**Frontera de aplicación.** La cultura se describe mejor de lo que se manipula: Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre cultura organizacional educativa |
|---|---|
...
Guárdala en `evidence/P15-C182-cultura-organizacional-educativa/` con estos archivos:
...
- Schein, E. (2010). *Organizational Culture and Leadership*. **Uso en esta clase:** modelo de niveles de cultura aplicable al diagnóstico institucional. Lectura selectiva: índice y capítulos pertinentes; registra edición y páginas consultadas.
- Bryk, A. & Schneider, B. (2002). *Trust in Schools*. **Uso en esta clase:** evidencia longitudinal sobre confianza relacional como condición de mejora. Lectura selectiva: índice y capítulos pertinentes; registra edición y páginas consultadas.
