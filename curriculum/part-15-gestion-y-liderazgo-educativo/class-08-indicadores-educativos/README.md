...
**Decisión que habilita:** determinar qué indicadores usará tu institución para decidir y cuáles dejará de recolectar<br>
...
2. Clasificar la situación distinguiendo **Indicador de resultado** de **Indicador de proceso**.
3. Decidir con fundamento, usando **Desagregación** como criterio y declarando la fuente.
...
| **Evidencia de logro** | qué muestra un tablero institucional con indicadores, desagregación, límites y la decisión asociada a cada uno frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
Todo indicador induce conducta: Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Indicador de resultado"]
    C --> A2["Indicador de proceso"]
    C --> A3["Desagregación"]
    C --> A4["Efecto de indicador"]
    A1 & A2 & A3 & A4 --> D{{"determinar qué<br/>indicadores usará tu<br/>institución para decidir<br/>y cuáles dejará de<br/>recolectar"}}
    D --> E["Evidencia de aprendizaje<br/>un tablero institucional<br/>con indicadores,<br/>desagregación, límites y<br/>la decisión asociada a<br/>cada…"]
...
inocua: produce decisiones que atacan el problema equivocado. **Indicador de resultado** no es lo
...
- **Evidencia de logro.** Qué muestra un tablero institucional con indicadores, desagregación, límites y la decisión asociada a cada uno frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
te deja en condiciones de qué indicadores usará tu institución para decidir y cuáles dejará de recolectar, y esa decisión se sostiene solo si
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Indicador de resultado** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Indicador de resultado de Indicador de proceso.** El trabajo aquí es separar lo observado de lo interpretado sobre **Indicador de proceso**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Desagregación como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Desagregación**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.
...
**Frontera de aplicación.** Todo indicador induce conducta: Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre indicadores educativos |
|---|---|
...
Guárdala en `evidence/P15-C188-indicadores-educativos/` con estos archivos:
