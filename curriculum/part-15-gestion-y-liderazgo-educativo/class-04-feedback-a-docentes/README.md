...
**Decisión que habilita:** determinar qué evidencia presentarás y qué acuerdo buscas de la conversación<br>
...
2. Clasificar la situación distinguiendo **Retroalimentación basada en evidencia** de **Foco en la práctica**.
...
| **Evidencia de logro** | qué muestra el guion y el registro de una conversación de retroalimentación con acuerdo y fecha de seguimiento frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
El coaching instruccional muestra efectos positivos en programas bien implementados, con caída al escalar. Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Retroalimentación<br/>basada en evidencia"]
    C --> A2["Foco en la práctica"]
    C --> A3["Acuerdo verificable"]
    C --> A4["Seguimiento"]
    A1 & A2 & A3 & A4 --> D{{"determinar qué evidencia<br/>presentarás y qué<br/>acuerdo buscas de la<br/>conversación"}}
    D --> E["Evidencia de aprendizaje<br/>el guion y el registro<br/>de una conversación de<br/>retroalimentación con<br/>acuerdo y fecha de…"]
...
inocua: produce decisiones que atacan el problema equivocado. **Retroalimentación basada en evidencia** no es lo
...
- **Evidencia de logro.** Qué muestra el guion y el registro de una conversación de retroalimentación con acuerdo y fecha de seguimiento frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
te deja en condiciones de qué evidencia presentarás y qué acuerdo buscas de la conversación, y esa decisión se sostiene solo si
...
|---|---|---|
| Knight, J. (2007). *Instructional Coaching*. | protocolos de conversación y estructura de acompañamiento con docentes. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
| Kraft, M., Blazar, D. & Hogan, D. (2018). *The Effect of Teacher Coaching*. | evidencia de efecto y advertencia sobre la caída al escalar los programas. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Retroalimentación basada en evidencia** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Retroalimentación basada en evidencia de Foco en la práctica.** El trabajo aquí es separar lo observado de lo interpretado sobre **Foco en la práctica**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.
...
|---|---|---|---|
| Intervenir sobre **Retroalimentación basada en evidencia** | Conversación anclada en lo observado y no en impresiones generales | Cuando **Evidencia de partida** es observable y accionable dentro del plazo de la decisión. | Sobrerreaccionar a una señal parcial. |
| Intervenir sobre **Foco en la práctica** | Centrar la conversación en decisiones docentes concretas y no en atributos de la persona | Cuando la primera explicación no distingue mecanismo ni responsable. | Convertir el concepto en etiqueta y no en intervención. |
| Observar antes de decidir | Reducir la incertidumbre antes de comprometer tiempo y credibilidad | Cuando la decisión es reversible y la evidencia disponible no distingue causas. | Observar indefinidamente y no decidir nunca. |
| Derivar o escalar | Poner la decisión donde están la competencia y la responsabilidad | Cuando hay normativa, resguardo de datos, salud o vulneración de derechos en juego. | Delegar hacia arriba lo que sí correspondía decidir en el aula. |

**Frontera de aplicación.** El coaching instruccional muestra efectos positivos en programas bien implementados, con caída al escalar. Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre feedback a docentes |
|---|---|
...
Guárdala en `evidence/P15-C184-feedback-a-docentes/` con estos archivos:
