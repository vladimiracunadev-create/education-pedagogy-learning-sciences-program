...
**Estado de evidencia:** `EN-DEBATE` · **Etapa:** 🟠 Etapa D — Educación superior y liderazgo · **Población de referencia:** equipos directivos, jefaturas técnicas y coordinaciones<br>
**Decisión que habilita:** determinar si una innovación propuesta merece la energía institucional que consumirá<br>
...
2. Clasificar la situación distinguiendo **Innovación** de **Costo de oportunidad**.
3. Decidir con fundamento, usando **Capacidad institucional** como criterio y declarando la fuente.
...
| **Evidencia de logro** | qué muestra una evaluación de una innovación con evidencia, ajuste al problema, capacidad requerida y costo de oportunidad frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
La evidencia sobre innovaciones específicas es heterogénea y muchas veces proviene de sus propios promotores. Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Innovación"]
    C --> A2["Costo de oportunidad"]
    C --> A3["Capacidad<br/>institucional"]
    C --> A4["Fidelidad de<br/>implementación"]
    A1 & A2 & A3 & A4 --> D{{"determinar si una<br/>innovación propuesta<br/>merece la energía<br/>institucional que<br/>consumirá"}}
    D --> E["Evidencia de aprendizaje<br/>una evaluación de una<br/>innovación con<br/>evidencia, ajuste al<br/>problema, capacidad<br/>requerida y costo…"]
...
inocua: produce decisiones que atacan el problema equivocado. **Innovación** no es lo
...
- **Evidencia de logro.** Qué muestra una evaluación de una innovación con evidencia, ajuste al problema, capacidad requerida y costo de oportunidad frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
te deja en condiciones de si una innovación propuesta merece la energía institucional que consumirá, y esa decisión se sostiene solo si
...
|---|---|---|
| Century, J. & Cassata, A. (2016). *Implementation Research: Finding Common Ground*. | sistematiza fidelidad de implementación y adaptación en innovaciones educativas. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
| Fullan, M. (2007). *The New Meaning of Educational Change*. | análisis clásico sobre por qué las innovaciones prenden o se disuelven en las escuelas. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Innovación** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Innovación de Costo de oportunidad.** El trabajo aquí es separar lo observado de lo interpretado sobre **Costo de oportunidad**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Capacidad institucional como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Capacidad institucional**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.
...
|---|---|---|---|
| Intervenir sobre **Innovación** | Cambio deliberado en la práctica con expectativa de mejora; no toda novedad lo es | Cuando **Evidencia de partida** es observable y accionable dentro del plazo de la decisión. | Sobrerreaccionar a una señal parcial. |
| Intervenir sobre **Costo de oportunidad** | Lo que la institución deja de hacer por dedicar energía a esta innovación | Cuando la primera explicación no distingue mecanismo ni responsable. | Convertir el concepto en etiqueta y no en intervención. |
| Observar antes de decidir | Reducir la incertidumbre antes de comprometer tiempo y credibilidad | Cuando la decisión es reversible y la evidencia disponible no distingue causas. | Observar indefinidamente y no decidir nunca. |
| Derivar o escalar | Poner la decisión donde están la competencia y la responsabilidad | Cuando hay normativa, resguardo de datos, salud o vulneración de derechos en juego. | Delegar hacia arriba lo que sí correspondía decidir en el aula. |

**Frontera de aplicación.** La evidencia sobre innovaciones específicas es heterogénea y muchas veces proviene de sus propios promotores. Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre innovación educativa |
|---|---|
...
Guárdala en `evidence/P15-C190-innovacion-educativa/` con estos archivos:
