...
**Estado de evidencia:** `PRACTICA-PROFESIONAL` · **Etapa:** 🟠 Etapa D — Educación superior y liderazgo · **Población de referencia:** equipos directivos, jefaturas técnicas y coordinaciones<br>
**Decisión que habilita:** determinar qué palanca de gestión tienes efectivamente disponible para el problema de equipo que enfrentas<br>
...
2. Clasificar la situación distinguiendo **Claridad de rol** de **Carga distribuida**.
3. Decidir con fundamento, usando **Conversación difícil** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Reconocimiento** a la vista.
...
| **Evidencia de logro** | qué muestra un plan de gestión de equipo con distribución de carga, desarrollo y protocolo de conversaciones difíciles frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
La gestión de equipos en educación está condicionada por la normativa laboral y por la estructura del sistema, que varían por país y por dependencia. Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Claridad de rol"]
    C --> A2["Carga distribuida"]
    C --> A3["Conversación difícil"]
    C --> A4["Reconocimiento"]
    A1 & A2 & A3 & A4 --> D{{"determinar qué palanca<br/>de gestión tienes<br/>efectivamente disponible<br/>para el problema de<br/>equipo…"}}
    D --> E["Evidencia de aprendizaje<br/>un plan de gestión de<br/>equipo con distribución<br/>de carga, desarrollo y<br/>protocolo de…"]
...
inocua: produce decisiones que atacan el problema equivocado. **Claridad de rol** no es lo
mismo que **Carga distribuida** —reparto justo y transparente del trabajo, incluidas las tareas invisibles—, y tratarlos como sinónimos hace
que la intervención se dirija al lugar incorrecto. Del mismo modo, **Conversación difícil** y
**Reconocimiento** describen aspectos distintos de la misma situación: el primero
intercambio sobre desempeño o conducta que la mayoría de los directivos posterga, mientras el segundo valoración específica del trabajo bien hecho;.
...
- **Evidencia de logro.** Qué muestra un plan de gestión de equipo con distribución de carga, desarrollo y protocolo de conversaciones difíciles frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
te deja en condiciones de qué palanca de gestión tienes efectivamente disponible para el problema de equipo que enfrentas, y esa decisión se sostiene solo si
...
|---|---|---|
| Hargreaves, A. & O'Connor, M. (2018). *Collaborative Professionalism*. | distingue colaboración real de coordinación y aporta criterios de conducción de equipos. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
| Robinson, V. (2011). *Student-Centered Leadership*. | incluye las conversaciones sobre desempeño como práctica directiva central. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Claridad de rol** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Claridad de rol de Carga distribuida.** El trabajo aquí es separar lo observado de lo interpretado sobre **Carga distribuida**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Conversación difícil como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Conversación difícil**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.

**Paso 4 — Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con Reconocimiento a la vista.** Con **Reconocimiento** ya delimitado, la pregunta pasa a ser de consecuencia: qué cambia para los estudiantes, para el tiempo de clase y para la carga del equipo. **Evidencia de partida** entrega la lectura observable; el juicio profesional sigue siendo humano y debe quedar firmado por quien lo hace.
...
|---|---|---|---|
| Intervenir sobre **Claridad de rol** | Definición explícita de funciones, decisiones y expectativas de cada integrante | Cuando **Evidencia de partida** es observable y accionable dentro del plazo de la decisión. | Sobrerreaccionar a una señal parcial. |
| Intervenir sobre **Carga distribuida** | Reparto justo y transparente del trabajo, incluidas las tareas invisibles | Cuando la primera explicación no distingue mecanismo ni responsable. | Convertir el concepto en etiqueta y no en intervención. |
| Observar antes de decidir | Reducir la incertidumbre antes de comprometer tiempo y credibilidad | Cuando la decisión es reversible y la evidencia disponible no distingue causas. | Observar indefinidamente y no decidir nunca. |
| Derivar o escalar | Poner la decisión donde están la competencia y la responsabilidad | Cuando hay normativa, resguardo de datos, salud o vulneración de derechos en juego. | Delegar hacia arriba lo que sí correspondía decidir en el aula. |

**Frontera de aplicación.** La gestión de equipos en educación está condicionada por la normativa laboral y por la estructura del sistema, que varían por país y por dependencia. Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre gestión de equipos |
|---|---|
...
Guárdala en `evidence/P15-C187-gestion-de-equipos/` con estos archivos:
