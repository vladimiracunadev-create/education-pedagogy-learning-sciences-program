...
**Estado de evidencia:** `EMERGENTE` · **Etapa:** 🔴 Etapa E — Investigación avanzada y formación de formadores · **Población de referencia:** nivel doctoral, dirección de tesis y formación docente<br>
**Decisión que habilita:** determinar qué principios de diseño quieres poner a prueba y cómo documentarás su refinamiento<br>
...
2. Clasificar la situación distinguiendo **Investigación basada en diseño** de **Principio de diseño**.
3. Decidir con fundamento, usando **Ciclo iterativo** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Conjetura de diseño** a la vista.
...
| **Evidencia de logro** | qué muestra un plan de investigación basada en diseño con ciclos, principios de diseño y sistema de documentación frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
La metodología tiene una debilidad reconocida: Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Investigación basada<br/>en diseño"]
    C --> A2["Principio de diseño"]
    C --> A3["Ciclo iterativo"]
    C --> A4["Conjetura de diseño"]
    A1 & A2 & A3 & A4 --> D{{"determinar qué<br/>principios de diseño<br/>quieres poner a prueba y<br/>cómo documentarás su<br/>refinamiento"}}
    D --> E["Evidencia de aprendizaje<br/>un plan de investigación<br/>basada en diseño con<br/>ciclos, principios de<br/>diseño y sistema de…"]
...
inocua: produce decisiones que atacan el problema equivocado. **Investigación basada en diseño** no es lo
...
- **Evidencia de logro.** Qué muestra un plan de investigación basada en diseño con ciclos, principios de diseño y sistema de documentación frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
te deja en condiciones de qué principios de diseño quieres poner a prueba y cómo documentarás su refinamiento, y esa decisión se sostiene solo si
...
|---|---|---|
| Design-Based Research Collective (2003). *Design-Based Research*. Educational Researcher, 32(1). | define el paradigma, sus criterios y sus tensiones metodológicas. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
| Anderson, T. & Shattuck, J. (2012). *Design-Based Research: A Decade of Progress in Education Research?* | balance crítico de sus logros y de sus debilidades. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Investigación basada en diseño** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Investigación basada en diseño de Principio de diseño.** El trabajo aquí es separar lo observado de lo interpretado sobre **Principio de diseño**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Ciclo iterativo como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Ciclo iterativo**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.

**Paso 4 — Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con Conjetura de diseño a la vista.** Con **Conjetura de diseño** ya delimitado, la pregunta pasa a ser de consecuencia: qué cambia para los estudiantes, para el tiempo de clase y para la carga del equipo. **Evidencia de partida** entrega la lectura observable; el juicio profesional sigue siendo humano y debe quedar firmado por quien lo hace.
...
|---|---|---|---|
| Intervenir sobre **Investigación basada en diseño** | Metodología que desarrolla y estudia intervenciones en contextos reales mediante ciclos iterativos | Cuando **Evidencia de partida** es observable y accionable dentro del plazo de la decisión. | Sobrerreaccionar a una señal parcial. |
| Intervenir sobre **Principio de diseño** | Afirmación transferible sobre qué funciona, para quién y bajo qué condiciones | Cuando la primera explicación no distingue mecanismo ni responsable. | Convertir el concepto en etiqueta y no en intervención. |
| Observar antes de decidir | Reducir la incertidumbre antes de comprometer tiempo y credibilidad | Cuando la decisión es reversible y la evidencia disponible no distingue causas. | Observar indefinidamente y no decidir nunca. |
| Derivar o escalar | Poner la decisión donde están la competencia y la responsabilidad | Cuando hay normativa, resguardo de datos, salud o vulneración de derechos en juego. | Delegar hacia arriba lo que sí correspondía decidir en el aula. |

**Frontera de aplicación.** La metodología tiene una debilidad reconocida: Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre investigación basada en diseño |
|---|---|
...
Guárdala en `evidence/P17-C210-investigacion-basada-en-diseno/` con estos archivos:
