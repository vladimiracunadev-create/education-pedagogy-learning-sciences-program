...
**Decisión que habilita:** determinar los criterios con que evaluarás una tesis y cómo los comunicarás antes de que se escriba<br>
...
2. Clasificar la situación distinguiendo **Dirección de tesis** de **Criterio de evaluación**.
3. Decidir con fundamento, usando **Retroalimentación sobre el texto** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Decisión fundamentada** a la vista.
...
| **Evidencia de logro** | qué muestra un protocolo de dirección y una pauta de evaluación de tesis con criterios explícitos y ejemplos frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
No hay evidencia experimental sobre modelos de dirección: Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Dirección de tesis"]
    C --> A2["Criterio de evaluación"]
    C --> A3["Retroalimentación<br/>sobre el texto"]
    C --> A4["Decisión fundamentada"]
    A1 & A2 & A3 & A4 --> D{{"determinar los criterios<br/>con que evaluarás una<br/>tesis y cómo los<br/>comunicarás antes de que<br/>se…"}}
    D --> E["Evidencia de aprendizaje<br/>un protocolo de<br/>dirección y una pauta de<br/>evaluación de tesis con<br/>criterios explícitos y<br/>ejemplos"]
...
inocua: produce decisiones que atacan el problema equivocado. **Dirección de tesis** no es lo
mismo que **Criterio de evaluación** —estándar explícito con que se juzga el trabajo, conocido antes de su elaboración—, y tratarlos como sinónimos hace
que la intervención se dirija al lugar incorrecto. Del mismo modo, **Retroalimentación sobre el texto** y
**Decisión fundamentada** describen aspectos distintos de la misma situación: el primero
comentario que permite al estudiante corregir, distinto de la reescritura por el director, mientras el segundo juicio evaluativo justificado con referencia a criterios y a evidencia del trabajo.
...
- **Evidencia de logro.** Qué muestra un protocolo de dirección y una pauta de evaluación de tesis con criterios explícitos y ejemplos frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
te deja en condiciones de los criterios con que evaluarás una tesis y cómo los comunicarás antes de que se escriba, y esa decisión se sostiene solo si
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Dirección de tesis** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Dirección de tesis de Criterio de evaluación.** El trabajo aquí es separar lo observado de lo interpretado sobre **Criterio de evaluación**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Retroalimentación sobre el texto como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Retroalimentación sobre el texto**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.

**Paso 4 — Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con Decisión fundamentada a la vista.** Con **Decisión fundamentada** ya delimitado, la pregunta pasa a ser de consecuencia: qué cambia para los estudiantes, para el tiempo de clase y para la carga del equipo. **Evidencia de partida** entrega la lectura observable; el juicio profesional sigue siendo humano y debe quedar firmado por quien lo hace.
...
**Frontera de aplicación.** No hay evidencia experimental sobre modelos de dirección: Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre dirección y evaluación de tesis |
|---|---|
...
Guárdala en `evidence/P17-C214-direccion-y-evaluacion-de-tesis/` con estos archivos:
