...
**Decisión que habilita:** determinar a qué revista corresponde tu trabajo y cómo responderás a la revisión<br>
...
2. Clasificar la situación distinguiendo **Revisión por pares** de **Ajuste a la revista**.
3. Decidir con fundamento, usando **Carta de respuesta** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Autoría** a la vista.
...
| **Evidencia de logro** | qué muestra una carta de respuesta a revisores de un manuscrito propio, con las correcciones y las réplicas fundamentadas frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
El sistema de publicación tiene problemas conocidos: Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Revisión por pares"]
    C --> A2["Ajuste a la revista"]
    C --> A3["Carta de respuesta"]
    C --> A4["Autoría"]
    A1 & A2 & A3 & A4 --> D{{"determinar a qué revista<br/>corresponde tu trabajo y<br/>cómo responderás a la<br/>revisión"}}
    D --> E["Evidencia de aprendizaje<br/>una carta de respuesta a<br/>revisores de un<br/>manuscrito propio, con<br/>las correcciones y las<br/>réplicas…"]
...
inocua: produce decisiones que atacan el problema equivocado. **Revisión por pares** no es lo
...
- **Evidencia de logro.** Qué muestra una carta de respuesta a revisores de un manuscrito propio, con las correcciones y las réplicas fundamentadas frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
te deja en condiciones de a qué revista corresponde tu trabajo y cómo responderás a la revisión, y esa decisión se sostiene solo si
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Revisión por pares** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Revisión por pares de Ajuste a la revista.** El trabajo aquí es separar lo observado de lo interpretado sobre **Ajuste a la revista**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Carta de respuesta como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Carta de respuesta**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.

**Paso 4 — Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con Autoría a la vista.** Con **Autoría** ya delimitado, la pregunta pasa a ser de consecuencia: qué cambia para los estudiantes, para el tiempo de clase y para la carga del equipo. **Evidencia de partida** entrega la lectura observable; el juicio profesional sigue siendo humano y debe quedar firmado por quien lo hace.
...
|---|---|---|---|
| Intervenir sobre **Revisión por pares** | Evaluación del manuscrito por especialistas del campo antes de su publicación | Cuando **Evidencia de partida** es observable y accionable dentro del plazo de la decisión. | Sobrerreaccionar a una señal parcial. |
| Intervenir sobre **Ajuste a la revista** | Correspondencia entre el trabajo y el alcance, la audiencia y el formato de la publicación | Cuando la primera explicación no distingue mecanismo ni responsable. | Convertir el concepto en etiqueta y no en intervención. |
| Observar antes de decidir | Reducir la incertidumbre antes de comprometer tiempo y credibilidad | Cuando la decisión es reversible y la evidencia disponible no distingue causas. | Observar indefinidamente y no decidir nunca. |
| Derivar o escalar | Poner la decisión donde están la competencia y la responsabilidad | Cuando hay normativa, resguardo de datos, salud o vulneración de derechos en juego. | Delegar hacia arriba lo que sí correspondía decidir en el aula. |

**Frontera de aplicación.** El sistema de publicación tiene problemas conocidos: Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre publicación y peer review |
|---|---|
...
Guárdala en `evidence/P17-C213-publicacion-y-peer-review/` con estos archivos:
