...
**Decisión que habilita:** determinar qué tipo de contribución hará tu investigación y con qué criterio se juzgará<br>
...
2. Clasificar la situación distinguiendo **Contribución teórica** de **Contribución metodológica**.
3. Decidir con fundamento, usando **Contribución empírica** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Contribución de síntesis** a la vista.
...
| **Evidencia de logro** | qué muestra la declaración de contribución de tu investigación con su tipo, su criterio de valoración y su defensa frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
La magnitud de la contribución no se decide por autoevaluación: Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Contribución teórica"]
    C --> A2["Contribución<br/>metodológica"]
    C --> A3["Contribución empírica"]
    C --> A4["Contribución de<br/>síntesis"]
    A1 & A2 & A3 & A4 --> D{{"determinar qué tipo de<br/>contribución hará tu<br/>investigación y con qué<br/>criterio se juzgará"}}
    D --> E["Evidencia de aprendizaje<br/>la declaración de<br/>contribución de tu<br/>investigación con su<br/>tipo, su criterio de<br/>valoración y su…"]
...
- **Evidencia de logro.** Qué muestra la declaración de contribución de tu investigación con su tipo, su criterio de valoración y su defensa frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
te deja en condiciones de qué tipo de contribución hará tu investigación y con qué criterio se juzgará, y esa decisión se sostiene solo si
...
|---|---|---|
| Whetten, D. (1989). *What Constitutes a Theoretical Contribution?* Academy of Management Review, 14(4). | criterios operativos para juzgar aportes teóricos, aplicables a educación. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
| Dunleavy, P. (2003). *Authoring a PhD*. | orienta la formulación explícita de la contribución en el trabajo doctoral. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Contribución teórica** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Contribución teórica de Contribución metodológica.** El trabajo aquí es separar lo observado de lo interpretado sobre **Contribución metodológica**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Contribución empírica como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Contribución empírica**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.

**Paso 4 — Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con Contribución de síntesis a la vista.** Con **Contribución de síntesis** ya delimitado, la pregunta pasa a ser de consecuencia: qué cambia para los estudiantes, para el tiempo de clase y para la carga del equipo. **Evidencia de partida** entrega la lectura observable; el juicio profesional sigue siendo humano y debe quedar firmado por quien lo hace.
...
**Frontera de aplicación.** La magnitud de la contribución no se decide por autoevaluación: Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre contribución al conocimiento |
|---|---|
...
Guárdala en `evidence/P17-C206-contribucion-al-conocimiento/` con estos archivos:
