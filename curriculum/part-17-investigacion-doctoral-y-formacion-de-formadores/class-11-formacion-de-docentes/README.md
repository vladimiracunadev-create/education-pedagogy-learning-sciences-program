...
**Decisión que habilita:** determinar qué diseño de formación docente producirá cambio en la práctica y no solo satisfacción<br>
...
2. Clasificar la situación distinguiendo **Desarrollo profesional efectivo** de **Foco en el contenido**.
3. Decidir con fundamento, usando **Duración sostenida** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Acompañamiento en el puesto** a la vista.
...
| **Evidencia de logro** | qué muestra el diseño de un programa de formación docente con las características asociadas a efectividad y su evaluación frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
La evidencia proviene mayormente de programas bien financiados y bien implementados, y los efectos caen al escalar. Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Desarrollo profesional<br/>efectivo"]
    C --> A2["Foco en el contenido"]
    C --> A3["Duración sostenida"]
    C --> A4["Acompañamiento en el<br/>puesto"]
    A1 & A2 & A3 & A4 --> D{{"determinar qué diseño de<br/>formación docente<br/>producirá cambio en la<br/>práctica y no solo…"}}
    D --> E["Evidencia de aprendizaje<br/>el diseño de un programa<br/>de formación docente con<br/>las características<br/>asociadas a efectividad<br/>y…"]
...
inocua: produce decisiones que atacan el problema equivocado. **Desarrollo profesional efectivo** no es lo
mismo que **Foco en el contenido** —centralidad de la disciplina y de su didáctica específica, más allá de técnicas generales—, y tratarlos como sinónimos hace
que la intervención se dirija al lugar incorrecto. Del mismo modo, **Duración sostenida** y
**Acompañamiento en el puesto** describen aspectos distintos de la misma situación: el primero
extensión en el tiempo con múltiples instancias, en vez de talleres aislados, mientras el segundo apoyo en el aula real, donde el cambio de práctica efectivamente ocurre.
...
- **Evidencia de logro.** Qué muestra el diseño de un programa de formación docente con las características asociadas a efectividad y su evaluación frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
te deja en condiciones de qué diseño de formación docente producirá cambio en la práctica y no solo satisfacción, y esa decisión se sostiene solo si
...
|---|---|---|
| Darling-Hammond, L. et al. (2017). *Effective Teacher Professional Development*. Learning Policy Institute. | sintetiza las características asociadas a programas que cambian la práctica. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
| Desimone, L. (2009). *Improving Impact Studies of Teachers' Professional Development*. | propone un marco conceptual y de medición para evaluar estos programas. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Desarrollo profesional efectivo** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Desarrollo profesional efectivo de Foco en el contenido.** El trabajo aquí es separar lo observado de lo interpretado sobre **Foco en el contenido**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Duración sostenida como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Duración sostenida**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.

**Paso 4 — Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con Acompañamiento en el puesto a la vista.** Con **Acompañamiento en el puesto** ya delimitado, la pregunta pasa a ser de consecuencia: qué cambia para los estudiantes, para el tiempo de clase y para la carga del equipo. **Evidencia de partida** entrega la lectura observable; el juicio profesional sigue siendo humano y debe quedar firmado por quien lo hace.
...
|---|---|---|---|
| Intervenir sobre **Desarrollo profesional efectivo** | Formación docente asociada a cambio en la práctica y en el aprendizaje de los estudiantes | Cuando **Evidencia de partida** es observable y accionable dentro del plazo de la decisión. | Sobrerreaccionar a una señal parcial. |
| Intervenir sobre **Foco en el contenido** | Centralidad de la disciplina y de su didáctica específica, más allá de técnicas generales | Cuando la primera explicación no distingue mecanismo ni responsable. | Convertir el concepto en etiqueta y no en intervención. |
| Observar antes de decidir | Reducir la incertidumbre antes de comprometer tiempo y credibilidad | Cuando la decisión es reversible y la evidencia disponible no distingue causas. | Observar indefinidamente y no decidir nunca. |
| Derivar o escalar | Poner la decisión donde están la competencia y la responsabilidad | Cuando hay normativa, resguardo de datos, salud o vulneración de derechos en juego. | Delegar hacia arriba lo que sí correspondía decidir en el aula. |

**Frontera de aplicación.** La evidencia proviene mayormente de programas bien financiados y bien implementados, y los efectos caen al escalar. Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre formación de docentes |
|---|---|
...
Guárdala en `evidence/P17-C215-formacion-de-docentes/` con estos archivos:
