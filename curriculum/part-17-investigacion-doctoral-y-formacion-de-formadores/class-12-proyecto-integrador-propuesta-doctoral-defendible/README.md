...
**Decisión que habilita:** determinar el conjunto completo de decisiones de tu propuesta y su defensa ante la objeción más fuerte<br>
...
flowchart TB
    ...
    C --> A1["Propuesta doctoral"]
    C --> A2["Factibilidad"]
    C --> A3["Objeción anticipada"]
    C --> A4["Defensa"]
    A1 & A2 & A3 & A4 --> D{{"determinar el conjunto<br/>completo de decisiones<br/>de tu propuesta y su<br/>defensa ante la objeción<br/>más…"}}
    D --> E["Evidencia de aprendizaje<br/>una propuesta doctoral<br/>completa con problema,<br/>contribución, diseño,<br/>ética, factibilidad y…"]
