...
**Decisión que habilita:** determinar si tu pregunta admite síntesis cuantitativa y qué estudios son legítimamente combinables<br>
...
2. Clasificar la situación distinguiendo **Revisión sistemática** de **Metaanálisis**.
3. Decidir con fundamento, usando **Heterogeneidad** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Sesgo de publicación** a la vista.
...
| **Evidencia de logro** | qué muestra un protocolo de revisión sistemática con criterios, estrategia de búsqueda y plan de síntesis y de análisis de sesgo frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
En educación la heterogeneidad suele ser alta porque las intervenciones, los contextos y las medidas difieren. Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Revisión sistemática"]
    C --> A2["Metaanálisis"]
    C --> A3["Heterogeneidad"]
    C --> A4["Sesgo de publicación"]
    A1 & A2 & A3 & A4 --> D{{"determinar si tu<br/>pregunta admite síntesis<br/>cuantitativa y qué<br/>estudios son<br/>legítimamente…"}}
    D --> E["Evidencia de aprendizaje<br/>un protocolo de revisión<br/>sistemática con<br/>criterios, estrategia de<br/>búsqueda y plan de<br/>síntesis y…"]
...
inocua: produce decisiones que atacan el problema equivocado. **Revisión sistemática** no es lo
...
- **Evidencia de logro.** Qué muestra un protocolo de revisión sistemática con criterios, estrategia de búsqueda y plan de síntesis y de análisis de sesgo frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
te deja en condiciones de si tu pregunta admite síntesis cuantitativa y qué estudios son legítimamente combinables, y esa decisión se sostiene solo si
...
|---|---|---|
| Cooper, H., Hedges, L. & Valentine, J. (eds.) (2019). *The Handbook of Research Synthesis and Meta-Analysis*. | el manual estándar para producir y juzgar síntesis cuantitativas. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
| Page, M. et al. (2021). *The PRISMA 2020 Statement*. | estándar de reporte de revisiones sistemáticas; úsalo como lista de verificación. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Revisión sistemática** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Revisión sistemática de Metaanálisis.** El trabajo aquí es separar lo observado de lo interpretado sobre **Metaanálisis**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Heterogeneidad como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Heterogeneidad**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.

**Paso 4 — Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con Sesgo de publicación a la vista.** Con **Sesgo de publicación** ya delimitado, la pregunta pasa a ser de consecuencia: qué cambia para los estudiantes, para el tiempo de clase y para la carga del equipo. **Evidencia de partida** entrega la lectura observable; el juicio profesional sigue siendo humano y debe quedar firmado por quien lo hace.
...
|---|---|---|---|
| Intervenir sobre **Revisión sistemática** | Síntesis con protocolo previo, búsqueda exhaustiva y criterios explícitos de inclusión | Cuando **Evidencia de partida** es observable y accionable dentro del plazo de la decisión. | Sobrerreaccionar a una señal parcial. |
| Intervenir sobre **Metaanálisis** | Síntesis cuantitativa que combina tamaños de efecto de estudios comparables | Cuando la primera explicación no distingue mecanismo ni responsable. | Convertir el concepto en etiqueta y no en intervención. |
| Observar antes de decidir | Reducir la incertidumbre antes de comprometer tiempo y credibilidad | Cuando la decisión es reversible y la evidencia disponible no distingue causas. | Observar indefinidamente y no decidir nunca. |
| Derivar o escalar | Poner la decisión donde están la competencia y la responsabilidad | Cuando hay normativa, resguardo de datos, salud o vulneración de derechos en juego. | Delegar hacia arriba lo que sí correspondía decidir en el aula. |

**Frontera de aplicación.** En educación la heterogeneidad suele ser alta porque las intervenciones, los contextos y las medidas difieren. Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre meta-análisis y revisión sistemática |
|---|---|
...
Guárdala en `evidence/P17-C209-meta-analisis-y-revision-sistematica/` con estos archivos:
