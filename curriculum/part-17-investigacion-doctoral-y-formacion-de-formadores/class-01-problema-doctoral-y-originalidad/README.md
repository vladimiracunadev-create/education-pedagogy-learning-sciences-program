...
**Estado de evidencia:** `PRACTICA-PROFESIONAL` · **Etapa:** 🔴 Etapa E — Investigación avanzada y formación de formadores · **Población de referencia:** nivel doctoral, dirección de tesis y formación docente<br>
**Decisión que habilita:** determinar cuál es la tensión no resuelta que tu investigación abordará y por qué importa al campo<br>
...
2. Clasificar la situación distinguiendo **Problema doctoral** de **Tema**.
3. Decidir con fundamento, usando **Estado del arte** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Relevancia para el campo** a la vista.
...
| **Evidencia de logro** | qué muestra la formulación de un problema doctoral con la tensión identificada, su estado en la literatura y su relevancia frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
La delimitación es iterativa y el problema cambia durante el proceso: Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Problema doctoral"]
    C --> A2["Tema"]
    C --> A3["Estado del arte"]
    C --> A4["Relevancia para el<br/>campo"]
    A1 & A2 & A3 & A4 --> D{{"determinar cuál es la<br/>tensión no resuelta que<br/>tu investigación<br/>abordará y por qué<br/>importa al…"}}
    D --> E["Evidencia de aprendizaje<br/>la formulación de un<br/>problema doctoral con la<br/>tensión identificada, su<br/>estado en la literatura…"]
...
inocua: produce decisiones que atacan el problema equivocado. **Problema doctoral** no es lo
mismo que **Tema** —área de interés; no constituye por sí sola un problema investigable—, y tratarlos como sinónimos hace
que la intervención se dirija al lugar incorrecto. Del mismo modo, **Estado del arte** y
**Relevancia para el campo** describen aspectos distintos de la misma situación: el primero
síntesis crítica de lo que el campo sabe, discute y no ha resuelto, mientras el segundo razón por la que la comunidad especializada debería interesarse en la respuesta.
...
- **Evidencia de logro.** Qué muestra la formulación de un problema doctoral con la tensión identificada, su estado en la literatura y su relevancia frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
te deja en condiciones de cuál es la tensión no resuelta que tu investigación abordará y por qué importa al campo, y esa decisión se sostiene solo si
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Problema doctoral** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Problema doctoral de Tema.** El trabajo aquí es separar lo observado de lo interpretado sobre **Tema**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Estado del arte como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Estado del arte**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.

**Paso 4 — Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con Relevancia para el campo a la vista.** Con **Relevancia para el campo** ya delimitado, la pregunta pasa a ser de consecuencia: qué cambia para los estudiantes, para el tiempo de clase y para la carga del equipo. **Evidencia de partida** entrega la lectura observable; el juicio profesional sigue siendo humano y debe quedar firmado por quien lo hace.
...
|---|---|---|---|
| Intervenir sobre **Problema doctoral** | Tensión, contradicción o vacío no resuelto que la comunidad del campo reconoce como relevante | Cuando **Evidencia de partida** es observable y accionable dentro del plazo de la decisión. | Sobrerreaccionar a una señal parcial. |
| Intervenir sobre **Tema** | Área de interés; no constituye por sí sola un problema investigable | Cuando la primera explicación no distingue mecanismo ni responsable. | Convertir el concepto en etiqueta y no en intervención. |
| Observar antes de decidir | Reducir la incertidumbre antes de comprometer tiempo y credibilidad | Cuando la decisión es reversible y la evidencia disponible no distingue causas. | Observar indefinidamente y no decidir nunca. |
| Derivar o escalar | Poner la decisión donde están la competencia y la responsabilidad | Cuando hay normativa, resguardo de datos, salud o vulneración de derechos en juego. | Delegar hacia arriba lo que sí correspondía decidir en el aula. |

**Frontera de aplicación.** La delimitación es iterativa y el problema cambia durante el proceso: Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre problema doctoral y originalidad |
|---|---|
...
Guárdala en `evidence/P17-C205-problema-doctoral-y-originalidad/` con estos archivos:
