...
**Decisión que habilita:** determinar si el uso de una herramienta cumple con las obligaciones de protección de datos y de trato justo<br>
...
flowchart TB
    ...
    C --> A1["Base legal"]
    C --> A2["Minimización"]
    C --> A3["Sesgo algorítmico"]
    C --> A4["Supervisión humana"]
    A1 & A2 & A3 & A4 --> D{{"determinar si el uso de<br/>una herramienta cumple<br/>con las obligaciones de<br/>protección de datos y<br/>de…"}}
    D --> E["Evidencia de aprendizaje<br/>una evaluación de una<br/>herramienta con base<br/>legal, datos tratados,<br/>riesgos, sesgos y<br/>medidas de…"]
