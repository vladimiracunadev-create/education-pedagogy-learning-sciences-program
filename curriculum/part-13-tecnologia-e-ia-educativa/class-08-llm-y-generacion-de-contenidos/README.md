...
2. Clasificar la situación distinguiendo **Modelo de lenguaje** de **Alucinación**.
3. Decidir con fundamento, usando **Verificación** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Responsabilidad profesional** a la vista.
...
| **Evidencia de logro** | qué muestra un protocolo de uso profesional con tareas permitidas, verificación exigida y registro de lo verificado frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
Las capacidades cambian rápido y cualquier afirmación específica sobre lo que un modelo puede o no hacer envejece; Cuando esa condición falla, el paso siguiente no es forzar el método:
...
inocua: produce decisiones que atacan el problema equivocado. **Modelo de lenguaje** no es lo
mismo que **Alucinación** —producción de información falsa presentada con la misma seguridad que la correcta—, y tratarlos como sinónimos hace
que la intervención se dirija al lugar incorrecto. Del mismo modo, **Verificación** y
**Responsabilidad profesional** describen aspectos distintos de la misma situación: el primero
comprobación humana de la exactitud y la pertinencia de la salida antes de usarla, mientras el segundo principio de que quien usa la salida responde por ella, sin importar cómo se generó.
...
- **Evidencia de logro.** Qué muestra un protocolo de uso profesional con tareas permitidas, verificación exigida y registro de lo verificado frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
te deja en condiciones de en qué tareas usarás un modelo de lenguaje y qué verificación aplicarás a cada salida, y esa decisión se sostiene solo si
...
|---|---|---|
| UNESCO (2023). *Guidance for Generative AI in Education and Research*. | la referencia internacional más usada para políticas institucionales de uso. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
| Bender, E. et al. (2021). *On the Dangers of Stochastic Parrots*. | el contrapunto crítico sobre límites, sesgos y costos de estos sistemas. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Modelo de lenguaje** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Modelo de lenguaje de Alucinación.** El trabajo aquí es separar lo observado de lo interpretado sobre **Alucinación**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Verificación como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Verificación**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.

**Paso 4 — Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con Responsabilidad profesional a la vista.** Con **Responsabilidad profesional** ya delimitado, la pregunta pasa a ser de consecuencia: qué cambia para los estudiantes, para el tiempo de clase y para la carga del equipo. **Evidencia de partida** entrega la lectura observable; el juicio profesional sigue siendo humano y debe quedar firmado por quien lo hace.
...
|---|---|---|---|
| Intervenir sobre **Modelo de lenguaje** | Sistema que produce texto plausible a partir de patrones aprendidos, sin garantía de veracidad | Cuando **Evidencia de partida** es observable y accionable dentro del plazo de la decisión. | Sobrerreaccionar a una señal parcial. |
| Intervenir sobre **Alucinación** | Producción de información falsa presentada con la misma seguridad que la correcta | Cuando la primera explicación no distingue mecanismo ni responsable. | Convertir el concepto en etiqueta y no en intervención. |
| Observar antes de decidir | Reducir la incertidumbre antes de comprometer tiempo y credibilidad | Cuando la decisión es reversible y la evidencia disponible no distingue causas. | Observar indefinidamente y no decidir nunca. |
| Derivar o escalar | Poner la decisión donde están la competencia y la responsabilidad | Cuando hay normativa, resguardo de datos, salud o vulneración de derechos en juego. | Delegar hacia arriba lo que sí correspondía decidir en el aula. |

**Frontera de aplicación.** Las capacidades cambian rápido y cualquier afirmación específica sobre lo que un modelo puede o no hacer envejece; Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre lLM y generación de contenidos |
|---|---|
...
Guárdala en `evidence/P13-C164-llm-y-generacion-de-contenidos/` con estos archivos:
