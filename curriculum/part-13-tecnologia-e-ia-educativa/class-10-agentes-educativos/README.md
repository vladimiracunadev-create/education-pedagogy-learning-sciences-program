...
2. Clasificar la situación distinguiendo **Agente** de **Autonomía acotada**.
3. Decidir con fundamento, usando **Punto de control** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Criterio de detención** a la vista.
...
| **Evidencia de logro** | qué muestra el diseño de un agente para una tarea acotada, con puntos de control humano y criterios de detención frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
Es un campo en desarrollo rápido y con poca evidencia educativa. Cuando esa condición falla, el paso siguiente no es forzar el método:
...
inocua: produce decisiones que atacan el problema equivocado. **Agente** no es lo
mismo que **Autonomía acotada** —límite explícito de lo que el agente puede hacer sin autorización humana—, y tratarlos como sinónimos hace
que la intervención se dirija al lugar incorrecto. Del mismo modo, **Punto de control** y
**Criterio de detención** describen aspectos distintos de la misma situación: el primero
instancia en que una persona revisa y autoriza antes de continuar, mientras el segundo condición que obliga al agente a detenerse y escalar a una persona.
...
- **Evidencia de logro.** Qué muestra el diseño de un agente para una tarea acotada, con puntos de control humano y criterios de detención frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
te deja en condiciones de qué tarea educativa puede ejecutar un agente y qué control humano debe conservarse, y esa decisión se sostiene solo si
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Agente** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Agente de Autonomía acotada.** El trabajo aquí es separar lo observado de lo interpretado sobre **Autonomía acotada**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Punto de control como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Punto de control**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.

**Paso 4 — Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con Criterio de detención a la vista.** Con **Criterio de detención** ya delimitado, la pregunta pasa a ser de consecuencia: qué cambia para los estudiantes, para el tiempo de clase y para la carga del equipo. **Evidencia de partida** entrega la lectura observable; el juicio profesional sigue siendo humano y debe quedar firmado por quien lo hace.
...
|---|---|---|---|
| Intervenir sobre **Agente** | Sistema que planifica y ejecuta acciones para cumplir un objetivo, no solo genera texto | Cuando **Evidencia de partida** es observable y accionable dentro del plazo de la decisión. | Sobrerreaccionar a una señal parcial. |
| Intervenir sobre **Autonomía acotada** | Límite explícito de lo que el agente puede hacer sin autorización humana | Cuando la primera explicación no distingue mecanismo ni responsable. | Convertir el concepto en etiqueta y no en intervención. |
| Observar antes de decidir | Reducir la incertidumbre antes de comprometer tiempo y credibilidad | Cuando la decisión es reversible y la evidencia disponible no distingue causas. | Observar indefinidamente y no decidir nunca. |
| Derivar o escalar | Poner la decisión donde están la competencia y la responsabilidad | Cuando hay normativa, resguardo de datos, salud o vulneración de derechos en juego. | Delegar hacia arriba lo que sí correspondía decidir en el aula. |

**Frontera de aplicación.** Es un campo en desarrollo rápido y con poca evidencia educativa. Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre agentes educativos |
|---|---|
...
Guárdala en `evidence/P13-C166-agentes-educativos/` con estos archivos:
