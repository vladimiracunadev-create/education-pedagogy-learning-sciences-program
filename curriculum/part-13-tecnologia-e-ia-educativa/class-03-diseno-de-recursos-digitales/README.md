...
**Estado de evidencia:** `ROBUSTA` · **Etapa:** 🟣 Etapa C — Núcleo profesional docente · **Población de referencia:** transversal a niveles y modalidades<br>
**Decisión que habilita:** determinar qué elementos de tu recurso están ayudando y cuáles solo aumentan la carga<br>
...
2. Clasificar la situación distinguiendo **Principio de coherencia** de **Principio de redundancia**.
3. Decidir con fundamento, usando **Contigüidad espacial y temporal** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Segmentación** a la vista.
...
| **Evidencia de logro** | qué muestra un recurso digital rediseñado con los principios aplicados y la justificación de cada cambio frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
Algunos principios se invierten con la experticia: Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Principio de<br/>coherencia"]
    C --> A2["Principio de<br/>redundancia"]
    C --> A3["Contigüidad espacial y<br/>temporal"]
    C --> A4["Segmentación"]
    A1 & A2 & A3 & A4 --> D{{"determinar qué elementos<br/>de tu recurso están<br/>ayudando y cuáles solo<br/>aumentan la carga"}}
    D --> E["Evidencia de aprendizaje<br/>un recurso digital<br/>rediseñado con los<br/>principios aplicados y<br/>la justificación de cada<br/>cambio"]
...
inocua: produce decisiones que atacan el problema equivocado. **Principio de coherencia** no es lo
mismo que **Principio de redundancia** —evitar presentar el mismo texto por escrito y en audio simultáneamente—, y tratarlos como sinónimos hace
que la intervención se dirija al lugar incorrecto. Del mismo modo, **Contigüidad espacial y temporal** y
**Segmentación** describen aspectos distintos de la misma situación: el primero
situar juntos en el espacio y en el tiempo los elementos que deben integrarse, mientras el segundo dividir la presentación en tramos con control del ritmo por parte del estudiante.
...
- **Evidencia de logro.** Qué muestra un recurso digital rediseñado con los principios aplicados y la justificación de cada cambio frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
te deja en condiciones de qué elementos de tu recurso están ayudando y cuáles solo aumentan la carga, y esa decisión se sostiene solo si
...
|---|---|---|
| Mayer, R. (2021). *Multimedia Learning* (3.ª ed.). | los principios con su evidencia experimental y sus condiciones límite. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
| Clark, R. & Mayer, R. (2016). *e-Learning and the Science of Instruction*. | traduce los principios a decisiones de diseño de material y de cursos en línea. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Principio de coherencia** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Principio de coherencia de Principio de redundancia.** El trabajo aquí es separar lo observado de lo interpretado sobre **Principio de redundancia**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Contigüidad espacial y temporal como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Contigüidad espacial y temporal**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.

**Paso 4 — Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con Segmentación a la vista.** Con **Segmentación** ya delimitado, la pregunta pasa a ser de consecuencia: qué cambia para los estudiantes, para el tiempo de clase y para la carga del equipo. **Evidencia de partida** entrega la lectura observable; el juicio profesional sigue siendo humano y debe quedar firmado por quien lo hace.
...
|---|---|---|---|
| Intervenir sobre **Principio de coherencia** | Eliminar todo elemento que no contribuye al objetivo, aunque resulte atractivo | Cuando **Evidencia de partida** es observable y accionable dentro del plazo de la decisión. | Sobrerreaccionar a una señal parcial. |
| Intervenir sobre **Principio de redundancia** | Evitar presentar el mismo texto por escrito y en audio simultáneamente | Cuando la primera explicación no distingue mecanismo ni responsable. | Convertir el concepto en etiqueta y no en intervención. |
| Observar antes de decidir | Reducir la incertidumbre antes de comprometer tiempo y credibilidad | Cuando la decisión es reversible y la evidencia disponible no distingue causas. | Observar indefinidamente y no decidir nunca. |
| Derivar o escalar | Poner la decisión donde están la competencia y la responsabilidad | Cuando hay normativa, resguardo de datos, salud o vulneración de derechos en juego. | Delegar hacia arriba lo que sí correspondía decidir en el aula. |

**Frontera de aplicación.** Algunos principios se invierten con la experticia: Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre diseño de recursos digitales |
|---|---|
...
Guárdala en `evidence/P13-C159-diseno-de-recursos-digitales/` con estos archivos:
