...
**Decisión que habilita:** determinar qué estructura y qué presencia docente sostendrán el aprendizaje en tu aula virtual<br>
...
2. Clasificar la situación distinguiendo **Aula virtual** de **Presencia docente**.
3. Decidir con fundamento, usando **Estructura** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Interacción con propósito** a la vista.
...
| **Evidencia de logro** | qué muestra el diseño de un aula virtual con estructura, plan de presencia docente e interacción con propósito frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
La comparación entre modalidades presencial y en línea rinde poco: Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Aula virtual"]
    C --> A2["Presencia docente"]
    C --> A3["Estructura"]
    C --> A4["Interacción con<br/>propósito"]
    A1 & A2 & A3 & A4 --> D{{"determinar qué<br/>estructura y qué<br/>presencia docente<br/>sostendrán el<br/>aprendizaje en tu aula<br/>virtual"}}
    D --> E["Evidencia de aprendizaje<br/>el diseño de un aula<br/>virtual con estructura,<br/>plan de presencia<br/>docente e interacción<br/>con…"]
...
inocua: produce decisiones que atacan el problema equivocado. **Aula virtual** no es lo
mismo que **Presencia docente** —conjunto de acciones visibles del docente que sostienen el curso y a los estudiantes—, y tratarlos como sinónimos hace
que la intervención se dirija al lugar incorrecto. Del mismo modo, **Estructura** y
**Interacción con propósito** describen aspectos distintos de la misma situación: el primero
organización predecible del espacio que reduce la carga de navegación y de gestión, mientras el segundo actividad de intercambio diseñada para un objetivo y no por sí misma.
...
- **Evidencia de logro.** Qué muestra el diseño de un aula virtual con estructura, plan de presencia docente e interacción con propósito frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
te deja en condiciones de qué estructura y qué presencia docente sostendrán el aprendizaje en tu aula virtual, y esa decisión se sostiene solo si
...
|---|---|---|
| Garrison, D., Anderson, T. & Archer, W. (2000). *Critical Inquiry in a Text-Based Environment*. | modelo de presencia docente, social y cognitiva; sigue siendo el marco más usado. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
| Means, B. et al. (2013). *The Effectiveness of Online and Blended Learning*. Teachers College Record. | síntesis que muestra que el diseño y el tiempo explican más que la modalidad. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Aula virtual** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Aula virtual de Presencia docente.** El trabajo aquí es separar lo observado de lo interpretado sobre **Presencia docente**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Estructura como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Estructura**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.

**Paso 4 — Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con Interacción con propósito a la vista.** Con **Interacción con propósito** ya delimitado, la pregunta pasa a ser de consecuencia: qué cambia para los estudiantes, para el tiempo de clase y para la carga del equipo. **Evidencia de partida** entrega la lectura observable; el juicio profesional sigue siendo humano y debe quedar firmado por quien lo hace.
...
|---|---|---|---|
| Intervenir sobre **Aula virtual** | Espacio digital que organiza materiales, actividades, interacción y evaluación de un curso | Cuando **Evidencia de partida** es observable y accionable dentro del plazo de la decisión. | Sobrerreaccionar a una señal parcial. |
| Intervenir sobre **Presencia docente** | Conjunto de acciones visibles del docente que sostienen el curso y a los estudiantes | Cuando la primera explicación no distingue mecanismo ni responsable. | Convertir el concepto en etiqueta y no en intervención. |
| Observar antes de decidir | Reducir la incertidumbre antes de comprometer tiempo y credibilidad | Cuando la decisión es reversible y la evidencia disponible no distingue causas. | Observar indefinidamente y no decidir nunca. |
| Derivar o escalar | Poner la decisión donde están la competencia y la responsabilidad | Cuando hay normativa, resguardo de datos, salud o vulneración de derechos en juego. | Delegar hacia arriba lo que sí correspondía decidir en el aula. |

**Frontera de aplicación.** La comparación entre modalidades presencial y en línea rinde poco: Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre lMS y aulas virtuales |
|---|---|
...
Guárdala en `evidence/P13-C158-lms-y-aulas-virtuales/` con estos archivos:
