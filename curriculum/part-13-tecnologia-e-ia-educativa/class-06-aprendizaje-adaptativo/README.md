...
**Decisión que habilita:** determinar si un sistema adaptativo aporta a tu objetivo o solo automatiza la asignación de ejercicios<br>
...
2. Clasificar la situación distinguiendo **Aprendizaje adaptativo** de **Modelo del estudiante**.
3. Decidir con fundamento, usando **Ruta adaptativa** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Delegación pedagógica** a la vista.
...
| **Evidencia de logro** | qué muestra una evaluación fundamentada de un sistema adaptativo con sus supuestos, su evidencia y sus riesgos frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
Buena parte de la evidencia proviene de los propios proveedores y con diseños débiles. Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Aprendizaje adaptativo"]
    C --> A2["Modelo del estudiante"]
    C --> A3["Ruta adaptativa"]
    C --> A4["Delegación pedagógica"]
    A1 & A2 & A3 & A4 --> D{{"determinar si un sistema<br/>adaptativo aporta a tu<br/>objetivo o solo<br/>automatiza la asignación<br/>de…"}}
    D --> E["Evidencia de aprendizaje<br/>una evaluación<br/>fundamentada de un<br/>sistema adaptativo con<br/>sus supuestos, su<br/>evidencia y sus…"]
...
inocua: produce decisiones que atacan el problema equivocado. **Aprendizaje adaptativo** no es lo
mismo que **Modelo del estudiante** —representación interna que el sistema construye sobre lo que el estudiante sabe—, y tratarlos como sinónimos hace
que la intervención se dirija al lugar incorrecto. Del mismo modo, **Ruta adaptativa** y
**Delegación pedagógica** describen aspectos distintos de la misma situación: el primero
secuencia individualizada que el sistema propone a partir de su modelo, mientras el segundo decisiones de enseñanza que quedan en manos del sistema y no del docente.
...
- **Evidencia de logro.** Qué muestra una evaluación fundamentada de un sistema adaptativo con sus supuestos, su evidencia y sus riesgos frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
te deja en condiciones de si un sistema adaptativo aporta a tu objetivo o solo automatiza la asignación de ejercicios, y esa decisión se sostiene solo si
...
|---|---|---|
| VanLehn, K. (2011). *The Relative Effectiveness of Human Tutoring, Intelligent Tutoring Systems, and Other Tutoring Systems*. | compara efectos con rigor y ordena expectativas sobre lo que estos sistemas logran. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
| Koedinger, K. & Aleven, V. (2007). *Exploring the Assistance Dilemma*. | analiza cuánta ayuda debe dar un sistema y cuándo la ayuda excesiva perjudica. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Aprendizaje adaptativo** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Aprendizaje adaptativo de Modelo del estudiante.** El trabajo aquí es separar lo observado de lo interpretado sobre **Modelo del estudiante**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Ruta adaptativa como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Ruta adaptativa**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.

**Paso 4 — Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con Delegación pedagógica a la vista.** Con **Delegación pedagógica** ya delimitado, la pregunta pasa a ser de consecuencia: qué cambia para los estudiantes, para el tiempo de clase y para la carga del equipo. **Evidencia de partida** entrega la lectura observable; el juicio profesional sigue siendo humano y debe quedar firmado por quien lo hace.
...
|---|---|---|---|
| Intervenir sobre **Aprendizaje adaptativo** | Sistema que ajusta contenido o dificultad según el desempeño del estudiante | Cuando **Evidencia de partida** es observable y accionable dentro del plazo de la decisión. | Sobrerreaccionar a una señal parcial. |
| Intervenir sobre **Modelo del estudiante** | Representación interna que el sistema construye sobre lo que el estudiante sabe | Cuando la primera explicación no distingue mecanismo ni responsable. | Convertir el concepto en etiqueta y no en intervención. |
| Observar antes de decidir | Reducir la incertidumbre antes de comprometer tiempo y credibilidad | Cuando la decisión es reversible y la evidencia disponible no distingue causas. | Observar indefinidamente y no decidir nunca. |
| Derivar o escalar | Poner la decisión donde están la competencia y la responsabilidad | Cuando hay normativa, resguardo de datos, salud o vulneración de derechos en juego. | Delegar hacia arriba lo que sí correspondía decidir en el aula. |

**Frontera de aplicación.** Buena parte de la evidencia proviene de los propios proveedores y con diseños débiles. Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre aprendizaje adaptativo |
|---|---|
...
Guárdala en `evidence/P13-C162-aprendizaje-adaptativo/` con estos archivos:
