...
**Decisión que habilita:** determinar qué desempeño real quieres evaluar y qué criterios permitirán juzgarlo con consistencia<br>
...
2. Clasificar la situación distinguiendo **Evaluación auténtica** de **Rúbrica analítica**.
3. Decidir con fundamento, usando **Calibración** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Validez de la inferencia** a la vista.
...
| **Evidencia de logro** | qué muestra una tarea de evaluación auténtica con rúbrica calibrada y evidencia de acuerdo entre dos evaluadores frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
La autenticidad no garantiza validez: Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Evaluación auténtica"]
    C --> A2["Rúbrica analítica"]
    C --> A3["Calibración"]
    C --> A4["Validez de la<br/>inferencia"]
    A1 & A2 & A3 & A4 --> D{{"determinar qué desempeño<br/>real quieres evaluar y<br/>qué criterios permitirán<br/>juzgarlo con…"}}
    D --> E["Evidencia de aprendizaje<br/>una tarea de evaluación<br/>auténtica con rúbrica<br/>calibrada y evidencia de<br/>acuerdo entre dos…"]
...
inocua: produce decisiones que atacan el problema equivocado. **Evaluación auténtica** no es lo
mismo que **Rúbrica analítica** —instrumento que descompone el desempeño en criterios y niveles observables—, y tratarlos como sinónimos hace
que la intervención se dirija al lugar incorrecto. Del mismo modo, **Calibración** y
**Validez de la inferencia** describen aspectos distintos de la misma situación: el primero
proceso de acordar la aplicación de la rúbrica entre evaluadores hasta lograr consistencia, mientras el segundo justificación de que la tarea permite concluir lo que se afirma sobre el estudiante.
...
- **Evidencia de logro.** Qué muestra una tarea de evaluación auténtica con rúbrica calibrada y evidencia de acuerdo entre dos evaluadores frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
te deja en condiciones de qué desempeño real quieres evaluar y qué criterios permitirán juzgarlo con consistencia, y esa decisión se sostiene solo si
...
|---|---|---|
| Wiggins, G. (1998). *Educative Assessment*. | define evaluación auténtica con criterios exigibles y no como sinónimo de creatividad. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
| Jonsson, A. & Svingby, G. (2007). *The Use of Scoring Rubrics: Reliability, Validity and Educational Consequences*. | evidencia sobre cuándo las rúbricas mejoran la consistencia y cuándo no. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Evaluación auténtica** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Evaluación auténtica de Rúbrica analítica.** El trabajo aquí es separar lo observado de lo interpretado sobre **Rúbrica analítica**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Calibración como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Calibración**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.

**Paso 4 — Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con Validez de la inferencia a la vista.** Con **Validez de la inferencia** ya delimitado, la pregunta pasa a ser de consecuencia: qué cambia para los estudiantes, para el tiempo de clase y para la carga del equipo. **Evidencia de partida** entrega la lectura observable; el juicio profesional sigue siendo humano y debe quedar firmado por quien lo hace.
...
|---|---|---|---|
| Intervenir sobre **Evaluación auténtica** | Tarea que replica desempeños valorados fuera de la escuela y exige integrar conocimientos | Cuando **Evidencia de partida** es observable y accionable dentro del plazo de la decisión. | Sobrerreaccionar a una señal parcial. |
| Intervenir sobre **Rúbrica analítica** | Instrumento que descompone el desempeño en criterios y niveles observables | Cuando la primera explicación no distingue mecanismo ni responsable. | Convertir el concepto en etiqueta y no en intervención. |
| Observar antes de decidir | Reducir la incertidumbre antes de comprometer tiempo y credibilidad | Cuando la decisión es reversible y la evidencia disponible no distingue causas. | Observar indefinidamente y no decidir nunca. |
| Derivar o escalar | Poner la decisión donde están la competencia y la responsabilidad | Cuando hay normativa, resguardo de datos, salud o vulneración de derechos en juego. | Delegar hacia arriba lo que sí correspondía decidir en el aula. |

**Frontera de aplicación.** La autenticidad no garantiza validez: Fuera de esa frontera, la comparación
...
Guárdala en `evidence/P05-C071-evaluacion-autentica/` con estos archivos:
