...
**Estado de evidencia:** `EN-DEBATE` · **Etapa:** 🔵 Etapa B — Enseñanza por ciclo vital · **Población de referencia:** 1.º a 4.º medio (14 a 18 años)<br>
**Decisión que habilita:** determinar si tu objetivo se sirve mejor de un problema abierto o de instrucción explícita seguida de aplicación<br>
...
| **Tutoría de proceso** | acompañamiento que orienta el razonamiento del grupo mediante preguntas, sin entregar la solución ni dejar que el grupo se pierda indefinidamente |
...
2. Clasificar la situación distinguiendo **Problema mal estructurado** de **Tutoría de proceso**.
3. Decidir con fundamento, usando **Activación de conocimiento previo** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Cierre conceptual** a la vista.
...
| **Evidencia de logro** | qué muestra un problema bien construido con su guía de tutoría, sus recursos y su evaluación del aprendizaje adquirido frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
El debate sobre guía mínima aplica directamente aquí. Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Problema mal<br/>estructurado"]
    C --> A2["Tutoría de proceso"]
    C --> A3["Activación de<br/>conocimiento previo"]
    C --> A4["Cierre conceptual"]
    A1 & A2 & A3 & A4 --> D{{"determinar si tu<br/>objetivo se sirve mejor<br/>de un problema abierto o<br/>de instrucción<br/>explícita…"}}
    D --> E["Evidencia de aprendizaje<br/>un problema bien<br/>construido con su guía<br/>de tutoría, sus recursos<br/>y su evaluación del…"]
...
inocua: produce decisiones que atacan el problema equivocado. **Problema mal estructurado** no es lo
mismo que **Tutoría de proceso** —acompañamiento que orienta el razonamiento del grupo mediante preguntas, sin entregar la solución ni dejar que el grupo se pierda indefinidamente—, y tratarlos como sinónimos hace
que la intervención se dirija al lugar incorrecto. Del mismo modo, **Activación de conocimiento previo** y
**Cierre conceptual** describen aspectos distintos de la misma situación: el primero
fase inicial en que el grupo determina qué sabe y qué necesita averiguar, mientras el segundo momento en que se sistematiza el contenido aprendido para que no quede disperso.
...
- **Evidencia de logro.** Qué muestra un problema bien construido con su guía de tutoría, sus recursos y su evaluación del aprendizaje adquirido frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
te deja en condiciones de si tu objetivo se sirve mejor de un problema abierto o de instrucción explícita seguida de aplicación, y esa decisión se sostiene solo si
...
|---|---|---|
| Hmelo-Silver, C. (2004). *Problem-Based Learning: What and How Do Students Learn?* | revisión que ordena qué aprende el estudiante en este enfoque y bajo qué condiciones. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
| Schmidt, H., Loyens, S., van Gog, T. & Paas, F. (2007). *Problem-Based Learning is Compatible with Human Cognitive Architecture*. | el contrapunto al artículo de guía mínima; útil para entender el debate completo. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
...
**Situación.** En 2.º medio, la mitad del curso entrega trabajos hechos con herramientas generativas y el resto dejó de entregar. La respuesta institucional fue prohibir el celular; el desenganche siguió igual.

**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Problema mal estructurado** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Problema mal estructurado de Tutoría de proceso.** El trabajo aquí es separar lo observado de lo interpretado sobre **Tutoría de proceso**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Activación de conocimiento previo como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Activación de conocimiento previo**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.

**Paso 4 — Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con Cierre conceptual a la vista.** Con **Cierre conceptual** ya delimitado, la pregunta pasa a ser de consecuencia: qué cambia para los estudiantes, para el tiempo de clase y para la carga del equipo. **Evidencia de partida** entrega la lectura observable; el juicio profesional sigue siendo humano y debe quedar firmado por quien lo hace.
...
|---|---|---|---|
| Intervenir sobre **Problema mal estructurado** | Situación sin una única solución correcta ni un procedimiento evidente; exige decisiones | Cuando **Evidencia de partida** es observable y accionable dentro del plazo de la decisión. | Sobrerreaccionar a una señal parcial. |
| Intervenir sobre **Tutoría de proceso** | Acompañamiento que orienta el razonamiento del grupo mediante preguntas, sin entregar la solución ni dejar que el grupo se pierda indefinidamente | Cuando la primera explicación no distingue mecanismo ni responsable. | Convertir el concepto en etiqueta y no en intervención. |
| Observar antes de decidir | Reducir la incertidumbre antes de comprometer tiempo y credibilidad | Cuando la decisión es reversible y la evidencia disponible no distingue causas. | Observar indefinidamente y no decidir nunca. |
| Derivar o escalar | Poner la decisión donde están la competencia y la responsabilidad | Cuando hay normativa, resguardo de datos, salud o vulneración de derechos en juego. | Delegar hacia arriba lo que sí correspondía decidir en el aula. |

**Frontera de aplicación.** El debate sobre guía mínima aplica directamente aquí. Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre aprendizaje basado en problemas |
|---|---|
...
Guárdala en `evidence/P05-C066-aprendizaje-basado-en-problemas/` con estos archivos:
...
Esta evidencia alimenta el artefacto de la parte: **desafío de educación media con autoridad pedagógica explícita, evaluación auténtica y análisis de resultados estudiante por estudiante**.
...
Riesgo característico de esta parte: **Interpretar como indisciplina lo que es un desajuste entre etapa y ambiente.** Antes de aplicar
