...
**Estado de evidencia:** `ROBUSTA` · **Etapa:** 🔵 Etapa B — Enseñanza por ciclo vital · **Población de referencia:** 1.º a 4.º medio (14 a 18 años)<br>
**Decisión que habilita:** determinar qué práctica de tu establecimiento está produciendo el desenganche que atribuye a los estudiantes<br>
...
2. Clasificar la situación distinguiendo **Desajuste etapa-ambiente** de **Necesidad de autonomía**.
3. Decidir con fundamento, usando **Sensibilidad al estatus** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Búsqueda de sentido** a la vista.
...
| **Evidencia de logro** | qué muestra un diagnóstico de desajuste entre etapa y ambiente en un curso real, con tres correcciones concretas frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
El desajuste explica una parte del desenganche, no todo: Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Desajuste<br/>etapa-ambiente"]
    C --> A2["Necesidad de autonomía"]
    C --> A3["Sensibilidad al<br/>estatus"]
    C --> A4["Búsqueda de sentido"]
    A1 & A2 & A3 & A4 --> D{{"determinar qué práctica<br/>de tu establecimiento<br/>está produciendo el<br/>desenganche que atribuye<br/>a…"}}
    D --> E["Evidencia de aprendizaje<br/>un diagnóstico de<br/>desajuste entre etapa y<br/>ambiente en un curso<br/>real, con tres<br/>correcciones…"]
...
inocua: produce decisiones que atacan el problema equivocado. **Desajuste etapa-ambiente** no es lo
mismo que **Necesidad de autonomía** —demanda creciente de decidir; el control percibido como arbitrario produce resistencia—, y tratarlos como sinónimos hace
que la intervención se dirija al lugar incorrecto. Del mismo modo, **Sensibilidad al estatus** y
**Búsqueda de sentido** describen aspectos distintos de la misma situación: el primero
alta reactividad a la evaluación de los pares;, mientras el segundo exigencia de que lo que se hace tenga relación con algo que importa.
...
- **Evidencia de logro.** Qué muestra un diagnóstico de desajuste entre etapa y ambiente en un curso real, con tres correcciones concretas frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
te deja en condiciones de qué práctica de tu establecimiento está produciendo el desenganche que atribuye a los estudiantes, y esa decisión se sostiene solo si
...
|---|---|---|
| Eccles, J. et al. (1993). *Stage-Environment Fit*. American Psychologist, 48(2). | el estudio que explica la caída de motivación en la transición a secundaria; base del diagnóstico. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
| Steinberg, L. (2014). *Age of Opportunity*. | reinterpreta la adolescencia como período de plasticidad y oportunidad educativa. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Desajuste etapa-ambiente** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Desajuste etapa-ambiente de Necesidad de autonomía.** El trabajo aquí es separar lo observado de lo interpretado sobre **Necesidad de autonomía**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Sensibilidad al estatus como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Sensibilidad al estatus**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.

**Paso 4 — Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con Búsqueda de sentido a la vista.** Con **Búsqueda de sentido** ya delimitado, la pregunta pasa a ser de consecuencia: qué cambia para los estudiantes, para el tiempo de clase y para la carga del equipo. **Evidencia de partida** entrega la lectura observable; el juicio profesional sigue siendo humano y debe quedar firmado por quien lo hace.
...
|---|---|---|---|
| Intervenir sobre **Desajuste etapa-ambiente** | Desencuentro entre lo que la etapa demanda y lo que la escuela ofrece; explica la caída de motivación | Cuando **Evidencia de partida** es observable y accionable dentro del plazo de la decisión. | Sobrerreaccionar a una señal parcial. |
| Intervenir sobre **Necesidad de autonomía** | Demanda creciente de decidir; el control percibido como arbitrario produce resistencia | Cuando la primera explicación no distingue mecanismo ni responsable. | Convertir el concepto en etiqueta y no en intervención. |
| Observar antes de decidir | Reducir la incertidumbre antes de comprometer tiempo y credibilidad | Cuando la decisión es reversible y la evidencia disponible no distingue causas. | Observar indefinidamente y no decidir nunca. |
| Derivar o escalar | Poner la decisión donde están la competencia y la responsabilidad | Cuando hay normativa, resguardo de datos, salud o vulneración de derechos en juego. | Delegar hacia arriba lo que sí correspondía decidir en el aula. |

**Frontera de aplicación.** El desajuste explica una parte del desenganche, no todo: Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre psicología de la adolescencia |
|---|---|
...
Guárdala en `evidence/P05-C061-psicologia-de-la-adolescencia/` con estos archivos:
