...
**Decisión que habilita:** determinar el diseño completo del desafío y qué evidencia probará que hubo aprendizaje disciplinar<br>
...
2. Clasificar la situación distinguiendo **Desafío integrador** de **Autonomía estructurada**.
3. Decidir con fundamento, usando **Producto público** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Análisis por estudiante** a la vista.
...
| **Evidencia de logro** | qué muestra un desafío completo de educación media, ejecutado, con evaluación auténtica y análisis de resultados por estudiante frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
Un desafío ejecutado una vez no prueba la eficacia del método: Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Desafío integrador"]
    C --> A2["Autonomía estructurada"]
    C --> A3["Producto público"]
    C --> A4["Análisis por<br/>estudiante"]
    A1 & A2 & A3 & A4 --> D{{"determinar el diseño<br/>completo del desafío y<br/>qué evidencia probará<br/>que hubo aprendizaje…"}}
    D --> E["Evidencia de aprendizaje<br/>un desafío completo de<br/>educación media,<br/>ejecutado, con<br/>evaluación auténtica y<br/>análisis de…"]
...
inocua: produce decisiones que atacan el problema equivocado. **Desafío integrador** no es lo
mismo que **Autonomía estructurada** —libertad de decisión dentro de límites explícitos que sostienen el aprendizaje—, y tratarlos como sinónimos hace
que la intervención se dirija al lugar incorrecto. Del mismo modo, **Producto público** y
**Análisis por estudiante** describen aspectos distintos de la misma situación: el primero
entrega que se presenta ante una audiencia real, lo que eleva la exigencia percibida, mientras el segundo revisión individual de resultados que impide que el promedio del grupo oculte a quien no aprendió.
...
- **Evidencia de logro.** Qué muestra un desafío completo de educación media, ejecutado, con evaluación auténtica y análisis de resultados por estudiante frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
te deja en condiciones de el diseño completo del desafío y qué evidencia probará que hubo aprendizaje disciplinar, y esa decisión se sostiene solo si
...
|---|---|---|
| Barron, B. & Darling-Hammond, L. (2008). *Teaching for Meaningful Learning*. | condiciones de diseño de experiencias extensas con evidencia de aprendizaje. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
| Wiggins, G. (1998). *Educative Assessment*. | criterios de evaluación auténtica aplicables al producto y al proceso del desafío. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Desafío integrador** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Desafío integrador de Autonomía estructurada.** El trabajo aquí es separar lo observado de lo interpretado sobre **Autonomía estructurada**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Producto público como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Producto público**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.

**Paso 4 — Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con Análisis por estudiante a la vista.** Con **Análisis por estudiante** ya delimitado, la pregunta pasa a ser de consecuencia: qué cambia para los estudiantes, para el tiempo de clase y para la carga del equipo. **Evidencia de partida** entrega la lectura observable; el juicio profesional sigue siendo humano y debe quedar firmado por quien lo hace.
...
|---|---|---|---|
| Intervenir sobre **Desafío integrador** | Tarea extensa que exige contenido disciplinar, autonomía y producto público | Cuando **Evidencia de partida** es observable y accionable dentro del plazo de la decisión. | Sobrerreaccionar a una señal parcial. |
| Intervenir sobre **Autonomía estructurada** | Libertad de decisión dentro de límites explícitos que sostienen el aprendizaje | Cuando la primera explicación no distingue mecanismo ni responsable. | Convertir el concepto en etiqueta y no en intervención. |
| Observar antes de decidir | Reducir la incertidumbre antes de comprometer tiempo y credibilidad | Cuando la decisión es reversible y la evidencia disponible no distingue causas. | Observar indefinidamente y no decidir nunca. |
| Derivar o escalar | Poner la decisión donde están la competencia y la responsabilidad | Cuando hay normativa, resguardo de datos, salud o vulneración de derechos en juego. | Delegar hacia arriba lo que sí correspondía decidir en el aula. |

**Frontera de aplicación.** Un desafío ejecutado una vez no prueba la eficacia del método: Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre proyecto integrador: desafío de educación media |
|---|---|
...
Guárdala en `evidence/P05-C072-proyecto-integrador-desafio-de-educacion-media/` con estos archivos:
