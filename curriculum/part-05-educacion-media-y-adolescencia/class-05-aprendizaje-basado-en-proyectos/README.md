...
**Decisión que habilita:** determinar qué aprendizaje disciplinar debe quedar comprobado al final del proyecto y cómo se comprobará<br>
...
2. Clasificar la situación distinguiendo **Pregunta conductora** de **Hito intermedio**.
3. Decidir con fundamento, usando **Andamiaje del proyecto** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Evaluación del aprendizaje** a la vista.
...
| **Evidencia de logro** | qué muestra el diseño de un proyecto con objetivos disciplinares, hitos, andamiaje y evaluación separada del producto final frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
Los metaanálisis muestran efectos positivos pero heterogéneos, y con frecuencia menores en conocimiento disciplinar que en motivación o habilidades de trabajo. Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Pregunta conductora"]
    C --> A2["Hito intermedio"]
    C --> A3["Andamiaje del proyecto"]
    C --> A4["Evaluación del<br/>aprendizaje"]
    A1 & A2 & A3 & A4 --> D{{"determinar qué<br/>aprendizaje disciplinar<br/>debe quedar comprobado<br/>al final del proyecto y<br/>cómo se…"}}
    D --> E["Evidencia de aprendizaje<br/>el diseño de un proyecto<br/>con objetivos<br/>disciplinares, hitos,<br/>andamiaje y evaluación<br/>separada…"]
...
inocua: produce decisiones que atacan el problema equivocado. **Pregunta conductora** no es lo
mismo que **Hito intermedio** —punto de control con entrega y retroalimentación antes del producto final—, y tratarlos como sinónimos hace
que la intervención se dirija al lugar incorrecto. Del mismo modo, **Andamiaje del proyecto** y
**Evaluación del aprendizaje** describen aspectos distintos de la misma situación: el primero
apoyos explícitos —modelos, plantillas, enseñanza directa— dentro del trabajo autónomo, mientras el segundo comprobación del contenido aprendido, distinta de la evaluación del producto entregado.
...
- **Evidencia de logro.** Qué muestra el diseño de un proyecto con objetivos disciplinares, hitos, andamiaje y evaluación separada del producto final frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
te deja en condiciones de qué aprendizaje disciplinar debe quedar comprobado al final del proyecto y cómo se comprobará, y esa decisión se sostiene solo si
...
|---|---|---|
| Condliffe, B. et al. (2017). *Project-Based Learning: A Literature Review*. MDRC. | revisión honesta sobre qué muestra y qué no muestra la evidencia disponible. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
| Barron, B. & Darling-Hammond, L. (2008). *Teaching for Meaningful Learning*. | sintetiza condiciones de diseño asociadas a mejores resultados en enfoques por proyectos. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Pregunta conductora** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Pregunta conductora de Hito intermedio.** El trabajo aquí es separar lo observado de lo interpretado sobre **Hito intermedio**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Andamiaje del proyecto como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Andamiaje del proyecto**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.

**Paso 4 — Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con Evaluación del aprendizaje a la vista.** Con **Evaluación del aprendizaje** ya delimitado, la pregunta pasa a ser de consecuencia: qué cambia para los estudiantes, para el tiempo de clase y para la carga del equipo. **Evidencia de partida** entrega la lectura observable; el juicio profesional sigue siendo humano y debe quedar firmado por quien lo hace.
...
|---|---|---|---|
| Intervenir sobre **Pregunta conductora** | Problema o desafío que organiza el proyecto y exige el contenido disciplinar | Cuando **Evidencia de partida** es observable y accionable dentro del plazo de la decisión. | Sobrerreaccionar a una señal parcial. |
| Intervenir sobre **Hito intermedio** | Punto de control con entrega y retroalimentación antes del producto final | Cuando la primera explicación no distingue mecanismo ni responsable. | Convertir el concepto en etiqueta y no en intervención. |
| Observar antes de decidir | Reducir la incertidumbre antes de comprometer tiempo y credibilidad | Cuando la decisión es reversible y la evidencia disponible no distingue causas. | Observar indefinidamente y no decidir nunca. |
| Derivar o escalar | Poner la decisión donde están la competencia y la responsabilidad | Cuando hay normativa, resguardo de datos, salud o vulneración de derechos en juego. | Delegar hacia arriba lo que sí correspondía decidir en el aula. |

**Frontera de aplicación.** Los metaanálisis muestran efectos positivos pero heterogéneos, y con frecuencia menores en conocimiento disciplinar que en motivación o habilidades de trabajo. Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre aprendizaje basado en proyectos |
|---|---|
...
Guárdala en `evidence/P05-C065-aprendizaje-basado-en-proyectos/` con estos archivos:
