...
**Decisión que habilita:** determinar qué información y qué experiencia necesita tu estudiante antes de decidir su trayectoria<br>
...
2. Clasificar la situación distinguiendo **Exploración vocacional** de **Autoconocimiento verificado**.
3. Decidir con fundamento, usando **Trayectoria formativa** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Información de empleabilidad** a la vista.
...
| **Evidencia de logro** | qué muestra un plan de orientación con exploración, información verificable de trayectorias y registro de decisiones del estudiante frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
La decisión vocacional está condicionada por factores que la orientación no controla: Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Exploración vocacional"]
    C --> A2["Autoconocimiento<br/>verificado"]
    C --> A3["Trayectoria formativa"]
    C --> A4["Información de<br/>empleabilidad"]
    A1 & A2 & A3 & A4 --> D{{"determinar qué<br/>información y qué<br/>experiencia necesita tu<br/>estudiante antes de<br/>decidir su…"}}
    D --> E["Evidencia de aprendizaje<br/>un plan de orientación<br/>con exploración,<br/>información verificable<br/>de trayectorias y<br/>registro de…"]
...
inocua: produce decisiones que atacan el problema equivocado. **Exploración vocacional** no es lo
mismo que **Autoconocimiento verificado** —imagen de las propias capacidades contrastada con desempeño y no solo con preferencia—, y tratarlos como sinónimos hace
que la intervención se dirija al lugar incorrecto. Del mismo modo, **Trayectoria formativa** y
**Información de empleabilidad** describen aspectos distintos de la misma situación: el primero
recorrido posible entre niveles y programas, incluidas las vías no universitarias, mientras el segundo datos sobre ingresos, empleo y continuidad de estudios de programas específicos.
...
- **Evidencia de logro.** Qué muestra un plan de orientación con exploración, información verificable de trayectorias y registro de decisiones del estudiante frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
te deja en condiciones de qué información y qué experiencia necesita tu estudiante antes de decidir su trayectoria, y esa decisión se sostiene solo si
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Exploración vocacional** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Exploración vocacional de Autoconocimiento verificado.** El trabajo aquí es separar lo observado de lo interpretado sobre **Autoconocimiento verificado**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Trayectoria formativa como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Trayectoria formativa**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.

**Paso 4 — Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con Información de empleabilidad a la vista.** Con **Información de empleabilidad** ya delimitado, la pregunta pasa a ser de consecuencia: qué cambia para los estudiantes, para el tiempo de clase y para la carga del equipo. **Evidencia de partida** entrega la lectura observable; el juicio profesional sigue siendo humano y debe quedar firmado por quien lo hace.
...
|---|---|---|---|
| Intervenir sobre **Exploración vocacional** | Proceso activo de conocer opciones formativas y laborales con información real | Cuando **Evidencia de partida** es observable y accionable dentro del plazo de la decisión. | Sobrerreaccionar a una señal parcial. |
| Intervenir sobre **Autoconocimiento verificado** | Imagen de las propias capacidades contrastada con desempeño y no solo con preferencia | Cuando la primera explicación no distingue mecanismo ni responsable. | Convertir el concepto en etiqueta y no en intervención. |
| Observar antes de decidir | Reducir la incertidumbre antes de comprometer tiempo y credibilidad | Cuando la decisión es reversible y la evidencia disponible no distingue causas. | Observar indefinidamente y no decidir nunca. |
| Derivar o escalar | Poner la decisión donde están la competencia y la responsabilidad | Cuando hay normativa, resguardo de datos, salud o vulneración de derechos en juego. | Delegar hacia arriba lo que sí correspondía decidir en el aula. |

**Frontera de aplicación.** La decisión vocacional está condicionada por factores que la orientación no controla: Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre orientación vocacional |
|---|---|
...
Guárdala en `evidence/P05-C069-orientacion-vocacional/` con estos archivos:
