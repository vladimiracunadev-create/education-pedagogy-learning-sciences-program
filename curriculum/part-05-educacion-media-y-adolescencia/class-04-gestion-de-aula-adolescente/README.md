...
**Decisión que habilita:** determinar qué nivel de intervención corresponde a cada tipo de conducta antes de que ocurra<br>
...
2. Clasificar la situación distinguiendo **Intervención graduada** de **Escalada**.
3. Decidir con fundamento, usando **Conducta pública y privada** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Recuperación del vínculo** a la vista.
...
| **Evidencia de logro** | qué muestra una escala propia de intervención graduada, con ejemplos de conducta y respuesta para cada nivel frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
Las escalas de intervención funcionan cuando la institución las sostiene: Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Intervención graduada"]
    C --> A2["Escalada"]
    C --> A3["Conducta pública y<br/>privada"]
    C --> A4["Recuperación del<br/>vínculo"]
    A1 & A2 & A3 & A4 --> D{{"determinar qué nivel de<br/>intervención corresponde<br/>a cada tipo de conducta<br/>antes de que ocurra"}}
    D --> E["Evidencia de aprendizaje<br/>una escala propia de<br/>intervención graduada,<br/>con ejemplos de conducta<br/>y respuesta para cada<br/>nivel"]
...
inocua: produce decisiones que atacan el problema equivocado. **Intervención graduada** no es lo
mismo que **Escalada** —dinámica en que la respuesta del adulto aumenta la intensidad del conflicto—, y tratarlos como sinónimos hace
que la intervención se dirija al lugar incorrecto. Del mismo modo, **Conducta pública y privada** y
**Recuperación del vínculo** describen aspectos distintos de la misma situación: el primero
distinción entre corregir ante el grupo o en privado;, mientras el segundo acción posterior a la corrección destinada a restablecer la relación de trabajo.
...
- **Evidencia de logro.** Qué muestra una escala propia de intervención graduada, con ejemplos de conducta y respuesta para cada nivel frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
te deja en condiciones de qué nivel de intervención corresponde a cada tipo de conducta antes de que ocurra, y esa decisión se sostiene solo si
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Intervención graduada** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Intervención graduada de Escalada.** El trabajo aquí es separar lo observado de lo interpretado sobre **Escalada**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Conducta pública y privada como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Conducta pública y privada**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.

**Paso 4 — Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con Recuperación del vínculo a la vista.** Con **Recuperación del vínculo** ya delimitado, la pregunta pasa a ser de consecuencia: qué cambia para los estudiantes, para el tiempo de clase y para la carga del equipo. **Evidencia de partida** entrega la lectura observable; el juicio profesional sigue siendo humano y debe quedar firmado por quien lo hace.
...
|---|---|---|---|
| Intervenir sobre **Intervención graduada** | Escala de respuestas de menor a mayor intensidad ante conductas disruptivas | Cuando **Evidencia de partida** es observable y accionable dentro del plazo de la decisión. | Sobrerreaccionar a una señal parcial. |
| Intervenir sobre **Escalada** | Dinámica en que la respuesta del adulto aumenta la intensidad del conflicto | Cuando la primera explicación no distingue mecanismo ni responsable. | Convertir el concepto en etiqueta y no en intervención. |
| Observar antes de decidir | Reducir la incertidumbre antes de comprometer tiempo y credibilidad | Cuando la decisión es reversible y la evidencia disponible no distingue causas. | Observar indefinidamente y no decidir nunca. |
| Derivar o escalar | Poner la decisión donde están la competencia y la responsabilidad | Cuando hay normativa, resguardo de datos, salud o vulneración de derechos en juego. | Delegar hacia arriba lo que sí correspondía decidir en el aula. |

**Frontera de aplicación.** Las escalas de intervención funcionan cuando la institución las sostiene: Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre gestión de aula adolescente |
|---|---|
...
Guárdala en `evidence/P05-C064-gestion-de-aula-adolescente/` con estos archivos:
