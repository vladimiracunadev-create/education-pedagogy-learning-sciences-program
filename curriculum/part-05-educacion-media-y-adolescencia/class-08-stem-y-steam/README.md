...
**Estado de evidencia:** `EMERGENTE` · **Etapa:** 🔵 Etapa B — Enseñanza por ciclo vital · **Población de referencia:** 1.º a 4.º medio (14 a 18 años)<br>
**Decisión que habilita:** determinar qué contenido disciplinar debe quedar aprendido en tu experiencia STEM y cómo lo comprobarás<br>
...
2. Clasificar la situación distinguiendo **Integración STEM** de **Diseño de ingeniería**.
3. Decidir con fundamento, usando **Restricción de diseño** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Modelo** a la vista.
...
| **Evidencia de logro** | qué muestra una experiencia STEM con objetivos disciplinares por área, restricciones de diseño y evaluación del aprendizaje frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
La evidencia sobre efectos de la integración STEM es emergente y heterogénea: Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Integración STEM"]
    C --> A2["Diseño de ingeniería"]
    C --> A3["Restricción de diseño"]
    C --> A4["Modelo"]
    A1 & A2 & A3 & A4 --> D{{"determinar qué contenido<br/>disciplinar debe quedar<br/>aprendido en tu<br/>experiencia STEM y cómo<br/>lo…"}}
    D --> E["Evidencia de aprendizaje<br/>una experiencia STEM con<br/>objetivos disciplinares<br/>por área, restricciones<br/>de diseño y evaluación…"]
...
inocua: produce decisiones que atacan el problema equivocado. **Integración STEM** no es lo
mismo que **Diseño de ingeniería** —ciclo de definir, idear, prototipar, probar y mejorar bajo restricciones—, y tratarlos como sinónimos hace
que la intervención se dirija al lugar incorrecto. Del mismo modo, **Restricción de diseño** y
**Modelo** describen aspectos distintos de la misma situación: el primero
límite explícito —material, tiempo, costo— que obliga a decidir con criterio, mientras el segundo representación simplificada que permite predecir el comportamiento de un sistema.
...
- **Evidencia de logro.** Qué muestra una experiencia STEM con objetivos disciplinares por área, restricciones de diseño y evaluación del aprendizaje frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
te deja en condiciones de qué contenido disciplinar debe quedar aprendido en tu experiencia STEM y cómo lo comprobarás, y esa decisión se sostiene solo si
...
|---|---|---|
| National Academy of Engineering & NRC (2014). *STEM Integration in K-12 Education*. | revisión rigurosa sobre qué se sabe y qué falta por establecer en integración STEM. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
| Cunningham, C. (2018). *Engineering in Elementary STEM Education*. | modelo de ciclo de diseño con evidencia de implementación escolar. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Integración STEM** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Integración STEM de Diseño de ingeniería.** El trabajo aquí es separar lo observado de lo interpretado sobre **Diseño de ingeniería**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Restricción de diseño como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Restricción de diseño**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.

**Paso 4 — Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con Modelo a la vista.** Con **Modelo** ya delimitado, la pregunta pasa a ser de consecuencia: qué cambia para los estudiantes, para el tiempo de clase y para la carga del equipo. **Evidencia de partida** entrega la lectura observable; el juicio profesional sigue siendo humano y debe quedar firmado por quien lo hace.
...
|---|---|---|---|
| Intervenir sobre **Integración STEM** | Articulación de disciplinas en torno a un problema que exige genuinamente a todas | Cuando **Evidencia de partida** es observable y accionable dentro del plazo de la decisión. | Sobrerreaccionar a una señal parcial. |
| Intervenir sobre **Diseño de ingeniería** | Ciclo de definir, idear, prototipar, probar y mejorar bajo restricciones | Cuando la primera explicación no distingue mecanismo ni responsable. | Convertir el concepto en etiqueta y no en intervención. |
| Observar antes de decidir | Reducir la incertidumbre antes de comprometer tiempo y credibilidad | Cuando la decisión es reversible y la evidencia disponible no distingue causas. | Observar indefinidamente y no decidir nunca. |
| Derivar o escalar | Poner la decisión donde están la competencia y la responsabilidad | Cuando hay normativa, resguardo de datos, salud o vulneración de derechos en juego. | Delegar hacia arriba lo que sí correspondía decidir en el aula. |

**Frontera de aplicación.** La evidencia sobre efectos de la integración STEM es emergente y heterogénea: Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre sTEM y STEAM |
|---|---|
...
Guárdala en `evidence/P05-C068-stem-y-steam/` con estos archivos:
