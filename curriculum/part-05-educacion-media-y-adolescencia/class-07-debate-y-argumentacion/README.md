...
**Decisión que habilita:** determinar qué estructura argumental vas a enseñar explícitamente y cómo la evaluarás<br>
...
2. Clasificar la situación distinguiendo **Argumento** de **Contraargumento**.
3. Decidir con fundamento, usando **Evidencia** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Reglas de deliberación** a la vista.
...
| **Evidencia de logro** | qué muestra una secuencia de argumentación con estructura enseñada, reglas de debate y rúbrica de calidad argumental frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
La transferencia del debate a otras situaciones no es automática y depende del contenido: Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Argumento"]
    C --> A2["Contraargumento"]
    C --> A3["Evidencia"]
    C --> A4["Reglas de deliberación"]
    A1 & A2 & A3 & A4 --> D{{"determinar qué<br/>estructura argumental<br/>vas a enseñar<br/>explícitamente y cómo la<br/>evaluarás"}}
    D --> E["Evidencia de aprendizaje<br/>una secuencia de<br/>argumentación con<br/>estructura enseñada,<br/>reglas de debate y<br/>rúbrica de calidad…"]
...
inocua: produce decisiones que atacan el problema equivocado. **Argumento** no es lo
mismo que **Contraargumento** —objeción a la propia posición, que un buen argumento debe anticipar y responder—, y tratarlos como sinónimos hace
que la intervención se dirija al lugar incorrecto. Del mismo modo, **Evidencia** y
**Reglas de deliberación** describen aspectos distintos de la misma situación: el primero
información verificable que respalda una razón;, mientras el segundo normas explícitas que hacen posible discutir sin que gane quien habla más fuerte.
...
- **Evidencia de logro.** Qué muestra una secuencia de argumentación con estructura enseñada, reglas de debate y rúbrica de calidad argumental frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
te deja en condiciones de qué estructura argumental vas a enseñar explícitamente y cómo la evaluarás, y esa decisión se sostiene solo si
...
|---|---|---|
| Toulmin, S. (1958). *The Uses of Argument*. | modelo de estructura argumental que se puede enseñar y evaluar con precisión. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
| Hess, D. & McAvoy, P. (2015). *The Political Classroom*. | criterios y evidencia para conducir deliberación sobre temas controversiales en la escuela. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Argumento** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Argumento de Contraargumento.** El trabajo aquí es separar lo observado de lo interpretado sobre **Contraargumento**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Evidencia como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Evidencia**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.

**Paso 4 — Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con Reglas de deliberación a la vista.** Con **Reglas de deliberación** ya delimitado, la pregunta pasa a ser de consecuencia: qué cambia para los estudiantes, para el tiempo de clase y para la carga del equipo. **Evidencia de partida** entrega la lectura observable; el juicio profesional sigue siendo humano y debe quedar firmado por quien lo hace.
...
|---|---|---|---|
| Intervenir sobre **Argumento** | Tesis sostenida con razones y evidencia que puede ser evaluada por su calidad | Cuando **Evidencia de partida** es observable y accionable dentro del plazo de la decisión. | Sobrerreaccionar a una señal parcial. |
| Intervenir sobre **Contraargumento** | Objeción a la propia posición, que un buen argumento debe anticipar y responder | Cuando la primera explicación no distingue mecanismo ni responsable. | Convertir el concepto en etiqueta y no en intervención. |
| Observar antes de decidir | Reducir la incertidumbre antes de comprometer tiempo y credibilidad | Cuando la decisión es reversible y la evidencia disponible no distingue causas. | Observar indefinidamente y no decidir nunca. |
| Derivar o escalar | Poner la decisión donde están la competencia y la responsabilidad | Cuando hay normativa, resguardo de datos, salud o vulneración de derechos en juego. | Delegar hacia arriba lo que sí correspondía decidir en el aula. |

**Frontera de aplicación.** La transferencia del debate a otras situaciones no es automática y depende del contenido: Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre debate y argumentación |
|---|---|
...
Guárdala en `evidence/P05-C067-debate-y-argumentacion/` con estos archivos:
