...
**Estado de evidencia:** `PRACTICA-PROFESIONAL` · **Etapa:** 🔵 Etapa B — Enseñanza por ciclo vital · **Población de referencia:** 1.º a 4.º medio (14 a 18 años)<br>
**Decisión que habilita:** determinar qué acción concreta construye o repara tu autoridad ante un curso específico<br>
...
2. Clasificar la situación distinguiendo **Autoridad pedagógica** de **Poder institucional**.
3. Decidir con fundamento, usando **Consistencia** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Reparación** a la vista.
...
| **Evidencia de logro** | qué muestra un protocolo personal de construcción y reparación de autoridad, con conductas observables y un caso aplicado frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
No existe evidencia experimental sólida sobre construcción de autoridad: Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Autoridad pedagógica"]
    C --> A2["Poder institucional"]
    C --> A3["Consistencia"]
    C --> A4["Reparación"]
    A1 & A2 & A3 & A4 --> D{{"determinar qué acción<br/>concreta construye o<br/>repara tu autoridad ante<br/>un curso específico"}}
    D --> E["Evidencia de aprendizaje<br/>un protocolo personal de<br/>construcción y<br/>reparación de autoridad,<br/>con conductas<br/>observables y un…"]
...
inocua: produce decisiones que atacan el problema equivocado. **Autoridad pedagógica** no es lo
mismo que **Poder institucional** —capacidad de sancionar derivada del cargo; existe aunque no haya legitimidad—, y tratarlos como sinónimos hace
que la intervención se dirija al lugar incorrecto. Del mismo modo, **Consistencia** y
**Reparación** describen aspectos distintos de la misma situación: el primero
correspondencia entre lo que se anuncia y lo que efectivamente ocurre, sostenida en el tiempo, mientras el segundo acción deliberada para restablecer la relación después de un error propio o de un conflicto.
...
- **Evidencia de logro.** Qué muestra un protocolo personal de construcción y reparación de autoridad, con conductas observables y un caso aplicado frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
te deja en condiciones de qué acción concreta construye o repara tu autoridad ante un curso específico, y esa decisión se sostiene solo si
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Autoridad pedagógica** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Autoridad pedagógica de Poder institucional.** El trabajo aquí es separar lo observado de lo interpretado sobre **Poder institucional**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Consistencia como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Consistencia**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.

**Paso 4 — Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con Reparación a la vista.** Con **Reparación** ya delimitado, la pregunta pasa a ser de consecuencia: qué cambia para los estudiantes, para el tiempo de clase y para la carga del equipo. **Evidencia de partida** entrega la lectura observable; el juicio profesional sigue siendo humano y debe quedar firmado por quien lo hace.
...
**Frontera de aplicación.** No existe evidencia experimental sólida sobre construcción de autoridad: Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre autoridad pedagógica |
|---|---|
...
Guárdala en `evidence/P05-C063-autoridad-pedagogica/` con estos archivos:
