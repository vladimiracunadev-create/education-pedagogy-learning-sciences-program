...
**Decisión que habilita:** determinar qué representación, analogía o secuencia hace enseñable el contenido que dominas<br>
...
2. Clasificar la situación distinguiendo **Conocimiento pedagógico del contenido** de **Representación**.
3. Decidir con fundamento, usando **Error típico** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Punto ciego del experto** a la vista.
...
| **Evidencia de logro** | qué muestra una ficha de conocimiento pedagógico de un contenido con errores típicos, representaciones y secuencia recomendada frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
Es conocimiento específico de contenido: Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Conocimiento<br/>pedagógico del<br/>contenido"]
    C --> A2["Representación"]
    C --> A3["Error típico"]
    C --> A4["Punto ciego del<br/>experto"]
    A1 & A2 & A3 & A4 --> D{{"determinar qué<br/>representación, analogía<br/>o secuencia hace<br/>enseñable el contenido<br/>que dominas"}}
    D --> E["Evidencia de aprendizaje<br/>una ficha de<br/>conocimiento pedagógico<br/>de un contenido con<br/>errores típicos,<br/>representaciones y…"]
...
inocua: produce decisiones que atacan el problema equivocado. **Conocimiento pedagógico del contenido** no es lo
mismo que **Representación** —forma de presentar una idea —analogía, modelo, ejemplo, diagrama— que la hace accesible—, y tratarlos como sinónimos hace
que la intervención se dirija al lugar incorrecto. Del mismo modo, **Error típico** y
**Punto ciego del experto** describen aspectos distintos de la misma situación: el primero
equivocación que el contenido produce de forma sistemática en quienes lo aprenden, mientras el segundo dificultad del especialista para ver qué pasos necesita quien no sabe.
...
- **Evidencia de logro.** Qué muestra una ficha de conocimiento pedagógico de un contenido con errores típicos, representaciones y secuencia recomendada frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
te deja en condiciones de qué representación, analogía o secuencia hace enseñable el contenido que dominas, y esa decisión se sostiene solo si
...
|---|---|---|
| Shulman, L. (1986). *Those Who Understand: Knowledge Growth in Teaching*. | el artículo fundacional del conocimiento pedagógico del contenido. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
| Ball, D., Thames, M. & Phelps, G. (2008). *Content Knowledge for Teaching: What Makes It Special?* | desarrolla el concepto con precisión y con evidencia en el caso de la matemática escolar. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Conocimiento pedagógico del contenido** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Conocimiento pedagógico del contenido de Representación.** El trabajo aquí es separar lo observado de lo interpretado sobre **Representación**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Error típico como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Error típico**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.

**Paso 4 — Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con Punto ciego del experto a la vista.** Con **Punto ciego del experto** ya delimitado, la pregunta pasa a ser de consecuencia: qué cambia para los estudiantes, para el tiempo de clase y para la carga del equipo. **Evidencia de partida** entrega la lectura observable; el juicio profesional sigue siendo humano y debe quedar firmado por quien lo hace.
...
|---|---|---|---|
| Intervenir sobre **Conocimiento pedagógico del contenido** | Saber sobre cómo enseñar un contenido específico, distinto del contenido y de la pedagogía general | Cuando **Evidencia de partida** es observable y accionable dentro del plazo de la decisión. | Sobrerreaccionar a una señal parcial. |
| Intervenir sobre **Representación** | Forma de presentar una idea —analogía, modelo, ejemplo, diagrama— que la hace accesible | Cuando la primera explicación no distingue mecanismo ni responsable. | Convertir el concepto en etiqueta y no en intervención. |
| Observar antes de decidir | Reducir la incertidumbre antes de comprometer tiempo y credibilidad | Cuando la decisión es reversible y la evidencia disponible no distingue causas. | Observar indefinidamente y no decidir nunca. |
| Derivar o escalar | Poner la decisión donde están la competencia y la responsabilidad | Cuando hay normativa, resguardo de datos, salud o vulneración de derechos en juego. | Delegar hacia arriba lo que sí correspondía decidir en el aula. |

**Frontera de aplicación.** Es conocimiento específico de contenido: Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre conocimiento pedagógico del contenido |
|---|---|
...
Guárdala en `evidence/P10-C121-conocimiento-pedagogico-del-contenido/` con estos archivos:
