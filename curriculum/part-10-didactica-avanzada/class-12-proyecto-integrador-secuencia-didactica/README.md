...
**Decisión que habilita:** determinar la secuencia completa de decisiones didácticas y su justificación técnica<br>
...
2. Clasificar la situación distinguiendo **Secuencia didáctica** de **Justificación técnica**.
3. Decidir con fundamento, usando **Registro de implementación** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Análisis de resultados** a la vista.
...
| **Evidencia de logro** | qué muestra una secuencia didáctica completa ejecutada, con registro de implementación y análisis de sus resultados frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
Una secuencia aplicada una vez, con un grupo, no prueba nada sobre la eficacia de las técnicas: Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Secuencia didáctica"]
    C --> A2["Justificación técnica"]
    C --> A3["Registro de<br/>implementación"]
    C --> A4["Análisis de resultados"]
    A1 & A2 & A3 & A4 --> D{{"determinar la secuencia<br/>completa de decisiones<br/>didácticas y su<br/>justificación técnica"}}
    D --> E["Evidencia de aprendizaje<br/>una secuencia didáctica<br/>completa ejecutada, con<br/>registro de<br/>implementación y<br/>análisis de sus…"]
...
inocua: produce decisiones que atacan el problema equivocado. **Secuencia didáctica** no es lo
...
- **Evidencia de logro.** Qué muestra una secuencia didáctica completa ejecutada, con registro de implementación y análisis de sus resultados frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
te deja en condiciones de la secuencia completa de decisiones didácticas y su justificación técnica, y esa decisión se sostiene solo si
...
|---|---|---|
| Rosenshine, B. (2012). *Principles of Instruction*. | marco de referencia para justificar y ordenar las decisiones de la secuencia. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
| Kirschner, P. & Hendrick, C. (2020). *How Learning Happens*. | modelo de justificación de decisiones didácticas a partir de la investigación. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Secuencia didáctica** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Secuencia didáctica de Justificación técnica.** El trabajo aquí es separar lo observado de lo interpretado sobre **Justificación técnica**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Registro de implementación como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Registro de implementación**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.

**Paso 4 — Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con Análisis de resultados a la vista.** Con **Análisis de resultados** ya delimitado, la pregunta pasa a ser de consecuencia: qué cambia para los estudiantes, para el tiempo de clase y para la carga del equipo. **Evidencia de partida** entrega la lectura observable; el juicio profesional sigue siendo humano y debe quedar firmado por quien lo hace.
...
|---|---|---|---|
| Intervenir sobre **Secuencia didáctica** | Conjunto ordenado de decisiones de enseñanza para un contenido determinado | Cuando **Evidencia de partida** es observable y accionable dentro del plazo de la decisión. | Sobrerreaccionar a una señal parcial. |
| Intervenir sobre **Justificación técnica** | Fundamento de cada decisión en un mecanismo de aprendizaje documentado | Cuando la primera explicación no distingue mecanismo ni responsable. | Convertir el concepto en etiqueta y no en intervención. |
| Observar antes de decidir | Reducir la incertidumbre antes de comprometer tiempo y credibilidad | Cuando la decisión es reversible y la evidencia disponible no distingue causas. | Observar indefinidamente y no decidir nunca. |
| Derivar o escalar | Poner la decisión donde están la competencia y la responsabilidad | Cuando hay normativa, resguardo de datos, salud o vulneración de derechos en juego. | Delegar hacia arriba lo que sí correspondía decidir en el aula. |

**Frontera de aplicación.** Una secuencia aplicada una vez, con un grupo, no prueba nada sobre la eficacia de las técnicas: Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre proyecto integrador: secuencia didáctica |
|---|---|
...
Guárdala en `evidence/P10-C132-proyecto-integrador-secuencia-didactica/` con estos archivos:
