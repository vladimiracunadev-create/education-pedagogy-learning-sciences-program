...
**Decisión que habilita:** determinar el criterio que activará el retiro de cada apoyo que ofreces<br>
...
2. Clasificar la situación distinguiendo **Andamiaje** de **Ajuste**.
3. Decidir con fundamento, usando **Desvanecimiento** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Dependencia inducida** a la vista.
...
| **Evidencia de logro** | qué muestra una secuencia con tres niveles de andamiaje y el criterio observable de retiro de cada uno frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
El andamiaje contingente exige observar de cerca, lo que en cursos numerosos es difícil de sostener para todos. Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Andamiaje"]
    C --> A2["Ajuste"]
    C --> A3["Desvanecimiento"]
    C --> A4["Dependencia inducida"]
    A1 & A2 & A3 & A4 --> D{{"determinar el criterio<br/>que activará el retiro<br/>de cada apoyo que<br/>ofreces"}}
    D --> E["Evidencia de aprendizaje<br/>una secuencia con tres<br/>niveles de andamiaje y<br/>el criterio observable<br/>de retiro de cada uno"]
...
inocua: produce decisiones que atacan el problema equivocado. **Andamiaje** no es lo
...
- **Evidencia de logro.** Qué muestra una secuencia con tres niveles de andamiaje y el criterio observable de retiro de cada uno frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
te deja en condiciones de el criterio que activará el retiro de cada apoyo que ofreces, y esa decisión se sostiene solo si
...
|---|---|---|
| Wood, D., Bruner, J. & Ross, G. (1976). *The Role of Tutoring in Problem Solving*. | define el andamiaje con criterios observables de ajuste y retiro. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
| van de Pol, J., Volman, M. & Beishuizen, J. (2010). *Scaffolding in Teacher–Student Interaction*. | revisión que sistematiza contingencia, desvanecimiento y transferencia de responsabilidad. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Andamiaje** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Andamiaje de Ajuste.** El trabajo aquí es separar lo observado de lo interpretado sobre **Ajuste**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Desvanecimiento como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Desvanecimiento**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.

**Paso 4 — Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con Dependencia inducida a la vista.** Con **Dependencia inducida** ya delimitado, la pregunta pasa a ser de consecuencia: qué cambia para los estudiantes, para el tiempo de clase y para la carga del equipo. **Evidencia de partida** entrega la lectura observable; el juicio profesional sigue siendo humano y debe quedar firmado por quien lo hace.
...
|---|---|---|---|
| Intervenir sobre **Andamiaje** | Apoyo temporal ajustado que permite un desempeño todavía no autónomo | Cuando **Evidencia de partida** es observable y accionable dentro del plazo de la decisión. | Sobrerreaccionar a una señal parcial. |
| Intervenir sobre **Ajuste** | Correspondencia entre el apoyo ofrecido y el desempeño observado, no el esperado | Cuando la primera explicación no distingue mecanismo ni responsable. | Convertir el concepto en etiqueta y no en intervención. |
| Observar antes de decidir | Reducir la incertidumbre antes de comprometer tiempo y credibilidad | Cuando la decisión es reversible y la evidencia disponible no distingue causas. | Observar indefinidamente y no decidir nunca. |
| Derivar o escalar | Poner la decisión donde están la competencia y la responsabilidad | Cuando hay normativa, resguardo de datos, salud o vulneración de derechos en juego. | Delegar hacia arriba lo que sí correspondía decidir en el aula. |

**Frontera de aplicación.** El andamiaje contingente exige observar de cerca, lo que en cursos numerosos es difícil de sostener para todos. Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre scaffolding |
|---|---|
...
Guárdala en `evidence/P10-C127-scaffolding/` con estos archivos:
