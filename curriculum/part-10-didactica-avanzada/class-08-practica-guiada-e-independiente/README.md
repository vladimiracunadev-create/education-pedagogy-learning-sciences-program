...
**Decisión que habilita:** determinar cuándo tu grupo está listo para practicar sin corrección inmediata<br>
...
2. Clasificar la situación distinguiendo **Práctica guiada** de **Práctica independiente**.
3. Decidir con fundamento, usando **Corrección oportuna** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Dosificación** a la vista.
...
| **Evidencia de logro** | qué muestra un diseño de práctica con fase guiada, criterio de paso e independiente, con corrección planificada frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
La práctica excesiva sin variación produce ejecución rígida que no transfiere. Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Práctica guiada"]
    C --> A2["Práctica independiente"]
    C --> A3["Corrección oportuna"]
    C --> A4["Dosificación"]
    A1 & A2 & A3 & A4 --> D{{"determinar cuándo tu<br/>grupo está listo para<br/>practicar sin corrección<br/>inmediata"}}
    D --> E["Evidencia de aprendizaje<br/>un diseño de práctica<br/>con fase guiada,<br/>criterio de paso e<br/>independiente, con<br/>corrección…"]
...
inocua: produce decisiones que atacan el problema equivocado. **Práctica guiada** no es lo
...
- **Evidencia de logro.** Qué muestra un diseño de práctica con fase guiada, criterio de paso e independiente, con corrección planificada frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
te deja en condiciones de cuándo tu grupo está listo para practicar sin corrección inmediata, y esa decisión se sostiene solo si
...
|---|---|---|
| Rosenshine, B. (2012). *Principles of Instruction*. | establece la secuencia de práctica guiada e independiente con sus criterios. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
| Soderstrom, N. & Bjork, R. (2015). *Learning versus Performance*. | distingue desempeño inmediato de aprendizaje duradero; clave para dosificar y distribuir. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Práctica guiada** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Práctica guiada de Práctica independiente.** El trabajo aquí es separar lo observado de lo interpretado sobre **Práctica independiente**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Corrección oportuna como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Corrección oportuna**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.

**Paso 4 — Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con Dosificación a la vista.** Con **Dosificación** ya delimitado, la pregunta pasa a ser de consecuencia: qué cambia para los estudiantes, para el tiempo de clase y para la carga del equipo. **Evidencia de partida** entrega la lectura observable; el juicio profesional sigue siendo humano y debe quedar firmado por quien lo hace.
...
|---|---|---|---|
| Intervenir sobre **Práctica guiada** | Ejecución del estudiante con verificación y corrección inmediata del docente | Cuando **Evidencia de partida** es observable y accionable dentro del plazo de la decisión. | Sobrerreaccionar a una señal parcial. |
| Intervenir sobre **Práctica independiente** | Ejecución autónoma, cuando el desempeño ya es correcto de forma consistente | Cuando la primera explicación no distingue mecanismo ni responsable. | Convertir el concepto en etiqueta y no en intervención. |
| Observar antes de decidir | Reducir la incertidumbre antes de comprometer tiempo y credibilidad | Cuando la decisión es reversible y la evidencia disponible no distingue causas. | Observar indefinidamente y no decidir nunca. |
| Derivar o escalar | Poner la decisión donde están la competencia y la responsabilidad | Cuando hay normativa, resguardo de datos, salud o vulneración de derechos en juego. | Delegar hacia arriba lo que sí correspondía decidir en el aula. |

**Frontera de aplicación.** La práctica excesiva sin variación produce ejecución rígida que no transfiere. Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre práctica guiada e independiente |
|---|---|
...
Guárdala en `evidence/P10-C128-practica-guiada-e-independiente/` con estos archivos:
