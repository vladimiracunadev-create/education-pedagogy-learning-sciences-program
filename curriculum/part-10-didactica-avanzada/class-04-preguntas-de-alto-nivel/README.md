...
**Decisión que habilita:** determinar qué preguntas harás y cómo asegurarás respuesta de todos y no solo de algunos<br>
...
2. Clasificar la situación distinguiendo **Pregunta de verificación** de **Tiempo de espera**.
3. Decidir con fundamento, usando **Respuesta simultánea** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Distractor diagnóstico** a la vista.
...
| **Evidencia de logro** | qué muestra un repertorio de preguntas de una unidad por nivel cognitivo, con la técnica de respuesta asociada a cada una frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
Las preguntas de alto nivel no siempre son mejores: Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Pregunta de<br/>verificación"]
    C --> A2["Tiempo de espera"]
    C --> A3["Respuesta simultánea"]
    C --> A4["Distractor diagnóstico"]
    A1 & A2 & A3 & A4 --> D{{"determinar qué preguntas<br/>harás y cómo asegurarás<br/>respuesta de todos y no<br/>solo de algunos"}}
    D --> E["Evidencia de aprendizaje<br/>un repertorio de<br/>preguntas de una unidad<br/>por nivel cognitivo, con<br/>la técnica de respuesta…"]
...
inocua: produce decisiones que atacan el problema equivocado. **Pregunta de verificación** no es lo
...
- **Evidencia de logro.** Qué muestra un repertorio de preguntas de una unidad por nivel cognitivo, con la técnica de respuesta asociada a cada una frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
te deja en condiciones de qué preguntas harás y cómo asegurarás respuesta de todos y no solo de algunos, y esa decisión se sostiene solo si
...
|---|---|---|
| Rowe, M. B. (1986). *Wait Time: Slowing Down May Be a Way of Speeding Up*. | el estudio clásico sobre tiempo de espera y sus efectos en la participación. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
| Wiliam, D. (2011). *Embedded Formative Assessment*. | técnicas de respuesta simultánea y de diseño de preguntas diagnósticas. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Pregunta de verificación** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Pregunta de verificación de Tiempo de espera.** El trabajo aquí es separar lo observado de lo interpretado sobre **Tiempo de espera**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Respuesta simultánea como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Respuesta simultánea**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.

**Paso 4 — Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con Distractor diagnóstico a la vista.** Con **Distractor diagnóstico** ya delimitado, la pregunta pasa a ser de consecuencia: qué cambia para los estudiantes, para el tiempo de clase y para la carga del equipo. **Evidencia de partida** entrega la lectura observable; el juicio profesional sigue siendo humano y debe quedar firmado por quien lo hace.
...
**Frontera de aplicación.** Las preguntas de alto nivel no siempre son mejores: Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre preguntas de alto nivel |
|---|---|
...
Guárdala en `evidence/P10-C124-preguntas-de-alto-nivel/` con estos archivos:
