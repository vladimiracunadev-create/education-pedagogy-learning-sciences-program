...
**Estado de evidencia:** `EN-DEBATE` · **Etapa:** 🟣 Etapa C — Núcleo profesional docente · **Población de referencia:** transversal a niveles y disciplinas<br>
**Decisión que habilita:** determinar qué mecanismo asegurará que el material previo se estudie antes de la sesión<br>
...
2. Clasificar la situación distinguiendo **Aula invertida** de **Material previo**.
3. Decidir con fundamento, usando **Verificación de preparación** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Uso del tiempo presencial** a la vista.
...
| **Evidencia de logro** | qué muestra un diseño de aula invertida con material previo, verificación de preparación y uso justificado del tiempo presencial frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
Los metaanálisis muestran efectos positivos pequeños a moderados, con alta heterogeneidad y dependientes del diseño. Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Aula invertida"]
    C --> A2["Material previo"]
    C --> A3["Verificación de<br/>preparación"]
    C --> A4["Uso del tiempo<br/>presencial"]
    A1 & A2 & A3 & A4 --> D{{"determinar qué mecanismo<br/>asegurará que el<br/>material previo se<br/>estudie antes de la<br/>sesión"}}
    D --> E["Evidencia de aprendizaje<br/>un diseño de aula<br/>invertida con material<br/>previo, verificación de<br/>preparación y uso<br/>justificado…"]
...
inocua: produce decisiones que atacan el problema equivocado. **Aula invertida** no es lo
...
- **Evidencia de logro.** Qué muestra un diseño de aula invertida con material previo, verificación de preparación y uso justificado del tiempo presencial frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
te deja en condiciones de qué mecanismo asegurará que el material previo se estudie antes de la sesión, y esa decisión se sostiene solo si
...
|---|---|---|
| Abeysekera, L. & Dawson, P. (2015). *Motivation and Cognitive Load in the Flipped Classroom*. | analiza los mecanismos que explicarían el efecto y sus condiciones. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
| van Alten, D. et al. (2019). *Effects of Flipping the Classroom on Learning: A Meta-Analysis*. | síntesis con efectos, heterogeneidad y variables moderadoras. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Aula invertida** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Aula invertida de Material previo.** El trabajo aquí es separar lo observado de lo interpretado sobre **Material previo**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Verificación de preparación como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Verificación de preparación**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.

**Paso 4 — Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con Uso del tiempo presencial a la vista.** Con **Uso del tiempo presencial** ya delimitado, la pregunta pasa a ser de consecuencia: qué cambia para los estudiantes, para el tiempo de clase y para la carga del equipo. **Evidencia de partida** entrega la lectura observable; el juicio profesional sigue siendo humano y debe quedar firmado por quien lo hace.
...
|---|---|---|---|
| Intervenir sobre **Aula invertida** | Modelo que traslada la primera exposición al contenido fuera de la sesión y usa el tiempo presencial para práctica | Cuando **Evidencia de partida** es observable y accionable dentro del plazo de la decisión. | Sobrerreaccionar a una señal parcial. |
| Intervenir sobre **Material previo** | Recurso breve y estructurado que el estudiante trabaja antes de la clase | Cuando la primera explicación no distingue mecanismo ni responsable. | Convertir el concepto en etiqueta y no en intervención. |
| Observar antes de decidir | Reducir la incertidumbre antes de comprometer tiempo y credibilidad | Cuando la decisión es reversible y la evidencia disponible no distingue causas. | Observar indefinidamente y no decidir nunca. |
| Derivar o escalar | Poner la decisión donde están la competencia y la responsabilidad | Cuando hay normativa, resguardo de datos, salud o vulneración de derechos en juego. | Delegar hacia arriba lo que sí correspondía decidir en el aula. |

**Frontera de aplicación.** Los metaanálisis muestran efectos positivos pequeños a moderados, con alta heterogeneidad y dependientes del diseño. Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre flipped classroom |
|---|---|
...
Guárdala en `evidence/P10-C130-flipped-classroom/` con estos archivos:
