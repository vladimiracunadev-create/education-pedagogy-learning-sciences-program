...
**Estado de evidencia:** `PRACTICA-PROFESIONAL` · **Etapa:** 🟣 Etapa C — Núcleo profesional docente · **Población de referencia:** transversal a niveles y disciplinas<br>
**Decisión que habilita:** determinar cómo estructurar la discusión para que produzca comprensión y no solo participación<br>
...
2. Clasificar la situación distinguiendo **Diálogo pedagógico** de **Encadenamiento**.
3. Decidir con fundamento, usando **Exigencia de fundamento** como criterio y declarando la fuente.
...
| **Evidencia de logro** | qué muestra el guion de una discusión con preguntas encadenadas, reglas de intervención y cierre conceptual previsto frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
La evidencia sobre enseñanza dialógica es prometedora y heterogénea, y depende mucho de la formación del docente y del tiempo disponible. Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Diálogo pedagógico"]
    C --> A2["Encadenamiento"]
    C --> A3["Exigencia de<br/>fundamento"]
    C --> A4["Cierre conceptual"]
    A1 & A2 & A3 & A4 --> D{{"determinar cómo<br/>estructurar la discusión<br/>para que produzca<br/>comprensión y no solo<br/>participación"}}
    D --> E["Evidencia de aprendizaje<br/>el guion de una<br/>discusión con preguntas<br/>encadenadas, reglas de<br/>intervención y cierre<br/>conceptual…"]
...
inocua: produce decisiones que atacan el problema equivocado. **Diálogo pedagógico** no es lo
mismo que **Encadenamiento** —conexión de cada intervención con la anterior para que la discusión progrese—, y tratarlos como sinónimos hace
que la intervención se dirija al lugar incorrecto. Del mismo modo, **Exigencia de fundamento** y
**Cierre conceptual** describen aspectos distintos de la misma situación: el primero
norma de que toda afirmación se acompaña de una razón o de evidencia, mientras el segundo sistematización final que fija lo aprendido y evita que la discusión se disuelva.
...
- **Evidencia de logro.** Qué muestra el guion de una discusión con preguntas encadenadas, reglas de intervención y cierre conceptual previsto frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
te deja en condiciones de cómo estructurar la discusión para que produzca comprensión y no solo participación, y esa decisión se sostiene solo si
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Diálogo pedagógico** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Diálogo pedagógico de Encadenamiento.** El trabajo aquí es separar lo observado de lo interpretado sobre **Encadenamiento**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Exigencia de fundamento como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Exigencia de fundamento**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.
...
**Frontera de aplicación.** La evidencia sobre enseñanza dialógica es prometedora y heterogénea, y depende mucho de la formación del docente y del tiempo disponible. Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre diálogo socrático |
|---|---|
...
Guárdala en `evidence/P10-C125-dialogo-socratico/` con estos archivos:
