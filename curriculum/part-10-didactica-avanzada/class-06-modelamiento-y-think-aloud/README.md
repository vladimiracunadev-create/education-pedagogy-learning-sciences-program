...
**Decisión que habilita:** determinar qué parte del proceso experto debes hacer visible para que tus estudiantes puedan imitarlo<br>
...
2. Clasificar la situación distinguiendo **Modelamiento** de **Pensamiento en voz alta**.
3. Decidir con fundamento, usando **Ejemplo trabajado** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Desvanecimiento** a la vista.
...
| **Evidencia de logro** | qué muestra el guion de un modelamiento con pensamiento en voz alta, incluidas las decisiones y los errores previstos frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
El modelamiento pierde eficacia con estudiantes que ya dominan el procedimiento: Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Modelamiento"]
    C --> A2["Pensamiento en voz<br/>alta"]
    C --> A3["Ejemplo trabajado"]
    C --> A4["Desvanecimiento"]
    A1 & A2 & A3 & A4 --> D{{"determinar qué parte del<br/>proceso experto debes<br/>hacer visible para que<br/>tus estudiantes puedan…"}}
    D --> E["Evidencia de aprendizaje<br/>el guion de un<br/>modelamiento con<br/>pensamiento en voz alta,<br/>incluidas las decisiones<br/>y los errores…"]
...
- **Evidencia de logro.** Qué muestra el guion de un modelamiento con pensamiento en voz alta, incluidas las decisiones y los errores previstos frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
te deja en condiciones de qué parte del proceso experto debes hacer visible para que tus estudiantes puedan imitarlo, y esa decisión se sostiene solo si
...
|---|---|---|
| Collins, A., Brown, J. S. & Newman, S. (1989). *Cognitive Apprenticeship*. | formula el modelamiento, el andamiaje y el desvanecimiento como sistema de enseñanza. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
| Sweller, J., Ayres, P. & Kalyuga, S. (2011). *Cognitive Load Theory*. | aporta la evidencia sobre ejemplos trabajados y su reversión por experticia. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Modelamiento** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Modelamiento de Pensamiento en voz alta.** El trabajo aquí es separar lo observado de lo interpretado sobre **Pensamiento en voz alta**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Ejemplo trabajado como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Ejemplo trabajado**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.

**Paso 4 — Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con Desvanecimiento a la vista.** Con **Desvanecimiento** ya delimitado, la pregunta pasa a ser de consecuencia: qué cambia para los estudiantes, para el tiempo de clase y para la carga del equipo. **Evidencia de partida** entrega la lectura observable; el juicio profesional sigue siendo humano y debe quedar firmado por quien lo hace.
...
**Frontera de aplicación.** El modelamiento pierde eficacia con estudiantes que ya dominan el procedimiento: Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre modelamiento y think-aloud |
|---|---|
...
Guárdala en `evidence/P10-C126-modelamiento-y-think-aloud/` con estos archivos:
