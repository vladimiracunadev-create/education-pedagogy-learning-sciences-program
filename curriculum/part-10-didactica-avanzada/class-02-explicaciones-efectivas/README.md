...
**Decisión que habilita:** determinar cómo estructurar la explicación de un contenido difícil para que resista la primera verificación<br>
...
2. Clasificar la situación distinguiendo **Segmentación** de **Señalización**.
3. Decidir con fundamento, usando **Conexión con lo previo** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Verificación inmediata** a la vista.
...
| **Evidencia de logro** | qué muestra una explicación diseñada con su estructura, sus ejemplos y su verificación de comprensión inmediata frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
Una explicación excelente no basta para aprender: Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Segmentación"]
    C --> A2["Señalización"]
    C --> A3["Conexión con lo previo"]
    C --> A4["Verificación inmediata"]
    A1 & A2 & A3 & A4 --> D{{"determinar cómo<br/>estructurar la<br/>explicación de un<br/>contenido difícil para<br/>que resista la primera…"}}
    D --> E["Evidencia de aprendizaje<br/>una explicación diseñada<br/>con su estructura, sus<br/>ejemplos y su<br/>verificación de<br/>comprensión…"]
...
inocua: produce decisiones que atacan el problema equivocado. **Segmentación** no es lo
mismo que **Señalización** —marcado explícito de lo importante para dirigir la atención del estudiante—, y tratarlos como sinónimos hace
que la intervención se dirija al lugar incorrecto. Del mismo modo, **Conexión con lo previo** y
**Verificación inmediata** describen aspectos distintos de la misma situación: el primero
anclaje del contenido nuevo en conocimiento que el estudiante ya posee, mientras el segundo comprobación de comprensión antes de avanzar, sobre todo el curso y no sobre algunos.
...
- **Evidencia de logro.** Qué muestra una explicación diseñada con su estructura, sus ejemplos y su verificación de comprensión inmediata frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
te deja en condiciones de cómo estructurar la explicación de un contenido difícil para que resista la primera verificación, y esa decisión se sostiene solo si
...
|---|---|---|
| Rosenshine, B. (2012). *Principles of Instruction*. | principios de explicación derivados de la investigación sobre docentes eficaces. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
| Mayer, R. (2021). *Multimedia Learning*. | aporta segmentación, señalización y principios de diseño con evidencia experimental. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Segmentación** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Segmentación de Señalización.** El trabajo aquí es separar lo observado de lo interpretado sobre **Señalización**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Conexión con lo previo como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Conexión con lo previo**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.

**Paso 4 — Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con Verificación inmediata a la vista.** Con **Verificación inmediata** ya delimitado, la pregunta pasa a ser de consecuencia: qué cambia para los estudiantes, para el tiempo de clase y para la carga del equipo. **Evidencia de partida** entrega la lectura observable; el juicio profesional sigue siendo humano y debe quedar firmado por quien lo hace.
...
|---|---|---|---|
| Intervenir sobre **Segmentación** | División de la explicación en partes con pausas de procesamiento entre ellas | Cuando **Evidencia de partida** es observable y accionable dentro del plazo de la decisión. | Sobrerreaccionar a una señal parcial. |
| Intervenir sobre **Señalización** | Marcado explícito de lo importante para dirigir la atención del estudiante | Cuando la primera explicación no distingue mecanismo ni responsable. | Convertir el concepto en etiqueta y no en intervención. |
| Observar antes de decidir | Reducir la incertidumbre antes de comprometer tiempo y credibilidad | Cuando la decisión es reversible y la evidencia disponible no distingue causas. | Observar indefinidamente y no decidir nunca. |
| Derivar o escalar | Poner la decisión donde están la competencia y la responsabilidad | Cuando hay normativa, resguardo de datos, salud o vulneración de derechos en juego. | Delegar hacia arriba lo que sí correspondía decidir en el aula. |

**Frontera de aplicación.** Una explicación excelente no basta para aprender: Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre explicaciones efectivas |
|---|---|
...
Guárdala en `evidence/P10-C122-explicaciones-efectivas/` con estos archivos:
