...
**Estado de evidencia:** `CONSISTENTE` · **Etapa:** 🟣 Etapa C — Núcleo profesional docente · **Población de referencia:** transversal a niveles y disciplinas<br>
**Decisión que habilita:** determinar qué harás con quienes no alcanzan el criterio, dentro de las restricciones reales de tu calendario<br>
...
2. Clasificar la situación distinguiendo **Aprendizaje para el dominio** de **Enseñanza correctiva**.
3. Decidir con fundamento, usando **Evaluación formativa frecuente** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Actividad de enriquecimiento** a la vista.
...
| **Evidencia de logro** | qué muestra un diseño de unidad con criterio de dominio, evaluación formativa y enseñanza correctiva planificada frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
El enfoque exige tiempo docente adicional y materiales alternativos, y su efecto depende de la calidad de la enseñanza correctiva. Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Aprendizaje para el<br/>dominio"]
    C --> A2["Enseñanza correctiva"]
    C --> A3["Evaluación formativa<br/>frecuente"]
    C --> A4["Actividad de<br/>enriquecimiento"]
    A1 & A2 & A3 & A4 --> D{{"determinar qué harás con<br/>quienes no alcanzan el<br/>criterio, dentro de las<br/>restricciones reales de…"}}
    D --> E["Evidencia de aprendizaje<br/>un diseño de unidad con<br/>criterio de dominio,<br/>evaluación formativa y<br/>enseñanza correctiva…"]
...
inocua: produce decisiones que atacan el problema equivocado. **Aprendizaje para el dominio** no es lo
mismo que **Enseñanza correctiva** —enseñanza distinta —no repetición— dirigida a quienes no alcanzaron el criterio—, y tratarlos como sinónimos hace
que la intervención se dirija al lugar incorrecto. Del mismo modo, **Evaluación formativa frecuente** y
**Actividad de enriquecimiento** describen aspectos distintos de la misma situación: el primero
comprobación periódica que identifica a tiempo a quienes no logran el criterio, mientras el segundo trabajo con mayor exigencia para quienes ya alcanzaron el criterio.
...
- **Evidencia de logro.** Qué muestra un diseño de unidad con criterio de dominio, evaluación formativa y enseñanza correctiva planificada frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
te deja en condiciones de qué harás con quienes no alcanzan el criterio, dentro de las restricciones reales de tu calendario, y esa decisión se sostiene solo si
...
|---|---|---|
| Bloom, B. (1968). *Learning for Mastery*. | la formulación original del enfoque y su fundamento. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
| Guskey, T. (2010). *Lessons of Mastery Learning*. Educational Leadership, 68(2). | revisa qué se implementa mal y qué condiciones hacen funcionar el enfoque. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
...
**Situación.** Un docente con dominio disciplinar sólido explica con claridad y su curso obtiene malos resultados. Al revisar, se ve que nadie practica con corrección durante la clase: la práctica se envía siempre como tarea.

**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Aprendizaje para el dominio** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Aprendizaje para el dominio de Enseñanza correctiva.** El trabajo aquí es separar lo observado de lo interpretado sobre **Enseñanza correctiva**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Evaluación formativa frecuente como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Evaluación formativa frecuente**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.

**Paso 4 — Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con Actividad de enriquecimiento a la vista.** Con **Actividad de enriquecimiento** ya delimitado, la pregunta pasa a ser de consecuencia: qué cambia para los estudiantes, para el tiempo de clase y para la carga del equipo. **Evidencia de partida** entrega la lectura observable; el juicio profesional sigue siendo humano y debe quedar firmado por quien lo hace.
...
|---|---|---|---|
| Intervenir sobre **Aprendizaje para el dominio** | Enfoque que fija el nivel de logro y permite variar el tiempo hasta alcanzarlo | Cuando **Evidencia de partida** es observable y accionable dentro del plazo de la decisión. | Sobrerreaccionar a una señal parcial. |
| Intervenir sobre **Enseñanza correctiva** | Enseñanza distinta —no repetición— dirigida a quienes no alcanzaron el criterio | Cuando la primera explicación no distingue mecanismo ni responsable. | Convertir el concepto en etiqueta y no en intervención. |
| Observar antes de decidir | Reducir la incertidumbre antes de comprometer tiempo y credibilidad | Cuando la decisión es reversible y la evidencia disponible no distingue causas. | Observar indefinidamente y no decidir nunca. |
| Derivar o escalar | Poner la decisión donde están la competencia y la responsabilidad | Cuando hay normativa, resguardo de datos, salud o vulneración de derechos en juego. | Delegar hacia arriba lo que sí correspondía decidir en el aula. |

**Frontera de aplicación.** El enfoque exige tiempo docente adicional y materiales alternativos, y su efecto depende de la calidad de la enseñanza correctiva. Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre mastery learning |
|---|---|
...
Guárdala en `evidence/P10-C131-mastery-learning/` con estos archivos:
...
Esta evidencia alimenta el artefacto de la parte: **secuencia didáctica completa con modelamiento, práctica guiada y verificación de comprensión, ejecutada y registrada**.
...
Riesgo característico de esta parte: **Adoptar una metodología sin verificar si se cumplen sus condiciones de eficacia.** Antes de aplicar
