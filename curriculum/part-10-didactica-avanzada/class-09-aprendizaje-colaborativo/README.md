...
**Estado de evidencia:** `ROBUSTA` · **Etapa:** 🟣 Etapa C — Núcleo profesional docente · **Población de referencia:** transversal a niveles y disciplinas<br>
**Decisión que habilita:** determinar qué condición de la colaboración falta en tu diseño de trabajo grupal<br>
...
2. Clasificar la situación distinguiendo **Interdependencia positiva** de **Responsabilidad individual**.
3. Decidir con fundamento, usando **Interacción promotora** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Habilidades de colaboración** a la vista.
...
| **Evidencia de logro** | qué muestra un diseño de trabajo colaborativo con interdependencia y responsabilidad individual explícitas frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
El aprendizaje colaborativo tiene evidencia sólida cuando se cumplen sus condiciones y resultados pobres cuando no. Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Interdependencia<br/>positiva"]
    C --> A2["Responsabilidad<br/>individual"]
    C --> A3["Interacción promotora"]
    C --> A4["Habilidades de<br/>colaboración"]
    A1 & A2 & A3 & A4 --> D{{"determinar qué condición<br/>de la colaboración falta<br/>en tu diseño de trabajo<br/>grupal"}}
    D --> E["Evidencia de aprendizaje<br/>un diseño de trabajo<br/>colaborativo con<br/>interdependencia y<br/>responsabilidad<br/>individual explícitas"]
...
inocua: produce decisiones que atacan el problema equivocado. **Interdependencia positiva** no es lo
mismo que **Responsabilidad individual** —exigencia de que cada integrante responda por su aprendizaje, no solo el grupo por el producto—, y tratarlos como sinónimos hace
que la intervención se dirija al lugar incorrecto. Del mismo modo, **Interacción promotora** y
**Habilidades de colaboración** describen aspectos distintos de la misma situación: el primero
dinámica en que los integrantes se explican, se corrigen y se apoyan efectivamente, mientras el segundo conductas concretas —escuchar, pedir aclaración, distribuir— que se enseñan explícitamente.
...
- **Evidencia de logro.** Qué muestra un diseño de trabajo colaborativo con interdependencia y responsabilidad individual explícitas frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
te deja en condiciones de qué condición de la colaboración falta en tu diseño de trabajo grupal, y esa decisión se sostiene solo si
...
|---|---|---|
| Johnson, D. & Johnson, R. (2009). *An Educational Psychology Success Story*. | define las cinco condiciones del aprendizaje cooperativo con la evidencia acumulada. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
| Slavin, R. (2014). *Cooperative Learning and Academic Achievement*. | revisa qué estructuras cooperativas producen efectos y cuáles no. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Interdependencia positiva** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Interdependencia positiva de Responsabilidad individual.** El trabajo aquí es separar lo observado de lo interpretado sobre **Responsabilidad individual**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Interacción promotora como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Interacción promotora**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.

**Paso 4 — Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con Habilidades de colaboración a la vista.** Con **Habilidades de colaboración** ya delimitado, la pregunta pasa a ser de consecuencia: qué cambia para los estudiantes, para el tiempo de clase y para la carga del equipo. **Evidencia de partida** entrega la lectura observable; el juicio profesional sigue siendo humano y debe quedar firmado por quien lo hace.
...
|---|---|---|---|
| Intervenir sobre **Interdependencia positiva** | Estructura en que el logro de uno requiere el logro de los demás | Cuando **Evidencia de partida** es observable y accionable dentro del plazo de la decisión. | Sobrerreaccionar a una señal parcial. |
| Intervenir sobre **Responsabilidad individual** | Exigencia de que cada integrante responda por su aprendizaje, no solo el grupo por el producto | Cuando la primera explicación no distingue mecanismo ni responsable. | Convertir el concepto en etiqueta y no en intervención. |
| Observar antes de decidir | Reducir la incertidumbre antes de comprometer tiempo y credibilidad | Cuando la decisión es reversible y la evidencia disponible no distingue causas. | Observar indefinidamente y no decidir nunca. |
| Derivar o escalar | Poner la decisión donde están la competencia y la responsabilidad | Cuando hay normativa, resguardo de datos, salud o vulneración de derechos en juego. | Delegar hacia arriba lo que sí correspondía decidir en el aula. |

**Frontera de aplicación.** El aprendizaje colaborativo tiene evidencia sólida cuando se cumplen sus condiciones y resultados pobres cuando no. Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre aprendizaje colaborativo |
|---|---|
...
Guárdala en `evidence/P10-C129-aprendizaje-colaborativo/` con estos archivos:
