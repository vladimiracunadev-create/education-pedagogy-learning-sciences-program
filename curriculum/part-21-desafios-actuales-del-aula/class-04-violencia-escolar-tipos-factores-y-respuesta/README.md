# Clase 256 — Violencia escolar: tipos, factores y respuesta

> **Parte 21 · Desafíos actuales del aula** — clase 4 de 12
...
**Decisión que habilita:** determinar de qué tipo de situación se trata y qué respuesta institucional corresponde activar<br>
**Evidencia de aprendizaje:** un árbol de decisión de violencia escolar con tipos, respuestas, plazos y responsables

## 🎯 Propósito

Clasificar correctamente una situación de violencia escolar y activar la respuesta institucional que corresponde, sin sobrerreaccionar ni minimizar.
...
2. **Explicar** cómo se distingue un conflicto, una falta y una situación de vulneración cuando todo ocurre a la vez.
3. **Decidir** —de qué tipo de situación se trata y qué respuesta institucional corresponde activar— y sostener la decisión con un fundamento escrito.
4. **Producir** la evidencia de la clase —un árbol de decisión de violencia escolar con tipos, respuestas, plazos y responsables— y contrastarla contra el criterio de logro.
...
2. Clasificar la situación distinguiendo **Violencia escolar** de **Conflicto**.
3. Decidir con fundamento, usando **Vulneración de derechos** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Proporcionalidad** a la vista.
...
| **Evidencia de logro** | qué muestra un árbol de decisión de violencia escolar con tipos, respuestas, plazos y responsables frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
La normativa establece plazos y obligaciones que varían según la naturaleza del hecho y que cambian con el tiempo: Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Violencia escolar"]
    C --> A2["Conflicto"]
    C --> A3["Vulneración de<br/>derechos"]
    C --> A4["Proporcionalidad"]
    A1 & A2 & A3 & A4 --> D{{"determinar de qué tipo<br/>de situación se trata y<br/>qué respuesta<br/>institucional<br/>corresponde activar"}}
    D --> E["Evidencia de aprendizaje<br/>un árbol de decisión de<br/>violencia escolar con<br/>tipos, respuestas,<br/>plazos y responsables"]
...
El error más costoso en violencia escolar es de clasificación. Tratar como conflicto una situación de acoso sostenido expone a la víctima; tratar como acoso un conflicto puntual escala innecesariamente y desgasta el sistema; tratar como falta disciplinaria una vulneración de derechos incumple la obligación legal de denunciar. La primera tarea profesional es clasificar con criterios y no con la impresión del momento, que casi siempre está influida por quién reclamó primero.
...
- **Evidencia de logro.** Qué muestra un árbol de decisión de violencia escolar con tipos, respuestas, plazos y responsables frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
El árbol de decisión funciona con tres preguntas: hay o no asimetría de poder, la conducta es puntual o sostenida, y existe o no vulneración de derechos que obligue a denunciar. Cada rama tiene una respuesta declarada, con plazo y responsable. El registro de los hechos —fecha, lugar, personas, descripción sin interpretación— se hace antes de decidir, porque es lo que permite sostener la decisión frente a la familia y frente a la autoridad.

### 5. Qué sostiene la evidencia y qué no

La normativa establece plazos y obligaciones que varían según la naturaleza del hecho y que cambian con el tiempo: la fuente oficial vigente siempre manda sobre cualquier material formativo. Además, la clasificación en la práctica rara vez es limpia, porque las situaciones evolucionan y lo que empezó como conflicto puede transformarse en acoso mientras el equipo delibera.
...
te deja en condiciones de de qué tipo de situación se trata y qué respuesta institucional corresponde activar, y esa decisión se sostiene solo si
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Violencia escolar** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Violencia escolar de Conflicto.** El trabajo aquí es separar lo observado de lo interpretado sobre **Conflicto**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Vulneración de derechos como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Vulneración de derechos**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.

**Paso 4 — Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con Proporcionalidad a la vista.** Con **Proporcionalidad** ya delimitado, la pregunta pasa a ser de consecuencia: qué cambia para los estudiantes, para el tiempo de clase y para la carga del equipo. **Evidencia de partida** entrega la lectura observable; el juicio profesional sigue siendo humano y debe quedar firmado por quien lo hace.
...
**Frontera de aplicación.** La normativa establece plazos y obligaciones que varían según la naturaleza del hecho y que cambian con el tiempo: Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre violencia escolar: tipos, factores y respuesta |
|---|---|
...
Un árbol de decisión de violencia escolar con tipos, respuestas, plazos y responsables.

Guárdala en `evidence/P21-C256-violencia-escolar-tipos-factores-y-respuesta/` con estos archivos:
...
Construye el árbol de decisión de tu establecimiento y contrástalo con tres casos reales del año pasado. Registra en cuántos la clasificación fue correcta.
...
- [ ] el árbol declara criterios de clasificación, respuesta, plazo y responsable por rama;
- [ ] el registro separa hechos observados de interpretaciones;
...
- Clasificar según quién reclamó primero o según qué familia presiona más.
- Registrar interpretaciones en vez de hechos, lo que invalida el respaldo cuando se necesita.
...
Los estudiantes con discapacidad, migrantes y de la diversidad sexual presentan tasas de victimización más altas, y sus denuncias son menos creídas. El criterio de clasificación debe protegerlos precisamente de ese sesgo.
...
1. ¿Existe asimetría de poder entre las partes y cómo lo sabes?
2. ¿Es un hecho puntual o hay antecedentes que nadie reunió todavía?
3. ¿Qué plazo legal corre desde el momento en que tomaste conocimiento?
...
Se apoya en las clases 150 y 155, y prepara las clases 257 y 261.
...
|---|---|---|
| [← 255 · Atención, pantallas y fragmentación cognitiva](../class-03-atencion-pantallas-y-fragmentacion-cognitiva/README.md) | [Parte 21](../README.md) · [Programa](../../../README.md) | [257 · Acoso escolar: detección e intervención con evidencia →](../class-05-acoso-escolar-deteccion-e-intervencion-con-evidencia/README.md) |
