# Clase 258 — Ciberacoso y conflictos que entran desde fuera

> **Parte 21 · Desafíos actuales del aula** — clase 6 de 12

**Estado de evidencia:** `EMERGENTE` · **Etapa:** 🟤 Etapa F — Especialización y desafíos contemporáneos · **Población de referencia:** escolar, con énfasis en segundo ciclo y media<br>
**Decisión que habilita:** determinar qué le corresponde a la escuela en este caso y qué corresponde derivar a otra instancia<br>
**Evidencia de aprendizaje:** un protocolo de ciberacoso con criterio de competencia, preservación de evidencia y acciones formativas

## 🎯 Propósito

Responder al ciberacoso con criterios de competencia institucional, preservación de evidencia y trabajo formativo, sin exceder el rol ni desentenderse.
...
2. **Explicar** qué puede hacer la escuela con algo que ocurre fuera de ella y llega igual a la sala.
3. **Decidir** —qué le corresponde a la escuela en este caso y qué corresponde derivar a otra instancia— y sostener la decisión con un fundamento escrito.
4. **Producir** la evidencia de la clase —un protocolo de ciberacoso con criterio de competencia, preservación de evidencia y acciones formativas— y contrastarla contra el criterio de logro.
...
|---|---|
| **Ciberacoso** | agresión sostenida mediante medios digitales, con posibilidad de anonimato, difusión amplia y permanencia del contenido |
| **Permanencia y difusión** | características que agravan el daño: el contenido persiste y la audiencia es indeterminada |
| **Preservación de evidencia** | resguardo del registro digital antes de que se elimine, condición para cualquier acción posterior |
| **Competencia institucional** | límite de lo que la escuela puede y debe abordar frente a hechos ocurridos fuera de ella |
...
2. Clasificar la situación distinguiendo **Ciberacoso** de **Permanencia y difusión**.
3. Decidir con fundamento, usando **Preservación de evidencia** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Competencia institucional** a la vista.
...
| **Evidencia de logro** | qué muestra un protocolo de ciberacoso con criterio de competencia, preservación de evidencia y acciones formativas frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
La evidencia sobre intervenciones eficaces contra el ciberacoso es considerablemente más débil que en acoso presencial, y varios programas escolares muestran efectos pequeños o nulos. Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Ciberacoso"]
    C --> A2["Permanencia y difusión"]
    C --> A3["Preservación de<br/>evidencia"]
    C --> A4["Competencia<br/>institucional"]
    A1 & A2 & A3 & A4 --> D{{"determinar qué le<br/>corresponde a la escuela<br/>en este caso y qué<br/>corresponde derivar a<br/>otra…"}}
    D --> E["Evidencia de aprendizaje<br/>un protocolo de<br/>ciberacoso con criterio<br/>de competencia,<br/>preservación de<br/>evidencia y acciones…"]
...
El ciberacoso desborda las categorías escolares clásicas: ocurre fuera del horario, en plataformas que la escuela no controla, con audiencia indeterminada y con contenido que persiste. Aun así, sus efectos entran completos a la sala. La posición defendible es intermedia: la escuela no tiene competencia sobre lo que ocurre en redes privadas, y sí tiene responsabilidad sobre el clima que ese hecho produce entre sus estudiantes y sobre el deber de orientar y derivar.

### 2. Frontera conceptual: qué es y qué no es

Los cuatro conceptos de esta clase se confunden entre sí con facilidad, y esa confusión no es
inocua: produce decisiones que atacan el problema equivocado. **Ciberacoso** no es lo
mismo que **Permanencia y difusión** —características que agravan el daño: el contenido persiste y la audiencia es indeterminada—, y tratarlos como sinónimos hace
que la intervención se dirija al lugar incorrecto. Del mismo modo, **Preservación de evidencia** y
**Competencia institucional** describen aspectos distintos de la misma situación: el primero
resguardo del registro digital antes de que se elimine, condición para cualquier acción posterior, mientras el segundo límite de lo que la escuela puede y debe abordar frente a hechos ocurridos fuera de ella.
...
- **Evidencia de logro.** Qué muestra un protocolo de ciberacoso con criterio de competencia, preservación de evidencia y acciones formativas frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
El protocolo ordena tres decisiones. Primero, preservar evidencia: capturas con fecha y contexto, antes de que el contenido se elimine. Segundo, determinar competencia: qué corresponde a la escuela, qué a la familia y qué a la autoridad, especialmente cuando hay contenido de carácter sexual o amenazas, donde existen obligaciones legales específicas. Tercero, actuar sobre lo que sí es escolar: el clima del curso, la protección de la víctima y el trabajo formativo con el grupo.

### 5. Qué sostiene la evidencia y qué no

La evidencia sobre intervenciones eficaces contra el ciberacoso es considerablemente más débil que en acoso presencial, y varios programas escolares muestran efectos pequeños o nulos. El terreno legal es complejo y cambia con frecuencia. Y existe un riesgo real de exceso: intervenir sobre la vida digital privada de los estudiantes sin competencia para hacerlo genera conflictos con familias y expone al establecimiento.
...
te deja en condiciones de qué le corresponde a la escuela en este caso y qué corresponde derivar a otra instancia, y esa decisión se sostiene solo si
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Ciberacoso** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Ciberacoso de Permanencia y difusión.** El trabajo aquí es separar lo observado de lo interpretado sobre **Permanencia y difusión**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Preservación de evidencia como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Preservación de evidencia**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.

**Paso 4 — Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con Competencia institucional a la vista.** Con **Competencia institucional** ya delimitado, la pregunta pasa a ser de consecuencia: qué cambia para los estudiantes, para el tiempo de clase y para la carga del equipo. **Evidencia de partida** entrega la lectura observable; el juicio profesional sigue siendo humano y debe quedar firmado por quien lo hace.
...
|---|---|---|---|
| Intervenir sobre **Ciberacoso** | Agresión sostenida mediante medios digitales, con posibilidad de anonimato, difusión amplia y permanencia del contenido | Cuando **Evidencia de partida** es observable y accionable dentro del plazo de la decisión. | Sobrerreaccionar a una señal parcial. |
| Intervenir sobre **Permanencia y difusión** | Características que agravan el daño: el contenido persiste y la audiencia es indeterminada | Cuando la primera explicación no distingue mecanismo ni responsable. | Convertir el concepto en etiqueta y no en intervención. |
| Observar antes de decidir | Reducir la incertidumbre antes de comprometer tiempo y credibilidad | Cuando la decisión es reversible y la evidencia disponible no distingue causas. | Observar indefinidamente y no decidir nunca. |
| Derivar o escalar | Poner la decisión donde están la competencia y la responsabilidad | Cuando hay normativa, resguardo de datos, salud o vulneración de derechos en juego. | Delegar hacia arriba lo que sí correspondía decidir en el aula. |

**Frontera de aplicación.** La evidencia sobre intervenciones eficaces contra el ciberacoso es considerablemente más débil que en acoso presencial, y varios programas escolares muestran efectos pequeños o nulos. Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre ciberacoso y conflictos que entran desde fuera |
|---|---|
...
Un protocolo de ciberacoso con criterio de competencia, preservación de evidencia y acciones formativas.

Guárdala en `evidence/P21-C258-ciberacoso-y-conflictos-que-entran-desde-fuera/` con estos archivos:
...
Escribe el protocolo de ciberacoso de tu establecimiento con los tres pasos. Contrástalo con un caso real y verifica si habría permitido actuar a tiempo.
...
- [ ] el protocolo declara el criterio de competencia institucional con ejemplos;
- [ ] la preservación de evidencia está descrita como primer paso operativo;
...
- Pedir que borren el contenido antes de preservarlo, con lo que se pierde toda posibilidad de acción.
- Asumir competencia sobre hechos privados o desentenderse del efecto que producen en la sala.
...
La exposición digital afecta de forma desproporcionada a adolescentes mujeres y a estudiantes de la diversidad sexual, y el contenido de carácter sexual no consentido tiene consecuencias que exceden por completo el ámbito escolar.
...
1. ¿Se preservó la evidencia antes de pedir que se eliminara el contenido?
2. ¿Qué parte de este caso es competencia de la escuela y cuál no?
3. ¿Qué está ocurriendo en la sala como efecto de esto?
...
Continúa la clase 257 y se articula con la 284 y con la parte 13.
...
|---|---|---|
| [← 257 · Acoso escolar: detección e intervención con evidencia](../class-05-acoso-escolar-deteccion-e-intervencion-con-evidencia/README.md) | [Parte 21](../README.md) · [Programa](../../../README.md) | [259 · Conductas agresivas y desregulación emocional →](../class-07-conductas-agresivas-y-desregulacion-emocional/README.md) |
