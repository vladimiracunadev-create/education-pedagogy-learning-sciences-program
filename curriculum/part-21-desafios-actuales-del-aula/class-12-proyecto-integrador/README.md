# Clase 264 — Proyecto integrador: plan de convivencia con indicadores

> **Parte 21 · Desafíos actuales del aula** — clase 12 de 12
...
**Decisión que habilita:** determinar el plan de convivencia del establecimiento y los tres indicadores que se medirán todos los meses<br>
**Evidencia de aprendizaje:** un plan de convivencia con protocolos, escala de intervención, tres indicadores y responsable de medición

## 🎯 Propósito

Integrar la parte en un plan de convivencia con protocolos activables, escala de intervención e indicadores medidos con periodicidad declarada.
...
2. **Explicar** cómo se sabe si la convivencia de una escuela mejoró o solo se dejó de hablar del tema.
3. **Decidir** —el plan de convivencia del establecimiento y los tres indicadores que se medirán todos los meses— y sostener la decisión con un fundamento escrito.
4. **Producir** la evidencia de la clase —un plan de convivencia con protocolos, escala de intervención, tres indicadores y responsable de medición— y contrastarla contra el criterio de logro.
...
|---|---|
| **Plan de convivencia** | documento que articula prevención, protocolos y seguimiento en un sistema coherente y verificable |
| **Protocolo activable** | procedimiento que un docente puede ejecutar sin consultar, porque sabe qué hacer y a quién acudir |
| **Indicador de convivencia** | medida periódica y comparable que permite saber si algo cambió: asistencia, incidentes, percepción de seguridad |
| **Periodicidad declarada** | frecuencia fijada de antemano con la que se mide y se revisa, con responsable nombrado |
...
2. Clasificar la situación distinguiendo **Plan de convivencia** de **Protocolo activable**.
3. Decidir con fundamento, usando **Indicador de convivencia** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Periodicidad declarada** a la vista.
...
| **Evidencia de logro** | qué muestra un plan de convivencia con protocolos, escala de intervención, tres indicadores y responsable de medición frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
Un plan no cambia por sí solo un clima escolar deteriorado: Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Plan de convivencia"]
    C --> A2["Protocolo activable"]
    C --> A3["Indicador de<br/>convivencia"]
    C --> A4["Periodicidad declarada"]
    A1 & A2 & A3 & A4 --> D{{"determinar el plan de<br/>convivencia del<br/>establecimiento y los<br/>tres indicadores que se<br/>medirán…"}}
    D --> E["Evidencia de aprendizaje<br/>un plan de convivencia<br/>con protocolos, escala<br/>de intervención, tres<br/>indicadores y<br/>responsable…"]
...
Los planes de convivencia suelen existir y no operar. La razón es identificable: describen valores y no procedimientos, no fijan indicadores y no asignan responsables de medición. El resultado es que nadie puede afirmar si la convivencia mejoró; se afirma que se trabajó en ella. Un plan que funciona se reconoce porque un docente nuevo sabe qué hacer ante una situación concreta y porque existen tres cifras que alguien revisa cada mes.

### 2. Frontera conceptual: qué es y qué no es

Los cuatro conceptos de esta clase se confunden entre sí con facilidad, y esa confusión no es
inocua: produce decisiones que atacan el problema equivocado. **Plan de convivencia** no es lo
mismo que **Protocolo activable** —procedimiento que un docente puede ejecutar sin consultar, porque sabe qué hacer y a quién acudir—, y tratarlos como sinónimos hace
que la intervención se dirija al lugar incorrecto. Del mismo modo, **Indicador de convivencia** y
**Periodicidad declarada** describen aspectos distintos de la misma situación: el primero
medida periódica y comparable que permite saber si algo cambió:, mientras el segundo frecuencia fijada de antemano con la que se mide y se revisa, con responsable nombrado.
...
- **Evidencia de logro.** Qué muestra un plan de convivencia con protocolos, escala de intervención, tres indicadores y responsable de medición frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
El plan integra las once clases anteriores: análisis de asistencia y desenganche, árbol de clasificación de situaciones, plan de acoso con acción sobre testigos, protocolo de escalada conductual, protocolo de agresión al personal, mediación restaurativa y criterios de derivación. A eso se agrega lo que lo hace verificable: tres indicadores con línea base, periodicidad mensual y responsable nombrado, y una instancia fija donde esos datos se revisan y producen decisiones.

### 5. Qué sostiene la evidencia y qué no

Un plan no cambia por sí solo un clima escolar deteriorado: requiere sostenerse en el tiempo, con estabilidad de equipo y respaldo de dirección. Los indicadores de convivencia son sensibles al registro: una mejora aparente puede reflejar simplemente que se dejó de registrar. Y la percepción de seguridad, que es el indicador más importante, es también el más caro de medir bien.
...
te deja en condiciones de el plan de convivencia del establecimiento y los tres indicadores que se medirán todos los meses, y esa decisión se sostiene solo si
...
|---|---|---|
| Bryk, A. & Schneider, B. (2002). *Trust in Schools*. | muestra que la confianza relacional es la condición que sostiene cualquier mejora de convivencia. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
| Ttofi, M. & Farrington, D. (2011). *Effectiveness of School-Based Programs to Reduce Bullying*. | qué componentes deben estar presentes para que un programa produzca efecto. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
...
|---|---|---|---|
| Intervenir sobre **Plan de convivencia** | Documento que articula prevención, protocolos y seguimiento en un sistema coherente y verificable | Cuando **Evidencia de partida** es observable y accionable dentro del plazo de la decisión. | Sobrerreaccionar a una señal parcial. |
| Intervenir sobre **Protocolo activable** | Procedimiento que un docente puede ejecutar sin consultar, porque sabe qué hacer y a quién acudir | Cuando la primera explicación no distingue mecanismo ni responsable. | Convertir el concepto en etiqueta y no en intervención. |
| Observar antes de decidir | Reducir la incertidumbre antes de comprometer tiempo y credibilidad | Cuando la decisión es reversible y la evidencia disponible no distingue causas. | Observar indefinidamente y no decidir nunca. |
| Derivar o escalar | Poner la decisión donde están la competencia y la responsabilidad | Cuando hay normativa, resguardo de datos, salud o vulneración de derechos en juego. | Delegar hacia arriba lo que sí correspondía decidir en el aula. |

**Frontera de aplicación.** Un plan no cambia por sí solo un clima escolar deteriorado: Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre proyecto integrador: plan de convivencia con indicadores |
|---|---|
...
Un plan de convivencia con protocolos, escala de intervención, tres indicadores y responsable de medición.

Guárdala en `evidence/P21-C264-proyecto-integrador/` con estos archivos:
...
Escribe el plan completo con tres indicadores y línea base. Preséntalo al equipo y consigue el compromiso de la instancia mensual de revisión.
...
- [ ] cada protocolo del plan es ejecutable por un docente nuevo sin consultar;
- [ ] los tres indicadores tienen línea base, periodicidad y responsable nombrado;
...
- Escribir un plan con valores y sin procedimientos ejecutables por quien no lo redactó.
- Elegir indicadores que mejoran cuando se registra menos, sin controlar ese efecto.
...
Los indicadores deben desagregarse: un clima que mejora en promedio puede empeorar para los estudiantes migrantes, con discapacidad o de la diversidad sexual. El promedio oculta exactamente lo que el plan debía atender.
...
1. ¿Qué tres cifras de convivencia revisó tu equipo el mes pasado?
2. ¿Un docente que llegó en marzo sabría qué hacer ante un caso de acoso?
3. ¿Cómo distingues una mejora real de una caída del registro?
...
Cierra la parte 21 integrando las clases 253 a 263, y se articula con las partes 12 y 15.
...
|---|---|---|
| [← 263 · Consumo, riesgo psicosocial y derivación](../class-11-consumo-riesgo-psicosocial-y-derivacion/README.md) | [Parte 21](../README.md) · [Programa](../../../README.md) | [Programa completo →](../../../README.md) |
