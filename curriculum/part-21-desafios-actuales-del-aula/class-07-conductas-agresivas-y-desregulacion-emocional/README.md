# Clase 259 — Conductas agresivas y desregulación emocional

> **Parte 21 · Desafíos actuales del aula** — clase 7 de 12
...
**Decisión que habilita:** determinar la secuencia de intervención de tu curso ante un episodio de desregulación o agresión<br>
**Evidencia de aprendizaje:** un protocolo de intervención graduada con secuencia, roles y análisis posterior

## 🎯 Propósito

Intervenir conductas agresivas y episodios de desregulación con una secuencia que baja la activación en vez de aumentarla.
...
2. **Explicar** qué hacer en los treinta segundos en que una situación puede escalar o detenerse.
3. **Decidir** —la secuencia de intervención de tu curso ante un episodio de desregulación o agresión— y sostener la decisión con un fundamento escrito.
4. **Producir** la evidencia de la clase —un protocolo de intervención graduada con secuencia, roles y análisis posterior— y contrastarla contra el criterio de logro.
...
|---|---|
| **Ciclo de escalada** | secuencia predecible —disparador, agitación, crisis, recuperación— que permite intervenir antes del punto crítico |
| **Desregulación emocional** | pérdida temporal de la capacidad de modular la respuesta emocional, en que el razonamiento no está disponible |
| **Intervención graduada** | respuesta cuya intensidad aumenta por pasos, priorizando siempre la reducción de la activación |
| **Análisis posterior** | revisión del episodio, una vez pasado, para identificar el disparador y prevenir la repetición |
...
2. Clasificar la situación distinguiendo **Ciclo de escalada** de **Desregulación emocional**.
3. Decidir con fundamento, usando **Intervención graduada** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Análisis posterior** a la vista.
...
| **Evidencia de logro** | qué muestra un protocolo de intervención graduada con secuencia, roles y análisis posterior frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
El enfoque exige formación y práctica que muchos equipos no reciben, y su aplicación individual sin respaldo institucional expone al docente. Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Ciclo de escalada"]
    C --> A2["Desregulación<br/>emocional"]
    C --> A3["Intervención graduada"]
    C --> A4["Análisis posterior"]
    A1 & A2 & A3 & A4 --> D{{"determinar la secuencia<br/>de intervención de tu<br/>curso ante un episodio<br/>de desregulación o<br/>agresión"}}
    D --> E["Evidencia de aprendizaje<br/>un protocolo de<br/>intervención graduada<br/>con secuencia, roles y<br/>análisis posterior"]
...
Los episodios de agresión rara vez son súbitos: siguen un ciclo con fases identificables, y la intervención rinde mucho más en la fase de agitación que en la de crisis. Durante la crisis el razonamiento no está disponible —hablar de consecuencias es inútil— y el objetivo único es la seguridad y la reducción de la activación. Buena parte de los episodios graves que ocurren en las escuelas escalaron por una intervención adulta que aumentó la exposición pública del estudiante.

### 2. Frontera conceptual: qué es y qué no es

Los cuatro conceptos de esta clase se confunden entre sí con facilidad, y esa confusión no es
inocua: produce decisiones que atacan el problema equivocado. **Ciclo de escalada** no es lo
mismo que **Desregulación emocional** —pérdida temporal de la capacidad de modular la respuesta emocional, en que el razonamiento no está disponible—, y tratarlos como sinónimos hace
que la intervención se dirija al lugar incorrecto. Del mismo modo, **Intervención graduada** y
**Análisis posterior** describen aspectos distintos de la misma situación: el primero
respuesta cuya intensidad aumenta por pasos, priorizando siempre la reducción de la activación, mientras el segundo revisión del episodio, una vez pasado, para identificar el disparador y prevenir la repetición.
...
- **Evidencia de logro.** Qué muestra un protocolo de intervención graduada con secuencia, roles y análisis posterior frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
El protocolo declara qué se hace en cada fase: en agitación, reducir demandas, bajar la voz, ofrecer opciones y espacio; en crisis, asegurar la seguridad y no confrontar; en recuperación, no exigir explicaciones inmediatas. Después, y solo después, viene el análisis del disparador y la consecuencia proporcional. Los roles se definen antes: quién interviene, quién saca al resto del curso, quién busca apoyo. Improvisarlo en el momento es lo que produce los peores resultados.

### 5. Qué sostiene la evidencia y qué no

El enfoque exige formación y práctica que muchos equipos no reciben, y su aplicación individual sin respaldo institucional expone al docente. La evidencia sobre programas de manejo de crisis es de calidad variable. Y hay episodios que exceden por completo lo escolar y requieren respuesta de salud, sin que aplazar esa derivación se justifique por querer resolverlo internamente.
...
te deja en condiciones de la secuencia de intervención de tu curso ante un episodio de desregulación o agresión, y esa decisión se sostiene solo si
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Ciclo de escalada** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Ciclo de escalada de Desregulación emocional.** El trabajo aquí es separar lo observado de lo interpretado sobre **Desregulación emocional**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Intervención graduada como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Intervención graduada**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.

**Paso 4 — Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con Análisis posterior a la vista.** Con **Análisis posterior** ya delimitado, la pregunta pasa a ser de consecuencia: qué cambia para los estudiantes, para el tiempo de clase y para la carga del equipo. **Evidencia de partida** entrega la lectura observable; el juicio profesional sigue siendo humano y debe quedar firmado por quien lo hace.
...
|---|---|---|---|
| Intervenir sobre **Ciclo de escalada** | Secuencia predecible —disparador, agitación, crisis, recuperación— que permite intervenir antes del punto crítico | Cuando **Evidencia de partida** es observable y accionable dentro del plazo de la decisión. | Sobrerreaccionar a una señal parcial. |
| Intervenir sobre **Desregulación emocional** | Pérdida temporal de la capacidad de modular la respuesta emocional, en que el razonamiento no está disponible | Cuando la primera explicación no distingue mecanismo ni responsable. | Convertir el concepto en etiqueta y no en intervención. |
| Observar antes de decidir | Reducir la incertidumbre antes de comprometer tiempo y credibilidad | Cuando la decisión es reversible y la evidencia disponible no distingue causas. | Observar indefinidamente y no decidir nunca. |
| Derivar o escalar | Poner la decisión donde están la competencia y la responsabilidad | Cuando hay normativa, resguardo de datos, salud o vulneración de derechos en juego. | Delegar hacia arriba lo que sí correspondía decidir en el aula. |

**Frontera de aplicación.** El enfoque exige formación y práctica que muchos equipos no reciben, y su aplicación individual sin respaldo institucional expone al docente. Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre conductas agresivas y desregulación emocional |
|---|---|
...
Un protocolo de intervención graduada con secuencia, roles y análisis posterior.

Guárdala en `evidence/P21-C259-conductas-agresivas-y-desregulacion-emocional/` con estos archivos:
...
Escribe el protocolo por fase con roles asignados. Preséntalo al equipo del curso y simula un episodio para verificar que todos saben qué les toca.
...
- [ ] el protocolo declara acciones diferenciadas por fase del ciclo;
- [ ] los roles adultos están asignados de antemano y son conocidos por el equipo;
...
- Confrontar públicamente durante la fase de crisis y convertir un episodio en una situación con audiencia.
- Exigir explicaciones y disculpas inmediatamente después, cuando la recuperación aún no ocurrió.
...
Los estudiantes con dificultades de autorregulación, con trastornos del lenguaje o con historia de adversidad tienen más probabilidad de escalar y de recibir sanciones acumuladas. El protocolo debe evitar que la condición se convierta en historial disciplinario.
...
1. ¿Qué precede habitualmente a los episodios de este estudiante?
2. ¿Quién hace qué mañana si ocurre en tu clase, y lo saben?
3. ¿En qué momento intentas razonar, y está disponible el razonamiento entonces?
...
Profundiza las clases 147 y 148 y se apoya en la 242. Prepara la clase 260.
...
|---|---|---|
| [← 258 · Ciberacoso y conflictos que entran desde fuera](../class-06-ciberacoso-y-conflictos-que-entran-desde-fuera/README.md) | [Parte 21](../README.md) · [Programa](../../../README.md) | [260 · Agresiones al docente y protección del equipo →](../class-08-agresiones-al-docente-y-proteccion-del-equipo/README.md) |
