# Clase 263 — Consumo, riesgo psicosocial y derivación

> **Parte 21 · Desafíos actuales del aula** — clase 11 de 12
...
**Decisión que habilita:** determinar si esta situación exige derivación, a qué instancia y con qué antecedentes<br>
**Evidencia de aprendizaje:** un protocolo de derivación con criterios, instancias, antecedentes exigidos y seguimiento

## 🎯 Propósito

Detectar situaciones de riesgo psicosocial y derivar con criterio, fundamento y seguimiento, distinguiendo lo escolar de lo que exige otra competencia.
...
2. **Explicar** cómo se deriva bien: ni tarde, ni sin fundamento, ni para sacarse el problema de encima.
3. **Decidir** —si esta situación exige derivación, a qué instancia y con qué antecedentes— y sostener la decisión con un fundamento escrito.
4. **Producir** la evidencia de la clase —un protocolo de derivación con criterios, instancias, antecedentes exigidos y seguimiento— y contrastarla contra el criterio de logro.
...
|---|---|
| **Riesgo psicosocial** | conjunto de condiciones —consumo, violencia intrafamiliar, explotación, abandono— que amenazan el desarrollo del estudiante |
| **Derivación responsable** | traspaso a otra instancia con antecedentes suficientes, seguimiento y sin abandono del vínculo escolar |
| **Deber de denuncia** | obligación legal de informar a la autoridad determinados hechos de los que se toma conocimiento |
| **Red intersectorial** | conjunto de instituciones —salud, protección, justicia, municipio— con las que la escuela articula |
...
2. Clasificar la situación distinguiendo **Riesgo psicosocial** de **Derivación responsable**.
3. Decidir con fundamento, usando **Deber de denuncia** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Red intersectorial** a la vista.
...
| **Evidencia de logro** | qué muestra un protocolo de derivación con criterios, instancias, antecedentes exigidos y seguimiento frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
La capacidad de respuesta de la red externa es limitada y desigual según territorio: Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Riesgo psicosocial"]
    C --> A2["Derivación responsable"]
    C --> A3["Deber de denuncia"]
    C --> A4["Red intersectorial"]
    A1 & A2 & A3 & A4 --> D{{"determinar si esta<br/>situación exige<br/>derivación, a qué<br/>instancia y con qué<br/>antecedentes"}}
    D --> E["Evidencia de aprendizaje<br/>un protocolo de<br/>derivación con<br/>criterios, instancias,<br/>antecedentes exigidos y<br/>seguimiento"]
...
La escuela es, para muchos estudiantes, la institución que más los ve. Eso le da una posición privilegiada de detección y una responsabilidad correlativa: derivar cuando corresponde, con fundamento y a la instancia correcta. Los dos errores opuestos son igualmente costosos. Derivar tarde deja al estudiante sin protección; derivar sin antecedentes ni criterio satura una red que ya está saturada y produce respuestas que no llegan.

### 2. Frontera conceptual: qué es y qué no es

Los cuatro conceptos de esta clase se confunden entre sí con facilidad, y esa confusión no es
inocua: produce decisiones que atacan el problema equivocado. **Riesgo psicosocial** no es lo
mismo que **Derivación responsable** —traspaso a otra instancia con antecedentes suficientes, seguimiento y sin abandono del vínculo escolar—, y tratarlos como sinónimos hace
que la intervención se dirija al lugar incorrecto. Del mismo modo, **Deber de denuncia** y
**Red intersectorial** describen aspectos distintos de la misma situación: el primero
obligación legal de informar a la autoridad determinados hechos de los que se toma conocimiento, mientras el segundo conjunto de instituciones —salud, protección, justicia, municipio— con las que la escuela articula.
...
- **Evidencia de logro.** Qué muestra un protocolo de derivación con criterios, instancias, antecedentes exigidos y seguimiento frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
El protocolo declara qué señales activan qué respuesta, qué antecedentes debe reunir la escuela antes de derivar —observaciones fechadas, no interpretaciones—, a qué instancia corresponde cada situación y quién hace el seguimiento. Se distingue con claridad lo que es derivación de lo que es denuncia obligatoria, donde los plazos legales corren desde el momento en que se toma conocimiento y no admiten deliberación institucional prolongada.

### 5. Qué sostiene la evidencia y qué no

La capacidad de respuesta de la red externa es limitada y desigual según territorio: una derivación correcta puede no producir atención durante meses, y la escuela debe sostener al estudiante mientras tanto. Además, la normativa sobre deber de denuncia, plazos y protección de datos es específica y cambiante: la fuente oficial vigente manda sobre cualquier material formativo.
...
te deja en condiciones de si esta situación exige derivación, a qué instancia y con qué antecedentes, y esa decisión se sostiene solo si
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Riesgo psicosocial** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Riesgo psicosocial de Derivación responsable.** El trabajo aquí es separar lo observado de lo interpretado sobre **Derivación responsable**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Deber de denuncia como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Deber de denuncia**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.

**Paso 4 — Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con Red intersectorial a la vista.** Con **Red intersectorial** ya delimitado, la pregunta pasa a ser de consecuencia: qué cambia para los estudiantes, para el tiempo de clase y para la carga del equipo. **Evidencia de partida** entrega la lectura observable; el juicio profesional sigue siendo humano y debe quedar firmado por quien lo hace.
...
|---|---|---|---|
| Intervenir sobre **Riesgo psicosocial** | Conjunto de condiciones —consumo, violencia intrafamiliar, explotación, abandono— que amenazan el desarrollo del estudiante | Cuando **Evidencia de partida** es observable y accionable dentro del plazo de la decisión. | Sobrerreaccionar a una señal parcial. |
| Intervenir sobre **Derivación responsable** | Traspaso a otra instancia con antecedentes suficientes, seguimiento y sin abandono del vínculo escolar | Cuando la primera explicación no distingue mecanismo ni responsable. | Convertir el concepto en etiqueta y no en intervención. |
| Observar antes de decidir | Reducir la incertidumbre antes de comprometer tiempo y credibilidad | Cuando la decisión es reversible y la evidencia disponible no distingue causas. | Observar indefinidamente y no decidir nunca. |
| Derivar o escalar | Poner la decisión donde están la competencia y la responsabilidad | Cuando hay normativa, resguardo de datos, salud o vulneración de derechos en juego. | Delegar hacia arriba lo que sí correspondía decidir en el aula. |

**Frontera de aplicación.** La capacidad de respuesta de la red externa es limitada y desigual según territorio: Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre consumo, riesgo psicosocial y derivación |
|---|---|
...
Un protocolo de derivación con criterios, instancias, antecedentes exigidos y seguimiento.

Guárdala en `evidence/P21-C263-consumo-riesgo-psicosocial-y-derivacion/` con estos archivos:
...
Revisa las derivaciones del año pasado en tu establecimiento y verifica cuántas tuvieron seguimiento. Propón el ajuste al protocolo con lo que encuentres.
...
- [ ] el protocolo distingue derivación de denuncia obligatoria con sus plazos;
- [ ] declara qué antecedentes debe reunir la escuela y quién realiza el seguimiento;
...
- Derivar para transferir el problema y desentenderse del vínculo escolar mientras tanto.
- Deliberar internamente durante semanas en un caso donde corre un plazo legal de denuncia.
...
La derivación puede convertirse en un mecanismo de exclusión encubierta cuando se usa para sacar del aula a estudiantes que incomodan. El criterio escrito y el seguimiento son las garantías contra ese uso.
...
1. ¿Qué antecedentes tienes documentados, con fecha, para fundar esta derivación?
2. ¿Corre algún plazo legal desde que tomaste conocimiento?
3. ¿Quién sostiene al estudiante mientras la red responde?
...
Profundiza la clase 155 y prepara la parte 23, en especial las clases 277 y 279.
...
|---|---|---|
| [← 262 · Aulas numerosas y heterogéneas con recursos limitados](../class-10-aulas-numerosas-y-heterogeneas-con-recursos-limitados/README.md) | [Parte 21](../README.md) · [Programa](../../../README.md) | [264 · Proyecto integrador: plan de convivencia con indicadores →](../class-12-proyecto-integrador/README.md) |
