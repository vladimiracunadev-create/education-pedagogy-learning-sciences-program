# Clase 260 — Agresiones al docente y protección del equipo

> **Parte 21 · Desafíos actuales del aula** — clase 8 de 12

**Estado de evidencia:** `MARCO-NORMATIVO` · **Etapa:** 🟤 Etapa F — Especialización y desafíos contemporáneos · **Población de referencia:** escolar, con énfasis en segundo ciclo y media<br>
**Decisión que habilita:** determinar qué activa tu establecimiento cuando un docente es agredido y quién lo acompaña<br>
**Evidencia de aprendizaje:** un protocolo de agresión al personal con activación institucional, acompañamiento y registro

## 🎯 Propósito

Responder a agresiones dirigidas al personal docente con protocolo, respaldo institucional y resguardo, sin dejar el caso en manos de la persona afectada.
...
2. **Explicar** qué hace una institución cuando la persona agredida es quien enseña.
3. **Decidir** —qué activa tu establecimiento cuando un docente es agredido y quién lo acompaña— y sostener la decisión con un fundamento escrito.
4. **Producir** la evidencia de la clase —un protocolo de agresión al personal con activación institucional, acompañamiento y registro— y contrastarla contra el criterio de logro.
...
|---|---|
| **Agresión al personal** | conducta que daña a un trabajador de la comunidad educativa, provenga de estudiantes, apoderados o terceros |
| **Respaldo institucional** | conjunto de acciones por las que la institución asume la conducción del caso y no la deja a la persona afectada |
| **Registro y denuncia** | documentación de los hechos y activación de las vías legales cuando corresponde |
| **Continuidad laboral** | condiciones que permiten a la persona afectada retomar el trabajo con seguridad y sin costo adicional |
...
2. Clasificar la situación distinguiendo **Agresión al personal** de **Respaldo institucional**.
3. Decidir con fundamento, usando **Registro y denuncia** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Continuidad laboral** a la vista.
...
| **Evidencia de logro** | qué muestra un protocolo de agresión al personal con activación institucional, acompañamiento y registro frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
La normativa laboral y educativa establece obligaciones que varían según la naturaleza del hecho y el tipo de dependencia del establecimiento, y la fuente oficial vigente manda. Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Agresión al personal"]
    C --> A2["Respaldo institucional"]
    C --> A3["Registro y denuncia"]
    C --> A4["Continuidad laboral"]
    A1 & A2 & A3 & A4 --> D{{"determinar qué activa tu<br/>establecimiento cuando<br/>un docente es agredido y<br/>quién lo acompaña"}}
    D --> E["Evidencia de aprendizaje<br/>un protocolo de agresión<br/>al personal con<br/>activación<br/>institucional,<br/>acompañamiento y<br/>registro"]
...
Las agresiones al personal docente son frecuentes y sistemáticamente subregistradas, en parte porque denunciarlas se percibe como reconocer una incapacidad para manejar el curso. Esa percepción es un problema institucional: cuando la respuesta depende de que la persona afectada tome la iniciativa, la mayoría de los casos no se registra y el patrón permanece invisible hasta que alguien termina con licencia médica.

### 2. Frontera conceptual: qué es y qué no es

Los cuatro conceptos de esta clase se confunden entre sí con facilidad, y esa confusión no es
inocua: produce decisiones que atacan el problema equivocado. **Agresión al personal** no es lo
mismo que **Respaldo institucional** —conjunto de acciones por las que la institución asume la conducción del caso y no la deja a la persona afectada—, y tratarlos como sinónimos hace
que la intervención se dirija al lugar incorrecto. Del mismo modo, **Registro y denuncia** y
**Continuidad laboral** describen aspectos distintos de la misma situación: el primero
documentación de los hechos y activación de las vías legales cuando corresponde, mientras el segundo condiciones que permiten a la persona afectada retomar el trabajo con seguridad y sin costo adicional.
...
- **Evidencia de logro.** Qué muestra un protocolo de agresión al personal con activación institucional, acompañamiento y registro frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
El protocolo debe fijar tres cosas. Qué se activa automáticamente al tomar conocimiento —sin que la persona deba solicitarlo—, quién conduce el caso y acompaña a la persona afectada, y qué condiciones se aseguran para el retorno. Se agrega el registro, que es lo que permite ver el patrón: hechos, fechas y contexto documentados aunque la persona decida no denunciar formalmente.

### 5. Qué sostiene la evidencia y qué no

La normativa laboral y educativa establece obligaciones que varían según la naturaleza del hecho y el tipo de dependencia del establecimiento, y la fuente oficial vigente manda. La tensión entre el derecho del estudiante a la educación y el resguardo del trabajador es real y no se resuelve con una regla general: requiere decisión caso a caso con criterios declarados.
...
te deja en condiciones de qué activa tu establecimiento cuando un docente es agredido y quién lo acompaña, y esa decisión se sostiene solo si
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Agresión al personal** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Agresión al personal de Respaldo institucional.** El trabajo aquí es separar lo observado de lo interpretado sobre **Respaldo institucional**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Registro y denuncia como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Registro y denuncia**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.

**Paso 4 — Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con Continuidad laboral a la vista.** Con **Continuidad laboral** ya delimitado, la pregunta pasa a ser de consecuencia: qué cambia para los estudiantes, para el tiempo de clase y para la carga del equipo. **Evidencia de partida** entrega la lectura observable; el juicio profesional sigue siendo humano y debe quedar firmado por quien lo hace.
...
|---|---|---|---|
| Intervenir sobre **Agresión al personal** | Conducta que daña a un trabajador de la comunidad educativa, provenga de estudiantes, apoderados o terceros | Cuando **Evidencia de partida** es observable y accionable dentro del plazo de la decisión. | Sobrerreaccionar a una señal parcial. |
| Intervenir sobre **Respaldo institucional** | Conjunto de acciones por las que la institución asume la conducción del caso y no la deja a la persona afectada | Cuando la primera explicación no distingue mecanismo ni responsable. | Convertir el concepto en etiqueta y no en intervención. |
| Observar antes de decidir | Reducir la incertidumbre antes de comprometer tiempo y credibilidad | Cuando la decisión es reversible y la evidencia disponible no distingue causas. | Observar indefinidamente y no decidir nunca. |
| Derivar o escalar | Poner la decisión donde están la competencia y la responsabilidad | Cuando hay normativa, resguardo de datos, salud o vulneración de derechos en juego. | Delegar hacia arriba lo que sí correspondía decidir en el aula. |

**Frontera de aplicación.** La normativa laboral y educativa establece obligaciones que varían según la naturaleza del hecho y el tipo de dependencia del establecimiento, y la fuente oficial vigente manda. Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre agresiones al docente y protección del equipo |
|---|---|
...
Un protocolo de agresión al personal con activación institucional, acompañamiento y registro.

Guárdala en `evidence/P21-C260-agresiones-al-docente-y-proteccion-del-equipo/` con estos archivos:
...
Revisa si tu establecimiento tiene protocolo de agresión al personal. Si no lo tiene, escríbelo con activación de oficio y preséntalo a dirección.
...
- [ ] el protocolo se activa de oficio al tomar conocimiento, sin requerir solicitud;
- [ ] existe registro de todos los hechos, independiente de si hubo denuncia formal;
...
- Dejar que la activación del protocolo dependa de que la persona afectada la solicite.
- Cerrar el caso con una conversación y sin registro, con lo que el patrón nunca se hace visible.
...
Los docentes en situación más precaria —reemplazos, contratos breves, primer año— son los que menos denuncian y los más expuestos. Un protocolo que dependa de la iniciativa individual los deja sistemáticamente fuera.
...
1. ¿Cuántas agresiones al personal se registraron el año pasado y cuántas ocurrieron?
2. ¿Quién acompaña a la persona afectada y con qué tiempo asignado?
3. ¿Qué condiciones se aseguran para el retorno al aula?
...
Se articula con las clases 256 y 259, y prepara la parte 23, en particular las clases 285 y 287.
...
|---|---|---|
| [← 259 · Conductas agresivas y desregulación emocional](../class-07-conductas-agresivas-y-desregulacion-emocional/README.md) | [Parte 21](../README.md) · [Programa](../../../README.md) | [261 · Mediación escolar y prácticas restaurativas →](../class-09-mediacion-escolar-y-practicas-restaurativas/README.md) |
