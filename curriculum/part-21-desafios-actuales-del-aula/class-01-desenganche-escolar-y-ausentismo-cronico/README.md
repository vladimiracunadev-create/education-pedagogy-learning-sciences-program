# Clase 253 — Desenganche escolar y ausentismo crónico

> **Parte 21 · Desafíos actuales del aula** — clase 1 de 12
...
**Decisión que habilita:** determinar qué estudiantes de tu curso están en riesgo por asistencia y qué se activa con cada uno esta semana<br>
**Evidencia de aprendizaje:** un análisis de asistencia del curso con estudiantes en riesgo identificados y acción asignada

## 🎯 Propósito

Detectar el desenganche antes de que se convierta en deserción, usando la asistencia como señal accionable y no como registro administrativo.
...
2. **Explicar** por qué la asistencia es el indicador temprano más barato y el más ignorado.
3. **Decidir** —qué estudiantes de tu curso están en riesgo por asistencia y qué se activa con cada uno esta semana— y sostener la decisión con un fundamento escrito.
4. **Producir** la evidencia de la clase —un análisis de asistencia del curso con estudiantes en riesgo identificados y acción asignada— y contrastarla contra el criterio de logro.
...
|---|---|
| **Ausentismo crónico** | pérdida del diez por ciento o más de las jornadas del año, por cualquier causa, justificada o no |
| **Desenganche** | retiro progresivo de la participación —conductual, emocional y cognitiva— que precede a la inasistencia |
| **Señal temprana** | indicador que aparece con anticipación suficiente para que la intervención todavía cambie la trayectoria |
| **Respuesta escalonada** | conjunto de acciones de intensidad creciente según el nivel de riesgo detectado |
...
2. Clasificar la situación distinguiendo **Ausentismo crónico** de **Desenganche**.
3. Decidir con fundamento, usando **Señal temprana** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Respuesta escalonada** a la vista.
...
| **Evidencia de logro** | qué muestra un análisis de asistencia del curso con estudiantes en riesgo identificados y acción asignada frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
La asistencia detecta el problema pero no informa su causa: Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Ausentismo crónico"]
    C --> A2["Desenganche"]
    C --> A3["Señal temprana"]
    C --> A4["Respuesta escalonada"]
    A1 & A2 & A3 & A4 --> D{{"determinar qué<br/>estudiantes de tu curso<br/>están en riesgo por<br/>asistencia y qué se<br/>activa con cada…"}}
    D --> E["Evidencia de aprendizaje<br/>un análisis de<br/>asistencia del curso con<br/>estudiantes en riesgo<br/>identificados y acción<br/>asignada"]
...
El ausentismo crónico es uno de los predictores más robustos de deserción y de bajo rendimiento, y tiene una virtud que ningún otro indicador tiene: la escuela ya lo registra todos los días. El problema es que se registra sin usarse. Contar faltas justificadas e injustificadas por separado oculta el fenómeno, porque para el aprendizaje da lo mismo la razón: el estudiante no estuvo. Y el desenganche empieza antes, con retiro de la participación dentro de la sala.

### 2. Frontera conceptual: qué es y qué no es

Los cuatro conceptos de esta clase se confunden entre sí con facilidad, y esa confusión no es
inocua: produce decisiones que atacan el problema equivocado. **Ausentismo crónico** no es lo
mismo que **Desenganche** —retiro progresivo de la participación —conductual, emocional y cognitiva— que precede a la inasistencia—, y tratarlos como sinónimos hace
que la intervención se dirija al lugar incorrecto. Del mismo modo, **Señal temprana** y
**Respuesta escalonada** describen aspectos distintos de la misma situación: el primero
indicador que aparece con anticipación suficiente para que la intervención todavía cambie la trayectoria, mientras el segundo conjunto de acciones de intensidad creciente según el nivel de riesgo detectado.
...
- **Evidencia de logro.** Qué muestra un análisis de asistencia del curso con estudiantes en riesgo identificados y acción asignada frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
El uso profesional del dato es simple y exige constancia: se calcula el porcentaje acumulado de inasistencia por estudiante, se revisa mensualmente y se activa una respuesta escalonada. Bajo el umbral de riesgo, contacto y seguimiento del docente jefe; sobre él, entrevista con la familia y plan concreto; en el nivel más alto, articulación con la red externa. Lo que convierte el sistema en algo real es que cada nivel tenga responsable nombrado y plazo.

### 5. Qué sostiene la evidencia y qué no

La asistencia detecta el problema pero no informa su causa: trabajo infantil, cuidado de hermanos, salud mental, acoso o desmotivación exigen respuestas distintas y la cifra no las distingue. Además, buena parte de la evidencia proviene de sistemas escolares con estructuras de apoyo distintas de las chilenas. Y la respuesta punitiva a la inasistencia es la que peor funciona, aunque siga siendo la más frecuente.
...
te deja en condiciones de qué estudiantes de tu curso están en riesgo por asistencia y qué se activa con cada uno esta semana, y esa decisión se sostiene solo si
...
|---|---|---|
| Balfanz, R. & Byrnes, V. (2012). *The Importance of Being in School*. | convierte la asistencia en indicador temprano accionable, con umbrales y evidencia. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
| Fredricks, J., Blumenfeld, P. & Paris, A. (2004). *School Engagement*. | distingue las tres dimensiones del compromiso escolar, que se pierden en orden. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Ausentismo crónico** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Ausentismo crónico de Desenganche.** El trabajo aquí es separar lo observado de lo interpretado sobre **Desenganche**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Señal temprana como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Señal temprana**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.

**Paso 4 — Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con Respuesta escalonada a la vista.** Con **Respuesta escalonada** ya delimitado, la pregunta pasa a ser de consecuencia: qué cambia para los estudiantes, para el tiempo de clase y para la carga del equipo. **Evidencia de partida** entrega la lectura observable; el juicio profesional sigue siendo humano y debe quedar firmado por quien lo hace.
...
|---|---|---|---|
| Intervenir sobre **Ausentismo crónico** | Pérdida del diez por ciento o más de las jornadas del año, por cualquier causa, justificada o no | Cuando **Evidencia de partida** es observable y accionable dentro del plazo de la decisión. | Sobrerreaccionar a una señal parcial. |
| Intervenir sobre **Desenganche** | Retiro progresivo de la participación —conductual, emocional y cognitiva— que precede a la inasistencia | Cuando la primera explicación no distingue mecanismo ni responsable. | Convertir el concepto en etiqueta y no en intervención. |
| Observar antes de decidir | Reducir la incertidumbre antes de comprometer tiempo y credibilidad | Cuando la decisión es reversible y la evidencia disponible no distingue causas. | Observar indefinidamente y no decidir nunca. |
| Derivar o escalar | Poner la decisión donde están la competencia y la responsabilidad | Cuando hay normativa, resguardo de datos, salud o vulneración de derechos en juego. | Delegar hacia arriba lo que sí correspondía decidir en el aula. |

**Frontera de aplicación.** La asistencia detecta el problema pero no informa su causa: Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre desenganche escolar y ausentismo crónico |
|---|---|
...
Un análisis de asistencia del curso con estudiantes en riesgo identificados y acción asignada.

Guárdala en `evidence/P21-C253-desenganche-escolar-y-ausentismo-cronico/` con estos archivos:
...
Calcula el porcentaje acumulado de inasistencia de tu curso. Identifica a los que cruzaron el umbral y activa una acción concreta con cada uno esta semana.
...
- [ ] el análisis identifica estudiantes por porcentaje acumulado y no por faltas del mes;
- [ ] cada estudiante en riesgo tiene acción asignada con responsable y plazo;
...
- Separar faltas justificadas de injustificadas y perder de vista el total, que es lo que afecta al aprendizaje.
- Responder a la inasistencia con sanciones que aumentan la distancia con la escuela.
...
El ausentismo se concentra en estudiantes con responsabilidades de cuidado, con problemas de salud crónicos y en contextos de mayor vulnerabilidad. Responder con sanción convierte una dificultad estructural en una falta personal.
...
1. ¿Cuántos estudiantes de tu curso perdieron ya el diez por ciento del año?
2. ¿Qué se activó la última vez que alguien cruzó el umbral, y quién lo activó?
3. ¿Qué señales de desenganche aparecieron antes de la primera inasistencia?
...
Abre la parte 21 y prepara la 254. Se articula con las clases 145 y 156 y con la parte 15.
...
|---|---|---|
| [← Parte 21](../README.md) | [Parte 21](../README.md) · [Programa](../../../README.md) | [254 · Falta de sentido: por qué estudiar dejó de ser evidente →](../class-02-falta-de-sentido-por-que-estudiar-dejo-de-ser-evidente/README.md) |
