# Clase 261 — Mediación escolar y prácticas restaurativas

> **Parte 21 · Desafíos actuales del aula** — clase 9 de 12
...
**Decisión que habilita:** determinar si este caso admite mediación restaurativa y qué reparación concreta corresponde<br>
**Evidencia de aprendizaje:** un acta de mediación con acuerdo de reparación, plazo y fecha de verificación

## 🎯 Propósito

Conducir mediaciones y prácticas restaurativas que produzcan reparación verificable, y reconocer cuándo no corresponde aplicarlas.
...
2. **Explicar** qué diferencia una reparación real de una disculpa dictada por el reglamento.
3. **Decidir** —si este caso admite mediación restaurativa y qué reparación concreta corresponde— y sostener la decisión con un fundamento escrito.
4. **Producir** la evidencia de la clase —un acta de mediación con acuerdo de reparación, plazo y fecha de verificación— y contrastarla contra el criterio de logro.
...
|---|---|
| **Justicia restaurativa** | enfoque centrado en reparar el daño y restaurar la relación, complementario y no sustitutivo del debido proceso |
| **Mediación escolar** | proceso voluntario en que un tercero facilita el acuerdo entre partes con poder comparable |
| **Acuerdo de reparación** | compromiso concreto, verificable y con plazo, que responde al daño efectivamente causado |
| **Contraindicación** | condición —asimetría de poder, riesgo, no voluntariedad— que hace inapropiada la mediación |
...
2. Clasificar la situación distinguiendo **Justicia restaurativa** de **Mediación escolar**.
3. Decidir con fundamento, usando **Acuerdo de reparación** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Contraindicación** a la vista.
...
| **Evidencia de logro** | qué muestra un acta de mediación con acuerdo de reparación, plazo y fecha de verificación frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
La calidad de la evidencia es desigual y los efectos dependen fuertemente de la formación de quien facilita. Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Justicia restaurativa"]
    C --> A2["Mediación escolar"]
    C --> A3["Acuerdo de reparación"]
    C --> A4["Contraindicación"]
    A1 & A2 & A3 & A4 --> D{{"determinar si este caso<br/>admite mediación<br/>restaurativa y qué<br/>reparación concreta<br/>corresponde"}}
    D --> E["Evidencia de aprendizaje<br/>un acta de mediación con<br/>acuerdo de reparación,<br/>plazo y fecha de<br/>verificación"]
...
Las prácticas restaurativas se difundieron rápido en las escuelas y con frecuencia se aplican mal. Su lógica es exigente: no reemplazan la consecuencia, sino que agregan la reparación del daño y la restauración del vínculo. Su evidencia muestra efectos favorables sobre clima y sobre reincidencia, con calidad de estudios variable. Y tienen contraindicaciones claras: no corresponden cuando hay asimetría de poder sostenida, cuando la participación no es voluntaria o cuando exponen a la persona dañada.

### 2. Frontera conceptual: qué es y qué no es

Los cuatro conceptos de esta clase se confunden entre sí con facilidad, y esa confusión no es
inocua: produce decisiones que atacan el problema equivocado. **Justicia restaurativa** no es lo
mismo que **Mediación escolar** —proceso voluntario en que un tercero facilita el acuerdo entre partes con poder comparable—, y tratarlos como sinónimos hace
que la intervención se dirija al lugar incorrecto. Del mismo modo, **Acuerdo de reparación** y
**Contraindicación** describen aspectos distintos de la misma situación: el primero
compromiso concreto, verificable y con plazo, que responde al daño efectivamente causado, mientras el segundo condición —asimetría de poder, riesgo, no voluntariedad— que hace inapropiada la mediación.
...
- **Evidencia de logro.** Qué muestra un acta de mediación con acuerdo de reparación, plazo y fecha de verificación frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
Una mediación conducida profesionalmente verifica primero las condiciones —voluntariedad, simetría, seguridad—, prepara a las partes por separado, y conduce el encuentro con reglas explícitas. El acuerdo debe ser concreto: qué hará cada parte, en qué plazo y quién verifica. Una disculpa dictada por el reglamento y firmada no es reparación; es un trámite que enseña que basta con decir la fórmula correcta.

### 5. Qué sostiene la evidencia y qué no

La calidad de la evidencia es desigual y los efectos dependen fuertemente de la formación de quien facilita. Aplicadas sin condiciones, estas prácticas pueden revictimizar. Y su instalación institucional exige tiempo docente y formación que rara vez se financian, con lo que suelen degradarse a una conversación apurada en la sala de profesores.
...
te deja en condiciones de si este caso admite mediación restaurativa y qué reparación concreta corresponde, y esa decisión se sostiene solo si
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Justicia restaurativa** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Justicia restaurativa de Mediación escolar.** El trabajo aquí es separar lo observado de lo interpretado sobre **Mediación escolar**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Acuerdo de reparación como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Acuerdo de reparación**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.

**Paso 4 — Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con Contraindicación a la vista.** Con **Contraindicación** ya delimitado, la pregunta pasa a ser de consecuencia: qué cambia para los estudiantes, para el tiempo de clase y para la carga del equipo. **Evidencia de partida** entrega la lectura observable; el juicio profesional sigue siendo humano y debe quedar firmado por quien lo hace.
...
|---|---|---|---|
| Intervenir sobre **Justicia restaurativa** | Enfoque centrado en reparar el daño y restaurar la relación, complementario y no sustitutivo del debido proceso | Cuando **Evidencia de partida** es observable y accionable dentro del plazo de la decisión. | Sobrerreaccionar a una señal parcial. |
| Intervenir sobre **Mediación escolar** | Proceso voluntario en que un tercero facilita el acuerdo entre partes con poder comparable | Cuando la primera explicación no distingue mecanismo ni responsable. | Convertir el concepto en etiqueta y no en intervención. |
| Observar antes de decidir | Reducir la incertidumbre antes de comprometer tiempo y credibilidad | Cuando la decisión es reversible y la evidencia disponible no distingue causas. | Observar indefinidamente y no decidir nunca. |
| Derivar o escalar | Poner la decisión donde están la competencia y la responsabilidad | Cuando hay normativa, resguardo de datos, salud o vulneración de derechos en juego. | Delegar hacia arriba lo que sí correspondía decidir en el aula. |

**Frontera de aplicación.** La calidad de la evidencia es desigual y los efectos dependen fuertemente de la formación de quien facilita. Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre mediación escolar y prácticas restaurativas |
|---|---|
...
Un acta de mediación con acuerdo de reparación, plazo y fecha de verificación.

Guárdala en `evidence/P21-C261-mediacion-escolar-y-practicas-restaurativas/` con estos archivos:
...
Conduce una mediación con verificación previa de condiciones. Redacta el acuerdo con plazo y verifica el cumplimiento en la fecha comprometida.
...
- [ ] el acta verifica voluntariedad, simetría y seguridad antes de la mediación;
- [ ] el acuerdo declara acción concreta, plazo y responsable de verificación;
...
- Aplicar mediación en casos de acoso sostenido, donde la asimetría de poder la contraindica.
- Cerrar con una disculpa firmada y sin acuerdo verificable de reparación.
...
La mediación exige competencias comunicativas que no todos los estudiantes tienen por igual: quien maneja mejor el lenguaje domina el proceso. La facilitación debe compensar esa asimetría o el acuerdo reproducirá la desigualdad de origen.
...
1. ¿Existe asimetría de poder que contraindique la mediación en este caso?
2. ¿Qué reparación concreta pide la persona dañada, y es realizable?
3. ¿Quién verificará el cumplimiento y en qué fecha?
...
Se apoya en las clases 256 y 257, y complementa la 150. Prepara la clase 264.
...
|---|---|---|
| [← 260 · Agresiones al docente y protección del equipo](../class-08-agresiones-al-docente-y-proteccion-del-equipo/README.md) | [Parte 21](../README.md) · [Programa](../../../README.md) | [262 · Aulas numerosas y heterogéneas con recursos limitados →](../class-10-aulas-numerosas-y-heterogeneas-con-recursos-limitados/README.md) |
