# Clase 262 — Aulas numerosas y heterogéneas con recursos limitados

> **Parte 21 · Desafíos actuales del aula** — clase 10 de 12

**Estado de evidencia:** `PRACTICA-PROFESIONAL` · **Etapa:** 🟤 Etapa F — Especialización y desafíos contemporáneos · **Población de referencia:** escolar, con énfasis en segundo ciclo y media<br>
**Decisión que habilita:** determinar qué estrategias de diferenciación son sostenibles con el tamaño y los recursos reales de tu curso<br>
**Evidencia de aprendizaje:** un diseño de clase con diferenciación sostenible y su verificación de carga de trabajo docente

## 🎯 Propósito

Diseñar estrategias de gestión y diferenciación viables en aulas numerosas y heterogéneas, sin depender de recursos que no existen.
...
2. **Explicar** qué decisiones cambian cuando hay cuarenta estudiantes y no hay recursos adicionales.
3. **Decidir** —qué estrategias de diferenciación son sostenibles con el tamaño y los recursos reales de tu curso— y sostener la decisión con un fundamento escrito.
4. **Producir** la evidencia de la clase —un diseño de clase con diferenciación sostenible y su verificación de carga de trabajo docente— y contrastarla contra el criterio de logro.
...
|---|---|
| **Diferenciación sostenible** | ajuste a la diversidad que un docente puede mantener durante todo el año sin colapsar |
| **Tarea común con niveles** | actividad única con distintos grados de exigencia o de apoyo, en vez de tres actividades distintas |
| **Rutinas de autonomía** | procedimientos enseñados que permiten al estudiante continuar sin intervención adulta constante |
| **Costo docente** | tiempo real de preparación y corrección que una estrategia exige por semana |
...
2. Clasificar la situación distinguiendo **Diferenciación sostenible** de **Tarea común con niveles**.
3. Decidir con fundamento, usando **Rutinas de autonomía** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Costo docente** a la vista.
...
| **Evidencia de logro** | qué muestra un diseño de clase con diferenciación sostenible y su verificación de carga de trabajo docente frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
La diferenciación sostenible es un compromiso y hay que decirlo: Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Diferenciación<br/>sostenible"]
    C --> A2["Tarea común con<br/>niveles"]
    C --> A3["Rutinas de autonomía"]
    C --> A4["Costo docente"]
    A1 & A2 & A3 & A4 --> D{{"determinar qué<br/>estrategias de<br/>diferenciación son<br/>sostenibles con el<br/>tamaño y los recursos…"}}
    D --> E["Evidencia de aprendizaje<br/>un diseño de clase con<br/>diferenciación<br/>sostenible y su<br/>verificación de carga de<br/>trabajo docente"]
...
Buena parte de la literatura sobre diferenciación asume condiciones que el sistema escolar chileno no ofrece: grupos pequeños, apoyo adicional y tiempo de preparación. Aplicada literalmente en un curso de cuarenta estudiantes, produce agotamiento y abandono en pocas semanas. La pregunta profesional no es cómo diferenciar idealmente, sino qué diferenciación puede sostenerse durante todo el año con el tiempo que realmente existe.

### 2. Frontera conceptual: qué es y qué no es

Los cuatro conceptos de esta clase se confunden entre sí con facilidad, y esa confusión no es
inocua: produce decisiones que atacan el problema equivocado. **Diferenciación sostenible** no es lo
mismo que **Tarea común con niveles** —actividad única con distintos grados de exigencia o de apoyo, en vez de tres actividades distintas—, y tratarlos como sinónimos hace
que la intervención se dirija al lugar incorrecto. Del mismo modo, **Rutinas de autonomía** y
**Costo docente** describen aspectos distintos de la misma situación: el primero
procedimientos enseñados que permiten al estudiante continuar sin intervención adulta constante, mientras el segundo tiempo real de preparación y corrección que una estrategia exige por semana.
...
- **Evidencia de logro.** Qué muestra un diseño de clase con diferenciación sostenible y su verificación de carga de trabajo docente frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
Las estrategias que sobreviven comparten un rasgo: no multiplican la preparación. Tarea común con tres niveles de exigencia en vez de tres tareas distintas; material de extensión disponible de forma permanente; rutinas de autonomía enseñadas al inicio del año; agrupamiento flexible que cambia con el contenido; y retroalimentación grupal sobre errores frecuentes en lugar de comentarios individuales en cada trabajo. Cada estrategia se evalúa por su costo semanal en horas.

### 5. Qué sostiene la evidencia y qué no

La diferenciación sostenible es un compromiso y hay que decirlo: atiende menos que la diferenciación ideal. Su evidencia específica es limitada y proviene sobre todo de descripciones de práctica. Además, el problema de fondo —tamaño de curso y horas no lectivas— es estructural y ninguna estrategia docente lo resuelve; presentarlas como solución completa desplaza la responsabilidad hacia quien menos puede modificarlo.
...
te deja en condiciones de qué estrategias de diferenciación son sostenibles con el tamaño y los recursos reales de tu curso, y esa decisión se sostiene solo si
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Diferenciación sostenible** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Diferenciación sostenible de Tarea común con niveles.** El trabajo aquí es separar lo observado de lo interpretado sobre **Tarea común con niveles**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Rutinas de autonomía como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Rutinas de autonomía**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.

**Paso 4 — Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con Costo docente a la vista.** Con **Costo docente** ya delimitado, la pregunta pasa a ser de consecuencia: qué cambia para los estudiantes, para el tiempo de clase y para la carga del equipo. **Evidencia de partida** entrega la lectura observable; el juicio profesional sigue siendo humano y debe quedar firmado por quien lo hace.
...
|---|---|---|---|
| Intervenir sobre **Diferenciación sostenible** | Ajuste a la diversidad que un docente puede mantener durante todo el año sin colapsar | Cuando **Evidencia de partida** es observable y accionable dentro del plazo de la decisión. | Sobrerreaccionar a una señal parcial. |
| Intervenir sobre **Tarea común con niveles** | Actividad única con distintos grados de exigencia o de apoyo, en vez de tres actividades distintas | Cuando la primera explicación no distingue mecanismo ni responsable. | Convertir el concepto en etiqueta y no en intervención. |
| Observar antes de decidir | Reducir la incertidumbre antes de comprometer tiempo y credibilidad | Cuando la decisión es reversible y la evidencia disponible no distingue causas. | Observar indefinidamente y no decidir nunca. |
| Derivar o escalar | Poner la decisión donde están la competencia y la responsabilidad | Cuando hay normativa, resguardo de datos, salud o vulneración de derechos en juego. | Delegar hacia arriba lo que sí correspondía decidir en el aula. |

**Frontera de aplicación.** La diferenciación sostenible es un compromiso y hay que decirlo: Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre aulas numerosas y heterogéneas con recursos limitados |
|---|---|
...
Un diseño de clase con diferenciación sostenible y su verificación de carga de trabajo docente.

Guárdala en `evidence/P21-C262-aulas-numerosas-y-heterogeneas-con-recursos-limitados/` con estos archivos:
...
Calcula las horas semanales que exige tu esquema actual de diferenciación. Rediséñalo con tarea común por niveles y compara la carga y la cobertura.
...
- [ ] cada estrategia declara su costo semanal en horas de preparación y corrección;
- [ ] el diseño usa tarea común con niveles en vez de actividades paralelas;
...
- Diseñar tres actividades distintas por clase y abandonar la diferenciación en tres semanas.
- Presentar la diferenciación como solución de un problema que es de tamaño de curso y de horas.
...
En un aula numerosa, los estudiantes que no interrumpen son los que menos atención reciben, independientemente de su necesidad. Una estrategia de diferenciación debe declarar cómo alcanza a quienes no reclaman.
...
1. ¿Cuántas horas semanales te exige realmente tu esquema de diferenciación?
2. ¿Qué rutinas de autonomía enseñaste y cuáles diste por supuestas?
3. ¿Qué parte de este problema no se resuelve con estrategias docentes?

## 📗 Fuentes y verificación

- Tomlinson, C. *The Differentiated Classroom* (edición vigente). **Uso en esta clase:** el marco de referencia, que conviene leer junto a la pregunta por su viabilidad real. Lectura selectiva: índice y capítulos pertinentes; registra edición y páginas consultadas. **Localizar:** [ISBN 9781416618607](https://openlibrary.org/isbn/9781416618607) · [ficha](../../../docs/REGISTRO_DE_FUENTES.md#tomlinson-the-differentiated-classroom)
- Rosenshine, B. (2012). *Principles of Instruction*. **Uso en esta clase:** prácticas de alto rendimiento y bajo costo de preparación, viables en cursos numerosos. Lectura selectiva: índice y capítulos pertinentes; registra edición y páginas consultadas. **Localizar:** [ficha](../../../docs/REGISTRO_DE_FUENTES.md#rosenshine-2012-principles-of-instruction) — sin localizador verificado todavía.
...
Se articula con la clase 251 y con la 246 de la parte 22. Complementa las partes 08 y 10.
...
|---|---|---|
| [← 261 · Mediación escolar y prácticas restaurativas](../class-09-mediacion-escolar-y-practicas-restaurativas/README.md) | [Parte 21](../README.md) · [Programa](../../../README.md) | [263 · Consumo, riesgo psicosocial y derivación →](../class-11-consumo-riesgo-psicosocial-y-derivacion/README.md) |
