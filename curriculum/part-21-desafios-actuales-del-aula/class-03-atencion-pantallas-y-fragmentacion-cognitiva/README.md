# Clase 255 — Atención, pantallas y fragmentación cognitiva

> **Parte 21 · Desafíos actuales del aula** — clase 3 de 12

**Estado de evidencia:** `EN-DEBATE` · **Etapa:** 🟤 Etapa F — Especialización y desafíos contemporáneos · **Población de referencia:** escolar, con énfasis en segundo ciclo y media<br>
**Decisión que habilita:** determinar la política de dispositivos de tu aula con fundamento y con un criterio de revisión<br>
**Evidencia de aprendizaje:** una política de uso de dispositivos con fundamento declarado, excepciones y criterio de revisión

## 🎯 Propósito

Tomar decisiones sobre dispositivos y atención distinguiendo lo que la evidencia sostiene de lo que circula como certeza cultural.
...
2. **Explicar** qué se puede afirmar con evidencia sobre pantallas y atención, y qué es pánico moral.
3. **Decidir** —la política de dispositivos de tu aula con fundamento y con un criterio de revisión— y sostener la decisión con un fundamento escrito.
4. **Producir** la evidencia de la clase —una política de uso de dispositivos con fundamento declarado, excepciones y criterio de revisión— y contrastarla contra el criterio de logro.
...
|---|---|
| **Atención sostenida** | capacidad de mantener el foco en una tarea a lo largo del tiempo, entrenable y sensible al contexto |
| **Costo de cambio de tarea** | pérdida de rendimiento al alternar entre actividades, documentada de forma consistente |
| **Pánico moral** | alarma social desproporcionada respecto de la evidencia disponible sobre un fenómeno nuevo |
| **Desplazamiento de actividad** | efecto por el cual el tiempo de pantalla sustituye a otras actividades, más que dañar directamente |
...
2. Clasificar la situación distinguiendo **Atención sostenida** de **Costo de cambio de tarea**.
3. Decidir con fundamento, usando **Pánico moral** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Desplazamiento de actividad** a la vista.
...
| **Evidencia de logro** | qué muestra una política de uso de dispositivos con fundamento declarado, excepciones y criterio de revisión frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
La investigación disponible es mayoritariamente correlacional y no permite establecer dirección causal: Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Atención sostenida"]
    C --> A2["Costo de cambio de<br/>tarea"]
    C --> A3["Pánico moral"]
    C --> A4["Desplazamiento de<br/>actividad"]
    A1 & A2 & A3 & A4 --> D{{"determinar la política<br/>de dispositivos de tu<br/>aula con fundamento y<br/>con un criterio de<br/>revisión"}}
    D --> E["Evidencia de aprendizaje<br/>una política de uso de<br/>dispositivos con<br/>fundamento declarado,<br/>excepciones y criterio<br/>de revisión"]
...
Hay dos afirmaciones que conviene separar. La primera está bien establecida: alternar entre tareas tiene un costo de rendimiento, y un dispositivo disponible durante una clase reduce lo que se aprende, incluso sin usarlo. La segunda —que las pantallas dañan estructuralmente la capacidad de atención de una generación— tiene evidencia mucho más débil, con estudios correlacionales, tamaños de efecto pequeños y problemas metodológicos serios. Sostener la primera sin adherir a la segunda es la posición defendible.

### 2. Frontera conceptual: qué es y qué no es

Los cuatro conceptos de esta clase se confunden entre sí con facilidad, y esa confusión no es
inocua: produce decisiones que atacan el problema equivocado. **Atención sostenida** no es lo
mismo que **Costo de cambio de tarea** —pérdida de rendimiento al alternar entre actividades, documentada de forma consistente—, y tratarlos como sinónimos hace
que la intervención se dirija al lugar incorrecto. Del mismo modo, **Pánico moral** y
**Desplazamiento de actividad** describen aspectos distintos de la misma situación: el primero
alarma social desproporcionada respecto de la evidencia disponible sobre un fenómeno nuevo, mientras el segundo efecto por el cual el tiempo de pantalla sustituye a otras actividades, más que dañar directamente.
...
- **Evidencia de logro.** Qué muestra una política de uso de dispositivos con fundamento declarado, excepciones y criterio de revisión frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
Una política de aula fundamentada distingue por función: el dispositivo como herramienta declarada de una tarea concreta, con inicio y término, es distinto del dispositivo disponible durante toda la clase. Las reglas funcionan cuando son explícitas, aplicadas de manera consistente y explicadas por su razón, no por autoridad. La revisión periódica evita que la política quede fijada en el pánico del año en que se escribió.

### 5. Qué sostiene la evidencia y qué no

La investigación disponible es mayoritariamente correlacional y no permite establecer dirección causal: es igualmente plausible que las dificultades de atención aumenten el uso de pantallas. El campo cambia más rápido que los estudios y buena parte de lo publicado ya describe tecnologías distintas de las actuales. Y las medidas de uso son casi siempre autorreportadas, con error conocido y grande.
...
te deja en condiciones de la política de dispositivos de tu aula con fundamento y con un criterio de revisión, y esa decisión se sostiene solo si
...
|---|---|---|
| Orben, A. & Przybylski, A. (2019). *The Association Between Adolescent Well-Being and Digital Technology Use*. | el análisis que redimensionó los tamaños de efecto reportados en la literatura previa. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
| Ward, A. et al. (2017). *Brain Drain*. | documenta el costo cognitivo de la mera presencia del dispositivo, sin uso. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Atención sostenida** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Atención sostenida de Costo de cambio de tarea.** El trabajo aquí es separar lo observado de lo interpretado sobre **Costo de cambio de tarea**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Pánico moral como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Pánico moral**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.

**Paso 4 — Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con Desplazamiento de actividad a la vista.** Con **Desplazamiento de actividad** ya delimitado, la pregunta pasa a ser de consecuencia: qué cambia para los estudiantes, para el tiempo de clase y para la carga del equipo. **Evidencia de partida** entrega la lectura observable; el juicio profesional sigue siendo humano y debe quedar firmado por quien lo hace.
...
|---|---|---|---|
| Intervenir sobre **Atención sostenida** | Capacidad de mantener el foco en una tarea a lo largo del tiempo, entrenable y sensible al contexto | Cuando **Evidencia de partida** es observable y accionable dentro del plazo de la decisión. | Sobrerreaccionar a una señal parcial. |
| Intervenir sobre **Costo de cambio de tarea** | Pérdida de rendimiento al alternar entre actividades, documentada de forma consistente | Cuando la primera explicación no distingue mecanismo ni responsable. | Convertir el concepto en etiqueta y no en intervención. |
| Observar antes de decidir | Reducir la incertidumbre antes de comprometer tiempo y credibilidad | Cuando la decisión es reversible y la evidencia disponible no distingue causas. | Observar indefinidamente y no decidir nunca. |
| Derivar o escalar | Poner la decisión donde están la competencia y la responsabilidad | Cuando hay normativa, resguardo de datos, salud o vulneración de derechos en juego. | Delegar hacia arriba lo que sí correspondía decidir en el aula. |

**Frontera de aplicación.** La investigación disponible es mayoritariamente correlacional y no permite establecer dirección causal: Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre atención, pantallas y fragmentación cognitiva |
|---|---|
...
Una política de uso de dispositivos con fundamento declarado, excepciones y criterio de revisión.

Guárdala en `evidence/P21-C255-atencion-pantallas-y-fragmentacion-cognitiva/` con estos archivos:
...
Redacta la política de dispositivos de tu aula con fundamento explícito y excepciones. Aplícala un mes y registra los conflictos que generó.
...
- [ ] la política declara su fundamento y distingue uso como herramienta de disponibilidad permanente;
- [ ] existe fecha de revisión y criterio para modificarla;
...
- Prohibir sin explicar la razón y perder la posibilidad de que la norma se sostenga sin vigilancia.
- Afirmar como establecido el daño estructural a la atención, que la evidencia disponible no respalda.
...
Las políticas restrictivas afectan de manera desigual a estudiantes que dependen del teléfono como único acceso a internet, a quienes lo usan como apoyo de accesibilidad y a quienes tienen responsabilidades de cuidado familiar durante la jornada.
...
1. ¿Tu norma sobre celulares está fundamentada o heredada?
2. ¿Qué evidencia tienes de que el dispositivo afecta el trabajo en tu clase específicamente?
3. ¿Qué actividad desplaza el tiempo de pantalla en tus estudiantes?
...
Profundiza la clase 153 y se apoya en la parte 13. Enlaza con la clase 284.
...
|---|---|---|
| [← 254 · Falta de sentido: por qué estudiar dejó de ser evidente](../class-02-falta-de-sentido-por-que-estudiar-dejo-de-ser-evidente/README.md) | [Parte 21](../README.md) · [Programa](../../../README.md) | [256 · Violencia escolar: tipos, factores y respuesta →](../class-04-violencia-escolar-tipos-factores-y-respuesta/README.md) |
