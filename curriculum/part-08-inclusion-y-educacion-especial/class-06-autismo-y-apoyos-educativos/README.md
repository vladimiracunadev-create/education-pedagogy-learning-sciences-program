...
**Decisión que habilita:** determinar qué ajuste de predictibilidad, comunicación o entorno sensorial requiere tu estudiante<br>
...
2. Clasificar la situación distinguiendo **Predictibilidad** de **Apoyo visual**.
...
| **Evidencia de logro** | qué muestra un conjunto de apoyos para un estudiante autista con su fundamento, su implementación y su criterio de revisión frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
El autismo presenta una variabilidad enorme: Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Predictibilidad"]
    C --> A2["Apoyo visual"]
    C --> A3["Regulación sensorial"]
    C --> A4["Comunicación<br/>aumentativa"]
    A1 & A2 & A3 & A4 --> D{{"determinar qué ajuste de<br/>predictibilidad,<br/>comunicación o entorno<br/>sensorial requiere tu…"}}
    D --> E["Evidencia de aprendizaje<br/>un conjunto de apoyos<br/>para un estudiante<br/>autista con su<br/>fundamento, su<br/>implementación y su…"]
...
inocua: produce decisiones que atacan el problema equivocado. **Predictibilidad** no es lo
mismo que **Apoyo visual** —representación gráfica de secuencias, normas o consignas que complementa el lenguaje oral—, y tratarlos como sinónimos hace
...
gestión de la estimulación del entorno según el perfil sensorial del estudiante, mientras el segundo sistemas que complementan o sustituyen el habla para permitir la comunicación.
...
- **Evidencia de logro.** Qué muestra un conjunto de apoyos para un estudiante autista con su fundamento, su implementación y su criterio de revisión frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
te deja en condiciones de qué ajuste de predictibilidad, comunicación o entorno sensorial requiere tu estudiante, y esa decisión se sostiene solo si
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Predictibilidad** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».
...
|---|---|---|---|
| Intervenir sobre **Predictibilidad** | Anticipación explícita de lo que va a ocurrir; reduce la ansiedad y aumenta la disponibilidad | Cuando **Evidencia de partida** es observable y accionable dentro del plazo de la decisión. | Sobrerreaccionar a una señal parcial. |
| Intervenir sobre **Apoyo visual** | Representación gráfica de secuencias, normas o consignas que complementa el lenguaje oral | Cuando la primera explicación no distingue mecanismo ni responsable. | Convertir el concepto en etiqueta y no en intervención. |
| Observar antes de decidir | Reducir la incertidumbre antes de comprometer tiempo y credibilidad | Cuando la decisión es reversible y la evidencia disponible no distingue causas. | Observar indefinidamente y no decidir nunca. |
| Derivar o escalar | Poner la decisión donde están la competencia y la responsabilidad | Cuando hay normativa, resguardo de datos, salud o vulneración de derechos en juego. | Delegar hacia arriba lo que sí correspondía decidir en el aula. |

**Frontera de aplicación.** El autismo presenta una variabilidad enorme: Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre autismo y apoyos educativos |
|---|---|
...
Guárdala en `evidence/P08-C102-autismo-y-apoyos-educativos/` con estos archivos:
