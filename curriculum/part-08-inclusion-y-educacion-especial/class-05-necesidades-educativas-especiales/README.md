...
**Decisión que habilita:** determinar qué apoyos concretos se derivan de una necesidad detectada y quién los ejecuta en el aula<br>
...
2. Clasificar la situación distinguiendo **Necesidad educativa especial** de **Necesidad permanente y transitoria**.
3. Decidir con fundamento, usando **Plan de apoyo individual** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Equipo de aula** a la vista.
...
| **Evidencia de logro** | qué muestra un plan de apoyo individual conectado con la planificación de aula, con responsables, plazos y criterios de revisión frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
El diagnóstico describe funcionamiento en un momento y con instrumentos limitados; Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Necesidad educativa<br/>especial"]
    C --> A2["Necesidad permanente y<br/>transitoria"]
    C --> A3["Plan de apoyo<br/>individual"]
    C --> A4["Equipo de aula"]
    A1 & A2 & A3 & A4 --> D{{"determinar qué apoyos<br/>concretos se derivan de<br/>una necesidad detectada<br/>y quién los ejecuta en<br/>el…"}}
    D --> E["Evidencia de aprendizaje<br/>un plan de apoyo<br/>individual conectado con<br/>la planificación de<br/>aula, con responsables,<br/>plazos y…"]
...
- **Evidencia de logro.** Qué muestra un plan de apoyo individual conectado con la planificación de aula, con responsables, plazos y criterios de revisión frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
te deja en condiciones de qué apoyos concretos se derivan de una necesidad detectada y quién los ejecuta en el aula, y esa decisión se sostiene solo si
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Necesidad educativa especial** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Necesidad educativa especial de Necesidad permanente y transitoria.** El trabajo aquí es separar lo observado de lo interpretado sobre **Necesidad permanente y transitoria**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Plan de apoyo individual como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Plan de apoyo individual**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.

**Paso 4 — Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con Equipo de aula a la vista.** Con **Equipo de aula** ya delimitado, la pregunta pasa a ser de consecuencia: qué cambia para los estudiantes, para el tiempo de clase y para la carga del equipo. **Evidencia de partida** entrega la lectura observable; el juicio profesional sigue siendo humano y debe quedar firmado por quien lo hace.
...
**Frontera de aplicación.** El diagnóstico describe funcionamiento en un momento y con instrumentos limitados; Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre necesidades educativas especiales |
|---|---|
...
Guárdala en `evidence/P08-C101-necesidades-educativas-especiales/` con estos archivos:
