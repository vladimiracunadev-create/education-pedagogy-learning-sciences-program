...
**Decisión que habilita:** determinar qué barrera concreta explica la no participación de un estudiante en tu clase<br>
...
2. Clasificar la situación distinguiendo **Barrera de acceso** de **Barrera de comprensión**.
3. Decidir con fundamento, usando **Barrera de participación** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Barrera de evaluación** a la vista.
...
| **Evidencia de logro** | qué muestra un mapa de barreras de una clase real con evidencia observada y la eliminación propuesta para cada una frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
El enfoque de barreras no niega que existan condiciones individuales que requieren apoyos específicos: Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Barrera de acceso"]
    C --> A2["Barrera de comprensión"]
    C --> A3["Barrera de<br/>participación"]
    C --> A4["Barrera de evaluación"]
    A1 & A2 & A3 & A4 --> D{{"determinar qué barrera<br/>concreta explica la no<br/>participación de un<br/>estudiante en tu clase"}}
    D --> E["Evidencia de aprendizaje<br/>un mapa de barreras de<br/>una clase real con<br/>evidencia observada y la<br/>eliminación propuesta<br/>para…"]
...
inocua: produce decisiones que atacan el problema equivocado. **Barrera de acceso** no es lo
mismo que **Barrera de comprensión** —obstáculo en el lenguaje, el formato o el conocimiento previo supuesto por la clase—, y tratarlos como sinónimos hace
que la intervención se dirija al lugar incorrecto. Del mismo modo, **Barrera de participación** y
**Barrera de evaluación** describen aspectos distintos de la misma situación: el primero
condición social u organizativa que impide intervenir, trabajar con otros o mostrar lo aprendido, mientras el segundo formato de evaluación que impide demostrar un aprendizaje que sí existe.
...
- **Evidencia de logro.** Qué muestra un mapa de barreras de una clase real con evidencia observada y la eliminación propuesta para cada una frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
te deja en condiciones de qué barrera concreta explica la no participación de un estudiante en tu clase, y esa decisión se sostiene solo si
...
|---|---|---|
| Booth, T. & Ainscow, M. (2011). *Index for Inclusion*. | fuente del concepto de barreras para el aprendizaje y la participación, con indicadores. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
| Organización Mundial de la Salud (2001). *CIF*. | fundamenta el funcionamiento como interacción entre la persona y su entorno. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Barrera de acceso** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Barrera de acceso de Barrera de comprensión.** El trabajo aquí es separar lo observado de lo interpretado sobre **Barrera de comprensión**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Barrera de participación como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Barrera de participación**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.

**Paso 4 — Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con Barrera de evaluación a la vista.** Con **Barrera de evaluación** ya delimitado, la pregunta pasa a ser de consecuencia: qué cambia para los estudiantes, para el tiempo de clase y para la carga del equipo. **Evidencia de partida** entrega la lectura observable; el juicio profesional sigue siendo humano y debe quedar firmado por quien lo hace.
...
|---|---|---|---|
| Intervenir sobre **Barrera de acceso** | Obstáculo físico, sensorial o comunicativo que impide llegar al contenido o al espacio | Cuando **Evidencia de partida** es observable y accionable dentro del plazo de la decisión. | Sobrerreaccionar a una señal parcial. |
| Intervenir sobre **Barrera de comprensión** | Obstáculo en el lenguaje, el formato o el conocimiento previo supuesto por la clase | Cuando la primera explicación no distingue mecanismo ni responsable. | Convertir el concepto en etiqueta y no en intervención. |
| Observar antes de decidir | Reducir la incertidumbre antes de comprometer tiempo y credibilidad | Cuando la decisión es reversible y la evidencia disponible no distingue causas. | Observar indefinidamente y no decidir nunca. |
| Derivar o escalar | Poner la decisión donde están la competencia y la responsabilidad | Cuando hay normativa, resguardo de datos, salud o vulneración de derechos en juego. | Delegar hacia arriba lo que sí correspondía decidir en el aula. |

**Frontera de aplicación.** El enfoque de barreras no niega que existan condiciones individuales que requieren apoyos específicos: Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre barreras para el aprendizaje y la participación |
|---|---|
...
Guárdala en `evidence/P08-C098-barreras-para-el-aprendizaje-y-la-participacion/` con estos archivos:
