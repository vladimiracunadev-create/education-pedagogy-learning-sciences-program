...
**Estado de evidencia:** `MARCO-NORMATIVO` · **Etapa:** 🟣 Etapa C — Núcleo profesional docente · **Población de referencia:** todos los niveles, con foco en apoyos y accesibilidad<br>
**Decisión que habilita:** determinar si una práctica de tu establecimiento integra, incluye o simplemente tolera la presencia del estudiante<br>
...
2. Clasificar la situación distinguiendo **Educación inclusiva** de **Integración**.
3. Decidir con fundamento, usando **Exclusión** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Apoyo** a la vista.
...
| **Evidencia de logro** | qué muestra un diagnóstico de tu establecimiento que clasifique tres prácticas como exclusión, integración o inclusión, con evidencia frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
La inclusión tiene tensiones prácticas reconocidas y discutidas por profesionales competentes: Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Educación inclusiva"]
    C --> A2["Integración"]
    C --> A3["Exclusión"]
    C --> A4["Apoyo"]
    A1 & A2 & A3 & A4 --> D{{"determinar si una<br/>práctica de tu<br/>establecimiento integra,<br/>incluye o simplemente<br/>tolera la…"}}
    D --> E["Evidencia de aprendizaje<br/>un diagnóstico de tu<br/>establecimiento que<br/>clasifique tres<br/>prácticas como<br/>exclusión, integración…"]
...
inocua: produce decisiones que atacan el problema equivocado. **Educación inclusiva** no es lo
mismo que **Integración** —incorporación del estudiante al espacio común exigiéndole adaptarse a él sin modificarlo—, y tratarlos como sinónimos hace
que la intervención se dirija al lugar incorrecto. Del mismo modo, **Exclusión** y
**Apoyo** describen aspectos distintos de la misma situación: el primero
impedimento de acceso, permanencia o participación, incluso cuando el estudiante está presente, mientras el segundo recurso, ajuste o intervención que hace posible la participación y el aprendizaje.
...
- **Evidencia de logro.** Qué muestra un diagnóstico de tu establecimiento que clasifique tres prácticas como exclusión, integración o inclusión, con evidencia frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
te deja en condiciones de si una práctica de tu establecimiento integra, incluye o simplemente tolera la presencia del estudiante, y esa decisión se sostiene solo si
...
|---|---|---|
| Booth, T. & Ainscow, M. (2011). *Index for Inclusion*. | convierte la inclusión en indicadores revisables por la propia comunidad educativa. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
| Ley 20.845 de Inclusión Escolar (Chile) y normativa asociada (edición vigente). | marco vigente que define obligaciones del sostenedor y derechos del estudiante. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Educación inclusiva** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Educación inclusiva de Integración.** El trabajo aquí es separar lo observado de lo interpretado sobre **Integración**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Exclusión como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Exclusión**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.
...
|---|---|---|---|
| Intervenir sobre **Educación inclusiva** | Proceso de eliminar barreras para que todos aprendan y participen en el sistema común | Cuando **Evidencia de partida** es observable y accionable dentro del plazo de la decisión. | Sobrerreaccionar a una señal parcial. |
| Intervenir sobre **Integración** | Incorporación del estudiante al espacio común exigiéndole adaptarse a él sin modificarlo | Cuando la primera explicación no distingue mecanismo ni responsable. | Convertir el concepto en etiqueta y no en intervención. |
| Observar antes de decidir | Reducir la incertidumbre antes de comprometer tiempo y credibilidad | Cuando la decisión es reversible y la evidencia disponible no distingue causas. | Observar indefinidamente y no decidir nunca. |
| Derivar o escalar | Poner la decisión donde están la competencia y la responsabilidad | Cuando hay normativa, resguardo de datos, salud o vulneración de derechos en juego. | Delegar hacia arriba lo que sí correspondía decidir en el aula. |

**Frontera de aplicación.** La inclusión tiene tensiones prácticas reconocidas y discutidas por profesionales competentes: Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre educación inclusiva |
|---|---|
...
Guárdala en `evidence/P08-C097-educacion-inclusiva/` con estos archivos:
...
- Booth, T. & Ainscow, M. (2011). *Index for Inclusion*. **Uso en esta clase:** convierte la inclusión en indicadores revisables por la propia comunidad educativa. Lectura selectiva: índice y capítulos pertinentes; registra edición y páginas consultadas.
- Ley 20.845 de Inclusión Escolar (Chile) y normativa asociada (edición vigente). **Uso en esta clase:** marco vigente que define obligaciones del sostenedor y derechos del estudiante. Lectura selectiva: índice y capítulos pertinentes; registra edición y páginas consultadas.
