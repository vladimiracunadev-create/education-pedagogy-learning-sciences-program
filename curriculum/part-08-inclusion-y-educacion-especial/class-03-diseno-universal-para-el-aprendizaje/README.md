...
**Estado de evidencia:** `EMERGENTE` · **Etapa:** 🟣 Etapa C — Núcleo profesional docente · **Población de referencia:** todos los niveles, con foco en apoyos y accesibilidad<br>
**Decisión que habilita:** determinar qué opciones incorporar al diseño para que menos estudiantes necesiten una adecuación individual<br>
...
2. Clasificar la situación distinguiendo **Representación** de **Acción y expresión**.
3. Decidir con fundamento, usando **Implicación** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Diseño anticipado** a la vista.
...
| **Evidencia de logro** | qué muestra el rediseño de una clase con los tres principios aplicados y la comparación con su versión original frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
La evidencia sobre el marco completo es limitada: Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Representación"]
    C --> A2["Acción y expresión"]
    C --> A3["Implicación"]
    C --> A4["Diseño anticipado"]
    A1 & A2 & A3 & A4 --> D{{"determinar qué opciones<br/>incorporar al diseño<br/>para que menos<br/>estudiantes necesiten<br/>una…"}}
    D --> E["Evidencia de aprendizaje<br/>el rediseño de una clase<br/>con los tres principios<br/>aplicados y la<br/>comparación con su<br/>versión…"]
...
inocua: produce decisiones que atacan el problema equivocado. **Representación** no es lo
mismo que **Acción y expresión** —formas alternativas de demostrar lo aprendido sin cambiar el objetivo—, y tratarlos como sinónimos hace
que la intervención se dirija al lugar incorrecto. Del mismo modo, **Implicación** y
**Diseño anticipado** describen aspectos distintos de la misma situación: el primero
opciones que sostienen el interés, el esfuerzo y la autorregulación durante la tarea, mientras el segundo previsión de la variabilidad en el diseño, en vez de ajuste posterior caso a caso.
...
- **Evidencia de logro.** Qué muestra el rediseño de una clase con los tres principios aplicados y la comparación con su versión original frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
te deja en condiciones de qué opciones incorporar al diseño para que menos estudiantes necesiten una adecuación individual, y esa decisión se sostiene solo si
...
|---|---|---|
| CAST (2024). *UDL Guidelines*, versión 3.0. | el marco vigente con sus principios y pautas; consulta la versión actualizada, no resúmenes antiguos. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
| Capp, M. (2017). *The Effectiveness of Universal Design for Learning: A Meta-Analysis*. | revisa la evidencia disponible y sus limitaciones metodológicas. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Representación** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Representación de Acción y expresión.** El trabajo aquí es separar lo observado de lo interpretado sobre **Acción y expresión**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Implicación como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Implicación**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.

**Paso 4 — Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con Diseño anticipado a la vista.** Con **Diseño anticipado** ya delimitado, la pregunta pasa a ser de consecuencia: qué cambia para los estudiantes, para el tiempo de clase y para la carga del equipo. **Evidencia de partida** entrega la lectura observable; el juicio profesional sigue siendo humano y debe quedar firmado por quien lo hace.
...
|---|---|---|---|
| Intervenir sobre **Representación** | Formas alternativas de presentar la información para que sea accesible a distintos perfiles | Cuando **Evidencia de partida** es observable y accionable dentro del plazo de la decisión. | Sobrerreaccionar a una señal parcial. |
| Intervenir sobre **Acción y expresión** | Formas alternativas de demostrar lo aprendido sin cambiar el objetivo | Cuando la primera explicación no distingue mecanismo ni responsable. | Convertir el concepto en etiqueta y no en intervención. |
| Observar antes de decidir | Reducir la incertidumbre antes de comprometer tiempo y credibilidad | Cuando la decisión es reversible y la evidencia disponible no distingue causas. | Observar indefinidamente y no decidir nunca. |
| Derivar o escalar | Poner la decisión donde están la competencia y la responsabilidad | Cuando hay normativa, resguardo de datos, salud o vulneración de derechos en juego. | Delegar hacia arriba lo que sí correspondía decidir en el aula. |

**Frontera de aplicación.** La evidencia sobre el marco completo es limitada: Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre diseño Universal para el Aprendizaje |
|---|---|
...
Guárdala en `evidence/P08-C099-diseno-universal-para-el-aprendizaje/` con estos archivos:
