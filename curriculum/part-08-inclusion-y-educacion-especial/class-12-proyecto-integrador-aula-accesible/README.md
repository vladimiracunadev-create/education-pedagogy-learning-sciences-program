...
**Estado de evidencia:** `CONSISTENTE` · **Etapa:** 🟣 Etapa C — Núcleo profesional docente · **Población de referencia:** todos los niveles, con foco en apoyos y accesibilidad<br>
**Decisión que habilita:** determinar el conjunto de decisiones que hará accesible tu aula y cómo verificarás que todos aprenden<br>
...
2. Clasificar la situación distinguiendo **Aula accesible** de **Coherencia de apoyos**.
3. Decidir con fundamento, usando **Evidencia de participación** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Revisión de apoyos** a la vista.
...
| **Evidencia de logro** | qué muestra el rediseño de un aula accesible con mapa de barreras, diseño universal, apoyos individuales y evidencia de participación frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
Un aula rediseñada no elimina todas las necesidades de apoyo especializado ni compensa condiciones institucionales adversas —cursos numerosos, falta de profesionales, ausencia de tiempo de coordinación—. Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Aula accesible"]
    C --> A2["Coherencia de apoyos"]
    C --> A3["Evidencia de<br/>participación"]
    C --> A4["Revisión de apoyos"]
    A1 & A2 & A3 & A4 --> D{{"determinar el conjunto<br/>de decisiones que hará<br/>accesible tu aula y cómo<br/>verificarás que todos…"}}
    D --> E["Evidencia de aprendizaje<br/>el rediseño de un aula<br/>accesible con mapa de<br/>barreras, diseño<br/>universal, apoyos<br/>individuales y…"]
...
inocua: produce decisiones que atacan el problema equivocado. **Aula accesible** no es lo
mismo que **Coherencia de apoyos** —conexión entre planificación de aula, plan de apoyo individual y trabajo del equipo—, y tratarlos como sinónimos hace
que la intervención se dirija al lugar incorrecto. Del mismo modo, **Evidencia de participación** y
**Revisión de apoyos** describen aspectos distintos de la misma situación: el primero
registro que muestra quién participa efectivamente y quién queda al margen, mientras el segundo proceso periódico que evita que un apoyo se vuelva permanente por inercia.
...
- **Evidencia de logro.** Qué muestra el rediseño de un aula accesible con mapa de barreras, diseño universal, apoyos individuales y evidencia de participación frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
te deja en condiciones de el conjunto de decisiones que hará accesible tu aula y cómo verificarás que todos aprenden, y esa decisión se sostiene solo si
...
|---|---|---|
| Booth, T. & Ainscow, M. (2011). *Index for Inclusion*. | instrumento de autoevaluación para verificar el rediseño con indicadores concretos. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
| CAST (2024). *UDL Guidelines* 3.0. | marco de diseño para articular las decisiones del aula rediseñada. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Aula accesible** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Aula accesible de Coherencia de apoyos.** El trabajo aquí es separar lo observado de lo interpretado sobre **Coherencia de apoyos**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Evidencia de participación como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Evidencia de participación**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.

**Paso 4 — Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con Revisión de apoyos a la vista.** Con **Revisión de apoyos** ya delimitado, la pregunta pasa a ser de consecuencia: qué cambia para los estudiantes, para el tiempo de clase y para la carga del equipo. **Evidencia de partida** entrega la lectura observable; el juicio profesional sigue siendo humano y debe quedar firmado por quien lo hace.
...
|---|---|---|---|
| Intervenir sobre **Aula accesible** | Espacio donde todos los estudiantes pueden acceder, participar y demostrar aprendizaje | Cuando **Evidencia de partida** es observable y accionable dentro del plazo de la decisión. | Sobrerreaccionar a una señal parcial. |
| Intervenir sobre **Coherencia de apoyos** | Conexión entre planificación de aula, plan de apoyo individual y trabajo del equipo | Cuando la primera explicación no distingue mecanismo ni responsable. | Convertir el concepto en etiqueta y no en intervención. |
| Observar antes de decidir | Reducir la incertidumbre antes de comprometer tiempo y credibilidad | Cuando la decisión es reversible y la evidencia disponible no distingue causas. | Observar indefinidamente y no decidir nunca. |
| Derivar o escalar | Poner la decisión donde están la competencia y la responsabilidad | Cuando hay normativa, resguardo de datos, salud o vulneración de derechos en juego. | Delegar hacia arriba lo que sí correspondía decidir en el aula. |

**Frontera de aplicación.** Un aula rediseñada no elimina todas las necesidades de apoyo especializado ni compensa condiciones institucionales adversas —cursos numerosos, falta de profesionales, ausencia de tiempo de coordinación—. Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre proyecto integrador: aula accesible |
|---|---|
...
Guárdala en `evidence/P08-C108-proyecto-integrador-aula-accesible/` con estos archivos:
...
- Booth, T. & Ainscow, M. (2011). *Index for Inclusion*. **Uso en esta clase:** instrumento de autoevaluación para verificar el rediseño con indicadores concretos. Lectura selectiva: índice y capítulos pertinentes; registra edición y páginas consultadas.
- CAST (2024). *UDL Guidelines* 3.0. **Uso en esta clase:** marco de diseño para articular las decisiones del aula rediseñada. Lectura selectiva: índice y capítulos pertinentes; registra edición y páginas consultadas.
