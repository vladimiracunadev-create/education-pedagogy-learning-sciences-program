...
**Decisión que habilita:** determinar qué formato, apoyo técnico o ajuste del espacio hace accesible tu clase concreta<br>
...
2. Clasificar la situación distinguiendo **Accesibilidad** de **Formato alternativo**.
3. Decidir con fundamento, usando **Tecnología de apoyo** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Ajuste razonable** a la vista.
...
| **Evidencia de logro** | qué muestra una revisión de accesibilidad de una clase con ajustes concretos por tipo de barrera y su verificación frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
Los ajustes de acceso no sustituyen los apoyos especializados: Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Accesibilidad"]
    C --> A2["Formato alternativo"]
    C --> A3["Tecnología de apoyo"]
    C --> A4["Ajuste razonable"]
    A1 & A2 & A3 & A4 --> D{{"determinar qué formato,<br/>apoyo técnico o ajuste<br/>del espacio hace<br/>accesible tu clase<br/>concreta"}}
    D --> E["Evidencia de aprendizaje<br/>una revisión de<br/>accesibilidad de una<br/>clase con ajustes<br/>concretos por tipo de<br/>barrera y su…"]
...
inocua: produce decisiones que atacan el problema equivocado. **Accesibilidad** no es lo
mismo que **Formato alternativo** —versión del material accesible: braille, macrotipo, audio, texto digital compatible con lectores—, y tratarlos como sinónimos hace
que la intervención se dirija al lugar incorrecto. Del mismo modo, **Tecnología de apoyo** y
**Ajuste razonable** describen aspectos distintos de la misma situación: el primero
dispositivo o software que compensa una limitación funcional y habilita el desempeño, mientras el segundo modificación necesaria y proporcionada para garantizar el ejercicio de un derecho.
...
- **Evidencia de logro.** Qué muestra una revisión de accesibilidad de una clase con ajustes concretos por tipo de barrera y su verificación frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
te deja en condiciones de qué formato, apoyo técnico o ajuste del espacio hace accesible tu clase concreta, y esa decisión se sostiene solo si
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Accesibilidad** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Accesibilidad de Formato alternativo.** El trabajo aquí es separar lo observado de lo interpretado sobre **Formato alternativo**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Tecnología de apoyo como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Tecnología de apoyo**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.

**Paso 4 — Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con Ajuste razonable a la vista.** Con **Ajuste razonable** ya delimitado, la pregunta pasa a ser de consecuencia: qué cambia para los estudiantes, para el tiempo de clase y para la carga del equipo. **Evidencia de partida** entrega la lectura observable; el juicio profesional sigue siendo humano y debe quedar firmado por quien lo hace.
...
|---|---|---|---|
| Intervenir sobre **Accesibilidad** | Condición que permite acceder al espacio, al material y a la actividad en igualdad de oportunidades | Cuando **Evidencia de partida** es observable y accionable dentro del plazo de la decisión. | Sobrerreaccionar a una señal parcial. |
| Intervenir sobre **Formato alternativo** | Versión del material accesible: braille, macrotipo, audio, texto digital compatible con lectores | Cuando la primera explicación no distingue mecanismo ni responsable. | Convertir el concepto en etiqueta y no en intervención. |
| Observar antes de decidir | Reducir la incertidumbre antes de comprometer tiempo y credibilidad | Cuando la decisión es reversible y la evidencia disponible no distingue causas. | Observar indefinidamente y no decidir nunca. |
| Derivar o escalar | Poner la decisión donde están la competencia y la responsabilidad | Cuando hay normativa, resguardo de datos, salud o vulneración de derechos en juego. | Delegar hacia arriba lo que sí correspondía decidir en el aula. |

**Frontera de aplicación.** Los ajustes de acceso no sustituyen los apoyos especializados: Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre discapacidad sensorial y motora |
|---|---|
...
Guárdala en `evidence/P08-C105-discapacidad-sensorial-y-motora/` con estos archivos:
