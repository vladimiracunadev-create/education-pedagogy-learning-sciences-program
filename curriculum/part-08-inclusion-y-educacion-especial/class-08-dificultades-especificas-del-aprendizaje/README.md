...
**Estado de evidencia:** `ROBUSTA` · **Etapa:** 🟣 Etapa C — Núcleo profesional docente · **Población de referencia:** todos los niveles, con foco en apoyos y accesibilidad<br>
**Decisión que habilita:** determinar si la dificultad de tu estudiante requiere intervención intensiva, ajuste de acceso o ambos<br>
...
2. Clasificar la situación distinguiendo **Dificultad específica** de **Respuesta a la intervención**.
3. Decidir con fundamento, usando **Intervención intensiva** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Ajuste de acceso** a la vista.
...
| **Evidencia de logro** | qué muestra un plan de intervención para una dificultad específica, con línea base, intervención y medición de progreso frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
Los criterios diagnósticos y los puntos de corte varían entre sistemas y manuales, y el desacuerdo profesional es real. Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Dificultad específica"]
    C --> A2["Respuesta a la<br/>intervención"]
    C --> A3["Intervención intensiva"]
    C --> A4["Ajuste de acceso"]
    A1 & A2 & A3 & A4 --> D{{"determinar si la<br/>dificultad de tu<br/>estudiante requiere<br/>intervención intensiva,<br/>ajuste de acceso…"}}
    D --> E["Evidencia de aprendizaje<br/>un plan de intervención<br/>para una dificultad<br/>específica, con línea<br/>base, intervención y<br/>medición…"]
...
inocua: produce decisiones que atacan el problema equivocado. **Dificultad específica** no es lo
mismo que **Respuesta a la intervención** —enfoque que evalúa la dificultad observando cómo responde el estudiante a enseñanza intensiva de calidad—, y tratarlos como sinónimos hace
que la intervención se dirija al lugar incorrecto. Del mismo modo, **Intervención intensiva** y
**Ajuste de acceso** describen aspectos distintos de la misma situación: el primero
enseñanza adicional, focalizada, frecuente y en grupo pequeño, con seguimiento de progreso, mientras el segundo apoyo —tiempo, formato, herramienta— que permite demostrar aprendizaje sin alterar el objetivo.
...
- **Evidencia de logro.** Qué muestra un plan de intervención para una dificultad específica, con línea base, intervención y medición de progreso frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
te deja en condiciones de si la dificultad de tu estudiante requiere intervención intensiva, ajuste de acceso o ambos, y esa decisión se sostiene solo si
...
|---|---|---|
| Fuchs, D. & Fuchs, L. (2006). *Introduction to Response to Intervention*. Reading Research Quarterly, 41(1). | expone el enfoque y sus condiciones de aplicación. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
| Snowling, M. & Hulme, C. (2011). *Evidence-Based Interventions for Reading and Language Difficulties*. | revisa qué intervenciones tienen respaldo y con qué magnitud. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
...
**Situación.** Un estudiante autista de 5.º básico tiene plan de apoyo vigente, informes completos y ninguna modificación real en la clase. Pasa la mitad de la jornada en la sala de recursos y su profesora jefe no participó del plan.

**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Dificultad específica** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Dificultad específica de Respuesta a la intervención.** El trabajo aquí es separar lo observado de lo interpretado sobre **Respuesta a la intervención**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Intervención intensiva como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Intervención intensiva**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.

**Paso 4 — Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con Ajuste de acceso a la vista.** Con **Ajuste de acceso** ya delimitado, la pregunta pasa a ser de consecuencia: qué cambia para los estudiantes, para el tiempo de clase y para la carga del equipo. **Evidencia de partida** entrega la lectura observable; el juicio profesional sigue siendo humano y debe quedar firmado por quien lo hace.
...
|---|---|---|---|
| Intervenir sobre **Dificultad específica** | Dificultad persistente en un dominio, desproporcionada respecto del desempeño general y de la enseñanza recibida | Cuando **Evidencia de partida** es observable y accionable dentro del plazo de la decisión. | Sobrerreaccionar a una señal parcial. |
| Intervenir sobre **Respuesta a la intervención** | Enfoque que evalúa la dificultad observando cómo responde el estudiante a enseñanza intensiva de calidad | Cuando la primera explicación no distingue mecanismo ni responsable. | Convertir el concepto en etiqueta y no en intervención. |
| Observar antes de decidir | Reducir la incertidumbre antes de comprometer tiempo y credibilidad | Cuando la decisión es reversible y la evidencia disponible no distingue causas. | Observar indefinidamente y no decidir nunca. |
| Derivar o escalar | Poner la decisión donde están la competencia y la responsabilidad | Cuando hay normativa, resguardo de datos, salud o vulneración de derechos en juego. | Delegar hacia arriba lo que sí correspondía decidir en el aula. |

**Frontera de aplicación.** Los criterios diagnósticos y los puntos de corte varían entre sistemas y manuales, y el desacuerdo profesional es real. Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre dificultades específicas del aprendizaje |
|---|---|
...
Guárdala en `evidence/P08-C104-dificultades-especificas-del-aprendizaje/` con estos archivos:
...
Esta evidencia alimenta el artefacto de la parte: **aula accesible con mapa de barreras observado, rediseño universal y plan de apoyo conectado con la planificación de aula**.
...
Riesgo característico de esta parte: **Reducir la inclusión a la presencia física del estudiante en la sala.** Antes de aplicar
...
- Fuchs, D. & Fuchs, L. (2006). *Introduction to Response to Intervention*. Reading Research Quarterly, 41(1). **Uso en esta clase:** expone el enfoque y sus condiciones de aplicación. Lectura selectiva: índice y capítulos pertinentes; registra edición y páginas consultadas.
- Snowling, M. & Hulme, C. (2011). *Evidence-Based Interventions for Reading and Language Difficulties*. **Uso en esta clase:** revisa qué intervenciones tienen respaldo y con qué magnitud. Lectura selectiva: índice y capítulos pertinentes; registra edición y páginas consultadas.
