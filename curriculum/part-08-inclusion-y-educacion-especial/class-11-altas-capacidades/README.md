...
**Estado de evidencia:** `EN-DEBATE` · **Etapa:** 🟣 Etapa C — Núcleo profesional docente · **Población de referencia:** todos los niveles, con foco en apoyos y accesibilidad<br>
**Decisión que habilita:** determinar qué forma de enriquecimiento o profundización corresponde a tu estudiante y en qué dominio<br>
...
2. Clasificar la situación distinguiendo **Altas capacidades** de **Enriquecimiento**.
3. Decidir con fundamento, usando **Aceleración** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Bajo rendimiento por falta de desafío** a la vista.
...
| **Evidencia de logro** | qué muestra un plan de enriquecimiento para un estudiante concreto, con objetivos, actividades y criterios de evaluación frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
El campo tiene desacuerdos reales sobre definición, identificación e intervención, y los instrumentos usados favorecen sistemáticamente a estudiantes de mayor nivel socioeconómico. Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Altas capacidades"]
    C --> A2["Enriquecimiento"]
    C --> A3["Aceleración"]
    C --> A4["Bajo rendimiento por<br/>falta de desafío"]
    A1 & A2 & A3 & A4 --> D{{"determinar qué forma de<br/>enriquecimiento o<br/>profundización<br/>corresponde a tu<br/>estudiante y en qué…"}}
    D --> E["Evidencia de aprendizaje<br/>un plan de<br/>enriquecimiento para un<br/>estudiante concreto, con<br/>objetivos, actividades y<br/>criterios…"]
...
inocua: produce decisiones que atacan el problema equivocado. **Altas capacidades** no es lo
mismo que **Enriquecimiento** —profundización o ampliación del currículo manteniendo al estudiante en su grupo—, y tratarlos como sinónimos hace
que la intervención se dirija al lugar incorrecto. Del mismo modo, **Aceleración** y
**Bajo rendimiento por falta de desafío** describen aspectos distintos de la misma situación: el primero
avance a contenidos o cursos superiores;, mientras el segundo desconexión y bajo desempeño de un estudiante capaz ante tareas triviales.
...
- **Evidencia de logro.** Qué muestra un plan de enriquecimiento para un estudiante concreto, con objetivos, actividades y criterios de evaluación frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
te deja en condiciones de qué forma de enriquecimiento o profundización corresponde a tu estudiante y en qué dominio, y esa decisión se sostiene solo si
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Altas capacidades** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Altas capacidades de Enriquecimiento.** El trabajo aquí es separar lo observado de lo interpretado sobre **Enriquecimiento**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.
...
|---|---|---|---|
| Intervenir sobre **Altas capacidades** | Desempeño o potencial marcadamente superior en uno o más dominios | Cuando **Evidencia de partida** es observable y accionable dentro del plazo de la decisión. | Sobrerreaccionar a una señal parcial. |
| Intervenir sobre **Enriquecimiento** | Profundización o ampliación del currículo manteniendo al estudiante en su grupo | Cuando la primera explicación no distingue mecanismo ni responsable. | Convertir el concepto en etiqueta y no en intervención. |
| Observar antes de decidir | Reducir la incertidumbre antes de comprometer tiempo y credibilidad | Cuando la decisión es reversible y la evidencia disponible no distingue causas. | Observar indefinidamente y no decidir nunca. |
| Derivar o escalar | Poner la decisión donde están la competencia y la responsabilidad | Cuando hay normativa, resguardo de datos, salud o vulneración de derechos en juego. | Delegar hacia arriba lo que sí correspondía decidir en el aula. |

**Frontera de aplicación.** El campo tiene desacuerdos reales sobre definición, identificación e intervención, y los instrumentos usados favorecen sistemáticamente a estudiantes de mayor nivel socioeconómico. Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre altas capacidades |
|---|---|
...
Guárdala en `evidence/P08-C107-altas-capacidades/` con estos archivos:
