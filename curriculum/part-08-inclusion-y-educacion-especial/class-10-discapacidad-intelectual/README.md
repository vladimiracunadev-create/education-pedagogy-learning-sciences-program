...
**Decisión que habilita:** determinar qué aprendizaje significativo perseguirás y con qué apoyos lo harás alcanzable<br>
...
2. Clasificar la situación distinguiendo **Apoyo graduado** de **Aprendizaje funcional**.
3. Decidir con fundamento, usando **Currículo significativo** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Expectativa profesional** a la vista.
...
| **Evidencia de logro** | qué muestra un plan de enseñanza con objetivos significativos, apoyos graduados y evidencia de progreso real frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
La discapacidad intelectual abarca perfiles muy diversos y necesidades de apoyo de intensidad muy distinta; Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Apoyo graduado"]
    C --> A2["Aprendizaje funcional"]
    C --> A3["Currículo<br/>significativo"]
    C --> A4["Expectativa<br/>profesional"]
    A1 & A2 & A3 & A4 --> D{{"determinar qué<br/>aprendizaje<br/>significativo<br/>perseguirás y con qué<br/>apoyos lo harás<br/>alcanzable"}}
    D --> E["Evidencia de aprendizaje<br/>un plan de enseñanza con<br/>objetivos<br/>significativos, apoyos<br/>graduados y evidencia de<br/>progreso real"]
...
inocua: produce decisiones que atacan el problema equivocado. **Apoyo graduado** no es lo
mismo que **Aprendizaje funcional** —competencia con uso directo en la vida cotidiana y en la autonomía de la persona—, y tratarlos como sinónimos hace
que la intervención se dirija al lugar incorrecto. Del mismo modo, **Currículo significativo** y
**Expectativa profesional** describen aspectos distintos de la misma situación: el primero
contenido académico ajustado en complejidad pero no vaciado de sentido, mientras el segundo nivel de logro que el equipo cree posible;.
...
- **Evidencia de logro.** Qué muestra un plan de enseñanza con objetivos significativos, apoyos graduados y evidencia de progreso real frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
te deja en condiciones de qué aprendizaje significativo perseguirás y con qué apoyos lo harás alcanzable, y esa decisión se sostiene solo si
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Apoyo graduado** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Apoyo graduado de Aprendizaje funcional.** El trabajo aquí es separar lo observado de lo interpretado sobre **Aprendizaje funcional**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Currículo significativo como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Currículo significativo**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.

**Paso 4 — Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con Expectativa profesional a la vista.** Con **Expectativa profesional** ya delimitado, la pregunta pasa a ser de consecuencia: qué cambia para los estudiantes, para el tiempo de clase y para la carga del equipo. **Evidencia de partida** entrega la lectura observable; el juicio profesional sigue siendo humano y debe quedar firmado por quien lo hace.
...
|---|---|---|---|
| Intervenir sobre **Apoyo graduado** | Ayuda ajustada en intensidad y retirada progresivamente según el desempeño observado | Cuando **Evidencia de partida** es observable y accionable dentro del plazo de la decisión. | Sobrerreaccionar a una señal parcial. |
| Intervenir sobre **Aprendizaje funcional** | Competencia con uso directo en la vida cotidiana y en la autonomía de la persona | Cuando la primera explicación no distingue mecanismo ni responsable. | Convertir el concepto en etiqueta y no en intervención. |
| Observar antes de decidir | Reducir la incertidumbre antes de comprometer tiempo y credibilidad | Cuando la decisión es reversible y la evidencia disponible no distingue causas. | Observar indefinidamente y no decidir nunca. |
| Derivar o escalar | Poner la decisión donde están la competencia y la responsabilidad | Cuando hay normativa, resguardo de datos, salud o vulneración de derechos en juego. | Delegar hacia arriba lo que sí correspondía decidir en el aula. |

**Frontera de aplicación.** La discapacidad intelectual abarca perfiles muy diversos y necesidades de apoyo de intensidad muy distinta; Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre discapacidad intelectual |
|---|---|
...
Guárdala en `evidence/P08-C106-discapacidad-intelectual/` con estos archivos:
