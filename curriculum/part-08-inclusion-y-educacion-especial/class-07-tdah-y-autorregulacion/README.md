...
**Decisión que habilita:** determinar qué ajuste de estructura y de tarea reducirá la demanda de autorregulación en tu clase<br>
...
2. Clasificar la situación distinguiendo **Función ejecutiva** de **Estructura externa**.
3. Decidir con fundamento, usando **Segmentación de la tarea** como criterio y declarando la fuente.
...
| **Evidencia de logro** | qué muestra un conjunto de ajustes de aula para un estudiante con TDAH, con su implementación y su medida de efecto frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
Los apoyos escolares mejoran el desempeño y la conducta en el aula, y no eliminan la condición. Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Función ejecutiva"]
    C --> A2["Estructura externa"]
    C --> A3["Segmentación de la<br/>tarea"]
    C --> A4["Retroalimentación<br/>frecuente"]
    A1 & A2 & A3 & A4 --> D{{"determinar qué ajuste de<br/>estructura y de tarea<br/>reducirá la demanda de<br/>autorregulación en tu…"}}
    D --> E["Evidencia de aprendizaje<br/>un conjunto de ajustes<br/>de aula para un<br/>estudiante con TDAH, con<br/>su implementación y su<br/>medida…"]
...
inocua: produce decisiones que atacan el problema equivocado. **Función ejecutiva** no es lo
...
- **Evidencia de logro.** Qué muestra un conjunto de ajustes de aula para un estudiante con TDAH, con su implementación y su medida de efecto frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
te deja en condiciones de qué ajuste de estructura y de tarea reducirá la demanda de autorregulación en tu clase, y esa decisión se sostiene solo si
...
|---|---|---|
| Barkley, R. (2015). *Attention-Deficit Hyperactivity Disorder: A Handbook for Diagnosis and Treatment*. | referencia sobre el modelo de funciones ejecutivas y sus implicancias educativas. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
| DuPaul, G. & Stoner, G. (2014). *ADHD in the Schools*. | intervenciones escolares con evidencia, descritas de forma directamente aplicable. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Función ejecutiva** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Función ejecutiva de Estructura externa.** El trabajo aquí es separar lo observado de lo interpretado sobre **Estructura externa**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Segmentación de la tarea como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Segmentación de la tarea**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.
...
|---|---|---|---|
| Intervenir sobre **Función ejecutiva** | Conjunto de procesos de planificación, inhibición y memoria de trabajo implicados en la conducta dirigida a metas | Cuando **Evidencia de partida** es observable y accionable dentro del plazo de la decisión. | Sobrerreaccionar a una señal parcial. |
| Intervenir sobre **Estructura externa** | Apoyos del entorno que sustituyen temporalmente la regulación que el estudiante no puede sostener | Cuando la primera explicación no distingue mecanismo ni responsable. | Convertir el concepto en etiqueta y no en intervención. |
| Observar antes de decidir | Reducir la incertidumbre antes de comprometer tiempo y credibilidad | Cuando la decisión es reversible y la evidencia disponible no distingue causas. | Observar indefinidamente y no decidir nunca. |
| Derivar o escalar | Poner la decisión donde están la competencia y la responsabilidad | Cuando hay normativa, resguardo de datos, salud o vulneración de derechos en juego. | Delegar hacia arriba lo que sí correspondía decidir en el aula. |

**Frontera de aplicación.** Los apoyos escolares mejoran el desempeño y la conducta en el aula, y no eliminan la condición. Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre tDAH y autorregulación |
|---|---|
...
Guárdala en `evidence/P08-C103-tdah-y-autorregulacion/` con estos archivos:
