...
**Decisión que habilita:** determinar qué se puede concluir de un informe técnico de una evaluación estandarizada y qué no<br>
...
2. Clasificar la situación distinguiendo **Teoría clásica** de **Teoría de respuesta al ítem**.
3. Decidir con fundamento, usando **Invarianza** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Equating** a la vista.
...
| **Evidencia de logro** | qué muestra la lectura crítica de un informe técnico real con las conclusiones que sostiene y las que lo exceden frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
Los modelos tienen supuestos fuertes —unidimensionalidad, independencia local— que rara vez se cumplen del todo, y su violación afecta las conclusiones. Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Teoría clásica"]
    C --> A2["Teoría de respuesta al<br/>ítem"]
    C --> A3["Invarianza"]
    C --> A4["Equating"]
    A1 & A2 & A3 & A4 --> D{{"determinar qué se puede<br/>concluir de un informe<br/>técnico de una<br/>evaluación estandarizada<br/>y qué no"}}
    D --> E["Evidencia de aprendizaje<br/>la lectura crítica de un<br/>informe técnico real con<br/>las conclusiones que<br/>sostiene y las que lo…"]
...
inocua: produce decisiones que atacan el problema equivocado. **Teoría clásica** no es lo
mismo que **Teoría de respuesta al ítem** —modelo que estima habilidad de la persona y parámetros del ítem en una misma escala—, y tratarlos como sinónimos hace
que la intervención se dirija al lugar incorrecto. Del mismo modo, **Invarianza** y
**Equating** describen aspectos distintos de la misma situación: el primero
propiedad por la cual los parámetros no dependen de la muestra particular usada, mientras el segundo procedimiento que hace comparables puntajes de formas distintas de una prueba.
...
- **Evidencia de logro.** Qué muestra la lectura crítica de un informe técnico real con las conclusiones que sostiene y las que lo exceden frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
te deja en condiciones de qué se puede concluir de un informe técnico de una evaluación estandarizada y qué no, y esa decisión se sostiene solo si
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Teoría clásica** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Teoría clásica de Teoría de respuesta al ítem.** El trabajo aquí es separar lo observado de lo interpretado sobre **Teoría de respuesta al ítem**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Invarianza como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Invarianza**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.

**Paso 4 — Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con Equating a la vista.** Con **Equating** ya delimitado, la pregunta pasa a ser de consecuencia: qué cambia para los estudiantes, para el tiempo de clase y para la carga del equipo. **Evidencia de partida** entrega la lectura observable; el juicio profesional sigue siendo humano y debe quedar firmado por quien lo hace.
...
|---|---|---|---|
| Intervenir sobre **Teoría clásica** | Modelo en que el puntaje observado es la suma de puntaje verdadero y error; sus índices dependen de la muestra | Cuando **Evidencia de partida** es observable y accionable dentro del plazo de la decisión. | Sobrerreaccionar a una señal parcial. |
| Intervenir sobre **Teoría de respuesta al ítem** | Modelo que estima habilidad de la persona y parámetros del ítem en una misma escala | Cuando la primera explicación no distingue mecanismo ni responsable. | Convertir el concepto en etiqueta y no en intervención. |
| Observar antes de decidir | Reducir la incertidumbre antes de comprometer tiempo y credibilidad | Cuando la decisión es reversible y la evidencia disponible no distingue causas. | Observar indefinidamente y no decidir nunca. |
| Derivar o escalar | Poner la decisión donde están la competencia y la responsabilidad | Cuando hay normativa, resguardo de datos, salud o vulneración de derechos en juego. | Delegar hacia arriba lo que sí correspondía decidir en el aula. |

**Frontera de aplicación.** Los modelos tienen supuestos fuertes —unidimensionalidad, independencia local— que rara vez se cumplen del todo, y su violación afecta las conclusiones. Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre introducción a teoría clásica e IRT |
|---|---|
...
Guárdala en `evidence/P11-C143-introduccion-a-teoria-clasica-e-irt/` con estos archivos:
