...
**Estado de evidencia:** `ROBUSTA` · **Etapa:** 🟣 Etapa C — Núcleo profesional docente · **Población de referencia:** transversal, con foco en instrumentos y decisiones<br>
**Decisión que habilita:** determinar qué afirmación puedes sostener con los resultados de tu evaluación y cuál no<br>
...
2. Clasificar la situación distinguiendo **Validez** de **Constructo**.
3. Decidir con fundamento, usando **Subrepresentación** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Consecuencia del uso** a la vista.
...
| **Evidencia de logro** | qué muestra un argumento de validez de una evaluación con sus fuentes de evidencia y sus limitaciones declaradas frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
La validación es un proceso continuo y nunca concluye: Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Validez"]
    C --> A2["Constructo"]
    C --> A3["Subrepresentación"]
    C --> A4["Consecuencia del uso"]
    A1 & A2 & A3 & A4 --> D{{"determinar qué<br/>afirmación puedes<br/>sostener con los<br/>resultados de tu<br/>evaluación y cuál no"}}
    D --> E["Evidencia de aprendizaje<br/>un argumento de validez<br/>de una evaluación con<br/>sus fuentes de evidencia<br/>y sus limitaciones…"]
...
inocua: produce decisiones que atacan el problema equivocado. **Validez** no es lo
mismo que **Constructo** —aquello que se pretende medir; casi nunca es directamente observable—, y tratarlos como sinónimos hace
que la intervención se dirija al lugar incorrecto. Del mismo modo, **Subrepresentación** y
**Consecuencia del uso** describen aspectos distintos de la misma situación: el primero
situación en que la evaluación cubre solo parte del constructo declarado, mientras el segundo efectos del uso de los resultados, que forman parte del juicio de validez.
...
- **Evidencia de logro.** Qué muestra un argumento de validez de una evaluación con sus fuentes de evidencia y sus limitaciones declaradas frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
te deja en condiciones de qué afirmación puedes sostener con los resultados de tu evaluación y cuál no, y esa decisión se sostiene solo si
...
|---|---|---|
| Messick, S. (1989). *Validity*. | el capítulo que integra interpretación, uso y consecuencias en un solo concepto de validez. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
| Kane, M. (2013). *Validating the Interpretations and Uses of Test Scores*. Journal of Educational Measurement, 50(1). | desarrolla el enfoque de argumento de validez, directamente aplicable a evaluaciones propias. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Validez** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Validez de Constructo.** El trabajo aquí es separar lo observado de lo interpretado sobre **Constructo**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Subrepresentación como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Subrepresentación**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.

**Paso 4 — Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con Consecuencia del uso a la vista.** Con **Consecuencia del uso** ya delimitado, la pregunta pasa a ser de consecuencia: qué cambia para los estudiantes, para el tiempo de clase y para la carga del equipo. **Evidencia de partida** entrega la lectura observable; el juicio profesional sigue siendo humano y debe quedar firmado por quien lo hace.
...
|---|---|---|---|
| Intervenir sobre **Validez** | Grado en que la evidencia respalda la interpretación y el uso propuestos de los puntajes | Cuando **Evidencia de partida** es observable y accionable dentro del plazo de la decisión. | Sobrerreaccionar a una señal parcial. |
| Intervenir sobre **Constructo** | Aquello que se pretende medir; casi nunca es directamente observable | Cuando la primera explicación no distingue mecanismo ni responsable. | Convertir el concepto en etiqueta y no en intervención. |
| Observar antes de decidir | Reducir la incertidumbre antes de comprometer tiempo y credibilidad | Cuando la decisión es reversible y la evidencia disponible no distingue causas. | Observar indefinidamente y no decidir nunca. |
| Derivar o escalar | Poner la decisión donde están la competencia y la responsabilidad | Cuando hay normativa, resguardo de datos, salud o vulneración de derechos en juego. | Delegar hacia arriba lo que sí correspondía decidir en el aula. |

**Frontera de aplicación.** La validación es un proceso continuo y nunca concluye: Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre validez |
|---|---|
...
Guárdala en `evidence/P11-C140-validez/` con estos archivos:
