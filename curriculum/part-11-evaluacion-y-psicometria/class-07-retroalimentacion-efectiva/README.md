...
**Decisión que habilita:** determinar cuándo y cómo entregarás la retroalimentación para que el estudiante pueda usarla<br>
...
2. Clasificar la situación distinguiendo **Retroalimentación sobre la tarea** de **Oportunidad de uso**.
3. Decidir con fundamento, usando **Efecto de la calificación** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Retroalimentación accionable** a la vista.
...
| **Evidencia de logro** | qué muestra un rediseño del sistema de retroalimentación de una asignatura con evidencia de su uso por los estudiantes frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
La retroalimentación abundante no es mejor: Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Retroalimentación<br/>sobre la tarea"]
    C --> A2["Oportunidad de uso"]
    C --> A3["Efecto de la<br/>calificación"]
    C --> A4["Retroalimentación<br/>accionable"]
    A1 & A2 & A3 & A4 --> D{{"determinar cuándo y cómo<br/>entregarás la<br/>retroalimentación para<br/>que el estudiante pueda<br/>usarla"}}
    D --> E["Evidencia de aprendizaje<br/>un rediseño del sistema<br/>de retroalimentación de<br/>una asignatura con<br/>evidencia de su uso por<br/>los…"]
...
- **Evidencia de logro.** Qué muestra un rediseño del sistema de retroalimentación de una asignatura con evidencia de su uso por los estudiantes frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
te deja en condiciones de cuándo y cómo entregarás la retroalimentación para que el estudiante pueda usarla, y esa decisión se sostiene solo si
...
|---|---|---|
| Hattie, J. & Timperley, H. (2007). *The Power of Feedback*. | modelo por niveles de retroalimentación y evidencia sobre cuáles funcionan. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
| Kluger, A. & DeNisi, A. (1996). *The Effects of Feedback Interventions on Performance*. | documenta que una proporción relevante de intervenciones de retroalimentación empeora el desempeño. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Retroalimentación sobre la tarea** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Retroalimentación sobre la tarea de Oportunidad de uso.** El trabajo aquí es separar lo observado de lo interpretado sobre **Oportunidad de uso**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Efecto de la calificación como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Efecto de la calificación**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.

**Paso 4 — Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con Retroalimentación accionable a la vista.** Con **Retroalimentación accionable** ya delimitado, la pregunta pasa a ser de consecuencia: qué cambia para los estudiantes, para el tiempo de clase y para la carga del equipo. **Evidencia de partida** entrega la lectura observable; el juicio profesional sigue siendo humano y debe quedar firmado por quien lo hace.
...
**Frontera de aplicación.** La retroalimentación abundante no es mejor: Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre retroalimentación efectiva |
|---|---|
...
Guárdala en `evidence/P11-C139-retroalimentacion-efectiva/` con estos archivos:
