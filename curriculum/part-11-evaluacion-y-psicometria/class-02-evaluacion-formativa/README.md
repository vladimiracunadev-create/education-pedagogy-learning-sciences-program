...
**Decisión que habilita:** determinar qué evidencia recogerás y qué decisión de enseñanza modificará<br>
...
2. Clasificar la situación distinguiendo **Evaluación formativa** de **Baja consecuencia**.
3. Decidir con fundamento, usando **Retroalimentación accionable** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Decisión instruccional** a la vista.
...
| **Evidencia de logro** | qué muestra un sistema formativo de asignatura con instrumentos, periodicidad y las decisiones que cada resultado activa frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
Los efectos reportados para la evaluación formativa varían mucho y algunas cifras muy citadas provienen de síntesis con problemas metodológicos. Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Evaluación formativa"]
    C --> A2["Baja consecuencia"]
    C --> A3["Retroalimentación<br/>accionable"]
    C --> A4["Decisión instruccional"]
    A1 & A2 & A3 & A4 --> D{{"determinar qué evidencia<br/>recogerás y qué decisión<br/>de enseñanza modificará"}}
    D --> E["Evidencia de aprendizaje<br/>un sistema formativo de<br/>asignatura con<br/>instrumentos,<br/>periodicidad y las<br/>decisiones que cada…"]
...
inocua: produce decisiones que atacan el problema equivocado. **Evaluación formativa** no es lo
...
- **Evidencia de logro.** Qué muestra un sistema formativo de asignatura con instrumentos, periodicidad y las decisiones que cada resultado activa frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
te deja en condiciones de qué evidencia recogerás y qué decisión de enseñanza modificará, y esa decisión se sostiene solo si
...
|---|---|---|
| Black, P. & Wiliam, D. (1998). *Assessment and Classroom Learning*. | la revisión que instaló el concepto con evidencia; conviene leer también sus críticas metodológicas. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
| Wiliam, D. (2011). *Embedded Formative Assessment*. | define la evaluación formativa por su uso y aporta técnicas concretas de aula. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Evaluación formativa** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Evaluación formativa de Baja consecuencia.** El trabajo aquí es separar lo observado de lo interpretado sobre **Baja consecuencia**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Retroalimentación accionable como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Retroalimentación accionable**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.

**Paso 4 — Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con Decisión instruccional a la vista.** Con **Decisión instruccional** ya delimitado, la pregunta pasa a ser de consecuencia: qué cambia para los estudiantes, para el tiempo de clase y para la carga del equipo. **Evidencia de partida** entrega la lectura observable; el juicio profesional sigue siendo humano y debe quedar firmado por quien lo hace.
...
|---|---|---|---|
| Intervenir sobre **Evaluación formativa** | Proceso en que la evidencia recogida se usa para adaptar la enseñanza o el aprendizaje | Cuando **Evidencia de partida** es observable y accionable dentro del plazo de la decisión. | Sobrerreaccionar a una señal parcial. |
| Intervenir sobre **Baja consecuencia** | Condición de que el instrumento no afecte la calificación, para que revele el estado real | Cuando la primera explicación no distingue mecanismo ni responsable. | Convertir el concepto en etiqueta y no en intervención. |
| Observar antes de decidir | Reducir la incertidumbre antes de comprometer tiempo y credibilidad | Cuando la decisión es reversible y la evidencia disponible no distingue causas. | Observar indefinidamente y no decidir nunca. |
| Derivar o escalar | Poner la decisión donde están la competencia y la responsabilidad | Cuando hay normativa, resguardo de datos, salud o vulneración de derechos en juego. | Delegar hacia arriba lo que sí correspondía decidir en el aula. |

**Frontera de aplicación.** Los efectos reportados para la evaluación formativa varían mucho y algunas cifras muy citadas provienen de síntesis con problemas metodológicos. Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre evaluación formativa |
|---|---|
...
Guárdala en `evidence/P11-C134-evaluacion-formativa/` con estos archivos:
