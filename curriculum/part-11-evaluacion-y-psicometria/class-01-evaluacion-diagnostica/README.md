...
**Decisión que habilita:** determinar qué prerrequisitos vas a medir y qué harás con cada resultado posible<br>
...
2. Clasificar la situación distinguiendo **Evaluación diagnóstica** de **Prerrequisito crítico**.
3. Decidir con fundamento, usando **Patrón de resultado** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Decisión asociada** a la vista.
...
| **Evidencia de logro** | qué muestra un instrumento diagnóstico breve con la decisión de enseñanza asociada a cada patrón de resultado frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
El diagnóstico mide un momento y con pocos ítems, de modo que su precisión individual es limitada: Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Evaluación diagnóstica"]
    C --> A2["Prerrequisito crítico"]
    C --> A3["Patrón de resultado"]
    C --> A4["Decisión asociada"]
    A1 & A2 & A3 & A4 --> D{{"determinar qué<br/>prerrequisitos vas a<br/>medir y qué harás con<br/>cada resultado posible"}}
    D --> E["Evidencia de aprendizaje<br/>un instrumento<br/>diagnóstico breve con la<br/>decisión de enseñanza<br/>asociada a cada patrón<br/>de…"]
...
- **Evidencia de logro.** Qué muestra un instrumento diagnóstico breve con la decisión de enseñanza asociada a cada patrón de resultado frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
te deja en condiciones de qué prerrequisitos vas a medir y qué harás con cada resultado posible, y esa decisión se sostiene solo si
...
|---|---|---|
| Ausubel, D. (1968). *Educational Psychology: A Cognitive View*. | fundamenta por qué el conocimiento previo es el factor que más condiciona el aprendizaje nuevo. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
| Wiliam, D. (2011). *Embedded Formative Assessment*. | aporta técnicas breves de recogida de evidencia aplicables al diagnóstico inicial. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Evaluación diagnóstica** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Evaluación diagnóstica de Prerrequisito crítico.** El trabajo aquí es separar lo observado de lo interpretado sobre **Prerrequisito crítico**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Patrón de resultado como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Patrón de resultado**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.

**Paso 4 — Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con Decisión asociada a la vista.** Con **Decisión asociada** ya delimitado, la pregunta pasa a ser de consecuencia: qué cambia para los estudiantes, para el tiempo de clase y para la carga del equipo. **Evidencia de partida** entrega la lectura observable; el juicio profesional sigue siendo humano y debe quedar firmado por quien lo hace.
...
**Frontera de aplicación.** El diagnóstico mide un momento y con pocos ítems, de modo que su precisión individual es limitada: Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre evaluación diagnóstica |
|---|---|
...
Guárdala en `evidence/P11-C133-evaluacion-diagnostica/` con estos archivos:
