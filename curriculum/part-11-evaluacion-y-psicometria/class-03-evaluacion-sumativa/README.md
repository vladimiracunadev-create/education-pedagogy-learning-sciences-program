...
**Estado de evidencia:** `CONSISTENTE` · **Etapa:** 🟣 Etapa C — Núcleo profesional docente · **Población de referencia:** transversal, con foco en instrumentos y decisiones<br>
**Decisión que habilita:** determinar qué evidencia sumativa justifica la decisión que vas a tomar sobre cada estudiante<br>
...
2. Clasificar la situación distinguiendo **Evaluación sumativa** de **Tabla de especificaciones**.
3. Decidir con fundamento, usando **Ponderación** como criterio y declarando la fuente.
...
| **Evidencia de logro** | qué muestra un plan de evaluación sumativa con tabla de especificaciones, ponderaciones justificadas y política de recuperación frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
Ninguna evaluación sumativa mide todo lo aprendido: Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Evaluación sumativa"]
    C --> A2["Tabla de<br/>especificaciones"]
    C --> A3["Ponderación"]
    C --> A4["Proporcionalidad"]
    A1 & A2 & A3 & A4 --> D{{"determinar qué evidencia<br/>sumativa justifica la<br/>decisión que vas a tomar<br/>sobre cada estudiante"}}
    D --> E["Evidencia de aprendizaje<br/>un plan de evaluación<br/>sumativa con tabla de<br/>especificaciones,<br/>ponderaciones<br/>justificadas y…"]
...
inocua: produce decisiones que atacan el problema equivocado. **Evaluación sumativa** no es lo
mismo que **Tabla de especificaciones** —matriz que asegura que la evaluación representa el contenido y los niveles enseñados—, y tratarlos como sinónimos hace
que la intervención se dirija al lugar incorrecto. Del mismo modo, **Ponderación** y
**Proporcionalidad** describen aspectos distintos de la misma situación: el primero
peso relativo de cada evaluación en la calificación final y su justificación, mientras el segundo correspondencia entre la consecuencia de la decisión y la calidad de la evidencia disponible.
...
- **Evidencia de logro.** Qué muestra un plan de evaluación sumativa con tabla de especificaciones, ponderaciones justificadas y política de recuperación frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
te deja en condiciones de qué evidencia sumativa justifica la decisión que vas a tomar sobre cada estudiante, y esa decisión se sostiene solo si
...
|---|---|---|
| AERA, APA & NCME (2014). *Standards for Educational and Psychological Testing*. | fija el estándar técnico según la consecuencia de la decisión. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
| Brookhart, S. (2013). *Grading and Group Work*. | analiza problemas frecuentes de calificación y sus soluciones técnicas. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
...
**Situación.** El establecimiento decide repitencias con el promedio final y una prueba de síntesis de 40 preguntas. Dos docentes de la misma asignatura califican el mismo trabajo con dos puntos de diferencia y nadie lo considera un problema técnico.

**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Evaluación sumativa** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Evaluación sumativa de Tabla de especificaciones.** El trabajo aquí es separar lo observado de lo interpretado sobre **Tabla de especificaciones**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Ponderación como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Ponderación**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.
...
|---|---|---|---|
| Intervenir sobre **Evaluación sumativa** | Valoración del logro al final de un período, con consecuencias para el estudiante | Cuando **Evidencia de partida** es observable y accionable dentro del plazo de la decisión. | Sobrerreaccionar a una señal parcial. |
| Intervenir sobre **Tabla de especificaciones** | Matriz que asegura que la evaluación representa el contenido y los niveles enseñados | Cuando la primera explicación no distingue mecanismo ni responsable. | Convertir el concepto en etiqueta y no en intervención. |
| Observar antes de decidir | Reducir la incertidumbre antes de comprometer tiempo y credibilidad | Cuando la decisión es reversible y la evidencia disponible no distingue causas. | Observar indefinidamente y no decidir nunca. |
| Derivar o escalar | Poner la decisión donde están la competencia y la responsabilidad | Cuando hay normativa, resguardo de datos, salud o vulneración de derechos en juego. | Delegar hacia arriba lo que sí correspondía decidir en el aula. |

**Frontera de aplicación.** Ninguna evaluación sumativa mide todo lo aprendido: Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre evaluación sumativa |
|---|---|
...
Guárdala en `evidence/P11-C135-evaluacion-sumativa/` con estos archivos:
...
Esta evidencia alimenta el artefacto de la parte: **sistema de evaluación de asignatura con argumento de validez, análisis de ítems y rúbricas calibradas entre evaluadores**.
...
Riesgo característico de esta parte: **Atribuir validez al instrumento en vez de a la interpretación y al uso.** Antes de aplicar
...
- AERA, APA & NCME (2014). *Standards for Educational and Psychological Testing*. **Uso en esta clase:** fija el estándar técnico según la consecuencia de la decisión. Lectura selectiva: índice y capítulos pertinentes; registra edición y páginas consultadas.
- Brookhart, S. (2013). *Grading and Group Work*. **Uso en esta clase:** analiza problemas frecuentes de calificación y sus soluciones técnicas. Lectura selectiva: índice y capítulos pertinentes; registra edición y páginas consultadas.
