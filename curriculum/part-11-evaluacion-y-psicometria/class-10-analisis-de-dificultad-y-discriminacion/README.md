...
**Decisión que habilita:** determinar qué ítems de tu prueba deben corregirse o eliminarse y por qué<br>
...
2. Clasificar la situación distinguiendo **Índice de dificultad** de **Índice de discriminación**.
3. Decidir con fundamento, usando **Análisis de distractores** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Ítem defectuoso** a la vista.
...
| **Evidencia de logro** | qué muestra el análisis de ítems de una prueba real con decisiones de corrección fundamentadas en los datos frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
Con grupos pequeños los índices son inestables y deben interpretarse con cautela: Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Índice de dificultad"]
    C --> A2["Índice de<br/>discriminación"]
    C --> A3["Análisis de<br/>distractores"]
    C --> A4["Ítem defectuoso"]
    A1 & A2 & A3 & A4 --> D{{"determinar qué ítems de<br/>tu prueba deben<br/>corregirse o eliminarse<br/>y por qué"}}
    D --> E["Evidencia de aprendizaje<br/>el análisis de ítems de<br/>una prueba real con<br/>decisiones de corrección<br/>fundamentadas en los<br/>datos"]
...
inocua: produce decisiones que atacan el problema equivocado. **Índice de dificultad** no es lo
mismo que **Índice de discriminación** —capacidad del ítem de diferenciar entre quienes dominan y quienes no el contenido—, y tratarlos como sinónimos hace
que la intervención se dirija al lugar incorrecto. Del mismo modo, **Análisis de distractores** y
**Ítem defectuoso** describen aspectos distintos de la misma situación: el primero
revisión de qué alternativas incorrectas fueron elegidas y por quiénes, mientras el segundo pregunta con discriminación nula o negativa, que introduce ruido en el puntaje.
...
- **Evidencia de logro.** Qué muestra el análisis de ítems de una prueba real con decisiones de corrección fundamentadas en los datos frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
te deja en condiciones de qué ítems de tu prueba deben corregirse o eliminarse y por qué, y esa decisión se sostiene solo si
...
|---|---|---|
| Crocker, L. & Algina (1986). *Introduction to Classical and Modern Test Theory*. | tratamiento estándar del análisis de ítems en teoría clásica. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
| Haladyna, T. (2004). *Developing and Validating Multiple-Choice Test Items*. | conecta construcción y análisis de ítems con criterios prácticos. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Índice de dificultad** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Índice de dificultad de Índice de discriminación.** El trabajo aquí es separar lo observado de lo interpretado sobre **Índice de discriminación**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Análisis de distractores como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Análisis de distractores**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.

**Paso 4 — Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con Ítem defectuoso a la vista.** Con **Ítem defectuoso** ya delimitado, la pregunta pasa a ser de consecuencia: qué cambia para los estudiantes, para el tiempo de clase y para la carga del equipo. **Evidencia de partida** entrega la lectura observable; el juicio profesional sigue siendo humano y debe quedar firmado por quien lo hace.
...
**Frontera de aplicación.** Con grupos pequeños los índices son inestables y deben interpretarse con cautela: Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre análisis de dificultad y discriminación |
|---|---|
...
Guárdala en `evidence/P11-C142-analisis-de-dificultad-y-discriminacion/` con estos archivos:
