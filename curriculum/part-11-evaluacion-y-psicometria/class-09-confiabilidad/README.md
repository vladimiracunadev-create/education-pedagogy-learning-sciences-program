...
**Decisión que habilita:** determinar si la diferencia de puntaje que estás interpretando supera el error de medida<br>
...
2. Clasificar la situación distinguiendo **Confiabilidad** de **Error estándar de medida**.
3. Decidir con fundamento, usando **Consistencia interna** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Acuerdo entre correctores** a la vista.
...
| **Evidencia de logro** | qué muestra un análisis de confiabilidad de una evaluación propia con la interpretación correcta de sus diferencias frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
Los coeficientes de consistencia interna se usan mal con frecuencia: Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Confiabilidad"]
    C --> A2["Error estándar de<br/>medida"]
    C --> A3["Consistencia interna"]
    C --> A4["Acuerdo entre<br/>correctores"]
    A1 & A2 & A3 & A4 --> D{{"determinar si la<br/>diferencia de puntaje<br/>que estás interpretando<br/>supera el error de<br/>medida"}}
    D --> E["Evidencia de aprendizaje<br/>un análisis de<br/>confiabilidad de una<br/>evaluación propia con la<br/>interpretación correcta<br/>de sus…"]
...
- **Evidencia de logro.** Qué muestra un análisis de confiabilidad de una evaluación propia con la interpretación correcta de sus diferencias frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
te deja en condiciones de si la diferencia de puntaje que estás interpretando supera el error de medida, y esa decisión se sostiene solo si
...
|---|---|---|
| AERA, APA & NCME (2014). *Standards for Educational and Psychological Testing*. | define confiabilidad y error de medida y su relación con el uso de los puntajes. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
| McNeish, D. (2018). *Thanks Coefficient Alpha, We'll Take It From Here*. Psychological Methods, 23(3). | expone los problemas del alfa y las alternativas disponibles. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Confiabilidad** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Confiabilidad de Error estándar de medida.** El trabajo aquí es separar lo observado de lo interpretado sobre **Error estándar de medida**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Consistencia interna como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Consistencia interna**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.

**Paso 4 — Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con Acuerdo entre correctores a la vista.** Con **Acuerdo entre correctores** ya delimitado, la pregunta pasa a ser de consecuencia: qué cambia para los estudiantes, para el tiempo de clase y para la carga del equipo. **Evidencia de partida** entrega la lectura observable; el juicio profesional sigue siendo humano y debe quedar firmado por quien lo hace.
...
**Frontera de aplicación.** Los coeficientes de consistencia interna se usan mal con frecuencia: Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre confiabilidad |
|---|---|
...
Guárdala en `evidence/P11-C141-confiabilidad/` con estos archivos:
