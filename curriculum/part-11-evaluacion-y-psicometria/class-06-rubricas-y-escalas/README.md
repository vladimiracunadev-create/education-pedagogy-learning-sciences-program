...
**Decisión que habilita:** determinar el tipo de rúbrica y los descriptores que sostendrán la consistencia de tu evaluación<br>
...
2. Clasificar la situación distinguiendo **Rúbrica analítica** de **Rúbrica holística**.
3. Decidir con fundamento, usando **Descriptor** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Calibración** a la vista.
...
| **Evidencia de logro** | qué muestra una rúbrica calibrada con evidencia de acuerdo entre evaluadores y su análisis de desacuerdos frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
Una rúbrica muy detallada puede convertir un desempeño complejo en una lista de verificación y premiar el cumplimiento formal sobre la calidad global. Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Rúbrica analítica"]
    C --> A2["Rúbrica holística"]
    C --> A3["Descriptor"]
    C --> A4["Calibración"]
    A1 & A2 & A3 & A4 --> D{{"determinar el tipo de<br/>rúbrica y los<br/>descriptores que<br/>sostendrán la<br/>consistencia de tu<br/>evaluación"}}
    D --> E["Evidencia de aprendizaje<br/>una rúbrica calibrada<br/>con evidencia de acuerdo<br/>entre evaluadores y su<br/>análisis de desacuerdos"]
...
inocua: produce decisiones que atacan el problema equivocado. **Rúbrica analítica** no es lo
mismo que **Rúbrica holística** —juicio global por niveles; más rápida y menos informativa para el estudiante—, y tratarlos como sinónimos hace
que la intervención se dirija al lugar incorrecto. Del mismo modo, **Descriptor** y
**Calibración** describen aspectos distintos de la misma situación: el primero
descripción del desempeño en un nivel;, mientras el segundo proceso de acuerdo entre evaluadores sobre la aplicación de los descriptores.
...
- **Evidencia de logro.** Qué muestra una rúbrica calibrada con evidencia de acuerdo entre evaluadores y su análisis de desacuerdos frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
te deja en condiciones de el tipo de rúbrica y los descriptores que sostendrán la consistencia de tu evaluación, y esa decisión se sostiene solo si
...
|---|---|---|
| Jonsson, A. & Svingby, G. (2007). *The Use of Scoring Rubrics*. | evidencia sobre consistencia, validez y consecuencias del uso de rúbricas. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
| Brookhart, S. (2013). *How to Create and Use Rubrics*. | guía práctica de construcción con ejemplos de descriptores observables. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Rúbrica analítica** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Rúbrica analítica de Rúbrica holística.** El trabajo aquí es separar lo observado de lo interpretado sobre **Rúbrica holística**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Descriptor como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Descriptor**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.

**Paso 4 — Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con Calibración a la vista.** Con **Calibración** ya delimitado, la pregunta pasa a ser de consecuencia: qué cambia para los estudiantes, para el tiempo de clase y para la carga del equipo. **Evidencia de partida** entrega la lectura observable; el juicio profesional sigue siendo humano y debe quedar firmado por quien lo hace.
...
**Frontera de aplicación.** Una rúbrica muy detallada puede convertir un desempeño complejo en una lista de verificación y premiar el cumplimiento formal sobre la calidad global. Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre rúbricas y escalas |
|---|---|
...
Guárdala en `evidence/P11-C138-rubricas-y-escalas/` con estos archivos:
...
- Jonsson, A. & Svingby, G. (2007). *The Use of Scoring Rubrics*. **Uso en esta clase:** evidencia sobre consistencia, validez y consecuencias del uso de rúbricas. Lectura selectiva: índice y capítulos pertinentes; registra edición y páginas consultadas.
- Brookhart, S. (2013). *How to Create and Use Rubrics*. **Uso en esta clase:** guía práctica de construcción con ejemplos de descriptores observables. Lectura selectiva: índice y capítulos pertinentes; registra edición y páginas consultadas.
