...
**Decisión que habilita:** determinar qué amenaza a la validez introduce tu tarea auténtica y cómo la controlarás<br>
...
2. Clasificar la situación distinguiendo **Tarea de desempeño** de **Amenaza a la validez**.
3. Decidir con fundamento, usando **Varianza irrelevante** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Control** a la vista.
...
| **Evidencia de logro** | qué muestra una tarea de desempeño auténtico con análisis de amenazas a la validez y sus controles frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
Cada control tiene costo: Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Tarea de desempeño"]
    C --> A2["Amenaza a la validez"]
    C --> A3["Varianza irrelevante"]
    C --> A4["Control"]
    A1 & A2 & A3 & A4 --> D{{"determinar qué amenaza a<br/>la validez introduce tu<br/>tarea auténtica y cómo<br/>la controlarás"}}
    D --> E["Evidencia de aprendizaje<br/>una tarea de desempeño<br/>auténtico con análisis<br/>de amenazas a la validez<br/>y sus controles"]
...
inocua: produce decisiones que atacan el problema equivocado. **Tarea de desempeño** no es lo
mismo que **Amenaza a la validez** —factor que hace que la tarea mida algo distinto de lo que se pretende—, y tratarlos como sinónimos hace
que la intervención se dirija al lugar incorrecto. Del mismo modo, **Varianza irrelevante** y
**Control** describen aspectos distintos de la misma situación: el primero
diferencias en el resultado producidas por factores ajenos al aprendizaje evaluado, mientras el segundo medida que reduce el efecto de una amenaza sin destruir la autenticidad de la tarea.
...
- **Evidencia de logro.** Qué muestra una tarea de desempeño auténtico con análisis de amenazas a la validez y sus controles frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
te deja en condiciones de qué amenaza a la validez introduce tu tarea auténtica y cómo la controlarás, y esa decisión se sostiene solo si
...
|---|---|---|
| Messick, S. (1994). *The Interplay of Evidence and Consequences in the Validation of Performance Assessments*. | analiza validez y varianza irrelevante en evaluación de desempeño. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
| Wiggins, G. (1998). *Educative Assessment*. | criterios de diseño de tareas auténticas defendibles. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Tarea de desempeño** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Tarea de desempeño de Amenaza a la validez.** El trabajo aquí es separar lo observado de lo interpretado sobre **Amenaza a la validez**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Varianza irrelevante como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Varianza irrelevante**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.

**Paso 4 — Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con Control a la vista.** Con **Control** ya delimitado, la pregunta pasa a ser de consecuencia: qué cambia para los estudiantes, para el tiempo de clase y para la carga del equipo. **Evidencia de partida** entrega la lectura observable; el juicio profesional sigue siendo humano y debe quedar firmado por quien lo hace.
...
|---|---|---|---|
| Intervenir sobre **Tarea de desempeño** | Actividad compleja que exige integrar conocimientos en un producto o ejecución | Cuando **Evidencia de partida** es observable y accionable dentro del plazo de la decisión. | Sobrerreaccionar a una señal parcial. |
| Intervenir sobre **Amenaza a la validez** | Factor que hace que la tarea mida algo distinto de lo que se pretende | Cuando la primera explicación no distingue mecanismo ni responsable. | Convertir el concepto en etiqueta y no en intervención. |
| Observar antes de decidir | Reducir la incertidumbre antes de comprometer tiempo y credibilidad | Cuando la decisión es reversible y la evidencia disponible no distingue causas. | Observar indefinidamente y no decidir nunca. |
| Derivar o escalar | Poner la decisión donde están la competencia y la responsabilidad | Cuando hay normativa, resguardo de datos, salud o vulneración de derechos en juego. | Delegar hacia arriba lo que sí correspondía decidir en el aula. |

**Frontera de aplicación.** Cada control tiene costo: Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre evaluación auténtica |
|---|---|
...
Guárdala en `evidence/P11-C136-evaluacion-autentica/` con estos archivos:
