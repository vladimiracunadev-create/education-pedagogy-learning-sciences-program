...
**Estado de evidencia:** `CONSISTENTE` · **Etapa:** 🟣 Etapa C — Núcleo profesional docente · **Población de referencia:** transversal, con foco escolar<br>
**Decisión que habilita:** determinar el plan completo de gestión y qué indicadores mostrarán si está funcionando<br>
...
2. Clasificar la situación distinguiendo **Plan de gestión de aula** de **Indicador de clima**.
3. Decidir con fundamento, usando **Coherencia con la institución** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Revisión periódica** a la vista.
...
| **Evidencia de logro** | qué muestra un plan de gestión de aula completo con indicadores de clima y registro de su primera aplicación frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
Ningún plan de aula compensa condiciones institucionales adversas ni situaciones que exceden lo pedagógico. Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Plan de gestión de<br/>aula"]
    C --> A2["Indicador de clima"]
    C --> A3["Coherencia con la<br/>institución"]
    C --> A4["Revisión periódica"]
    A1 & A2 & A3 & A4 --> D{{"determinar el plan<br/>completo de gestión y<br/>qué indicadores<br/>mostrarán si está<br/>funcionando"}}
    D --> E["Evidencia de aprendizaje<br/>un plan de gestión de<br/>aula completo con<br/>indicadores de clima y<br/>registro de su primera<br/>aplicación"]
...
inocua: produce decisiones que atacan el problema equivocado. **Plan de gestión de aula** no es lo
mismo que **Indicador de clima** —medida observable —tiempo de inicio, participación, incidentes— que permite seguir el efecto—, y tratarlos como sinónimos hace
que la intervención se dirija al lugar incorrecto. Del mismo modo, **Coherencia con la institución** y
**Revisión periódica** describen aspectos distintos de la misma situación: el primero
correspondencia entre el plan del docente y el reglamento y los protocolos vigentes, mientras el segundo instancia planificada para ajustar el plan con evidencia de su funcionamiento.
...
- **Evidencia de logro.** Qué muestra un plan de gestión de aula completo con indicadores de clima y registro de su primera aplicación frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
te deja en condiciones de el plan completo de gestión y qué indicadores mostrarán si está funcionando, y esa decisión se sostiene solo si
...
**Situación.** En 8.º básico se registran 23 anotaciones en un mes, casi todas en los mismos cuatro estudiantes y casi todas en los primeros diez minutos de clase. El reglamento se aplica con criterios distintos según el docente.

**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Plan de gestión de aula** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Plan de gestión de aula de Indicador de clima.** El trabajo aquí es separar lo observado de lo interpretado sobre **Indicador de clima**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Coherencia con la institución como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Coherencia con la institución**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.

**Paso 4 — Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con Revisión periódica a la vista.** Con **Revisión periódica** ya delimitado, la pregunta pasa a ser de consecuencia: qué cambia para los estudiantes, para el tiempo de clase y para la carga del equipo. **Evidencia de partida** entrega la lectura observable; el juicio profesional sigue siendo humano y debe quedar firmado por quien lo hace.
...
|---|---|---|---|
| Intervenir sobre **Plan de gestión de aula** | Conjunto articulado de decisiones preventivas y de respuesta para un curso | Cuando **Evidencia de partida** es observable y accionable dentro del plazo de la decisión. | Sobrerreaccionar a una señal parcial. |
| Intervenir sobre **Indicador de clima** | Medida observable —tiempo de inicio, participación, incidentes— que permite seguir el efecto | Cuando la primera explicación no distingue mecanismo ni responsable. | Convertir el concepto en etiqueta y no en intervención. |
| Observar antes de decidir | Reducir la incertidumbre antes de comprometer tiempo y credibilidad | Cuando la decisión es reversible y la evidencia disponible no distingue causas. | Observar indefinidamente y no decidir nunca. |
| Derivar o escalar | Poner la decisión donde están la competencia y la responsabilidad | Cuando hay normativa, resguardo de datos, salud o vulneración de derechos en juego. | Delegar hacia arriba lo que sí correspondía decidir en el aula. |

**Frontera de aplicación.** Ningún plan de aula compensa condiciones institucionales adversas ni situaciones que exceden lo pedagógico. Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre proyecto integrador: plan de gestión de aula |
|---|---|
...
Guárdala en `evidence/P12-C156-proyecto-integrador-plan-de-gestion-de-aula/` con estos archivos:
...
Esta evidencia alimenta el artefacto de la parte: **plan de gestión de aula con rutinas enseñadas, escala de intervención graduada, protocolos y indicadores de clima**.
...
Riesgo característico de esta parte: **Gestionar por reacción y llamar disciplina a la escalada.** Antes de aplicar
...
- Evertson, C. & Emmer, E. *Classroom Management* (edición vigente). **Uso en esta clase:** modelo completo de planificación de la gestión desde el comienzo del año. Lectura selectiva: índice y capítulos pertinentes; registra edición y páginas consultadas. **Localizar:** [ISBN 9780205349982](https://openlibrary.org/isbn/9780205349982) · [ficha](../../../docs/REGISTRO_DE_FUENTES.md#evertson-emmer-classroom-management)
- Mineduc. *Política Nacional de Convivencia Educativa* (edición vigente). **Uso en esta clase:** marco chileno que enmarca el plan del docente en la política institucional. Lectura selectiva: índice y capítulos pertinentes; registra edición y páginas consultadas. **Localizar:** [fuente oficial](https://convivenciaparaciudadania.mineduc.cl/) · [ficha](../../../docs/REGISTRO_DE_FUENTES.md#mineduc-politica-nacional-de-convivencia-educativa)
