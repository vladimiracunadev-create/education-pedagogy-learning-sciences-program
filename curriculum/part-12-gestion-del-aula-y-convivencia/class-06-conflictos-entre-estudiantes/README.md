...
**Estado de evidencia:** `EMERGENTE` · **Etapa:** 🟣 Etapa C — Núcleo profesional docente · **Población de referencia:** transversal, con foco escolar<br>
**Decisión que habilita:** determinar si la situación es un conflicto mediable, un caso de hostigamiento o una vulneración que exige protocolo<br>
...
2. Clasificar la situación distinguiendo **Conflicto** de **Hostigamiento**.
3. Decidir con fundamento, usando **Práctica restaurativa** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Derivación** a la vista.
...
| **Evidencia de logro** | qué muestra un protocolo de mediación con criterios de clasificación de la situación y el procedimiento para cada caso frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
La evidencia sobre prácticas restaurativas en escuelas es prometedora y todavía limitada: Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Conflicto"]
    C --> A2["Hostigamiento"]
    C --> A3["Práctica restaurativa"]
    C --> A4["Derivación"]
    A1 & A2 & A3 & A4 --> D{{"determinar si la<br/>situación es un<br/>conflicto mediable, un<br/>caso de hostigamiento o<br/>una vulneración…"}}
    D --> E["Evidencia de aprendizaje<br/>un protocolo de<br/>mediación con criterios<br/>de clasificación de la<br/>situación y el<br/>procedimiento…"]
...
inocua: produce decisiones que atacan el problema equivocado. **Conflicto** no es lo
mismo que **Hostigamiento** —agresión sostenida con asimetría de poder; no es mediable y requiere intervención específica—, y tratarlos como sinónimos hace
que la intervención se dirija al lugar incorrecto. Del mismo modo, **Práctica restaurativa** y
**Derivación** describen aspectos distintos de la misma situación: el primero
enfoque centrado en reparar el daño y restablecer relaciones, con evidencia emergente, mientras el segundo traspaso a la instancia competente cuando la situación excede la mediación pedagógica.
...
- **Evidencia de logro.** Qué muestra un protocolo de mediación con criterios de clasificación de la situación y el procedimiento para cada caso frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
te deja en condiciones de si la situación es un conflicto mediable, un caso de hostigamiento o una vulneración que exige protocolo, y esa decisión se sostiene solo si
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Conflicto** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Conflicto de Hostigamiento.** El trabajo aquí es separar lo observado de lo interpretado sobre **Hostigamiento**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Práctica restaurativa como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Práctica restaurativa**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.

**Paso 4 — Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con Derivación a la vista.** Con **Derivación** ya delimitado, la pregunta pasa a ser de consecuencia: qué cambia para los estudiantes, para el tiempo de clase y para la carga del equipo. **Evidencia de partida** entrega la lectura observable; el juicio profesional sigue siendo humano y debe quedar firmado por quien lo hace.
...
**Frontera de aplicación.** La evidencia sobre prácticas restaurativas en escuelas es prometedora y todavía limitada: Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre conflictos entre estudiantes |
|---|---|
...
Guárdala en `evidence/P12-C150-conflictos-entre-estudiantes/` con estos archivos:
