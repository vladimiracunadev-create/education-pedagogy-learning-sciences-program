...
**Estado de evidencia:** `PRACTICA-PROFESIONAL` · **Etapa:** 🟣 Etapa C — Núcleo profesional docente · **Población de referencia:** transversal, con foco escolar<br>
**Decisión que habilita:** determinar el guion que usarás en las tres situaciones de tensión más frecuentes de tu práctica<br>
...
2. Clasificar la situación distinguiendo **Lenguaje descriptivo** de **Mensaje en primera persona**.
3. Decidir con fundamento, usando **Desescalada** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Cierre relacional** a la vista.
...
| **Evidencia de logro** | qué muestra tres guiones de intervención verbal con su fundamento y su análisis tras aplicarlos frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
No hay evidencia experimental robusta sobre fórmulas verbales específicas: Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Lenguaje descriptivo"]
    C --> A2["Mensaje en primera<br/>persona"]
    C --> A3["Desescalada"]
    C --> A4["Cierre relacional"]
    A1 & A2 & A3 & A4 --> D{{"determinar el guion que<br/>usarás en las tres<br/>situaciones de tensión<br/>más frecuentes de tu<br/>práctica"}}
    D --> E["Evidencia de aprendizaje<br/>tres guiones de<br/>intervención verbal con<br/>su fundamento y su<br/>análisis tras aplicarlos"]
...
inocua: produce decisiones que atacan el problema equivocado. **Lenguaje descriptivo** no es lo
mismo que **Mensaje en primera persona** —formulación que expresa el efecto de la conducta sin acusar—, y tratarlos como sinónimos hace
que la intervención se dirija al lugar incorrecto. Del mismo modo, **Desescalada** y
**Cierre relacional** describen aspectos distintos de la misma situación: el primero
conjunto de conductas verbales y no verbales que reducen la intensidad del conflicto, mientras el segundo acción final que restablece la relación de trabajo después de la corrección.
...
- **Evidencia de logro.** Qué muestra tres guiones de intervención verbal con su fundamento y su análisis tras aplicarlos frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
te deja en condiciones de el guion que usarás en las tres situaciones de tensión más frecuentes de tu práctica, y esa decisión se sostiene solo si
...
|---|---|---|
| Ginott, H. (1972). *Teacher and Child*. | origen del lenguaje descriptivo aplicado a la relación educativa. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
| Marzano, R. (2003). *Classroom Management That Works*. | sistematiza prácticas de comunicación y relación con evidencia observacional. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Lenguaje descriptivo** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Lenguaje descriptivo de Mensaje en primera persona.** El trabajo aquí es separar lo observado de lo interpretado sobre **Mensaje en primera persona**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Desescalada como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Desescalada**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.

**Paso 4 — Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con Cierre relacional a la vista.** Con **Cierre relacional** ya delimitado, la pregunta pasa a ser de consecuencia: qué cambia para los estudiantes, para el tiempo de clase y para la carga del equipo. **Evidencia de partida** entrega la lectura observable; el juicio profesional sigue siendo humano y debe quedar firmado por quien lo hace.
...
|---|---|---|---|
| Intervenir sobre **Lenguaje descriptivo** | Descripción de la conducta observada sin juicio sobre la persona | Cuando **Evidencia de partida** es observable y accionable dentro del plazo de la decisión. | Sobrerreaccionar a una señal parcial. |
| Intervenir sobre **Mensaje en primera persona** | Formulación que expresa el efecto de la conducta sin acusar | Cuando la primera explicación no distingue mecanismo ni responsable. | Convertir el concepto en etiqueta y no en intervención. |
| Observar antes de decidir | Reducir la incertidumbre antes de comprometer tiempo y credibilidad | Cuando la decisión es reversible y la evidencia disponible no distingue causas. | Observar indefinidamente y no decidir nunca. |
| Derivar o escalar | Poner la decisión donde están la competencia y la responsabilidad | Cuando hay normativa, resguardo de datos, salud o vulneración de derechos en juego. | Delegar hacia arriba lo que sí correspondía decidir en el aula. |

**Frontera de aplicación.** No hay evidencia experimental robusta sobre fórmulas verbales específicas: Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre comunicación docente |
|---|---|
...
Guárdala en `evidence/P12-C149-comunicacion-docente/` con estos archivos:
