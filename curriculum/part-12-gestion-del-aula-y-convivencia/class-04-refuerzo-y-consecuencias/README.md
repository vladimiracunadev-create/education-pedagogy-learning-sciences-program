...
**Decisión que habilita:** determinar qué consecuencia corresponde a una conducta y cómo evitarás depender de ella<br>
...
2. Clasificar la situación distinguiendo **Reforzamiento** de **Consecuencia lógica**.
3. Decidir con fundamento, usando **Previsibilidad** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Retirada del sistema externo** a la vista.
...
| **Evidencia de logro** | qué muestra un sistema graduado de reconocimiento y consecuencias con su fundamento y su plan de retirada frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
Los sistemas de puntos y premios producen efectos a corto plazo y riesgos conocidos: Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Reforzamiento"]
    C --> A2["Consecuencia lógica"]
    C --> A3["Previsibilidad"]
    C --> A4["Retirada del sistema<br/>externo"]
    A1 & A2 & A3 & A4 --> D{{"determinar qué<br/>consecuencia corresponde<br/>a una conducta y cómo<br/>evitarás depender de<br/>ella"}}
    D --> E["Evidencia de aprendizaje<br/>un sistema graduado de<br/>reconocimiento y<br/>consecuencias con su<br/>fundamento y su plan de<br/>retirada"]
...
mismo que **Consecuencia lógica** —respuesta relacionada con la conducta y proporcional a su gravedad—, y tratarlos como sinónimos hace
que la intervención se dirija al lugar incorrecto. Del mismo modo, **Previsibilidad** y
**Retirada del sistema externo** describen aspectos distintos de la misma situación: el primero
condición de que la consecuencia sea conocida de antemano y se aplique con consistencia, mientras el segundo plan para que la conducta se sostenga sin depender del refuerzo aplicado.
...
- **Evidencia de logro.** Qué muestra un sistema graduado de reconocimiento y consecuencias con su fundamento y su plan de retirada frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
te deja en condiciones de qué consecuencia corresponde a una conducta y cómo evitarás depender de ella, y esa decisión se sostiene solo si
...
**Paso 2 — Clasificar la situación distinguiendo Reforzamiento de Consecuencia lógica.** El trabajo aquí es separar lo observado de lo interpretado sobre **Consecuencia lógica**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Previsibilidad como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Previsibilidad**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.

**Paso 4 — Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con Retirada del sistema externo a la vista.** Con **Retirada del sistema externo** ya delimitado, la pregunta pasa a ser de consecuencia: qué cambia para los estudiantes, para el tiempo de clase y para la carga del equipo. **Evidencia de partida** entrega la lectura observable; el juicio profesional sigue siendo humano y debe quedar firmado por quien lo hace.
...
**Frontera de aplicación.** Los sistemas de puntos y premios producen efectos a corto plazo y riesgos conocidos: Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre refuerzo y consecuencias |
|---|---|
...
Guárdala en `evidence/P12-C148-refuerzo-y-consecuencias/` con estos archivos:
