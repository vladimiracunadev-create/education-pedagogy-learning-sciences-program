...
**Decisión que habilita:** determinar qué normas y rutinas vas a enseñar explícitamente y cómo verificarás su instalación<br>
...
2. Clasificar la situación distinguiendo **Norma** de **Rutina**.
3. Decidir con fundamento, usando **Formulación en positivo** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Instalación** a la vista.
...
| **Evidencia de logro** | qué muestra el sistema de normas y rutinas de un curso con su plan de enseñanza, práctica y corrección frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
Las normas ordenan la convivencia cotidiana y no resuelven conflictos de fondo ni situaciones que requieren protocolo. Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Norma"]
    C --> A2["Rutina"]
    C --> A3["Formulación en<br/>positivo"]
    C --> A4["Instalación"]
    A1 & A2 & A3 & A4 --> D{{"determinar qué normas y<br/>rutinas vas a enseñar<br/>explícitamente y cómo<br/>verificarás su<br/>instalación"}}
    D --> E["Evidencia de aprendizaje<br/>el sistema de normas y<br/>rutinas de un curso con<br/>su plan de enseñanza,<br/>práctica y corrección"]
...
inocua: produce decisiones que atacan el problema equivocado. **Norma** no es lo
mismo que **Rutina** —procedimiento estable para una situación recurrente; se automatiza con práctica—, y tratarlos como sinónimos hace
que la intervención se dirija al lugar incorrecto. Del mismo modo, **Formulación en positivo** y
**Instalación** describen aspectos distintos de la misma situación: el primero
enunciado que describe la conducta esperada en vez de la prohibida, mientras el segundo estado en que la rutina se ejecuta sin necesidad de recordarla.
...
- **Evidencia de logro.** Qué muestra el sistema de normas y rutinas de un curso con su plan de enseñanza, práctica y corrección frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
te deja en condiciones de qué normas y rutinas vas a enseñar explícitamente y cómo verificarás su instalación, y esa decisión se sostiene solo si
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Norma** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Norma de Rutina.** El trabajo aquí es separar lo observado de lo interpretado sobre **Rutina**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Formulación en positivo como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Formulación en positivo**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.

**Paso 4 — Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con Instalación a la vista.** Con **Instalación** ya delimitado, la pregunta pasa a ser de consecuencia: qué cambia para los estudiantes, para el tiempo de clase y para la carga del equipo. **Evidencia de partida** entrega la lectura observable; el juicio profesional sigue siendo humano y debe quedar firmado por quien lo hace.
...
|---|---|---|---|
| Intervenir sobre **Norma** | Regla de convivencia que define qué es aceptable; se enseña y se sostiene, no solo se publica | Cuando **Evidencia de partida** es observable y accionable dentro del plazo de la decisión. | Sobrerreaccionar a una señal parcial. |
| Intervenir sobre **Rutina** | Procedimiento estable para una situación recurrente; se automatiza con práctica | Cuando la primera explicación no distingue mecanismo ni responsable. | Convertir el concepto en etiqueta y no en intervención. |
| Observar antes de decidir | Reducir la incertidumbre antes de comprometer tiempo y credibilidad | Cuando la decisión es reversible y la evidencia disponible no distingue causas. | Observar indefinidamente y no decidir nunca. |
| Derivar o escalar | Poner la decisión donde están la competencia y la responsabilidad | Cuando hay normativa, resguardo de datos, salud o vulneración de derechos en juego. | Delegar hacia arriba lo que sí correspondía decidir en el aula. |

**Frontera de aplicación.** Las normas ordenan la convivencia cotidiana y no resuelven conflictos de fondo ni situaciones que requieren protocolo. Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre normas y rutinas |
|---|---|
...
Guárdala en `evidence/P12-C146-normas-y-rutinas/` con estos archivos:
