...
**Decisión que habilita:** determinar qué decisión concreta vas a modificar para mejorar el clima de tu curso<br>
...
2. Clasificar la situación distinguiendo **Clima de aula** de **Previsibilidad**.
3. Decidir con fundamento, usando **Seguridad psicológica** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Exigencia con apoyo** a la vista.
...
| **Evidencia de logro** | qué muestra un diagnóstico de clima de aula con evidencia observada y tres decisiones de mejora priorizadas frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
El clima medido por encuestas y el clima real no siempre coinciden, y los instrumentos de percepción son sensibles al momento y al deseo de agradar. Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Clima de aula"]
    C --> A2["Previsibilidad"]
    C --> A3["Seguridad psicológica"]
    C --> A4["Exigencia con apoyo"]
    A1 & A2 & A3 & A4 --> D{{"determinar qué decisión<br/>concreta vas a modificar<br/>para mejorar el clima de<br/>tu curso"}}
    D --> E["Evidencia de aprendizaje<br/>un diagnóstico de clima<br/>de aula con evidencia<br/>observada y tres<br/>decisiones de mejora<br/>priorizadas"]
...
inocua: produce decisiones que atacan el problema equivocado. **Clima de aula** no es lo
...
- **Evidencia de logro.** Qué muestra un diagnóstico de clima de aula con evidencia observada y tres decisiones de mejora priorizadas frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
te deja en condiciones de qué decisión concreta vas a modificar para mejorar el clima de tu curso, y esa decisión se sostiene solo si
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Clima de aula** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Clima de aula de Previsibilidad.** El trabajo aquí es separar lo observado de lo interpretado sobre **Previsibilidad**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Seguridad psicológica como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Seguridad psicológica**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.

**Paso 4 — Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con Exigencia con apoyo a la vista.** Con **Exigencia con apoyo** ya delimitado, la pregunta pasa a ser de consecuencia: qué cambia para los estudiantes, para el tiempo de clase y para la carga del equipo. **Evidencia de partida** entrega la lectura observable; el juicio profesional sigue siendo humano y debe quedar firmado por quien lo hace.
...
|---|---|---|---|
| Intervenir sobre **Clima de aula** | Calidad percibida de las relaciones, la seguridad y las condiciones de trabajo en la sala | Cuando **Evidencia de partida** es observable y accionable dentro del plazo de la decisión. | Sobrerreaccionar a una señal parcial. |
| Intervenir sobre **Previsibilidad** | Grado en que el estudiante puede anticipar lo que ocurrirá y qué se espera de él | Cuando la primera explicación no distingue mecanismo ni responsable. | Convertir el concepto en etiqueta y no en intervención. |
| Observar antes de decidir | Reducir la incertidumbre antes de comprometer tiempo y credibilidad | Cuando la decisión es reversible y la evidencia disponible no distingue causas. | Observar indefinidamente y no decidir nunca. |
| Derivar o escalar | Poner la decisión donde están la competencia y la responsabilidad | Cuando hay normativa, resguardo de datos, salud o vulneración de derechos en juego. | Delegar hacia arriba lo que sí correspondía decidir en el aula. |

**Frontera de aplicación.** El clima medido por encuestas y el clima real no siempre coinciden, y los instrumentos de percepción son sensibles al momento y al deseo de agradar. Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre clima de aula |
|---|---|
...
Guárdala en `evidence/P12-C145-clima-de-aula/` con estos archivos:
