...
**Decisión que habilita:** determinar qué está protegiendo la resistencia de tu estudiante y qué condición debe cambiar primero<br>
...
2. Clasificar la situación distinguiendo **Resistencia** de **Desenganche**.
3. Decidir con fundamento, usando **Historia de fracaso** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Reingreso** a la vista.
...
| **Evidencia de logro** | qué muestra un plan de intervención para un estudiante desenganchado con hipótesis, acciones y seguimiento frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
La desmotivación puede tener causas que exceden la asignatura: Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Resistencia"]
    C --> A2["Desenganche"]
    C --> A3["Historia de fracaso"]
    C --> A4["Reingreso"]
    A1 & A2 & A3 & A4 --> D{{"determinar qué está<br/>protegiendo la<br/>resistencia de tu<br/>estudiante y qué<br/>condición debe cambiar…"}}
    D --> E["Evidencia de aprendizaje<br/>un plan de intervención<br/>para un estudiante<br/>desenganchado con<br/>hipótesis, acciones y<br/>seguimiento"]
...
inocua: produce decisiones que atacan el problema equivocado. **Resistencia** no es lo
...
- **Evidencia de logro.** Qué muestra un plan de intervención para un estudiante desenganchado con hipótesis, acciones y seguimiento frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
te deja en condiciones de qué está protegiendo la resistencia de tu estudiante y qué condición debe cambiar primero, y esa decisión se sostiene solo si
...
|---|---|---|
| Covington, M. (1992). *Making the Grade: A Self-Worth Perspective on Motivation and School Reform*. | explica la evitación del esfuerzo como protección del valor propio. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
| Wlodkowski, R. (2008). *Enhancing Adult Motivation to Learn*. | estrategias de reenganche aplicables también a adolescentes y adultos jóvenes. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Resistencia** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Resistencia de Desenganche.** El trabajo aquí es separar lo observado de lo interpretado sobre **Desenganche**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Historia de fracaso como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Historia de fracaso**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.

**Paso 4 — Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con Reingreso a la vista.** Con **Reingreso** ya delimitado, la pregunta pasa a ser de consecuencia: qué cambia para los estudiantes, para el tiempo de clase y para la carga del equipo. **Evidencia de partida** entrega la lectura observable; el juicio profesional sigue siendo humano y debe quedar firmado por quien lo hace.
...
|---|---|---|---|
| Intervenir sobre **Resistencia** | Conducta de rechazo activo o pasivo que suele proteger de una amenaza percibida | Cuando **Evidencia de partida** es observable y accionable dentro del plazo de la decisión. | Sobrerreaccionar a una señal parcial. |
| Intervenir sobre **Desenganche** | Retiro progresivo del esfuerzo y de la participación, con frecuencia silencioso | Cuando la primera explicación no distingue mecanismo ni responsable. | Convertir el concepto en etiqueta y no en intervención. |
| Observar antes de decidir | Reducir la incertidumbre antes de comprometer tiempo y credibilidad | Cuando la decisión es reversible y la evidencia disponible no distingue causas. | Observar indefinidamente y no decidir nunca. |
| Derivar o escalar | Poner la decisión donde están la competencia y la responsabilidad | Cuando hay normativa, resguardo de datos, salud o vulneración de derechos en juego. | Delegar hacia arriba lo que sí correspondía decidir en el aula. |

**Frontera de aplicación.** La desmotivación puede tener causas que exceden la asignatura: Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre desmotivación y resistencia |
|---|---|
...
Guárdala en `evidence/P12-C151-desmotivacion-y-resistencia/` con estos archivos:
