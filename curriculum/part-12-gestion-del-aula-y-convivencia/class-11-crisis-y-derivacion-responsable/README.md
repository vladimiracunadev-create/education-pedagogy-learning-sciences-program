...
**Estado de evidencia:** `MARCO-NORMATIVO` · **Etapa:** 🟣 Etapa C — Núcleo profesional docente · **Población de referencia:** transversal, con foco escolar<br>
**Decisión que habilita:** determinar qué corresponde hacer, en qué orden y con quién, ante una situación de riesgo<br>
...
2. Clasificar la situación distinguiendo **Situación de riesgo** de **Contención**.
3. Decidir con fundamento, usando **Derivación responsable** como criterio y declarando la fuente.
...
| **Evidencia de logro** | qué muestra un protocolo personal de actuación ante tres situaciones de riesgo, contrastado con la normativa vigente frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
La normativa sobre denuncia, plazos y responsabilidades es específica y cambia; Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Situación de riesgo"]
    C --> A2["Contención"]
    C --> A3["Derivación responsable"]
    C --> A4["Registro"]
    A1 & A2 & A3 & A4 --> D{{"determinar qué<br/>corresponde hacer, en<br/>qué orden y con quién,<br/>ante una situación de<br/>riesgo"}}
    D --> E["Evidencia de aprendizaje<br/>un protocolo personal de<br/>actuación ante tres<br/>situaciones de riesgo,<br/>contrastado con la…"]
...
inocua: produce decisiones que atacan el problema equivocado. **Situación de riesgo** no es lo
mismo que **Contención** —respuesta inmediata que asegura la integridad antes de cualquier otra acción—, y tratarlos como sinónimos hace
que la intervención se dirija al lugar incorrecto. Del mismo modo, **Derivación responsable** y
**Registro** describen aspectos distintos de la misma situación: el primero
traspaso a la instancia competente con información suficiente y verificación de recepción, mientras el segundo documentación fechada de lo observado, lo actuado y lo informado.
...
- **Evidencia de logro.** Qué muestra un protocolo personal de actuación ante tres situaciones de riesgo, contrastado con la normativa vigente frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
te deja en condiciones de qué corresponde hacer, en qué orden y con quién, ante una situación de riesgo, y esa decisión se sostiene solo si
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Situación de riesgo** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Situación de riesgo de Contención.** El trabajo aquí es separar lo observado de lo interpretado sobre **Contención**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Derivación responsable como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Derivación responsable**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.
...
|---|---|---|---|
| Intervenir sobre **Situación de riesgo** | Circunstancia que compromete la integridad física o psicológica de un estudiante | Cuando **Evidencia de partida** es observable y accionable dentro del plazo de la decisión. | Sobrerreaccionar a una señal parcial. |
| Intervenir sobre **Contención** | Respuesta inmediata que asegura la integridad antes de cualquier otra acción | Cuando la primera explicación no distingue mecanismo ni responsable. | Convertir el concepto en etiqueta y no en intervención. |
| Observar antes de decidir | Reducir la incertidumbre antes de comprometer tiempo y credibilidad | Cuando la decisión es reversible y la evidencia disponible no distingue causas. | Observar indefinidamente y no decidir nunca. |
| Derivar o escalar | Poner la decisión donde están la competencia y la responsabilidad | Cuando hay normativa, resguardo de datos, salud o vulneración de derechos en juego. | Delegar hacia arriba lo que sí correspondía decidir en el aula. |

**Frontera de aplicación.** La normativa sobre denuncia, plazos y responsabilidades es específica y cambia; Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre crisis y derivación responsable |
|---|---|
...
Guárdala en `evidence/P12-C155-crisis-y-derivacion-responsable/` con estos archivos:
