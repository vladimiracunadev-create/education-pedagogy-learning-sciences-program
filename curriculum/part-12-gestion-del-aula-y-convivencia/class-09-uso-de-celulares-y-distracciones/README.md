...
**Estado de evidencia:** `EN-DEBATE` · **Etapa:** 🟣 Etapa C — Núcleo profesional docente · **Población de referencia:** transversal, con foco escolar<br>
**Decisión que habilita:** determinar qué política de dispositivos aplicarás y cómo la sostendrás sin desgastar la relación<br>
...
2. Clasificar la situación distinguiendo **Atención dividida** de **Uso instruccional**.
3. Decidir con fundamento, usando **Consistencia institucional** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Comunicación anticipada** a la vista.
...
| **Evidencia de logro** | qué muestra una política de uso de dispositivos con su fundamento, su procedimiento y su comunicación a las familias frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
La evidencia sobre prohibiciones a nivel de establecimiento es mixta y los estudios disponibles tienen limitaciones de diseño. Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Atención dividida"]
    C --> A2["Uso instruccional"]
    C --> A3["Consistencia<br/>institucional"]
    C --> A4["Comunicación<br/>anticipada"]
    A1 & A2 & A3 & A4 --> D{{"determinar qué política<br/>de dispositivos<br/>aplicarás y cómo la<br/>sostendrás sin desgastar<br/>la relación"}}
    D --> E["Evidencia de aprendizaje<br/>una política de uso de<br/>dispositivos con su<br/>fundamento, su<br/>procedimiento y su<br/>comunicación a las…"]
...
inocua: produce decisiones que atacan el problema equivocado. **Atención dividida** no es lo
...
- **Evidencia de logro.** Qué muestra una política de uso de dispositivos con su fundamento, su procedimiento y su comunicación a las familias frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
te deja en condiciones de qué política de dispositivos aplicarás y cómo la sostendrás sin desgastar la relación, y esa decisión se sostiene solo si
...
|---|---|---|
| Ward, A. et al. (2017). *Brain Drain: The Mere Presence of One's Own Smartphone Reduces Available Cognitive Capacity*. | evidencia experimental sobre el costo atencional de la presencia del dispositivo. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
| UNESCO (2023). *Informe de Seguimiento de la Educación en el Mundo: tecnología en la educación*. | revisa la evidencia sobre uso de tecnología y políticas de dispositivos en escuelas. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Atención dividida** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Atención dividida de Uso instruccional.** El trabajo aquí es separar lo observado de lo interpretado sobre **Uso instruccional**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Consistencia institucional como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Consistencia institucional**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.

**Paso 4 — Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con Comunicación anticipada a la vista.** Con **Comunicación anticipada** ya delimitado, la pregunta pasa a ser de consecuencia: qué cambia para los estudiantes, para el tiempo de clase y para la carga del equipo. **Evidencia de partida** entrega la lectura observable; el juicio profesional sigue siendo humano y debe quedar firmado por quien lo hace.
...
|---|---|---|---|
| Intervenir sobre **Atención dividida** | Alternancia entre tareas con costo de rendimiento; no es procesamiento simultáneo | Cuando **Evidencia de partida** es observable y accionable dentro del plazo de la decisión. | Sobrerreaccionar a una señal parcial. |
| Intervenir sobre **Uso instruccional** | Empleo del dispositivo para una tarea de aprendizaje definida y acotada | Cuando la primera explicación no distingue mecanismo ni responsable. | Convertir el concepto en etiqueta y no en intervención. |
| Observar antes de decidir | Reducir la incertidumbre antes de comprometer tiempo y credibilidad | Cuando la decisión es reversible y la evidencia disponible no distingue causas. | Observar indefinidamente y no decidir nunca. |
| Derivar o escalar | Poner la decisión donde están la competencia y la responsabilidad | Cuando hay normativa, resguardo de datos, salud o vulneración de derechos en juego. | Delegar hacia arriba lo que sí correspondía decidir en el aula. |

**Frontera de aplicación.** La evidencia sobre prohibiciones a nivel de establecimiento es mixta y los estudios disponibles tienen limitaciones de diseño. Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre uso de celulares y distracciones |
|---|---|
...
Guárdala en `evidence/P12-C153-uso-de-celulares-y-distracciones/` con estos archivos:
