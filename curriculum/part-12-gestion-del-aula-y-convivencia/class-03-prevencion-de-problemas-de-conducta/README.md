...
**Decisión que habilita:** determinar qué momento de tu clase concentra los problemas y qué decisión previa lo eliminaría<br>
...
2. Clasificar la situación distinguiendo **Prevención** de **Percepción simultánea**.
3. Decidir con fundamento, usando **Densidad de la clase** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Momento crítico** a la vista.
...
| **Evidencia de logro** | qué muestra un análisis de los momentos críticos de tus clases con las medidas preventivas correspondientes frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
La prevención reduce la disrupción ordinaria y no resuelve situaciones que tienen causas fuera del aula: Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Prevención"]
    C --> A2["Percepción simultánea"]
    C --> A3["Densidad de la clase"]
    C --> A4["Momento crítico"]
    A1 & A2 & A3 & A4 --> D{{"determinar qué momento<br/>de tu clase concentra<br/>los problemas y qué<br/>decisión previa lo<br/>eliminaría"}}
    D --> E["Evidencia de aprendizaje<br/>un análisis de los<br/>momentos críticos de tus<br/>clases con las medidas<br/>preventivas<br/>correspondientes"]
...
inocua: produce decisiones que atacan el problema equivocado. **Prevención** no es lo
mismo que **Percepción simultánea** —capacidad de saber qué ocurre en toda la sala mientras se atiende a una parte—, y tratarlos como sinónimos hace
que la intervención se dirija al lugar incorrecto. Del mismo modo, **Densidad de la clase** y
**Momento crítico** describen aspectos distintos de la misma situación: el primero
proporción del tiempo en que los estudiantes están efectivamente ocupados en algo con sentido, mientras el segundo instante recurrente —inicio, transiciones, entrega de material, cierre— donde se concentran los problemas.
...
- **Evidencia de logro.** Qué muestra un análisis de los momentos críticos de tus clases con las medidas preventivas correspondientes frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
te deja en condiciones de qué momento de tu clase concentra los problemas y qué decisión previa lo eliminaría, y esa decisión se sostiene solo si
...
|---|---|---|
| Kounin, J. (1970). *Discipline and Group Management in Classrooms*. | establece percepción simultánea, ritmo y solapamiento como factores decisivos. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
| Simonsen, B. et al. (2008). *Evidence-Based Practices in Classroom Management*. | sistematiza prácticas preventivas con respaldo empírico. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Prevención** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Prevención de Percepción simultánea.** El trabajo aquí es separar lo observado de lo interpretado sobre **Percepción simultánea**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Densidad de la clase como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Densidad de la clase**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.

**Paso 4 — Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con Momento crítico a la vista.** Con **Momento crítico** ya delimitado, la pregunta pasa a ser de consecuencia: qué cambia para los estudiantes, para el tiempo de clase y para la carga del equipo. **Evidencia de partida** entrega la lectura observable; el juicio profesional sigue siendo humano y debe quedar firmado por quien lo hace.
...
|---|---|---|---|
| Intervenir sobre **Prevención** | Conjunto de decisiones tomadas antes del problema que reducen su probabilidad | Cuando **Evidencia de partida** es observable y accionable dentro del plazo de la decisión. | Sobrerreaccionar a una señal parcial. |
| Intervenir sobre **Percepción simultánea** | Capacidad de saber qué ocurre en toda la sala mientras se atiende a una parte | Cuando la primera explicación no distingue mecanismo ni responsable. | Convertir el concepto en etiqueta y no en intervención. |
| Observar antes de decidir | Reducir la incertidumbre antes de comprometer tiempo y credibilidad | Cuando la decisión es reversible y la evidencia disponible no distingue causas. | Observar indefinidamente y no decidir nunca. |
| Derivar o escalar | Poner la decisión donde están la competencia y la responsabilidad | Cuando hay normativa, resguardo de datos, salud o vulneración de derechos en juego. | Delegar hacia arriba lo que sí correspondía decidir en el aula. |

**Frontera de aplicación.** La prevención reduce la disrupción ordinaria y no resuelve situaciones que tienen causas fuera del aula: Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre prevención de problemas de conducta |
|---|---|
...
Guárdala en `evidence/P12-C147-prevencion-de-problemas-de-conducta/` con estos archivos:
