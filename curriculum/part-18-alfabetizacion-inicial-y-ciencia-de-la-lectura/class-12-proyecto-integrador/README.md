# Clase 228 — Proyecto integrador: plan lector de establecimiento

> **Parte 18 · Alfabetización inicial y ciencia de la lectura** — clase 12 de 12

**Estado de evidencia:** `PRACTICA-PROFESIONAL` · **Etapa:** 🟤 Etapa F — Especialización y desafíos contemporáneos · **Población de referencia:** parvularia y primer ciclo básico, con proyección a todo el sistema<br>
**Decisión que habilita:** determinar el plan lector completo del establecimiento y quién responde por cada componente<br>
**Evidencia de aprendizaje:** un plan lector de establecimiento con progresión por nivel, calendario de medición, esquema de intervención y responsables nombrados

## 🎯 Propósito

Integrar todo lo trabajado en un plan lector de establecimiento con progresión, medición, intervención y responsables definidos.
...
2. **Explicar** cómo se construye un plan lector que sobreviva al cambio de docentes y de dirección.
3. **Decidir** —el plan lector completo del establecimiento y quién responde por cada componente— y sostener la decisión con un fundamento escrito.
4. **Producir** la evidencia de la clase —un plan lector de establecimiento con progresión por nivel, calendario de medición, esquema de intervención y responsables nombrados— y contrastarla contra el criterio de logro.
...
|---|---|
| **Plan lector de establecimiento** | documento que define qué se enseña, cuándo se mide y cómo se interviene en toda la trayectoria lectora |
| **Continuidad entre niveles** | coherencia de la progresión cuando el estudiante cambia de curso y de docente |
| **Responsable nombrado** | persona identificada para cada componente, sin la cual el plan depende de la voluntad general |
| **Revisión programada** | fecha fijada de antemano para evaluar el plan con datos y decidir su ajuste |
...
2. Clasificar la situación distinguiendo **Plan lector de establecimiento** de **Continuidad entre niveles**.
3. Decidir con fundamento, usando **Responsable nombrado** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Revisión programada** a la vista.
...
| **Evidencia de logro** | qué muestra un plan lector de establecimiento con progresión por nivel, calendario de medición, esquema de intervención y responsables nombrados frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
Un plan es una hipótesis organizacional: Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Plan lector de<br/>establecimiento"]
    C --> A2["Continuidad entre<br/>niveles"]
    C --> A3["Responsable nombrado"]
    C --> A4["Revisión programada"]
    A1 & A2 & A3 & A4 --> D{{"determinar el plan<br/>lector completo del<br/>establecimiento y quién<br/>responde por cada<br/>componente"}}
    D --> E["Evidencia de aprendizaje<br/>un plan lector de<br/>establecimiento con<br/>progresión por nivel,<br/>calendario de medición,<br/>esquema de…"]
...
Los planes lectores fracasan casi siempre por la misma razón: dependen de personas y no de estructura. Un docente comprometido levanta un sistema que funciona dos años y desaparece cuando se va. Un plan que sobrevive declara la progresión por nivel de modo que el docente que llega sepa qué se enseñó antes, fija el calendario de medición con responsables nombrados, y establece qué ocurre con los resultados. La diferencia entre un plan real y un documento de carpeta está en si alguien puede ejecutarlo sin haber estado en la reunión donde se acordó.

### 2. Frontera conceptual: qué es y qué no es

Los cuatro conceptos de esta clase se confunden entre sí con facilidad, y esa confusión no es
inocua: produce decisiones que atacan el problema equivocado. **Plan lector de establecimiento** no es lo
mismo que **Continuidad entre niveles** —coherencia de la progresión cuando el estudiante cambia de curso y de docente—, y tratarlos como sinónimos hace
que la intervención se dirija al lugar incorrecto. Del mismo modo, **Responsable nombrado** y
**Revisión programada** describen aspectos distintos de la misma situación: el primero
persona identificada para cada componente, sin la cual el plan depende de la voluntad general, mientras el segundo fecha fijada de antemano para evaluar el plan con datos y decidir su ajuste.
...
- **Evidencia de logro.** Qué muestra un plan lector de establecimiento con progresión por nivel, calendario de medición, esquema de intervención y responsables nombrados frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
El proyecto integra las once clases anteriores: la progresión de correspondencias, la práctica de fluidez, el trabajo de vocabulario, la enseñanza de comprensión y de escritura, el calendario de evaluación por componentes y el esquema de intervención por niveles. Cada componente se entrega con responsable, plazo y evidencia de que ocurrió. El plan se presenta al equipo y se somete a la prueba decisiva: entregárselo a un docente nuevo y verificar si puede ejecutarlo.

### 5. Qué sostiene la evidencia y qué no

Un plan es una hipótesis organizacional: aunque cada componente tenga respaldo, su implementación depende de tiempo docente, estabilidad del equipo y decisiones de dirección que exceden a quien lo escribe. Tampoco garantiza resultados en un año: las trayectorias lectoras se mueven en plazos largos y la lectura de resultados anuales suele producir cambios de rumbo prematuros.
...
te deja en condiciones de el plan lector completo del establecimiento y quién responde por cada componente, y esa decisión se sostiene solo si
...
|---|---|---|
| Snow, C., Burns, S. & Griffin, P. (eds.) (1998). *Preventing Reading Difficulties in Young Children*. | el marco de prevención que un plan de establecimiento debe traducir a decisiones. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
| Bryk, A. et al. (2010). *Organizing Schools for Improvement*. | qué condiciones organizacionales hacen que una mejora se sostenga más allá de las personas. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Plan lector de establecimiento** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Plan lector de establecimiento de Continuidad entre niveles.** El trabajo aquí es separar lo observado de lo interpretado sobre **Continuidad entre niveles**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Responsable nombrado como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Responsable nombrado**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.

**Paso 4 — Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con Revisión programada a la vista.** Con **Revisión programada** ya delimitado, la pregunta pasa a ser de consecuencia: qué cambia para los estudiantes, para el tiempo de clase y para la carga del equipo. **Evidencia de partida** entrega la lectura observable; el juicio profesional sigue siendo humano y debe quedar firmado por quien lo hace.
...
|---|---|---|---|
| Intervenir sobre **Plan lector de establecimiento** | Documento que define qué se enseña, cuándo se mide y cómo se interviene en toda la trayectoria lectora | Cuando **Evidencia de partida** es observable y accionable dentro del plazo de la decisión. | Sobrerreaccionar a una señal parcial. |
| Intervenir sobre **Continuidad entre niveles** | Coherencia de la progresión cuando el estudiante cambia de curso y de docente | Cuando la primera explicación no distingue mecanismo ni responsable. | Convertir el concepto en etiqueta y no en intervención. |
| Observar antes de decidir | Reducir la incertidumbre antes de comprometer tiempo y credibilidad | Cuando la decisión es reversible y la evidencia disponible no distingue causas. | Observar indefinidamente y no decidir nunca. |
| Derivar o escalar | Poner la decisión donde están la competencia y la responsabilidad | Cuando hay normativa, resguardo de datos, salud o vulneración de derechos en juego. | Delegar hacia arriba lo que sí correspondía decidir en el aula. |

**Frontera de aplicación.** Un plan es una hipótesis organizacional: Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre proyecto integrador: plan lector de establecimiento |
|---|---|
...
Un plan lector de establecimiento con progresión por nivel, calendario de medición, esquema de intervención y responsables nombrados.

Guárdala en `evidence/P18-C228-proyecto-integrador/` con estos archivos:
...
Escribe el plan lector completo de un establecimiento real o del caso. Entrégalo a alguien que no participó y pídele que ejecute la primera semana solo con el documento.
...
- [ ] cada componente del plan tiene responsable, plazo y evidencia comprometida;
- [ ] un docente que no participó en su elaboración puede ejecutar el plan leyéndolo;
...
- Escribir el plan sin responsables nombrados ni horario real para cada componente.
- Evaluar el plan a un año y descartarlo antes de que la progresión alcance a producir efecto.
...
El plan debe declarar explícitamente qué ocurre con los estudiantes que llegan a mitad de trayectoria, con quienes aprenden en segunda lengua y con quienes tienen dificultades específicas. Un plan que solo describe el caso típico deja fuera precisamente a quienes más dependen de que exista.
...
1. ¿Qué pasa con tu plan si se van los dos docentes que más lo empujaron?
2. ¿En qué fecha y con qué datos se revisará el plan, y quién convoca esa revisión?
3. ¿Qué parte del plan no tiene hoy horario real asignado?
...
Cierra la parte 18 integrando las clases 217 a 227, y enlaza con la parte 15 para su implementación institucional.
...
|---|---|---|
| [← 227 · Alfabetización disciplinar en las asignaturas](../class-11-alfabetizacion-disciplinar-en-las-asignaturas/README.md) | [Parte 18](../README.md) · [Programa](../../../README.md) | [Programa completo →](../../../README.md) |
