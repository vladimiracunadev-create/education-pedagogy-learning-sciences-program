...
**Clases:** 12 (217–228) · **Población de referencia:** parvularia y primer ciclo básico, con proyección a todo el sistema · **Conceptos operacionales:** 48 · **Señales observables:** 36<br>
...
```mermaid
flowchart TB
    OR["Lenguaje oral<br/>vocabulario y conocimiento"] --> COMP["Comprension lectora"]
    CF["Conciencia fonologica"] --> DEC["Decodificacion"]
    DEC --> FLU["Fluidez"]
    FLU --> COMP
    COMP --> DISC["Alfabetizacion disciplinar"]
    EV["Evaluacion por componentes"] --> INT["Intervencion por niveles"]
    INT --> DEC
    INT --> FLU
    INT --> COMP
```
