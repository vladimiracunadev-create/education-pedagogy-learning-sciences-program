# Clase 221 — Vocabulario y conocimiento del mundo

> **Parte 18 · Alfabetización inicial y ciencia de la lectura** — clase 5 de 12

**Estado de evidencia:** `CONSISTENTE` · **Etapa:** 🟤 Etapa F — Especialización y desafíos contemporáneos · **Población de referencia:** parvularia y primer ciclo básico, con proyección a todo el sistema<br>
**Decisión que habilita:** determinar qué palabras se enseñan explícitamente en tu unidad y cómo se verifica que quedaron disponibles<br>
**Evidencia de aprendizaje:** una selección justificada de palabras de alto rendimiento con su plan de enseñanza y verificación

## 🎯 Propósito

Enseñar vocabulario de forma deliberada y construir conocimiento del mundo como condición de la comprensión, no como adorno cultural.
...
2. **Explicar** por qué el vocabulario es la variable que más separa trayectorias y la que menos se enseña deliberadamente.
3. **Decidir** —qué palabras se enseñan explícitamente en tu unidad y cómo se verifica que quedaron disponibles— y sostener la decisión con un fundamento escrito.
4. **Producir** la evidencia de la clase —una selección justificada de palabras de alto rendimiento con su plan de enseñanza y verificación— y contrastarla contra el criterio de logro.
...
|---|---|
| **Vocabulario receptivo y productivo** | palabras que el estudiante comprende al escucharlas o leerlas frente a las que efectivamente usa |
| **Palabras de alto rendimiento** | términos frecuentes en el lenguaje escrito y transversales a varias asignaturas, que rinden más al enseñarse |
| **Conocimiento del mundo** | información previa sobre el tema del texto; determina cuánto se comprende con las mismas palabras |
| **Efecto acumulativo** | dinámica por la que quien sabe más palabras aprende más palabras al leer, y quien sabe menos se rezaga |
...
2. Clasificar la situación distinguiendo **Vocabulario receptivo y productivo** de **Palabras de alto rendimiento**.
3. Decidir con fundamento, usando **Conocimiento del mundo** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Efecto acumulativo** a la vista.
...
| **Evidencia de logro** | qué muestra una selección justificada de palabras de alto rendimiento con su plan de enseñanza y verificación frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
El tamaño del vocabulario que se puede enseñar directamente es una fracción mínima del que un estudiante necesita: Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Vocabulario receptivo<br/>y productivo"]
    C --> A2["Palabras de alto<br/>rendimiento"]
    C --> A3["Conocimiento del mundo"]
    C --> A4["Efecto acumulativo"]
    A1 & A2 & A3 & A4 --> D{{"determinar qué palabras<br/>se enseñan<br/>explícitamente en tu<br/>unidad y cómo se<br/>verifica que quedaron…"}}
    D --> E["Evidencia de aprendizaje<br/>una selección<br/>justificada de palabras<br/>de alto rendimiento con<br/>su plan de enseñanza y…"]
...
El vocabulario se adquiere sobre todo por exposición al lenguaje, y esa exposición es profundamente desigual antes de que la escuela intervenga. La consecuencia es un efecto acumulativo: leer requiere vocabulario y a la vez lo construye, de modo que las diferencias se amplifican con los años. La escuela puede intervenir en dos frentes: enseñar deliberadamente un conjunto acotado de palabras de alto rendimiento, y construir conocimiento del mundo mediante lectura en voz alta y unidades temáticas con contenido real.

### 2. Frontera conceptual: qué es y qué no es

Los cuatro conceptos de esta clase se confunden entre sí con facilidad, y esa confusión no es
inocua: produce decisiones que atacan el problema equivocado. **Vocabulario receptivo y productivo** no es lo
mismo que **Palabras de alto rendimiento** —términos frecuentes en el lenguaje escrito y transversales a varias asignaturas, que rinden más al enseñarse—, y tratarlos como sinónimos hace
que la intervención se dirija al lugar incorrecto. Del mismo modo, **Conocimiento del mundo** y
**Efecto acumulativo** describen aspectos distintos de la misma situación: el primero
información previa sobre el tema del texto;, mientras el segundo dinámica por la que quien sabe más palabras aprende más palabras al leer, y quien sabe menos se rezaga.
...
- **Evidencia de logro.** Qué muestra una selección justificada de palabras de alto rendimiento con su plan de enseñanza y verificación frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
La enseñanza deliberada rinde cuando se eligen pocas palabras y se trabajan en profundidad: definición en lenguaje accesible, ejemplos y contraejemplos, uso en contextos distintos y recuperación espaciada. Elegir bien importa más que enseñar muchas: las palabras frecuentes en el lenguaje escrito y transversales a asignaturas rinden más que las técnicas de un solo tema. El resto del vocabulario se construye por volumen de lectura y de escucha, que la escuela puede aumentar deliberadamente.

### 5. Qué sostiene la evidencia y qué no

El tamaño del vocabulario que se puede enseñar directamente es una fracción mínima del que un estudiante necesita: la enseñanza explícita nunca reemplaza al volumen de exposición. Además, la relación entre vocabulario y comprensión es en parte indirecta —ambos dependen del conocimiento previo—, de modo que enseñar listas de palabras sin construir conocimiento del tema produce definiciones memorizadas sin efecto sobre la comprensión.
...
te deja en condiciones de qué palabras se enseñan explícitamente en tu unidad y cómo se verifica que quedaron disponibles, y esa decisión se sostiene solo si
...
|---|---|---|
| Romeo, R. et al. (2018). *Beyond the 30-Million-Word Gap*. | corrige la lectura simplista de la brecha de vocabulario y señala qué interacción importa realmente. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
| Snow, C., Burns, S. & Griffin, P. (eds.) (1998). *Preventing Reading Difficulties in Young Children*. | conecta lenguaje oral temprano con comprensión posterior con evidencia longitudinal. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Vocabulario receptivo y productivo** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Vocabulario receptivo y productivo de Palabras de alto rendimiento.** El trabajo aquí es separar lo observado de lo interpretado sobre **Palabras de alto rendimiento**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Conocimiento del mundo como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Conocimiento del mundo**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.

**Paso 4 — Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con Efecto acumulativo a la vista.** Con **Efecto acumulativo** ya delimitado, la pregunta pasa a ser de consecuencia: qué cambia para los estudiantes, para el tiempo de clase y para la carga del equipo. **Evidencia de partida** entrega la lectura observable; el juicio profesional sigue siendo humano y debe quedar firmado por quien lo hace.
...
|---|---|---|---|
| Intervenir sobre **Vocabulario receptivo y productivo** | Palabras que el estudiante comprende al escucharlas o leerlas frente a las que efectivamente usa | Cuando **Evidencia de partida** es observable y accionable dentro del plazo de la decisión. | Sobrerreaccionar a una señal parcial. |
| Intervenir sobre **Palabras de alto rendimiento** | Términos frecuentes en el lenguaje escrito y transversales a varias asignaturas, que rinden más al enseñarse | Cuando la primera explicación no distingue mecanismo ni responsable. | Convertir el concepto en etiqueta y no en intervención. |
| Observar antes de decidir | Reducir la incertidumbre antes de comprometer tiempo y credibilidad | Cuando la decisión es reversible y la evidencia disponible no distingue causas. | Observar indefinidamente y no decidir nunca. |
| Derivar o escalar | Poner la decisión donde están la competencia y la responsabilidad | Cuando hay normativa, resguardo de datos, salud o vulneración de derechos en juego. | Delegar hacia arriba lo que sí correspondía decidir en el aula. |

**Frontera de aplicación.** El tamaño del vocabulario que se puede enseñar directamente es una fracción mínima del que un estudiante necesita: Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre vocabulario y conocimiento del mundo |
|---|---|
...
Una selección justificada de palabras de alto rendimiento con su plan de enseñanza y verificación.

Guárdala en `evidence/P18-C221-vocabulario-y-conocimiento-del-mundo/` con estos archivos:
...
Selecciona diez palabras de alto rendimiento de tu próxima unidad. Enséñalas con recuperación espaciada y verifica su uso en producción escrita tres semanas después.
...
- [ ] la selección de palabras declara el criterio por el que se eligieron esas y no otras;
- [ ] existe verificación de uso en contexto y no solo de reconocimiento de la definición;
...
- Entregar listas de palabras para memorizar y evaluarlas con definiciones textuales.
- Suponer que el vocabulario se adquiere solo por leer, en estudiantes que aún leen poco y con dificultad.
...
La enseñanza deliberada de vocabulario es una de las intervenciones más equitativas disponibles: beneficia especialmente a estudiantes cuyo entorno no aporta el vocabulario académico. Para estudiantes que aprenden el castellano como segunda lengua, el trabajo de vocabulario es enseñanza de la lengua de instrucción y debe planificarse como tal.
...
1. ¿Qué diez palabras de tu próxima unidad rinden en más de una asignatura?
2. ¿Cómo sabrás si una palabra enseñada quedó disponible tres semanas después?
3. ¿Qué conocimiento del mundo asume el texto que vas a usar, y quién de tu curso no lo tiene?

## 📗 Fuentes y verificación

- Romeo, R. et al. (2018). *Beyond the 30-Million-Word Gap*. **Uso en esta clase:** corrige la lectura simplista de la brecha de vocabulario y señala qué interacción importa realmente. Lectura selectiva: índice y capítulos pertinentes; registra edición y páginas consultadas.
- Snow, C., Burns, S. & Griffin, P. (eds.) (1998). *Preventing Reading Difficulties in Young Children*. **Uso en esta clase:** conecta lenguaje oral temprano con comprensión posterior con evidencia longitudinal. Lectura selectiva: índice y capítulos pertinentes; registra edición y páginas consultadas.
...
Complementa la clase 220 y sostiene la 222: sin vocabulario, ninguna estrategia de comprensión produce comprensión. Enlaza con la clase 227.
...
|---|---|---|
| [← 220 · Fluidez lectora: medirla y desarrollarla](../class-04-fluidez-lectora-medirla-y-desarrollarla/README.md) | [Parte 18](../README.md) · [Programa](../../../README.md) | [222 · Comprensión lectora y sus estrategias →](../class-06-comprension-lectora-y-sus-estrategias/README.md) |
