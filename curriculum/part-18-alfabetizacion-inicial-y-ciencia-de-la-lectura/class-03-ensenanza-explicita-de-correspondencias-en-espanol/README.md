# Clase 219 — Enseñanza explícita de correspondencias en español

> **Parte 18 · Alfabetización inicial y ciencia de la lectura** — clase 3 de 12
...
**Decisión que habilita:** determinar el orden de enseñanza de las correspondencias y qué texto usa el estudiante mientras las aprende<br>
**Evidencia de aprendizaje:** una progresión de correspondencias con su justificación, textos asociados y criterio de avance

## 🎯 Propósito

Definir una progresión explícita de correspondencias entre grafemas y fonemas, con práctica en texto decodificable y criterio de avance.
...
2. **Explicar** qué cambia en la enseñanza de correspondencias cuando la ortografía es transparente como la del español.
3. **Decidir** —el orden de enseñanza de las correspondencias y qué texto usa el estudiante mientras las aprende— y sostener la decisión con un fundamento escrito.
4. **Producir** la evidencia de la clase —una progresión de correspondencias con su justificación, textos asociados y criterio de avance— y contrastarla contra el criterio de logro.
...
|---|---|
| **Correspondencia grafema-fonema** | relación sistemática entre una unidad escrita y el sonido que representa |
| **Transparencia ortográfica** | grado de regularidad entre escritura y pronunciación; el español es de los sistemas más transparentes |
| **Texto decodificable** | material compuesto principalmente por correspondencias ya enseñadas, que permite practicar sin adivinar |
| **Enseñanza sistemática** | secuencia planificada de antemano, con orden justificado y verificación, frente a la enseñanza según aparezca |
...
2. Clasificar la situación distinguiendo **Correspondencia grafema-fonema** de **Transparencia ortográfica**.
3. Decidir con fundamento, usando **Texto decodificable** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Enseñanza sistemática** a la vista.
...
| **Evidencia de logro** | qué muestra una progresión de correspondencias con su justificación, textos asociados y criterio de avance frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
La enseñanza sistemática es condición necesaria y no suficiente: Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Correspondencia<br/>grafema-fonema"]
    C --> A2["Transparencia<br/>ortográfica"]
    C --> A3["Texto decodificable"]
    C --> A4["Enseñanza sistemática"]
    A1 & A2 & A3 & A4 --> D{{"determinar el orden de<br/>enseñanza de las<br/>correspondencias y qué<br/>texto usa el estudiante<br/>mientras…"}}
    D --> E["Evidencia de aprendizaje<br/>una progresión de<br/>correspondencias con su<br/>justificación, textos<br/>asociados y criterio de<br/>avance"]
...
La enseñanza sistemática y explícita de las correspondencias produce mejores resultados que los enfoques que confían en el reconocimiento global o en el contexto, y la diferencia es mayor en los estudiantes con más riesgo de dificultad. Es una de las conclusiones mejor establecidas de la investigación educativa. La transparencia del español modifica el calendario, no el principio: como cada letra representa casi siempre el mismo sonido, la decodificación se domina antes que en inglés y la fase intensiva es más breve, con un puñado de irregularidades reales que se enseñan aparte.

### 2. Frontera conceptual: qué es y qué no es

Los cuatro conceptos de esta clase se confunden entre sí con facilidad, y esa confusión no es
inocua: produce decisiones que atacan el problema equivocado. **Correspondencia grafema-fonema** no es lo
mismo que **Transparencia ortográfica** —grado de regularidad entre escritura y pronunciación; el español es de los sistemas más transparentes—, y tratarlos como sinónimos hace
que la intervención se dirija al lugar incorrecto. Del mismo modo, **Texto decodificable** y
**Enseñanza sistemática** describen aspectos distintos de la misma situación: el primero
material compuesto principalmente por correspondencias ya enseñadas, que permite practicar sin adivinar, mientras el segundo secuencia planificada de antemano, con orden justificado y verificación, frente a la enseñanza según aparezca.
...
- **Evidencia de logro.** Qué muestra una progresión de correspondencias con su justificación, textos asociados y criterio de avance frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
Una progresión profesional decide el orden por frecuencia y por productividad —qué correspondencias permiten leer más palabras antes—, evita introducir juntas letras confundibles y asegura que el estudiante practique con textos hechos de lo que ya sabe. El texto decodificable no es literatura y no pretende serlo: es material de práctica, y convive con lectura en voz alta de textos ricos que el docente lee y el estudiante todavía no puede leer solo.

### 5. Qué sostiene la evidencia y qué no

La enseñanza sistemática es condición necesaria y no suficiente: no produce comprensión por sí sola, que depende de vocabulario y conocimiento del mundo. Trasladar sin ajuste los plazos y las secuencias de la investigación anglosajona al español produce programas innecesariamente largos. Y el material decodificable, usado como única dieta lectora, empobrece el contacto con el lenguaje escrito real.
...
te deja en condiciones de el orden de enseñanza de las correspondencias y qué texto usa el estudiante mientras las aprende, y esa decisión se sostiene solo si
...
|---|---|---|
| Seidenberg, M. (2017). *Language at the Speed of Sight*. | explica por qué la enseñanza explícita funciona en términos del mecanismo, no de la ideología. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
| Snow, C., Burns, S. & Griffin, P. (eds.) (1998). *Preventing Reading Difficulties in Young Children*. | el informe que fijó la prevención temprana como criterio de política pública. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Correspondencia grafema-fonema** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Correspondencia grafema-fonema de Transparencia ortográfica.** El trabajo aquí es separar lo observado de lo interpretado sobre **Transparencia ortográfica**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Texto decodificable como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Texto decodificable**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.

**Paso 4 — Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con Enseñanza sistemática a la vista.** Con **Enseñanza sistemática** ya delimitado, la pregunta pasa a ser de consecuencia: qué cambia para los estudiantes, para el tiempo de clase y para la carga del equipo. **Evidencia de partida** entrega la lectura observable; el juicio profesional sigue siendo humano y debe quedar firmado por quien lo hace.
...
|---|---|---|---|
| Intervenir sobre **Correspondencia grafema-fonema** | Relación sistemática entre una unidad escrita y el sonido que representa | Cuando **Evidencia de partida** es observable y accionable dentro del plazo de la decisión. | Sobrerreaccionar a una señal parcial. |
| Intervenir sobre **Transparencia ortográfica** | Grado de regularidad entre escritura y pronunciación; el español es de los sistemas más transparentes | Cuando la primera explicación no distingue mecanismo ni responsable. | Convertir el concepto en etiqueta y no en intervención. |
| Observar antes de decidir | Reducir la incertidumbre antes de comprometer tiempo y credibilidad | Cuando la decisión es reversible y la evidencia disponible no distingue causas. | Observar indefinidamente y no decidir nunca. |
| Derivar o escalar | Poner la decisión donde están la competencia y la responsabilidad | Cuando hay normativa, resguardo de datos, salud o vulneración de derechos en juego. | Delegar hacia arriba lo que sí correspondía decidir en el aula. |

**Frontera de aplicación.** La enseñanza sistemática es condición necesaria y no suficiente: Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre enseñanza explícita de correspondencias en español |
|---|---|
...
Una progresión de correspondencias con su justificación, textos asociados y criterio de avance.

Guárdala en `evidence/P18-C219-ensenanza-explicita-de-correspondencias-en-espanol/` con estos archivos:
...
Escribe la progresión completa de tu curso con su justificación. Marca los tramos donde el material disponible no coincide con lo enseñado y propone el reemplazo.
...
- [ ] la progresión declara el orden elegido y la razón de ese orden;
- [ ] cada tramo tiene texto de práctica coherente con lo enseñado y un criterio de avance;
...
- Introducir las letras según el orden del texto escolar sin criterio de frecuencia ni de productividad.
- Pedir que el estudiante lea textos con correspondencias que nadie le enseñó, y llamar a eso lectura autónoma.
...
La enseñanza sistemática beneficia a todos y resulta indispensable para quienes tienen dificultades: son exactamente los estudiantes a quienes los métodos basados en adivinar dejan sin herramienta. Aumentar la dosis y la explicitud es la primera adecuación, antes que cualquier otra.
...
1. ¿Cuál es el orden de correspondencias de tu curso y quién lo decidió?
2. ¿Qué proporción del texto que lee tu estudiante está compuesta de lo que ya se le enseñó?
3. ¿Cuánto debería durar la fase intensiva en español, y en qué basas ese plazo?
...
Continúa la clase 218 y alimenta la 220: sin decodificación establecida, la práctica de fluidez no tiene sobre qué operar.
...
|---|---|---|
| [← 218 · Conciencia fonológica y principio alfabético](../class-02-conciencia-fonologica-y-principio-alfabetico/README.md) | [Parte 18](../README.md) · [Programa](../../../README.md) | [220 · Fluidez lectora: medirla y desarrollarla →](../class-04-fluidez-lectora-medirla-y-desarrollarla/README.md) |
