# Clase 226 — Intervención por niveles y grupos de refuerzo

> **Parte 18 · Alfabetización inicial y ciencia de la lectura** — clase 10 de 12
...
**Decisión que habilita:** determinar quién entra a intervención intensiva, con qué dosis y bajo qué criterio de salida<br>
**Evidencia de aprendizaje:** un esquema de intervención por niveles con criterios de entrada y salida, dosis y responsables

## 🎯 Propósito

Organizar la enseñanza lectora en niveles de intensidad, con criterios de entrada y salida, para concentrar los recursos escasos donde rinden más.
...
2. **Explicar** cómo se organiza el apoyo lector de una escuela para que no dependa de la buena voluntad de un docente.
3. **Decidir** —quién entra a intervención intensiva, con qué dosis y bajo qué criterio de salida— y sostener la decisión con un fundamento escrito.
4. **Producir** la evidencia de la clase —un esquema de intervención por niveles con criterios de entrada y salida, dosis y responsables— y contrastarla contra el criterio de logro.
...
|---|---|
| **Intervención por niveles** | organización de la enseñanza en capas de intensidad creciente, con la enseñanza de aula como primera capa |
| **Enseñanza de calidad universal** | primera capa que atiende a todos; si falla, ninguna capa posterior alcanza a compensarla |
| **Criterio de entrada y salida** | umbral declarado que define quién recibe apoyo adicional y cuándo lo deja |
| **Dosis** | combinación de frecuencia, duración y tamaño de grupo que define la intensidad real de un apoyo |
...
2. Clasificar la situación distinguiendo **Intervención por niveles** de **Enseñanza de calidad universal**.
3. Decidir con fundamento, usando **Criterio de entrada y salida** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Dosis** a la vista.
...
| **Evidencia de logro** | qué muestra un esquema de intervención por niveles con criterios de entrada y salida, dosis y responsables frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
El modelo supone que existe capacidad instalada para la primera capa y personal para las siguientes, lo que no siempre ocurre. Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Intervención por<br/>niveles"]
    C --> A2["Enseñanza de calidad<br/>universal"]
    C --> A3["Criterio de entrada y<br/>salida"]
    C --> A4["Dosis"]
    A1 & A2 & A3 & A4 --> D{{"determinar quién entra a<br/>intervención intensiva,<br/>con qué dosis y bajo qué<br/>criterio de salida"}}
    D --> E["Evidencia de aprendizaje<br/>un esquema de<br/>intervención por niveles<br/>con criterios de entrada<br/>y salida, dosis y<br/>responsables"]
...
Ninguna escuela tiene recursos para dar apoyo intensivo a todos, y por eso la pregunta relevante es de asignación. El modelo por niveles resuelve esa asignación con una lógica simple: se asegura primero la enseñanza de calidad para todos, se identifica con medidas breves quién no progresa, se agrega intensidad en grupo pequeño y se reserva la mayor intensidad para los pocos que aún no responden. La primera capa es la más importante: si la enseñanza de aula es deficiente, la demanda de apoyo desborda cualquier estructura.

### 2. Frontera conceptual: qué es y qué no es

Los cuatro conceptos de esta clase se confunden entre sí con facilidad, y esa confusión no es
inocua: produce decisiones que atacan el problema equivocado. **Intervención por niveles** no es lo
mismo que **Enseñanza de calidad universal** —primera capa que atiende a todos; si falla, ninguna capa posterior alcanza a compensarla—, y tratarlos como sinónimos hace
que la intervención se dirija al lugar incorrecto. Del mismo modo, **Criterio de entrada y salida** y
**Dosis** describen aspectos distintos de la misma situación: el primero
umbral declarado que define quién recibe apoyo adicional y cuándo lo deja, mientras el segundo combinación de frecuencia, duración y tamaño de grupo que define la intensidad real de un apoyo.
...
- **Evidencia de logro.** Qué muestra un esquema de intervención por niveles con criterios de entrada y salida, dosis y responsables frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
Un esquema aplicable declara cuántos estudiantes puede sostener cada capa, con qué frecuencia y en qué horario real —no en el que sobra—, quién ejecuta y quién monitorea. Los criterios de entrada y salida se fijan antes para evitar que el apoyo se vuelva permanente por inercia. La revisión periódica en equipo es la que hace circular a los estudiantes entre capas; sin ella, el grupo de apoyo se congela con los mismos nombres todo el año.

### 5. Qué sostiene la evidencia y qué no

El modelo supone que existe capacidad instalada para la primera capa y personal para las siguientes, lo que no siempre ocurre. Su evidencia es más sólida en lectura inicial que en cursos superiores o en otras áreas. Además, aplicado con rigidez se convierte en un sistema de clasificación temprana con efectos de expectativa, que es exactamente lo contrario de su propósito.
...
te deja en condiciones de quién entra a intervención intensiva, con qué dosis y bajo qué criterio de salida, y esa decisión se sostiene solo si
...
|---|---|---|
| Fuchs, D. & Fuchs, L. (2006). *Introduction to Response to Intervention*. | el modelo original con sus condiciones de funcionamiento explícitas. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
| Snowling, M. & Hulme, C. (2011). *Evidence-Based Interventions for Reading and Language Difficulties*. | qué intensidad hace falta realmente para mover el resultado en los casos resistentes. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Intervención por niveles** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Intervención por niveles de Enseñanza de calidad universal.** El trabajo aquí es separar lo observado de lo interpretado sobre **Enseñanza de calidad universal**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Criterio de entrada y salida como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Criterio de entrada y salida**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.

**Paso 4 — Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con Dosis a la vista.** Con **Dosis** ya delimitado, la pregunta pasa a ser de consecuencia: qué cambia para los estudiantes, para el tiempo de clase y para la carga del equipo. **Evidencia de partida** entrega la lectura observable; el juicio profesional sigue siendo humano y debe quedar firmado por quien lo hace.
...
|---|---|---|---|
| Intervenir sobre **Intervención por niveles** | Organización de la enseñanza en capas de intensidad creciente, con la enseñanza de aula como primera capa | Cuando **Evidencia de partida** es observable y accionable dentro del plazo de la decisión. | Sobrerreaccionar a una señal parcial. |
| Intervenir sobre **Enseñanza de calidad universal** | Primera capa que atiende a todos; si falla, ninguna capa posterior alcanza a compensarla | Cuando la primera explicación no distingue mecanismo ni responsable. | Convertir el concepto en etiqueta y no en intervención. |
| Observar antes de decidir | Reducir la incertidumbre antes de comprometer tiempo y credibilidad | Cuando la decisión es reversible y la evidencia disponible no distingue causas. | Observar indefinidamente y no decidir nunca. |
| Derivar o escalar | Poner la decisión donde están la competencia y la responsabilidad | Cuando hay normativa, resguardo de datos, salud o vulneración de derechos en juego. | Delegar hacia arriba lo que sí correspondía decidir en el aula. |

**Frontera de aplicación.** El modelo supone que existe capacidad instalada para la primera capa y personal para las siguientes, lo que no siempre ocurre. Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre intervención por niveles y grupos de refuerzo |
|---|---|
...
Un esquema de intervención por niveles con criterios de entrada y salida, dosis y responsables.

Guárdala en `evidence/P18-C226-intervencion-por-niveles-y-grupos-de-refuerzo/` con estos archivos:
...
Diseña el esquema de tu establecimiento con capacidad real por capa. Simula un semestre con los datos del curso y muestra cuántos estudiantes entrarían y saldrían.
...
- [ ] el esquema declara criterios de entrada y salida con umbral observable;
- [ ] la dosis está expresada en frecuencia, duración, tamaño de grupo y horario real;
...
- Montar capas de apoyo sobre una enseñanza de aula deficiente y esperar que compensen.
- Dejar a los mismos estudiantes en el grupo de apoyo todo el año por no fijar criterio de salida.
...
El apoyo por niveles no reemplaza al programa de integración ni al plan de apoyo individual: los ordena. El riesgo a vigilar es que el horario del apoyo se tome de las asignaturas que más motivan al estudiante, con lo que el precio del apoyo termina siendo el vínculo con la escuela.
...
1. ¿Cuántos estudiantes puede sostener realmente tu segunda capa esta semana?
2. ¿En qué horario ocurre el apoyo y qué deja de recibir el estudiante mientras tanto?
3. ¿Quién decide que un estudiante sale del apoyo, y con qué evidencia?

## 📗 Fuentes y verificación

- Fuchs, D. & Fuchs, L. (2006). *Introduction to Response to Intervention*. **Uso en esta clase:** el modelo original con sus condiciones de funcionamiento explícitas. Lectura selectiva: índice y capítulos pertinentes; registra edición y páginas consultadas.
- Snowling, M. & Hulme, C. (2011). *Evidence-Based Interventions for Reading and Language Difficulties*. **Uso en esta clase:** qué intensidad hace falta realmente para mover el resultado en los casos resistentes. Lectura selectiva: índice y capítulos pertinentes; registra edición y páginas consultadas.
...
Aplica las clases 224 y 225 y prepara el proyecto integrador. Se articula con la parte 08 y con la clase 191.
...
|---|---|---|
| [← 225 · Evaluación de la lectura por componentes](../class-09-evaluacion-de-la-lectura-por-componentes/README.md) | [Parte 18](../README.md) · [Programa](../../../README.md) | [227 · Alfabetización disciplinar en las asignaturas →](../class-11-alfabetizacion-disciplinar-en-las-asignaturas/README.md) |
