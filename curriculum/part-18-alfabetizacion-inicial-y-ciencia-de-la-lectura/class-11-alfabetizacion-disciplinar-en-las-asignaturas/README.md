# Clase 227 — Alfabetización disciplinar en las asignaturas

> **Parte 18 · Alfabetización inicial y ciencia de la lectura** — clase 11 de 12

**Estado de evidencia:** `EMERGENTE` · **Etapa:** 🟤 Etapa F — Especialización y desafíos contemporáneos · **Población de referencia:** parvularia y primer ciclo básico, con proyección a todo el sistema<br>
**Decisión que habilita:** determinar qué práctica lectora propia de tu asignatura vas a enseñar explícitamente este semestre<br>
**Evidencia de aprendizaje:** una secuencia de alfabetización disciplinar con el tipo de texto, la forma de leerlo y la producción asociada

## 🎯 Propósito

Enseñar las formas de leer y escribir propias de cada disciplina, en vez de delegar la lectura al profesor de lenguaje.
...
2. **Explicar** por qué cada asignatura lee distinto y por qué eso no se enseña en ninguna.
3. **Decidir** —qué práctica lectora propia de tu asignatura vas a enseñar explícitamente este semestre— y sostener la decisión con un fundamento escrito.
4. **Producir** la evidencia de la clase —una secuencia de alfabetización disciplinar con el tipo de texto, la forma de leerlo y la producción asociada— y contrastarla contra el criterio de logro.
...
|---|---|
| **Alfabetización disciplinar** | conjunto de prácticas de lectura y escritura propias de un campo: qué se considera evidencia, cómo se cita, qué se pregunta al texto |
| **Lectura de fuentes** | práctica histórica de interrogar un documento por su origen, contexto e intención antes que por su contenido |
| **Texto multimodal** | material que combina prosa, símbolos, gráficos o ecuaciones y exige leerlos de forma coordinada |
| **Transferencia limitada** | hecho de que la habilidad lectora general no basta para leer bien en un dominio específico |
...
2. Clasificar la situación distinguiendo **Alfabetización disciplinar** de **Lectura de fuentes**.
3. Decidir con fundamento, usando **Texto multimodal** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Transferencia limitada** a la vista.
...
| **Evidencia de logro** | qué muestra una secuencia de alfabetización disciplinar con el tipo de texto, la forma de leerlo y la producción asociada frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
La evidencia sobre alfabetización disciplinar es más reciente y menos concluyente que la de la alfabetización inicial: Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Alfabetización<br/>disciplinar"]
    C --> A2["Lectura de fuentes"]
    C --> A3["Texto multimodal"]
    C --> A4["Transferencia limitada"]
    A1 & A2 & A3 & A4 --> D{{"determinar qué práctica<br/>lectora propia de tu<br/>asignatura vas a enseñar<br/>explícitamente este…"}}
    D --> E["Evidencia de aprendizaje<br/>una secuencia de<br/>alfabetización<br/>disciplinar con el tipo<br/>de texto, la forma de<br/>leerlo y la…"]
...
Un historiador, un físico y un abogado no leen igual, y esa diferencia no es de estilo sino de método: cada campo define qué cuenta como evidencia y qué se le pregunta a un texto. La escuela suele tratar la lectura como una habilidad general que se adquiere en lenguaje y luego se aplica en todas partes. La investigación sobre lectura experta sugiere lo contrario: buena parte de la dificultad de un estudiante en historia o en ciencias es de alfabetización disciplinar, no de comprensión general.

### 2. Frontera conceptual: qué es y qué no es

Los cuatro conceptos de esta clase se confunden entre sí con facilidad, y esa confusión no es
inocua: produce decisiones que atacan el problema equivocado. **Alfabetización disciplinar** no es lo
mismo que **Lectura de fuentes** —práctica histórica de interrogar un documento por su origen, contexto e intención antes que por su contenido—, y tratarlos como sinónimos hace
que la intervención se dirija al lugar incorrecto. Del mismo modo, **Texto multimodal** y
**Transferencia limitada** describen aspectos distintos de la misma situación: el primero
material que combina prosa, símbolos, gráficos o ecuaciones y exige leerlos de forma coordinada, mientras el segundo hecho de que la habilidad lectora general no basta para leer bien en un dominio específico.
...
- **Evidencia de logro.** Qué muestra una secuencia de alfabetización disciplinar con el tipo de texto, la forma de leerlo y la producción asociada frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
Enseñar alfabetización disciplinar significa hacer explícito lo que el docente experto hace automáticamente: mostrar cómo interroga una fuente, cómo lee un gráfico junto al párrafo que lo comenta, qué anota al margen y qué descarta. Se modela en voz alta, se practica con textos reales del campo y se evalúa con producciones propias de la disciplina. Es enseñanza de contenido y de lectura al mismo tiempo, no una actividad adicional.

### 5. Qué sostiene la evidencia y qué no

La evidencia sobre alfabetización disciplinar es más reciente y menos concluyente que la de la alfabetización inicial: hay descripciones sólidas de la práctica experta y menos estudios que muestren efectos consistentes de enseñarla. Además, exige docentes que dominen su disciplina lo bastante como para explicitar su propio proceso, lo que no siempre está disponible. Y no reemplaza a la enseñanza básica de lectura: un estudiante que no decodifica no accede a ninguna disciplina.
...
te deja en condiciones de qué práctica lectora propia de tu asignatura vas a enseñar explícitamente este semestre, y esa decisión se sostiene solo si
...
|---|---|---|
| Seidenberg, M. (2017). *Language at the Speed of Sight*. | aporta el mecanismo que explica por qué el conocimiento del dominio pesa tanto en la comprensión. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
| Shulman, L. (1986). *Those Who Understand: Knowledge Growth in Teaching*. | fundamenta por qué la enseñanza de la lectura de un campo es parte del saber didáctico de ese campo. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Alfabetización disciplinar** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Alfabetización disciplinar de Lectura de fuentes.** El trabajo aquí es separar lo observado de lo interpretado sobre **Lectura de fuentes**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Texto multimodal como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Texto multimodal**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.

**Paso 4 — Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con Transferencia limitada a la vista.** Con **Transferencia limitada** ya delimitado, la pregunta pasa a ser de consecuencia: qué cambia para los estudiantes, para el tiempo de clase y para la carga del equipo. **Evidencia de partida** entrega la lectura observable; el juicio profesional sigue siendo humano y debe quedar firmado por quien lo hace.
...
|---|---|---|---|
| Intervenir sobre **Alfabetización disciplinar** | Conjunto de prácticas de lectura y escritura propias de un campo: qué se considera evidencia, cómo se cita, qué se pregunta al texto | Cuando **Evidencia de partida** es observable y accionable dentro del plazo de la decisión. | Sobrerreaccionar a una señal parcial. |
| Intervenir sobre **Lectura de fuentes** | Práctica histórica de interrogar un documento por su origen, contexto e intención antes que por su contenido | Cuando la primera explicación no distingue mecanismo ni responsable. | Convertir el concepto en etiqueta y no en intervención. |
| Observar antes de decidir | Reducir la incertidumbre antes de comprometer tiempo y credibilidad | Cuando la decisión es reversible y la evidencia disponible no distingue causas. | Observar indefinidamente y no decidir nunca. |
| Derivar o escalar | Poner la decisión donde están la competencia y la responsabilidad | Cuando hay normativa, resguardo de datos, salud o vulneración de derechos en juego. | Delegar hacia arriba lo que sí correspondía decidir en el aula. |

**Frontera de aplicación.** La evidencia sobre alfabetización disciplinar es más reciente y menos concluyente que la de la alfabetización inicial: Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre alfabetización disciplinar en las asignaturas |
|---|---|
...
Una secuencia de alfabetización disciplinar con el tipo de texto, la forma de leerlo y la producción asociada.

Guárdala en `evidence/P18-C227-alfabetizacion-disciplinar-en-las-asignaturas/` con estos archivos:
...
Graba tu propio proceso al leer un texto de tu disciplina pensando en voz alta. Conviértelo en una clase de modelamiento y aplícala con un texto real del curso.
...
- [ ] la secuencia declara la práctica lectora propia del campo y cómo se modela;
- [ ] la producción evaluada es del tipo que la disciplina reconoce como legítimo;
...
- Delegar toda la lectura al docente de lenguaje y evaluar en historia una comprensión que nadie enseñó.
- Sustituir la enseñanza disciplinar por técnicas generales de subrayado y resumen.
...
Hacer explícitas las reglas implícitas de cada disciplina beneficia sobre todo a los estudiantes cuyo entorno no las transmite fuera de la escuela. Lo que para unos es evidente por familiaridad, para otros solo existe si alguien lo enseña.
...
1. ¿Qué le pregunta a un texto un experto de tu disciplina y dónde lo enseñas?
2. ¿Qué parte de la dificultad de tus estudiantes es comprensión general y qué parte es disciplinar?
3. ¿Qué producción escrita propia de tu campo pides, y la modelaste antes de pedirla?
...
Cierra el recorrido técnico de la parte 18 y conecta con las partes 04, 05 y 10. Prepara el proyecto integrador.
...
|---|---|---|
| [← 226 · Intervención por niveles y grupos de refuerzo](../class-10-intervencion-por-niveles-y-grupos-de-refuerzo/README.md) | [Parte 18](../README.md) · [Programa](../../../README.md) | [228 · Proyecto integrador: plan lector de establecimiento →](../class-12-proyecto-integrador/README.md) |
