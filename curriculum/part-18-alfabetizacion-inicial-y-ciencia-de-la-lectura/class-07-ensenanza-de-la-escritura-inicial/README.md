# Clase 223 — Enseñanza de la escritura inicial

> **Parte 18 · Alfabetización inicial y ciencia de la lectura** — clase 7 de 12
...
**Decisión que habilita:** determinar qué componente de la escritura enseñas en cada tramo y qué se corrige en cada entrega<br>
**Evidencia de aprendizaje:** una secuencia de escritura con transcripción, composición y revisión declaradas por separado

## 🎯 Propósito

Enseñar escritura inicial distinguiendo transcripción de composición, con práctica deliberada de ambas y retroalimentación que corrija lo enseñado.
...
2. **Explicar** por qué escribir es la tarea escolar que más carga impone y la que menos se enseña por partes.
3. **Decidir** —qué componente de la escritura enseñas en cada tramo y qué se corrige en cada entrega— y sostener la decisión con un fundamento escrito.
4. **Producir** la evidencia de la clase —una secuencia de escritura con transcripción, composición y revisión declaradas por separado— y contrastarla contra el criterio de logro.
...
|---|---|
| **Transcripción** | componentes de bajo nivel de la escritura: caligrafía, ortografía y automatización del trazo |
| **Composición** | generación y organización de ideas, elección léxica y estructura del texto |
| **Estrategias autorreguladas** | enseñanza explícita del proceso de escribir —planificar, redactar, revisar— con andamiaje decreciente |
| **Retroalimentación focalizada** | corrección de un aspecto declarado de antemano, en vez de marcar todo lo corregible |
...
2. Clasificar la situación distinguiendo **Transcripción** de **Composición**.
3. Decidir con fundamento, usando **Estrategias autorreguladas** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Retroalimentación focalizada** a la vista.
...
| **Evidencia de logro** | qué muestra una secuencia de escritura con transcripción, composición y revisión declaradas por separado frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
La evidencia sobre enseñanza de la escritura es más débil que la de la lectura y proviene mayoritariamente del inglés, con implicancias distintas para una ortografía transparente. Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Transcripción"]
    C --> A2["Composición"]
    C --> A3["Estrategias<br/>autorreguladas"]
    C --> A4["Retroalimentación<br/>focalizada"]
    A1 & A2 & A3 & A4 --> D{{"determinar qué<br/>componente de la<br/>escritura enseñas en<br/>cada tramo y qué se<br/>corrige en cada entrega"}}
    D --> E["Evidencia de aprendizaje<br/>una secuencia de<br/>escritura con<br/>transcripción,<br/>composición y revisión<br/>declaradas por separado"]
...
Escribir es la tarea escolar que más recursos cognitivos consume simultáneamente: hay que decidir qué decir, cómo decirlo, cómo se escriben las palabras y cómo se trazan las letras. Cuando la transcripción no está automatizada, consume la capacidad que la composición necesitaba, y el resultado es un texto pobre que se interpreta como falta de ideas. Separar los componentes permite enseñar cada uno con la práctica que le corresponde y diagnosticar qué falla realmente.

### 2. Frontera conceptual: qué es y qué no es

Los cuatro conceptos de esta clase se confunden entre sí con facilidad, y esa confusión no es
inocua: produce decisiones que atacan el problema equivocado. **Transcripción** no es lo
mismo que **Composición** —generación y organización de ideas, elección léxica y estructura del texto—, y tratarlos como sinónimos hace
que la intervención se dirija al lugar incorrecto. Del mismo modo, **Estrategias autorreguladas** y
**Retroalimentación focalizada** describen aspectos distintos de la misma situación: el primero
enseñanza explícita del proceso de escribir —planificar, redactar, revisar— con andamiaje decreciente, mientras el segundo corrección de un aspecto declarado de antemano, en vez de marcar todo lo corregible.
...
- **Evidencia de logro.** Qué muestra una secuencia de escritura con transcripción, composición y revisión declaradas por separado frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
La enseñanza que rinde combina práctica de transcripción hasta la automatización, enseñanza explícita del proceso de composición con modelamiento y andamiaje que se retira, y revisión con criterios conocidos de antemano. La retroalimentación funciona cuando es focalizada: corregir un aspecto declarado, no marcar cada error del texto. Escribir mucho sin enseñanza produce sobre todo consolidación de lo que ya se hacía.

### 5. Qué sostiene la evidencia y qué no

La evidencia sobre enseñanza de la escritura es más débil que la de la lectura y proviene mayoritariamente del inglés, con implicancias distintas para una ortografía transparente. El efecto de la enseñanza explícita del proceso es sólido en textos escolares acotados; su transferencia a la escritura disciplinar avanzada está menos documentada. Y ninguna cantidad de método compensa no tener nada que decir sobre el tema.
...
te deja en condiciones de qué componente de la escritura enseñas en cada tramo y qué se corrige en cada entrega, y esa decisión se sostiene solo si
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Transcripción** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Transcripción de Composición.** El trabajo aquí es separar lo observado de lo interpretado sobre **Composición**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Estrategias autorreguladas como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Estrategias autorreguladas**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.

**Paso 4 — Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con Retroalimentación focalizada a la vista.** Con **Retroalimentación focalizada** ya delimitado, la pregunta pasa a ser de consecuencia: qué cambia para los estudiantes, para el tiempo de clase y para la carga del equipo. **Evidencia de partida** entrega la lectura observable; el juicio profesional sigue siendo humano y debe quedar firmado por quien lo hace.
...
|---|---|---|---|
| Intervenir sobre **Transcripción** | Componentes de bajo nivel de la escritura: caligrafía, ortografía y automatización del trazo | Cuando **Evidencia de partida** es observable y accionable dentro del plazo de la decisión. | Sobrerreaccionar a una señal parcial. |
| Intervenir sobre **Composición** | Generación y organización de ideas, elección léxica y estructura del texto | Cuando la primera explicación no distingue mecanismo ni responsable. | Convertir el concepto en etiqueta y no en intervención. |
| Observar antes de decidir | Reducir la incertidumbre antes de comprometer tiempo y credibilidad | Cuando la decisión es reversible y la evidencia disponible no distingue causas. | Observar indefinidamente y no decidir nunca. |
| Derivar o escalar | Poner la decisión donde están la competencia y la responsabilidad | Cuando hay normativa, resguardo de datos, salud o vulneración de derechos en juego. | Delegar hacia arriba lo que sí correspondía decidir en el aula. |

**Frontera de aplicación.** La evidencia sobre enseñanza de la escritura es más débil que la de la lectura y proviene mayoritariamente del inglés, con implicancias distintas para una ortografía transparente. Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre enseñanza de la escritura inicial |
|---|---|
...
Una secuencia de escritura con transcripción, composición y revisión declaradas por separado.

Guárdala en `evidence/P18-C223-ensenanza-de-la-escritura-inicial/` con estos archivos:
...
Toma tres textos de tus estudiantes y clasifica cada dificultad como transcripción o composición. Diseña dos semanas de práctica para el componente que domine el diagnóstico.
...
- [ ] la secuencia distingue explícitamente transcripción, composición y revisión;
- [ ] cada entrega declara de antemano qué aspecto se retroalimenta;
...
- Corregir todo en cada texto y anular la señal: el estudiante no sabe qué debía mejorar.
- Pedir composición extensa a estudiantes que aún no automatizan la transcripción, y leer el resultado como falta de ideas.
...
Para estudiantes con disgrafía o dificultad motora, automatizar la transcripción puede no ser una meta razonable y corresponde ofrecer vías alternativas —teclado, dictado— sin reducir la exigencia de composición. Confundir ambas cosas es lo que produce evaluaciones que miden caligrafía y las llaman escritura.
...
Se apoya en la clase 219 y complementa la 222. Prepara la 227, donde escribir es la forma de aprender el contenido de cada asignatura.
...
|---|---|---|
| [← 222 · Comprensión lectora y sus estrategias](../class-06-comprension-lectora-y-sus-estrategias/README.md) | [Parte 18](../README.md) · [Programa](../../../README.md) | [224 · Dislexia y dificultades específicas de lectura →](../class-08-dislexia-y-dificultades-especificas-de-lectura/README.md) |
