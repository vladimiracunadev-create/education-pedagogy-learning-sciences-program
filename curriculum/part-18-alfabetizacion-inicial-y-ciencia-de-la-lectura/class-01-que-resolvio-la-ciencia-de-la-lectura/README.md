...
**Decisión que habilita:** determinar qué componente de la lectura está fallando en tu curso antes de elegir cualquier programa o material<br>
...
flowchart TB
    ...
    C --> A1["Modelo simple de la<br/>lectura"]
    C --> A2["Reconocimiento de<br/>palabras"]
    C --> A3["Comprensión del<br/>lenguaje"]
    C --> A4["Cuerdas de la lectura"]
    A1 & A2 & A3 & A4 --> D{{"determinar qué<br/>componente de la lectura<br/>está fallando en tu<br/>curso antes de elegir<br/>cualquier…"}}
    D --> E["Evidencia de aprendizaje<br/>un diagnóstico de curso<br/>que separa<br/>decodificación, fluidez,<br/>vocabulario y<br/>comprensión con…"]
