# Clase 225 — Evaluación de la lectura por componentes

> **Parte 18 · Alfabetización inicial y ciencia de la lectura** — clase 9 de 12
...
**Decisión que habilita:** determinar qué se mide, cuándo y con qué instrumento en el sistema de evaluación lectora de tu establecimiento<br>
**Evidencia de aprendizaje:** un calendario de evaluación lectora con instrumento, frecuencia, responsable y uso previsto de cada medida

## 🎯 Propósito

Construir un sistema de evaluación lectora por componentes, con instrumentos breves, comparables y repetibles a lo largo del año.
...
2. **Explicar** por qué una sola prueba de lectura impide decidir y cuatro medidas breves permiten hacerlo.
3. **Decidir** —qué se mide, cuándo y con qué instrumento en el sistema de evaluación lectora de tu establecimiento— y sostener la decisión con un fundamento escrito.
4. **Producir** la evidencia de la clase —un calendario de evaluación lectora con instrumento, frecuencia, responsable y uso previsto de cada medida— y contrastarla contra el criterio de logro.
...
|---|---|
| **Evaluación por componentes** | medición separada de decodificación, fluidez, vocabulario y comprensión para localizar la dificultad |
| **Medida breve repetible** | instrumento de pocos minutos, aplicable varias veces al año, que permite ver progreso y no solo estado |
| **Punto de corte** | umbral que separa quién requiere intervención; es una decisión, no un hecho natural |
| **Uso previsto** | decisión que se tomará con el resultado, declarada antes de aplicar el instrumento |
...
2. Clasificar la situación distinguiendo **Evaluación por componentes** de **Medida breve repetible**.
3. Decidir con fundamento, usando **Punto de corte** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Uso previsto** a la vista.
...
| **Evidencia de logro** | qué muestra un calendario de evaluación lectora con instrumento, frecuencia, responsable y uso previsto de cada medida frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
Las medidas breves miden bien lo que miden y nada más: Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Evaluación por<br/>componentes"]
    C --> A2["Medida breve repetible"]
    C --> A3["Punto de corte"]
    C --> A4["Uso previsto"]
    A1 & A2 & A3 & A4 --> D{{"determinar qué se mide,<br/>cuándo y con qué<br/>instrumento en el<br/>sistema de evaluación<br/>lectora de tu…"}}
    D --> E["Evidencia de aprendizaje<br/>un calendario de<br/>evaluación lectora con<br/>instrumento, frecuencia,<br/>responsable y uso<br/>previsto de…"]
...
La evaluación lectora escolar suele consistir en una prueba de comprensión aplicada dos veces al año, que informa que hay un problema sin decir dónde está. Un sistema útil hace lo contrario: mide poco, breve y seguido, y separa componentes. La virtud de las medidas breves repetibles es que muestran pendiente y no solo altura: un estudiante bajo que progresa rápido y otro bajo que no progresa requieren decisiones opuestas, y una medición anual no distingue entre ambos.

### 2. Frontera conceptual: qué es y qué no es

Los cuatro conceptos de esta clase se confunden entre sí con facilidad, y esa confusión no es
inocua: produce decisiones que atacan el problema equivocado. **Evaluación por componentes** no es lo
mismo que **Medida breve repetible** —instrumento de pocos minutos, aplicable varias veces al año, que permite ver progreso y no solo estado—, y tratarlos como sinónimos hace
que la intervención se dirija al lugar incorrecto. Del mismo modo, **Punto de corte** y
**Uso previsto** describen aspectos distintos de la misma situación: el primero
umbral que separa quién requiere intervención;, mientras el segundo decisión que se tomará con el resultado, declarada antes de aplicar el instrumento.
...
- **Evidencia de logro.** Qué muestra un calendario de evaluación lectora con instrumento, frecuencia, responsable y uso previsto de cada medida frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
Un sistema profesional declara antes de aplicar qué decisión se tomará con cada resultado. Fija tres a cuatro momentos en el año, asigna responsable, define condiciones de aplicación para que los datos sean comparables y establece el punto de corte con su justificación. Los resultados se revisan en equipo y desembocan en movimientos concretos de agrupamiento e intervención; si nadie cambia nada tras la medición, el sistema es un rito administrativo.

### 5. Qué sostiene la evidencia y qué no

Las medidas breves miden bien lo que miden y nada más: la fluidez no informa sobre vocabulario, y ninguna informa sobre gusto por leer. Los puntos de corte disponibles provienen en su mayoría de otros sistemas escolares y sirven mejor para seguir el progreso individual que para clasificar. Y toda medición frecuente corre el riesgo de estrechar la enseñanza hacia lo medido si el equipo pierde de vista el propósito.
...
te deja en condiciones de qué se mide, cuándo y con qué instrumento en el sistema de evaluación lectora de tu establecimiento, y esa decisión se sostiene solo si
...
|---|---|---|
| Fuchs, D. & Fuchs, L. (2006). *Introduction to Response to Intervention*. | modelo de medición frecuente ligada a decisiones de intervención y no a informes. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
| AERA, APA & NCME (2014). *Standards for Educational and Psychological Testing*. | obliga a declarar el uso previsto antes de aplicar cualquier instrumento. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Evaluación por componentes** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Evaluación por componentes de Medida breve repetible.** El trabajo aquí es separar lo observado de lo interpretado sobre **Medida breve repetible**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Punto de corte como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Punto de corte**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.

**Paso 4 — Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con Uso previsto a la vista.** Con **Uso previsto** ya delimitado, la pregunta pasa a ser de consecuencia: qué cambia para los estudiantes, para el tiempo de clase y para la carga del equipo. **Evidencia de partida** entrega la lectura observable; el juicio profesional sigue siendo humano y debe quedar firmado por quien lo hace.
...
|---|---|---|---|
| Intervenir sobre **Evaluación por componentes** | Medición separada de decodificación, fluidez, vocabulario y comprensión para localizar la dificultad | Cuando **Evidencia de partida** es observable y accionable dentro del plazo de la decisión. | Sobrerreaccionar a una señal parcial. |
| Intervenir sobre **Medida breve repetible** | Instrumento de pocos minutos, aplicable varias veces al año, que permite ver progreso y no solo estado | Cuando la primera explicación no distingue mecanismo ni responsable. | Convertir el concepto en etiqueta y no en intervención. |
| Observar antes de decidir | Reducir la incertidumbre antes de comprometer tiempo y credibilidad | Cuando la decisión es reversible y la evidencia disponible no distingue causas. | Observar indefinidamente y no decidir nunca. |
| Derivar o escalar | Poner la decisión donde están la competencia y la responsabilidad | Cuando hay normativa, resguardo de datos, salud o vulneración de derechos en juego. | Delegar hacia arriba lo que sí correspondía decidir en el aula. |

**Frontera de aplicación.** Las medidas breves miden bien lo que miden y nada más: Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre evaluación de la lectura por componentes |
|---|---|
...
Un calendario de evaluación lectora con instrumento, frecuencia, responsable y uso previsto de cada medida.

Guárdala en `evidence/P18-C225-evaluacion-de-la-lectura-por-componentes/` con estos archivos:
...
Diseña el calendario de evaluación lectora de un ciclo completo. Declara para cada instrumento su uso previsto y presenta el diseño al equipo para que comprometa las decisiones asociadas.
...
- [ ] cada instrumento del calendario declara su uso previsto y su responsable;
- [ ] las condiciones de aplicación están fijadas de modo que los resultados sean comparables;
...
- Aplicar instrumentos sin haber declarado qué decisión se tomará con el resultado.
- Comparar mediciones tomadas con textos y condiciones distintas y leer la diferencia como progreso.
...
Un sistema por componentes protege a los estudiantes que hoy quedan invisibles: el que decodifica bien y no comprende, y el que comprende oralmente y no decodifica. Las adecuaciones de aplicación se declaran de antemano para que los resultados sigan siendo interpretables.
...
1. ¿Qué decisión concreta se tomó el año pasado con los resultados de lectura de tu establecimiento?
2. ¿Tus mediciones permiten ver pendiente o solo estado?
3. ¿Quién es responsable de aplicar cada instrumento y quién de que el resultado se use?
...
Integra las clases 217 a 224 y alimenta la 226. Se apoya en el marco de validez de la parte 11.
...
|---|---|---|
| [← 224 · Dislexia y dificultades específicas de lectura](../class-08-dislexia-y-dificultades-especificas-de-lectura/README.md) | [Parte 18](../README.md) · [Programa](../../../README.md) | [226 · Intervención por niveles y grupos de refuerzo →](../class-10-intervencion-por-niveles-y-grupos-de-refuerzo/README.md) |
