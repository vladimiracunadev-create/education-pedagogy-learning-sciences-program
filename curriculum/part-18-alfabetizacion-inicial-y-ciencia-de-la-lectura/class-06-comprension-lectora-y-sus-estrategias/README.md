# Clase 222 — Comprensión lectora y sus estrategias

> **Parte 18 · Alfabetización inicial y ciencia de la lectura** — clase 6 de 12
...
**Decisión que habilita:** determinar si la dificultad de comprensión de tu curso pide estrategia, vocabulario o conocimiento del tema<br>
**Evidencia de aprendizaje:** una secuencia de comprensión que declara la estrategia enseñada, su dosis y el conocimiento previo que exige el texto

## 🎯 Propósito

Enseñar estrategias de comprensión con dosis breve y explícita, y reconocer cuándo el problema no es de estrategia sino de conocimiento.
...
2. **Explicar** por qué enseñar estrategias de comprensión funciona rápido y deja de rendir pronto.
3. **Decidir** —si la dificultad de comprensión de tu curso pide estrategia, vocabulario o conocimiento del tema— y sostener la decisión con un fundamento escrito.
4. **Producir** la evidencia de la clase —una secuencia de comprensión que declara la estrategia enseñada, su dosis y el conocimiento previo que exige el texto— y contrastarla contra el criterio de logro.
...
|---|---|
| **Estrategia de comprensión** | procedimiento deliberado —predecir, resumir, preguntarse, clarificar— que el lector aplica sobre el texto |
| **Enseñanza recíproca** | formato en que los estudiantes turnan el rol de conductor aplicando un conjunto pequeño de estrategias |
| **Modelo situacional** | representación mental de lo que el texto describe, más allá de las palabras; es lo que realmente se recuerda |
| **Efecto de saturación** | punto a partir del cual seguir enseñando estrategias no agrega comprensión medible |
...
2. Clasificar la situación distinguiendo **Estrategia de comprensión** de **Enseñanza recíproca**.
3. Decidir con fundamento, usando **Modelo situacional** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Efecto de saturación** a la vista.
...
| **Evidencia de logro** | qué muestra una secuencia de comprensión que declara la estrategia enseñada, su dosis y el conocimiento previo que exige el texto frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
El efecto de las estrategias es real, rápido y limitado; Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Estrategia de<br/>comprensión"]
    C --> A2["Enseñanza recíproca"]
    C --> A3["Modelo situacional"]
    C --> A4["Efecto de saturación"]
    A1 & A2 & A3 & A4 --> D{{"determinar si la<br/>dificultad de<br/>comprensión de tu curso<br/>pide estrategia,<br/>vocabulario o…"}}
    D --> E["Evidencia de aprendizaje<br/>una secuencia de<br/>comprensión que declara<br/>la estrategia enseñada,<br/>su dosis y el<br/>conocimiento…"]
...
Enseñar a los estudiantes a resumir, preguntarse y monitorear su comprensión produce efectos medibles y rápidos, sobre todo en lectores que nunca supervisaron su propia lectura. El hallazgo incómodo es que esos efectos saturan: unas pocas semanas de enseñanza explícita capturan casi todo el beneficio, y prolongarla desplaza tiempo que rendiría más leyendo sobre el tema. La razón es que la comprensión depende sobre todo de conocimiento —del mundo y de palabras—, y ninguna estrategia sustituye lo que el lector no sabe.

### 2. Frontera conceptual: qué es y qué no es

Los cuatro conceptos de esta clase se confunden entre sí con facilidad, y esa confusión no es
inocua: produce decisiones que atacan el problema equivocado. **Estrategia de comprensión** no es lo
mismo que **Enseñanza recíproca** —formato en que los estudiantes turnan el rol de conductor aplicando un conjunto pequeño de estrategias—, y tratarlos como sinónimos hace
que la intervención se dirija al lugar incorrecto. Del mismo modo, **Modelo situacional** y
**Efecto de saturación** describen aspectos distintos de la misma situación: el primero
representación mental de lo que el texto describe, más allá de las palabras;, mientras el segundo punto a partir del cual seguir enseñando estrategias no agrega comprensión medible.
...
- **Evidencia de logro.** Qué muestra una secuencia de comprensión que declara la estrategia enseñada, su dosis y el conocimiento previo que exige el texto frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
La aplicación profesional es de dosis: enseñar pocas estrategias, modelarlas en voz alta, practicarlas con textos del contenido que se está estudiando y luego soltarlas para que se usen sin nombrarlas. La enseñanza recíproca funciona bien porque distribuye el rol y obliga a verbalizar. El error de diseño más común es convertir la estrategia en el contenido de la clase: llenar el cuaderno de organizadores gráficos sobre textos que el estudiante no podía entender por falta de vocabulario.

### 5. Qué sostiene la evidencia y qué no

El efecto de las estrategias es real, rápido y limitado; no compensa vacíos de conocimiento ni de vocabulario. Buena parte de la investigación mide comprensión con pruebas de textos breves y descontextualizados, que favorecen precisamente a las estrategias; el efecto sobre la comprensión de textos largos y disciplinares está menos establecido. La comprensión, además, es en buena medida específica del dominio: comprender un texto de historia no garantiza comprender uno de biología.
...
te deja en condiciones de si la dificultad de comprensión de tu curso pide estrategia, vocabulario o conocimiento del tema, y esa decisión se sostiene solo si
...
|---|---|---|
| Castles, A., Rastle, K. & Nation, K. (2018). *Ending the Reading Wars*. | trata el efecto de saturación de las estrategias con el detalle que la práctica escolar suele ignorar. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
| Seidenberg, M. (2017). *Language at the Speed of Sight*. | explica por qué el conocimiento pesa más que la técnica en la comprensión. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Estrategia de comprensión** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Estrategia de comprensión de Enseñanza recíproca.** El trabajo aquí es separar lo observado de lo interpretado sobre **Enseñanza recíproca**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Modelo situacional como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Modelo situacional**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.

**Paso 4 — Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con Efecto de saturación a la vista.** Con **Efecto de saturación** ya delimitado, la pregunta pasa a ser de consecuencia: qué cambia para los estudiantes, para el tiempo de clase y para la carga del equipo. **Evidencia de partida** entrega la lectura observable; el juicio profesional sigue siendo humano y debe quedar firmado por quien lo hace.
...
|---|---|---|---|
| Intervenir sobre **Estrategia de comprensión** | Procedimiento deliberado —predecir, resumir, preguntarse, clarificar— que el lector aplica sobre el texto | Cuando **Evidencia de partida** es observable y accionable dentro del plazo de la decisión. | Sobrerreaccionar a una señal parcial. |
| Intervenir sobre **Enseñanza recíproca** | Formato en que los estudiantes turnan el rol de conductor aplicando un conjunto pequeño de estrategias | Cuando la primera explicación no distingue mecanismo ni responsable. | Convertir el concepto en etiqueta y no en intervención. |
| Observar antes de decidir | Reducir la incertidumbre antes de comprometer tiempo y credibilidad | Cuando la decisión es reversible y la evidencia disponible no distingue causas. | Observar indefinidamente y no decidir nunca. |
| Derivar o escalar | Poner la decisión donde están la competencia y la responsabilidad | Cuando hay normativa, resguardo de datos, salud o vulneración de derechos en juego. | Delegar hacia arriba lo que sí correspondía decidir en el aula. |

**Frontera de aplicación.** El efecto de las estrategias es real, rápido y limitado; Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre comprensión lectora y sus estrategias |
|---|---|
...
Una secuencia de comprensión que declara la estrategia enseñada, su dosis y el conocimiento previo que exige el texto.

Guárdala en `evidence/P18-C222-comprension-lectora-y-sus-estrategias/` con estos archivos:
...
Toma un texto de tu asignatura y lista el conocimiento previo que exige. Construye ese conocimiento en dos clases antes de entregarlo y compara la comprensión con la del curso anterior.
...
- [ ] la secuencia declara qué estrategias enseña, con qué dosis y cuándo deja de enseñarlas;
- [ ] el texto elegido declara el conocimiento previo que exige y cómo se construye antes;
...
- Dedicar un semestre a enseñar estrategias con textos que el estudiante no puede decodificar ni entender.
- Evaluar la aplicación de la estrategia —el organizador completo— en vez de la comprensión del texto.
...
Los estudiantes con menos exposición previa al lenguaje escrito ganan más con la enseñanza explícita de supervisión, y pierden más cuando la clase reemplaza la construcción de conocimiento por ejercicios de estrategia. Para quien aprende en segunda lengua, la estrategia sin vocabulario no produce comprensión.
...
1. ¿Tu estudiante no comprende porque no supervisa la lectura o porque no conoce el tema?
2. ¿Cuánto tiempo llevas enseñando estrategias y qué evidencia tienes de que siguen rindiendo?
3. ¿Qué conocimiento previo asume el texto y cómo lo construyes antes de repartirlo?
...
Depende de las clases 220 y 221, y prepara la 227, donde la comprensión se vuelve responsabilidad de cada asignatura.
...
|---|---|---|
| [← 221 · Vocabulario y conocimiento del mundo](../class-05-vocabulario-y-conocimiento-del-mundo/README.md) | [Parte 18](../README.md) · [Programa](../../../README.md) | [223 · Enseñanza de la escritura inicial →](../class-07-ensenanza-de-la-escritura-inicial/README.md) |
