# Clase 224 — Dislexia y dificultades específicas de lectura

> **Parte 18 · Alfabetización inicial y ciencia de la lectura** — clase 8 de 12
...
**Decisión que habilita:** determinar si el bajo rendimiento lector de un estudiante exige intensificar la enseñanza o iniciar evaluación especializada<br>
**Evidencia de aprendizaje:** un informe de decisión con evidencia de respuesta a la enseñanza y criterio de derivación

## 🎯 Propósito

Reconocer el perfil de la dislexia y de otras dificultades específicas, responder con intervención intensiva y evitar tanto el sobrediagnóstico como el abandono.
...
2. **Explicar** cómo se distingue una dificultad específica de lectura de una enseñanza insuficiente.
3. **Decidir** —si el bajo rendimiento lector de un estudiante exige intensificar la enseñanza o iniciar evaluación especializada— y sostener la decisión con un fundamento escrito.
4. **Producir** la evidencia de la clase —un informe de decisión con evidencia de respuesta a la enseñanza y criterio de derivación— y contrastarla contra el criterio de logro.
...
|---|---|
| **Dislexia** | dificultad persistente y específica en el reconocimiento preciso y fluido de palabras, de base fonológica y no explicada por falta de enseñanza |
| **Doble déficit** | combinación de debilidad fonológica y lentitud de nombrado automático, asociada a los cuadros más resistentes |
| **Respuesta a la enseñanza** | criterio que evalúa el progreso ante enseñanza de calidad antes de atribuir la dificultad al estudiante |
| **Intervención intensiva** | aumento de dosis, explicitud y frecuencia con grupos pequeños y monitoreo frecuente |
...
2. Clasificar la situación distinguiendo **Dislexia** de **Doble déficit**.
3. Decidir con fundamento, usando **Respuesta a la enseñanza** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Intervención intensiva** a la vista.
...
| **Evidencia de logro** | qué muestra un informe de decisión con evidencia de respuesta a la enseñanza y criterio de derivación frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
El límite entre dificultad específica y bajo rendimiento es un continuo, no una frontera natural, y depende del punto de corte que se elija. Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Dislexia"]
    C --> A2["Doble déficit"]
    C --> A3["Respuesta a la<br/>enseñanza"]
    C --> A4["Intervención intensiva"]
    A1 & A2 & A3 & A4 --> D{{"determinar si el bajo<br/>rendimiento lector de un<br/>estudiante exige<br/>intensificar la<br/>enseñanza o…"}}
    D --> E["Evidencia de aprendizaje<br/>un informe de decisión<br/>con evidencia de<br/>respuesta a la enseñanza<br/>y criterio de derivación"]
...
La dislexia no es una lectura invertida ni un problema de visión: es una dificultad específica y persistente en el reconocimiento de palabras, con base fonológica. El diagnóstico exige descartar primero la explicación más frecuente y más corregible, que es enseñanza insuficiente. De ahí que el criterio de respuesta a la enseñanza sea tan útil: se intensifica la enseñanza con calidad comprobada, se monitorea, y solo si el progreso sigue siendo insuficiente se sospecha una dificultad específica.

### 2. Frontera conceptual: qué es y qué no es

Los cuatro conceptos de esta clase se confunden entre sí con facilidad, y esa confusión no es
inocua: produce decisiones que atacan el problema equivocado. **Dislexia** no es lo
mismo que **Doble déficit** —combinación de debilidad fonológica y lentitud de nombrado automático, asociada a los cuadros más resistentes—, y tratarlos como sinónimos hace
que la intervención se dirija al lugar incorrecto. Del mismo modo, **Respuesta a la enseñanza** y
**Intervención intensiva** describen aspectos distintos de la misma situación: el primero
criterio que evalúa el progreso ante enseñanza de calidad antes de atribuir la dificultad al estudiante, mientras el segundo aumento de dosis, explicitud y frecuencia con grupos pequeños y monitoreo frecuente.
...
- **Evidencia de logro.** Qué muestra un informe de decisión con evidencia de respuesta a la enseñanza y criterio de derivación frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
El procedimiento profesional tiene orden. Primero se verifica que la enseñanza recibida fue sistemática y explícita. Luego se intensifica en grupo pequeño con monitoreo frecuente durante un plazo declarado. Si el progreso es insuficiente pese a eso, corresponde derivar a evaluación especializada. Mientras tanto, la enseñanza no se detiene ni se rebaja: los apoyos de acceso —más tiempo, texto leído en voz alta, formato— permiten seguir aprendiendo el contenido mientras se trabaja la lectura.

### 5. Qué sostiene la evidencia y qué no

El límite entre dificultad específica y bajo rendimiento es un continuo, no una frontera natural, y depende del punto de corte que se elija. La evaluación diagnóstica en español dispone de menos instrumentos normados que en inglés. Además, el criterio de respuesta a la enseñanza solo funciona si la enseñanza previa fue de calidad: aplicado sobre enseñanza deficiente, convierte la falla del sistema en un atributo del estudiante.
...
te deja en condiciones de si el bajo rendimiento lector de un estudiante exige intensificar la enseñanza o iniciar evaluación especializada, y esa decisión se sostiene solo si
...
|---|---|---|
| Snowling, M. & Hulme, C. (2011). *Evidence-Based Interventions for Reading and Language Difficulties*. | distingue lo que funciona de lo que se vende, con criterios de intensidad y monitoreo. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
| Fuchs, D. & Fuchs, L. (2006). *Introduction to Response to Intervention*. | el marco que ordena la secuencia de intensificación antes de la derivación. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Dislexia** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Dislexia de Doble déficit.** El trabajo aquí es separar lo observado de lo interpretado sobre **Doble déficit**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Respuesta a la enseñanza como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Respuesta a la enseñanza**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.

**Paso 4 — Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con Intervención intensiva a la vista.** Con **Intervención intensiva** ya delimitado, la pregunta pasa a ser de consecuencia: qué cambia para los estudiantes, para el tiempo de clase y para la carga del equipo. **Evidencia de partida** entrega la lectura observable; el juicio profesional sigue siendo humano y debe quedar firmado por quien lo hace.
...
|---|---|---|---|
| Intervenir sobre **Dislexia** | Dificultad persistente y específica en el reconocimiento preciso y fluido de palabras, de base fonológica y no explicada por falta de enseñanza | Cuando **Evidencia de partida** es observable y accionable dentro del plazo de la decisión. | Sobrerreaccionar a una señal parcial. |
| Intervenir sobre **Doble déficit** | Combinación de debilidad fonológica y lentitud de nombrado automático, asociada a los cuadros más resistentes | Cuando la primera explicación no distingue mecanismo ni responsable. | Convertir el concepto en etiqueta y no en intervención. |
| Observar antes de decidir | Reducir la incertidumbre antes de comprometer tiempo y credibilidad | Cuando la decisión es reversible y la evidencia disponible no distingue causas. | Observar indefinidamente y no decidir nunca. |
| Derivar o escalar | Poner la decisión donde están la competencia y la responsabilidad | Cuando hay normativa, resguardo de datos, salud o vulneración de derechos en juego. | Delegar hacia arriba lo que sí correspondía decidir en el aula. |

**Frontera de aplicación.** El límite entre dificultad específica y bajo rendimiento es un continuo, no una frontera natural, y depende del punto de corte que se elija. Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre dislexia y dificultades específicas de lectura |
|---|---|
...
Un informe de decisión con evidencia de respuesta a la enseñanza y criterio de derivación.

Guárdala en `evidence/P18-C224-dislexia-y-dificultades-especificas-de-lectura/` con estos archivos:
...
Toma el caso de un estudiante con bajo rendimiento lector. Documenta la enseñanza recibida, aplica ocho semanas de intensificación con tres mediciones y escribe la decisión que corresponde.
...
- [ ] el informe documenta la enseñanza recibida antes de atribuir la dificultad al estudiante;
- [ ] existe monitoreo con al menos tres mediciones y un criterio explícito de derivación;
...
- Derivar a evaluación especializada sin haber verificado la calidad y la dosis de la enseñanza recibida.
- Esperar a que el estudiante madure y perder los años en que la intervención rinde más.
...
Una dificultad específica no justifica reducir el objetivo de aprendizaje: justifica cambiar la vía de acceso y aumentar la enseñanza. Confundir ambas cosas condena a un estudiante con inteligencia intacta a un currículum empobrecido por un problema de lectura tratable.
...
Depende de las clases 219 y 220 y se articula con la 226. Profundiza lo tratado en la clase 104.
...
|---|---|---|
| [← 223 · Enseñanza de la escritura inicial](../class-07-ensenanza-de-la-escritura-inicial/README.md) | [Parte 18](../README.md) · [Programa](../../../README.md) | [225 · Evaluación de la lectura por componentes →](../class-09-evaluacion-de-la-lectura-por-componentes/README.md) |
