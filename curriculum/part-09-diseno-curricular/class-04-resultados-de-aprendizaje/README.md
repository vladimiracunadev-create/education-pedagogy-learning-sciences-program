...
**Decisión que habilita:** determinar el nivel de desempeño exigido en cada resultado y cómo se evidenciará<br>
...
2. Clasificar la situación distinguiendo **Resultado de aprendizaje** de **Verbo observable**.
3. Decidir con fundamento, usando **Condición de desempeño** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Criterio de logro** a la vista.
...
| **Evidencia de logro** | qué muestra un conjunto de resultados de aprendizaje reescritos con verbo, objeto, condición y criterio, revisados por pares frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
Llevado al extremo, este enfoque fragmenta el aprendizaje en listas interminables de microresultados y pierde de vista la comprensión integrada. Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Resultado de<br/>aprendizaje"]
    C --> A2["Verbo observable"]
    C --> A3["Condición de desempeño"]
    C --> A4["Criterio de logro"]
    A1 & A2 & A3 & A4 --> D{{"determinar el nivel de<br/>desempeño exigido en<br/>cada resultado y cómo se<br/>evidenciará"}}
    D --> E["Evidencia de aprendizaje<br/>un conjunto de<br/>resultados de<br/>aprendizaje reescritos<br/>con verbo, objeto,<br/>condición y criterio,…"]
...
inocua: produce decisiones que atacan el problema equivocado. **Resultado de aprendizaje** no es lo
...
- **Evidencia de logro.** Qué muestra un conjunto de resultados de aprendizaje reescritos con verbo, objeto, condición y criterio, revisados por pares frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
te deja en condiciones de el nivel de desempeño exigido en cada resultado y cómo se evidenciará, y esa decisión se sostiene solo si
...
|---|---|---|
| Anderson, L. & Krathwohl, D. (2001). *A Taxonomy for Learning, Teaching, and Assessing*. | ordena verbos y niveles cognitivos; base para elegir el verbo por el desempeño real. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
| Biggs, J. & Collis, K. (1982). *Evaluating the Quality of Learning: The SOLO Taxonomy*. | permite graduar la complejidad del desempeño y no solo su presencia. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Resultado de aprendizaje** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Resultado de aprendizaje de Verbo observable.** El trabajo aquí es separar lo observado de lo interpretado sobre **Verbo observable**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Condición de desempeño como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Condición de desempeño**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.

**Paso 4 — Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con Criterio de logro a la vista.** Con **Criterio de logro** ya delimitado, la pregunta pasa a ser de consecuencia: qué cambia para los estudiantes, para el tiempo de clase y para la carga del equipo. **Evidencia de partida** entrega la lectura observable; el juicio profesional sigue siendo humano y debe quedar firmado por quien lo hace.
...
|---|---|---|---|
| Intervenir sobre **Resultado de aprendizaje** | Declaración de lo que el estudiante podrá hacer al finalizar, verificable con evidencia | Cuando **Evidencia de partida** es observable y accionable dentro del plazo de la decisión. | Sobrerreaccionar a una señal parcial. |
| Intervenir sobre **Verbo observable** | Acción que puede constatarse externamente; excluye «conocer», «comprender» y «valorar» sin más | Cuando la primera explicación no distingue mecanismo ni responsable. | Convertir el concepto en etiqueta y no en intervención. |
| Observar antes de decidir | Reducir la incertidumbre antes de comprometer tiempo y credibilidad | Cuando la decisión es reversible y la evidencia disponible no distingue causas. | Observar indefinidamente y no decidir nunca. |
| Derivar o escalar | Poner la decisión donde están la competencia y la responsabilidad | Cuando hay normativa, resguardo de datos, salud o vulneración de derechos en juego. | Delegar hacia arriba lo que sí correspondía decidir en el aula. |

**Frontera de aplicación.** Llevado al extremo, este enfoque fragmenta el aprendizaje en listas interminables de microresultados y pierde de vista la comprensión integrada. Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre resultados de aprendizaje |
|---|---|
...
Guárdala en `evidence/P09-C112-resultados-de-aprendizaje/` con estos archivos:
