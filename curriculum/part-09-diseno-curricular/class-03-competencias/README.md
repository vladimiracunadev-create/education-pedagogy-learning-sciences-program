...
**Estado de evidencia:** `EN-DEBATE` · **Etapa:** 🟣 Etapa C — Núcleo profesional docente · **Población de referencia:** diseño de asignaturas, programas y planes de estudio<br>
**Decisión que habilita:** determinar si tu programa se organiza mejor por competencias, por contenidos o por una combinación explícita<br>
...
2. Clasificar la situación distinguiendo **Currículo por competencias** de **Currículo disciplinar**.
3. Decidir con fundamento, usando **Conocimiento poderoso** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Integración de saberes** a la vista.
...
| **Evidencia de logro** | qué muestra un análisis fundamentado de la estructura de un programa con su justificación y sus riesgos declarados frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
No hay evidencia concluyente de que un enfoque produzca mejores aprendizajes que el otro: Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Currículo por<br/>competencias"]
    C --> A2["Currículo disciplinar"]
    C --> A3["Conocimiento poderoso"]
    C --> A4["Integración de saberes"]
    A1 & A2 & A3 & A4 --> D{{"determinar si tu<br/>programa se organiza<br/>mejor por competencias,<br/>por contenidos o por<br/>una…"}}
    D --> E["Evidencia de aprendizaje<br/>un análisis fundamentado<br/>de la estructura de un<br/>programa con su<br/>justificación y sus<br/>riesgos…"]
...
inocua: produce decisiones que atacan el problema equivocado. **Currículo por competencias** no es lo
mismo que **Currículo disciplinar** —organización en torno a la estructura del conocimiento de cada disciplina—, y tratarlos como sinónimos hace
que la intervención se dirija al lugar incorrecto. Del mismo modo, **Conocimiento poderoso** y
**Integración de saberes** describen aspectos distintos de la misma situación: el primero
conocimiento especializado que la escuela ofrece y que no se adquiere en la experiencia cotidiana, mientras el segundo articulación entre conocimiento, procedimiento y criterio dentro de una competencia.
...
- **Evidencia de logro.** Qué muestra un análisis fundamentado de la estructura de un programa con su justificación y sus riesgos declarados frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
te deja en condiciones de si tu programa se organiza mejor por competencias, por contenidos o por una combinación explícita, y esa decisión se sostiene solo si
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Currículo por competencias** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Currículo por competencias de Currículo disciplinar.** El trabajo aquí es separar lo observado de lo interpretado sobre **Currículo disciplinar**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Conocimiento poderoso como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Conocimiento poderoso**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.

**Paso 4 — Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con Integración de saberes a la vista.** Con **Integración de saberes** ya delimitado, la pregunta pasa a ser de consecuencia: qué cambia para los estudiantes, para el tiempo de clase y para la carga del equipo. **Evidencia de partida** entrega la lectura observable; el juicio profesional sigue siendo humano y debe quedar firmado por quien lo hace.
...
**Frontera de aplicación.** No hay evidencia concluyente de que un enfoque produzca mejores aprendizajes que el otro: Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre competencias |
|---|---|
...
Guárdala en `evidence/P09-C111-competencias/` con estos archivos:
