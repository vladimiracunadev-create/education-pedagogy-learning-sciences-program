...
**Decisión que habilita:** determinar el diseño curricular completo y demostrar su coherencia con una auditoría documentada<br>
...
2. Clasificar la situación distinguiendo **Coherencia curricular** de **Trazabilidad**.
3. Decidir con fundamento, usando **Auditoría interna** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Documentación del diseño** a la vista.
...
| **Evidencia de logro** | qué muestra un currículo completo con perfil, mapa, secuencia, syllabus y auditoría de alineamiento frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
Un currículo coherente no garantiza aprendizaje: Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Coherencia curricular"]
    C --> A2["Trazabilidad"]
    C --> A3["Auditoría interna"]
    C --> A4["Documentación del<br/>diseño"]
    A1 & A2 & A3 & A4 --> D{{"determinar el diseño<br/>curricular completo y<br/>demostrar su coherencia<br/>con una auditoría<br/>documentada"}}
    D --> E["Evidencia de aprendizaje<br/>un currículo completo<br/>con perfil, mapa,<br/>secuencia, syllabus y<br/>auditoría de<br/>alineamiento"]
...
inocua: produce decisiones que atacan el problema equivocado. **Coherencia curricular** no es lo
mismo que **Trazabilidad** —posibilidad de seguir un aprendizaje del perfil hasta su evaluación concreta—, y tratarlos como sinónimos hace
que la intervención se dirija al lugar incorrecto. Del mismo modo, **Auditoría interna** y
**Documentación del diseño** describen aspectos distintos de la misma situación: el primero
revisión sistemática de la coherencia realizada por el propio equipo, mientras el segundo registro que permite a otros entender y sostener las decisiones tomadas.
...
- **Evidencia de logro.** Qué muestra un currículo completo con perfil, mapa, secuencia, syllabus y auditoría de alineamiento frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
te deja en condiciones de el diseño curricular completo y demostrar su coherencia con una auditoría documentada, y esa decisión se sostiene solo si
...
|---|---|---|
| Biggs, J. & Tang, C. (2011). *Teaching for Quality Learning at University*. | marco integral para diseñar y auditar coherencia curricular. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
| Jacobs, H. H. (1997). *Mapping the Big Picture*. | metodología de mapeo que sostiene la verificación de coherencia. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Coherencia curricular** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Coherencia curricular de Trazabilidad.** El trabajo aquí es separar lo observado de lo interpretado sobre **Trazabilidad**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Auditoría interna como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Auditoría interna**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.

**Paso 4 — Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con Documentación del diseño a la vista.** Con **Documentación del diseño** ya delimitado, la pregunta pasa a ser de consecuencia: qué cambia para los estudiantes, para el tiempo de clase y para la carga del equipo. **Evidencia de partida** entrega la lectura observable; el juicio profesional sigue siendo humano y debe quedar firmado por quien lo hace.
...
**Frontera de aplicación.** Un currículo coherente no garantiza aprendizaje: Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre proyecto integrador: currículo completo |
|---|---|
...
Guárdala en `evidence/P09-C120-proyecto-integrador-curriculo-completo/` con estos archivos:
