...
**Decisión que habilita:** determinar qué se prioriza y qué se sacrifica cuando el tiempo real resulte menor que el planificado<br>
...
2. Clasificar la situación distinguiendo **Planificación anual** de **Priorización**.
3. Decidir con fundamento, usando **Holgura** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Criterio de ajuste** a la vista.
...
| **Evidencia de logro** | qué muestra una planificación anual con priorización declarada, holguras y criterios de ajuste ante pérdida de tiempo frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
La priorización tiene costos: Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Planificación anual"]
    C --> A2["Priorización"]
    C --> A3["Holgura"]
    C --> A4["Criterio de ajuste"]
    A1 & A2 & A3 & A4 --> D{{"determinar qué se<br/>prioriza y qué se<br/>sacrifica cuando el<br/>tiempo real resulte<br/>menor que el…"}}
    D --> E["Evidencia de aprendizaje<br/>una planificación anual<br/>con priorización<br/>declarada, holguras y<br/>criterios de ajuste ante<br/>pérdida…"]
...
inocua: produce decisiones que atacan el problema equivocado. **Planificación anual** no es lo
mismo que **Priorización** —decisión explícita sobre qué aprendizajes son irrenunciables y cuáles admiten recorte—, y tratarlos como sinónimos hace
que la intervención se dirija al lugar incorrecto. Del mismo modo, **Holgura** y
**Criterio de ajuste** describen aspectos distintos de la misma situación: el primero
tiempo no asignado que absorbe interrupciones sin destruir la planificación, mientras el segundo regla decidida de antemano sobre qué se recorta cuando falta tiempo.
...
- **Evidencia de logro.** Qué muestra una planificación anual con priorización declarada, holguras y criterios de ajuste ante pérdida de tiempo frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
te deja en condiciones de qué se prioriza y qué se sacrifica cuando el tiempo real resulte menor que el planificado, y esa decisión se sostiene solo si
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Planificación anual** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Planificación anual de Priorización.** El trabajo aquí es separar lo observado de lo interpretado sobre **Priorización**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Holgura como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Holgura**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.

**Paso 4 — Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con Criterio de ajuste a la vista.** Con **Criterio de ajuste** ya delimitado, la pregunta pasa a ser de consecuencia: qué cambia para los estudiantes, para el tiempo de clase y para la carga del equipo. **Evidencia de partida** entrega la lectura observable; el juicio profesional sigue siendo humano y debe quedar firmado por quien lo hace.
...
|---|---|---|---|
| Intervenir sobre **Planificación anual** | Distribución de aprendizajes y evaluaciones a lo largo del año o del semestre | Cuando **Evidencia de partida** es observable y accionable dentro del plazo de la decisión. | Sobrerreaccionar a una señal parcial. |
| Intervenir sobre **Priorización** | Decisión explícita sobre qué aprendizajes son irrenunciables y cuáles admiten recorte | Cuando la primera explicación no distingue mecanismo ni responsable. | Convertir el concepto en etiqueta y no en intervención. |
| Observar antes de decidir | Reducir la incertidumbre antes de comprometer tiempo y credibilidad | Cuando la decisión es reversible y la evidencia disponible no distingue causas. | Observar indefinidamente y no decidir nunca. |
| Derivar o escalar | Poner la decisión donde están la competencia y la responsabilidad | Cuando hay normativa, resguardo de datos, salud o vulneración de derechos en juego. | Delegar hacia arriba lo que sí correspondía decidir en el aula. |

**Frontera de aplicación.** La priorización tiene costos: Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre planificación anual y por unidad |
|---|---|
...
Guárdala en `evidence/P09-C119-planificacion-anual-y-por-unidad/` con estos archivos:
