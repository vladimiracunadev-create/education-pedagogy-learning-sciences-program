...
**Decisión que habilita:** determinar en qué nivel del currículum se está produciendo la brecha que observas en tus resultados<br>
...
2. Clasificar la situación distinguiendo **Currículum prescrito** de **Currículum enseñado**.
3. Decidir con fundamento, usando **Currículum evaluado** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Currículum oculto** a la vista.
...
| **Evidencia de logro** | qué muestra un diagnóstico de una asignatura que compare los seis niveles del currículum con evidencia de cada uno frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
La distinción es una herramienta analítica y no una jerarquía de importancia: Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Currículum prescrito"]
    C --> A2["Currículum enseñado"]
    C --> A3["Currículum evaluado"]
    C --> A4["Currículum oculto"]
    A1 & A2 & A3 & A4 --> D{{"determinar en qué nivel<br/>del currículum se está<br/>produciendo la brecha<br/>que observas en tus…"}}
    D --> E["Evidencia de aprendizaje<br/>un diagnóstico de una<br/>asignatura que compare<br/>los seis niveles del<br/>currículum con evidencia<br/>de…"]
...
inocua: produce decisiones que atacan el problema equivocado. **Currículum prescrito** no es lo
mismo que **Currículum enseñado** —lo que efectivamente ocurre en la sala, que suele diferir de lo planificado—, y tratarlos como sinónimos hace
que la intervención se dirija al lugar incorrecto. Del mismo modo, **Currículum evaluado** y
**Currículum oculto** describen aspectos distintos de la misma situación: el primero
lo que se mide;, mientras el segundo aprendizajes no declarados que la institución transmite con sus prácticas y su organización.
...
- **Evidencia de logro.** Qué muestra un diagnóstico de una asignatura que compare los seis niveles del currículum con evidencia de cada uno frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
te deja en condiciones de en qué nivel del currículum se está produciendo la brecha que observas en tus resultados, y esa decisión se sostiene solo si
...
|---|---|---|
| Goodlad, J. (1979). *Curriculum Inquiry*. | origen de la distinción entre niveles del currículum, todavía la más útil para diagnosticar. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
| Jackson, P. (1968). *Life in Classrooms*. | introduce el currículo oculto con observación etnográfica; sigue siendo la mejor descripción del fenómeno. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Currículum prescrito** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Currículum prescrito de Currículum enseñado.** El trabajo aquí es separar lo observado de lo interpretado sobre **Currículum enseñado**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Currículum evaluado como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Currículum evaluado**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.

**Paso 4 — Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con Currículum oculto a la vista.** Con **Currículum oculto** ya delimitado, la pregunta pasa a ser de consecuencia: qué cambia para los estudiantes, para el tiempo de clase y para la carga del equipo. **Evidencia de partida** entrega la lectura observable; el juicio profesional sigue siendo humano y debe quedar firmado por quien lo hace.
...
|---|---|---|---|
| Intervenir sobre **Currículum prescrito** | Lo que la autoridad define como obligatorio para el sistema | Cuando **Evidencia de partida** es observable y accionable dentro del plazo de la decisión. | Sobrerreaccionar a una señal parcial. |
| Intervenir sobre **Currículum enseñado** | Lo que efectivamente ocurre en la sala, que suele diferir de lo planificado | Cuando la primera explicación no distingue mecanismo ni responsable. | Convertir el concepto en etiqueta y no en intervención. |
| Observar antes de decidir | Reducir la incertidumbre antes de comprometer tiempo y credibilidad | Cuando la decisión es reversible y la evidencia disponible no distingue causas. | Observar indefinidamente y no decidir nunca. |
| Derivar o escalar | Poner la decisión donde están la competencia y la responsabilidad | Cuando hay normativa, resguardo de datos, salud o vulneración de derechos en juego. | Delegar hacia arriba lo que sí correspondía decidir en el aula. |

**Frontera de aplicación.** La distinción es una herramienta analítica y no una jerarquía de importancia: Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre concepto y niveles del currículum |
|---|---|
...
Guárdala en `evidence/P09-C109-concepto-y-niveles-del-curriculum/` con estos archivos:
