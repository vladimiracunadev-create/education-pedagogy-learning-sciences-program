...
**Decisión que habilita:** determinar dónde se desarrolla y dónde se evalúa cada elemento del perfil a lo largo del plan<br>
...
2. Clasificar la situación distinguiendo **Mapa curricular** de **Nivel de desarrollo**.
3. Decidir con fundamento, usando **Vacío curricular** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Redundancia** a la vista.
...
| **Evidencia de logro** | qué muestra un mapa curricular completo con niveles de desarrollo por asignatura y análisis de vacíos y redundancias frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
El mapa refleja declaraciones de los docentes y envejece con cada cambio de equipo. Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Mapa curricular"]
    C --> A2["Nivel de desarrollo"]
    C --> A3["Vacío curricular"]
    C --> A4["Redundancia"]
    A1 & A2 & A3 & A4 --> D{{"determinar dónde se<br/>desarrolla y dónde se<br/>evalúa cada elemento del<br/>perfil a lo largo del<br/>plan"}}
    D --> E["Evidencia de aprendizaje<br/>un mapa curricular<br/>completo con niveles de<br/>desarrollo por<br/>asignatura y análisis de<br/>vacíos y…"]
...
inocua: produce decisiones que atacan el problema equivocado. **Mapa curricular** no es lo
...
- **Evidencia de logro.** Qué muestra un mapa curricular completo con niveles de desarrollo por asignatura y análisis de vacíos y redundancias frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
te deja en condiciones de dónde se desarrolla y dónde se evalúa cada elemento del perfil a lo largo del plan, y esa decisión se sostiene solo si
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Mapa curricular** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Mapa curricular de Nivel de desarrollo.** El trabajo aquí es separar lo observado de lo interpretado sobre **Nivel de desarrollo**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Vacío curricular como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Vacío curricular**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.

**Paso 4 — Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con Redundancia a la vista.** Con **Redundancia** ya delimitado, la pregunta pasa a ser de consecuencia: qué cambia para los estudiantes, para el tiempo de clase y para la carga del equipo. **Evidencia de partida** entrega la lectura observable; el juicio profesional sigue siendo humano y debe quedar firmado por quien lo hace.
...
|---|---|---|---|
| Intervenir sobre **Mapa curricular** | Representación de la contribución de cada asignatura a los aprendizajes del perfil | Cuando **Evidencia de partida** es observable y accionable dentro del plazo de la decisión. | Sobrerreaccionar a una señal parcial. |
| Intervenir sobre **Nivel de desarrollo** | Grado en que una asignatura introduce, desarrolla o consolida un aprendizaje | Cuando la primera explicación no distingue mecanismo ni responsable. | Convertir el concepto en etiqueta y no en intervención. |
| Observar antes de decidir | Reducir la incertidumbre antes de comprometer tiempo y credibilidad | Cuando la decisión es reversible y la evidencia disponible no distingue causas. | Observar indefinidamente y no decidir nunca. |
| Derivar o escalar | Poner la decisión donde están la competencia y la responsabilidad | Cuando hay normativa, resguardo de datos, salud o vulneración de derechos en juego. | Delegar hacia arriba lo que sí correspondía decidir en el aula. |

**Frontera de aplicación.** El mapa refleja declaraciones de los docentes y envejece con cada cambio de equipo. Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre mapas curriculares |
|---|---|
...
Guárdala en `evidence/P09-C115-mapas-curriculares/` con estos archivos:
