...
**Estado de evidencia:** `PRACTICA-PROFESIONAL` · **Etapa:** 🟣 Etapa C — Núcleo profesional docente · **Población de referencia:** diseño de asignaturas, programas y planes de estudio<br>
**Decisión que habilita:** determinar qué debe contener tu syllabus para que un estudiante pueda organizarse y un colega pueda dictar el curso<br>
...
2. Clasificar la situación distinguiendo **Syllabus** de **Carga de trabajo**.
3. Decidir con fundamento, usando **Política de curso** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Transparencia** a la vista.
...
| **Evidencia de logro** | qué muestra un syllabus completo con carga de trabajo calculada, criterios de evaluación y políticas explícitas frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
El syllabus no sustituye la comunicación durante el curso ni congela decisiones: Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Syllabus"]
    C --> A2["Carga de trabajo"]
    C --> A3["Política de curso"]
    C --> A4["Transparencia"]
    A1 & A2 & A3 & A4 --> D{{"determinar qué debe<br/>contener tu syllabus<br/>para que un estudiante<br/>pueda organizarse y un<br/>colega…"}}
    D --> E["Evidencia de aprendizaje<br/>un syllabus completo con<br/>carga de trabajo<br/>calculada, criterios de<br/>evaluación y políticas…"]
...
inocua: produce decisiones que atacan el problema equivocado. **Syllabus** no es lo
mismo que **Carga de trabajo** —tiempo total estimado del estudiante, dentro y fuera de la sesión—, y tratarlos como sinónimos hace
que la intervención se dirija al lugar incorrecto. Del mismo modo, **Política de curso** y
**Transparencia** describen aspectos distintos de la misma situación: el primero
reglas explícitas sobre entregas, atrasos, integridad académica y uso de herramientas, mientras el segundo condición de que el estudiante pueda anticipar qué se le exigirá y cómo se calificará.
...
- **Evidencia de logro.** Qué muestra un syllabus completo con carga de trabajo calculada, criterios de evaluación y políticas explícitas frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
te deja en condiciones de qué debe contener tu syllabus para que un estudiante pueda organizarse y un colega pueda dictar el curso, y esa decisión se sostiene solo si
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Syllabus** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Syllabus de Carga de trabajo.** El trabajo aquí es separar lo observado de lo interpretado sobre **Carga de trabajo**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Política de curso como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Política de curso**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.

**Paso 4 — Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con Transparencia a la vista.** Con **Transparencia** ya delimitado, la pregunta pasa a ser de consecuencia: qué cambia para los estudiantes, para el tiempo de clase y para la carga del equipo. **Evidencia de partida** entrega la lectura observable; el juicio profesional sigue siendo humano y debe quedar firmado por quien lo hace.
...
|---|---|---|---|
| Intervenir sobre **Syllabus** | Documento que define el acuerdo académico de una asignatura y su plan de trabajo | Cuando **Evidencia de partida** es observable y accionable dentro del plazo de la decisión. | Sobrerreaccionar a una señal parcial. |
| Intervenir sobre **Carga de trabajo** | Tiempo total estimado del estudiante, dentro y fuera de la sesión | Cuando la primera explicación no distingue mecanismo ni responsable. | Convertir el concepto en etiqueta y no en intervención. |
| Observar antes de decidir | Reducir la incertidumbre antes de comprometer tiempo y credibilidad | Cuando la decisión es reversible y la evidencia disponible no distingue causas. | Observar indefinidamente y no decidir nunca. |
| Derivar o escalar | Poner la decisión donde están la competencia y la responsabilidad | Cuando hay normativa, resguardo de datos, salud o vulneración de derechos en juego. | Delegar hacia arriba lo que sí correspondía decidir en el aula. |

**Frontera de aplicación.** El syllabus no sustituye la comunicación durante el curso ni congela decisiones: Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre diseño de syllabus |
|---|---|
...
Guárdala en `evidence/P09-C118-diseno-de-syllabus/` con estos archivos:
