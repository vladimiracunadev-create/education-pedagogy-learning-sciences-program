...
**Decisión que habilita:** determinar el orden de tu programa a partir de dependencias reales y no de la tradición del temario<br>
...
2. Clasificar la situación distinguiendo **Dependencia** de **Progresión**.
3. Decidir con fundamento, usando **Currículo en espiral** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Prerrequisito** a la vista.
...
| **Evidencia de logro** | qué muestra una secuencia justificada con mapa de dependencias y puntos de retorno planificados frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
No todas las secuencias tienen dependencias fuertes: Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Dependencia"]
    C --> A2["Progresión"]
    C --> A3["Currículo en espiral"]
    C --> A4["Prerrequisito"]
    A1 & A2 & A3 & A4 --> D{{"determinar el orden de<br/>tu programa a partir de<br/>dependencias reales y no<br/>de la tradición del…"}}
    D --> E["Evidencia de aprendizaje<br/>una secuencia<br/>justificada con mapa de<br/>dependencias y puntos de<br/>retorno planificados"]
...
inocua: produce decisiones que atacan el problema equivocado. **Dependencia** no es lo
...
- **Evidencia de logro.** Qué muestra una secuencia justificada con mapa de dependencias y puntos de retorno planificados frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
te deja en condiciones de el orden de tu programa a partir de dependencias reales y no de la tradición del temario, y esa decisión se sostiene solo si
...
|---|---|---|
| Bruner, J. (1960). *The Process of Education*. | origen del currículo en espiral y de la idea de estructura de la disciplina. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
| Clements, D. & Sarama, J. (2014). *Learning Trajectories*. | ejemplo detallado de secuenciación basada en evidencia sobre cómo progresa el aprendizaje. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Dependencia** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Dependencia de Progresión.** El trabajo aquí es separar lo observado de lo interpretado sobre **Progresión**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Currículo en espiral como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Currículo en espiral**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.

**Paso 4 — Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con Prerrequisito a la vista.** Con **Prerrequisito** ya delimitado, la pregunta pasa a ser de consecuencia: qué cambia para los estudiantes, para el tiempo de clase y para la carga del equipo. **Evidencia de partida** entrega la lectura observable; el juicio profesional sigue siendo humano y debe quedar firmado por quien lo hace.
...
|---|---|---|---|
| Intervenir sobre **Dependencia** | Relación por la que un aprendizaje es condición para otro | Cuando **Evidencia de partida** es observable y accionable dentro del plazo de la decisión. | Sobrerreaccionar a una señal parcial. |
| Intervenir sobre **Progresión** | Aumento planificado de complejidad, autonomía o abstracción en un mismo aprendizaje | Cuando la primera explicación no distingue mecanismo ni responsable. | Convertir el concepto en etiqueta y no en intervención. |
| Observar antes de decidir | Reducir la incertidumbre antes de comprometer tiempo y credibilidad | Cuando la decisión es reversible y la evidencia disponible no distingue causas. | Observar indefinidamente y no decidir nunca. |
| Derivar o escalar | Poner la decisión donde están la competencia y la responsabilidad | Cuando hay normativa, resguardo de datos, salud o vulneración de derechos en juego. | Delegar hacia arriba lo que sí correspondía decidir en el aula. |

**Frontera de aplicación.** No todas las secuencias tienen dependencias fuertes: Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre secuenciación curricular |
|---|---|
...
Guárdala en `evidence/P09-C114-secuenciacion-curricular/` con estos archivos:
