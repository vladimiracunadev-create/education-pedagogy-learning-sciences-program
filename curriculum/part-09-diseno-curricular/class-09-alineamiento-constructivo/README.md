...
**Estado de evidencia:** `CONSISTENTE` · **Etapa:** 🟣 Etapa C — Núcleo profesional docente · **Población de referencia:** diseño de asignaturas, programas y planes de estudio<br>
**Decisión que habilita:** determinar dónde se rompe el alineamiento de tu programa y qué corrección corresponde<br>
...
2. Clasificar la situación distinguiendo **Alineamiento constructivo** de **Actividad alineada**.
3. Decidir con fundamento, usando **Desalineamiento** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Nivel cognitivo** a la vista.
...
| **Evidencia de logro** | qué muestra una auditoría de alineamiento de una asignatura con brechas detectadas y propuesta de corrección frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
Un programa perfectamente alineado puede seguir siendo malo si sus resultados son triviales, y el alineamiento estricto puede empujar hacia objetivos fáciles de evaluar. Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Alineamiento<br/>constructivo"]
    C --> A2["Actividad alineada"]
    C --> A3["Desalineamiento"]
    C --> A4["Nivel cognitivo"]
    A1 & A2 & A3 & A4 --> D{{"determinar dónde se<br/>rompe el alineamiento de<br/>tu programa y qué<br/>corrección corresponde"}}
    D --> E["Evidencia de aprendizaje<br/>una auditoría de<br/>alineamiento de una<br/>asignatura con brechas<br/>detectadas y propuesta<br/>de corrección"]
...
inocua: produce decisiones que atacan el problema equivocado. **Alineamiento constructivo** no es lo
mismo que **Actividad alineada** —tarea que hace practicar exactamente el desempeño que el resultado declara—, y tratarlos como sinónimos hace
que la intervención se dirija al lugar incorrecto. Del mismo modo, **Desalineamiento** y
**Nivel cognitivo** describen aspectos distintos de la misma situación: el primero
situación en que la evaluación exige un desempeño que la enseñanza no desarrolló, mientras el segundo complejidad del desempeño exigido;.
...
- **Evidencia de logro.** Qué muestra una auditoría de alineamiento de una asignatura con brechas detectadas y propuesta de corrección frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
te deja en condiciones de dónde se rompe el alineamiento de tu programa y qué corrección corresponde, y esa decisión se sostiene solo si
...
|---|---|---|
| Biggs, J. (1996). *Enhancing Teaching through Constructive Alignment*. Higher Education, 32. | el artículo que formula el concepto y su procedimiento de aplicación. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
| Anderson, L. & Krathwohl, D. (2001). *A Taxonomy for Learning, Teaching, and Assessing*. | permite comparar niveles cognitivos entre resultado, actividad y evaluación. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
...
**Situación.** El programa de la asignatura declara «pensamiento crítico» como objetivo central. La única evaluación del semestre es una prueba de selección múltiple sobre contenidos, y nadie ha notado la contradicción en cuatro años.

**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Alineamiento constructivo** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Alineamiento constructivo de Actividad alineada.** El trabajo aquí es separar lo observado de lo interpretado sobre **Actividad alineada**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Desalineamiento como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Desalineamiento**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.

**Paso 4 — Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con Nivel cognitivo a la vista.** Con **Nivel cognitivo** ya delimitado, la pregunta pasa a ser de consecuencia: qué cambia para los estudiantes, para el tiempo de clase y para la carga del equipo. **Evidencia de partida** entrega la lectura observable; el juicio profesional sigue siendo humano y debe quedar firmado por quien lo hace.
...
|---|---|---|---|
| Intervenir sobre **Alineamiento constructivo** | Correspondencia entre resultados declarados, actividades de aprendizaje y tareas de evaluación | Cuando **Evidencia de partida** es observable y accionable dentro del plazo de la decisión. | Sobrerreaccionar a una señal parcial. |
| Intervenir sobre **Actividad alineada** | Tarea que hace practicar exactamente el desempeño que el resultado declara | Cuando la primera explicación no distingue mecanismo ni responsable. | Convertir el concepto en etiqueta y no en intervención. |
| Observar antes de decidir | Reducir la incertidumbre antes de comprometer tiempo y credibilidad | Cuando la decisión es reversible y la evidencia disponible no distingue causas. | Observar indefinidamente y no decidir nunca. |
| Derivar o escalar | Poner la decisión donde están la competencia y la responsabilidad | Cuando hay normativa, resguardo de datos, salud o vulneración de derechos en juego. | Delegar hacia arriba lo que sí correspondía decidir en el aula. |

**Frontera de aplicación.** Un programa perfectamente alineado puede seguir siendo malo si sus resultados son triviales, y el alineamiento estricto puede empujar hacia objetivos fáciles de evaluar. Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre alineamiento constructivo |
|---|---|
...
Guárdala en `evidence/P09-C117-alineamiento-constructivo/` con estos archivos:
...
Esta evidencia alimenta el artefacto de la parte: **currículo completo con perfil, resultados verificables, mapa curricular y auditoría de alineamiento documentada**.
...
Riesgo característico de esta parte: **Redactar objetivos con verbos no observables y evaluarlos igual.** Antes de aplicar
