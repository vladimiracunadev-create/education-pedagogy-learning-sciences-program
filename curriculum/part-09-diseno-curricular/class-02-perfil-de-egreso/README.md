...
**Estado de evidencia:** `MARCO-NORMATIVO` · **Etapa:** 🟣 Etapa C — Núcleo profesional docente · **Población de referencia:** diseño de asignaturas, programas y planes de estudio<br>
**Decisión que habilita:** determinar qué desempeños definen el perfil de egreso y cómo se comprobará que se logran<br>
...
2. Clasificar la situación distinguiendo **Perfil de egreso** de **Matriz de contribución**.
3. Decidir con fundamento, usando **Nivel de dominio** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Verificabilidad** a la vista.
...
| **Evidencia de logro** | qué muestra un perfil de egreso con desempeños verificables y su matriz de contribución por asignatura o módulo frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
Un perfil bien escrito no garantiza que el programa lo produzca: Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Perfil de egreso"]
    C --> A2["Matriz de contribución"]
    C --> A3["Nivel de dominio"]
    C --> A4["Verificabilidad"]
    A1 & A2 & A3 & A4 --> D{{"determinar qué<br/>desempeños definen el<br/>perfil de egreso y cómo<br/>se comprobará que se<br/>logran"}}
    D --> E["Evidencia de aprendizaje<br/>un perfil de egreso con<br/>desempeños verificables<br/>y su matriz de<br/>contribución por<br/>asignatura o…"]
...
inocua: produce decisiones que atacan el problema equivocado. **Perfil de egreso** no es lo
mismo que **Matriz de contribución** —tabla que muestra qué asignatura desarrolla y evalúa cada elemento del perfil—, y tratarlos como sinónimos hace
que la intervención se dirija al lugar incorrecto. Del mismo modo, **Nivel de dominio** y
**Verificabilidad** describen aspectos distintos de la misma situación: el primero
grado de desempeño esperado al egreso, distinto del de etapas intermedias, mientras el segundo posibilidad de comprobar el logro con evidencia y no solo con la aprobación de asignaturas.
...
- **Evidencia de logro.** Qué muestra un perfil de egreso con desempeños verificables y su matriz de contribución por asignatura o módulo frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
te deja en condiciones de qué desempeños definen el perfil de egreso y cómo se comprobará que se logran, y esa decisión se sostiene solo si
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Perfil de egreso** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Perfil de egreso de Matriz de contribución.** El trabajo aquí es separar lo observado de lo interpretado sobre **Matriz de contribución**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Nivel de dominio como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Nivel de dominio**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.

**Paso 4 — Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con Verificabilidad a la vista.** Con **Verificabilidad** ya delimitado, la pregunta pasa a ser de consecuencia: qué cambia para los estudiantes, para el tiempo de clase y para la carga del equipo. **Evidencia de partida** entrega la lectura observable; el juicio profesional sigue siendo humano y debe quedar firmado por quien lo hace.
...
|---|---|---|---|
| Intervenir sobre **Perfil de egreso** | Conjunto de desempeños que caracteriza a quien completa el programa | Cuando **Evidencia de partida** es observable y accionable dentro del plazo de la decisión. | Sobrerreaccionar a una señal parcial. |
| Intervenir sobre **Matriz de contribución** | Tabla que muestra qué asignatura desarrolla y evalúa cada elemento del perfil | Cuando la primera explicación no distingue mecanismo ni responsable. | Convertir el concepto en etiqueta y no en intervención. |
| Observar antes de decidir | Reducir la incertidumbre antes de comprometer tiempo y credibilidad | Cuando la decisión es reversible y la evidencia disponible no distingue causas. | Observar indefinidamente y no decidir nunca. |
| Derivar o escalar | Poner la decisión donde están la competencia y la responsabilidad | Cuando hay normativa, resguardo de datos, salud o vulneración de derechos en juego. | Delegar hacia arriba lo que sí correspondía decidir en el aula. |

**Frontera de aplicación.** Un perfil bien escrito no garantiza que el programa lo produzca: Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre perfil de egreso |
|---|---|
...
Guárdala en `evidence/P09-C110-perfil-de-egreso/` con estos archivos:
