...
**Estado de evidencia:** `ROBUSTA` · **Etapa:** 🟣 Etapa C — Núcleo profesional docente · **Población de referencia:** diseño de asignaturas, programas y planes de estudio<br>
**Decisión que habilita:** determinar el objetivo y el criterio de éxito de tu próxima clase, en lenguaje que tus estudiantes usen<br>
...
2. Clasificar la situación distinguiendo **Objetivo de clase** de **Criterio de éxito**.
3. Decidir con fundamento, usando **Ejemplo modelo** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Autoevaluación** a la vista.
...
| **Evidencia de logro** | qué muestra los objetivos y criterios de éxito de una unidad, redactados en lenguaje del estudiante y probados con ellos frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
Compartir objetivos no siempre conviene al inicio: Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Objetivo de clase"]
    C --> A2["Criterio de éxito"]
    C --> A3["Ejemplo modelo"]
    C --> A4["Autoevaluación"]
    A1 & A2 & A3 & A4 --> D{{"determinar el objetivo y<br/>el criterio de éxito de<br/>tu próxima clase, en<br/>lenguaje que tus…"}}
    D --> E["Evidencia de aprendizaje<br/>los objetivos y<br/>criterios de éxito de<br/>una unidad, redactados<br/>en lenguaje del<br/>estudiante y…"]
...
inocua: produce decisiones que atacan el problema equivocado. **Objetivo de clase** no es lo
mismo que **Criterio de éxito** —descripción de cómo se ve un trabajo logrado; permite al estudiante evaluarse—, y tratarlos como sinónimos hace
que la intervención se dirija al lugar incorrecto. Del mismo modo, **Ejemplo modelo** y
**Autoevaluación** describen aspectos distintos de la misma situación: el primero
trabajo real que ilustra el criterio y hace visible el estándar esperado, mientras el segundo juicio del estudiante sobre su propio trabajo a partir de criterios explícitos.
...
- **Evidencia de logro.** Qué muestra los objetivos y criterios de éxito de una unidad, redactados en lenguaje del estudiante y probados con ellos frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
te deja en condiciones de el objetivo y el criterio de éxito de tu próxima clase, en lenguaje que tus estudiantes usen, y esa decisión se sostiene solo si
...
|---|---|---|
| Wiliam, D. (2011). *Embedded Formative Assessment*. | desarrolla objetivos y criterios de éxito como técnica de aula con evidencia. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
| Sadler, D. R. (1989). *Formative Assessment and the Design of Instructional Systems*. | explica por qué el estudiante necesita el criterio para poder cerrar la brecha de aprendizaje. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Objetivo de clase** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Objetivo de clase de Criterio de éxito.** El trabajo aquí es separar lo observado de lo interpretado sobre **Criterio de éxito**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Ejemplo modelo como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Ejemplo modelo**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.

**Paso 4 — Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con Autoevaluación a la vista.** Con **Autoevaluación** ya delimitado, la pregunta pasa a ser de consecuencia: qué cambia para los estudiantes, para el tiempo de clase y para la carga del equipo. **Evidencia de partida** entrega la lectura observable; el juicio profesional sigue siendo humano y debe quedar firmado por quien lo hace.
...
|---|---|---|---|
| Intervenir sobre **Objetivo de clase** | Aprendizaje concreto perseguido en una sesión, distinto de la actividad que se realizará | Cuando **Evidencia de partida** es observable y accionable dentro del plazo de la decisión. | Sobrerreaccionar a una señal parcial. |
| Intervenir sobre **Criterio de éxito** | Descripción de cómo se ve un trabajo logrado; permite al estudiante evaluarse | Cuando la primera explicación no distingue mecanismo ni responsable. | Convertir el concepto en etiqueta y no en intervención. |
| Observar antes de decidir | Reducir la incertidumbre antes de comprometer tiempo y credibilidad | Cuando la decisión es reversible y la evidencia disponible no distingue causas. | Observar indefinidamente y no decidir nunca. |
| Derivar o escalar | Poner la decisión donde están la competencia y la responsabilidad | Cuando hay normativa, resguardo de datos, salud o vulneración de derechos en juego. | Delegar hacia arriba lo que sí correspondía decidir en el aula. |

**Frontera de aplicación.** Compartir objetivos no siempre conviene al inicio: Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre objetivos de aprendizaje |
|---|---|
...
Guárdala en `evidence/P09-C113-objetivos-de-aprendizaje/` con estos archivos:
