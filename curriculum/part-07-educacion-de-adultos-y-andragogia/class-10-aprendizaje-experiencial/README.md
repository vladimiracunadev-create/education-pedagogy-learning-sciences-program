...
**Decisión que habilita:** determinar cómo estructurarás la reflexión para que la experiencia produzca aprendizaje transferible<br>
...
2. Clasificar la situación distinguiendo **Ciclo experiencial** de **Reflexión estructurada**.
3. Decidir con fundamento, usando **Conceptualización** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Simulación** a la vista.
...
| **Evidencia de logro** | qué muestra el diseño de una actividad experiencial con guion de reflexión, conceptualización explícita y plan de aplicación frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
El modelo del ciclo experiencial es una heurística de diseño útil y no una teoría con respaldo experimental fuerte; Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Ciclo experiencial"]
    C --> A2["Reflexión estructurada"]
    C --> A3["Conceptualización"]
    C --> A4["Simulación"]
    A1 & A2 & A3 & A4 --> D{{"determinar cómo<br/>estructurarás la<br/>reflexión para que la<br/>experiencia produzca<br/>aprendizaje…"}}
    D --> E["Evidencia de aprendizaje<br/>el diseño de una<br/>actividad experiencial<br/>con guion de reflexión,<br/>conceptualización<br/>explícita y…"]
...
inocua: produce decisiones que atacan el problema equivocado. **Ciclo experiencial** no es lo
mismo que **Reflexión estructurada** —análisis guiado por preguntas que impide quedarse en la impresión de la experiencia—, y tratarlos como sinónimos hace
que la intervención se dirija al lugar incorrecto. Del mismo modo, **Conceptualización** y
**Simulación** describen aspectos distintos de la misma situación: el primero
paso en que la experiencia se conecta con un modelo o principio que permite transferirla, mientras el segundo recreación controlada de una situación real para practicar sin consecuencias reales.
...
- **Evidencia de logro.** Qué muestra el diseño de una actividad experiencial con guion de reflexión, conceptualización explícita y plan de aplicación frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
te deja en condiciones de cómo estructurarás la reflexión para que la experiencia produzca aprendizaje transferible, y esa decisión se sostiene solo si
...
|---|---|---|
| Kolb, D. (1984). *Experiential Learning*. | el modelo del ciclo; útil para el diseño de la reflexión, no para clasificar personas. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
| Schön, D. (1983). *The Reflective Practitioner*. | fundamenta la reflexión sobre la acción como mecanismo de aprendizaje profesional. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Ciclo experiencial** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Ciclo experiencial de Reflexión estructurada.** El trabajo aquí es separar lo observado de lo interpretado sobre **Reflexión estructurada**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Conceptualización como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Conceptualización**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.

**Paso 4 — Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con Simulación a la vista.** Con **Simulación** ya delimitado, la pregunta pasa a ser de consecuencia: qué cambia para los estudiantes, para el tiempo de clase y para la carga del equipo. **Evidencia de partida** entrega la lectura observable; el juicio profesional sigue siendo humano y debe quedar firmado por quien lo hace.
...
**Frontera de aplicación.** El modelo del ciclo experiencial es una heurística de diseño útil y no una teoría con respaldo experimental fuerte; Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre aprendizaje experiencial |
|---|---|
...
Guárdala en `evidence/P07-C094-aprendizaje-experiencial/` con estos archivos:
