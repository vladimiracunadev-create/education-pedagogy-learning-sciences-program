...
**Decisión que habilita:** determinar qué nivel de evaluación necesitas realmente y qué instrumento lo hace viable<br>
...
2. Clasificar la situación distinguiendo **Nivel de reacción** de **Nivel de aprendizaje**.
3. Decidir con fundamento, usando **Nivel de conducta** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Nivel de resultado** a la vista.
...
| **Evidencia de logro** | qué muestra un plan de evaluación de un programa con al menos dos niveles y sus instrumentos, más el análisis de sus límites frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
El modelo de cuatro niveles es una taxonomía útil y no un modelo causal validado: Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Nivel de reacción"]
    C --> A2["Nivel de aprendizaje"]
    C --> A3["Nivel de conducta"]
    C --> A4["Nivel de resultado"]
    A1 & A2 & A3 & A4 --> D{{"determinar qué nivel de<br/>evaluación necesitas<br/>realmente y qué<br/>instrumento lo hace<br/>viable"}}
    D --> E["Evidencia de aprendizaje<br/>un plan de evaluación de<br/>un programa con al menos<br/>dos niveles y sus<br/>instrumentos, más el…"]
...
inocua: produce decisiones que atacan el problema equivocado. **Nivel de reacción** no es lo
...
- **Evidencia de logro.** Qué muestra un plan de evaluación de un programa con al menos dos niveles y sus instrumentos, más el análisis de sus límites frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
te deja en condiciones de qué nivel de evaluación necesitas realmente y qué instrumento lo hace viable, y esa decisión se sostiene solo si
...
|---|---|---|
| Kirkpatrick, D. & Kirkpatrick, J. (2006). *Evaluating Training Programs*. | el modelo de cuatro niveles, ampliamente usado; conviene conocerlo con sus críticas. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
| Alliger, G. & Janak, E. (1989). *Kirkpatrick's Levels of Training Criteria: Thirty Years Later*. | el análisis que muestra la débil relación entre niveles y desmonta su lectura jerárquica. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Nivel de reacción** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Nivel de reacción de Nivel de aprendizaje.** El trabajo aquí es separar lo observado de lo interpretado sobre **Nivel de aprendizaje**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Nivel de conducta como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Nivel de conducta**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.

**Paso 4 — Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con Nivel de resultado a la vista.** Con **Nivel de resultado** ya delimitado, la pregunta pasa a ser de consecuencia: qué cambia para los estudiantes, para el tiempo de clase y para la carga del equipo. **Evidencia de partida** entrega la lectura observable; el juicio profesional sigue siendo humano y debe quedar firmado por quien lo hace.
...
|---|---|---|---|
| Intervenir sobre **Nivel de reacción** | Satisfacción declarada por el participante; el más fácil de medir y el menos informativo | Cuando **Evidencia de partida** es observable y accionable dentro del plazo de la decisión. | Sobrerreaccionar a una señal parcial. |
| Intervenir sobre **Nivel de aprendizaje** | Verificación de lo aprendido con instrumentos distintos de la autopercepción | Cuando la primera explicación no distingue mecanismo ni responsable. | Convertir el concepto en etiqueta y no en intervención. |
| Observar antes de decidir | Reducir la incertidumbre antes de comprometer tiempo y credibilidad | Cuando la decisión es reversible y la evidencia disponible no distingue causas. | Observar indefinidamente y no decidir nunca. |
| Derivar o escalar | Poner la decisión donde están la competencia y la responsabilidad | Cuando hay normativa, resguardo de datos, salud o vulneración de derechos en juego. | Delegar hacia arriba lo que sí correspondía decidir en el aula. |

**Frontera de aplicación.** El modelo de cuatro niveles es una taxonomía útil y no un modelo causal validado: Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre evaluación en formación de adultos |
|---|---|
...
Guárdala en `evidence/P07-C095-evaluacion-en-formacion-de-adultos/` con estos archivos:
