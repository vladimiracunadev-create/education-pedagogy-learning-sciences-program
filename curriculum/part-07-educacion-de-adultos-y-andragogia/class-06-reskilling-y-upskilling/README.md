...
**Estado de evidencia:** `EMERGENTE` · **Etapa:** 🔵 Etapa B — Enseñanza por ciclo vital · **Población de referencia:** educación de adultos, capacitación laboral y formación continua<br>
**Decisión que habilita:** determinar qué brecha específica separa el perfil actual del perfil objetivo y en qué orden se cierra<br>
...
2. Clasificar la situación distinguiendo **Reconversión** de **Actualización**.
3. Decidir con fundamento, usando **Brecha de competencias** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Competencia transferible** a la vista.
...
| **Evidencia de logro** | qué muestra un plan de reconversión con brecha diagnosticada, ruta formativa priorizada y estimación realista de tiempo frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
La evidencia sobre programas de reconversión es heterogénea y sus resultados dependen fuertemente del mercado laboral local y de la duración del programa. Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Reconversión"]
    C --> A2["Actualización"]
    C --> A3["Brecha de competencias"]
    C --> A4["Competencia<br/>transferible"]
    A1 & A2 & A3 & A4 --> D{{"determinar qué brecha<br/>específica separa el<br/>perfil actual del perfil<br/>objetivo y en qué orden<br/>se…"}}
    D --> E["Evidencia de aprendizaje<br/>un plan de reconversión<br/>con brecha<br/>diagnosticada, ruta<br/>formativa priorizada y<br/>estimación…"]
...
inocua: produce decisiones que atacan el problema equivocado. **Reconversión** no es lo
mismo que **Actualización** —mejora de competencias dentro del mismo oficio ante cambios tecnológicos o normativos—, y tratarlos como sinónimos hace
que la intervención se dirija al lugar incorrecto. Del mismo modo, **Brecha de competencias** y
**Competencia transferible** describen aspectos distintos de la misma situación: el primero
diferencia entre el perfil actual de la persona y el perfil objetivo del puesto, mientras el segundo capacidad del oficio anterior que sigue siendo válida en el nuevo contexto.
...
- **Evidencia de logro.** Qué muestra un plan de reconversión con brecha diagnosticada, ruta formativa priorizada y estimación realista de tiempo frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
te deja en condiciones de qué brecha específica separa el perfil actual del perfil objetivo y en qué orden se cierra, y esa decisión se sostiene solo si
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Reconversión** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Reconversión de Actualización.** El trabajo aquí es separar lo observado de lo interpretado sobre **Actualización**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Brecha de competencias como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Brecha de competencias**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.

**Paso 4 — Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con Competencia transferible a la vista.** Con **Competencia transferible** ya delimitado, la pregunta pasa a ser de consecuencia: qué cambia para los estudiantes, para el tiempo de clase y para la carga del equipo. **Evidencia de partida** entrega la lectura observable; el juicio profesional sigue siendo humano y debe quedar firmado por quien lo hace.
...
|---|---|---|---|
| Intervenir sobre **Reconversión** | Cambio hacia un oficio distinto, que exige competencias nuevas y no solo actualización | Cuando **Evidencia de partida** es observable y accionable dentro del plazo de la decisión. | Sobrerreaccionar a una señal parcial. |
| Intervenir sobre **Actualización** | Mejora de competencias dentro del mismo oficio ante cambios tecnológicos o normativos | Cuando la primera explicación no distingue mecanismo ni responsable. | Convertir el concepto en etiqueta y no en intervención. |
| Observar antes de decidir | Reducir la incertidumbre antes de comprometer tiempo y credibilidad | Cuando la decisión es reversible y la evidencia disponible no distingue causas. | Observar indefinidamente y no decidir nunca. |
| Derivar o escalar | Poner la decisión donde están la competencia y la responsabilidad | Cuando hay normativa, resguardo de datos, salud o vulneración de derechos en juego. | Delegar hacia arriba lo que sí correspondía decidir en el aula. |

**Frontera de aplicación.** La evidencia sobre programas de reconversión es heterogénea y sus resultados dependen fuertemente del mercado laboral local y de la duración del programa. Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre reskilling y upskilling |
|---|---|
...
Guárdala en `evidence/P07-C090-reskilling-y-upskilling/` con estos archivos:
