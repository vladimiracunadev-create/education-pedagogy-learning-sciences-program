...
**Decisión que habilita:** determinar qué estructura mínima necesita tu programa de mentoría para producir resultados verificables<br>
...
2. Clasificar la situación distinguiendo **Mentoría** de **Acuerdo de mentoría**.
3. Decidir con fundamento, usando **Emparejamiento** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Cierre** a la vista.
...
| **Evidencia de logro** | qué muestra un diseño de programa de mentoría con criterios de emparejamiento, acuerdos, frecuencia y evaluación frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
Los efectos reportados provienen sobre todo de estudios correlacionales con autoselección: Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Mentoría"]
    C --> A2["Acuerdo de mentoría"]
    C --> A3["Emparejamiento"]
    C --> A4["Cierre"]
    A1 & A2 & A3 & A4 --> D{{"determinar qué<br/>estructura mínima<br/>necesita tu programa de<br/>mentoría para producir<br/>resultados…"}}
    D --> E["Evidencia de aprendizaje<br/>un diseño de programa de<br/>mentoría con criterios<br/>de emparejamiento,<br/>acuerdos, frecuencia y…"]
...
inocua: produce decisiones que atacan el problema equivocado. **Mentoría** no es lo
...
- **Evidencia de logro.** Qué muestra un diseño de programa de mentoría con criterios de emparejamiento, acuerdos, frecuencia y evaluación frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
te deja en condiciones de qué estructura mínima necesita tu programa de mentoría para producir resultados verificables, y esa decisión se sostiene solo si
...
|---|---|---|
| Eby, L. et al. (2008). *Does Mentoring Matter? A Multidisciplinary Meta-Analysis*. | síntesis de efectos y de sus limitaciones metodológicas. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
| Clutterbuck, D. (2004). *Everyone Needs a Mentor*. | modelo operativo de diseño de programas con acuerdos y estructura. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Mentoría** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Mentoría de Acuerdo de mentoría.** El trabajo aquí es separar lo observado de lo interpretado sobre **Acuerdo de mentoría**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Emparejamiento como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Emparejamiento**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.

**Paso 4 — Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con Cierre a la vista.** Con **Cierre** ya delimitado, la pregunta pasa a ser de consecuencia: qué cambia para los estudiantes, para el tiempo de clase y para la carga del equipo. **Evidencia de partida** entrega la lectura observable; el juicio profesional sigue siendo humano y debe quedar firmado por quien lo hace.
...
|---|---|---|---|
| Intervenir sobre **Mentoría** | Relación en que una persona con más experiencia acompaña el desarrollo de otra en su contexto | Cuando **Evidencia de partida** es observable y accionable dentro del plazo de la decisión. | Sobrerreaccionar a una señal parcial. |
| Intervenir sobre **Acuerdo de mentoría** | Documento breve con objetivos, frecuencia, duración y confidencialidad de la relación | Cuando la primera explicación no distingue mecanismo ni responsable. | Convertir el concepto en etiqueta y no en intervención. |
| Observar antes de decidir | Reducir la incertidumbre antes de comprometer tiempo y credibilidad | Cuando la decisión es reversible y la evidencia disponible no distingue causas. | Observar indefinidamente y no decidir nunca. |
| Derivar o escalar | Poner la decisión donde están la competencia y la responsabilidad | Cuando hay normativa, resguardo de datos, salud o vulneración de derechos en juego. | Delegar hacia arriba lo que sí correspondía decidir en el aula. |

**Frontera de aplicación.** Los efectos reportados provienen sobre todo de estudios correlacionales con autoselección: Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre mentoría |
|---|---|
...
Guárdala en `evidence/P07-C092-mentoria/` con estos archivos:
