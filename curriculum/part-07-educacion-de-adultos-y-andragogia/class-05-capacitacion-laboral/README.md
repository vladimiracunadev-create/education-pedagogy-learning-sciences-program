...
**Decisión que habilita:** determinar qué desempeño debe cambiar en el puesto y qué condiciones organizacionales lo permitirán<br>
...
2. Clasificar la situación distinguiendo **Análisis de necesidades** de **Objetivo de desempeño**.
3. Decidir con fundamento, usando **Transferencia** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Clima de transferencia** a la vista.
...
| **Evidencia de logro** | qué muestra un diseño de capacitación con análisis de necesidades, objetivos de desempeño y plan de transferencia acordado con la jefatura frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
La evidencia sobre transferencia muestra que los factores organizacionales pesan tanto como el diseño instruccional, y que muchos programas exitosos en aprendizaje fracasan en transferencia por razones ajenas a la formación. Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Análisis de<br/>necesidades"]
    C --> A2["Objetivo de desempeño"]
    C --> A3["Transferencia"]
    C --> A4["Clima de transferencia"]
    A1 & A2 & A3 & A4 --> D{{"determinar qué desempeño<br/>debe cambiar en el<br/>puesto y qué condiciones<br/>organizacionales lo…"}}
    D --> E["Evidencia de aprendizaje<br/>un diseño de<br/>capacitación con<br/>análisis de necesidades,<br/>objetivos de desempeño y<br/>plan de…"]
...
inocua: produce decisiones que atacan el problema equivocado. **Análisis de necesidades** no es lo
...
- **Evidencia de logro.** Qué muestra un diseño de capacitación con análisis de necesidades, objetivos de desempeño y plan de transferencia acordado con la jefatura frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
te deja en condiciones de qué desempeño debe cambiar en el puesto y qué condiciones organizacionales lo permitirán, y esa decisión se sostiene solo si
...
|---|---|---|
| Baldwin, T. & Ford, J. K. (1988). *Transfer of Training*. Personnel Psychology, 41. | el modelo clásico de transferencia y sus factores organizacionales. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
| Blume, B. et al. (2010). *Transfer of Training: A Meta-Analytic Review*. Journal of Management, 36(4). | síntesis cuantitativa sobre qué predice realmente la transferencia. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Análisis de necesidades** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Análisis de necesidades de Objetivo de desempeño.** El trabajo aquí es separar lo observado de lo interpretado sobre **Objetivo de desempeño**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Transferencia como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Transferencia**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.

**Paso 4 — Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con Clima de transferencia a la vista.** Con **Clima de transferencia** ya delimitado, la pregunta pasa a ser de consecuencia: qué cambia para los estudiantes, para el tiempo de clase y para la carga del equipo. **Evidencia de partida** entrega la lectura observable; el juicio profesional sigue siendo humano y debe quedar firmado por quien lo hace.
...
|---|---|---|---|
| Intervenir sobre **Análisis de necesidades** | Diagnóstico que distingue si el problema se resuelve con formación o con otra intervención | Cuando **Evidencia de partida** es observable y accionable dentro del plazo de la decisión. | Sobrerreaccionar a una señal parcial. |
| Intervenir sobre **Objetivo de desempeño** | Cambio observable en el trabajo, distinto de un objetivo de conocimiento | Cuando la primera explicación no distingue mecanismo ni responsable. | Convertir el concepto en etiqueta y no en intervención. |
| Observar antes de decidir | Reducir la incertidumbre antes de comprometer tiempo y credibilidad | Cuando la decisión es reversible y la evidencia disponible no distingue causas. | Observar indefinidamente y no decidir nunca. |
| Derivar o escalar | Poner la decisión donde están la competencia y la responsabilidad | Cuando hay normativa, resguardo de datos, salud o vulneración de derechos en juego. | Delegar hacia arriba lo que sí correspondía decidir en el aula. |

**Frontera de aplicación.** La evidencia sobre transferencia muestra que los factores organizacionales pesan tanto como el diseño instruccional, y que muchos programas exitosos en aprendizaje fracasan en transferencia por razones ajenas a la formación. Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre capacitación laboral |
|---|---|
...
Guárdala en `evidence/P07-C089-capacitacion-laboral/` con estos archivos:
