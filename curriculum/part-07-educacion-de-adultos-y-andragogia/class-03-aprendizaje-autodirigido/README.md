...
**Decisión que habilita:** determinar qué apoyos a la autorregulación incorporará tu programa para sostener el trabajo autónomo<br>
...
2. Clasificar la situación distinguiendo **Aprendizaje autodirigido** de **Contrato de aprendizaje**.
3. Decidir con fundamento, usando **Monitoreo del avance** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Punto de contacto** a la vista.
...
| **Evidencia de logro** | qué muestra un dispositivo de apoyo a la autodirección con metas, plan, seguimiento y punto de contacto ante el abandono frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
La autodirección no es un rasgo estable: Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Aprendizaje<br/>autodirigido"]
    C --> A2["Contrato de<br/>aprendizaje"]
    C --> A3["Monitoreo del avance"]
    C --> A4["Punto de contacto"]
    A1 & A2 & A3 & A4 --> D{{"determinar qué apoyos a<br/>la autorregulación<br/>incorporará tu programa<br/>para sostener el<br/>trabajo…"}}
    D --> E["Evidencia de aprendizaje<br/>un dispositivo de apoyo<br/>a la autodirección con<br/>metas, plan, seguimiento<br/>y punto de contacto…"]
...
- **Evidencia de logro.** Qué muestra un dispositivo de apoyo a la autodirección con metas, plan, seguimiento y punto de contacto ante el abandono frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
te deja en condiciones de qué apoyos a la autorregulación incorporará tu programa para sostener el trabajo autónomo, y esa decisión se sostiene solo si
...
|---|---|---|
| Zimmerman, B. (2002). *Becoming a Self-Regulated Learner*. | modelo de autorregulación con fases y estrategias enseñables. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
| Education Endowment Foundation (2018). *Metacognition and Self-Regulated Learning*. | evidencia sobre qué apoyos a la autorregulación funcionan y con qué magnitud. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Aprendizaje autodirigido** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Aprendizaje autodirigido de Contrato de aprendizaje.** El trabajo aquí es separar lo observado de lo interpretado sobre **Contrato de aprendizaje**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Monitoreo del avance como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Monitoreo del avance**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.

**Paso 4 — Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con Punto de contacto a la vista.** Con **Punto de contacto** ya delimitado, la pregunta pasa a ser de consecuencia: qué cambia para los estudiantes, para el tiempo de clase y para la carga del equipo. **Evidencia de partida** entrega la lectura observable; el juicio profesional sigue siendo humano y debe quedar firmado por quien lo hace.
...
**Frontera de aplicación.** La autodirección no es un rasgo estable: Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre aprendizaje autodirigido |
|---|---|
...
Guárdala en `evidence/P07-C087-aprendizaje-autodirigido/` con estos archivos:
