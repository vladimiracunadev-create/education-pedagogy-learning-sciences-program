...
**Decisión que habilita:** determinar qué experiencia previa vas a usar como anclaje y cuál vas a confrontar<br>
...
2. Clasificar la situación distinguiendo **Anclaje** de **Creencia arraigada**.
3. Decidir con fundamento, usando **Desaprendizaje** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Validación de la experiencia** a la vista.
...
| **Evidencia de logro** | qué muestra un instrumento de activación de experiencia previa con el uso previsto de cada respuesta esperada frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
No toda creencia arraigada es errónea: Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Anclaje"]
    C --> A2["Creencia arraigada"]
    C --> A3["Desaprendizaje"]
    C --> A4["Validación de la<br/>experiencia"]
    A1 & A2 & A3 & A4 --> D{{"determinar qué<br/>experiencia previa vas a<br/>usar como anclaje y cuál<br/>vas a confrontar"}}
    D --> E["Evidencia de aprendizaje<br/>un instrumento de<br/>activación de<br/>experiencia previa con<br/>el uso previsto de cada<br/>respuesta…"]
...
inocua: produce decisiones que atacan el problema equivocado. **Anclaje** no es lo
mismo que **Creencia arraigada** —idea sostenida por experiencia personal, resistente al argumento y frecuente en adultos con oficio—, y tratarlos como sinónimos hace
que la intervención se dirija al lugar incorrecto. Del mismo modo, **Desaprendizaje** y
**Validación de la experiencia** describen aspectos distintos de la misma situación: el primero
proceso de abandonar una práctica o creencia consolidada;, mientras el segundo reconocimiento explícito de lo que el participante sabe antes de corregir lo que sabe mal.
...
- **Evidencia de logro.** Qué muestra un instrumento de activación de experiencia previa con el uso previsto de cada respuesta esperada frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
te deja en condiciones de qué experiencia previa vas a usar como anclaje y cuál vas a confrontar, y esa decisión se sostiene solo si
...
|---|---|---|
| Mezirow, J. (1991). *Transformative Dimensions of Adult Learning*. | explica cómo se revisan supuestos consolidados y qué condiciones lo hacen posible. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
| Schön, D. (1983). *The Reflective Practitioner*. | describe el conocimiento en la acción del profesional experimentado y su resistencia al cambio. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Anclaje** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Anclaje de Creencia arraigada.** El trabajo aquí es separar lo observado de lo interpretado sobre **Creencia arraigada**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Desaprendizaje como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Desaprendizaje**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.

**Paso 4 — Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con Validación de la experiencia a la vista.** Con **Validación de la experiencia** ya delimitado, la pregunta pasa a ser de consecuencia: qué cambia para los estudiantes, para el tiempo de clase y para la carga del equipo. **Evidencia de partida** entrega la lectura observable; el juicio profesional sigue siendo humano y debe quedar firmado por quien lo hace.
...
|---|---|---|---|
| Intervenir sobre **Anclaje** | Conexión entre el contenido nuevo y una experiencia previa que le da sentido | Cuando **Evidencia de partida** es observable y accionable dentro del plazo de la decisión. | Sobrerreaccionar a una señal parcial. |
| Intervenir sobre **Creencia arraigada** | Idea sostenida por experiencia personal, resistente al argumento y frecuente en adultos con oficio | Cuando la primera explicación no distingue mecanismo ni responsable. | Convertir el concepto en etiqueta y no en intervención. |
| Observar antes de decidir | Reducir la incertidumbre antes de comprometer tiempo y credibilidad | Cuando la decisión es reversible y la evidencia disponible no distingue causas. | Observar indefinidamente y no decidir nunca. |
| Derivar o escalar | Poner la decisión donde están la competencia y la responsabilidad | Cuando hay normativa, resguardo de datos, salud o vulneración de derechos en juego. | Delegar hacia arriba lo que sí correspondía decidir en el aula. |

**Frontera de aplicación.** No toda creencia arraigada es errónea: Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre experiencia previa como recurso |
|---|---|
...
Guárdala en `evidence/P07-C086-experiencia-previa-como-recurso/` con estos archivos:
