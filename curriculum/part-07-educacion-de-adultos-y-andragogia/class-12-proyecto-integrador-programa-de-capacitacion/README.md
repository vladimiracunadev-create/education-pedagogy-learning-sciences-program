...
**Decisión que habilita:** determinar el diseño completo del programa y qué evidencia probará que produjo cambio en el desempeño<br>
...
2. Clasificar la situación distinguiendo **Programa de capacitación** de **Guion del formador**.
3. Decidir con fundamento, usando **Fidelidad de implementación** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Escalabilidad** a la vista.
...
| **Evidencia de logro** | qué muestra un programa de capacitación completo con diagnóstico, diseño, materiales, plan de transferencia y evaluación frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
Un programa bien diseñado no garantiza transferencia: Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Programa de<br/>capacitación"]
    C --> A2["Guion del formador"]
    C --> A3["Fidelidad de<br/>implementación"]
    C --> A4["Escalabilidad"]
    A1 & A2 & A3 & A4 --> D{{"determinar el diseño<br/>completo del programa y<br/>qué evidencia probará<br/>que produjo cambio en<br/>el…"}}
    D --> E["Evidencia de aprendizaje<br/>un programa de<br/>capacitación completo<br/>con diagnóstico, diseño,<br/>materiales, plan de<br/>transferencia…"]
...
inocua: produce decisiones que atacan el problema equivocado. **Programa de capacitación** no es lo
mismo que **Guion del formador** —documento que permite a otra persona ejecutar la sesión con fidelidad razonable—, y tratarlos como sinónimos hace
que la intervención se dirija al lugar incorrecto. Del mismo modo, **Fidelidad de implementación** y
**Escalabilidad** describen aspectos distintos de la misma situación: el primero
grado en que la ejecución corresponde al diseño;, mientras el segundo posibilidad de repetir el programa con otros formadores y grupos sin perder calidad.
...
- **Evidencia de logro.** Qué muestra un programa de capacitación completo con diagnóstico, diseño, materiales, plan de transferencia y evaluación frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
te deja en condiciones de el diseño completo del programa y qué evidencia probará que produjo cambio en el desempeño, y esa decisión se sostiene solo si
...
|---|---|---|
| Merriam, S. & Bierema, L. (2013). *Adult Learning: Linking Theory and Practice*. | marco general del diseño para adultos con criterios de calidad. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
| Blume, B. et al. (2010). *Transfer of Training: A Meta-Analytic Review*. | evidencia sobre qué condiciones del diseño y del entorno predicen transferencia. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Programa de capacitación** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Programa de capacitación de Guion del formador.** El trabajo aquí es separar lo observado de lo interpretado sobre **Guion del formador**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Fidelidad de implementación como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Fidelidad de implementación**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.

**Paso 4 — Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con Escalabilidad a la vista.** Con **Escalabilidad** ya delimitado, la pregunta pasa a ser de consecuencia: qué cambia para los estudiantes, para el tiempo de clase y para la carga del equipo. **Evidencia de partida** entrega la lectura observable; el juicio profesional sigue siendo humano y debe quedar firmado por quien lo hace.
...
|---|---|---|---|
| Intervenir sobre **Programa de capacitación** | Conjunto articulado de sesiones, materiales y evaluación orientado a un cambio de desempeño | Cuando **Evidencia de partida** es observable y accionable dentro del plazo de la decisión. | Sobrerreaccionar a una señal parcial. |
| Intervenir sobre **Guion del formador** | Documento que permite a otra persona ejecutar la sesión con fidelidad razonable | Cuando la primera explicación no distingue mecanismo ni responsable. | Convertir el concepto en etiqueta y no en intervención. |
| Observar antes de decidir | Reducir la incertidumbre antes de comprometer tiempo y credibilidad | Cuando la decisión es reversible y la evidencia disponible no distingue causas. | Observar indefinidamente y no decidir nunca. |
| Derivar o escalar | Poner la decisión donde están la competencia y la responsabilidad | Cuando hay normativa, resguardo de datos, salud o vulneración de derechos en juego. | Delegar hacia arriba lo que sí correspondía decidir en el aula. |

**Frontera de aplicación.** Un programa bien diseñado no garantiza transferencia: Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre proyecto integrador: programa de capacitación |
|---|---|
...
Guárdala en `evidence/P07-C096-proyecto-integrador-programa-de-capacitacion/` con estos archivos:
