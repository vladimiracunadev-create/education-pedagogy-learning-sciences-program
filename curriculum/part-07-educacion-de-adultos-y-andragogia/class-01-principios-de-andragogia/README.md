...
**Decisión que habilita:** determinar qué supuesto andragógico se cumple en tu grupo real y cuál no<br>
...
2. Clasificar la situación distinguiendo **Andragogía** de **Necesidad de saber por qué**.
3. Decidir con fundamento, usando **Autoconcepto de autonomía** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Orientación a la tarea** a la vista.
...
| **Evidencia de logro** | qué muestra un diagnóstico de tu grupo adulto que contraste los supuestos andragógicos con lo que efectivamente observas frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
La andragogía ha sido criticada por su débil base empírica: Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Andragogía"]
    C --> A2["Necesidad de saber por<br/>qué"]
    C --> A3["Autoconcepto de<br/>autonomía"]
    C --> A4["Orientación a la tarea"]
    A1 & A2 & A3 & A4 --> D{{"determinar qué supuesto<br/>andragógico se cumple en<br/>tu grupo real y cuál no"}}
    D --> E["Evidencia de aprendizaje<br/>un diagnóstico de tu<br/>grupo adulto que<br/>contraste los supuestos<br/>andragógicos con lo que…"]
...
inocua: produce decisiones que atacan el problema equivocado. **Andragogía** no es lo
mismo que **Necesidad de saber por qué** —exigencia adulta de comprender la utilidad de lo que se le pide aprender—, y tratarlos como sinónimos hace
que la intervención se dirija al lugar incorrecto. Del mismo modo, **Autoconcepto de autonomía** y
**Orientación a la tarea** describen aspectos distintos de la misma situación: el primero
imagen de sí mismo como persona que decide;, mientras el segundo preferencia por aprendizajes organizados en torno a problemas reales y no a materias.
...
- **Evidencia de logro.** Qué muestra un diagnóstico de tu grupo adulto que contraste los supuestos andragógicos con lo que efectivamente observas frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
te deja en condiciones de qué supuesto andragógico se cumple en tu grupo real y cuál no, y esa decisión se sostiene solo si
...
|---|---|---|
| Knowles, M. (1984). *The Adult Learner*. | la formulación clásica de los supuestos; imprescindible como referencia y como objeto de crítica. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
| Merriam, S. & Bierema, L. (2013). *Adult Learning: Linking Theory and Practice*. | revisa críticamente la andragogía y separa lo respaldado de lo asumido. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Andragogía** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Andragogía de Necesidad de saber por qué.** El trabajo aquí es separar lo observado de lo interpretado sobre **Necesidad de saber por qué**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Autoconcepto de autonomía como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Autoconcepto de autonomía**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.

**Paso 4 — Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con Orientación a la tarea a la vista.** Con **Orientación a la tarea** ya delimitado, la pregunta pasa a ser de consecuencia: qué cambia para los estudiantes, para el tiempo de clase y para la carga del equipo. **Evidencia de partida** entrega la lectura observable; el juicio profesional sigue siendo humano y debe quedar firmado por quien lo hace.
...
|---|---|---|---|
| Intervenir sobre **Andragogía** | Conjunto de supuestos sobre cómo aprenden los adultos, formulado como alternativa a la pedagogía escolar | Cuando **Evidencia de partida** es observable y accionable dentro del plazo de la decisión. | Sobrerreaccionar a una señal parcial. |
| Intervenir sobre **Necesidad de saber por qué** | Exigencia adulta de comprender la utilidad de lo que se le pide aprender | Cuando la primera explicación no distingue mecanismo ni responsable. | Convertir el concepto en etiqueta y no en intervención. |
| Observar antes de decidir | Reducir la incertidumbre antes de comprometer tiempo y credibilidad | Cuando la decisión es reversible y la evidencia disponible no distingue causas. | Observar indefinidamente y no decidir nunca. |
| Derivar o escalar | Poner la decisión donde están la competencia y la responsabilidad | Cuando hay normativa, resguardo de datos, salud o vulneración de derechos en juego. | Delegar hacia arriba lo que sí correspondía decidir en el aula. |

**Frontera de aplicación.** La andragogía ha sido criticada por su débil base empírica: Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre principios de andragogía |
|---|---|
...
Guárdala en `evidence/P07-C085-principios-de-andragogia/` con estos archivos:
