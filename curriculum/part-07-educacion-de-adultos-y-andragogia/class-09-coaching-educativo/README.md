...
**Estado de evidencia:** `EN-DEBATE` · **Etapa:** 🔵 Etapa B — Enseñanza por ciclo vital · **Población de referencia:** educación de adultos, capacitación laboral y formación continua<br>
**Decisión que habilita:** determinar si la situación requiere coaching, mentoría, supervisión o derivación a otro profesional<br>
...
2. Clasificar la situación distinguiendo **Coaching** de **Observación de desempeño**.
3. Decidir con fundamento, usando **Pregunta de coaching** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Límite de rol** a la vista.
...
| **Evidencia de logro** | qué muestra un protocolo de conversación de coaching con su estructura, sus preguntas y sus límites declarados frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
El término se usa para prácticas muy distintas y buena parte de la oferta comercial carece de base empírica. Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Coaching"]
    C --> A2["Observación de<br/>desempeño"]
    C --> A3["Pregunta de coaching"]
    C --> A4["Límite de rol"]
    A1 & A2 & A3 & A4 --> D{{"determinar si la<br/>situación requiere<br/>coaching, mentoría,<br/>supervisión o derivación<br/>a otro…"}}
    D --> E["Evidencia de aprendizaje<br/>un protocolo de<br/>conversación de coaching<br/>con su estructura, sus<br/>preguntas y sus límites…"]
...
inocua: produce decisiones que atacan el problema equivocado. **Coaching** no es lo
mismo que **Observación de desempeño** —base del coaching educativo: se trabaja sobre lo que se observó, no sobre lo que se cree—, y tratarlos como sinónimos hace
que la intervención se dirija al lugar incorrecto. Del mismo modo, **Pregunta de coaching** y
**Límite de rol** describen aspectos distintos de la misma situación: el primero
intervención que ayuda a analizar el propio desempeño en vez de entregar la respuesta, mientras el segundo frontera entre acompañar el desempeño y abordar asuntos que exigen otro profesional.
...
- **Evidencia de logro.** Qué muestra un protocolo de conversación de coaching con su estructura, sus preguntas y sus límites declarados frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
te deja en condiciones de si la situación requiere coaching, mentoría, supervisión o derivación a otro profesional, y esa decisión se sostiene solo si
...
|---|---|---|
| Kraft, M., Blazar, D. & Hogan, D. (2018). *The Effect of Teacher Coaching on Instruction and Achievement*. Review of Educational Research, 88(4). | metaanálisis con efectos y con la caída observada al escalar los programas. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
| Knight, J. (2007). *Instructional Coaching*. | modelo operativo de coaching instruccional con protocolos de conversación. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
...
**Situación.** El sostenedor contrató una capacitación de 16 horas en evaluación formativa para los 42 docentes. Todos la evaluaron con nota alta y, tres meses después, ninguna práctica de aula cambió.

**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Coaching** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Coaching de Observación de desempeño.** El trabajo aquí es separar lo observado de lo interpretado sobre **Observación de desempeño**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Pregunta de coaching como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Pregunta de coaching**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.

**Paso 4 — Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con Límite de rol a la vista.** Con **Límite de rol** ya delimitado, la pregunta pasa a ser de consecuencia: qué cambia para los estudiantes, para el tiempo de clase y para la carga del equipo. **Evidencia de partida** entrega la lectura observable; el juicio profesional sigue siendo humano y debe quedar firmado por quien lo hace.
...
|---|---|---|---|
| Intervenir sobre **Coaching** | Acompañamiento estructurado orientado a que la persona mejore un desempeño que ella misma define | Cuando **Evidencia de partida** es observable y accionable dentro del plazo de la decisión. | Sobrerreaccionar a una señal parcial. |
| Intervenir sobre **Observación de desempeño** | Base del coaching educativo: se trabaja sobre lo que se observó, no sobre lo que se cree | Cuando la primera explicación no distingue mecanismo ni responsable. | Convertir el concepto en etiqueta y no en intervención. |
| Observar antes de decidir | Reducir la incertidumbre antes de comprometer tiempo y credibilidad | Cuando la decisión es reversible y la evidencia disponible no distingue causas. | Observar indefinidamente y no decidir nunca. |
| Derivar o escalar | Poner la decisión donde están la competencia y la responsabilidad | Cuando hay normativa, resguardo de datos, salud o vulneración de derechos en juego. | Delegar hacia arriba lo que sí correspondía decidir en el aula. |

**Frontera de aplicación.** El término se usa para prácticas muy distintas y buena parte de la oferta comercial carece de base empírica. Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre coaching educativo |
|---|---|
...
Guárdala en `evidence/P07-C093-coaching-educativo/` con estos archivos:
...
Esta evidencia alimenta el artefacto de la parte: **programa de capacitación ejecutable por otro formador, con diagnóstico, plan de transferencia acordado y evaluación más allá de la satisfacción**.
...
Riesgo característico de esta parte: **Diseñar para el contenido y no para el problema que el adulto necesita resolver.** Antes de aplicar
...
- Kraft, M., Blazar, D. & Hogan, D. (2018). *The Effect of Teacher Coaching on Instruction and Achievement*. Review of Educational Research, 88(4). **Uso en esta clase:** metaanálisis con efectos y con la caída observada al escalar los programas. Lectura selectiva: índice y capítulos pertinentes; registra edición y páginas consultadas.
- Knight, J. (2007). *Instructional Coaching*. **Uso en esta clase:** modelo operativo de coaching instruccional con protocolos de conversación. Lectura selectiva: índice y capítulos pertinentes; registra edición y páginas consultadas.
