...
**Decisión que habilita:** determinar si tu objetivo se puede lograr con un formato breve o si exige sesiones extensas<br>
...
2. Clasificar la situación distinguiendo **Microaprendizaje** de **Espaciado**.
3. Decidir con fundamento, usando **Objetivo acotado** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Fragmentación** a la vista.
...
| **Evidencia de logro** | qué muestra una secuencia de microaprendizaje con objetivos acotados, espaciado planificado y verificación de aprendizaje frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
La evidencia específica sobre microaprendizaje es limitada y de calidad variable; Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Microaprendizaje"]
    C --> A2["Espaciado"]
    C --> A3["Objetivo acotado"]
    C --> A4["Fragmentación"]
    A1 & A2 & A3 & A4 --> D{{"determinar si tu<br/>objetivo se puede lograr<br/>con un formato breve o<br/>si exige sesiones<br/>extensas"}}
    D --> E["Evidencia de aprendizaje<br/>una secuencia de<br/>microaprendizaje con<br/>objetivos acotados,<br/>espaciado planificado y<br/>verificación…"]
...
inocua: produce decisiones que atacan el problema equivocado. **Microaprendizaje** no es lo
mismo que **Espaciado** —distribución de las unidades en el tiempo para favorecer retención—, y tratarlos como sinónimos hace
que la intervención se dirija al lugar incorrecto. Del mismo modo, **Objetivo acotado** y
**Fragmentación** describen aspectos distintos de la misma situación: el primero
aprendizaje que puede lograrse y verificarse en una unidad breve, mientras el segundo riesgo de dividir un contenido complejo hasta perder la comprensión del conjunto.
...
- **Evidencia de logro.** Qué muestra una secuencia de microaprendizaje con objetivos acotados, espaciado planificado y verificación de aprendizaje frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
te deja en condiciones de si tu objetivo se puede lograr con un formato breve o si exige sesiones extensas, y esa decisión se sostiene solo si
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Microaprendizaje** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Microaprendizaje de Espaciado.** El trabajo aquí es separar lo observado de lo interpretado sobre **Espaciado**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Objetivo acotado como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Objetivo acotado**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.

**Paso 4 — Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con Fragmentación a la vista.** Con **Fragmentación** ya delimitado, la pregunta pasa a ser de consecuencia: qué cambia para los estudiantes, para el tiempo de clase y para la carga del equipo. **Evidencia de partida** entrega la lectura observable; el juicio profesional sigue siendo humano y debe quedar firmado por quien lo hace.
...
|---|---|---|---|
| Intervenir sobre **Microaprendizaje** | Unidad formativa breve y autocontenida orientada a un objetivo acotado | Cuando **Evidencia de partida** es observable y accionable dentro del plazo de la decisión. | Sobrerreaccionar a una señal parcial. |
| Intervenir sobre **Espaciado** | Distribución de las unidades en el tiempo para favorecer retención | Cuando la primera explicación no distingue mecanismo ni responsable. | Convertir el concepto en etiqueta y no en intervención. |
| Observar antes de decidir | Reducir la incertidumbre antes de comprometer tiempo y credibilidad | Cuando la decisión es reversible y la evidencia disponible no distingue causas. | Observar indefinidamente y no decidir nunca. |
| Derivar o escalar | Poner la decisión donde están la competencia y la responsabilidad | Cuando hay normativa, resguardo de datos, salud o vulneración de derechos en juego. | Delegar hacia arriba lo que sí correspondía decidir en el aula. |

**Frontera de aplicación.** La evidencia específica sobre microaprendizaje es limitada y de calidad variable; Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre microlearning |
|---|---|
...
Guárdala en `evidence/P07-C091-microlearning/` con estos archivos:
