...
**Decisión que habilita:** determinar qué debe decidir el estudiante en tu laboratorio para que aprenda algo más que el procedimiento<br>
...
2. Clasificar la situación distinguiendo **Laboratorio de receta** de **Decisión experimental**.
3. Decidir con fundamento, usando **Análisis de datos propios** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Incertidumbre** a la vista.
...
| **Evidencia de logro** | qué muestra el rediseño de una práctica de laboratorio con decisiones del estudiante y análisis de datos propios frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
El rediseño consume más tiempo y exige más apoyo, lo que en cursos numerosos tiene un costo real. Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Laboratorio de receta"]
    C --> A2["Decisión experimental"]
    C --> A3["Análisis de datos<br/>propios"]
    C --> A4["Incertidumbre"]
    A1 & A2 & A3 & A4 --> D{{"determinar qué debe<br/>decidir el estudiante en<br/>tu laboratorio para que<br/>aprenda algo más que el…"}}
    D --> E["Evidencia de aprendizaje<br/>el rediseño de una<br/>práctica de laboratorio<br/>con decisiones del<br/>estudiante y análisis de<br/>datos…"]
...
inocua: produce decisiones que atacan el problema equivocado. **Laboratorio de receta** no es lo
...
- **Evidencia de logro.** Qué muestra el rediseño de una práctica de laboratorio con decisiones del estudiante y análisis de datos propios frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
te deja en condiciones de qué debe decidir el estudiante en tu laboratorio para que aprenda algo más que el procedimiento, y esa decisión se sostiene solo si
...
|---|---|---|
| Holmes, N. G. & Wieman, C. (2018). *Introductory Physics Labs: We Can Do Better*. Physics Today. | evidencia sobre el bajo aporte conceptual de los laboratorios de receta y alternativas. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
| Hofstein, A. & Lunetta, V. (2004). *The Laboratory in Science Education*. | revisión sobre qué aprende y qué no aprende el estudiante en el laboratorio. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Laboratorio de receta** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Laboratorio de receta de Decisión experimental.** El trabajo aquí es separar lo observado de lo interpretado sobre **Decisión experimental**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Análisis de datos propios como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Análisis de datos propios**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.

**Paso 4 — Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con Incertidumbre a la vista.** Con **Incertidumbre** ya delimitado, la pregunta pasa a ser de consecuencia: qué cambia para los estudiantes, para el tiempo de clase y para la carga del equipo. **Evidencia de partida** entrega la lectura observable; el juicio profesional sigue siendo humano y debe quedar firmado por quien lo hace.
...
|---|---|---|---|
| Intervenir sobre **Laboratorio de receta** | Práctica en que el procedimiento está completamente prescrito y el resultado es conocido | Cuando **Evidencia de partida** es observable y accionable dentro del plazo de la decisión. | Sobrerreaccionar a una señal parcial. |
| Intervenir sobre **Decisión experimental** | Elección que el estudiante debe tomar y justificar durante la práctica | Cuando la primera explicación no distingue mecanismo ni responsable. | Convertir el concepto en etiqueta y no en intervención. |
| Observar antes de decidir | Reducir la incertidumbre antes de comprometer tiempo y credibilidad | Cuando la decisión es reversible y la evidencia disponible no distingue causas. | Observar indefinidamente y no decidir nunca. |
| Derivar o escalar | Poner la decisión donde están la competencia y la responsabilidad | Cuando hay normativa, resguardo de datos, salud o vulneración de derechos en juego. | Delegar hacia arriba lo que sí correspondía decidir en el aula. |

**Frontera de aplicación.** El rediseño consume más tiempo y exige más apoyo, lo que en cursos numerosos tiene un costo real. Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre laboratorios |
|---|---|
...
Guárdala en `evidence/P14-C174-laboratorios/` con estos archivos:
