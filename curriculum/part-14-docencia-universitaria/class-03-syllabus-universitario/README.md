...
**Decisión que habilita:** determinar qué información necesita el estudiante para organizarse y tomar decisiones sobre tu curso<br>
...
2. Clasificar la situación distinguiendo **Syllabus** de **Política de curso**.
3. Decidir con fundamento, usando **Bibliografía justificada** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Accesibilidad declarada** a la vista.
...
| **Evidencia de logro** | qué muestra un syllabus universitario completo, revisado por un estudiante y por un colega frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
El syllabus no reemplaza la comunicación durante el semestre ni impide ajustes justificados. Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Syllabus"]
    C --> A2["Política de curso"]
    C --> A3["Bibliografía<br/>justificada"]
    C --> A4["Accesibilidad<br/>declarada"]
    A1 & A2 & A3 & A4 --> D{{"determinar qué<br/>información necesita el<br/>estudiante para<br/>organizarse y tomar<br/>decisiones sobre tu…"}}
    D --> E["Evidencia de aprendizaje<br/>un syllabus<br/>universitario completo,<br/>revisado por un<br/>estudiante y por un<br/>colega"]
...
- **Evidencia de logro.** Qué muestra un syllabus universitario completo, revisado por un estudiante y por un colega frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
te deja en condiciones de qué información necesita el estudiante para organizarse y tomar decisiones sobre tu curso, y esa decisión se sostiene solo si
...
**Paso 2 — Clasificar la situación distinguiendo Syllabus de Política de curso.** El trabajo aquí es separar lo observado de lo interpretado sobre **Política de curso**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Bibliografía justificada como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Bibliografía justificada**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.

**Paso 4 — Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con Accesibilidad declarada a la vista.** Con **Accesibilidad declarada** ya delimitado, la pregunta pasa a ser de consecuencia: qué cambia para los estudiantes, para el tiempo de clase y para la carga del equipo. **Evidencia de partida** entrega la lectura observable; el juicio profesional sigue siendo humano y debe quedar firmado por quien lo hace.
...
|---|---|---|---|
| Intervenir sobre **Syllabus** | Documento que establece el acuerdo académico y el plan de trabajo de la asignatura | Cuando **Evidencia de partida** es observable y accionable dentro del plazo de la decisión. | Sobrerreaccionar a una señal parcial. |
| Intervenir sobre **Política de curso** | Reglas explícitas sobre entregas, atrasos, integridad y uso de herramientas | Cuando la primera explicación no distingue mecanismo ni responsable. | Convertir el concepto en etiqueta y no en intervención. |
| Observar antes de decidir | Reducir la incertidumbre antes de comprometer tiempo y credibilidad | Cuando la decisión es reversible y la evidencia disponible no distingue causas. | Observar indefinidamente y no decidir nunca. |
| Derivar o escalar | Poner la decisión donde están la competencia y la responsabilidad | Cuando hay normativa, resguardo de datos, salud o vulneración de derechos en juego. | Delegar hacia arriba lo que sí correspondía decidir en el aula. |

**Frontera de aplicación.** El syllabus no reemplaza la comunicación durante el semestre ni impide ajustes justificados. Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre syllabus universitario |
|---|---|
...
Guárdala en `evidence/P14-C171-syllabus-universitario/` con estos archivos:
