...
**Estado de evidencia:** `EN-DEBATE` · **Etapa:** 🟠 Etapa D — Educación superior y liderazgo · **Población de referencia:** pregrado y postgrado universitario y técnico superior<br>
**Decisión que habilita:** determinar qué evaluaciones de tu asignatura son insostenibles y con qué las reemplazas<br>
...
3. Decidir con fundamento, usando **Uso declarado** como criterio y declarando la fuente.
...
| **Evidencia de logro** | qué muestra una política de integridad de asignatura con evaluaciones rediseñadas y procedimiento con debido proceso frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
El campo está en transición y no hay consenso sobre qué usos son legítimos. Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A3["Uso declarado"]
    C --> A4["Debido proceso"]
    A1 & A2 & A3 & A4 --> D{{"determinar qué<br/>evaluaciones de tu<br/>asignatura son<br/>insostenibles y con qué<br/>las reemplazas"}}
    D --> E["Evidencia de aprendizaje<br/>una política de<br/>integridad de asignatura<br/>con evaluaciones<br/>rediseñadas y<br/>procedimiento con…"]
...
- **Evidencia de logro.** Qué muestra una política de integridad de asignatura con evaluaciones rediseñadas y procedimiento con debido proceso frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
te deja en condiciones de qué evaluaciones de tu asignatura son insostenibles y con qué las reemplazas, y esa decisión se sostiene solo si
...
|---|---|---|---|
| Intervenir sobre **Integridad académica** | Conjunto de normas sobre autoría, honestidad y atribución en el trabajo académico | Cuando **Evidencia de partida** es observable y accionable dentro del plazo de la decisión. | Sobrerreaccionar a una señal parcial. |
| Intervenir sobre **Evaluación resistente** | Tarea que no puede resolverse sin el aprendizaje que declara evaluar | Cuando la primera explicación no distingue mecanismo ni responsable. | Convertir el concepto en etiqueta y no en intervención. |
| Observar antes de decidir | Reducir la incertidumbre antes de comprometer tiempo y credibilidad | Cuando la decisión es reversible y la evidencia disponible no distingue causas. | Observar indefinidamente y no decidir nunca. |
| Derivar o escalar | Poner la decisión donde están la competencia y la responsabilidad | Cuando hay normativa, resguardo de datos, salud o vulneración de derechos en juego. | Delegar hacia arriba lo que sí correspondía decidir en el aula. |

**Frontera de aplicación.** El campo está en transición y no hay consenso sobre qué usos son legítimos. Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre integridad académica |
|---|---|
...
Guárdala en `evidence/P14-C177-integridad-academica/` con estos archivos:
