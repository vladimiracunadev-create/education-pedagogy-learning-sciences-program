...
**Estado de evidencia:** `CONSISTENTE` · **Etapa:** 🟠 Etapa D — Educación superior y liderazgo · **Población de referencia:** pregrado y postgrado universitario y técnico superior<br>
**Decisión que habilita:** determinar el diseño completo de la asignatura y qué evidencia mostrará que produjo aprendizaje<br>
...
2. Clasificar la situación distinguiendo **Diseño integral** de **Revisión de pares docente**.
3. Decidir con fundamento, usando **Evidencia de resultados** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Mejora iterativa** a la vista.
...
| **Evidencia de logro** | qué muestra una asignatura universitaria completa con syllabus, diseño de sesiones, sistema de evaluación y análisis de resultados frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
Una asignatura ejecutada una vez no permite atribuir resultados al diseño: Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Diseño integral"]
    C --> A2["Revisión de pares<br/>docente"]
    C --> A3["Evidencia de<br/>resultados"]
    C --> A4["Mejora iterativa"]
    A1 & A2 & A3 & A4 --> D{{"determinar el diseño<br/>completo de la<br/>asignatura y qué<br/>evidencia mostrará que<br/>produjo aprendizaje"}}
    D --> E["Evidencia de aprendizaje<br/>una asignatura<br/>universitaria completa<br/>con syllabus, diseño de<br/>sesiones, sistema de<br/>evaluación y…"]
...
inocua: produce decisiones que atacan el problema equivocado. **Diseño integral** no es lo
mismo que **Revisión de pares docente** —evaluación del diseño por colegas antes o después de su implementación—, y tratarlos como sinónimos hace
que la intervención se dirija al lugar incorrecto. Del mismo modo, **Evidencia de resultados** y
**Mejora iterativa** describen aspectos distintos de la misma situación: el primero
información sobre el aprendizaje logrado y no solo sobre la satisfacción, mientras el segundo ajuste del diseño con la evidencia de cada versión del curso.
...
- **Evidencia de logro.** Qué muestra una asignatura universitaria completa con syllabus, diseño de sesiones, sistema de evaluación y análisis de resultados frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
te deja en condiciones de el diseño completo de la asignatura y qué evidencia mostrará que produjo aprendizaje, y esa decisión se sostiene solo si
...
|---|---|---|
| Biggs, J. & Tang, C. (2011). *Teaching for Quality Learning at University*. | marco integral para diseñar y revisar una asignatura completa. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
| Boyer, E. (1990). *Scholarship Reconsidered*. | fundamenta la docencia como objeto legítimo de indagación académica sistemática. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
...
**Situación.** En la carrera de pedagogía de la universidad asociada, la asignatura de primer año reprueba al 45 % cada semestre. El programa declara 6 créditos y exige, medido en horas reales, casi el doble.

**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Diseño integral** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Diseño integral de Revisión de pares docente.** El trabajo aquí es separar lo observado de lo interpretado sobre **Revisión de pares docente**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Evidencia de resultados como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Evidencia de resultados**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.

**Paso 4 — Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con Mejora iterativa a la vista.** Con **Mejora iterativa** ya delimitado, la pregunta pasa a ser de consecuencia: qué cambia para los estudiantes, para el tiempo de clase y para la carga del equipo. **Evidencia de partida** entrega la lectura observable; el juicio profesional sigue siendo humano y debe quedar firmado por quien lo hace.
...
|---|---|---|---|
| Intervenir sobre **Diseño integral** | Articulación de resultados, métodos, evaluación y carga en una sola asignatura coherente | Cuando **Evidencia de partida** es observable y accionable dentro del plazo de la decisión. | Sobrerreaccionar a una señal parcial. |
| Intervenir sobre **Revisión de pares docente** | Evaluación del diseño por colegas antes o después de su implementación | Cuando la primera explicación no distingue mecanismo ni responsable. | Convertir el concepto en etiqueta y no en intervención. |
| Observar antes de decidir | Reducir la incertidumbre antes de comprometer tiempo y credibilidad | Cuando la decisión es reversible y la evidencia disponible no distingue causas. | Observar indefinidamente y no decidir nunca. |
| Derivar o escalar | Poner la decisión donde están la competencia y la responsabilidad | Cuando hay normativa, resguardo de datos, salud o vulneración de derechos en juego. | Delegar hacia arriba lo que sí correspondía decidir en el aula. |

**Frontera de aplicación.** Una asignatura ejecutada una vez no permite atribuir resultados al diseño: Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre proyecto integrador: asignatura universitaria |
|---|---|
...
Guárdala en `evidence/P14-C180-proyecto-integrador-asignatura-universitaria/` con estos archivos:
...
Esta evidencia alimenta el artefacto de la parte: **asignatura universitaria completa con syllabus, carga calculada, métodos activos y sistema de evaluación sostenible**.
...
Riesgo característico de esta parte: **Suponer que el dominio disciplinar se traduce solo en buena enseñanza.** Antes de aplicar
...
- Biggs, J. & Tang, C. (2011). *Teaching for Quality Learning at University*. **Uso en esta clase:** marco integral para diseñar y revisar una asignatura completa. Lectura selectiva: índice y capítulos pertinentes; registra edición y páginas consultadas.
- Boyer, E. (1990). *Scholarship Reconsidered*. **Uso en esta clase:** fundamenta la docencia como objeto legítimo de indagación académica sistemática. Lectura selectiva: índice y capítulos pertinentes; registra edición y páginas consultadas.
