...
**Estado de evidencia:** `ROBUSTA` · **Etapa:** 🟠 Etapa D — Educación superior y liderazgo · **Población de referencia:** pregrado y postgrado universitario y técnico superior<br>
**Decisión que habilita:** determinar dónde intercalarás procesamiento activo en tu clase y cómo verificarás su efecto<br>
...
2. Clasificar la situación distinguiendo **Procesamiento activo** de **Intercalado**.
3. Decidir con fundamento, usando **Instrucción entre pares** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Verificación en gran grupo** a la vista.
...
| **Evidencia de logro** | qué muestra el rediseño de una cátedra con actividades de procesamiento intercaladas y su verificación de comprensión frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
Los efectos dependen de la calidad de las preguntas y de la implementación, no del formato en sí: Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Procesamiento activo"]
    C --> A2["Intercalado"]
    C --> A3["Instrucción entre<br/>pares"]
    C --> A4["Verificación en gran<br/>grupo"]
    A1 & A2 & A3 & A4 --> D{{"determinar dónde<br/>intercalarás<br/>procesamiento activo en<br/>tu clase y cómo<br/>verificarás su efecto"}}
    D --> E["Evidencia de aprendizaje<br/>el rediseño de una<br/>cátedra con actividades<br/>de procesamiento<br/>intercaladas y su<br/>verificación de…"]
...
inocua: produce decisiones que atacan el problema equivocado. **Procesamiento activo** no es lo
mismo que **Intercalado** —alternancia entre exposición breve y actividad, en vez de exposición continua—, y tratarlos como sinónimos hace
que la intervención se dirija al lugar incorrecto. Del mismo modo, **Instrucción entre pares** y
**Verificación en gran grupo** describen aspectos distintos de la misma situación: el primero
técnica en que los estudiantes discuten una pregunta conceptual y vuelven a responder, mientras el segundo técnica que revela el estado de comprensión de un curso numeroso en poco tiempo.
...
- **Evidencia de logro.** Qué muestra el rediseño de una cátedra con actividades de procesamiento intercaladas y su verificación de comprensión frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
te deja en condiciones de dónde intercalarás procesamiento activo en tu clase y cómo verificarás su efecto, y esa decisión se sostiene solo si
...
|---|---|---|
| Freeman, S. et al. (2014). *Active Learning Increases Student Performance*. PNAS, 111(23). | el metaanálisis que reordenó la discusión sobre la cátedra universitaria. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
| Mazur, E. (1997). *Peer Instruction: A User's Manual*. | el método de instrucción entre pares con su implementación paso a paso. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Procesamiento activo** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Procesamiento activo de Intercalado.** El trabajo aquí es separar lo observado de lo interpretado sobre **Intercalado**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Instrucción entre pares como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Instrucción entre pares**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.

**Paso 4 — Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con Verificación en gran grupo a la vista.** Con **Verificación en gran grupo** ya delimitado, la pregunta pasa a ser de consecuencia: qué cambia para los estudiantes, para el tiempo de clase y para la carga del equipo. **Evidencia de partida** entrega la lectura observable; el juicio profesional sigue siendo humano y debe quedar firmado por quien lo hace.
...
|---|---|---|---|
| Intervenir sobre **Procesamiento activo** | Actividad que obliga al estudiante a recuperar, aplicar o explicar lo que se está enseñando | Cuando **Evidencia de partida** es observable y accionable dentro del plazo de la decisión. | Sobrerreaccionar a una señal parcial. |
| Intervenir sobre **Intercalado** | Alternancia entre exposición breve y actividad, en vez de exposición continua | Cuando la primera explicación no distingue mecanismo ni responsable. | Convertir el concepto en etiqueta y no en intervención. |
| Observar antes de decidir | Reducir la incertidumbre antes de comprometer tiempo y credibilidad | Cuando la decisión es reversible y la evidencia disponible no distingue causas. | Observar indefinidamente y no decidir nunca. |
| Derivar o escalar | Poner la decisión donde están la competencia y la responsabilidad | Cuando hay normativa, resguardo de datos, salud o vulneración de derechos en juego. | Delegar hacia arriba lo que sí correspondía decidir en el aula. |

**Frontera de aplicación.** Los efectos dependen de la calidad de las preguntas y de la implementación, no del formato en sí: Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre clase magistral efectiva |
|---|---|
...
Guárdala en `evidence/P14-C172-clase-magistral-efectiva/` con estos archivos:
