...
**Decisión que habilita:** determinar qué aporta tu asignatura al perfil de egreso y qué se puede sacrificar de su temario<br>
...
2. Clasificar la situación distinguiendo **Contribución al perfil** de **Temario heredado**.
3. Decidir con fundamento, usando **Carga académica** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Coherencia de programa** a la vista.
...
| **Evidencia de logro** | qué muestra el diseño de una asignatura con su contribución al perfil, alineamiento y carga calculada frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
La autonomía docente y la tradición disciplinar hacen que estas decisiones sean políticas además de técnicas: Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Contribución al perfil"]
    C --> A2["Temario heredado"]
    C --> A3["Carga académica"]
    C --> A4["Coherencia de programa"]
    A1 & A2 & A3 & A4 --> D{{"determinar qué aporta tu<br/>asignatura al perfil de<br/>egreso y qué se puede<br/>sacrificar de su temario"}}
    D --> E["Evidencia de aprendizaje<br/>el diseño de una<br/>asignatura con su<br/>contribución al perfil,<br/>alineamiento y carga<br/>calculada"]
...
inocua: produce decisiones que atacan el problema equivocado. **Contribución al perfil** no es lo
mismo que **Temario heredado** —conjunto de contenidos que se enseñan por tradición y no por su aporte al perfil—, y tratarlos como sinónimos hace
que la intervención se dirija al lugar incorrecto. Del mismo modo, **Carga académica** y
**Coherencia de programa** describen aspectos distintos de la misma situación: el primero
tiempo total del estudiante expresado en créditos y verificado contra la realidad, mientras el segundo articulación con las asignaturas previas y posteriores de la carrera.
...
- **Evidencia de logro.** Qué muestra el diseño de una asignatura con su contribución al perfil, alineamiento y carga calculada frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
te deja en condiciones de qué aporta tu asignatura al perfil de egreso y qué se puede sacrificar de su temario, y esa decisión se sostiene solo si
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Contribución al perfil** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Contribución al perfil de Temario heredado.** El trabajo aquí es separar lo observado de lo interpretado sobre **Temario heredado**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Carga académica como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Carga académica**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.

**Paso 4 — Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con Coherencia de programa a la vista.** Con **Coherencia de programa** ya delimitado, la pregunta pasa a ser de consecuencia: qué cambia para los estudiantes, para el tiempo de clase y para la carga del equipo. **Evidencia de partida** entrega la lectura observable; el juicio profesional sigue siendo humano y debe quedar firmado por quien lo hace.
...
|---|---|---|---|
| Intervenir sobre **Contribución al perfil** | Aporte específico de la asignatura a los desempeños del egresado | Cuando **Evidencia de partida** es observable y accionable dentro del plazo de la decisión. | Sobrerreaccionar a una señal parcial. |
| Intervenir sobre **Temario heredado** | Conjunto de contenidos que se enseñan por tradición y no por su aporte al perfil | Cuando la primera explicación no distingue mecanismo ni responsable. | Convertir el concepto en etiqueta y no en intervención. |
| Observar antes de decidir | Reducir la incertidumbre antes de comprometer tiempo y credibilidad | Cuando la decisión es reversible y la evidencia disponible no distingue causas. | Observar indefinidamente y no decidir nunca. |
| Derivar o escalar | Poner la decisión donde están la competencia y la responsabilidad | Cuando hay normativa, resguardo de datos, salud o vulneración de derechos en juego. | Delegar hacia arriba lo que sí correspondía decidir en el aula. |

**Frontera de aplicación.** La autonomía docente y la tradición disciplinar hacen que estas decisiones sean políticas además de técnicas: Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre diseño de asignaturas |
|---|---|
...
Guárdala en `evidence/P14-C170-diseno-de-asignaturas/` con estos archivos:
