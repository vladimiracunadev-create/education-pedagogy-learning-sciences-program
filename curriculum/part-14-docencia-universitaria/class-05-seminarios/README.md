...
**Decisión que habilita:** determinar qué preparación exigirás y cómo asegurarás que la discusión trabaje sobre el texto<br>
...
2. Clasificar la situación distinguiendo **Seminario** de **Preparación verificada**.
3. Decidir con fundamento, usando **Rol de sesión** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Contribución intelectual** a la vista.
...
| **Evidencia de logro** | qué muestra el diseño de un seminario con preparación exigida, estructura de sesión y criterios de evaluación de la participación frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
No hay evidencia experimental sólida sobre formatos de seminario: Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Seminario"]
    C --> A2["Preparación verificada"]
    C --> A3["Rol de sesión"]
    C --> A4["Contribución<br/>intelectual"]
    A1 & A2 & A3 & A4 --> D{{"determinar qué<br/>preparación exigirás y<br/>cómo asegurarás que la<br/>discusión trabaje sobre<br/>el texto"}}
    D --> E["Evidencia de aprendizaje<br/>el diseño de un<br/>seminario con<br/>preparación exigida,<br/>estructura de sesión y<br/>criterios de…"]
...
inocua: produce decisiones que atacan el problema equivocado. **Seminario** no es lo
mismo que **Preparación verificada** —mecanismo que asegura que el texto fue leído antes de la sesión—, y tratarlos como sinónimos hace
que la intervención se dirija al lugar incorrecto. Del mismo modo, **Rol de sesión** y
**Contribución intelectual** describen aspectos distintos de la misma situación: el primero
función asignada —presentar, objetar, moderar, sintetizar— que estructura la discusión, mientras el segundo aporte que hace avanzar la discusión, distinto de la cantidad de intervenciones.
...
- **Evidencia de logro.** Qué muestra el diseño de un seminario con preparación exigida, estructura de sesión y criterios de evaluación de la participación frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
te deja en condiciones de qué preparación exigirás y cómo asegurarás que la discusión trabaje sobre el texto, y esa decisión se sostiene solo si
...
|---|---|---|
| Brookfield, S. & Preskill, S. (2005). *Discussion as a Way of Teaching*. | repertorio de estructuras de discusión con criterios de conducción. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
| Alexander, R. (2020). *A Dialogic Teaching Companion*. | principios de discusión productiva aplicables al formato de seminario. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Seminario** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Seminario de Preparación verificada.** El trabajo aquí es separar lo observado de lo interpretado sobre **Preparación verificada**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Rol de sesión como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Rol de sesión**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.

**Paso 4 — Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con Contribución intelectual a la vista.** Con **Contribución intelectual** ya delimitado, la pregunta pasa a ser de consecuencia: qué cambia para los estudiantes, para el tiempo de clase y para la carga del equipo. **Evidencia de partida** entrega la lectura observable; el juicio profesional sigue siendo humano y debe quedar firmado por quien lo hace.
...
|---|---|---|---|
| Intervenir sobre **Seminario** | Formato de discusión intensiva sobre textos o problemas, con participación exigida | Cuando **Evidencia de partida** es observable y accionable dentro del plazo de la decisión. | Sobrerreaccionar a una señal parcial. |
| Intervenir sobre **Preparación verificada** | Mecanismo que asegura que el texto fue leído antes de la sesión | Cuando la primera explicación no distingue mecanismo ni responsable. | Convertir el concepto en etiqueta y no en intervención. |
| Observar antes de decidir | Reducir la incertidumbre antes de comprometer tiempo y credibilidad | Cuando la decisión es reversible y la evidencia disponible no distingue causas. | Observar indefinidamente y no decidir nunca. |
| Derivar o escalar | Poner la decisión donde están la competencia y la responsabilidad | Cuando hay normativa, resguardo de datos, salud o vulneración de derechos en juego. | Delegar hacia arriba lo que sí correspondía decidir en el aula. |

**Frontera de aplicación.** No hay evidencia experimental sólida sobre formatos de seminario: Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre seminarios |
|---|---|
...
Guárdala en `evidence/P14-C173-seminarios/` con estos archivos:
