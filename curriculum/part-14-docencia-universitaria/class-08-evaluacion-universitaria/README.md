...
**Decisión que habilita:** determinar cómo distribuir la evaluación para que informe el aprendizaje sin volverse insostenible<br>
...
2. Clasificar la situación distinguiendo **Evaluación distribuida** de **Carga de corrección**.
3. Decidir con fundamento, usando **Retroalimentación entre pares** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Evaluación por muestreo** a la vista.
...
| **Evidencia de logro** | qué muestra un sistema de evaluación de asignatura con carga de corrección calculada y retroalimentación planificada frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
La retroalimentación entre pares tiene calidad variable y requiere formación y criterios; Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Evaluación distribuida"]
    C --> A2["Carga de corrección"]
    C --> A3["Retroalimentación<br/>entre pares"]
    C --> A4["Evaluación por<br/>muestreo"]
    A1 & A2 & A3 & A4 --> D{{"determinar cómo<br/>distribuir la evaluación<br/>para que informe el<br/>aprendizaje sin<br/>volverse…"}}
    D --> E["Evidencia de aprendizaje<br/>un sistema de evaluación<br/>de asignatura con carga<br/>de corrección calculada<br/>y retroalimentación…"]
...
inocua: produce decisiones que atacan el problema equivocado. **Evaluación distribuida** no es lo
mismo que **Carga de corrección** —tiempo docente que exige el sistema de evaluación; determina su sostenibilidad—, y tratarlos como sinónimos hace
que la intervención se dirija al lugar incorrecto. Del mismo modo, **Retroalimentación entre pares** y
**Evaluación por muestreo** describen aspectos distintos de la misma situación: el primero
revisión estructurada entre estudiantes con criterios, que amplía la retroalimentación disponible, mientras el segundo estrategia de revisar en profundidad una parte del trabajo y no todo.
...
- **Evidencia de logro.** Qué muestra un sistema de evaluación de asignatura con carga de corrección calculada y retroalimentación planificada frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
te deja en condiciones de cómo distribuir la evaluación para que informe el aprendizaje sin volverse insostenible, y esa decisión se sostiene solo si
...
|---|---|---|
| Boud, D. & Molloy, E. (2013). *Rethinking Models of Feedback for Learning*. | propone sistemas de retroalimentación sostenibles y centrados en el uso del estudiante. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
| Nicol, D. & Macfarlane-Dick (2006). *Formative Assessment and Self-Regulated Learning*. | principios de evaluación que fortalecen la autorregulación en educación superior. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Evaluación distribuida** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Evaluación distribuida de Carga de corrección.** El trabajo aquí es separar lo observado de lo interpretado sobre **Carga de corrección**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Retroalimentación entre pares como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Retroalimentación entre pares**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.

**Paso 4 — Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con Evaluación por muestreo a la vista.** Con **Evaluación por muestreo** ya delimitado, la pregunta pasa a ser de consecuencia: qué cambia para los estudiantes, para el tiempo de clase y para la carga del equipo. **Evidencia de partida** entrega la lectura observable; el juicio profesional sigue siendo humano y debe quedar firmado por quien lo hace.
...
|---|---|---|---|
| Intervenir sobre **Evaluación distribuida** | Conjunto de instancias a lo largo del semestre, en vez de una o dos pruebas finales | Cuando **Evidencia de partida** es observable y accionable dentro del plazo de la decisión. | Sobrerreaccionar a una señal parcial. |
| Intervenir sobre **Carga de corrección** | Tiempo docente que exige el sistema de evaluación; determina su sostenibilidad | Cuando la primera explicación no distingue mecanismo ni responsable. | Convertir el concepto en etiqueta y no en intervención. |
| Observar antes de decidir | Reducir la incertidumbre antes de comprometer tiempo y credibilidad | Cuando la decisión es reversible y la evidencia disponible no distingue causas. | Observar indefinidamente y no decidir nunca. |
| Derivar o escalar | Poner la decisión donde están la competencia y la responsabilidad | Cuando hay normativa, resguardo de datos, salud o vulneración de derechos en juego. | Delegar hacia arriba lo que sí correspondía decidir en el aula. |

**Frontera de aplicación.** La retroalimentación entre pares tiene calidad variable y requiere formación y criterios; Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre evaluación universitaria |
|---|---|
...
Guárdala en `evidence/P14-C176-evaluacion-universitaria/` con estos archivos:
