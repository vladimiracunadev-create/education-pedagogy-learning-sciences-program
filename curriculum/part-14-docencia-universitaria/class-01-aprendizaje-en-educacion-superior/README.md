...
**Decisión que habilita:** determinar qué decisión tuya está empujando a tus estudiantes hacia el enfoque superficial<br>
...
2. Clasificar la situación distinguiendo **Enfoque profundo** de **Enfoque superficial**.
3. Decidir con fundamento, usando **Carga percibida** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Demanda de la evaluación** a la vista.
...
| **Evidencia de logro** | qué muestra un análisis de tu asignatura que identifique qué condiciones inducen enfoque superficial y su corrección frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
La distinción entre enfoques es una herramienta descriptiva y no una tipología de personas: Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Enfoque profundo"]
    C --> A2["Enfoque superficial"]
    C --> A3["Carga percibida"]
    C --> A4["Demanda de la<br/>evaluación"]
    A1 & A2 & A3 & A4 --> D{{"determinar qué decisión<br/>tuya está empujando a<br/>tus estudiantes hacia el<br/>enfoque superficial"}}
    D --> E["Evidencia de aprendizaje<br/>un análisis de tu<br/>asignatura que<br/>identifique qué<br/>condiciones inducen<br/>enfoque superficial y<br/>su…"]
...
inocua: produce decisiones que atacan el problema equivocado. **Enfoque profundo** no es lo
mismo que **Enfoque superficial** —intención de cumplir con el mínimo evaluado; es una respuesta racional a ciertas condiciones—, y tratarlos como sinónimos hace
que la intervención se dirija al lugar incorrecto. Del mismo modo, **Carga percibida** y
**Demanda de la evaluación** describen aspectos distintos de la misma situación: el primero
estimación del estudiante sobre el trabajo exigido;, mientras el segundo nivel cognitivo que la evaluación exige realmente, más allá del declarado.
...
- **Evidencia de logro.** Qué muestra un análisis de tu asignatura que identifique qué condiciones inducen enfoque superficial y su corrección frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
te deja en condiciones de qué decisión tuya está empujando a tus estudiantes hacia el enfoque superficial, y esa decisión se sostiene solo si
...
|---|---|---|
| Marton, F. & Säljö, R. (1976). *On Qualitative Differences in Learning*. | el estudio que introduce la distinción entre enfoque profundo y superficial. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
| Ramsden, P. (2003). *Learning to Teach in Higher Education*. | conecta la investigación sobre enfoques con decisiones concretas de diseño docente. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Enfoque profundo** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Enfoque profundo de Enfoque superficial.** El trabajo aquí es separar lo observado de lo interpretado sobre **Enfoque superficial**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Carga percibida como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Carga percibida**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.

**Paso 4 — Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con Demanda de la evaluación a la vista.** Con **Demanda de la evaluación** ya delimitado, la pregunta pasa a ser de consecuencia: qué cambia para los estudiantes, para el tiempo de clase y para la carga del equipo. **Evidencia de partida** entrega la lectura observable; el juicio profesional sigue siendo humano y debe quedar firmado por quien lo hace.
...
|---|---|---|---|
| Intervenir sobre **Enfoque profundo** | Intención de comprender, relacionar y aplicar; se asocia con mejores resultados de largo plazo | Cuando **Evidencia de partida** es observable y accionable dentro del plazo de la decisión. | Sobrerreaccionar a una señal parcial. |
| Intervenir sobre **Enfoque superficial** | Intención de cumplir con el mínimo evaluado; es una respuesta racional a ciertas condiciones | Cuando la primera explicación no distingue mecanismo ni responsable. | Convertir el concepto en etiqueta y no en intervención. |
| Observar antes de decidir | Reducir la incertidumbre antes de comprometer tiempo y credibilidad | Cuando la decisión es reversible y la evidencia disponible no distingue causas. | Observar indefinidamente y no decidir nunca. |
| Derivar o escalar | Poner la decisión donde están la competencia y la responsabilidad | Cuando hay normativa, resguardo de datos, salud o vulneración de derechos en juego. | Delegar hacia arriba lo que sí correspondía decidir en el aula. |

**Frontera de aplicación.** La distinción entre enfoques es una herramienta descriptiva y no una tipología de personas: Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre aprendizaje en educación superior |
|---|---|
...
Guárdala en `evidence/P14-C169-aprendizaje-en-educacion-superior/` con estos archivos:
