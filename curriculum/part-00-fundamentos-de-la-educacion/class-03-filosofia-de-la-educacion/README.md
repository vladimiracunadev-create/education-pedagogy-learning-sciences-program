...
**Decisión que habilita:** decidir qué fines educativos vas a priorizar cuando entren en conflicto entre sí<br>
...
flowchart TB
    ...
    C --> A1["Fines de la educación"]
    C --> A2["Autoridad pedagógica"]
    C --> A3["Autonomía"]
    C --> A4["Tradición y<br/>emancipación"]
    A1 & A2 & A3 & A4 --> D{{"decidir qué fines<br/>educativos vas a<br/>priorizar cuando entren<br/>en conflicto entre sí"}}
    D --> E["Evidencia de aprendizaje<br/>un ensayo breve que<br/>defienda una posición<br/>sobre el fin de la<br/>educación y responda a<br/>la objeción…"]
