...
**Decisión que habilita:** decidir con qué indicadores vas a afirmar que tu curso, programa o institución mejoró<br>
...
2. Clasificar la situación distinguiendo **Calidad educativa** de **Equidad**.
3. Decidir con fundamento, usando **Indicador** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Efecto de indicador** a la vista.
...
| **Evidencia de logro** | qué muestra un tablero de tres a cinco indicadores propios, con definición, fuente, límite y el sesgo que cada uno introduce frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
Ninguna definición de calidad es neutra, y esta clase no zanja el debate: Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Calidad educativa"]
    C --> A2["Equidad"]
    C --> A3["Indicador"]
    C --> A4["Efecto de indicador"]
    A1 & A2 & A3 & A4 --> D{{"decidir con qué<br/>indicadores vas a<br/>afirmar que tu curso,<br/>programa o institución<br/>mejoró"}}
    D --> E["Evidencia de aprendizaje<br/>un tablero de tres a<br/>cinco indicadores<br/>propios, con definición,<br/>fuente, límite y el<br/>sesgo que…"]
...
inocua: produce decisiones que atacan el problema equivocado. **Calidad educativa** no es lo
mismo que **Equidad** —distribución justa de oportunidades y resultados; no es lo mismo que igualdad de trato—, y tratarlos como sinónimos hace
que la intervención se dirija al lugar incorrecto. Del mismo modo, **Indicador** y
**Efecto de indicador** describen aspectos distintos de la misma situación: el primero
medida observable que se usa como aproximación de algo que no se puede medir directamente, mientras el segundo distorsión que produce medir:.
...
- **Evidencia de logro.** Qué muestra un tablero de tres a cinco indicadores propios, con definición, fuente, límite y el sesgo que cada uno introduce frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
te deja en condiciones de con qué indicadores vas a afirmar que tu curso, programa o institución mejoró, y esa decisión se sostiene solo si
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Calidad educativa** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Calidad educativa de Equidad.** El trabajo aquí es separar lo observado de lo interpretado sobre **Equidad**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Indicador como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Indicador**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.

**Paso 4 — Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con Efecto de indicador a la vista.** Con **Efecto de indicador** ya delimitado, la pregunta pasa a ser de consecuencia: qué cambia para los estudiantes, para el tiempo de clase y para la carga del equipo. **Evidencia de partida** entrega la lectura observable; el juicio profesional sigue siendo humano y debe quedar firmado por quien lo hace.
...
|---|---|---|---|
| Intervenir sobre **Calidad educativa** | Juicio sobre el valor de los procesos y resultados educativos; depende de los fines que se declaren | Cuando **Evidencia de partida** es observable y accionable dentro del plazo de la decisión. | Sobrerreaccionar a una señal parcial. |
| Intervenir sobre **Equidad** | Distribución justa de oportunidades y resultados; no es lo mismo que igualdad de trato | Cuando la primera explicación no distingue mecanismo ni responsable. | Convertir el concepto en etiqueta y no en intervención. |
| Observar antes de decidir | Reducir la incertidumbre antes de comprometer tiempo y credibilidad | Cuando la decisión es reversible y la evidencia disponible no distingue causas. | Observar indefinidamente y no decidir nunca. |
| Derivar o escalar | Poner la decisión donde están la competencia y la responsabilidad | Cuando hay normativa, resguardo de datos, salud o vulneración de derechos en juego. | Delegar hacia arriba lo que sí correspondía decidir en el aula. |

**Frontera de aplicación.** Ninguna definición de calidad es neutra, y esta clase no zanja el debate: Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre calidad y equidad educativa |
|---|---|
...
Guárdala en `evidence/P00-C011-calidad-y-equidad-educativa/` con estos archivos:
