...
**Estado de evidencia:** `MARCO-NORMATIVO` · **Etapa:** 🟢 Etapa A — Fundamentos · **Población de referencia:** transversal a todo el sistema educativo<br>
**Decisión que habilita:** decidir si una práctica institucional cotidiana vulnera o resguarda un derecho exigible<br>
...
2. Clasificar la situación distinguiendo **Derecho a la educación** de **No discriminación arbitraria**.
3. Decidir con fundamento, usando **Debido proceso** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Interés superior del niño** a la vista.
...
| **Evidencia de logro** | qué muestra una revisión de tres prácticas de tu establecimiento contrastadas con la norma vigente, con brechas y plan de corrección frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
El derecho fija el marco, no resuelve los conflictos entre derechos: Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Derecho a la educación"]
    C --> A2["No discriminación<br/>arbitraria"]
    C --> A3["Debido proceso"]
    C --> A4["Interés superior del<br/>niño"]
    A1 & A2 & A3 & A4 --> D{{"decidir si una práctica<br/>institucional cotidiana<br/>vulnera o resguarda un<br/>derecho exigible"}}
    D --> E["Evidencia de aprendizaje<br/>una revisión de tres<br/>prácticas de tu<br/>establecimiento<br/>contrastadas con la<br/>norma vigente, con…"]
...
inocua: produce decisiones que atacan el problema equivocado. **Derecho a la educación** no es lo
mismo que **No discriminación arbitraria** —prohibición de tratar de forma desigual sin justificación razonable y proporcional—, y tratarlos como sinónimos hace
que la intervención se dirija al lugar incorrecto. Del mismo modo, **Debido proceso** y
**Interés superior del niño** describen aspectos distintos de la misma situación: el primero
conjunto de garantías —información, defensa, plazos, proporcionalidad— antes de una sanción, mientras el segundo criterio que obliga a considerar primero el bienestar del estudiante en toda decisión que lo afecte.
...
- **Evidencia de logro.** Qué muestra una revisión de tres prácticas de tu establecimiento contrastadas con la norma vigente, con brechas y plan de corrección frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
te deja en condiciones de si una práctica institucional cotidiana vulnera o resguarda un derecho exigible, y esa decisión se sostiene solo si
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Derecho a la educación** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Derecho a la educación de No discriminación arbitraria.** El trabajo aquí es separar lo observado de lo interpretado sobre **No discriminación arbitraria**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Debido proceso como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Debido proceso**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.

**Paso 4 — Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con Interés superior del niño a la vista.** Con **Interés superior del niño** ya delimitado, la pregunta pasa a ser de consecuencia: qué cambia para los estudiantes, para el tiempo de clase y para la carga del equipo. **Evidencia de partida** entrega la lectura observable; el juicio profesional sigue siendo humano y debe quedar firmado por quien lo hace.
...
|---|---|---|---|
| Intervenir sobre **Derecho a la educación** | Garantía exigible de acceso, permanencia y calidad, con obligaciones para el Estado y los sostenedores | Cuando **Evidencia de partida** es observable y accionable dentro del plazo de la decisión. | Sobrerreaccionar a una señal parcial. |
| Intervenir sobre **No discriminación arbitraria** | Prohibición de tratar de forma desigual sin justificación razonable y proporcional | Cuando la primera explicación no distingue mecanismo ni responsable. | Convertir el concepto en etiqueta y no en intervención. |
| Observar antes de decidir | Reducir la incertidumbre antes de comprometer tiempo y credibilidad | Cuando la decisión es reversible y la evidencia disponible no distingue causas. | Observar indefinidamente y no decidir nunca. |
| Derivar o escalar | Poner la decisión donde están la competencia y la responsabilidad | Cuando hay normativa, resguardo de datos, salud o vulneración de derechos en juego. | Delegar hacia arriba lo que sí correspondía decidir en el aula. |

**Frontera de aplicación.** El derecho fija el marco, no resuelve los conflictos entre derechos: Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre derecho a la educación |
|---|---|
...
Guárdala en `evidence/P00-C007-derecho-a-la-educacion/` con estos archivos:
