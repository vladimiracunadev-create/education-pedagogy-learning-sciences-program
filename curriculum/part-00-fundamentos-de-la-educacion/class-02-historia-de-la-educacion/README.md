...
**Decisión que habilita:** decidir qué práctica heredada de tu institución conviene conservar, cuál revisar y con qué argumento<br>
...
2. Clasificar la situación distinguiendo **Forma escolar** de **Graduación por edad**.
3. Decidir con fundamento, usando **Escolarización de masas** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Tradición pedagógica** a la vista.
...
| **Evidencia de logro** | qué muestra una línea de tiempo comentada que rastree tres prácticas de tu institución hasta el problema histórico que las originó frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
La historia explica el origen, no justifica la permanencia ni condena la práctica. Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Forma escolar"]
    C --> A2["Graduación por edad"]
    C --> A3["Escolarización de<br/>masas"]
    C --> A4["Tradición pedagógica"]
    A1 & A2 & A3 & A4 --> D{{"decidir qué práctica<br/>heredada de tu<br/>institución conviene<br/>conservar, cuál revisar<br/>y con qué…"}}
    D --> E["Evidencia de aprendizaje<br/>una línea de tiempo<br/>comentada que rastree<br/>tres prácticas de tu<br/>institución hasta el<br/>problema…"]
...
inocua: produce decisiones que atacan el problema equivocado. **Forma escolar** no es lo
mismo que **Graduación por edad** —organización de estudiantes en cursos según año de nacimiento, no según dominio—, y tratarlos como sinónimos hace
que la intervención se dirija al lugar incorrecto. Del mismo modo, **Escolarización de masas** y
**Tradición pedagógica** describen aspectos distintos de la misma situación: el primero
proceso de extensión de la escuela a toda la población, ligado a la formación de los Estados nacionales, mientras el segundo corriente con supuestos propios sobre fines, método y autoridad, que sigue operando en prácticas actuales.
...
- **Evidencia de logro.** Qué muestra una línea de tiempo comentada que rastree tres prácticas de tu institución hasta el problema histórico que las originó frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
te deja en condiciones de qué práctica heredada de tu institución conviene conservar, cuál revisar y con qué argumento, y esa decisión se sostiene solo si
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Forma escolar** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Forma escolar de Graduación por edad.** El trabajo aquí es separar lo observado de lo interpretado sobre **Graduación por edad**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Escolarización de masas como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Escolarización de masas**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.

**Paso 4 — Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con Tradición pedagógica a la vista.** Con **Tradición pedagógica** ya delimitado, la pregunta pasa a ser de consecuencia: qué cambia para los estudiantes, para el tiempo de clase y para la carga del equipo. **Evidencia de partida** entrega la lectura observable; el juicio profesional sigue siendo humano y debe quedar firmado por quien lo hace.
...
|---|---|---|---|
| Intervenir sobre **Forma escolar** | Conjunto de rasgos —aula, grupo por edad, horario, currículo— que hacen reconocible a una escuela | Cuando **Evidencia de partida** es observable y accionable dentro del plazo de la decisión. | Sobrerreaccionar a una señal parcial. |
| Intervenir sobre **Graduación por edad** | Organización de estudiantes en cursos según año de nacimiento, no según dominio | Cuando la primera explicación no distingue mecanismo ni responsable. | Convertir el concepto en etiqueta y no en intervención. |
| Observar antes de decidir | Reducir la incertidumbre antes de comprometer tiempo y credibilidad | Cuando la decisión es reversible y la evidencia disponible no distingue causas. | Observar indefinidamente y no decidir nunca. |
| Derivar o escalar | Poner la decisión donde están la competencia y la responsabilidad | Cuando hay normativa, resguardo de datos, salud o vulneración de derechos en juego. | Delegar hacia arriba lo que sí correspondía decidir en el aula. |

**Frontera de aplicación.** La historia explica el origen, no justifica la permanencia ni condena la práctica. Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre historia de la educación |
|---|---|
...
Guárdala en `evidence/P00-C002-historia-de-la-educacion/` con estos archivos:
