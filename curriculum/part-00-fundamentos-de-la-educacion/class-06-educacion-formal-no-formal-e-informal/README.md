...
**Decisión que habilita:** decidir qué parte de un aprendizaje conviene formalizar y qué parte se sostiene mejor fuera del aula<br>
...
2. Clasificar la situación distinguiendo **Educación formal** de **Educación no formal**.
3. Decidir con fundamento, usando **Aprendizaje informal** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Reconocimiento de aprendizajes previos** a la vista.
...
| **Evidencia de logro** | qué muestra un mapa de aprendizajes de un grupo real que identifique origen formal, no formal e informal de sus competencias actuales frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
El aprendizaje informal es potente pero desigual y a veces erróneo: Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Educación formal"]
    C --> A2["Educación no formal"]
    C --> A3["Aprendizaje informal"]
    C --> A4["Reconocimiento de<br/>aprendizajes previos"]
    A1 & A2 & A3 & A4 --> D{{"decidir qué parte de un<br/>aprendizaje conviene<br/>formalizar y qué parte<br/>se sostiene mejor fuera<br/>del…"}}
    D --> E["Evidencia de aprendizaje<br/>un mapa de aprendizajes<br/>de un grupo real que<br/>identifique origen<br/>formal, no formal e<br/>informal de…"]
...
inocua: produce decisiones que atacan el problema equivocado. **Educación formal** no es lo
...
- **Evidencia de logro.** Qué muestra un mapa de aprendizajes de un grupo real que identifique origen formal, no formal e informal de sus competencias actuales frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
te deja en condiciones de qué parte de un aprendizaje conviene formalizar y qué parte se sostiene mejor fuera del aula, y esa decisión se sostiene solo si
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Educación formal** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Educación formal de Educación no formal.** El trabajo aquí es separar lo observado de lo interpretado sobre **Educación no formal**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Aprendizaje informal como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Aprendizaje informal**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.

**Paso 4 — Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con Reconocimiento de aprendizajes previos a la vista.** Con **Reconocimiento de aprendizajes previos** ya delimitado, la pregunta pasa a ser de consecuencia: qué cambia para los estudiantes, para el tiempo de clase y para la carga del equipo. **Evidencia de partida** entrega la lectura observable; el juicio profesional sigue siendo humano y debe quedar firmado por quien lo hace.
...
|---|---|---|---|
| Intervenir sobre **Educación formal** | La que conduce a certificación reconocida dentro del sistema escolar o superior | Cuando **Evidencia de partida** es observable y accionable dentro del plazo de la decisión. | Sobrerreaccionar a una señal parcial. |
| Intervenir sobre **Educación no formal** | Actividad educativa organizada e intencionada fuera del sistema reglado; suele certificar sin conducir a grado | Cuando la primera explicación no distingue mecanismo ni responsable. | Convertir el concepto en etiqueta y no en intervención. |
| Observar antes de decidir | Reducir la incertidumbre antes de comprometer tiempo y credibilidad | Cuando la decisión es reversible y la evidencia disponible no distingue causas. | Observar indefinidamente y no decidir nunca. |
| Derivar o escalar | Poner la decisión donde están la competencia y la responsabilidad | Cuando hay normativa, resguardo de datos, salud o vulneración de derechos en juego. | Delegar hacia arriba lo que sí correspondía decidir en el aula. |

**Frontera de aplicación.** El aprendizaje informal es potente pero desigual y a veces erróneo: Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre educación formal, no formal e informal |
|---|---|
...
Guárdala en `evidence/P00-C006-educacion-formal-no-formal-e-informal/` con estos archivos:
