...
**Decisión que habilita:** decidir a qué nivel del sistema corresponde resolver un problema y con qué instrumento<br>
...
2. Clasificar la situación distinguiendo **Nivel de decisión** de **Sostenedor**.
3. Decidir con fundamento, usando **Aseguramiento de la calidad** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Vía de reclamo** a la vista.
...
| **Evidencia de logro** | qué muestra el mapa del sistema educativo chileno con actores, competencias y vías de reclamo, más tres casos ubicados en él frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
El mapa refleja la institucionalidad vigente a una fecha y envejece: Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Nivel de decisión"]
    C --> A2["Sostenedor"]
    C --> A3["Aseguramiento de la<br/>calidad"]
    C --> A4["Vía de reclamo"]
    A1 & A2 & A3 & A4 --> D{{"decidir a qué nivel del<br/>sistema corresponde<br/>resolver un problema y<br/>con qué instrumento"}}
    D --> E["Evidencia de aprendizaje<br/>el mapa del sistema<br/>educativo chileno con<br/>actores, competencias y<br/>vías de reclamo, más<br/>tres…"]
...
inocua: produce decisiones que atacan el problema equivocado. **Nivel de decisión** no es lo
mismo que **Sostenedor** —persona jurídica responsable del establecimiento ante la autoridad, con obligaciones legales propias—, y tratarlos como sinónimos hace
que la intervención se dirija al lugar incorrecto. Del mismo modo, **Aseguramiento de la calidad** y
**Vía de reclamo** describen aspectos distintos de la misma situación: el primero
conjunto de instituciones que evalúan, fiscalizan y apoyan a los establecimientos, mientras el segundo procedimiento formal por el que un miembro de la comunidad exige el cumplimiento de un derecho.
...
- **Evidencia de logro.** Qué muestra el mapa del sistema educativo chileno con actores, competencias y vías de reclamo, más tres casos ubicados en él frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
te deja en condiciones de a qué nivel del sistema corresponde resolver un problema y con qué instrumento, y esa decisión se sostiene solo si
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Nivel de decisión** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Nivel de decisión de Sostenedor.** El trabajo aquí es separar lo observado de lo interpretado sobre **Sostenedor**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.
...
|---|---|---|---|
| Intervenir sobre **Nivel de decisión** | Instancia —aula, establecimiento, sostenedor, autoridad nacional— con competencia sobre un asunto | Cuando **Evidencia de partida** es observable y accionable dentro del plazo de la decisión. | Sobrerreaccionar a una señal parcial. |
| Intervenir sobre **Sostenedor** | Persona jurídica responsable del establecimiento ante la autoridad, con obligaciones legales propias | Cuando la primera explicación no distingue mecanismo ni responsable. | Convertir el concepto en etiqueta y no en intervención. |
| Observar antes de decidir | Reducir la incertidumbre antes de comprometer tiempo y credibilidad | Cuando la decisión es reversible y la evidencia disponible no distingue causas. | Observar indefinidamente y no decidir nunca. |
| Derivar o escalar | Poner la decisión donde están la competencia y la responsabilidad | Cuando hay normativa, resguardo de datos, salud o vulneración de derechos en juego. | Delegar hacia arriba lo que sí correspondía decidir en el aula. |

**Frontera de aplicación.** El mapa refleja la institucionalidad vigente a una fecha y envejece: Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre proyecto integrador: mapa del sistema educativo |
|---|---|
...
Guárdala en `evidence/P00-C012-proyecto-integrador-mapa-del-sistema-educativo/` con estos archivos:
