...
**Decisión que habilita:** decidir, ante una situación concreta, si corresponde actuar, consultar al equipo, informar formalmente o denunciar<br>
...
2. Clasificar la situación distinguiendo **Deber de cuidado** de **Confidencialidad**.
3. Decidir con fundamento, usando **Conflicto de interés** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Deber de denuncia** a la vista.
...
| **Evidencia de logro** | qué muestra un árbol de decisión propio para tres situaciones frecuentes, con actor responsable, plazo y registro en cada rama frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
El marco legal define pisos, no techos, y cambia. Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Deber de cuidado"]
    C --> A2["Confidencialidad"]
    C --> A3["Conflicto de interés"]
    C --> A4["Deber de denuncia"]
    A1 & A2 & A3 & A4 --> D{{"decidir, ante una<br/>situación concreta, si<br/>corresponde actuar,<br/>consultar al equipo,<br/>informar…"}}
    D --> E["Evidencia de aprendizaje<br/>un árbol de decisión<br/>propio para tres<br/>situaciones frecuentes,<br/>con actor responsable,<br/>plazo y…"]
...
inocua: produce decisiones que atacan el problema equivocado. **Deber de cuidado** no es lo
mismo que **Confidencialidad** —resguardo de la información sensible del estudiante, con sus excepciones legales explícitas—, y tratarlos como sinónimos hace
que la intervención se dirija al lugar incorrecto. Del mismo modo, **Conflicto de interés** y
**Deber de denuncia** describen aspectos distintos de la misma situación: el primero
situación en que un interés personal puede afectar la imparcialidad de una decisión profesional, mientras el segundo obligación legal de poner en conocimiento de la autoridad hechos que puedan constituir delito.
...
- **Evidencia de logro.** Qué muestra un árbol de decisión propio para tres situaciones frecuentes, con actor responsable, plazo y registro en cada rama frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
te deja en condiciones de decidir, ante una situación concreta, si corresponde actuar, consultar al equipo, informar formalmente o denunciar, y esa decisión se sostiene solo si
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Deber de cuidado** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Deber de cuidado de Confidencialidad.** El trabajo aquí es separar lo observado de lo interpretado sobre **Confidencialidad**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Conflicto de interés como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Conflicto de interés**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.

**Paso 4 — Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con Deber de denuncia a la vista.** Con **Deber de denuncia** ya delimitado, la pregunta pasa a ser de consecuencia: qué cambia para los estudiantes, para el tiempo de clase y para la carga del equipo. **Evidencia de partida** entrega la lectura observable; el juicio profesional sigue siendo humano y debe quedar firmado por quien lo hace.
...
|---|---|---|---|
| Intervenir sobre **Deber de cuidado** | Obligación de proteger la integridad física y psicológica de los estudiantes a cargo | Cuando **Evidencia de partida** es observable y accionable dentro del plazo de la decisión. | Sobrerreaccionar a una señal parcial. |
| Intervenir sobre **Confidencialidad** | Resguardo de la información sensible del estudiante, con sus excepciones legales explícitas | Cuando la primera explicación no distingue mecanismo ni responsable. | Convertir el concepto en etiqueta y no en intervención. |
| Observar antes de decidir | Reducir la incertidumbre antes de comprometer tiempo y credibilidad | Cuando la decisión es reversible y la evidencia disponible no distingue causas. | Observar indefinidamente y no decidir nunca. |
| Derivar o escalar | Poner la decisión donde están la competencia y la responsabilidad | Cuando hay normativa, resguardo de datos, salud o vulneración de derechos en juego. | Delegar hacia arriba lo que sí correspondía decidir en el aula. |

**Frontera de aplicación.** El marco legal define pisos, no techos, y cambia. Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre ética profesional docente |
|---|---|
...
Guárdala en `evidence/P00-C004-etica-profesional-docente/` con estos archivos:
