...
**Estado de evidencia:** `EN-DEBATE` · **Etapa:** 🟢 Etapa A — Fundamentos · **Población de referencia:** transversal a todo el sistema educativo<br>
**Decisión que habilita:** decidir qué parte de un resultado educativo es responsabilidad de la práctica pedagógica y cuál exige acción fuera del aula<br>
...
2. Clasificar la situación distinguiendo **Reproducción social** de **Capital cultural**.
3. Decidir con fundamento, usando **Efecto escuela** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Segregación escolar** a la vista.
...
| **Evidencia de logro** | qué muestra un análisis de un resultado real de tu grupo que separe factores pedagógicos, institucionales y externos, con acciones para cada uno frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
El tamaño del efecto escuela varía según sistema, nivel y forma de medirlo, y su estimación depende de supuestos discutidos. Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Reproducción social"]
    C --> A2["Capital cultural"]
    C --> A3["Efecto escuela"]
    C --> A4["Segregación escolar"]
    A1 & A2 & A3 & A4 --> D{{"decidir qué parte de un<br/>resultado educativo es<br/>responsabilidad de la<br/>práctica pedagógica y<br/>cuál…"}}
    D --> E["Evidencia de aprendizaje<br/>un análisis de un<br/>resultado real de tu<br/>grupo que separe<br/>factores pedagógicos,<br/>institucionales y…"]
...
inocua: produce decisiones que atacan el problema equivocado. **Reproducción social** no es lo
mismo que **Capital cultural** —conjunto de disposiciones, códigos y saberes valorados por la escuela que no todos los hogares proveen—, y tratarlos como sinónimos hace
que la intervención se dirija al lugar incorrecto. Del mismo modo, **Efecto escuela** y
**Segregación escolar** describen aspectos distintos de la misma situación: el primero
porción de la variación de resultados atribuible a lo que hace el establecimiento, mientras el segundo concentración de estudiantes de origen socioeconómico similar en los mismos establecimientos.
...
- **Evidencia de logro.** Qué muestra un análisis de un resultado real de tu grupo que separe factores pedagógicos, institucionales y externos, con acciones para cada uno frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
te deja en condiciones de qué parte de un resultado educativo es responsabilidad de la práctica pedagógica y cuál exige acción fuera del aula, y esa decisión se sostiene solo si
...
|---|---|---|
| Bourdieu, P. & Passeron, J.-C. (1970). *La reproducción*. | la formulación clásica de la escuela como reproductora; léelo como hipótesis potente y discutida, no como conclusión. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
| Bellei, C. (2013). *El estudio de la segregación socioeconómica y académica de la educación chilena*. | documenta con datos la segregación del sistema chileno y sus consecuencias sobre los resultados. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Reproducción social** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Reproducción social de Capital cultural.** El trabajo aquí es separar lo observado de lo interpretado sobre **Capital cultural**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Efecto escuela como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Efecto escuela**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.

**Paso 4 — Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con Segregación escolar a la vista.** Con **Segregación escolar** ya delimitado, la pregunta pasa a ser de consecuencia: qué cambia para los estudiantes, para el tiempo de clase y para la carga del equipo. **Evidencia de partida** entrega la lectura observable; el juicio profesional sigue siendo humano y debe quedar firmado por quien lo hace.
...
|---|---|---|---|
| Intervenir sobre **Reproducción social** | Mecanismo por el cual la escuela transmite y legitima desigualdades de origen | Cuando **Evidencia de partida** es observable y accionable dentro del plazo de la decisión. | Sobrerreaccionar a una señal parcial. |
| Intervenir sobre **Capital cultural** | Conjunto de disposiciones, códigos y saberes valorados por la escuela que no todos los hogares proveen | Cuando la primera explicación no distingue mecanismo ni responsable. | Convertir el concepto en etiqueta y no en intervención. |
| Observar antes de decidir | Reducir la incertidumbre antes de comprometer tiempo y credibilidad | Cuando la decisión es reversible y la evidencia disponible no distingue causas. | Observar indefinidamente y no decidir nunca. |
| Derivar o escalar | Poner la decisión donde están la competencia y la responsabilidad | Cuando hay normativa, resguardo de datos, salud o vulneración de derechos en juego. | Delegar hacia arriba lo que sí correspondía decidir en el aula. |

**Frontera de aplicación.** El tamaño del efecto escuela varía según sistema, nivel y forma de medirlo, y su estimación depende de supuestos discutidos. Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre rol social de la escuela |
|---|---|
...
Guárdala en `evidence/P00-C008-rol-social-de-la-escuela/` con estos archivos:
