...
**Decisión que habilita:** decidir a quién corresponde una decisión y con quién debe tomarse de forma conjunta<br>
...
2. Clasificar la situación distinguiendo **Rol profesional** de **Frontera de competencia**.
3. Decidir con fundamento, usando **Trabajo colaborativo** como criterio y declarando la fuente.
...
| **Evidencia de logro** | qué muestra una matriz de roles y decisiones de tu institución que indique quién decide, quién es consultado y quién debe ser informado frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
Las descripciones formales de cargo rara vez coinciden con la práctica real, y en instituciones pequeñas una persona cumple varios roles. Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Rol profesional"]
    C --> A2["Frontera de<br/>competencia"]
    C --> A3["Trabajo colaborativo"]
    C --> A4["Derivación"]
    A1 & A2 & A3 & A4 --> D{{"decidir a quién<br/>corresponde una decisión<br/>y con quién debe tomarse<br/>de forma conjunta"}}
    D --> E["Evidencia de aprendizaje<br/>una matriz de roles y<br/>decisiones de tu<br/>institución que indique<br/>quién decide, quién es…"]
...
inocua: produce decisiones que atacan el problema equivocado. **Rol profesional** no es lo
mismo que **Frontera de competencia** —límite de lo que un profesional puede afirmar o decidir según su formación y su rol—, y tratarlos como sinónimos hace
que la intervención se dirija al lugar incorrecto. Del mismo modo, **Trabajo colaborativo** y
**Derivación** describen aspectos distintos de la misma situación: el primero
forma de coordinación en que dos o más profesionales comparten diseño, ejecución y evaluación, mientras el segundo traspaso formal de una situación a otro profesional o servicio, con información suficiente y seguimiento.
...
- **Evidencia de logro.** Qué muestra una matriz de roles y decisiones de tu institución que indique quién decide, quién es consultado y quién debe ser informado frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
te deja en condiciones de a quién corresponde una decisión y con quién debe tomarse de forma conjunta, y esa decisión se sostiene solo si
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Rol profesional** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Rol profesional de Frontera de competencia.** El trabajo aquí es separar lo observado de lo interpretado sobre **Frontera de competencia**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Trabajo colaborativo como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Trabajo colaborativo**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.
...
|---|---|---|---|
| Intervenir sobre **Rol profesional** | Conjunto de funciones, competencias y responsabilidades asignadas formalmente a un cargo | Cuando **Evidencia de partida** es observable y accionable dentro del plazo de la decisión. | Sobrerreaccionar a una señal parcial. |
| Intervenir sobre **Frontera de competencia** | Límite de lo que un profesional puede afirmar o decidir según su formación y su rol | Cuando la primera explicación no distingue mecanismo ni responsable. | Convertir el concepto en etiqueta y no en intervención. |
| Observar antes de decidir | Reducir la incertidumbre antes de comprometer tiempo y credibilidad | Cuando la decisión es reversible y la evidencia disponible no distingue causas. | Observar indefinidamente y no decidir nunca. |
| Derivar o escalar | Poner la decisión donde están la competencia y la responsabilidad | Cuando hay normativa, resguardo de datos, salud o vulneración de derechos en juego. | Delegar hacia arriba lo que sí correspondía decidir en el aula. |

**Frontera de aplicación.** Las descripciones formales de cargo rara vez coinciden con la práctica real, y en instituciones pequeñas una persona cumple varios roles. Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre profesiones y roles educativos |
|---|---|
...
Guárdala en `evidence/P00-C009-profesiones-y-roles-educativos/` con estos archivos:
