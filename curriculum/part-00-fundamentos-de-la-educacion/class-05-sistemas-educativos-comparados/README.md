...
**Estado de evidencia:** `CONSISTENTE` · **Etapa:** 🟢 Etapa A — Fundamentos · **Población de referencia:** transversal a todo el sistema educativo<br>
**Decisión que habilita:** decidir qué elemento de un sistema extranjero es transferible a tu contexto y bajo qué condiciones<br>
...
2. Clasificar la situación distinguiendo **Sistema educativo** de **Gobernanza**.
3. Decidir con fundamento, usando **Transferibilidad** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Evaluación internacional** a la vista.
...
| **Evidencia de logro** | qué muestra una comparación estructurada entre dos sistemas educativos con tres dimensiones y una conclusión sobre transferibilidad frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
Las evaluaciones internacionales miden un subconjunto acotado de aprendizajes y su comparabilidad depende de supuestos técnicos fuertes —traducción, equivalencia de ítems, muestreo, exclusiones—. Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Sistema educativo"]
    C --> A2["Gobernanza"]
    C --> A3["Transferibilidad"]
    C --> A4["Evaluación<br/>internacional"]
    A1 & A2 & A3 & A4 --> D{{"decidir qué elemento de<br/>un sistema extranjero es<br/>transferible a tu<br/>contexto y bajo qué…"}}
    D --> E["Evidencia de aprendizaje<br/>una comparación<br/>estructurada entre dos<br/>sistemas educativos con<br/>tres dimensiones y una…"]
...
inocua: produce decisiones que atacan el problema equivocado. **Sistema educativo** no es lo
mismo que **Gobernanza** —distribución de la autoridad para decidir sobre currículo, financiamiento, personal y evaluación—, y tratarlos como sinónimos hace
que la intervención se dirija al lugar incorrecto. Del mismo modo, **Transferibilidad** y
**Evaluación internacional** describen aspectos distintos de la misma situación: el primero
grado en que una política funciona fuera de las condiciones en que fue diseñada, mientras el segundo estudio comparado que mide desempeños con instrumentos comunes entre países.
...
- **Evidencia de logro.** Qué muestra una comparación estructurada entre dos sistemas educativos con tres dimensiones y una conclusión sobre transferibilidad frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
te deja en condiciones de qué elemento de un sistema extranjero es transferible a tu contexto y bajo qué condiciones, y esa decisión se sostiene solo si
...
|---|---|---|
| OCDE. *Education at a Glance* (edición vigente). | compendio anual comparado de indicadores; úsalo por sus definiciones y notas metodológicas, no solo por sus tablas. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
| Sahlberg, P. (2011). *Finnish Lessons*. | caso paradigmático de sistema admirado; léelo prestando atención a las condiciones históricas que el propio autor describe. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Sistema educativo** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Sistema educativo de Gobernanza.** El trabajo aquí es separar lo observado de lo interpretado sobre **Gobernanza**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Transferibilidad como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Transferibilidad**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.

**Paso 4 — Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con Evaluación internacional a la vista.** Con **Evaluación internacional** ya delimitado, la pregunta pasa a ser de consecuencia: qué cambia para los estudiantes, para el tiempo de clase y para la carga del equipo. **Evidencia de partida** entrega la lectura observable; el juicio profesional sigue siendo humano y debe quedar firmado por quien lo hace.
...
|---|---|---|---|
| Intervenir sobre **Sistema educativo** | Conjunto articulado de niveles, instituciones, financiamiento, currículo y regulación de un país | Cuando **Evidencia de partida** es observable y accionable dentro del plazo de la decisión. | Sobrerreaccionar a una señal parcial. |
| Intervenir sobre **Gobernanza** | Distribución de la autoridad para decidir sobre currículo, financiamiento, personal y evaluación | Cuando la primera explicación no distingue mecanismo ni responsable. | Convertir el concepto en etiqueta y no en intervención. |
| Observar antes de decidir | Reducir la incertidumbre antes de comprometer tiempo y credibilidad | Cuando la decisión es reversible y la evidencia disponible no distingue causas. | Observar indefinidamente y no decidir nunca. |
| Derivar o escalar | Poner la decisión donde están la competencia y la responsabilidad | Cuando hay normativa, resguardo de datos, salud o vulneración de derechos en juego. | Delegar hacia arriba lo que sí correspondía decidir en el aula. |

**Frontera de aplicación.** Las evaluaciones internacionales miden un subconjunto acotado de aprendizajes y su comparabilidad depende de supuestos técnicos fuertes —traducción, equivalencia de ítems, muestreo, exclusiones—. Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre sistemas educativos comparados |
|---|---|
...
Guárdala en `evidence/P00-C005-sistemas-educativos-comparados/` con estos archivos:
