# Clase 277 — Salud mental escolar: alcance y límites de la escuela

> **Parte 23 · Bienestar, salud mental y sostenibilidad del oficio** — clase 1 de 12
...
**Decisión que habilita:** determinar qué le corresponde a tu establecimiento en esta situación y qué exige otra competencia profesional<br>
**Evidencia de aprendizaje:** un mapa de competencias y umbrales de acción, con la frontera del rol docente declarada

## 🎯 Propósito

Establecer con precisión el alcance del rol escolar frente a la salud mental, para actuar sin exceder la competencia ni desentenderse.
...
2. **Explicar** dónde termina la responsabilidad de un docente y empieza la de otro profesional.
3. **Decidir** —qué le corresponde a tu establecimiento en esta situación y qué exige otra competencia profesional— y sostener la decisión con un fundamento escrito.
4. **Producir** la evidencia de la clase —un mapa de competencias y umbrales de acción, con la frontera del rol docente declarada— y contrastarla contra el criterio de logro.
...
|---|---|
| **Frontera del rol** | límite entre lo que un docente puede y debe hacer y lo que requiere competencia profesional distinta |
| **Detección** | identificación de señales que ameritan atención, función que sí corresponde a la escuela |
| **Umbral de acción** | nivel de señal declarado a partir del cual se activa una respuesta determinada |
| **Corresponsabilidad** | distribución de tareas entre escuela, familia y red de salud, con roles explícitos |
...
2. Clasificar la situación distinguiendo **Frontera del rol** de **Detección**.
3. Decidir con fundamento, usando **Umbral de acción** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Corresponsabilidad** a la vista.
...
| **Evidencia de logro** | qué muestra un mapa de competencias y umbrales de acción, con la frontera del rol docente declarada frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
La frontera es más nítida en el papel que en la práctica: Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Frontera del rol"]
    C --> A2["Detección"]
    C --> A3["Umbral de acción"]
    C --> A4["Corresponsabilidad"]
    A1 & A2 & A3 & A4 --> D{{"determinar qué le<br/>corresponde a tu<br/>establecimiento en esta<br/>situación y qué exige<br/>otra…"}}
    D --> E["Evidencia de aprendizaje<br/>un mapa de competencias<br/>y umbrales de acción,<br/>con la frontera del rol<br/>docente declarada"]
...
La salud mental entró a la escuela sin que la escuela definiera cómo recibirla. El resultado es una frontera difusa que produce dos errores opuestos y frecuentes: docentes que diagnostican, aconsejan tratamientos y sostienen situaciones clínicas sin competencia, y equipos que no informan una señal grave por miedo a equivocarse. Definir la frontera no es desentenderse: es hacer bien la parte que efectivamente corresponde, que es detectar, acompañar el rol escolar, derivar y sostener el vínculo.

### 2. Frontera conceptual: qué es y qué no es

Los cuatro conceptos de esta clase se confunden entre sí con facilidad, y esa confusión no es
inocua: produce decisiones que atacan el problema equivocado. **Frontera del rol** no es lo
mismo que **Detección** —identificación de señales que ameritan atención, función que sí corresponde a la escuela—, y tratarlos como sinónimos hace
que la intervención se dirija al lugar incorrecto. Del mismo modo, **Umbral de acción** y
**Corresponsabilidad** describen aspectos distintos de la misma situación: el primero
nivel de señal declarado a partir del cual se activa una respuesta determinada, mientras el segundo distribución de tareas entre escuela, familia y red de salud, con roles explícitos.
...
- **Evidencia de logro.** Qué muestra un mapa de competencias y umbrales de acción, con la frontera del rol docente declarada frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
El mapa de competencias declara qué hace la escuela y qué no, con ejemplos concretos. La escuela detecta señales, registra observaciones fechadas, informa a quien corresponde, ajusta las exigencias académicas mientras dura la situación y mantiene el vínculo. La escuela no diagnostica, no indica tratamientos, no conduce procesos terapéuticos ni reemplaza a la familia en decisiones de salud. Los umbrales de acción se declaran de antemano para que nadie tenga que decidir solo en el momento.

### 5. Qué sostiene la evidencia y qué no

La frontera es más nítida en el papel que en la práctica: un docente jefe con vínculo estrecho recibe confidencias que ninguna definición de rol anticipó. Además, la disponibilidad de la red de salud mental es limitada y desigual, de modo que la escuela termina sosteniendo durante meses situaciones que exceden su competencia, sin que exista una alternativa real.
...
te deja en condiciones de qué le corresponde a tu establecimiento en esta situación y qué exige otra competencia profesional, y esa decisión se sostiene solo si
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Frontera del rol** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Frontera del rol de Detección.** El trabajo aquí es separar lo observado de lo interpretado sobre **Detección**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Umbral de acción como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Umbral de acción**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.

**Paso 4 — Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con Corresponsabilidad a la vista.** Con **Corresponsabilidad** ya delimitado, la pregunta pasa a ser de consecuencia: qué cambia para los estudiantes, para el tiempo de clase y para la carga del equipo. **Evidencia de partida** entrega la lectura observable; el juicio profesional sigue siendo humano y debe quedar firmado por quien lo hace.
...
|---|---|---|---|
| Intervenir sobre **Frontera del rol** | Límite entre lo que un docente puede y debe hacer y lo que requiere competencia profesional distinta | Cuando **Evidencia de partida** es observable y accionable dentro del plazo de la decisión. | Sobrerreaccionar a una señal parcial. |
| Intervenir sobre **Detección** | Identificación de señales que ameritan atención, función que sí corresponde a la escuela | Cuando la primera explicación no distingue mecanismo ni responsable. | Convertir el concepto en etiqueta y no en intervención. |
| Observar antes de decidir | Reducir la incertidumbre antes de comprometer tiempo y credibilidad | Cuando la decisión es reversible y la evidencia disponible no distingue causas. | Observar indefinidamente y no decidir nunca. |
| Derivar o escalar | Poner la decisión donde están la competencia y la responsabilidad | Cuando hay normativa, resguardo de datos, salud o vulneración de derechos en juego. | Delegar hacia arriba lo que sí correspondía decidir en el aula. |

**Frontera de aplicación.** La frontera es más nítida en el papel que en la práctica: Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre salud mental escolar: alcance y límites de la escuela |
|---|---|
...
Un mapa de competencias y umbrales de acción, con la frontera del rol docente declarada.

Guárdala en `evidence/P23-C277-salud-mental-escolar-alcance-y-limites-de-la-escuela/` con estos archivos:
...
Escribe el mapa de competencias de tu establecimiento con tres umbrales de acción. Preséntalo al equipo y verifica si todos coinciden en dónde está la frontera.
...
- [ ] el mapa declara con ejemplos qué corresponde a la escuela y qué no;
- [ ] cada umbral de acción tiene respuesta, responsable y plazo definidos;
...
- Asumir funciones clínicas por vocación de ayuda y sin competencia ni respaldo institucional.
- Callar una señal grave por temor a exagerar o por no querer alarmar a la familia.
...
Los estudiantes sin acceso a salud privada dependen enteramente de la derivación escolar y de una red saturada. La escuela es, para ellos, la única puerta de entrada, y eso agrega peso a la calidad de la detección.
...
1. ¿Qué señal reciente no informaste y por qué razón?
2. ¿Qué haces cuando la red no responde y la situación continúa?
3. ¿Sabe tu equipo qué hacer sin tener que preguntar en el momento?
...
Abre la parte 23 y ordena las clases siguientes. Profundiza la clase 155 y se articula con la 263.
...
|---|---|---|
| [← Parte 23](../README.md) | [Parte 23](../README.md) · [Programa](../../../README.md) | [278 · Ansiedad y estrés académico →](../class-02-ansiedad-y-estres-academico/README.md) |
