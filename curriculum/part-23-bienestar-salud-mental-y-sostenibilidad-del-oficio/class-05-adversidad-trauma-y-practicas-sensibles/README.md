# Clase 281 — Adversidad, trauma y prácticas sensibles

> **Parte 23 · Bienestar, salud mental y sostenibilidad del oficio** — clase 5 de 12
...
**Decisión que habilita:** determinar qué condiciones de previsibilidad y seguridad requiere este estudiante para poder aprender<br>
**Evidencia de aprendizaje:** un diseño de aula con previsibilidad, regulación y relación estable, con su fundamento declarado

## 🎯 Propósito

Diseñar prácticas sensibles a la adversidad que sostengan el aprendizaje sin convertir la historia del estudiante en su destino.
...
2. **Explicar** cómo se enseña a un estudiante cuya historia lo mantiene en alerta permanente.
3. **Decidir** —qué condiciones de previsibilidad y seguridad requiere este estudiante para poder aprender— y sostener la decisión con un fundamento escrito.
4. **Producir** la evidencia de la clase —un diseño de aula con previsibilidad, regulación y relación estable, con su fundamento declarado— y contrastarla contra el criterio de logro.
...
|---|---|
| **Experiencias adversas en la infancia** | conjunto de situaciones —violencia, negligencia, pérdida— asociadas estadísticamente a peores resultados de salud y educativos |
| **Respuesta de alerta** | estado de activación sostenida que reduce la disponibilidad para tareas que exigen concentración |
| **Práctica sensible a la adversidad** | conjunto de decisiones que priorizan previsibilidad, seguridad y relación estable |
| **Relación estable** | vínculo sostenido con al menos un adulto, uno de los factores protectores mejor documentados |
...
2. Clasificar la situación distinguiendo **Experiencias adversas en la infancia** de **Respuesta de alerta**.
3. Decidir con fundamento, usando **Práctica sensible a la adversidad** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Relación estable** a la vista.
...
| **Evidencia de logro** | qué muestra un diseño de aula con previsibilidad, regulación y relación estable, con su fundamento declarado frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
El campo tiene un problema de sobreextensión: Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Experiencias adversas<br/>en la infancia"]
    C --> A2["Respuesta de alerta"]
    C --> A3["Práctica sensible a la<br/>adversidad"]
    C --> A4["Relación estable"]
    A1 & A2 & A3 & A4 --> D{{"determinar qué<br/>condiciones de<br/>previsibilidad y<br/>seguridad requiere este<br/>estudiante para poder…"}}
    D --> E["Evidencia de aprendizaje<br/>un diseño de aula con<br/>previsibilidad,<br/>regulación y relación<br/>estable, con su<br/>fundamento declarado"]
...
La investigación sobre adversidad temprana muestra asociaciones consistentes con dificultades escolares, y esa evidencia se ha difundido con más certeza de la que corresponde. Lo que está bien establecido es la asociación estadística y el papel protector de una relación estable con un adulto. Lo que se afirma con menos respaldo son los mecanismos neurobiológicos precisos y la eficacia específica de los programas escolares que se venden bajo esta etiqueta.

### 2. Frontera conceptual: qué es y qué no es

Los cuatro conceptos de esta clase se confunden entre sí con facilidad, y esa confusión no es
inocua: produce decisiones que atacan el problema equivocado. **Experiencias adversas en la infancia** no es lo
mismo que **Respuesta de alerta** —estado de activación sostenida que reduce la disponibilidad para tareas que exigen concentración—, y tratarlos como sinónimos hace
que la intervención se dirija al lugar incorrecto. Del mismo modo, **Práctica sensible a la adversidad** y
**Relación estable** describen aspectos distintos de la misma situación: el primero
conjunto de decisiones que priorizan previsibilidad, seguridad y relación estable, mientras el segundo vínculo sostenido con al menos un adulto, uno de los factores protectores mejor documentados.
...
- **Evidencia de logro.** Qué muestra un diseño de aula con previsibilidad, regulación y relación estable, con su fundamento declarado frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
Las decisiones que se sostienen son sencillas y de bajo costo: previsibilidad en la rutina y anticipación de cambios, evitar exposición pública en momentos de desregulación, ofrecer opciones que devuelvan control, y asegurar que al menos un adulto de la escuela tenga vínculo sostenido con el estudiante. Nada de esto exige conocer la historia del estudiante en detalle, lo que además protege su privacidad y evita el uso indebido de información sensible.

### 5. Qué sostiene la evidencia y qué no

El campo tiene un problema de sobreextensión: se atribuye a trauma una variedad de conductas que tienen otras explicaciones, y se aplican etiquetas clínicas desde el aula sin competencia. La evidencia sobre programas escolares específicos es todavía emergente. Y existe un riesgo de determinismo: tratar la historia como pronóstico reduce las expectativas y produce exactamente el resultado que se temía.
...
te deja en condiciones de qué condiciones de previsibilidad y seguridad requiere este estudiante para poder aprender, y esa decisión se sostiene solo si
...
|---|---|---|
| Perry, B. & Szalavitz, M. (2006). *The Boy Who Was Raised as a Dog*. | explica el efecto de la adversidad sobre la conducta escolar sin convertirlo en destino. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
| Masten, A. (2014). *Ordinary Magic: Resilience in Development*. | muestra que los factores protectores son comunes y accesibles, no excepcionales. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Experiencias adversas en la infancia** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Experiencias adversas en la infancia de Respuesta de alerta.** El trabajo aquí es separar lo observado de lo interpretado sobre **Respuesta de alerta**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Práctica sensible a la adversidad como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Práctica sensible a la adversidad**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.

**Paso 4 — Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con Relación estable a la vista.** Con **Relación estable** ya delimitado, la pregunta pasa a ser de consecuencia: qué cambia para los estudiantes, para el tiempo de clase y para la carga del equipo. **Evidencia de partida** entrega la lectura observable; el juicio profesional sigue siendo humano y debe quedar firmado por quien lo hace.
...
|---|---|---|---|
| Intervenir sobre **Experiencias adversas en la infancia** | Conjunto de situaciones —violencia, negligencia, pérdida— asociadas estadísticamente a peores resultados de salud y educativos | Cuando **Evidencia de partida** es observable y accionable dentro del plazo de la decisión. | Sobrerreaccionar a una señal parcial. |
| Intervenir sobre **Respuesta de alerta** | Estado de activación sostenida que reduce la disponibilidad para tareas que exigen concentración | Cuando la primera explicación no distingue mecanismo ni responsable. | Convertir el concepto en etiqueta y no en intervención. |
| Observar antes de decidir | Reducir la incertidumbre antes de comprometer tiempo y credibilidad | Cuando la decisión es reversible y la evidencia disponible no distingue causas. | Observar indefinidamente y no decidir nunca. |
| Derivar o escalar | Poner la decisión donde están la competencia y la responsabilidad | Cuando hay normativa, resguardo de datos, salud o vulneración de derechos en juego. | Delegar hacia arriba lo que sí correspondía decidir en el aula. |

**Frontera de aplicación.** El campo tiene un problema de sobreextensión: Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre adversidad, trauma y prácticas sensibles |
|---|---|
...
Un diseño de aula con previsibilidad, regulación y relación estable, con su fundamento declarado.

Guárdala en `evidence/P23-C281-adversidad-trauma-y-practicas-sensibles/` con estos archivos:
...
Revisa la previsibilidad de tu jornada durante una semana. Introduce dos ajustes de anticipación y registra su efecto en el estudiante que más los necesita.
...
- [ ] el diseño se apoya en previsibilidad, regulación y relación, sin requerir información clínica;
- [ ] las expectativas de aprendizaje se mantienen y están declaradas;
...
- Convertir la historia del estudiante en pronóstico y bajar la exigencia en consecuencia.
- Recabar y compartir información sensible sin necesidad ni resguardo.
...
El manejo de información sensible es aquí una obligación ética central: saber más de lo necesario sobre la vida de un estudiante genera riesgos de estigmatización que superan el beneficio pedagógico.
...
1. ¿Qué adulto de la escuela tiene vínculo sostenido con este estudiante?
2. ¿Cuánta previsibilidad ofrece tu jornada a quien necesita anticipar?
3. ¿Bajaste la exigencia por la historia y no por el desempeño?
...
Se apoya en la parte 02 y en la clase 277. Se articula con las clases 259 y 282.
...
|---|---|---|
| [← 280 · Aprendizaje socioemocional: qué funciona](../class-04-aprendizaje-socioemocional-que-funciona/README.md) | [Parte 23](../README.md) · [Programa](../../../README.md) | [282 · Duelo, crisis y emergencias en la comunidad →](../class-06-duelo-crisis-y-emergencias-en-la-comunidad/README.md) |
