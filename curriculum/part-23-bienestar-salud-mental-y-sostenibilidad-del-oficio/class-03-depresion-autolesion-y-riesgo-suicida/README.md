# Clase 279 — Depresión, autolesión y riesgo suicida

> **Parte 23 · Bienestar, salud mental y sostenibilidad del oficio** — clase 3 de 12
...
**Decisión que habilita:** determinar qué activa tu establecimiento ante una señal de riesgo y quién hace cada cosa<br>
**Evidencia de aprendizaje:** un protocolo de riesgo con señales, activación inmediata, actores, registro y seguimiento

## 🎯 Propósito

Activar un protocolo de riesgo suicida con pasos definidos, sin improvisar, sin exceder el rol y sin dejar sola a la persona que detectó la señal.
...
2. **Explicar** qué se hace exactamente en los minutos siguientes a una señal de riesgo.
3. **Decidir** —qué activa tu establecimiento ante una señal de riesgo y quién hace cada cosa— y sostener la decisión con un fundamento escrito.
4. **Producir** la evidencia de la clase —un protocolo de riesgo con señales, activación inmediata, actores, registro y seguimiento— y contrastarla contra el criterio de logro.
...
|---|---|
| **Señal de riesgo** | manifestación verbal, conductual o escrita que indica posibilidad de daño autoinfligido |
| **Activación inmediata** | conjunto de acciones que ocurren el mismo día en que se detecta la señal, sin deliberación previa |
| **Acompañamiento continuo** | condición de no dejar sola a la persona en riesgo mientras se activa la respuesta |
| **Postvención** | conjunto de acciones dirigidas a la comunidad después de un evento consumado, para prevenir el contagio |
...
2. Clasificar la situación distinguiendo **Señal de riesgo** de **Activación inmediata**.
3. Decidir con fundamento, usando **Acompañamiento continuo** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Postvención** a la vista.
...
| **Evidencia de logro** | qué muestra un protocolo de riesgo con señales, activación inmediata, actores, registro y seguimiento frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
El protocolo no evalúa riesgo clínico —eso es competencia de salud— y su función es asegurar que la respuesta ocurra. Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Señal de riesgo"]
    C --> A2["Activación inmediata"]
    C --> A3["Acompañamiento<br/>continuo"]
    C --> A4["Postvención"]
    A1 & A2 & A3 & A4 --> D{{"determinar qué activa tu<br/>establecimiento ante una<br/>señal de riesgo y quién<br/>hace cada cosa"}}
    D --> E["Evidencia de aprendizaje<br/>un protocolo de riesgo<br/>con señales, activación<br/>inmediata, actores,<br/>registro y seguimiento"]
...
Esta es la situación en que improvisar tiene el costo más alto. Las señales de riesgo suicida en población escolar son más frecuentes de lo que se supone y el silencio es la respuesta más común, por temor a equivocarse o a empeorar la situación. La evidencia disponible es clara en un punto que contradice el temor más extendido: preguntar directamente por ideación no aumenta el riesgo. Lo que sí lo aumenta es la falta de respuesta.

### 2. Frontera conceptual: qué es y qué no es

Los cuatro conceptos de esta clase se confunden entre sí con facilidad, y esa confusión no es
inocua: produce decisiones que atacan el problema equivocado. **Señal de riesgo** no es lo
mismo que **Activación inmediata** —conjunto de acciones que ocurren el mismo día en que se detecta la señal, sin deliberación previa—, y tratarlos como sinónimos hace
que la intervención se dirija al lugar incorrecto. Del mismo modo, **Acompañamiento continuo** y
**Postvención** describen aspectos distintos de la misma situación: el primero
condición de no dejar sola a la persona en riesgo mientras se activa la respuesta, mientras el segundo conjunto de acciones dirigidas a la comunidad después de un evento consumado, para prevenir el contagio.
...
- **Evidencia de logro.** Qué muestra un protocolo de riesgo con señales, activación inmediata, actores, registro y seguimiento frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
El protocolo debe fijar acciones inmediatas y no deliberativas: no dejar sola a la persona, informar de inmediato a quien esté designado, contactar a la familia el mismo día, derivar a salud con los antecedentes reunidos y registrar todo lo actuado. También debe fijar lo que no se hace: prometer confidencialidad absoluta, evaluar la gravedad clínica, o postergar el contacto por falta de certeza. La postvención se planifica antes, porque después no hay tiempo de diseñarla.

### 5. Qué sostiene la evidencia y qué no

El protocolo no evalúa riesgo clínico —eso es competencia de salud— y su función es asegurar que la respuesta ocurra. La disponibilidad de atención especializada es limitada y el establecimiento debe sostener al estudiante mientras tanto, con un rol que no le corresponde plenamente. La normativa y las orientaciones vigentes son específicas y cambian: la fuente oficial manda.
...
te deja en condiciones de qué activa tu establecimiento ante una señal de riesgo y quién hace cada cosa, y esa decisión se sostiene solo si
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Señal de riesgo** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Señal de riesgo de Activación inmediata.** El trabajo aquí es separar lo observado de lo interpretado sobre **Activación inmediata**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Acompañamiento continuo como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Acompañamiento continuo**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.

**Paso 4 — Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con Postvención a la vista.** Con **Postvención** ya delimitado, la pregunta pasa a ser de consecuencia: qué cambia para los estudiantes, para el tiempo de clase y para la carga del equipo. **Evidencia de partida** entrega la lectura observable; el juicio profesional sigue siendo humano y debe quedar firmado por quien lo hace.
...
|---|---|---|---|
| Intervenir sobre **Señal de riesgo** | Manifestación verbal, conductual o escrita que indica posibilidad de daño autoinfligido | Cuando **Evidencia de partida** es observable y accionable dentro del plazo de la decisión. | Sobrerreaccionar a una señal parcial. |
| Intervenir sobre **Activación inmediata** | Conjunto de acciones que ocurren el mismo día en que se detecta la señal, sin deliberación previa | Cuando la primera explicación no distingue mecanismo ni responsable. | Convertir el concepto en etiqueta y no en intervención. |
| Observar antes de decidir | Reducir la incertidumbre antes de comprometer tiempo y credibilidad | Cuando la decisión es reversible y la evidencia disponible no distingue causas. | Observar indefinidamente y no decidir nunca. |
| Derivar o escalar | Poner la decisión donde están la competencia y la responsabilidad | Cuando hay normativa, resguardo de datos, salud o vulneración de derechos en juego. | Delegar hacia arriba lo que sí correspondía decidir en el aula. |

**Frontera de aplicación.** El protocolo no evalúa riesgo clínico —eso es competencia de salud— y su función es asegurar que la respuesta ocurra. Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre depresión, autolesión y riesgo suicida |
|---|---|
...
Un protocolo de riesgo con señales, activación inmediata, actores, registro y seguimiento.

Guárdala en `evidence/P23-C279-depresion-autolesion-y-riesgo-suicida/` con estos archivos:
...
Verifica si tu establecimiento tiene protocolo escrito y plan de postvención. Si falta alguno, redáctalo y preséntalo esta semana a dirección.
...
- [ ] el protocolo declara acciones inmediatas del mismo día, con responsable nombrado;
- [ ] incluye plan de postvención escrito antes de necesitarlo;
...
- Prometer confidencialidad absoluta a un estudiante que revela una señal de riesgo.
- Deliberar en equipo durante días sobre si la señal era suficientemente grave.
...
El riesgo se concentra en grupos específicos —estudiantes de la diversidad sexual, con antecedentes de violencia, con acoso sostenido— y el protocolo debe nombrarlos para que la detección no dependa de la sensibilidad individual del adulto que esté cerca.
...
1. ¿Qué pasa hoy en tu establecimiento si un estudiante revela ideación a las once de la mañana?
2. ¿Quién acompaña a la persona mientras se contacta a la familia?
3. ¿Existe plan de postvención escrito, y quién lo conoce?
...
Continúa la clase 277 y se articula con la 263 y con la 282.
...
|---|---|---|
| [← 278 · Ansiedad y estrés académico](../class-02-ansiedad-y-estres-academico/README.md) | [Parte 23](../README.md) · [Programa](../../../README.md) | [280 · Aprendizaje socioemocional: qué funciona →](../class-04-aprendizaje-socioemocional-que-funciona/README.md) |
