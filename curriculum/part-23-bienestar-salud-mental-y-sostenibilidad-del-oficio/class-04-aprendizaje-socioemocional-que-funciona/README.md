# Clase 280 — Aprendizaje socioemocional: qué funciona

> **Parte 23 · Bienestar, salud mental y sostenibilidad del oficio** — clase 4 de 12
...
**Decisión que habilita:** determinar qué esperas de tu programa socioemocional y si esa expectativa está respaldada<br>
**Evidencia de aprendizaje:** un diseño de implementación con objetivos declarados, condiciones aseguradas y medición proporcional

## 🎯 Propósito

Implementar aprendizaje socioemocional con expectativas proporcionales a su evidencia y con las condiciones que lo hacen funcionar.
...
2. **Explicar** qué produce realmente un programa socioemocional y qué se le atribuye sin evidencia.
3. **Decidir** —qué esperas de tu programa socioemocional y si esa expectativa está respaldada— y sostener la decisión con un fundamento escrito.
4. **Producir** la evidencia de la clase —un diseño de implementación con objetivos declarados, condiciones aseguradas y medición proporcional— y contrastarla contra el criterio de logro.
...
|---|---|
| **Aprendizaje socioemocional** | enseñanza sistemática de habilidades de autoconocimiento, autorregulación, relación y toma de decisiones |
| **Implementación con fidelidad** | aplicación del programa según su diseño; principal predictor de que produzca efectos |
| **Efecto proporcional** | resultado esperable según la evidencia, distinto de la promesa comercial del programa |
| **Clima como condición** | requisito de que el entorno escolar sostenga lo que el programa enseña, o el mensaje se contradice |
...
2. Clasificar la situación distinguiendo **Aprendizaje socioemocional** de **Implementación con fidelidad**.
3. Decidir con fundamento, usando **Efecto proporcional** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Clima como condición** a la vista.
...
| **Evidencia de logro** | qué muestra un diseño de implementación con objetivos declarados, condiciones aseguradas y medición proporcional frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
Los tamaños de efecto son moderados y disminuyen en implementaciones reales fuera de condiciones de investigación. Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Aprendizaje<br/>socioemocional"]
    C --> A2["Implementación con<br/>fidelidad"]
    C --> A3["Efecto proporcional"]
    C --> A4["Clima como condición"]
    A1 & A2 & A3 & A4 --> D{{"determinar qué esperas<br/>de tu programa<br/>socioemocional y si esa<br/>expectativa está<br/>respaldada"}}
    D --> E["Evidencia de aprendizaje<br/>un diseño de<br/>implementación con<br/>objetivos declarados,<br/>condiciones aseguradas y<br/>medición…"]
...
El aprendizaje socioemocional tiene evidencia real: los metaanálisis muestran efectos consistentes sobre habilidades sociales, conducta y clima, y efectos menores pero presentes sobre rendimiento académico. También tiene una industria alrededor que promete bastante más de lo que la evidencia sostiene. La posición profesional es sostener ambas cosas: implementarlo por lo que sí produce, y no venderlo como solución de problemas académicos o de convivencia que tienen otras causas.

### 2. Frontera conceptual: qué es y qué no es

Los cuatro conceptos de esta clase se confunden entre sí con facilidad, y esa confusión no es
inocua: produce decisiones que atacan el problema equivocado. **Aprendizaje socioemocional** no es lo
mismo que **Implementación con fidelidad** —aplicación del programa según su diseño; principal predictor de que produzca efectos—, y tratarlos como sinónimos hace
que la intervención se dirija al lugar incorrecto. Del mismo modo, **Efecto proporcional** y
**Clima como condición** describen aspectos distintos de la misma situación: el primero
resultado esperable según la evidencia, distinto de la promesa comercial del programa, mientras el segundo requisito de que el entorno escolar sostenga lo que el programa enseña, o el mensaje se contradice.
...
- **Evidencia de logro.** Qué muestra un diseño de implementación con objetivos declarados, condiciones aseguradas y medición proporcional frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
Las condiciones que la evidencia identifica son exigentes: programa estructurado y secuenciado, tiempo protegido en el horario, docentes formados, y coherencia entre lo que el programa enseña y lo que la escuela hace. Ese último punto es el que más falla: un programa de regulación emocional en una escuela que responde con sanciones inmediatas a cualquier desregulación enseña, en los hechos, lo contrario de lo que dice el material.

### 5. Qué sostiene la evidencia y qué no

Los tamaños de efecto son moderados y disminuyen en implementaciones reales fuera de condiciones de investigación. Buena parte de la evidencia proviene de programas específicos evaluados por sus propios desarrolladores. La transferencia a resultados de largo plazo está menos documentada. Y la medición de habilidades socioemocionales se apoya en autorreporte, con limitaciones conocidas.
...
te deja en condiciones de qué esperas de tu programa socioemocional y si esa expectativa está respaldada, y esa decisión se sostiene solo si
...
|---|---|---|
| Durlak, J. et al. (2011). *The Impact of Enhancing Students' Social and Emotional Learning*. | el metaanálisis que fija qué efectos son esperables y de qué magnitud. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
| Weare, K. & Nind, M. (2011). *Mental Health Promotion in Schools*. | advierte sobre la distancia entre condiciones de investigación e implementación real. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Aprendizaje socioemocional** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Aprendizaje socioemocional de Implementación con fidelidad.** El trabajo aquí es separar lo observado de lo interpretado sobre **Implementación con fidelidad**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Efecto proporcional como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Efecto proporcional**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.

**Paso 4 — Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con Clima como condición a la vista.** Con **Clima como condición** ya delimitado, la pregunta pasa a ser de consecuencia: qué cambia para los estudiantes, para el tiempo de clase y para la carga del equipo. **Evidencia de partida** entrega la lectura observable; el juicio profesional sigue siendo humano y debe quedar firmado por quien lo hace.
...
|---|---|---|---|
| Intervenir sobre **Aprendizaje socioemocional** | Enseñanza sistemática de habilidades de autoconocimiento, autorregulación, relación y toma de decisiones | Cuando **Evidencia de partida** es observable y accionable dentro del plazo de la decisión. | Sobrerreaccionar a una señal parcial. |
| Intervenir sobre **Implementación con fidelidad** | Aplicación del programa según su diseño; principal predictor de que produzca efectos | Cuando la primera explicación no distingue mecanismo ni responsable. | Convertir el concepto en etiqueta y no en intervención. |
| Observar antes de decidir | Reducir la incertidumbre antes de comprometer tiempo y credibilidad | Cuando la decisión es reversible y la evidencia disponible no distingue causas. | Observar indefinidamente y no decidir nunca. |
| Derivar o escalar | Poner la decisión donde están la competencia y la responsabilidad | Cuando hay normativa, resguardo de datos, salud o vulneración de derechos en juego. | Delegar hacia arriba lo que sí correspondía decidir en el aula. |

**Frontera de aplicación.** Los tamaños de efecto son moderados y disminuyen en implementaciones reales fuera de condiciones de investigación. Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre aprendizaje socioemocional: qué funciona |
|---|---|
...
Un diseño de implementación con objetivos declarados, condiciones aseguradas y medición proporcional.

Guárdala en `evidence/P23-C280-aprendizaje-socioemocional-que-funciona/` con estos archivos:
...
Evalúa un programa socioemocional en uso con los criterios de condiciones. Declara qué falta asegurar antes de esperar los efectos reportados.
...
- [ ] el diseño declara objetivos proporcionales a la evidencia disponible;
- [ ] las condiciones de implementación —tiempo, formación, coherencia— están aseguradas antes de comenzar;
...
- Comprar un programa y aplicarlo sin tiempo protegido ni formación, esperando el efecto reportado.
- Atribuirle mejoras académicas o de convivencia que dependen de otras condiciones.
...
1. ¿Qué esperas exactamente de este programa y en qué evidencia te apoyas?
2. ¿Tiene tiempo protegido en el horario o se aplica cuando alcanza?
3. ¿Qué hace tu escuela que contradice lo que el programa enseña?
...
Se apoya en las clases 029 y 277, y se articula con la parte 12 y con la clase 288.
...
|---|---|---|
| [← 279 · Depresión, autolesión y riesgo suicida](../class-03-depresion-autolesion-y-riesgo-suicida/README.md) | [Parte 23](../README.md) · [Programa](../../../README.md) | [281 · Adversidad, trauma y prácticas sensibles →](../class-05-adversidad-trauma-y-practicas-sensibles/README.md) |
