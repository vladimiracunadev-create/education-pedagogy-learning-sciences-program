# Clase 288 — Proyecto integrador: plan de bienestar escolar

> **Parte 23 · Bienestar, salud mental y sostenibilidad del oficio** — clase 12 de 12

**Estado de evidencia:** `PRACTICA-PROFESIONAL` · **Etapa:** 🟤 Etapa F — Especialización y desafíos contemporáneos · **Población de referencia:** transversal, estudiantes y equipos docentes<br>
**Decisión que habilita:** determinar el plan de bienestar del establecimiento y qué compromisos institucionales lo sostienen<br>
**Evidencia de aprendizaje:** un plan de bienestar con protocolos, compromisos institucionales, indicadores y responsables

## 🎯 Propósito

Integrar la parte en un plan de bienestar escolar que cubra estudiantes y equipo, con protocolos, compromisos institucionales y medición.
...
2. **Explicar** cómo se integra el bienestar de estudiantes y de adultos en un solo plan verificable.
3. **Decidir** —el plan de bienestar del establecimiento y qué compromisos institucionales lo sostienen— y sostener la decisión con un fundamento escrito.
4. **Producir** la evidencia de la clase —un plan de bienestar con protocolos, compromisos institucionales, indicadores y responsables— y contrastarla contra el criterio de logro.
...
|---|---|
| **Plan de bienestar** | documento que articula salud mental estudiantil, convivencia, formación y condiciones de trabajo del equipo |
| **Compromiso institucional** | decisión de la dirección que modifica una condición y no solo agrega una actividad |
| **Indicador de bienestar** | medida periódica —derivaciones, licencias, rotación, percepción de seguridad— que permite ver cambio |
| **Coherencia interna** | correspondencia entre lo que el plan enseña y lo que la institución efectivamente hace |
...
2. Clasificar la situación distinguiendo **Plan de bienestar** de **Compromiso institucional**.
3. Decidir con fundamento, usando **Indicador de bienestar** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Coherencia interna** a la vista.
...
| **Evidencia de logro** | qué muestra un plan de bienestar con protocolos, compromisos institucionales, indicadores y responsables frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
Buena parte de lo que determina el bienestar escolar excede al establecimiento: Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Plan de bienestar"]
    C --> A2["Compromiso<br/>institucional"]
    C --> A3["Indicador de bienestar"]
    C --> A4["Coherencia interna"]
    A1 & A2 & A3 & A4 --> D{{"determinar el plan de<br/>bienestar del<br/>establecimiento y qué<br/>compromisos<br/>institucionales lo…"}}
    D --> E["Evidencia de aprendizaje<br/>un plan de bienestar con<br/>protocolos, compromisos<br/>institucionales,<br/>indicadores y<br/>responsables"]
...
Los planes de bienestar suelen tratar por separado a estudiantes y a adultos, cuando en la práctica son el mismo sistema: un equipo agotado no puede sostener la salud mental de nadie, y una comunidad con clima deteriorado desgasta al equipo. El plan de esta parte los integra y agrega lo que casi nunca aparece: compromisos institucionales que modifican condiciones, y no solo un calendario de actividades de promoción.

### 2. Frontera conceptual: qué es y qué no es

Los cuatro conceptos de esta clase se confunden entre sí con facilidad, y esa confusión no es
inocua: produce decisiones que atacan el problema equivocado. **Plan de bienestar** no es lo
mismo que **Compromiso institucional** —decisión de la dirección que modifica una condición y no solo agrega una actividad—, y tratarlos como sinónimos hace
que la intervención se dirija al lugar incorrecto. Del mismo modo, **Indicador de bienestar** y
**Coherencia interna** describen aspectos distintos de la misma situación: el primero
medida periódica —derivaciones, licencias, rotación, percepción de seguridad— que permite ver cambio, mientras el segundo correspondencia entre lo que el plan enseña y lo que la institución efectivamente hace.
...
- **Evidencia de logro.** Qué muestra un plan de bienestar con protocolos, compromisos institucionales, indicadores y responsables frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
El plan integra las once clases anteriores: mapa de competencias y umbrales, ajustes de condiciones de evaluación, protocolo de riesgo y postvención, implementación socioemocional con condiciones aseguradas, prácticas sensibles a la adversidad, protocolo de crisis, programa de afectividad y de convivencia digital, medición de carga, diagnóstico organizacional y plan de cuidado del equipo. Cada componente compromete responsable, plazo e indicador.

### 5. Qué sostiene la evidencia y qué no

Buena parte de lo que determina el bienestar escolar excede al establecimiento: acceso a salud mental, condiciones socioeconómicas de las familias, normativa laboral y financiamiento. El plan opera sobre el margen institucional, que es real y acotado. Y los indicadores son sensibles al registro: menos derivaciones puede significar mejor situación o peor detección.
...
te deja en condiciones de el plan de bienestar del establecimiento y qué compromisos institucionales lo sostienen, y esa decisión se sostiene solo si
...
|---|---|---|
| Weare, K. & Nind, M. (2011). *Mental Health Promotion in Schools*. | qué componentes de un enfoque escolar integral cuentan con respaldo. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
| Bryk, A. & Schneider, B. (2002). *Trust in Schools*. | la condición relacional sin la cual ningún plan institucional se sostiene. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Plan de bienestar** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Plan de bienestar de Compromiso institucional.** El trabajo aquí es separar lo observado de lo interpretado sobre **Compromiso institucional**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Indicador de bienestar como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Indicador de bienestar**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.

**Paso 4 — Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con Coherencia interna a la vista.** Con **Coherencia interna** ya delimitado, la pregunta pasa a ser de consecuencia: qué cambia para los estudiantes, para el tiempo de clase y para la carga del equipo. **Evidencia de partida** entrega la lectura observable; el juicio profesional sigue siendo humano y debe quedar firmado por quien lo hace.
...
|---|---|---|---|
| Intervenir sobre **Plan de bienestar** | Documento que articula salud mental estudiantil, convivencia, formación y condiciones de trabajo del equipo | Cuando **Evidencia de partida** es observable y accionable dentro del plazo de la decisión. | Sobrerreaccionar a una señal parcial. |
| Intervenir sobre **Compromiso institucional** | Decisión de la dirección que modifica una condición y no solo agrega una actividad | Cuando la primera explicación no distingue mecanismo ni responsable. | Convertir el concepto en etiqueta y no en intervención. |
| Observar antes de decidir | Reducir la incertidumbre antes de comprometer tiempo y credibilidad | Cuando la decisión es reversible y la evidencia disponible no distingue causas. | Observar indefinidamente y no decidir nunca. |
| Derivar o escalar | Poner la decisión donde están la competencia y la responsabilidad | Cuando hay normativa, resguardo de datos, salud o vulneración de derechos en juego. | Delegar hacia arriba lo que sí correspondía decidir en el aula. |

**Frontera de aplicación.** Buena parte de lo que determina el bienestar escolar excede al establecimiento: Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre proyecto integrador: plan de bienestar escolar |
|---|---|
...
Un plan de bienestar con protocolos, compromisos institucionales, indicadores y responsables.

Guárdala en `evidence/P23-C288-proyecto-integrador/` con estos archivos:
...
Escribe el plan integrando estudiantes y equipo, con dos compromisos institucionales. Preséntalo a dirección y consigue que se comprometan por escrito.
...
- [ ] cada componente tiene responsable, plazo e indicador declarados;
- [ ] el plan incluye al menos dos compromisos institucionales que modifican condiciones;
...
- Escribir un plan de actividades sin ningún compromiso que modifique una condición.
- Interpretar la caída de un indicador como mejora sin verificar si cambió el registro.
...
El plan debe desagregar sus indicadores: el bienestar promedio de una comunidad puede mejorar mientras empeora para los estudiantes con más barreras y para los docentes con condiciones más precarias.
...
1. ¿Qué condición concreta cambia la institución por efecto de este plan?
2. ¿Qué indicador muestra el bienestar del equipo y quién lo revisa?
3. ¿Qué hace tu escuela que contradice lo que el plan declara?
...
Cierra la parte 23 integrando las clases 277 a 287, y se articula con las partes 12, 15 y 21.
...
|---|---|---|
| [← 287 · Cuidado del equipo y liderazgo del bienestar](../class-11-cuidado-del-equipo-y-liderazgo-del-bienestar/README.md) | [Parte 23](../README.md) · [Programa](../../../README.md) | [Programa completo →](../../../README.md) |
