# Clase 286 — Desgaste profesional y su prevención institucional

> **Parte 23 · Bienestar, salud mental y sostenibilidad del oficio** — clase 10 de 12
...
**Decisión que habilita:** determinar qué condición organizacional de tu establecimiento está produciendo desgaste y qué se modifica<br>
**Evidencia de aprendizaje:** un diagnóstico de condiciones organizacionales con dos modificaciones concretas comprometidas

## 🎯 Propósito

Comprender el desgaste profesional como fenómeno organizacional y diseñar prevención institucional en vez de trasladar la responsabilidad al individuo.
...
2. **Explicar** por qué el autocuidado individual no resuelve un problema que es de organización del trabajo.
3. **Decidir** —qué condición organizacional de tu establecimiento está produciendo desgaste y qué se modifica— y sostener la decisión con un fundamento escrito.
4. **Producir** la evidencia de la clase —un diagnóstico de condiciones organizacionales con dos modificaciones concretas comprometidas— y contrastarla contra el criterio de logro.
...
|---|---|
| **Desgaste profesional** | síndrome de agotamiento, distanciamiento y pérdida de eficacia percibida, asociado a condiciones de trabajo |
| **Determinante organizacional** | condición del trabajo —carga, control, reconocimiento, comunidad, justicia— que predice el desgaste |
| **Autonomía profesional** | margen real de decisión sobre el propio trabajo, uno de los factores protectores más consistentes |
| **Traslado de responsabilidad** | error de tratar como problema individual lo que es producido por la organización |
...
2. Clasificar la situación distinguiendo **Desgaste profesional** de **Determinante organizacional**.
3. Decidir con fundamento, usando **Autonomía profesional** como criterio y declarando la fuente.
4. Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con **Traslado de responsabilidad** a la vista.
...
| **Evidencia de logro** | qué muestra un diagnóstico de condiciones organizacionales con dos modificaciones concretas comprometidas frente al criterio declarado de antemano |

**Frontera de aplicación.** El método vale mientras las condiciones que lo sostienen se cumplan.
Muchas condiciones dependen de decisiones de sostenedor o de normativa nacional y exceden al establecimiento. Cuando esa condición falla, el paso siguiente no es forzar el método:
...
flowchart TB
    ...
    C --> A1["Desgaste profesional"]
    C --> A2["Determinante<br/>organizacional"]
    C --> A3["Autonomía profesional"]
    C --> A4["Traslado de<br/>responsabilidad"]
    A1 & A2 & A3 & A4 --> D{{"determinar qué condición<br/>organizacional de tu<br/>establecimiento está<br/>produciendo desgaste y<br/>qué…"}}
    D --> E["Evidencia de aprendizaje<br/>un diagnóstico de<br/>condiciones<br/>organizacionales con dos<br/>modificaciones concretas<br/>comprometidas"]
...
El desgaste profesional docente se aborda con frecuencia mediante talleres de autocuidado, que trasladan al individuo la responsabilidad de un problema que la investigación sitúa en las condiciones del trabajo. Los determinantes identificados son organizacionales: sobrecarga, falta de control sobre el propio trabajo, ausencia de reconocimiento, comunidad débil y percepción de injusticia. Ninguno se modifica con técnicas de relajación, aunque estas puedan ayudar a sobrellevarlos.

### 2. Frontera conceptual: qué es y qué no es

Los cuatro conceptos de esta clase se confunden entre sí con facilidad, y esa confusión no es
inocua: produce decisiones que atacan el problema equivocado. **Desgaste profesional** no es lo
mismo que **Determinante organizacional** —condición del trabajo —carga, control, reconocimiento, comunidad, justicia— que predice el desgaste—, y tratarlos como sinónimos hace
que la intervención se dirija al lugar incorrecto. Del mismo modo, **Autonomía profesional** y
**Traslado de responsabilidad** describen aspectos distintos de la misma situación: el primero
margen real de decisión sobre el propio trabajo, uno de los factores protectores más consistentes, mientras el segundo error de tratar como problema individual lo que es producido por la organización.
...
- **Evidencia de logro.** Qué muestra un diagnóstico de condiciones organizacionales con dos modificaciones concretas comprometidas frente al criterio declarado de antemano. Se registra con fecha y contexto; sin eso, la señal no distingue una tendencia de una casualidad.
...
El diagnóstico institucional revisa esas cinco condiciones con evidencia: carga medida, margen de decisión efectivo, mecanismos de reconocimiento, calidad de las relaciones en el equipo y percepción de equidad en la distribución de tareas. De ahí salen modificaciones concretas: reducir una exigencia de reporte, devolver decisiones al equipo docente, revisar la distribución de jefaturas. Dos cambios reales valen más que un programa completo de bienestar.

### 5. Qué sostiene la evidencia y qué no

Muchas condiciones dependen de decisiones de sostenedor o de normativa nacional y exceden al establecimiento. La evidencia sobre intervenciones organizacionales en escuelas es más escasa que la del diagnóstico. Y la rotación docente, que es a la vez causa y efecto del desgaste, responde también a condiciones salariales que ninguna intervención pedagógica modifica.
...
te deja en condiciones de qué condición organizacional de tu establecimiento está produciendo desgaste y qué se modifica, y esa decisión se sostiene solo si
...
|---|---|---|
| Maslach, C. & Leiter, M. (2016). *Understanding the Burnout Experience*. | los determinantes organizacionales del desgaste y por qué el enfoque individual falla. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
| Bryk, A. & Schneider, B. (2002). *Trust in Schools*. | la confianza relacional como condición que protege y sostiene el trabajo del equipo. | ¿Qué supuesto de esta clase ayuda a poner a prueba? |
...
**Paso 1 — Delimitar el contexto y comprobar —no suponer— qué saben ya los estudiantes.** El equipo escribe primero el supuesto asociado a **Desgaste profesional** y se prohíbe tratarlo como hecho. Contrasta ese supuesto con **Evidencia de partida** y anota qué parte del dato todavía no existe. Del paso sale un registro fechado y una frase explícita: «cambiaríamos de decisión si…».

**Paso 2 — Clasificar la situación distinguiendo Desgaste profesional de Determinante organizacional.** El trabajo aquí es separar lo observado de lo interpretado sobre **Determinante organizacional**. La evidencia que ordena la conversación es **Evidencia de proceso**; si su definición no está escrita, escribirla es parte del paso. Nada avanza mientras el equipo no acuerde qué contaría como refutación.

**Paso 3 — Decidir con fundamento, usando Autonomía profesional como criterio y declarando la fuente.** El riesgo de este paso es cerrar demasiado rápido alrededor de **Autonomía profesional**. Antes de concluir, se enumeran dos explicaciones alternativas del mismo patrón y se revisa si **Evidencia de logro** logra distinguirlas. Si no lo logra, hace falta otra evidencia y así debe quedar registrado.

**Paso 4 — Anticipar qué evidencia confirmaría la decisión y cuál la refutaría, con Traslado de responsabilidad a la vista.** Con **Traslado de responsabilidad** ya delimitado, la pregunta pasa a ser de consecuencia: qué cambia para los estudiantes, para el tiempo de clase y para la carga del equipo. **Evidencia de partida** entrega la lectura observable; el juicio profesional sigue siendo humano y debe quedar firmado por quien lo hace.
...
|---|---|---|---|
| Intervenir sobre **Desgaste profesional** | Síndrome de agotamiento, distanciamiento y pérdida de eficacia percibida, asociado a condiciones de trabajo | Cuando **Evidencia de partida** es observable y accionable dentro del plazo de la decisión. | Sobrerreaccionar a una señal parcial. |
| Intervenir sobre **Determinante organizacional** | Condición del trabajo —carga, control, reconocimiento, comunidad, justicia— que predice el desgaste | Cuando la primera explicación no distingue mecanismo ni responsable. | Convertir el concepto en etiqueta y no en intervención. |
| Observar antes de decidir | Reducir la incertidumbre antes de comprometer tiempo y credibilidad | Cuando la decisión es reversible y la evidencia disponible no distingue causas. | Observar indefinidamente y no decidir nunca. |
| Derivar o escalar | Poner la decisión donde están la competencia y la responsabilidad | Cuando hay normativa, resguardo de datos, salud o vulneración de derechos en juego. | Delegar hacia arriba lo que sí correspondía decidir en el aula. |

**Frontera de aplicación.** Muchas condiciones dependen de decisiones de sostenedor o de normativa nacional y exceden al establecimiento. Fuera de esa frontera, la comparación
...
| Nivel | Responsabilidad sobre desgaste profesional y su prevención institucional |
|---|---|
...
Un diagnóstico de condiciones organizacionales con dos modificaciones concretas comprometidas.

Guárdala en `evidence/P23-C286-desgaste-profesional-y-su-prevencion-institucional/` con estos archivos:
...
Aplica el diagnóstico de las cinco condiciones en tu equipo. Compromete dos modificaciones concretas y verifica su ejecución en dos meses.
...
- [ ] el diagnóstico cubre las cinco condiciones organizacionales con evidencia;
- [ ] se comprometen dos modificaciones concretas con responsable y plazo;
...
- Responder al desgaste con talleres de autocuidado y no tocar ninguna condición del trabajo.
- Diagnosticar sin comprometer modificaciones, con lo que la consulta agrava la percepción de injusticia.
...
Los establecimientos con población más vulnerable concentran mayor carga emocional y mayor rotación, de modo que el desgaste refuerza la desigualdad: los estudiantes que más necesitan continuidad son los que menos la tienen.
...
1. ¿Sobre qué decisiones de su propio trabajo tiene control real un docente aquí?
2. ¿Cómo se distribuyen las jefaturas y los cursos más demandantes?
3. ¿Qué se modificó la última vez que se diagnosticó el clima laboral?
...
Continúa la clase 285 y prepara la 287. Se articula con las clases 260 y 192.
...
|---|---|---|
| [← 285 · Carga docente, tiempo y sostenibilidad](../class-09-carga-docente-tiempo-y-sostenibilidad/README.md) | [Parte 23](../README.md) · [Programa](../../../README.md) | [287 · Cuidado del equipo y liderazgo del bienestar →](../class-11-cuidado-del-equipo-y-liderazgo-del-bienestar/README.md) |
